#[doc = "Register `MASTER_INTERFACE_MONITOR_M0` reader"]
pub type R = crate::R<MasterInterfaceMonitorM0Spec>;
#[doc = "Register `MASTER_INTERFACE_MONITOR_M0` writer"]
pub type W = crate::W<MasterInterfaceMonitorM0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn stalled_ar_channel(&mut self) -> StalledArChannelW<MasterInterfaceMonitorM0Spec> {
        StalledArChannelW::new(self, 0)
    }
    #[doc = "Bit 1 - A transfer is stalled on the R channel.\n\nRVALID is HIGH.\n\nRREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_r_channel(&mut self) -> StalledRChannelW<MasterInterfaceMonitorM0Spec> {
        StalledRChannelW::new(self, 1)
    }
    #[doc = "Bit 2 - A transfer is stalled on the AW channel.\n\nAWVALID is HIGH.\n\nAWREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_aw_channel(&mut self) -> StalledAwChannelW<MasterInterfaceMonitorM0Spec> {
        StalledAwChannelW::new(self, 2)
    }
    #[doc = "Bit 3 - A transfer is stalled on the W channel.\n\nWVALID is HIGH.\n\nWREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_w_channel(&mut self) -> StalledWChannelW<MasterInterfaceMonitorM0Spec> {
        StalledWChannelW::new(self, 3)
    }
    #[doc = "Bit 4 - A transfer is stalled on the B channel. BVALID\n\nis HIGH BREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_b_channel(&mut self) -> StalledBChannelW<MasterInterfaceMonitorM0Spec> {
        StalledBChannelW::new(self, 4)
    }
    #[doc = "Bits 8:15 - Number of outstanding read transactions.\n\nFrom request handshake to response."]
    #[inline(always)]
    #[must_use]
    pub fn outstanding_reads(&mut self) -> OutstandingReadsW<MasterInterfaceMonitorM0Spec> {
        OutstandingReadsW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Number of outstanding write transactions.\n\nFrom request handshake to response."]
    #[inline(always)]
    #[must_use]
    pub fn outstanding_writes(&mut self) -> OutstandingWritesW<MasterInterfaceMonitorM0Spec> {
        OutstandingWritesW::new(self, 16)
    }
}
#[doc = "Master Interface Monitor Registers\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`master_interface_monitor_m0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`master_interface_monitor_m0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MasterInterfaceMonitorM0Spec;
impl crate::RegisterSpec for MasterInterfaceMonitorM0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`master_interface_monitor_m0::R`](R) reader structure"]
impl crate::Readable for MasterInterfaceMonitorM0Spec {}
#[doc = "`write(|w| ..)` method takes [`master_interface_monitor_m0::W`](W) writer structure"]
impl crate::Writable for MasterInterfaceMonitorM0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MASTER_INTERFACE_MONITOR_M0 to value 0"]
impl crate::Resettable for MasterInterfaceMonitorM0Spec {
