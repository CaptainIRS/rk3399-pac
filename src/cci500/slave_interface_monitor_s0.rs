#[doc = "Register `SLAVE_INTERFACE_MONITOR_S0` reader"]
pub type R = crate::R<SlaveInterfaceMonitorS0Spec>;
#[doc = "Register `SLAVE_INTERFACE_MONITOR_S0` writer"]
pub type W = crate::W<SlaveInterfaceMonitorS0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn stalled_ar_channel(&mut self) -> StalledArChannelW<SlaveInterfaceMonitorS0Spec> {
        StalledArChannelW::new(self, 0)
    }
    #[doc = "Bit 1 - A transfer is stalled on the R channel.\n\nRVALID is HIGH.\n\nRREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_r_channel(&mut self) -> StalledRChannelW<SlaveInterfaceMonitorS0Spec> {
        StalledRChannelW::new(self, 1)
    }
    #[doc = "Bit 2 - A transfer is stalled on the AW channel.\n\nAWVALID is HIGH.\n\nAWREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_aw_channel(&mut self) -> StalledAwChannelW<SlaveInterfaceMonitorS0Spec> {
        StalledAwChannelW::new(self, 2)
    }
    #[doc = "Bit 3 - A transfer is stalled on the W channel.\n\nWVALID is HIGH.\n\nWREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_w_channel(&mut self) -> StalledWChannelW<SlaveInterfaceMonitorS0Spec> {
        StalledWChannelW::new(self, 3)
    }
    #[doc = "Bit 4 - A transfer is stalled on the B channel. BVALID\n\nis HIGH\n\nBREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_b_channel(&mut self) -> StalledBChannelW<SlaveInterfaceMonitorS0Spec> {
        StalledBChannelW::new(self, 4)
    }
    #[doc = "Bit 5 - A transfer is stalled on the AC channel.\n\nACVALID is HIGH.\n\nACREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_ac_channel(&mut self) -> StalledAcChannelW<SlaveInterfaceMonitorS0Spec> {
        StalledAcChannelW::new(self, 5)
    }
    #[doc = "Bit 6 - A transfer is stalled on the CR channel.\n\nCRVALID is HIGH.\n\nCRREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_cr_channel(&mut self) -> StalledCrChannelW<SlaveInterfaceMonitorS0Spec> {
        StalledCrChannelW::new(self, 6)
    }
    #[doc = "Bit 7 - A transfer is stalled on the CD channel.\n\nCDVALID is HIGH.\n\nCDREADY is LOW.\n\nACE slave only."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_cd_channel(&mut self) -> StalledCdChannelW<SlaveInterfaceMonitorS0Spec> {
        StalledCdChannelW::new(self, 7)
    }
    #[doc = "Bits 8:15 - Number of outstanding read transactions.\n\nFrom request\n\nhandshake to response or RACK for ACE\n\ninterfaces."]
    #[inline(always)]
    #[must_use]
    pub fn outstanding_reads(&mut self) -> OutstandingReadsW<SlaveInterfaceMonitorS0Spec> {
        OutstandingReadsW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Number of outstanding write transactions.\n\nFrom request handshake to response for ACE\n\nLite interfaces or WACK for ACE interfaces."]
    #[inline(always)]
    #[must_use]
    pub fn outstanding_writes(&mut self) -> OutstandingWritesW<SlaveInterfaceMonitorS0Spec> {
        OutstandingWritesW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Number of outstanding snoop requests or\n\nDVM messages. From request handshake to\n\nresponse or snoop data for a hit."]
    #[inline(always)]
    #[must_use]
    pub fn outstanding_snoops(&mut self) -> OutstandingSnoopsW<SlaveInterfaceMonitorS0Spec> {
        OutstandingSnoopsW::new(self, 24)
    }
}
#[doc = "Slave Interface Monitor Registers\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slave_interface_monitor_s0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`slave_interface_monitor_s0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SlaveInterfaceMonitorS0Spec;
impl crate::RegisterSpec for SlaveInterfaceMonitorS0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`slave_interface_monitor_s0::R`](R) reader structure"]
impl crate::Readable for SlaveInterfaceMonitorS0Spec {}
#[doc = "`write(|w| ..)` method takes [`slave_interface_monitor_s0::W`](W) writer structure"]
impl crate::Writable for SlaveInterfaceMonitorS0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SLAVE_INTERFACE_MONITOR_S0 to value 0"]
impl crate::Resettable for SlaveInterfaceMonitorS0Spec {
