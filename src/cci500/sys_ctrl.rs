...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn snoop_disable(&mut self) -> SnoopDisableW<SysCtrlSpec> {
        SnoopDisableW::new(self, 0)
    }
    #[doc = "Bit 1 - DVM message disable"]
    #[inline(always)]
    #[must_use]
    pub fn dvm_disable(&mut self) -> DvmDisableW<SysCtrlSpec> {
        DvmDisableW::new(self, 1)
    }
    #[doc = "Bit 2 - Disable the snoop filter"]
    #[inline(always)]
    #[must_use]
    pub fn snoop_filter_disable(&mut self) -> SnoopFilterDisableW<SysCtrlSpec> {
        SnoopFilterDisableW::new(self, 2)
    }
    #[doc = "Bit 3 - Disable regional clock gating"]
    #[inline(always)]
    #[must_use]
    pub fn disable_clock_gating(&mut self) -> DisableClockGatingW<SysCtrlSpec> {
