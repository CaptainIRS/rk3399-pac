#[doc = "Register `SNOOP_CTRL_S0` reader"]
pub type R = crate::R<SnoopCtrlS0Spec>;
#[doc = "Register `SNOOP_CTRL_S0` writer"]
pub type W = crate::W<SnoopCtrlS0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enable_snoops(&mut self) -> EnableSnoopsW<SnoopCtrlS0Spec> {
        EnableSnoopsW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable issuing of DVM message requests from\n\nthis slave interface.\n\nRAZ/WI for interfaces not supporting DVM\n\nmessages:"]
    #[inline(always)]
    #[must_use]
    pub fn enable_dvms(&mut self) -> EnableDvmsW<SnoopCtrlS0Spec> {
        EnableDvmsW::new(self, 1)
    }
    #[doc = "Bit 30 - Slave interface supports snoop requests. This\n\nis overridden to 0x0 if you set the\n\nControl Override Register bit\\[0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn support_snoops(&mut self) -> SupportSnoopsW<SnoopCtrlS0Spec> {
        SupportSnoopsW::new(self, 30)
    }
    #[doc = "Bit 31 - Slave interface supports DVM messages. This\n\nis overridden to 0x0 if you set the\n\nControl Override Register bit\\[1\\]"]
    #[inline(always)]
    #[must_use]
    pub fn support_dvms(&mut self) -> SupportDvmsW<SnoopCtrlS0Spec> {
        SupportDvmsW::new(self, 31)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`snoop_ctrl_s0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`snoop_ctrl_s0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SnoopCtrlS0Spec;
impl crate::RegisterSpec for SnoopCtrlS0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`snoop_ctrl_s0::R`](R) reader structure"]
impl crate::Readable for SnoopCtrlS0Spec {}
#[doc = "`write(|w| ..)` method takes [`snoop_ctrl_s0::W`](W) writer structure"]
impl crate::Writable for SnoopCtrlS0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SNOOP_CTRL_S0 to value 0"]
impl crate::Resettable for SnoopCtrlS0Spec {
