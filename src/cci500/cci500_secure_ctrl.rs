#[doc = "Register `CCI500_SECURE_CTRL` reader"]
pub type R = crate::R<Cci500SecureCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn non_secure_override(&mut self) -> NonSecureOverrideW<Cci500SecureCtrlSpec> {
    ...
    pub fn debug_monitor_security_override(
        &mut self,
    ) -> DebugMonitorSecurityOverrideW<Cci500SecureCtrlSpec> {
        DebugMonitorSecurityOverrideW::new(self, 1)
    }
}
#[doc = "Secure Access Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cci500_secure_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cci500_secure_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cci500SecureCtrlSpec;
impl crate::RegisterSpec for Cci500SecureCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cci500_secure_ctrl::R`](R) reader structure"]
impl crate::Readable for Cci500SecureCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`cci500_secure_ctrl::W`](W) writer structure"]
impl crate::Writable for Cci500SecureCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CCI500_SECURE_CTRL to value 0"]
impl crate::Resettable for Cci500SecureCtrlSpec {
