#[doc = "Register `CCI500_MASTER_INTERFACE_MONITOR_M1` reader"]
pub type R = crate::R<Cci500MasterInterfaceMonitorM1Spec>;
#[doc = "Register `CCI500_MASTER_INTERFACE_MONITOR_M1` writer"]
pub type W = crate::W<Cci500MasterInterfaceMonitorM1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn stalled_ar_channel(&mut self) -> StalledArChannelW<Cci500MasterInterfaceMonitorM1Spec> {
        StalledArChannelW::new(self, 0)
    }
    #[doc = "Bit 1 - A transfer is stalled on the R channel.\n\nRVALID is HIGH.\n\nRREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_r_channel(&mut self) -> StalledRChannelW<Cci500MasterInterfaceMonitorM1Spec> {
        StalledRChannelW::new(self, 1)
    }
    #[doc = "Bit 2 - A transfer is stalled on the AW channel.\n\nAWVALID is HIGH.\n\nAWREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_aw_channel(&mut self) -> StalledAwChannelW<Cci500MasterInterfaceMonitorM1Spec> {
        StalledAwChannelW::new(self, 2)
    }
    #[doc = "Bit 3 - A transfer is stalled on the W channel.\n\nWVALID is HIGH.\n\nWREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_w_channel(&mut self) -> StalledWChannelW<Cci500MasterInterfaceMonitorM1Spec> {
        StalledWChannelW::new(self, 3)
    }
    #[doc = "Bit 4 - A transfer is stalled on the B channel. BVALID\n\nis HIGH BREADY is LOW."]
    #[inline(always)]
    #[must_use]
    pub fn stalled_b_channel(&mut self) -> StalledBChannelW<Cci500MasterInterfaceMonitorM1Spec> {
        StalledBChannelW::new(self, 4)
    }
    #[doc = "Bits 8:15 - Number of outstanding read transactions.\n\nFrom request handshake to response."]
    #[inline(always)]
    #[must_use]
    pub fn outstanding_reads(&mut self) -> OutstandingReadsW<Cci500MasterInterfaceMonitorM1Spec> {
        OutstandingReadsW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Number of outstanding write transactions.\n\nFrom request handshake to response."]
    #[inline(always)]
    #[must_use]
    pub fn outstanding_writes(&mut self) -> OutstandingWritesW<Cci500MasterInterfaceMonitorM1Spec> {
...
pub struct Cci500MasterInterfaceMonitorM1Spec;
impl crate::RegisterSpec for Cci500MasterInterfaceMonitorM1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cci500_master_interface_monitor_m1::R`](R) reader structure"]
impl crate::Readable for Cci500MasterInterfaceMonitorM1Spec {}
#[doc = "`write(|w| ..)` method takes [`cci500_master_interface_monitor_m1::W`](W) writer structure"]
impl crate::Writable for Cci500MasterInterfaceMonitorM1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CCI500_MASTER_INTERFACE_MONITOR_M1 to value 0"]
impl crate::Resettable for Cci500MasterInterfaceMonitorM1Spec {
