#[doc = "Register `DENALI_PHY_197` reader"]
pub type R = crate::R<DenaliPhy197Spec>;
#[doc = "Register `DENALI_PHY_197` writer"]
pub type W = crate::W<DenaliPhy197Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq0_fall_slave_delay_1(
        &mut self,
    ) -> PhyRddqsDq0FallSlaveDelay1W<DenaliPhy197Spec> {
    ...
    pub fn phy_rddqs_dq1_rise_slave_delay_1(
        &mut self,
    ) -> PhyRddqsDq1RiseSlaveDelay1W<DenaliPhy197Spec> {
        PhyRddqsDq1RiseSlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_197::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_197::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy197Spec;
impl crate::RegisterSpec for DenaliPhy197Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_197::R`](R) reader structure"]
impl crate::Readable for DenaliPhy197Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_197::W`](W) writer structure"]
impl crate::Writable for DenaliPhy197Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_197 to value 0"]
impl crate::Resettable for DenaliPhy197Spec {
