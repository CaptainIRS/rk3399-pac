#[doc = "Register `DENALI_PHY_131` reader"]
pub type R = crate::R<DenaliPhy131Spec>;
#[doc = "Register `DENALI_PHY_131` writer"]
pub type W = crate::W<DenaliPhy131Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq0_shift_1(&mut self) -> PhySwWrdq0Shift1W<DenaliPhy131Spec> {
        PhySwWrdq0Shift1W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ1 for slice 1. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq1_shift_1(&mut self) -> PhySwWrdq1Shift1W<DenaliPhy131Spec> {
        PhySwWrdq1Shift1W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ2 for slice 1. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq2_shift_1(&mut self) -> PhySwWrdq2Shift1W<DenaliPhy131Spec> {
        PhySwWrdq2Shift1W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ3 for slice 1. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq3_shift_1(&mut self) -> PhySwWrdq3Shift1W<DenaliPhy131Spec> {
        PhySwWrdq3Shift1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_131::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_131::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy131Spec;
impl crate::RegisterSpec for DenaliPhy131Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_131::R`](R) reader structure"]
impl crate::Readable for DenaliPhy131Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_131::W`](W) writer structure"]
impl crate::Writable for DenaliPhy131Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_131 to value 0"]
impl crate::Resettable for DenaliPhy131Spec {
