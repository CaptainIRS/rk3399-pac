#[doc = "Register `DENALI_PHY_470` reader"]
pub type R = crate::R<DenaliPhy470Spec>;
#[doc = "Register `DENALI_PHY_470` writer"]
pub type W = crate::W<DenaliPhy470Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddata_en_tsel_dly_3(&mut self) -> PhyRddataEnTselDly3W<DenaliPhy470Spec> {
        PhyRddataEnTselDly3W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Master delay line override settings for slice 3. Bit (0) enables software half clock mode. Bit (1) is the software half clock mode value. Bit (2) enables software bypass mode. Bit (3) is the software bypass mode value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_master_mode_3(&mut self) -> PhySwMasterMode3W<DenaliPhy470Spec> {
        PhySwMasterMode3W::new(self, 8)
    }
    #[doc = "Bits 16:25 - Start value for master delay line locking algorithm for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_master_delay_start_3(&mut self) -> PhyMasterDelayStart3W<DenaliPhy470Spec> {
        PhyMasterDelayStart3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_470::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_470::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy470Spec;
impl crate::RegisterSpec for DenaliPhy470Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_470::R`](R) reader structure"]
impl crate::Readable for DenaliPhy470Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_470::W`](W) writer structure"]
impl crate::Writable for DenaliPhy470Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_470 to value 0"]
impl crate::Resettable for DenaliPhy470Spec {
