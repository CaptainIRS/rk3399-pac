#[doc = "Register `DENALI_PHY_211` reader"]
pub type R = crate::R<DenaliPhy211Spec>;
#[doc = "Register `DENALI_PHY_211` writer"]
pub type W = crate::W<DenaliPhy211Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_oe_timing_1(&mut self) -> PhyDqOeTiming1W<DenaliPhy211Spec> {
        PhyDqOeTiming1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Start/end timing values for DQ/DM read based termination enable and select signals for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_tsel_rd_timing_1(&mut self) -> PhyDqTselRdTiming1W<DenaliPhy211Spec> {
        PhyDqTselRdTiming1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Start/end timing values for DQ/DM write based termination enable and select signals for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_tsel_wr_timing_1(&mut self) -> PhyDqTselWrTiming1W<DenaliPhy211Spec> {
        PhyDqTselWrTiming1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Start/end timing values for DQS output enable signals for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_oe_timing_1(&mut self) -> PhyDqsOeTiming1W<DenaliPhy211Spec> {
        PhyDqsOeTiming1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_211::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_211::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy211Spec;
impl crate::RegisterSpec for DenaliPhy211Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_211::R`](R) reader structure"]
impl crate::Readable for DenaliPhy211Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_211::W`](W) writer structure"]
impl crate::Writable for DenaliPhy211Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_211 to value 0"]
impl crate::Resettable for DenaliPhy211Spec {
