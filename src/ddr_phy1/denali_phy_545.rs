#[doc = "Register `DENALI_PHY_545` reader"]
pub type R = crate::R<DenaliPhy545Spec>;
#[doc = "Register `DENALI_PHY_545` writer"]
pub type W = crate::W<DenaliPhy545Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_adr1_clk_wr_slave_delay_0(&mut self) -> PhyAdr1ClkWrSlaveDelay0W<DenaliPhy545Spec> {
        PhyAdr1ClkWrSlaveDelay0W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Address slice slave delay setting for address slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr2_clk_wr_slave_delay_0(&mut self) -> PhyAdr2ClkWrSlaveDelay0W<DenaliPhy545Spec> {
        PhyAdr2ClkWrSlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_545::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_545::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy545Spec;
impl crate::RegisterSpec for DenaliPhy545Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_545::R`](R) reader structure"]
impl crate::Readable for DenaliPhy545Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_545::W`](W) writer structure"]
impl crate::Writable for DenaliPhy545Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_545 to value 0"]
impl crate::Resettable for DenaliPhy545Spec {
