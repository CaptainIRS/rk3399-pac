...
#[doc = "Field `PHY_ADR_DDL_TEST_MSTR_DLY_OBS_2` reader - DDL test observation delays for address slice 2 master DDL. READ-ONLY"]
pub type PhyAdrDdlTestMstrDlyObs2R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - DDL test observation delays for address slice 2 master DDL. READ-ONLY"]
    #[inline(always)]
