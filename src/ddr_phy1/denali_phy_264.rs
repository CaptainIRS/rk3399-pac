#[doc = "Register `DENALI_PHY_264` reader"]
pub type R = crate::R<DenaliPhy264Spec>;
#[doc = "Register `DENALI_PHY_264` writer"]
pub type W = crate::W<DenaliPhy264Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dbi_mode_2(&mut self) -> PhyDbiMode2W<DenaliPhy264Spec> {
        PhyDbiMode2W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Per-rank CS map for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_rank_cs_map_2(&mut self) -> PhyPerRankCsMap2W<DenaliPhy264Spec> {
    ...
    pub fn phy_per_cs_training_multicast_en_2(
        &mut self,
    ) -> PhyPerCsTrainingMulticastEn2W<DenaliPhy264Spec> {
        PhyPerCsTrainingMulticastEn2W::new(self, 16)
    }
    #[doc = "Bit 24 - For per-rank training, indicates which ranksparamtersareread/ writtenforslice2.'"]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_cs_training_index_2(&mut self) -> PhyPerCsTrainingIndex2W<DenaliPhy264Spec> {
        PhyPerCsTrainingIndex2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_264::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_264::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy264Spec;
impl crate::RegisterSpec for DenaliPhy264Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_264::R`](R) reader structure"]
impl crate::Readable for DenaliPhy264Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_264::W`](W) writer structure"]
impl crate::Writable for DenaliPhy264Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_264 to value 0x0001_0000"]
impl crate::Resettable for DenaliPhy264Spec {
