#[doc = "Register `DENALI_PHY_192` reader"]
pub type R = crate::R<DenaliPhy192Spec>;
#[doc = "Register `DENALI_PHY_192` writer"]
pub type W = crate::W<DenaliPhy192Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq0_slave_delay_1(&mut self) -> PhyRddq0SlaveDelay1W<DenaliPhy192Spec> {
        PhyRddq0SlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQ1 slave delay setting for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq1_slave_delay_1(&mut self) -> PhyRddq1SlaveDelay1W<DenaliPhy192Spec> {
        PhyRddq1SlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_192::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_192::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy192Spec;
impl crate::RegisterSpec for DenaliPhy192Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_192::R`](R) reader structure"]
impl crate::Readable for DenaliPhy192Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_192::W`](W) writer structure"]
impl crate::Writable for DenaliPhy192Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_192 to value 0"]
impl crate::Resettable for DenaliPhy192Spec {
