#[doc = "Register `DENALI_PHY_473` reader"]
pub type R = crate::R<DenaliPhy473Spec>;
#[doc = "Register `DENALI_PHY_473` writer"]
pub type W = crate::W<DenaliPhy473Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_back_step_3(&mut self) -> PhyGtlvlBackStep3W<DenaliPhy473Spec> {
        PhyGtlvlBackStep3W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Final backup step delay used in gate training algorithm for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_final_step_3(&mut self) -> PhyGtlvlFinalStep3W<DenaliPhy473Spec> {
        PhyGtlvlFinalStep3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_473::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_473::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy473Spec;
impl crate::RegisterSpec for DenaliPhy473Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_473::R`](R) reader structure"]
impl crate::Readable for DenaliPhy473Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_473::W`](W) writer structure"]
impl crate::Writable for DenaliPhy473Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_473 to value 0"]
impl crate::Resettable for DenaliPhy473Spec {
