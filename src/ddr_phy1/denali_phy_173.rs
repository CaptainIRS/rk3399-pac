...
#[doc = "Field `PHY_RDLVL_RDDQS_DQ_NUM_WINDOWS_OBS_1` reader - Observation register for read leveling number of windows found for slice 1. READ-ONLY"]
pub type PhyRdlvlRddqsDqNumWindowsObs1R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:1 - Observation register for read leveling number of windows found for slice 1. READ-ONLY"]
    #[inline(always)]
