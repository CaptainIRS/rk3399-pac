#[doc = "Register `DENALI_PHY_462` reader"]
pub type R = crate::R<DenaliPhy462Spec>;
#[doc = "Register `DENALI_PHY_462` writer"]
pub type W = crate::W<DenaliPhy462Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddqs_latency_adjust_3(&mut self) -> PhyRddqsLatencyAdjust3W<DenaliPhy462Spec> {
        PhyRddqsLatencyAdjust3W::new(self, 0)
    }
    #[doc = "Bits 8:10 - Number of cycles to delay the incoming dfi_wrdata_en/dfi_wrdata signals for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_write_path_lat_add_3(&mut self) -> PhyWritePathLatAdd3W<DenaliPhy462Spec> {
    ...
    pub fn phy_wrlvl_delay_early_threshold_3(
        &mut self,
    ) -> PhyWrlvlDelayEarlyThreshold3W<DenaliPhy462Spec> {
        PhyWrlvlDelayEarlyThreshold3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_462::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_462::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy462Spec;
impl crate::RegisterSpec for DenaliPhy462Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_462::R`](R) reader structure"]
impl crate::Readable for DenaliPhy462Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_462::W`](W) writer structure"]
impl crate::Writable for DenaliPhy462Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_462 to value 0"]
impl crate::Resettable for DenaliPhy462Spec {
