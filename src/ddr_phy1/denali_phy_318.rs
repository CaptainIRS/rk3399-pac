#[doc = "Register `DENALI_PHY_318` reader"]
pub type R = crate::R<DenaliPhy318Spec>;
#[doc = "Register `DENALI_PHY_318` writer"]
pub type W = crate::W<DenaliPhy318Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq6_slave_delay_2(&mut self) -> PhyClkWrdq6SlaveDelay2W<DenaliPhy318Spec> {
        PhyClkWrdq6SlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ7 for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq7_slave_delay_2(&mut self) -> PhyClkWrdq7SlaveDelay2W<DenaliPhy318Spec> {
        PhyClkWrdq7SlaveDelay2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_318::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_318::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy318Spec;
impl crate::RegisterSpec for DenaliPhy318Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_318::R`](R) reader structure"]
impl crate::Readable for DenaliPhy318Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_318::W`](W) writer structure"]
impl crate::Writable for DenaliPhy318Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_318 to value 0"]
impl crate::Resettable for DenaliPhy318Spec {
