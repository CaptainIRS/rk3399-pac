#[doc = "Register `DENALI_PHY_277` reader"]
pub type R = crate::R<DenaliPhy277Spec>;
#[doc = "Register `DENALI_PHY_277` writer"]
pub type W = crate::W<DenaliPhy277Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddqs_dq_enc_obs_select_2(&mut self) -> PhyRddqsDqEncObsSelect2W<DenaliPhy277Spec> {
        PhyRddqsDqEncObsSelect2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Select value to map the internal write DQ slave delay encoded settings to the accessible write DQ encoded slave delay observation register for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wr_enc_obs_select_2(&mut self) -> PhyWrEncObsSelect2W<DenaliPhy277Spec> {
        PhyWrEncObsSelect2W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Select value to map the internal write DQ/DQS automatic cycle/ half_cycle shift settings to the accessible write DQ/DQS shift observation register for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wr_shift_obs_select_2(&mut self) -> PhyWrShiftObsSelect2W<DenaliPhy277Spec> {
        PhyWrShiftObsSelect2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Select value to map the internal read entry FIFO read/write pointers to the accessible read entry FIFO pointer observation register for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_fifo_ptr_obs_select_2(&mut self) -> PhyFifoPtrObsSelect2W<DenaliPhy277Spec> {
        PhyFifoPtrObsSelect2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_277::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_277::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy277Spec;
impl crate::RegisterSpec for DenaliPhy277Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_277::R`](R) reader structure"]
impl crate::Readable for DenaliPhy277Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_277::W`](W) writer structure"]
impl crate::Writable for DenaliPhy277Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_277 to value 0"]
impl crate::Resettable for DenaliPhy277Spec {
