#[doc = "Register `DENALI_PHY_392` reader"]
pub type R = crate::R<DenaliPhy392Spec>;
#[doc = "Register `DENALI_PHY_392` writer"]
pub type W = crate::W<DenaliPhy392Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dbi_mode_3(&mut self) -> PhyDbiMode3W<DenaliPhy392Spec> {
        PhyDbiMode3W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Per-rank CS map for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_rank_cs_map_3(&mut self) -> PhyPerRankCsMap3W<DenaliPhy392Spec> {
    ...
    pub fn phy_per_cs_training_multicast_en_3(
        &mut self,
    ) -> PhyPerCsTrainingMulticastEn3W<DenaliPhy392Spec> {
        PhyPerCsTrainingMulticastEn3W::new(self, 16)
    }
    #[doc = "Bit 24 - For per-rank training, indicates which ranksparamtersareread/ writtenforslice3.'"]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_cs_training_index_3(&mut self) -> PhyPerCsTrainingIndex3W<DenaliPhy392Spec> {
        PhyPerCsTrainingIndex3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_392::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_392::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy392Spec;
impl crate::RegisterSpec for DenaliPhy392Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_392::R`](R) reader structure"]
impl crate::Readable for DenaliPhy392Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_392::W`](W) writer structure"]
impl crate::Writable for DenaliPhy392Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_392 to value 0x0001_0000"]
impl crate::Resettable for DenaliPhy392Spec {
