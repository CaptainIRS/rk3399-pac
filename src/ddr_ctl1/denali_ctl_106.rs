#[doc = "Register `DENALI_CTL_106` reader"]
pub type R = crate::R<DenaliCtl106Spec>;
#[doc = "Register `DENALI_CTL_106` writer"]
pub type W = crate::W<DenaliCtl106Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpc_promote_threshold_f2(&mut self) -> LpcPromoteThresholdF2W<DenaliCtl106Spec> {
        LpcPromoteThresholdF2W::new(self, 0)
    }
    #[doc = "Bit 16 - Enable LPC to execute a DFI control update on a self-refresh exit sequence. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn lpc_sr_ctrlupd_en(&mut self) -> LpcSrCtrlupdEnW<DenaliCtl106Spec> {
        LpcSrCtrlupdEnW::new(self, 16)
    }
    #[doc = "Bit 24 - Enable LPC to execute a DFI PHY update on a self-refresh exit sequence. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn lpc_sr_phyupd_en(&mut self) -> LpcSrPhyupdEnW<DenaliCtl106Spec> {
        LpcSrPhyupdEnW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_106::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_106::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl106Spec;
impl crate::RegisterSpec for DenaliCtl106Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_106::R`](R) reader structure"]
impl crate::Readable for DenaliCtl106Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_106::W`](W) writer structure"]
impl crate::Writable for DenaliCtl106Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_106 to value 0"]
impl crate::Resettable for DenaliCtl106Spec {
