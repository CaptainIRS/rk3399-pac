#[doc = "Register `DENALI_CTL_92` reader"]
pub type R = crate::R<DenaliCtl92Spec>;
#[doc = "Register `DENALI_CTL_92` writer"]
pub type W = crate::W<DenaliCtl92Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lowpower_refresh_enable(&mut self) -> LowpowerRefreshEnableW<DenaliCtl92Spec> {
        LowpowerRefreshEnableW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Clock hold delay on self-refresh entry for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn cksre_f0(&mut self) -> CksreF0W<DenaliCtl92Spec> {
        CksreF0W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Clock stable delay on self-refresh exit for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn cksrx_f0(&mut self) -> CksrxF0W<DenaliCtl92Spec> {
        CksrxF0W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Clock hold delay on self-refresh entry for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn cksre_f1(&mut self) -> CksreF1W<DenaliCtl92Spec> {
        CksreF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_92::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_92::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl92Spec;
impl crate::RegisterSpec for DenaliCtl92Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_92::R`](R) reader structure"]
impl crate::Readable for DenaliCtl92Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_92::W`](W) writer structure"]
impl crate::Writable for DenaliCtl92Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_92 to value 0"]
impl crate::Resettable for DenaliCtl92Spec {
