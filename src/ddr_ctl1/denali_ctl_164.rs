#[doc = "Register `DENALI_CTL_164` reader"]
pub type R = crate::R<DenaliCtl164Spec>;
#[doc = "Register `DENALI_CTL_164` writer"]
pub type W = crate::W<DenaliCtl164Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn long_count_mask(&mut self) -> LongCountMaskW<DenaliCtl164Spec> {
        LongCountMaskW::new(self, 0)
    }
    #[doc = "Bits 8:12 - AREF number of pending refreshes until the normal priority request is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn aref_norm_threshold(&mut self) -> ArefNormThresholdW<DenaliCtl164Spec> {
        ArefNormThresholdW::new(self, 8)
    }
    #[doc = "Bits 16:20 - AREF number of pending refreshes until the high priority request is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn aref_high_threshold(&mut self) -> ArefHighThresholdW<DenaliCtl164Spec> {
        ArefHighThresholdW::new(self, 16)
    }
    #[doc = "Bits 24:28 - AREF number of pending refreshes until the maximum number of refreshes has been exceeded."]
    #[inline(always)]
    #[must_use]
    pub fn aref_max_deficit(&mut self) -> ArefMaxDeficitW<DenaliCtl164Spec> {
        ArefMaxDeficitW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_164::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_164::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl164Spec;
impl crate::RegisterSpec for DenaliCtl164Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_164::R`](R) reader structure"]
impl crate::Readable for DenaliCtl164Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_164::W`](W) writer structure"]
impl crate::Writable for DenaliCtl164Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_164 to value 0"]
impl crate::Resettable for DenaliCtl164Spec {
