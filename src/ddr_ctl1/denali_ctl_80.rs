#[doc = "Register `DENALI_CTL_80` reader"]
pub type R = crate::R<DenaliCtl80Spec>;
#[doc = "Register `DENALI_CTL_80` writer"]
pub type W = crate::W<DenaliCtl80Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn upd_ctrlupd_norm_threshold_f2(&mut self) -> UpdCtrlupdNormThresholdF2W<DenaliCtl80Spec> {
        UpdCtrlupdNormThresholdF2W::new(self, 0)
    }
    #[doc = "Bits 16:31 - DFI control update number of long counts until the high priority request is asserted for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn upd_ctrlupd_high_threshold_f2(&mut self) -> UpdCtrlupdHighThresholdF2W<DenaliCtl80Spec> {
        UpdCtrlupdHighThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_80::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_80::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl80Spec;
impl crate::RegisterSpec for DenaliCtl80Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_80::R`](R) reader structure"]
impl crate::Readable for DenaliCtl80Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_80::W`](W) writer structure"]
impl crate::Writable for DenaliCtl80Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_80 to value 0"]
impl crate::Resettable for DenaliCtl80Spec {
