#[doc = "Register `DENALI_CTL_25` reader"]
pub type R = crate::R<DenaliCtl25Spec>;
#[doc = "Register `DENALI_CTL_25` writer"]
pub type W = crate::W<DenaliCtl25Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn caslat_lin_f2(&mut self) -> CaslatLinF2W<DenaliCtl25Spec> {
        CaslatLinF2W::new(self, 0)
    }
    #[doc = "Bits 8:12 - DRAM WRLAT value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn wrlat_f2(&mut self) -> WrlatF2W<DenaliCtl25Spec> {
        WrlatF2W::new(self, 8)
    }
    #[doc = "Bits 16:21 - DRAM additive latency value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn additive_lat_f2(&mut self) -> AdditiveLatF2W<DenaliCtl25Spec> {
        AdditiveLatF2W::new(self, 16)
    }
    #[doc = "Bits 24:26 - DRAM burst interrupt interval value in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tbst_int_interval(&mut self) -> TbstIntIntervalW<DenaliCtl25Spec> {
        TbstIntIntervalW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_25::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_25::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl25Spec;
impl crate::RegisterSpec for DenaliCtl25Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_25::R`](R) reader structure"]
impl crate::Readable for DenaliCtl25Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_25::W`](W) writer structure"]
impl crate::Writable for DenaliCtl25Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_25 to value 0"]
impl crate::Resettable for DenaliCtl25Spec {
