#[doc = "Register `DENALI_CTL_126` reader"]
pub type R = crate::R<DenaliCtl126Spec>;
#[doc = "Register `DENALI_CTL_126` writer"]
pub type W = crate::W<DenaliCtl126Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfc_f1(&mut self) -> TfcF1W<DenaliCtl126Spec> {
        TfcF1W::new(self, 0)
    }
    #[doc = "Bits 16:20 - JEDEC TCKFSPE, the valid clock requirement after entering SDP change."]
    #[inline(always)]
    #[must_use]
    pub fn tckfspe_f1(&mut self) -> TckfspeF1W<DenaliCtl126Spec> {
        TckfspeF1W::new(self, 16)
    }
    #[doc = "Bits 24:28 - JEDEC TCKFSPX, the valid clock requirement before 1st valid command after FSP change."]
    #[inline(always)]
    #[must_use]
    pub fn tckfspx_f1(&mut self) -> TckfspxF1W<DenaliCtl126Spec> {
        TckfspxF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_126::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_126::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl126Spec;
impl crate::RegisterSpec for DenaliCtl126Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_126::R`](R) reader structure"]
impl crate::Readable for DenaliCtl126Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_126::W`](W) writer structure"]
impl crate::Writable for DenaliCtl126Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_126 to value 0"]
impl crate::Resettable for DenaliCtl126Spec {
