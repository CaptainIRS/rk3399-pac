#[doc = "Register `DENALI_CTL_136` reader"]
pub type R = crate::R<DenaliCtl136Spec>;
#[doc = "Register `DENALI_CTL_136` writer"]
pub type W = crate::W<DenaliCtl136Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr0_data_f2_0(&mut self) -> Mr0DataF2_0W<DenaliCtl136Spec> {
        Mr0DataF2_0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 1 for chip select 0 for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn mr1_data_f2_0(&mut self) -> Mr1DataF2_0W<DenaliCtl136Spec> {
        Mr1DataF2_0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_136::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_136::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl136Spec;
impl crate::RegisterSpec for DenaliCtl136Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_136::R`](R) reader structure"]
impl crate::Readable for DenaliCtl136Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_136::W`](W) writer structure"]
impl crate::Writable for DenaliCtl136Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_136 to value 0"]
impl crate::Resettable for DenaliCtl136Spec {
