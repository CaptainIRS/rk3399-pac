#[doc = "Register `DENALI_CTL_98` reader"]
pub type R = crate::R<DenaliCtl98Spec>;
#[doc = "Register `DENALI_CTL_98` writer"]
pub type W = crate::W<DenaliCtl98Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpi_sr_mcclk_gate_wakeup_f2(&mut self) -> LpiSrMcclkGateWakeupF2W<DenaliCtl98Spec> {
        LpiSrMcclkGateWakeupF2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when memory is in self- refresh power down lite, for frequncy copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_srpd_lite_wakeup_f2(&mut self) -> LpiSrpdLiteWakeupF2W<DenaliCtl98Spec> {
        LpiSrpdLiteWakeupF2W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when memory is in self- refresh power down deep, for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_srpd_deep_wakeup_f2(&mut self) -> LpiSrpdDeepWakeupF2W<DenaliCtl98Spec> {
    ...
    pub fn lpi_srpd_deep_mcclk_gate_wakeup_f2(
        &mut self,
    ) -> LpiSrpdDeepMcclkGateWakeupF2W<DenaliCtl98Spec> {
        LpiSrpdDeepMcclkGateWakeupF2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_98::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_98::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl98Spec;
impl crate::RegisterSpec for DenaliCtl98Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_98::R`](R) reader structure"]
impl crate::Readable for DenaliCtl98Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_98::W`](W) writer structure"]
impl crate::Writable for DenaliCtl98Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_98 to value 0"]
impl crate::Resettable for DenaliCtl98Spec {
