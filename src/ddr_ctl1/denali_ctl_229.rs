#[doc = "Register `DENALI_CTL_229` reader"]
pub type R = crate::R<DenaliCtl229Spec>;
#[doc = "Register `DENALI_CTL_229` writer"]
pub type W = crate::W<DenaliCtl229Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_high_threshold_f0(&mut self) -> WrlvlHighThresholdF0W<DenaliCtl229Spec> {
        WrlvlHighThresholdF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Write leveling timeout number of long counts until the timeout is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_timeout_f0(&mut self) -> WrlvlTimeoutF0W<DenaliCtl229Spec> {
        WrlvlTimeoutF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_229::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_229::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl229Spec;
impl crate::RegisterSpec for DenaliCtl229Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_229::R`](R) reader structure"]
impl crate::Readable for DenaliCtl229Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_229::W`](W) writer structure"]
impl crate::Writable for DenaliCtl229Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_229 to value 0"]
impl crate::Resettable for DenaliCtl229Spec {
