#[doc = "Register `DENALI_CTL_235` reader"]
pub type R = crate::R<DenaliCtl235Spec>;
#[doc = "Register `DENALI_CTL_235` writer"]
pub type W = crate::W<DenaliCtl235Spec>;
...
impl W {
    ...
    pub fn wrlvl_sw_promote_threshold_f2(
        &mut self,
    ) -> WrlvlSwPromoteThresholdF2W<DenaliCtl235Spec> {
    ...
    pub fn wrlvl_dfi_promote_threshold_f2(
        &mut self,
    ) -> WrlvlDfiPromoteThresholdF2W<DenaliCtl235Spec> {
        WrlvlDfiPromoteThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_235::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_235::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl235Spec;
impl crate::RegisterSpec for DenaliCtl235Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_235::R`](R) reader structure"]
impl crate::Readable for DenaliCtl235Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_235::W`](W) writer structure"]
impl crate::Writable for DenaliCtl235Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_235 to value 0"]
impl crate::Resettable for DenaliCtl235Spec {
