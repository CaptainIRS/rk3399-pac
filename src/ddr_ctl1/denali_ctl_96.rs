#[doc = "Register `DENALI_CTL_96` reader"]
pub type R = crate::R<DenaliCtl96Spec>;
#[doc = "Register `DENALI_CTL_96` writer"]
pub type W = crate::W<DenaliCtl96Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpi_sr_wakeup_f1(&mut self) -> LpiSrWakeupF1W<DenaliCtl96Spec> {
        LpiSrWakeupF1W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when memory is in self- refresh with memory and controller clock gating, for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_sr_mcclk_gate_wakeup_f1(&mut self) -> LpiSrMcclkGateWakeupF1W<DenaliCtl96Spec> {
        LpiSrMcclkGateWakeupF1W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when memory is in self- refresh power down lite, for frequncy copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_srpd_lite_wakeup_f1(&mut self) -> LpiSrpdLiteWakeupF1W<DenaliCtl96Spec> {
        LpiSrpdLiteWakeupF1W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when memory is in self- refresh power down deep, for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_srpd_deep_wakeup_f1(&mut self) -> LpiSrpdDeepWakeupF1W<DenaliCtl96Spec> {
        LpiSrpdDeepWakeupF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_96::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_96::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl96Spec;
impl crate::RegisterSpec for DenaliCtl96Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_96::R`](R) reader structure"]
impl crate::Readable for DenaliCtl96Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_96::W`](W) writer structure"]
impl crate::Writable for DenaliCtl96Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_96 to value 0"]
impl crate::Resettable for DenaliCtl96Spec {
