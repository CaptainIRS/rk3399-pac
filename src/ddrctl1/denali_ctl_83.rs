#[doc = "Register `DENALI_CTL_83` reader"]
pub type R = crate::R<DenaliCtl83Spec>;
#[doc = "Register `DENALI_CTL_83` writer"]
pub type W = crate::W<DenaliCtl83Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_phymstr_resp_f0(&mut self) -> TdfiPhymstrRespF0W<DenaliCtl83Spec> {
    ...
    pub fn phymstr_dfi_promote_threshold_f0(
        &mut self,
    ) -> PhymstrDfiPromoteThresholdF0W<DenaliCtl83Spec> {
        PhymstrDfiPromoteThresholdF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_83::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_83::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl83Spec;
impl crate::RegisterSpec for DenaliCtl83Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_83::R`](R) reader structure"]
impl crate::Readable for DenaliCtl83Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_83::W`](W) writer structure"]
impl crate::Writable for DenaliCtl83Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_83 to value 0"]
impl crate::Resettable for DenaliCtl83Spec {
