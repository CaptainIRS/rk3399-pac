#[doc = "Register `DENALI_CTL_143` reader"]
pub type R = crate::R<DenaliCtl143Spec>;
#[doc = "Register `DENALI_CTL_143` writer"]
pub type W = crate::W<DenaliCtl143Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr14_data_f1_0(&mut self) -> Mr14DataF1_0W<DenaliCtl143Spec> {
        Mr14DataF1_0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 14 for chip select 0."]
    #[inline(always)]
    #[must_use]
    pub fn mr14_data_f2_0(&mut self) -> Mr14DataF2_0W<DenaliCtl143Spec> {
        Mr14DataF2_0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_143::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_143::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl143Spec;
impl crate::RegisterSpec for DenaliCtl143Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_143::R`](R) reader structure"]
impl crate::Readable for DenaliCtl143Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_143::W`](W) writer structure"]
impl crate::Writable for DenaliCtl143Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_143 to value 0"]
impl crate::Resettable for DenaliCtl143Spec {
