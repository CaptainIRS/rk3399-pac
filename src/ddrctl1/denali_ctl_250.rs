#[doc = "Register `DENALI_CTL_250` reader"]
pub type R = crate::R<DenaliCtl250Spec>;
#[doc = "Register `DENALI_CTL_250` writer"]
pub type W = crate::W<DenaliCtl250Spec>;
...
impl W {
    ...
    pub fn rdlvl_gate_dfi_promote_threshold_f1(
        &mut self,
    ) -> RdlvlGateDfiPromoteThresholdF1W<DenaliCtl250Spec> {
        RdlvlGateDfiPromoteThresholdF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Read leveling normal threshold number of long counts until the normal priority request is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_norm_threshold_f2(&mut self) -> RdlvlNormThresholdF2W<DenaliCtl250Spec> {
        RdlvlNormThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_250::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_250::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl250Spec;
impl crate::RegisterSpec for DenaliCtl250Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_250::R`](R) reader structure"]
impl crate::Readable for DenaliCtl250Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_250::W`](W) writer structure"]
impl crate::Writable for DenaliCtl250Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_250 to value 0"]
impl crate::Resettable for DenaliCtl250Spec {
