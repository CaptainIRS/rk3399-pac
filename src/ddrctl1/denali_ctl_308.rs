#[doc = "Register `DENALI_CTL_308` reader"]
pub type R = crate::R<DenaliCtl308Spec>;
#[doc = "Register `DENALI_CTL_308` writer"]
pub type W = crate::W<DenaliCtl308Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_calvl_cc_f0(&mut self) -> TdfiCalvlCcF0W<DenaliCtl308Spec> {
        TdfiCalvlCcF0W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Defines the DFI tCALVL_CAPTURE timing parameter (in DFI clocks), the minimum cycles between a calibration command and a dfi_calvl_capture pulse."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_calvl_capture_f0(&mut self) -> TdfiCalvlCaptureF0W<DenaliCtl308Spec> {
        TdfiCalvlCaptureF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_308::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_308::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl308Spec;
impl crate::RegisterSpec for DenaliCtl308Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_308::R`](R) reader structure"]
impl crate::Readable for DenaliCtl308Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_308::W`](W) writer structure"]
impl crate::Writable for DenaliCtl308Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_308 to value 0"]
impl crate::Resettable for DenaliCtl308Spec {
