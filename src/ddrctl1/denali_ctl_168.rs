#[doc = "Register `DENALI_CTL_168` reader"]
pub type R = crate::R<DenaliCtl168Spec>;
#[doc = "Register `DENALI_CTL_168` writer"]
pub type W = crate::W<DenaliCtl168Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zq_calstart_timeout_f0(&mut self) -> ZqCalstartTimeoutF0W<DenaliCtl168Spec> {
        ZqCalstartTimeoutF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - ZQ LATCH number of long counts until the timeout is asserted for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn zq_callatch_timeout_f0(&mut self) -> ZqCallatchTimeoutF0W<DenaliCtl168Spec> {
        ZqCallatchTimeoutF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_168::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_168::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl168Spec;
impl crate::RegisterSpec for DenaliCtl168Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_168::R`](R) reader structure"]
impl crate::Readable for DenaliCtl168Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_168::W`](W) writer structure"]
impl crate::Writable for DenaliCtl168Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_168 to value 0"]
impl crate::Resettable for DenaliCtl168Spec {
