#[doc = "Register `PERF_LATENCY_CTRL0` reader"]
pub type R = crate::R<PerfLatencyCtrl0Spec>;
#[doc = "Register `PERF_LATENCY_CTRL0` writer"]
pub type W = crate::W<PerfLatencyCtrl0Spec>;
#[doc = "\n\nValue on reset: 0"]
...
#[doc = "Field `SW_AXI_PERF_WORK_E` reader - "]
...
#[doc = "Field `SW_AXI_PERF_WORK_E` writer - "]
...
#[doc = "Field `SW_AXI_PERF_CLR_E` reader - "]
...
#[doc = "Field `SW_AXI_PERF_CLR_E` writer - "]
pub type SwAxiPerfClrEW<'a, REG> = crate::BitWriter<'a, REG, SwAxiPerfClrE>;
...
pub enum SwAxiPerfFrmType {
    #[doc = "0: clear by software configuration"]
    B0 = 0,
    #[doc = "1: clear by frame end"]
    B1 = 1,
}
...
#[doc = "Field `SW_AXI_PERF_FRM_TYPE` reader - latency mode"]
...
#[doc = "Field `SW_AXI_PERF_FRM_TYPE` writer - latency mode"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sw_axi_perf_work_e(&mut self) -> SwAxiPerfWorkEW<PerfLatencyCtrl0Spec> {
        SwAxiPerfWorkEW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn sw_axi_perf_clr_e(&mut self) -> SwAxiPerfClrEW<PerfLatencyCtrl0Spec> {
        SwAxiPerfClrEW::new(self, 1)
    }
    #[doc = "Bit 2 - latency mode"]
    #[inline(always)]
    #[must_use]
    pub fn sw_axi_perf_frm_type(&mut self) -> SwAxiPerfFrmTypeW<PerfLatencyCtrl0Spec> {
        SwAxiPerfFrmTypeW::new(self, 2)
    }
    #[doc = "Bit 3 - sw_axi_cnt_type"]
    #[inline(always)]
    #[must_use]
    pub fn sw_axi_cnt_type(&mut self) -> SwAxiCntTypeW<PerfLatencyCtrl0Spec> {
        SwAxiCntTypeW::new(self, 3)
    }
    #[doc = "Bits 4:7 - sw_rd_latency_id"]
    #[inline(always)]
    #[must_use]
    pub fn sw_rd_latency_id(&mut self) -> SwRdLatencyIdW<PerfLatencyCtrl0Spec> {
        SwRdLatencyIdW::new(self, 4)
    }
    #[doc = "Bits 8:19 - sw_rd_latency_thr"]
    #[inline(always)]
    #[must_use]
    pub fn sw_rd_latency_thr(&mut self) -> SwRdLatencyThrW<PerfLatencyCtrl0Spec> {
        SwRdLatencyThrW::new(self, 8)
    }
}
#[doc = "Axi performance latency module contrl register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`perf_latency_ctrl0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`perf_latency_ctrl0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PerfLatencyCtrl0Spec;
impl crate::RegisterSpec for PerfLatencyCtrl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`perf_latency_ctrl0::R`](R) reader structure"]
impl crate::Readable for PerfLatencyCtrl0Spec {}
#[doc = "`write(|w| ..)` method takes [`perf_latency_ctrl0::W`](W) writer structure"]
impl crate::Writable for PerfLatencyCtrl0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PERF_LATENCY_CTRL0 to value 0x28"]
impl crate::Resettable for PerfLatencyCtrl0Spec {
