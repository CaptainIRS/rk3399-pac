#[doc = "Register `WIN0_YUV2YUV_R2Y_COE3` reader"]
pub type R = crate::R<Win0Yuv2yuvR2yCoe3Spec>;
#[doc = "Register `WIN0_YUV2YUV_R2Y_COE3` writer"]
pub type W = crate::W<Win0Yuv2yuvR2yCoe3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csc_coe20(&mut self) -> CscCoe20W<Win0Yuv2yuvR2yCoe3Spec> {
        CscCoe20W::new(self, 0)
    }
    #[doc = "Bits 16:31 - coefficient of 3x4 matrix"]
    #[inline(always)]
    #[must_use]
    pub fn csc_coe21(&mut self) -> CscCoe21W<Win0Yuv2yuvR2yCoe3Spec> {
...
pub struct Win0Yuv2yuvR2yCoe3Spec;
impl crate::RegisterSpec for Win0Yuv2yuvR2yCoe3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`win0_yuv2yuv_r2y_coe3::R`](R) reader structure"]
impl crate::Readable for Win0Yuv2yuvR2yCoe3Spec {}
#[doc = "`write(|w| ..)` method takes [`win0_yuv2yuv_r2y_coe3::W`](W) writer structure"]
impl crate::Writable for Win0Yuv2yuvR2yCoe3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WIN0_YUV2YUV_R2Y_COE3 to value 0"]
impl crate::Resettable for Win0Yuv2yuvR2yCoe3Spec {
