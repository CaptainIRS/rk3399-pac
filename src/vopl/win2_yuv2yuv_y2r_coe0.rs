#[doc = "Register `WIN2_YUV2YUV_Y2R_COE0` reader"]
pub type R = crate::R<Win2Yuv2yuvY2rCoe0Spec>;
#[doc = "Register `WIN2_YUV2YUV_Y2R_COE0` writer"]
pub type W = crate::W<Win2Yuv2yuvY2rCoe0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csc_coe00(&mut self) -> CscCoe00W<Win2Yuv2yuvY2rCoe0Spec> {
        CscCoe00W::new(self, 0)
    }
    #[doc = "Bits 16:31 - coefficient of 3x4 matrix"]
    #[inline(always)]
    #[must_use]
    pub fn csc_coe01(&mut self) -> CscCoe01W<Win2Yuv2yuvY2rCoe0Spec> {
...
pub struct Win2Yuv2yuvY2rCoe0Spec;
impl crate::RegisterSpec for Win2Yuv2yuvY2rCoe0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`win2_yuv2yuv_y2r_coe0::R`](R) reader structure"]
impl crate::Readable for Win2Yuv2yuvY2rCoe0Spec {}
#[doc = "`write(|w| ..)` method takes [`win2_yuv2yuv_y2r_coe0::W`](W) writer structure"]
impl crate::Writable for Win2Yuv2yuvY2rCoe0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WIN2_YUV2YUV_Y2R_COE0 to value 0"]
impl crate::Resettable for Win2Yuv2yuvY2rCoe0Spec {
