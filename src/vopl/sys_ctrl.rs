...
#[doc = "Field `VOPL_FIELD_TVE_TIMING_POL` reader - VOPL_field_tve_timing_pol"]
pub type VoplFieldTveTimingPolR = crate::BitReader;
#[doc = "Field `VOPL_FIELD_TVE_TIMING_POL` writer - VOPL_field_tve_timing_pol"]
pub type VoplFieldTveTimingPolW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "VOP DMA stop mode\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VoplDmaStop {
    #[doc = "0: disable"]
    B0 = 0,
    #[doc = "1: enable * If DMA is working, the stop mode would not be active until current bus transfer is finished."]
    B1 = 1,
}
impl From<VoplDmaStop> for bool {
    #[inline(always)]
    fn from(variant: VoplDmaStop) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `VOPL_DMA_STOP` reader - VOP DMA stop mode"]
pub type VoplDmaStopR = crate::BitReader<VoplDmaStop>;
impl VoplDmaStopR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> VoplDmaStop {
        match self.bits {
            false => VoplDmaStop::B0,
            true => VoplDmaStop::B1,
        }
    }
    #[doc = "disable"]
...
#[doc = "Field `VOPL_DMA_STOP` writer - VOP DMA stop mode"]
pub type VoplDmaStopW<'a, REG> = crate::BitWriter<'a, REG, VoplDmaStop>;
impl<'a, REG> VoplDmaStopW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "disable"]
    #[inline(always)]
    pub fn b0(self) -> &'a mut crate::W<REG> {
        self.variant(VoplDmaStop::B0)
    }
    #[doc = "enable * If DMA is working, the stop mode would not be active until current bus transfer is finished."]
    #[inline(always)]
    pub fn b1(self) -> &'a mut crate::W<REG> {
        self.variant(VoplDmaStop::B1)
    }
}
...
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VoplStandbyEn {
    #[doc = "0: disable"]
    B0 = 0,
    #[doc = "1: enable * Black display is recommended before setting standby mode enable."]
    B1 = 1,
}
impl From<VoplStandbyEn> for bool {
    #[inline(always)]
    fn from(variant: VoplStandbyEn) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `VOPL_STANDBY_EN` reader - LCDC standby mode\n\nWriting '1' to turn LCDC into standby mode, All the layer would\n\ndisable and the data transfer from frame buffer memory would stop\n\nat the end of current frame.\n\nThe output would be blank.\n\nWhen writing '0' to this bit, standby mode would disable and the\n\nLCDC go back to work immediately."]
pub type VoplStandbyEnR = crate::BitReader<VoplStandbyEn>;
impl VoplStandbyEnR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> VoplStandbyEn {
        match self.bits {
            false => VoplStandbyEn::B0,
            true => VoplStandbyEn::B1,
        }
    }
    #[doc = "disable"]
    #[inline(always)]
    pub fn is_b0(&self) -> bool {
        *self == VoplStandbyEn::B0
    }
    #[doc = "enable * Black display is recommended before setting standby mode enable."]
    #[inline(always)]
    pub fn is_b1(&self) -> bool {
        *self == VoplStandbyEn::B1
    }
}
#[doc = "Field `VOPL_STANDBY_EN` writer - LCDC standby mode\n\nWriting '1' to turn LCDC into standby mode, All the layer would\n\ndisable and the data transfer from frame buffer memory would stop\n\nat the end of current frame.\n\nThe output would be blank.\n\nWhen writing '0' to this bit, standby mode would disable and the\n\nLCDC go back to work immediately."]
pub type VoplStandbyEnW<'a, REG> = crate::BitWriter<'a, REG, VoplStandbyEn>;
impl<'a, REG> VoplStandbyEnW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "disable"]
    #[inline(always)]
    pub fn b0(self) -> &'a mut crate::W<REG> {
        self.variant(VoplStandbyEn::B0)
    }
    #[doc = "enable * Black display is recommended before setting standby mode enable."]
    #[inline(always)]
    pub fn b1(self) -> &'a mut crate::W<REG> {
        self.variant(VoplStandbyEn::B1)
    }
}
...
#[doc = "Field `VOPL_FIELD_TVE_POL` reader - VOPL_field_tve_pol"]
pub type VoplFieldTvePolR = crate::BitReader;
...
impl R {
    ...
    #[doc = "Bit 20 - VOPL_field_tve_timing_pol"]
    #[inline(always)]
    pub fn vopl_field_tve_timing_pol(&self) -> VoplFieldTveTimingPolR {
        VoplFieldTveTimingPolR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - VOP DMA stop mode"]
    #[inline(always)]
    pub fn vopl_dma_stop(&self) -> VoplDmaStopR {
        VoplDmaStopR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - LCDC standby mode\n\nWriting '1' to turn LCDC into standby mode, All the layer would\n\ndisable and the data transfer from frame buffer memory would stop\n\nat the end of current frame.\n\nThe output would be blank.\n\nWhen writing '0' to this bit, standby mode would disable and the\n\nLCDC go back to work immediately."]
    #[inline(always)]
    pub fn vopl_standby_en(&self) -> VoplStandbyEnR {
        VoplStandbyEnR::new(((self.bits >> 22) & 1) != 0)
    }
    ...
    #[doc = "Bit 30 - VOPL_field_tve_pol"]
    #[inline(always)]
    pub fn vopl_field_tve_pol(&self) -> VoplFieldTvePolR {
        VoplFieldTvePolR::new(((self.bits >> 30) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vopl_field_tve_timing_pol(&mut self) -> VoplFieldTveTimingPolW<SysCtrlSpec> {
        VoplFieldTveTimingPolW::new(self, 20)
    }
    #[doc = "Bit 21 - VOP DMA stop mode"]
    #[inline(always)]
    #[must_use]
    pub fn vopl_dma_stop(&mut self) -> VoplDmaStopW<SysCtrlSpec> {
        VoplDmaStopW::new(self, 21)
    }
    #[doc = "Bit 22 - LCDC standby mode\n\nWriting '1' to turn LCDC into standby mode, All the layer would\n\ndisable and the data transfer from frame buffer memory would stop\n\nat the end of current frame.\n\nThe output would be blank.\n\nWhen writing '0' to this bit, standby mode would disable and the\n\nLCDC go back to work immediately."]
    #[inline(always)]
    #[must_use]
    pub fn vopl_standby_en(&mut self) -> VoplStandbyEnW<SysCtrlSpec> {
        VoplStandbyEnW::new(self, 22)
    }
    #[doc = "Bit 23 - LCDC layer axi-clk auto gating enable"]
    #[inline(always)]
    #[must_use]
