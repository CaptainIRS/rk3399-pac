...
pub enum PwmEn {
    #[doc = "0: disabled"]
    B0 = 0,
    #[doc = "1: enabled. If the PWM is worked the one-shot mode, this bit will be cleared at the end of operation"]
    B1 = 1,
}
...
impl PwmEnR {
    ...
    #[doc = "enabled. If the PWM is worked the one-shot mode, this bit will be cleared at the end of operation"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_en(&mut self) -> PwmEnW<PwmCtrlSpec> {
        PwmEnW::new(self, 0)
    }
    #[doc = "Bits 1:2 - PWM Operation Mode"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_mode(&mut self) -> PwmModeW<PwmCtrlSpec> {
        PwmModeW::new(self, 1)
    }
    #[doc = "Bit 3 - Duty Cycle Output Polarity\n\nThis defines the polarity for duty cycle. PWM starts the output\n\nwaveform with duty cycle."]
    #[inline(always)]
    #[must_use]
    pub fn duty_pol(&mut self) -> DutyPolW<PwmCtrlSpec> {
        DutyPolW::new(self, 3)
    }
    #[doc = "Bit 4 - Inactive State Output Polarity\n\nThis defines the output waveform polarity when PWM channel is in\n\ninactive state. The inactive state means that PWM finishes the\n\ncomplete waveform in one-shot mode or PWM channel is disabled."]
    #[inline(always)]
    #[must_use]
    pub fn inactive_pol(&mut self) -> InactivePolW<PwmCtrlSpec> {
        InactivePolW::new(self, 4)
    }
    #[doc = "Bit 5 - PWM Output mode"]
    #[inline(always)]
    #[must_use]
    pub fn output_mode(&mut self) -> OutputModeW<PwmCtrlSpec> {
        OutputModeW::new(self, 5)
    }
    #[doc = "Bit 8 - Low Power Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lp_en(&mut self) -> LpEnW<PwmCtrlSpec> {
        LpEnW::new(self, 8)
    }
    #[doc = "Bit 9 - Clock Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sel(&mut self) -> ClkSelW<PwmCtrlSpec> {
        ClkSelW::new(self, 9)
    }
    #[doc = "Bits 12:14 - Prescale Factor\n\nThis field defines the prescale factor applied to input clock. The\n\nvalue N means that the input clock is divided by 2^N."]
    #[inline(always)]
    #[must_use]
    pub fn prescale(&mut self) -> PrescaleW<PwmCtrlSpec> {
        PrescaleW::new(self, 12)
    }
    #[doc = "Bits 16:23 - Scale Factor\n\nThis fields defines the scale factor applied to prescaled clock. The\n\nvalue N means the clock is divided by 2*N. If N is 0, it means that\n\nthe clock is divided by 512(2*256)."]
    #[inline(always)]
    #[must_use]
    pub fn scale(&mut self) -> ScaleW<PwmCtrlSpec> {
        ScaleW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Repeat Counter\n\nThis field defines the repeated effective periods of output waveform\n\nin one-shot mode. The value N means N+1 repeated effective\n\nperiods."]
    #[inline(always)]
    #[must_use]
    pub fn rpt(&mut self) -> RptW<PwmCtrlSpec> {
        RptW::new(self, 24)
    }
}
#[doc = "PWM Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets PWM_CTRL to value 0x200a"]
impl crate::Resettable for PwmCtrlSpec {
