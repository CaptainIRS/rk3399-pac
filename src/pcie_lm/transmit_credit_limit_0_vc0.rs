#[doc = "Register `TRANSMIT_CREDIT_LIMIT_0_VC0` reader"]
pub type R = crate::R<TransmitCreditLimit0Vc0Spec>;
...
#[doc = "Transmit Credit Limit Register 0 VC0 Non-Posted payload credit limit received by the core for Link 0 (in units of 4 Dwords).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`transmit_credit_limit_0_vc0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TransmitCreditLimit0Vc0Spec;
impl crate::RegisterSpec for TransmitCreditLimit0Vc0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`transmit_credit_limit_0_vc0::R`](R) reader structure"]
impl crate::Readable for TransmitCreditLimit0Vc0Spec {}
#[doc = "`reset()` method sets TRANSMIT_CREDIT_LIMIT_0_VC0 to value 0"]
impl crate::Resettable for TransmitCreditLimit0Vc0Spec {
