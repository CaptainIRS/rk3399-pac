#[doc = "Register `END_POINT_BUS_AND_DEVICE_NUMBER` reader"]
pub type R = crate::R<EndPointBusAndDeviceNumberSpec>;
...
#[doc = "End Point Bus and Device Number Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`end_point_bus_and_device_number::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EndPointBusAndDeviceNumberSpec;
impl crate::RegisterSpec for EndPointBusAndDeviceNumberSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`end_point_bus_and_device_number::R`](R) reader structure"]
impl crate::Readable for EndPointBusAndDeviceNumberSpec {}
#[doc = "`reset()` method sets END_POINT_BUS_AND_DEVICE_NUMBER to value 0"]
impl crate::Resettable for EndPointBusAndDeviceNumberSpec {
