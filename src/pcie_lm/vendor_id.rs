...
Vendor ID"]
    #[inline(always)]
    #[must_use]
    pub fn vid(&mut self) -> VidW<VendorIdSpec> {
        VidW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Subsystem Vendor ID \\[SVID\\]
Subsystem Vendor ID"]
    #[inline(always)]
    #[must_use]
    pub fn svid(&mut self) -> SvidW<VendorIdSpec> {
        SvidW::new(self, 16)
    }
}
#[doc = "Vendor ID Register Subsystem Vendor ID\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vendor_id::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`vendor_id::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`vendor_id::W`](W) writer structure"]
impl crate::Writable for VendorIdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VENDOR_ID to value 0x17cd_17cd"]
