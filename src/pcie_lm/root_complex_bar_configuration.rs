#[doc = "Register `ROOT_COMPLEX_BAR_CONFIGURATION` reader"]
pub type R = crate::R<RootComplexBarConfigurationSpec>;
#[doc = "Register `ROOT_COMPLEX_BAR_CONFIGURATION` writer"]
pub type W = crate::W<RootComplexBarConfigurationSpec>;
...
This field specifies the aperture of the RC BAR 0. The encodings are: 0000 = 4, 00001 =8B, ..... 01_1111 = 8G, ....10_0100 = 256G."]
    #[inline(always)]
    #[must_use]
    pub fn rcbar0a(&mut self) -> Rcbar0aW<RootComplexBarConfigurationSpec> {
        Rcbar0aW::new(self, 0)
    }
    #[doc = "Bits 6:8 - RC BAR 0 control \\[RCBAR0C\\]
Specifies the configuration of RC BAR0. The various encodings are:"]
    #[inline(always)]
    #[must_use]
    pub fn rcbar0c(&mut self) -> Rcbar0cW<RootComplexBarConfigurationSpec> {
        Rcbar0cW::new(self, 6)
    }
    #[doc = "Bits 9:13 - RC BAR 1 Aperture \\[RCBAR1A\\]
This field specifies the aperture of the RC BAR 1. The encodings are: 0000 = 4, 00001 =8B, ..... 1_1101 = 2G"]
    #[inline(always)]
    #[must_use]
    pub fn rcbar1a(&mut self) -> Rcbar1aW<RootComplexBarConfigurationSpec> {
        Rcbar1aW::new(self, 9)
    }
    #[doc = "Bits 14:16 - RC BAR 1 control \\[RCBAR1C\\]
Specifies the configuration of RC BAR1. The various encodings are: 000: Disabled 001: 32bit IO BAR 010-011: Reserved 100: 32bit memory BAR, non prefetchable 101: 32bit memory BAR, prefetchable 110-111: Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn rcbar1c(&mut self) -> Rcbar1cW<RootComplexBarConfigurationSpec> {
...
Enable for Prefetchable memory base and limit registers in type1 config space"]
    #[inline(always)]
    #[must_use]
    pub fn rcbarpme(&mut self) -> RcbarpmeW<RootComplexBarConfigurationSpec> {
...
Width of Prefetchable Memory Base and Limit registers in type1 config space. 0=32 bits, 1=64bits"]
    #[inline(always)]
    #[must_use]
    pub fn rcbarpms(&mut self) -> RcbarpmsW<RootComplexBarConfigurationSpec> {
...
Enable for IO Base and Limit registers in type1 config space"]
    #[inline(always)]
    #[must_use]
    pub fn rcbarpie(&mut self) -> RcbarpieW<RootComplexBarConfigurationSpec> {
...
Width of IO Base and Limit registers in type1 config space. 0=32 bits, 1=64bits"]
    #[inline(always)]
    #[must_use]
    pub fn rcbarpis(&mut self) -> RcbarpisW<RootComplexBarConfigurationSpec> {
...
This bit must be set to 1 to enable BAR checking in the RC mode. When this bit is set to 0, the core will forward all incoming memory requests to the client logic without checking their address ranges."]
    #[inline(always)]
    #[must_use]
    pub fn rcbce(&mut self) -> RcbceW<RootComplexBarConfigurationSpec> {
        RcbceW::new(self, 31)
    }
}
#[doc = "Root Complex BAR Configuration Register This bit must be set to 1 to enable BAR checking in the RC mode. When this bit is set to 0, the core will forward all incoming memory requests to the client logic without checking their address ranges.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`root_complex_bar_configuration::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`root_complex_bar_configuration::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RootComplexBarConfigurationSpec;
impl crate::RegisterSpec for RootComplexBarConfigurationSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`root_complex_bar_configuration::R`](R) reader structure"]
impl crate::Readable for RootComplexBarConfigurationSpec {}
#[doc = "`write(|w| ..)` method takes [`root_complex_bar_configuration::W`](W) writer structure"]
impl crate::Writable for RootComplexBarConfigurationSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ROOT_COMPLEX_BAR_CONFIGURATION to value 0x0001_2994"]
impl crate::Resettable for RootComplexBarConfigurationSpec {
