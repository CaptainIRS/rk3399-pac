#[doc = "Register `RECEIVE_FTS_COUNT` reader"]
pub type R = crate::R<ReceiveFtsCountSpec>;
...
#[doc = "Receive FTS Count Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`receive_fts_count::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ReceiveFtsCountSpec;
impl crate::RegisterSpec for ReceiveFtsCountSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`receive_fts_count::R`](R) reader structure"]
impl crate::Readable for ReceiveFtsCountSpec {}
#[doc = "`reset()` method sets RECEIVE_FTS_COUNT to value 0"]
impl crate::Resettable for ReceiveFtsCountSpec {
