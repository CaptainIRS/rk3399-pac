#[doc = "Register `LOCAL_INTERRUPT_MASK` reader"]
pub type R = crate::R<LocalInterruptMaskSpec>;
#[doc = "Register `LOCAL_INTERRUPT_MASK` writer"]
pub type W = crate::W<LocalInterruptMaskSpec>;
...
Parity error detected while reading from the PNP Receive FIFO RAM."]
    #[inline(always)]
    #[must_use]
    pub fn prfpe(&mut self) -> PrfpeW<LocalInterruptMaskSpec> {
        PrfpeW::new(self, 0)
    }
    #[doc = "Bit 1 - Completion RX FIFO Parity Error \\[CRFPE\\]
Parity error detected while reading from the Completion Receive FIFO RAM."]
    #[inline(always)]
    #[must_use]
    pub fn crfpe(&mut self) -> CrfpeW<LocalInterruptMaskSpec> {
        CrfpeW::new(self, 1)
    }
    #[doc = "Bit 2 - Replay RAM Parity Error \\[RRPE\\]
Parity error detected while reading from Replay Buffer RAM."]
    #[inline(always)]
    #[must_use]
    pub fn rrpe(&mut self) -> RrpeW<LocalInterruptMaskSpec> {
        RrpeW::new(self, 2)
    }
    #[doc = "Bit 3 - PNP RX FIFO Overflow \\[PRFO\\]
Overflow occurred in the PNP Receive FIFO."]
    #[inline(always)]
    #[must_use]
    pub fn prfo(&mut self) -> PrfoW<LocalInterruptMaskSpec> {
        PrfoW::new(self, 3)
    }
    #[doc = "Bit 4 - Completion RX FIFO Overflow \\[CRFO\\]
Overflow occurred in the Completion Receive FIFO."]
    #[inline(always)]
    #[must_use]
    pub fn crfo(&mut self) -> CrfoW<LocalInterruptMaskSpec> {
        CrfoW::new(self, 4)
    }
    #[doc = "Bit 5 - Replay Timeout \\[RT\\]
Replay timer timed out"]
    #[inline(always)]
    #[must_use]
    pub fn rt(&mut self) -> RtW<LocalInterruptMaskSpec> {
        RtW::new(self, 5)
    }
    #[doc = "Bit 6 - Replay Timer Rollover \\[RTR\\]
Replay timer rolled over after 4 transmissions of the same TLP."]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RtrW<LocalInterruptMaskSpec> {
        RtrW::new(self, 6)
    }
    #[doc = "Bit 7 - Phy Error \\[PE\\]
Phy error detected on receive side."]
    #[inline(always)]
    #[must_use]
    pub fn pe(&mut self) -> PeW<LocalInterruptMaskSpec> {
        PeW::new(self, 7)
    }
    #[doc = "Bit 8 - Malformed TLP Received \\[MTR\\]
Malformed TLP received from the link."]
    #[inline(always)]
    #[must_use]
    pub fn mtr(&mut self) -> MtrW<LocalInterruptMaskSpec> {
        MtrW::new(self, 8)
    }
    #[doc = "Bit 9 - Unexpected Completion Received \\[UCR\\]
Unexpected Completion received from the link."]
    #[inline(always)]
    #[must_use]
    pub fn ucr(&mut self) -> UcrW<LocalInterruptMaskSpec> {
        UcrW::new(self, 9)
    }
    #[doc = "Bit 10 - Flow Control Error \\[FCE\\]
An error was observed in the flow control advertisements from the other side."]
    #[inline(always)]
    #[must_use]
    pub fn fce(&mut self) -> FceW<LocalInterruptMaskSpec> {
        FceW::new(self, 10)
    }
    #[doc = "Bit 11 - Completion Timeout \\[CT\\]
A request timed out waiting for completion."]
    #[inline(always)]
    #[must_use]
    pub fn ct(&mut self) -> CtW<LocalInterruptMaskSpec> {
        CtW::new(self, 11)
    }
    #[doc = "Bit 18 - Unmapped TC \\[UTC\\]
Unmapped TC error"]
    #[inline(always)]
    #[must_use]
    pub fn utc(&mut self) -> UtcW<LocalInterruptMaskSpec> {
        UtcW::new(self, 18)
    }
    #[doc = "Bit 19 - MSI Mask Value Change \\[MMVC\\]
MSI mask register value in the MSI capability register changes value in ANY of the functions in the controller"]
    #[inline(always)]
    #[must_use]
    pub fn mmvc(&mut self) -> MmvcW<LocalInterruptMaskSpec> {
        MmvcW::new(self, 19)
    }
}
#[doc = "Local Interrupt Mask Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`local_interrupt_mask::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`local_interrupt_mask::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LocalInterruptMaskSpec;
impl crate::RegisterSpec for LocalInterruptMaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`local_interrupt_mask::R`](R) reader structure"]
impl crate::Readable for LocalInterruptMaskSpec {}
#[doc = "`write(|w| ..)` method takes [`local_interrupt_mask::W`](W) writer structure"]
impl crate::Writable for LocalInterruptMaskSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LOCAL_INTERRUPT_MASK to value 0x000c_0fff"]
impl crate::Resettable for LocalInterruptMaskSpec {
