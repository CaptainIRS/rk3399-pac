#[doc = "Register `SOFTRST_CON20` reader"]
pub type R = crate::R<SoftrstCon20Spec>;
#[doc = "Register `SOFTRST_CON20` writer"]
pub type W = crate::W<SoftrstCon20Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn presetn_gpio2_req(&mut self) -> PresetnGpio2ReqW<SoftrstCon20Spec> {
        PresetnGpio2ReqW::new(self, 0)
    }
    #[doc = "Bit 1 - presetn_gpio3 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_gpio3_req(&mut self) -> PresetnGpio3ReqW<SoftrstCon20Spec> {
        PresetnGpio3ReqW::new(self, 1)
    }
    #[doc = "Bit 2 - presetn_gpio4 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_gpio4_req(&mut self) -> PresetnGpio4ReqW<SoftrstCon20Spec> {
        PresetnGpio4ReqW::new(self, 2)
    }
    #[doc = "Bit 3 - presetn_grf request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_grf_req(&mut self) -> PresetnGrfReqW<SoftrstCon20Spec> {
        PresetnGrfReqW::new(self, 3)
    }
    #[doc = "Bit 4 - presetn_alive_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_alive_noc_req(&mut self) -> PresetnAliveNocReqW<SoftrstCon20Spec> {
        PresetnAliveNocReqW::new(self, 4)
    }
    #[doc = "Bit 5 - presetn_wdt0 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_wdt0_req(&mut self) -> PresetnWdt0ReqW<SoftrstCon20Spec> {
        PresetnWdt0ReqW::new(self, 5)
    }
    #[doc = "Bit 6 - presetn_wdt1 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_wdt1_req(&mut self) -> PresetnWdt1ReqW<SoftrstCon20Spec> {
        PresetnWdt1ReqW::new(self, 6)
    }
    #[doc = "Bit 7 - presetn_intr_arb request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_intr_arb_req(&mut self) -> PresetnIntrArbReqW<SoftrstCon20Spec> {
        PresetnIntrArbReqW::new(self, 7)
    }
    #[doc = "Bit 8 - presetn_uphy0_dptx request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_uphy0_dptx_req(&mut self) -> PresetnUphy0DptxReqW<SoftrstCon20Spec> {
        PresetnUphy0DptxReqW::new(self, 8)
    }
    #[doc = "Bit 10 - presetn_uphy0_apb request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_uphy0_apb_req(&mut self) -> PresetnUphy0ApbReqW<SoftrstCon20Spec> {
        PresetnUphy0ApbReqW::new(self, 10)
    }
    #[doc = "Bit 12 - presetn_uphy0_tcphy request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_uphy0_tcphy_req(&mut self) -> PresetnUphy0TcphyReqW<SoftrstCon20Spec> {
        PresetnUphy0TcphyReqW::new(self, 12)
    }
    #[doc = "Bit 13 - presetn_uphy1_tcphy request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_uphy1_tcphy_req(&mut self) -> PresetnUphy1TcphyReqW<SoftrstCon20Spec> {
        PresetnUphy1TcphyReqW::new(self, 13)
    }
    #[doc = "Bit 14 - presetn_uphy0_tcpdctrl request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_uphy0_tcpdctrl_req(&mut self) -> PresetnUphy0TcpdctrlReqW<SoftrstCon20Spec> {
        PresetnUphy0TcpdctrlReqW::new(self, 14)
    }
    #[doc = "Bit 15 - presetn_uphy1_tcpdctrl request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_uphy1_tcpdctrl_req(&mut self) -> PresetnUphy1TcpdctrlReqW<SoftrstCon20Spec> {
        PresetnUphy1TcpdctrlReqW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<SoftrstCon20Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal software reset control register20\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`softrst_con20::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`softrst_con20::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SoftrstCon20Spec;
impl crate::RegisterSpec for SoftrstCon20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`softrst_con20::R`](R) reader structure"]
impl crate::Readable for SoftrstCon20Spec {}
#[doc = "`write(|w| ..)` method takes [`softrst_con20::W`](W) writer structure"]
impl crate::Writable for SoftrstCon20Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOFTRST_CON20 to value 0"]
impl crate::Resettable for SoftrstCon20Spec {
