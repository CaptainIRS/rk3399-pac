#[doc = "Register `CLKSEL_CON62` reader"]
pub type R = crate::R<ClkselCon62Spec>;
#[doc = "Register `CLKSEL_CON62` writer"]
pub type W = crate::W<ClkselCon62Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c2_div_con(&mut self) -> ClkI2c2DivConW<ClkselCon62Spec> {
        ClkI2c2DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_i2c2 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c2_pll_sel(&mut self) -> ClkI2c2PllSelW<ClkselCon62Spec> {
        ClkI2c2PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:14 - i2c6 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c6_div_con(&mut self) -> ClkI2c6DivConW<ClkselCon62Spec> {
        ClkI2c6DivConW::new(self, 8)
    }
    #[doc = "Bit 15 - clk_i2c6 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c6_pll_sel(&mut self) -> ClkI2c6PllSelW<ClkselCon62Spec> {
        ClkI2c6PllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon62Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register62\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con62::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con62::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon62Spec;
impl crate::RegisterSpec for ClkselCon62Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con62::R`](R) reader structure"]
impl crate::Readable for ClkselCon62Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con62::W`](W) writer structure"]
impl crate::Writable for ClkselCon62Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON62 to value 0x0303"]
impl crate::Resettable for ClkselCon62Spec {
