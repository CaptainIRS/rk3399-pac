...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_core_l_lpll_src_en(&mut self) -> ClkCoreLLpllSrcEnW<ClkgateCon0Spec> {
        ClkCoreLLpllSrcEnW::new(self, 0)
    }
    #[doc = "Bit 1 - clk_core_l_bpll clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_core_l_bpll_src_en(&mut self) -> ClkCoreLBpllSrcEnW<ClkgateCon0Spec> {
        ClkCoreLBpllSrcEnW::new(self, 1)
    }
    #[doc = "Bit 2 - clk_core_l_dpll clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_core_l_dpll_src_en(&mut self) -> ClkCoreLDpllSrcEnW<ClkgateCon0Spec> {
        ClkCoreLDpllSrcEnW::new(self, 2)
    }
    #[doc = "Bit 3 - clk_core_l_gpll clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_core_l_gpll_src_en(&mut self) -> ClkCoreLGpllSrcEnW<ClkgateCon0Spec> {
        ClkCoreLGpllSrcEnW::new(self, 3)
    }
    #[doc = "Bit 4 - aclkm_core_l clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclkm_core_l_en(&mut self) -> AclkmCoreLEnW<ClkgateCon0Spec> {
        AclkmCoreLEnW::new(self, 4)
    }
    #[doc = "Bit 5 - atclk_core_l clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn atclk_core_l_en(&mut self) -> AtclkCoreLEnW<ClkgateCon0Spec> {
        AtclkCoreLEnW::new(self, 5)
    }
    #[doc = "Bit 6 - pclk_coredbg_l clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_coredbg_l_en(&mut self) -> PclkCoredbgLEnW<ClkgateCon0Spec> {
        PclkCoredbgLEnW::new(self, 6)
    }
    #[doc = "Bit 7 - clk_pvtm_core_l clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_pvtm_core_l_en(&mut self) -> ClkPvtmCoreLEnW<ClkgateCon0Spec> {
