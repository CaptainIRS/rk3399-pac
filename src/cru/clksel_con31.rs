#[doc = "Register `CLKSEL_CON31` reader"]
pub type R = crate::R<ClkselCon31Spec>;
#[doc = "Register `CLKSEL_CON31` writer"]
pub type W = crate::W<ClkselCon31Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_i2s_ch_sel(&mut self) -> ClkI2sChSelW<ClkselCon31Spec> {
        ClkI2sChSelW::new(self, 0)
    }
    #[doc = "Bit 2 - clk_i2sout clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2sout_sel(&mut self) -> ClkI2soutSelW<ClkselCon31Spec> {
        ClkI2soutSelW::new(self, 2)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon31Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register31\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con31::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con31::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon31Spec;
impl crate::RegisterSpec for ClkselCon31Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con31::R`](R) reader structure"]
impl crate::Readable for ClkselCon31Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con31::W`](W) writer structure"]
impl crate::Writable for ClkselCon31Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON31 to value 0"]
impl crate::Resettable for ClkselCon31Spec {
