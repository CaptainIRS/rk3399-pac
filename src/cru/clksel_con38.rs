#[doc = "Register `CLKSEL_CON38` reader"]
pub type R = crate::R<ClkselCon38Spec>;
#[doc = "Register `CLKSEL_CON38` writer"]
pub type W = crate::W<ClkselCon38Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_testout1_div_con(&mut self) -> ClkTestout1DivConW<ClkselCon38Spec> {
        ClkTestout1DivConW::new(self, 0)
    }
    #[doc = "Bit 5 - clk_testout1 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_testout1_clk_sel(&mut self) -> ClkTestout1ClkSelW<ClkselCon38Spec> {
        ClkTestout1ClkSelW::new(self, 5)
    }
    #[doc = "Bits 6:7 - clk_testout1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_testout1_pll_sel(&mut self) -> ClkTestout1PllSelW<ClkselCon38Spec> {
        ClkTestout1PllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - clk_testout2 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_testout2_div_con(&mut self) -> ClkTestout2DivConW<ClkselCon38Spec> {
        ClkTestout2DivConW::new(self, 8)
    }
    #[doc = "Bit 13 - clk_testout2 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_testout2_clk_sel(&mut self) -> ClkTestout2ClkSelW<ClkselCon38Spec> {
        ClkTestout2ClkSelW::new(self, 13)
    }
    #[doc = "Bits 14:15 - clk_testout2 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_testout2_pll_sel(&mut self) -> ClkTestout2PllSelW<ClkselCon38Spec> {
        ClkTestout2PllSelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon38Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register38\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con38::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con38::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon38Spec;
impl crate::RegisterSpec for ClkselCon38Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con38::R`](R) reader structure"]
impl crate::Readable for ClkselCon38Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con38::W`](W) writer structure"]
impl crate::Writable for ClkselCon38Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON38 to value 0x3f3f"]
impl crate::Resettable for ClkselCon38Spec {
