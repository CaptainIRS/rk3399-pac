#[doc = "Register `CRU_NPLL_CON1` reader"]
pub type R = crate::R<CruNpllCon1Spec>;
#[doc = "Register `CRU_NPLL_CON1` writer"]
pub type W = crate::W<CruNpllCon1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn refdiv(&mut self) -> RefdivW<CruNpllCon1Spec> {
        RefdivW::new(self, 0)
    }
    #[doc = "Bits 8:10 - First Post Divide Value (1-7)"]
    #[inline(always)]
    #[must_use]
    pub fn postdiv1(&mut self) -> Postdiv1W<CruNpllCon1Spec> {
        Postdiv1W::new(self, 8)
    }
    #[doc = "Bits 12:14 - Second Post Divide Value (1-7)"]
    #[inline(always)]
    #[must_use]
    pub fn postdiv2(&mut self) -> Postdiv2W<CruNpllCon1Spec> {
        Postdiv2W::new(self, 12)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruNpllCon1Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "NPLL configuration register1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_npll_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_npll_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruNpllCon1Spec;
impl crate::RegisterSpec for CruNpllCon1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_npll_con1::R`](R) reader structure"]
impl crate::Readable for CruNpllCon1Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_npll_con1::W`](W) writer structure"]
impl crate::Writable for CruNpllCon1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_NPLL_CON1 to value 0x1203"]
impl crate::Resettable for CruNpllCon1Spec {
