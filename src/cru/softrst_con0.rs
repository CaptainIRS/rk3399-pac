...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_l_srstn_req(&mut self) -> Core0LSrstnReqW<SoftrstCon0Spec> {
        Core0LSrstnReqW::new(self, 0)
    }
    #[doc = "Bit 1 - core0_b_srstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn core0_b_srstn_req(&mut self) -> Core0BSrstnReqW<SoftrstCon0Spec> {
        Core0BSrstnReqW::new(self, 1)
    }
    #[doc = "Bit 2 - corepo0_l_srstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn corepo0_l_srstn_req(&mut self) -> Corepo0LSrstnReqW<SoftrstCon0Spec> {
        Corepo0LSrstnReqW::new(self, 2)
    }
    #[doc = "Bit 3 - corepo0_b_srstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn corepo0_b_srstn_req(&mut self) -> Corepo0BSrstnReqW<SoftrstCon0Spec> {
        Corepo0BSrstnReqW::new(self, 3)
    }
    #[doc = "Bit 4 - l2_l_srstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn l2_l_srstn_req(&mut self) -> L2LSrstnReqW<SoftrstCon0Spec> {
        L2LSrstnReqW::new(self, 4)
    }
    #[doc = "Bit 5 - l2_b_srstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn l2_b_srstn_req(&mut self) -> L2BSrstnReqW<SoftrstCon0Spec> {
        L2BSrstnReqW::new(self, 5)
    }
    #[doc = "Bit 6 - adb_l_srstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn adb_l_srstn_req(&mut self) -> AdbLSrstnReqW<SoftrstCon0Spec> {
        AdbLSrstnReqW::new(self, 6)
    }
    #[doc = "Bit 7 - adb_b_srstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn adb_b_srstn_req(&mut self) -> AdbBSrstnReqW<SoftrstCon0Spec> {
        AdbBSrstnReqW::new(self, 7)
    }
    #[doc = "Bit 8 - aresetn_cci request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_cci_req(&mut self) -> AresetnCciReqW<SoftrstCon0Spec> {
        AresetnCciReqW::new(self, 8)
    }
    #[doc = "Bit 9 - aresetn_ccim0_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_ccim0_noc_req(&mut self) -> AresetnCcim0NocReqW<SoftrstCon0Spec> {
        AresetnCcim0NocReqW::new(self, 9)
    }
    #[doc = "Bit 10 - aresetn_ccim1_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_ccim1_noc_req(&mut self) -> AresetnCcim1NocReqW<SoftrstCon0Spec> {
        AresetnCcim1NocReqW::new(self, 10)
    }
    #[doc = "Bit 11 - resetn_dbg_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_dbg_noc_req(&mut self) -> ResetnDbgNocReqW<SoftrstCon0Spec> {
...
#[doc = "`reset()` method sets SOFTRST_CON0 to value 0"]
