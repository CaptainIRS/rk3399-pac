...
#[doc = "Field `HCLK_VOP0_NOC_EN` reader - hclk_vop0_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type HclkVop0NocEnR = crate::BitReader;
#[doc = "Field `HCLK_VOP0_NOC_EN` writer - hclk_vop0_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type HclkVop0NocEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ACLK_VOP0_NOC_EN` reader - aclk_vop0_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type AclkVop0NocEnR = crate::BitReader;
#[doc = "Field `ACLK_VOP0_NOC_EN` writer - aclk_vop0_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type AclkVop0NocEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HCLK_VOP0_EN` reader - hclk_vop0 clock disable bit When HIGH, disable clock"]
pub type HclkVop0EnR = crate::BitReader;
#[doc = "Field `HCLK_VOP0_EN` writer - hclk_vop0 clock disable bit When HIGH, disable clock"]
pub type HclkVop0EnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ACLK_VOP0_EN` reader - aclk_vop0 clock disable bit When HIGH, disable clock"]
pub type AclkVop0EnR = crate::BitReader;
#[doc = "Field `ACLK_VOP0_EN` writer - aclk_vop0 clock disable bit When HIGH, disable clock"]
pub type AclkVop0EnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HCLK_VOPB_NOC_EN` reader - hclk_vopb_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type HclkVopbNocEnR = crate::BitReader;
#[doc = "Field `HCLK_VOPB_NOC_EN` writer - hclk_vopb_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type HclkVopbNocEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ACLK_VOPB_NOC_EN` reader - aclk_vopb_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type AclkVopbNocEnR = crate::BitReader;
#[doc = "Field `ACLK_VOPB_NOC_EN` writer - aclk_vopb_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type AclkVopbNocEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HCLK_VOPB_EN` reader - hclk_vopb clock disable bit When HIGH, disable clock"]
pub type HclkVopbEnR = crate::BitReader;
#[doc = "Field `HCLK_VOPB_EN` writer - hclk_vopb clock disable bit When HIGH, disable clock"]
pub type HclkVopbEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ACLK_VOPB_EN` reader - aclk_vopb clock disable bit When HIGH, disable clock"]
pub type AclkVopbEnR = crate::BitReader;
#[doc = "Field `ACLK_VOPB_EN` writer - aclk_vopb clock disable bit When HIGH, disable clock"]
pub type AclkVopbEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `WRITE_MASK` writer - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
pub type WriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bit 0 - hclk_vop0_noc clock disable bit When HIGH, disable clock Suggest always on"]
    #[inline(always)]
    pub fn hclk_vop0_noc_en(&self) -> HclkVop0NocEnR {
        HclkVop0NocEnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - aclk_vop0_noc clock disable bit When HIGH, disable clock Suggest always on"]
    #[inline(always)]
    pub fn aclk_vop0_noc_en(&self) -> AclkVop0NocEnR {
        AclkVop0NocEnR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - hclk_vop0 clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn hclk_vop0_en(&self) -> HclkVop0EnR {
        HclkVop0EnR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - aclk_vop0 clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn aclk_vop0_en(&self) -> AclkVop0EnR {
        AclkVop0EnR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - hclk_vopb_noc clock disable bit When HIGH, disable clock Suggest always on"]
    #[inline(always)]
    pub fn hclk_vopb_noc_en(&self) -> HclkVopbNocEnR {
        HclkVopbNocEnR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - aclk_vopb_noc clock disable bit When HIGH, disable clock Suggest always on"]
    #[inline(always)]
    pub fn aclk_vopb_noc_en(&self) -> AclkVopbNocEnR {
        AclkVopbNocEnR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - hclk_vopb clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn hclk_vopb_en(&self) -> HclkVopbEnR {
        HclkVopbEnR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - aclk_vopb clock disable bit When HIGH, disable clock"]
    #[inline(always)]
