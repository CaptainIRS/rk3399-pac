#[doc = "Register `CRU_CLKSEL_CON41` reader"]
pub type R = crate::R<CruClkselCon41Spec>;
#[doc = "Register `CRU_CLKSEL_CON41` writer"]
pub type W = crate::W<CruClkselCon41Spec>;
#[doc = "Field `CLK_USB3_OTG1_SUSPEND_DIV_CON` reader - clk_usb3_otg1_suspend divider control register clk=clk_src/(div_con+1)"]
pub type ClkUsb3Otg1SuspendDivConR = crate::FieldReader<u16>;
#[doc = "Field `CLK_USB3_OTG1_SUSPEND_DIV_CON` writer - clk_usb3_otg1_suspend divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:9 - clk_usb3_otg1_suspend divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_usb3_otg1_suspend_div_con(
        &mut self,
    ) -> ClkUsb3Otg1SuspendDivConW<CruClkselCon41Spec> {
        ClkUsb3Otg1SuspendDivConW::new(self, 0)
    }
    #[doc = "Bit 15 - clk_usb3_otg1_suspend_src clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_usb3_otg1_suspend_src_sel(
        &mut self,
    ) -> ClkUsb3Otg1SuspendSrcSelW<CruClkselCon41Spec> {
        ClkUsb3Otg1SuspendSrcSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon41Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register41\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con41::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con41::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon41Spec;
impl crate::RegisterSpec for CruClkselCon41Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con41::R`](R) reader structure"]
impl crate::Readable for CruClkselCon41Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con41::W`](W) writer structure"]
impl crate::Writable for CruClkselCon41Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON41 to value 0"]
impl crate::Resettable for CruClkselCon41Spec {
