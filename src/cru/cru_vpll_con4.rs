#[doc = "Register `CRU_VPLL_CON4` reader"]
pub type R = crate::R<CruVpllCon4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssmod_bp(&mut self) -> SsmodBpW<CruVpllCon4Spec> {
        SsmodBpW::new(self, 0)
    }
    #[doc = "Bit 1 - Bypass SSMOD by module"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_disable_sscg(&mut self) -> SsmodDisableSscgW<CruVpllCon4Spec> {
        SsmodDisableSscgW::new(self, 1)
    }
    #[doc = "Bit 2 - Reset modulator state"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_reset(&mut self) -> SsmodResetW<CruVpllCon4Spec> {
...
#[doc = "VPLL configuration register4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_vpll_con4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_vpll_con4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruVpllCon4Spec;
impl crate::RegisterSpec for CruVpllCon4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_vpll_con4::R`](R) reader structure"]
impl crate::Readable for CruVpllCon4Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_vpll_con4::W`](W) writer structure"]
impl crate::Writable for CruVpllCon4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_VPLL_CON4 to value 0x07"]
impl crate::Resettable for CruVpllCon4Spec {
