#[doc = "Register `CLKGATE_CON29` reader"]
pub type R = crate::R<ClkgateCon29Spec>;
#[doc = "Register `CLKGATE_CON29` writer"]
pub type W = crate::W<ClkgateCon29Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_vio_noc_en(&mut self) -> AclkVioNocEnW<ClkgateCon29Spec> {
        AclkVioNocEnW::new(self, 0)
    }
    #[doc = "Bit 1 - pclk_mipi_dsi0 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_mipi_dsi0_en(&mut self) -> PclkMipiDsi0EnW<ClkgateCon29Spec> {
        PclkMipiDsi0EnW::new(self, 1)
    }
    #[doc = "Bit 2 - pclk_mipi_dsi1 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_mipi_dsi1_en(&mut self) -> PclkMipiDsi1EnW<ClkgateCon29Spec> {
        PclkMipiDsi1EnW::new(self, 2)
    }
    #[doc = "Bit 3 - pclk_hdcpnoc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_hdcpnoc_en(&mut self) -> PclkHdcpnocEnW<ClkgateCon29Spec> {
        PclkHdcpnocEnW::new(self, 3)
    }
    #[doc = "Bit 4 - aclk_hdcpnoc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_hdcpnoc_en(&mut self) -> AclkHdcpnocEnW<ClkgateCon29Spec> {
        AclkHdcpnocEnW::new(self, 4)
    }
    #[doc = "Bit 5 - hclk_hdcpnoc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_hdcpnoc_en(&mut self) -> HclkHdcpnocEnW<ClkgateCon29Spec> {
        HclkHdcpnocEnW::new(self, 5)
    }
    #[doc = "Bit 6 - pclk_hdmi_ctrl clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_hdmi_ctrl_en(&mut self) -> PclkHdmiCtrlEnW<ClkgateCon29Spec> {
        PclkHdmiCtrlEnW::new(self, 6)
    }
    #[doc = "Bit 7 - pclk_dp_ctrl clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_dp_ctrl_en(&mut self) -> PclkDpCtrlEnW<ClkgateCon29Spec> {
        PclkDpCtrlEnW::new(self, 7)
    }
    #[doc = "Bit 8 - pclk_hdcp22 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_hdcp22_en(&mut self) -> PclkHdcp22EnW<ClkgateCon29Spec> {
        PclkHdcp22EnW::new(self, 8)
    }
    #[doc = "Bit 9 - hclk_hdcp22 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_hdcp22_en(&mut self) -> HclkHdcp22EnW<ClkgateCon29Spec> {
        HclkHdcp22EnW::new(self, 9)
    }
    #[doc = "Bit 10 - aclk_hdcp22 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_hdcp22_en(&mut self) -> AclkHdcp22EnW<ClkgateCon29Spec> {
        AclkHdcp22EnW::new(self, 10)
    }
    #[doc = "Bit 11 - pclk_gasket clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_gasket_en(&mut self) -> PclkGasketEnW<ClkgateCon29Spec> {
        PclkGasketEnW::new(self, 11)
    }
    #[doc = "Bit 12 - pclk_vio_grf clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_vio_grf_en(&mut self) -> PclkVioGrfEnW<ClkgateCon29Spec> {
        PclkVioGrfEnW::new(self, 12)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkgateCon29Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock gating register29\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clkgate_con29::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clkgate_con29::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkgateCon29Spec;
impl crate::RegisterSpec for ClkgateCon29Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clkgate_con29::R`](R) reader structure"]
impl crate::Readable for ClkgateCon29Spec {}
#[doc = "`write(|w| ..)` method takes [`clkgate_con29::W`](W) writer structure"]
impl crate::Writable for ClkgateCon29Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKGATE_CON29 to value 0"]
impl crate::Resettable for ClkgateCon29Spec {
