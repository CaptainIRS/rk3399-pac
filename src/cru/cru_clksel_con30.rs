#[doc = "Register `CRU_CLKSEL_CON30` reader"]
pub type R = crate::R<CruClkselCon30Spec>;
#[doc = "Register `CRU_CLKSEL_CON30` writer"]
pub type W = crate::W<CruClkselCon30Spec>;
#[doc = "Field `CLK_I2S2_DIV_CON` reader - clk_i2s2 divider control register clk=clk_src/(div_con+1)"]
pub type ClkI2s2DivConR = crate::FieldReader;
#[doc = "Field `CLK_I2S2_DIV_CON` writer - clk_i2s2 divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:6 - clk_i2s2 divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_i2s2_div_con(&mut self) -> ClkI2s2DivConW<CruClkselCon30Spec> {
        ClkI2s2DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_i2s2 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2s2_pll_sel(&mut self) -> ClkI2s2PllSelW<CruClkselCon30Spec> {
        ClkI2s2PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:9 - clk_i2s2 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2s2_sel(&mut self) -> ClkI2s2SelW<CruClkselCon30Spec> {
        ClkI2s2SelW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon30Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register30\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con30::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con30::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon30Spec;
impl crate::RegisterSpec for CruClkselCon30Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con30::R`](R) reader structure"]
impl crate::Readable for CruClkselCon30Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con30::W`](W) writer structure"]
impl crate::Writable for CruClkselCon30Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON30 to value 0x0300"]
impl crate::Resettable for CruClkselCon30Spec {
