#[doc = "Register `CLKSEL_CON61` reader"]
pub type R = crate::R<ClkselCon61Spec>;
#[doc = "Register `CLKSEL_CON61` writer"]
pub type W = crate::W<ClkselCon61Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c1_div_con(&mut self) -> ClkI2c1DivConW<ClkselCon61Spec> {
        ClkI2c1DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_i2c1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c1_pll_sel(&mut self) -> ClkI2c1PllSelW<ClkselCon61Spec> {
        ClkI2c1PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:14 - i2c5 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c5_div_con(&mut self) -> ClkI2c5DivConW<ClkselCon61Spec> {
        ClkI2c5DivConW::new(self, 8)
    }
    #[doc = "Bit 15 - clk_i2c5 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c5_pll_sel(&mut self) -> ClkI2c5PllSelW<ClkselCon61Spec> {
        ClkI2c5PllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon61Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register61\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con61::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con61::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon61Spec;
impl crate::RegisterSpec for ClkselCon61Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con61::R`](R) reader structure"]
impl crate::Readable for ClkselCon61Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con61::W`](W) writer structure"]
impl crate::Writable for ClkselCon61Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON61 to value 0x0303"]
impl crate::Resettable for ClkselCon61Spec {
