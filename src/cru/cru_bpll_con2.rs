#[doc = "Register `CRU_BPLL_CON2` reader"]
...
pub struct CruBpllCon2Spec;
impl crate::RegisterSpec for CruBpllCon2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_bpll_con2::R`](R) reader structure"]
impl crate::Readable for CruBpllCon2Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_bpll_con2::W`](W) writer structure"]
impl crate::Writable for CruBpllCon2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_BPLL_CON2 to value 0x031f"]
impl crate::Resettable for CruBpllCon2Spec {
