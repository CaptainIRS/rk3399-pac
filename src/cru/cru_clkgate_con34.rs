...
#[doc = "Field `HCLK_I2S0_EN` reader - hclk_i2s0 clock disable bit When HIGH, disable clock"]
pub type HclkI2s0EnR = crate::BitReader;
#[doc = "Field `HCLK_I2S0_EN` writer - hclk_i2s0 clock disable bit When HIGH, disable clock"]
pub type HclkI2s0EnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HCLK_I2S1_EN` reader - hclk_i2s1 clock disable bit When HIGH, disable clock"]
pub type HclkI2s1EnR = crate::BitReader;
#[doc = "Field `HCLK_I2S1_EN` writer - hclk_i2s1 clock disable bit When HIGH, disable clock"]
pub type HclkI2s1EnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HCLK_I2S2_EN` reader - hclk_i2s2 clock disable bit When HIGH, disable clock"]
pub type HclkI2s2EnR = crate::BitReader;
#[doc = "Field `HCLK_I2S2_EN` writer - hclk_i2s2 clock disable bit When HIGH, disable clock"]
pub type HclkI2s2EnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HCLK_SPDIF_EN` reader - hclk_spdif clock disable bit When HIGH, disable clock"]
pub type HclkSpdifEnR = crate::BitReader;
#[doc = "Field `HCLK_SPDIF_EN` writer - hclk_spdif clock disable bit When HIGH, disable clock"]
pub type HclkSpdifEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HCLK_SDIO_EN` reader - hclk_sdio clock disable bit When HIGH, disable clock"]
pub type HclkSdioEnR = crate::BitReader;
#[doc = "Field `HCLK_SDIO_EN` writer - hclk_sdio clock disable bit When HIGH, disable clock"]
pub type HclkSdioEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PCLK_SPI5_EN` reader - pclk_spi5 clock disable bit When HIGH, disable clock"]
pub type PclkSpi5EnR = crate::BitReader;
#[doc = "Field `PCLK_SPI5_EN` writer - pclk_spi5 clock disable bit When HIGH, disable clock"]
pub type PclkSpi5EnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HCLK_SDIOAUDIO_NOC_EN` reader - hclk_sdioaudio_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type HclkSdioaudioNocEnR = crate::BitReader;
#[doc = "Field `HCLK_SDIOAUDIO_NOC_EN` writer - hclk_sdioaudio_noc clock disable bit When HIGH, disable clock Suggest always on"]
pub type HclkSdioaudioNocEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `WRITE_MASK` writer - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
pub type WriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bit 0 - hclk_i2s0 clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn hclk_i2s0_en(&self) -> HclkI2s0EnR {
        HclkI2s0EnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - hclk_i2s1 clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn hclk_i2s1_en(&self) -> HclkI2s1EnR {
        HclkI2s1EnR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - hclk_i2s2 clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn hclk_i2s2_en(&self) -> HclkI2s2EnR {
        HclkI2s2EnR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - hclk_spdif clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn hclk_spdif_en(&self) -> HclkSpdifEnR {
        HclkSpdifEnR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - hclk_sdio clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn hclk_sdio_en(&self) -> HclkSdioEnR {
        HclkSdioEnR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - pclk_spi5 clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn pclk_spi5_en(&self) -> PclkSpi5EnR {
        PclkSpi5EnR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - hclk_sdioaudio_noc clock disable bit When HIGH, disable clock Suggest always on"]
    #[inline(always)]
