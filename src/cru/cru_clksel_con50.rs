#[doc = "Register `CRU_CLKSEL_CON50` reader"]
pub type R = crate::R<CruClkselCon50Spec>;
#[doc = "Register `CRU_CLKSEL_CON50` writer"]
pub type W = crate::W<CruClkselCon50Spec>;
#[doc = "Field `DCLK_VOP1_DIV_CON` reader - vop1 divider control register clk=clk_src/(div_con+1)"]
pub type DclkVop1DivConR = crate::FieldReader;
#[doc = "Field `DCLK_VOP1_DIV_CON` writer - vop1 divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:7 - vop1 divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dclk_vop1_div_con(&mut self) -> DclkVop1DivConW<CruClkselCon50Spec> {
        DclkVop1DivConW::new(self, 0)
    }
    #[doc = "Bits 8:9 - dclk_vop1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn dclk_vop1_pll_sel(&mut self) -> DclkVop1PllSelW<CruClkselCon50Spec> {
        DclkVop1PllSelW::new(self, 8)
    }
    #[doc = "Bit 11 - dclk_vop1 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn dclk_vop1_dclk_sel(&mut self) -> DclkVop1DclkSelW<CruClkselCon50Spec> {
        DclkVop1DclkSelW::new(self, 11)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon50Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register50\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con50::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con50::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon50Spec;
impl crate::RegisterSpec for CruClkselCon50Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con50::R`](R) reader structure"]
impl crate::Readable for CruClkselCon50Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con50::W`](W) writer structure"]
impl crate::Writable for CruClkselCon50Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON50 to value 0x03"]
impl crate::Resettable for CruClkselCon50Spec {
