#[doc = "Register `CLKSEL_CON19` reader"]
pub type R = crate::R<ClkselCon19Spec>;
#[doc = "Register `CLKSEL_CON19` writer"]
pub type W = crate::W<ClkselCon19Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_hsicphy_pll_sel(&mut self) -> ClkHsicphyPllSelW<ClkselCon19Spec> {
        ClkHsicphyPllSelW::new(self, 0)
    }
    #[doc = "Bit 4 - clk_rmii_src clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_rmii_src_sel(&mut self) -> ClkRmiiSrcSelW<ClkselCon19Spec> {
        ClkRmiiSrcSelW::new(self, 4)
    }
    #[doc = "Bits 8:10 - pclk_gmac divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_gmac_div_con(&mut self) -> PclkGmacDivConW<ClkselCon19Spec> {
        PclkGmacDivConW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon19Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register19\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con19::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con19::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon19Spec;
impl crate::RegisterSpec for ClkselCon19Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con19::R`](R) reader structure"]
impl crate::Readable for ClkselCon19Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con19::W`](W) writer structure"]
impl crate::Writable for ClkselCon19Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON19 to value 0x0100"]
impl crate::Resettable for ClkselCon19Spec {
