#[doc = "Register `CRU_CLKSEL_CON40` reader"]
...
impl W {
    ...
    pub fn clk_usb3_otg0_suspend_div_con(
        &mut self,
    ) -> ClkUsb3Otg0SuspendDivConW<CruClkselCon40Spec> {
        ClkUsb3Otg0SuspendDivConW::new(self, 0)
    }
    #[doc = "Bit 15 - clk_usb3_otg0_suspend_src clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_usb3_otg0_suspend_src_sel(
        &mut self,
...
#[doc = "Internal clock select and divide register40\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con40::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con40::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon40Spec;
impl crate::RegisterSpec for CruClkselCon40Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con40::R`](R) reader structure"]
impl crate::Readable for CruClkselCon40Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con40::W`](W) writer structure"]
impl crate::Writable for CruClkselCon40Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON40 to value 0"]
impl crate::Resettable for CruClkselCon40Spec {
