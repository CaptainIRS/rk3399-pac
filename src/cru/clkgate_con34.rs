#[doc = "Register `CLKGATE_CON34` reader"]
pub type R = crate::R<ClkgateCon34Spec>;
#[doc = "Register `CLKGATE_CON34` writer"]
pub type W = crate::W<ClkgateCon34Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hclk_i2s0_en(&mut self) -> HclkI2s0EnW<ClkgateCon34Spec> {
        HclkI2s0EnW::new(self, 0)
    }
    #[doc = "Bit 1 - hclk_i2s1 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_i2s1_en(&mut self) -> HclkI2s1EnW<ClkgateCon34Spec> {
        HclkI2s1EnW::new(self, 1)
    }
    #[doc = "Bit 2 - hclk_i2s2 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_i2s2_en(&mut self) -> HclkI2s2EnW<ClkgateCon34Spec> {
        HclkI2s2EnW::new(self, 2)
    }
    #[doc = "Bit 3 - hclk_spdif clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_spdif_en(&mut self) -> HclkSpdifEnW<ClkgateCon34Spec> {
        HclkSpdifEnW::new(self, 3)
    }
    #[doc = "Bit 4 - hclk_sdio clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_sdio_en(&mut self) -> HclkSdioEnW<ClkgateCon34Spec> {
        HclkSdioEnW::new(self, 4)
    }
    #[doc = "Bit 5 - pclk_spi5 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_spi5_en(&mut self) -> PclkSpi5EnW<ClkgateCon34Spec> {
        PclkSpi5EnW::new(self, 5)
    }
    #[doc = "Bit 6 - hclk_sdioaudio_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_sdioaudio_noc_en(&mut self) -> HclkSdioaudioNocEnW<ClkgateCon34Spec> {
        HclkSdioaudioNocEnW::new(self, 6)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkgateCon34Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock gating register34\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clkgate_con34::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clkgate_con34::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkgateCon34Spec;
impl crate::RegisterSpec for ClkgateCon34Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clkgate_con34::R`](R) reader structure"]
impl crate::Readable for ClkgateCon34Spec {}
#[doc = "`write(|w| ..)` method takes [`clkgate_con34::W`](W) writer structure"]
impl crate::Writable for ClkgateCon34Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKGATE_CON34 to value 0"]
impl crate::Resettable for ClkgateCon34Spec {
