#[doc = "Register `LPLL_CON2` reader"]
pub type R = crate::R<LpllCon2Spec>;
#[doc = "Register `LPLL_CON2` writer"]
pub type W = crate::W<LpllCon2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fracdiv(&mut self) -> FracdivW<LpllCon2Spec> {
        FracdivW::new(self, 0)
    }
}
#[doc = "LPLL configuration register2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpll_con2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpll_con2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LpllCon2Spec;
impl crate::RegisterSpec for LpllCon2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpll_con2::R`](R) reader structure"]
impl crate::Readable for LpllCon2Spec {}
#[doc = "`write(|w| ..)` method takes [`lpll_con2::W`](W) writer structure"]
impl crate::Writable for LpllCon2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPLL_CON2 to value 0x031f"]
impl crate::Resettable for LpllCon2Spec {
