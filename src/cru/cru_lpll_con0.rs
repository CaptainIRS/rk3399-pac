#[doc = "Register `CRU_LPLL_CON0` reader"]
...
#[doc = "LPLL configuration register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_lpll_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_lpll_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruLpllCon0Spec;
impl crate::RegisterSpec for CruLpllCon0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_lpll_con0::R`](R) reader structure"]
impl crate::Readable for CruLpllCon0Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_lpll_con0::W`](W) writer structure"]
impl crate::Writable for CruLpllCon0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_LPLL_CON0 to value 0x96"]
impl crate::Resettable for CruLpllCon0Spec {
