#[doc = "Register `CLKSEL_CON8` reader"]
pub type R = crate::R<ClkselCon8Spec>;
#[doc = "Register `CLKSEL_CON8` writer"]
pub type W = crate::W<ClkselCon8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_vdu_div_con(&mut self) -> AclkVduDivConW<ClkselCon8Spec> {
        AclkVduDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - aclk_vdu clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_vdu_pll_sel(&mut self) -> AclkVduPllSelW<ClkselCon8Spec> {
        AclkVduPllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - hclk_vdu divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_vdu_div_con(&mut self) -> HclkVduDivConW<ClkselCon8Spec> {
        HclkVduDivConW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon8Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register8\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con8::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con8::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon8Spec;
impl crate::RegisterSpec for ClkselCon8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con8::R`](R) reader structure"]
impl crate::Readable for ClkselCon8Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con8::W`](W) writer structure"]
impl crate::Writable for ClkselCon8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON8 to value 0x0101"]
impl crate::Resettable for ClkselCon8Spec {
