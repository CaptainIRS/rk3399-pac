#[doc = "Register `CLKSEL_CON57` reader"]
pub type R = crate::R<ClkselCon57Spec>;
#[doc = "Register `CLKSEL_CON57` writer"]
pub type W = crate::W<ClkselCon57Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pclk_alive_div_con(&mut self) -> PclkAliveDivConW<ClkselCon57Spec> {
        PclkAliveDivConW::new(self, 0)
    }
    #[doc = "Bits 6:15 - clkout_24m divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clkout_24m_div_con(&mut self) -> Clkout24mDivConW<ClkselCon57Spec> {
        Clkout24mDivConW::new(self, 6)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon57Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register57\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con57::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con57::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon57Spec;
impl crate::RegisterSpec for ClkselCon57Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con57::R`](R) reader structure"]
impl crate::Readable for ClkselCon57Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con57::W`](W) writer structure"]
impl crate::Writable for ClkselCon57Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON57 to value 0x05"]
impl crate::Resettable for ClkselCon57Spec {
