#[doc = "Register `CLKSEL_CON43` reader"]
pub type R = crate::R<ClkselCon43Spec>;
#[doc = "Register `CLKSEL_CON43` writer"]
pub type W = crate::W<ClkselCon43Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pclk_vio_div_con(&mut self) -> PclkVioDivConW<ClkselCon43Spec> {
        PclkVioDivConW::new(self, 0)
    }
    #[doc = "Bits 5:9 - hclk_hdcp divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_hdcp_div_con(&mut self) -> HclkHdcpDivConW<ClkselCon43Spec> {
        HclkHdcpDivConW::new(self, 5)
    }
    #[doc = "Bits 10:14 - pclk_hdcp divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_hdcp_div_con(&mut self) -> PclkHdcpDivConW<ClkselCon43Spec> {
        PclkHdcpDivConW::new(self, 10)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon43Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register43\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con43::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con43::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon43Spec;
impl crate::RegisterSpec for ClkselCon43Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con43::R`](R) reader structure"]
impl crate::Readable for ClkselCon43Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con43::W`](W) writer structure"]
impl crate::Writable for ClkselCon43Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON43 to value 0x0421"]
impl crate::Resettable for ClkselCon43Spec {
