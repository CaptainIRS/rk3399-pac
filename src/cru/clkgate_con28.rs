#[doc = "Register `CLKGATE_CON28` reader"]
pub type R = crate::R<ClkgateCon28Spec>;
#[doc = "Register `CLKGATE_CON28` writer"]
pub type W = crate::W<ClkgateCon28Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hclk_vop0_noc_en(&mut self) -> HclkVop0NocEnW<ClkgateCon28Spec> {
        HclkVop0NocEnW::new(self, 0)
    }
    #[doc = "Bit 1 - aclk_vop0_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_vop0_noc_en(&mut self) -> AclkVop0NocEnW<ClkgateCon28Spec> {
        AclkVop0NocEnW::new(self, 1)
    }
    #[doc = "Bit 2 - hclk_vop0 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_vop0_en(&mut self) -> HclkVop0EnW<ClkgateCon28Spec> {
        HclkVop0EnW::new(self, 2)
    }
    #[doc = "Bit 3 - aclk_vop0 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_vop0_en(&mut self) -> AclkVop0EnW<ClkgateCon28Spec> {
        AclkVop0EnW::new(self, 3)
    }
    #[doc = "Bit 4 - hclk_vopb_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_vopb_noc_en(&mut self) -> HclkVopbNocEnW<ClkgateCon28Spec> {
        HclkVopbNocEnW::new(self, 4)
    }
    #[doc = "Bit 5 - aclk_vopb_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_vopb_noc_en(&mut self) -> AclkVopbNocEnW<ClkgateCon28Spec> {
        AclkVopbNocEnW::new(self, 5)
    }
    #[doc = "Bit 6 - hclk_vopb clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_vopb_en(&mut self) -> HclkVopbEnW<ClkgateCon28Spec> {
        HclkVopbEnW::new(self, 6)
    }
    #[doc = "Bit 7 - aclk_vopb clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_vopb_en(&mut self) -> AclkVopbEnW<ClkgateCon28Spec> {
        AclkVopbEnW::new(self, 7)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkgateCon28Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock gating register28\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clkgate_con28::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clkgate_con28::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkgateCon28Spec;
impl crate::RegisterSpec for ClkgateCon28Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clkgate_con28::R`](R) reader structure"]
impl crate::Readable for ClkgateCon28Spec {}
#[doc = "`write(|w| ..)` method takes [`clkgate_con28::W`](W) writer structure"]
impl crate::Writable for ClkgateCon28Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKGATE_CON28 to value 0"]
impl crate::Resettable for ClkgateCon28Spec {
