#[doc = "Register `CLKSEL_CON63` reader"]
pub type R = crate::R<ClkselCon63Spec>;
#[doc = "Register `CLKSEL_CON63` writer"]
pub type W = crate::W<ClkselCon63Spec>;
#[doc = "Field `CLK_I2C3_DIV_CON` reader - i2c3 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type ClkI2c3DivConR = crate::FieldReader;
#[doc = "Field `CLK_I2C3_DIV_CON` writer - i2c3 divider control register\n\nclk=clk_src/(div_con+1)"]
...
#[doc = "Field `CLK_I2C7_DIV_CON` reader - i2c7 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type ClkI2c7DivConR = crate::FieldReader;
#[doc = "Field `CLK_I2C7_DIV_CON` writer - i2c7 divider control register\n\nclk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:6 - i2c3 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:14 - i2c7 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c3_div_con(&mut self) -> ClkI2c3DivConW<ClkselCon63Spec> {
        ClkI2c3DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_i2c3 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c3_pll_sel(&mut self) -> ClkI2c3PllSelW<ClkselCon63Spec> {
        ClkI2c3PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:14 - i2c7 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c7_div_con(&mut self) -> ClkI2c7DivConW<ClkselCon63Spec> {
        ClkI2c7DivConW::new(self, 8)
    }
    #[doc = "Bit 15 - clk_i2c7 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2c7_pll_sel(&mut self) -> ClkI2c7PllSelW<ClkselCon63Spec> {
        ClkI2c7PllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon63Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register63\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con63::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con63::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon63Spec;
impl crate::RegisterSpec for ClkselCon63Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con63::R`](R) reader structure"]
impl crate::Readable for ClkselCon63Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con63::W`](W) writer structure"]
impl crate::Writable for ClkselCon63Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON63 to value 0x0303"]
impl crate::Resettable for ClkselCon63Spec {
