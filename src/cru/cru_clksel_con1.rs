...
#[doc = "Field `ATCLK_CORE_L_DIV_CON` reader - atclk_core_l divider control register clk=clk_src/(div_con+1)"]
pub type AtclkCoreLDivConR = crate::FieldReader;
#[doc = "Field `ATCLK_CORE_L_DIV_CON` writer - atclk_core_l divider control register clk=clk_src/(div_con+1)"]
pub type AtclkCoreLDivConW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `PCLK_DBG_L_DIV_CON` reader - pclk_dbg_l divider control register clk=clk_src/(div_con+1)"]
pub type PclkDbgLDivConR = crate::FieldReader;
#[doc = "Field `PCLK_DBG_L_DIV_CON` writer - pclk_dbg_l divider control register clk=clk_src/(div_con+1)"]
pub type PclkDbgLDivConW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `WRITE_MASK` writer - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
pub type WriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:4 - atclk_core_l divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
    pub fn atclk_core_l_div_con(&self) -> AtclkCoreLDivConR {
        AtclkCoreLDivConR::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bits 8:12 - pclk_dbg_l divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
