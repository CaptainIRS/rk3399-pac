#[doc = "Register `CLKSEL_CON55` reader"]
pub type R = crate::R<ClkselCon55Spec>;
#[doc = "Register `CLKSEL_CON55` writer"]
pub type W = crate::W<ClkselCon55Spec>;
#[doc = "Field `CLK_ISP0_DIV_CON` reader - clk_isp0 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type ClkIsp0DivConR = crate::FieldReader;
#[doc = "Field `CLK_ISP0_DIV_CON` writer - clk_isp0 divider control register\n\nclk=clk_src/(div_con+1)"]
...
#[doc = "Field `CLK_ISP1_DIV_CON` reader - clk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type ClkIsp1DivConR = crate::FieldReader;
#[doc = "Field `CLK_ISP1_DIV_CON` writer - clk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:4 - clk_isp0 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:12 - clk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_isp0_div_con(&mut self) -> ClkIsp0DivConW<ClkselCon55Spec> {
        ClkIsp0DivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - clk_isp0 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_isp0_pll_sel(&mut self) -> ClkIsp0PllSelW<ClkselCon55Spec> {
        ClkIsp0PllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - clk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_isp1_div_con(&mut self) -> ClkIsp1DivConW<ClkselCon55Spec> {
        ClkIsp1DivConW::new(self, 8)
    }
    #[doc = "Bits 14:15 - clk_isp1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_isp1_pll_sel(&mut self) -> ClkIsp1PllSelW<ClkselCon55Spec> {
        ClkIsp1PllSelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon55Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register55\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con55::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con55::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon55Spec;
impl crate::RegisterSpec for ClkselCon55Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con55::R`](R) reader structure"]
impl crate::Readable for ClkselCon55Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con55::W`](W) writer structure"]
impl crate::Writable for ClkselCon55Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON55 to value 0x8181"]
impl crate::Resettable for ClkselCon55Spec {
