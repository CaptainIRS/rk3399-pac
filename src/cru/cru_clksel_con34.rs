...
#[doc = "Field `CLK_UART1_DIV_CON` reader - clk_uart1 divider control register clk=clk_src/(div_con+1)"]
pub type ClkUart1DivConR = crate::FieldReader;
#[doc = "Field `CLK_UART1_DIV_CON` writer - clk_uart1 divider control register clk=clk_src/(div_con+1)"]
...
#[doc = "Field `CLK_WRITE_MASK` writer - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
pub type ClkWriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:6 - clk_uart1 divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
