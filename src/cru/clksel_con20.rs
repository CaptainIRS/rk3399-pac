#[doc = "Register `CLKSEL_CON20` reader"]
pub type R = crate::R<ClkselCon20Spec>;
#[doc = "Register `CLKSEL_CON20` writer"]
pub type W = crate::W<ClkselCon20Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_gmac_div_con(&mut self) -> AclkGmacDivConW<ClkselCon20Spec> {
        AclkGmacDivConW::new(self, 0)
    }
    #[doc = "Bit 7 - aclk_gmac clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_gmac_pll_sel(&mut self) -> AclkGmacPllSelW<ClkselCon20Spec> {
        AclkGmacPllSelW::new(self, 7)
    }
    #[doc = "Bits 8:12 - clk_gmac divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_gmac_div_con(&mut self) -> ClkGmacDivConW<ClkselCon20Spec> {
        ClkGmacDivConW::new(self, 8)
    }
    #[doc = "Bits 14:15 - clk_gmac clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_gmac_pll_sel(&mut self) -> ClkGmacPllSelW<ClkselCon20Spec> {
        ClkGmacPllSelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon20Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register20\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con20::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con20::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon20Spec;
impl crate::RegisterSpec for ClkselCon20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con20::R`](R) reader structure"]
impl crate::Readable for ClkselCon20Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con20::W`](W) writer structure"]
impl crate::Writable for ClkselCon20Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON20 to value 0x9303"]
impl crate::Resettable for ClkselCon20Spec {
