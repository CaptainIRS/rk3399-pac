#[doc = "Register `SOFTRST_CON9` reader"]
pub type R = crate::R<SoftrstCon9Spec>;
#[doc = "Register `SOFTRST_CON9` writer"]
pub type W = crate::W<SoftrstCon9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn resetn_usb2phy0_por_req(&mut self) -> ResetnUsb2phy0PorReqW<SoftrstCon9Spec> {
    ...
    pub fn resetn_usb2phy0_utmi_port0_req(
        &mut self,
    ) -> ResetnUsb2phy0UtmiPort0ReqW<SoftrstCon9Spec> {
    ...
    pub fn resetn_usb2phy0_utmi_port1_req(
        &mut self,
    ) -> ResetnUsb2phy0UtmiPort1ReqW<SoftrstCon9Spec> {
        ResetnUsb2phy0UtmiPort1ReqW::new(self, 2)
    }
    #[doc = "Bit 3 - resetn_usb2phy0_ehciphy request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_usb2phy0_ehciphy_req(&mut self) -> ResetnUsb2phy0EhciphyReqW<SoftrstCon9Spec> {
        ResetnUsb2phy0EhciphyReqW::new(self, 3)
    }
    #[doc = "Bit 4 - resetn_uphy0_pipe_l00 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_uphy0_pipe_l00_req(&mut self) -> ResetnUphy0PipeL00ReqW<SoftrstCon9Spec> {
        ResetnUphy0PipeL00ReqW::new(self, 4)
    }
    #[doc = "Bit 5 - resetn_uphy0 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_uphy0_req(&mut self) -> ResetnUphy0ReqW<SoftrstCon9Spec> {
        ResetnUphy0ReqW::new(self, 5)
    }
    #[doc = "Bit 6 - resetn_uphy0_tcpdpwrup request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_uphy0_tcpdpwrup_req(&mut self) -> ResetnUphy0TcpdpwrupReqW<SoftrstCon9Spec> {
        ResetnUphy0TcpdpwrupReqW::new(self, 6)
    }
    #[doc = "Bit 8 - resetn_usb2phy1_por request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_usb2phy1_por_req(&mut self) -> ResetnUsb2phy1PorReqW<SoftrstCon9Spec> {
    ...
    pub fn resetn_usb2phy1_utmi_port0_req(
        &mut self,
    ) -> ResetnUsb2phy1UtmiPort0ReqW<SoftrstCon9Spec> {
    ...
    pub fn resetn_usb2phy1_utmi_port1_req(
        &mut self,
    ) -> ResetnUsb2phy1UtmiPort1ReqW<SoftrstCon9Spec> {
        ResetnUsb2phy1UtmiPort1ReqW::new(self, 10)
    }
    #[doc = "Bit 11 - resetn_usb2phy1_ehciphy request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_usb2phy1_ehciphy_req(&mut self) -> ResetnUsb2phy1EhciphyReqW<SoftrstCon9Spec> {
        ResetnUsb2phy1EhciphyReqW::new(self, 11)
    }
    #[doc = "Bit 12 - resetn_uphy1_pipe_l00 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_uphy1_pipe_l00_req(&mut self) -> ResetnUphy1PipeL00ReqW<SoftrstCon9Spec> {
        ResetnUphy1PipeL00ReqW::new(self, 12)
    }
    #[doc = "Bit 13 - resetn_uphy1 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_uphy1_req(&mut self) -> ResetnUphy1ReqW<SoftrstCon9Spec> {
        ResetnUphy1ReqW::new(self, 13)
    }
    #[doc = "Bit 14 - resetn_uphy1_tcpdpwrup request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_uphy1_tcpdpwrup_req(&mut self) -> ResetnUphy1TcpdpwrupReqW<SoftrstCon9Spec> {
        ResetnUphy1TcpdpwrupReqW::new(self, 14)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<SoftrstCon9Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal software reset control register9\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`softrst_con9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`softrst_con9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SoftrstCon9Spec;
impl crate::RegisterSpec for SoftrstCon9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`softrst_con9::R`](R) reader structure"]
impl crate::Readable for SoftrstCon9Spec {}
#[doc = "`write(|w| ..)` method takes [`softrst_con9::W`](W) writer structure"]
impl crate::Writable for SoftrstCon9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOFTRST_CON9 to value 0"]
impl crate::Resettable for SoftrstCon9Spec {
