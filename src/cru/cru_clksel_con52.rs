...
#[doc = "Field `CLK_VOP1_PWM_DIV_CON` reader - vop1_pwm divider control register clk=clk_src/(div_con+1)"]
pub type ClkVop1PwmDivConR = crate::FieldReader;
#[doc = "Field `CLK_VOP1_PWM_DIV_CON` writer - vop1_pwm divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:4 - vop1_pwm divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
