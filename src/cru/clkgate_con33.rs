#[doc = "Register `CLKGATE_CON33` reader"]
pub type R = crate::R<ClkgateCon33Spec>;
#[doc = "Register `CLKGATE_CON33` writer"]
pub type W = crate::W<ClkgateCon33Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_gic_en(&mut self) -> AclkGicEnW<ClkgateCon33Spec> {
        AclkGicEnW::new(self, 0)
    }
    #[doc = "Bit 1 - aclk_gic_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_gic_noc_en(&mut self) -> AclkGicNocEnW<ClkgateCon33Spec> {
    ...
    pub fn aclk_gic_adb400_core_l_2_gic_en(
        &mut self,
    ) -> AclkGicAdb400CoreL2GicEnW<ClkgateCon33Spec> {
    ...
    pub fn aclk_gic_adb400_core_b_2_gic_en(
        &mut self,
    ) -> AclkGicAdb400CoreB2GicEnW<ClkgateCon33Spec> {
    ...
    pub fn aclk_gic_adb400_gic_2_core_l_en(
        &mut self,
    ) -> AclkGicAdb400Gic2CoreLEnW<ClkgateCon33Spec> {
    ...
    pub fn aclk_gic_adb400_gic_2_core_b_en(
        &mut self,
    ) -> AclkGicAdb400Gic2CoreBEnW<ClkgateCon33Spec> {
        AclkGicAdb400Gic2CoreBEnW::new(self, 5)
    }
    #[doc = "Bit 8 - hclk_sdmmc clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_sdmmc_en(&mut self) -> HclkSdmmcEnW<ClkgateCon33Spec> {
        HclkSdmmcEnW::new(self, 8)
    }
    #[doc = "Bit 9 - hclk_sd_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_sd_noc_en(&mut self) -> HclkSdNocEnW<ClkgateCon33Spec> {
        HclkSdNocEnW::new(self, 9)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkgateCon33Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock gating register33\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clkgate_con33::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clkgate_con33::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkgateCon33Spec;
impl crate::RegisterSpec for ClkgateCon33Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clkgate_con33::R`](R) reader structure"]
impl crate::Readable for ClkgateCon33Spec {}
#[doc = "`write(|w| ..)` method takes [`clkgate_con33::W`](W) writer structure"]
impl crate::Writable for ClkgateCon33Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKGATE_CON33 to value 0"]
impl crate::Resettable for ClkgateCon33Spec {
