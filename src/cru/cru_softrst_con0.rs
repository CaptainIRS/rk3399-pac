...
#[doc = "Field `CORE0_L_SRSTN_REQ` reader - core0_l_srstn request bit When HIGH, reset relative logic"]
pub type Core0LSrstnReqR = crate::BitReader;
#[doc = "Field `CORE0_L_SRSTN_REQ` writer - core0_l_srstn request bit When HIGH, reset relative logic"]
pub type Core0LSrstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE0_B_SRSTN_REQ` reader - core0_b_srstn request bit When HIGH, reset relative logic"]
pub type Core0BSrstnReqR = crate::BitReader;
#[doc = "Field `CORE0_B_SRSTN_REQ` writer - core0_b_srstn request bit When HIGH, reset relative logic"]
pub type Core0BSrstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COREPO0_L_SRSTN_REQ` reader - corepo0_l_srstn request bit When HIGH, reset relative logic"]
pub type Corepo0LSrstnReqR = crate::BitReader;
#[doc = "Field `COREPO0_L_SRSTN_REQ` writer - corepo0_l_srstn request bit When HIGH, reset relative logic"]
pub type Corepo0LSrstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COREPO0_B_SRSTN_REQ` reader - corepo0_b_srstn request bit When HIGH, reset relative logic"]
pub type Corepo0BSrstnReqR = crate::BitReader;
#[doc = "Field `COREPO0_B_SRSTN_REQ` writer - corepo0_b_srstn request bit When HIGH, reset relative logic"]
pub type Corepo0BSrstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_L_SRSTN_REQ` reader - l2_l_srstn request bit When HIGH, reset relative logic"]
pub type L2LSrstnReqR = crate::BitReader;
#[doc = "Field `L2_L_SRSTN_REQ` writer - l2_l_srstn request bit When HIGH, reset relative logic"]
pub type L2LSrstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_B_SRSTN_REQ` reader - l2_b_srstn request bit When HIGH, reset relative logic"]
pub type L2BSrstnReqR = crate::BitReader;
#[doc = "Field `L2_B_SRSTN_REQ` writer - l2_b_srstn request bit When HIGH, reset relative logic"]
pub type L2BSrstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ADB_L_SRSTN_REQ` reader - adb_l_srstn request bit When HIGH, reset relative logic"]
pub type AdbLSrstnReqR = crate::BitReader;
#[doc = "Field `ADB_L_SRSTN_REQ` writer - adb_l_srstn request bit When HIGH, reset relative logic"]
pub type AdbLSrstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ADB_B_SRSTN_REQ` reader - adb_b_srstn request bit When HIGH, reset relative logic"]
pub type AdbBSrstnReqR = crate::BitReader;
#[doc = "Field `ADB_B_SRSTN_REQ` writer - adb_b_srstn request bit When HIGH, reset relative logic"]
pub type AdbBSrstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ARESETN_CCI_REQ` reader - aresetn_cci request bit When HIGH, reset relative logic"]
pub type AresetnCciReqR = crate::BitReader;
#[doc = "Field `ARESETN_CCI_REQ` writer - aresetn_cci request bit When HIGH, reset relative logic"]
pub type AresetnCciReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ARESETN_CCIM0_NOC_REQ` reader - aresetn_ccim0_noc request bit When HIGH, reset relative logic"]
pub type AresetnCcim0NocReqR = crate::BitReader;
#[doc = "Field `ARESETN_CCIM0_NOC_REQ` writer - aresetn_ccim0_noc request bit When HIGH, reset relative logic"]
pub type AresetnCcim0NocReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ARESETN_CCIM1_NOC_REQ` reader - aresetn_ccim1_noc request bit When HIGH, reset relative logic"]
pub type AresetnCcim1NocReqR = crate::BitReader;
#[doc = "Field `ARESETN_CCIM1_NOC_REQ` writer - aresetn_ccim1_noc request bit When HIGH, reset relative logic"]
pub type AresetnCcim1NocReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESETN_DBG_NOC_REQ` reader - resetn_dbg_noc request bit When HIGH, reset relative logic"]
pub type ResetnDbgNocReqR = crate::BitReader;
#[doc = "Field `RESETN_DBG_NOC_REQ` writer - resetn_dbg_noc request bit When HIGH, reset relative logic"]
