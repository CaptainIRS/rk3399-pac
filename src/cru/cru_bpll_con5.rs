#[doc = "Register `CRU_BPLL_CON5` reader"]
pub type R = crate::R<CruBpllCon5Spec>;
#[doc = "Register `CRU_BPLL_CON5` writer"]
pub type W = crate::W<CruBpllCon5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssmod_sel_ext_wave(&mut self) -> SsmodSelExtWaveW<CruBpllCon5Spec> {
        SsmodSelExtWaveW::new(self, 0)
    }
    #[doc = "Bits 8:15 - External wave table data inputs (0-255)"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_ext_maxaddr(&mut self) -> SsmodExtMaxaddrW<CruBpllCon5Spec> {
        SsmodExtMaxaddrW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruBpllCon5Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "BPLL configuration register5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_bpll_con5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_bpll_con5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruBpllCon5Spec;
impl crate::RegisterSpec for CruBpllCon5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_bpll_con5::R`](R) reader structure"]
impl crate::Readable for CruBpllCon5Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_bpll_con5::W`](W) writer structure"]
impl crate::Writable for CruBpllCon5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_BPLL_CON5 to value 0x7f00"]
impl crate::Resettable for CruBpllCon5Spec {
