#[doc = "Register `CRU_CLKSEL_CON18` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_pcie_core_clk_sel(&mut self) -> ClkPcieCoreClkSelW<CruClkselCon18Spec> {
        ClkPcieCoreClkSelW::new(self, 7)
    }
    #[doc = "Bits 8:9 - clk_pcie_core clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_pcie_core_pll_sel(&mut self) -> ClkPcieCorePllSelW<CruClkselCon18Spec> {
...
#[doc = "Internal clock select and divide register18\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con18::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con18::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon18Spec;
impl crate::RegisterSpec for CruClkselCon18Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con18::R`](R) reader structure"]
impl crate::Readable for CruClkselCon18Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con18::W`](W) writer structure"]
impl crate::Writable for CruClkselCon18Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON18 to value 0x4a87"]
impl crate::Resettable for CruClkselCon18Spec {
