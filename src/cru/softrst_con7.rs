#[doc = "Register `SOFTRST_CON7` reader"]
pub type R = crate::R<SoftrstCon7Spec>;
#[doc = "Register `SOFTRST_CON7` writer"]
pub type W = crate::W<SoftrstCon7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aresetn_perihp_noc_req(&mut self) -> AresetnPerihpNocReqW<SoftrstCon7Spec> {
        AresetnPerihpNocReqW::new(self, 0)
    }
    #[doc = "Bit 1 - presetn_perihp_grf request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_perihp_grf_req(&mut self) -> PresetnPerihpGrfReqW<SoftrstCon7Spec> {
        PresetnPerihpGrfReqW::new(self, 1)
    }
    #[doc = "Bit 2 - hresetn_perihp_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_perihp_noc_req(&mut self) -> HresetnPerihpNocReqW<SoftrstCon7Spec> {
        HresetnPerihpNocReqW::new(self, 2)
    }
    #[doc = "Bit 3 - hresetn_usbhost0 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_usbhost0_req(&mut self) -> HresetnUsbhost0ReqW<SoftrstCon7Spec> {
        HresetnUsbhost0ReqW::new(self, 3)
    }
    #[doc = "Bit 4 - hresetn_hostc0_aux request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_hostc0_aux_req(&mut self) -> HresetnHostc0AuxReqW<SoftrstCon7Spec> {
        HresetnHostc0AuxReqW::new(self, 4)
    }
    #[doc = "Bit 5 - hresetn_host0_arb request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_host0_arb_req(&mut self) -> HresetnHost0ArbReqW<SoftrstCon7Spec> {
        HresetnHost0ArbReqW::new(self, 5)
    }
    #[doc = "Bit 6 - hresetn_usbhost1 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_usbhost1_req(&mut self) -> HresetnUsbhost1ReqW<SoftrstCon7Spec> {
        HresetnUsbhost1ReqW::new(self, 6)
    }
    #[doc = "Bit 7 - hresetn_hostc1_aux request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_hostc1_aux_req(&mut self) -> HresetnHostc1AuxReqW<SoftrstCon7Spec> {
        HresetnHostc1AuxReqW::new(self, 7)
    }
    #[doc = "Bit 8 - hresetn_host1_arb request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_host1_arb_req(&mut self) -> HresetnHost1ArbReqW<SoftrstCon7Spec> {
        HresetnHost1ArbReqW::new(self, 8)
    }
    #[doc = "Bit 9 - hresetn_sdio0 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_sdio0_req(&mut self) -> HresetnSdio0ReqW<SoftrstCon7Spec> {
        HresetnSdio0ReqW::new(self, 9)
    }
    #[doc = "Bit 10 - hresetn_sdmmc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_sdmmc_req(&mut self) -> HresetnSdmmcReqW<SoftrstCon7Spec> {
        HresetnSdmmcReqW::new(self, 10)
    }
    #[doc = "Bit 11 - hresetn_hsic request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_hsic_req(&mut self) -> HresetnHsicReqW<SoftrstCon7Spec> {
        HresetnHsicReqW::new(self, 11)
    }
    #[doc = "Bit 12 - hresetn_hsic_aux request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_hsic_aux_req(&mut self) -> HresetnHsicAuxReqW<SoftrstCon7Spec> {
        HresetnHsicAuxReqW::new(self, 12)
    }
    #[doc = "Bit 13 - hresetn_ahb1tom request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_ahb1tom_req(&mut self) -> HresetnAhb1tomReqW<SoftrstCon7Spec> {
        HresetnAhb1tomReqW::new(self, 13)
    }
    #[doc = "Bit 14 - presetn_perihp_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_perihp_noc_req(&mut self) -> PresetnPerihpNocReqW<SoftrstCon7Spec> {
        PresetnPerihpNocReqW::new(self, 14)
    }
    #[doc = "Bit 15 - presetn_hsicphy request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_hsicphy_req(&mut self) -> PresetnHsicphyReqW<SoftrstCon7Spec> {
        PresetnHsicphyReqW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<SoftrstCon7Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal software reset control register7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`softrst_con7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`softrst_con7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SoftrstCon7Spec;
impl crate::RegisterSpec for SoftrstCon7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`softrst_con7::R`](R) reader structure"]
impl crate::Readable for SoftrstCon7Spec {}
#[doc = "`write(|w| ..)` method takes [`softrst_con7::W`](W) writer structure"]
impl crate::Writable for SoftrstCon7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOFTRST_CON7 to value 0"]
impl crate::Resettable for SoftrstCon7Spec {
