#[doc = "Register `CLKGATE_CON3` reader"]
pub type R = crate::R<ClkgateCon3Spec>;
#[doc = "Register `CLKGATE_CON3` writer"]
pub type W = crate::W<ClkgateCon3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_ddrc_lpll_src_en(&mut self) -> ClkDdrcLpllSrcEnW<ClkgateCon3Spec> {
        ClkDdrcLpllSrcEnW::new(self, 0)
    }
    #[doc = "Bit 1 - clk_ddrc_bpll clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_ddrc_bpll_src_en(&mut self) -> ClkDdrcBpllSrcEnW<ClkgateCon3Spec> {
        ClkDdrcBpllSrcEnW::new(self, 1)
    }
    #[doc = "Bit 2 - clk_ddrc_dpll clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_ddrc_dpll_src_en(&mut self) -> ClkDdrcDpllSrcEnW<ClkgateCon3Spec> {
        ClkDdrcDpllSrcEnW::new(self, 2)
    }
    #[doc = "Bit 3 - clk_ddrc_gpll clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_ddrc_gpll_src_en(&mut self) -> ClkDdrcGpllSrcEnW<ClkgateCon3Spec> {
        ClkDdrcGpllSrcEnW::new(self, 3)
    }
    #[doc = "Bit 4 - pclk_ddr clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_ddr_en(&mut self) -> PclkDdrEnW<ClkgateCon3Spec> {
        PclkDdrEnW::new(self, 4)
    }
    #[doc = "Bit 7 - aclk_center_src clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_center_src_en(&mut self) -> AclkCenterSrcEnW<ClkgateCon3Spec> {
        AclkCenterSrcEnW::new(self, 7)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkgateCon3Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock gating register3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clkgate_con3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clkgate_con3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkgateCon3Spec;
impl crate::RegisterSpec for ClkgateCon3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clkgate_con3::R`](R) reader structure"]
impl crate::Readable for ClkgateCon3Spec {}
#[doc = "`write(|w| ..)` method takes [`clkgate_con3::W`](W) writer structure"]
impl crate::Writable for ClkgateCon3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKGATE_CON3 to value 0"]
impl crate::Resettable for ClkgateCon3Spec {
