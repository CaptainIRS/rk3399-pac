#[doc = "Register `BPLL_CON5` reader"]
pub type R = crate::R<BpllCon5Spec>;
#[doc = "Register `BPLL_CON5` writer"]
pub type W = crate::W<BpllCon5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssmod_sel_ext_wave(&mut self) -> SsmodSelExtWaveW<BpllCon5Spec> {
        SsmodSelExtWaveW::new(self, 0)
    }
    #[doc = "Bits 8:15 - External wave table data inputs\n\n(0-255)"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_ext_maxaddr(&mut self) -> SsmodExtMaxaddrW<BpllCon5Spec> {
        SsmodExtMaxaddrW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<BpllCon5Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "BPLL configuration register5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bpll_con5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bpll_con5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BpllCon5Spec;
impl crate::RegisterSpec for BpllCon5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bpll_con5::R`](R) reader structure"]
impl crate::Readable for BpllCon5Spec {}
#[doc = "`write(|w| ..)` method takes [`bpll_con5::W`](W) writer structure"]
impl crate::Writable for BpllCon5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BPLL_CON5 to value 0x7f00"]
impl crate::Resettable for BpllCon5Spec {
