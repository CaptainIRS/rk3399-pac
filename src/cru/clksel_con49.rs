#[doc = "Register `CLKSEL_CON49` reader"]
pub type R = crate::R<ClkselCon49Spec>;
#[doc = "Register `CLKSEL_CON49` writer"]
pub type W = crate::W<ClkselCon49Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dclk_vop0_div_con(&mut self) -> DclkVop0DivConW<ClkselCon49Spec> {
        DclkVop0DivConW::new(self, 0)
    }
    #[doc = "Bits 8:9 - dclk_vop0 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn dclk_vop0_pll_sel(&mut self) -> DclkVop0PllSelW<ClkselCon49Spec> {
        DclkVop0PllSelW::new(self, 8)
    }
    #[doc = "Bit 11 - dclk_vop0 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn dclk_vop0_dclk_sel(&mut self) -> DclkVop0DclkSelW<ClkselCon49Spec> {
        DclkVop0DclkSelW::new(self, 11)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon49Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register49\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con49::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con49::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon49Spec;
impl crate::RegisterSpec for ClkselCon49Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con49::R`](R) reader structure"]
impl crate::Readable for ClkselCon49Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con49::W`](W) writer structure"]
impl crate::Writable for ClkselCon49Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON49 to value 0x01"]
impl crate::Resettable for ClkselCon49Spec {
