#[doc = "Register `CLKSEL_CON10` reader"]
pub type R = crate::R<ClkselCon10Spec>;
#[doc = "Register `CLKSEL_CON10` writer"]
pub type W = crate::W<ClkselCon10Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_iep_div_con(&mut self) -> AclkIepDivConW<ClkselCon10Spec> {
        AclkIepDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - aclk_iep clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_iep_pll_sel(&mut self) -> AclkIepPllSelW<ClkselCon10Spec> {
        AclkIepPllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - hclk_iep divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_iep_div_con(&mut self) -> HclkIepDivConW<ClkselCon10Spec> {
        HclkIepDivConW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon10Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register10\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con10::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con10::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon10Spec;
impl crate::RegisterSpec for ClkselCon10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con10::R`](R) reader structure"]
impl crate::Readable for ClkselCon10Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con10::W`](W) writer structure"]
impl crate::Writable for ClkselCon10Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON10 to value 0x0101"]
impl crate::Resettable for ClkselCon10Spec {
