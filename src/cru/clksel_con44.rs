#[doc = "Register `CLKSEL_CON44` reader"]
pub type R = crate::R<ClkselCon44Spec>;
#[doc = "Register `CLKSEL_CON44` writer"]
pub type W = crate::W<ClkselCon44Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pclk_edp_div_con(&mut self) -> PclkEdpDivConW<ClkselCon44Spec> {
        PclkEdpDivConW::new(self, 8)
    }
    #[doc = "Bit 15 - pclk_edp clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_edp_pll_sel(&mut self) -> PclkEdpPllSelW<ClkselCon44Spec> {
        PclkEdpPllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon44Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register44\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con44::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con44::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon44Spec;
impl crate::RegisterSpec for ClkselCon44Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con44::R`](R) reader structure"]
impl crate::Readable for ClkselCon44Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con44::W`](W) writer structure"]
impl crate::Writable for ClkselCon44Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON44 to value 0x0700"]
impl crate::Resettable for ClkselCon44Spec {
