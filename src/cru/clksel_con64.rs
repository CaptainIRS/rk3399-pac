#[doc = "Register `CLKSEL_CON64` reader"]
pub type R = crate::R<ClkselCon64Spec>;
#[doc = "Register `CLKSEL_CON64` writer"]
pub type W = crate::W<ClkselCon64Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_uphy0_tcpdcore_div_con(&mut self) -> ClkUphy0TcpdcoreDivConW<ClkselCon64Spec> {
        ClkUphy0TcpdcoreDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - clk_uphy0_tcpdcore clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uphy0_tcpdcore_clk_sel(&mut self) -> ClkUphy0TcpdcoreClkSelW<ClkselCon64Spec> {
        ClkUphy0TcpdcoreClkSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - clk_uphy0_tcpdphy_ref divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uphy0_tcpdphy_ref_div_con(&mut self) -> ClkUphy0TcpdphyRefDivConW<ClkselCon64Spec> {
        ClkUphy0TcpdphyRefDivConW::new(self, 8)
    }
    #[doc = "Bit 15 - clk_uphy0_tcpdphy_ref clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uphy0_tcpdphy_ref_clk_sel(&mut self) -> ClkUphy0TcpdphyRefClkSelW<ClkselCon64Spec> {
        ClkUphy0TcpdphyRefClkSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon64Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register64\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con64::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con64::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon64Spec;
impl crate::RegisterSpec for ClkselCon64Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con64::R`](R) reader structure"]
impl crate::Readable for ClkselCon64Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con64::W`](W) writer structure"]
impl crate::Writable for ClkselCon64Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON64 to value 0xc5"]
impl crate::Resettable for ClkselCon64Spec {
