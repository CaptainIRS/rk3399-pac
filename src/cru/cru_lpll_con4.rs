#[doc = "Register `CRU_LPLL_CON4` reader"]
pub type R = crate::R<CruLpllCon4Spec>;
#[doc = "Register `CRU_LPLL_CON4` writer"]
pub type W = crate::W<CruLpllCon4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssmod_bp(&mut self) -> SsmodBpW<CruLpllCon4Spec> {
        SsmodBpW::new(self, 0)
    }
    #[doc = "Bit 1 - Bypass SSMOD by module"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_disable_sscg(&mut self) -> SsmodDisableSscgW<CruLpllCon4Spec> {
        SsmodDisableSscgW::new(self, 1)
    }
    #[doc = "Bit 2 - Reset modulator state"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_reset(&mut self) -> SsmodResetW<CruLpllCon4Spec> {
        SsmodResetW::new(self, 2)
    }
    #[doc = "Bit 3 - Selects center spread or downs pread"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_downspread(&mut self) -> SsmodDownspreadW<CruLpllCon4Spec> {
        SsmodDownspreadW::new(self, 3)
    }
    #[doc = "Bits 4:7 - Divider required to set the modulation frequency\n\nDivider required to set the modulation frequency"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_divval(&mut self) -> SsmodDivvalW<CruLpllCon4Spec> {
        SsmodDivvalW::new(self, 4)
    }
    #[doc = "Bits 8:12 - spread amplitude\n\n% = 0.1 * SPREAD\\[4:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn ssmod_spread(&mut self) -> SsmodSpreadW<CruLpllCon4Spec> {
        SsmodSpreadW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruLpllCon4Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "LPLL configuration register4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_lpll_con4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_lpll_con4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruLpllCon4Spec;
impl crate::RegisterSpec for CruLpllCon4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_lpll_con4::R`](R) reader structure"]
impl crate::Readable for CruLpllCon4Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_lpll_con4::W`](W) writer structure"]
impl crate::Writable for CruLpllCon4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_LPLL_CON4 to value 0x07"]
impl crate::Resettable for CruLpllCon4Spec {
