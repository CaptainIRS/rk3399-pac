#[doc = "Register `CLKGATE_CON23` reader"]
pub type R = crate::R<ClkgateCon23Spec>;
#[doc = "Register `CLKGATE_CON23` writer"]
pub type W = crate::W<ClkgateCon23Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_intmem_en(&mut self) -> AclkIntmemEnW<ClkgateCon23Spec> {
        AclkIntmemEnW::new(self, 0)
    }
    #[doc = "Bit 1 - aclk_tzma clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_tzma_en(&mut self) -> AclkTzmaEnW<ClkgateCon23Spec> {
        AclkTzmaEnW::new(self, 1)
    }
    #[doc = "Bit 2 - clk_intmem0 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_intmem0_en(&mut self) -> ClkIntmem0EnW<ClkgateCon23Spec> {
        ClkIntmem0EnW::new(self, 2)
    }
    #[doc = "Bit 3 - clk_intmem1 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_intmem1_en(&mut self) -> ClkIntmem1EnW<ClkgateCon23Spec> {
        ClkIntmem1EnW::new(self, 3)
    }
    #[doc = "Bit 4 - clk_intmem2 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_intmem2_en(&mut self) -> ClkIntmem2EnW<ClkgateCon23Spec> {
        ClkIntmem2EnW::new(self, 4)
    }
    #[doc = "Bit 5 - clk_intmem3 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_intmem3_en(&mut self) -> ClkIntmem3EnW<ClkgateCon23Spec> {
        ClkIntmem3EnW::new(self, 5)
    }
    #[doc = "Bit 6 - clk_intmem4 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_intmem4_en(&mut self) -> ClkIntmem4EnW<ClkgateCon23Spec> {
        ClkIntmem4EnW::new(self, 6)
    }
    #[doc = "Bit 7 - clk_intmem5 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_intmem5_en(&mut self) -> ClkIntmem5EnW<ClkgateCon23Spec> {
        ClkIntmem5EnW::new(self, 7)
    }
    #[doc = "Bit 8 - aclk_dcf clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_dcf_en(&mut self) -> AclkDcfEnW<ClkgateCon23Spec> {
        AclkDcfEnW::new(self, 8)
    }
    #[doc = "Bit 9 - pclk_dcf clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_dcf_en(&mut self) -> PclkDcfEnW<ClkgateCon23Spec> {
        PclkDcfEnW::new(self, 9)
    }
    #[doc = "Bit 10 - pclk_spi0codec clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_spi0codec_en(&mut self) -> PclkSpi0codecEnW<ClkgateCon23Spec> {
        PclkSpi0codecEnW::new(self, 10)
    }
    #[doc = "Bit 11 - pclk_spi1 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_spi1_en(&mut self) -> PclkSpi1EnW<ClkgateCon23Spec> {
        PclkSpi1EnW::new(self, 11)
    }
    #[doc = "Bit 12 - pclk_spi2 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_spi2_en(&mut self) -> PclkSpi2EnW<ClkgateCon23Spec> {
        PclkSpi2EnW::new(self, 12)
    }
    #[doc = "Bit 13 - pclk_spi4 clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_spi4_en(&mut self) -> PclkSpi4EnW<ClkgateCon23Spec> {
        PclkSpi4EnW::new(self, 13)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkgateCon23Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock gating register23\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clkgate_con23::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clkgate_con23::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkgateCon23Spec;
impl crate::RegisterSpec for ClkgateCon23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clkgate_con23::R`](R) reader structure"]
impl crate::Readable for ClkgateCon23Spec {}
#[doc = "`write(|w| ..)` method takes [`clkgate_con23::W`](W) writer structure"]
impl crate::Writable for ClkgateCon23Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKGATE_CON23 to value 0"]
impl crate::Resettable for ClkgateCon23Spec {
