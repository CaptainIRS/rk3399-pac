#[doc = "Register `CLKSEL_CON34` reader"]
pub type R = crate::R<ClkselCon34Spec>;
#[doc = "Register `CLKSEL_CON34` writer"]
pub type W = crate::W<ClkselCon34Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_uart1_div_con(&mut self) -> ClkUart1DivConW<ClkselCon34Spec> {
        ClkUart1DivConW::new(self, 0)
    }
    #[doc = "Bits 8:9 - clk_uart1 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uart1_sel(&mut self) -> ClkUart1SelW<ClkselCon34Spec> {
        ClkUart1SelW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn clk_write_mask(&mut self) -> ClkWriteMaskW<ClkselCon34Spec> {
        ClkWriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register34\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con34::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con34::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon34Spec;
impl crate::RegisterSpec for ClkselCon34Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con34::R`](R) reader structure"]
impl crate::Readable for ClkselCon34Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con34::W`](W) writer structure"]
impl crate::Writable for ClkselCon34Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON34 to value 0x0200"]
impl crate::Resettable for ClkselCon34Spec {
