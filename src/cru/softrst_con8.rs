#[doc = "Register `SOFTRST_CON8` reader"]
pub type R = crate::R<SoftrstCon8Spec>;
#[doc = "Register `SOFTRST_CON8` writer"]
pub type W = crate::W<SoftrstCon8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aresetn_pcie_req(&mut self) -> AresetnPcieReqW<SoftrstCon8Spec> {
        AresetnPcieReqW::new(self, 0)
    }
    #[doc = "Bit 1 - presetn_pcie request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_pcie_req(&mut self) -> PresetnPcieReqW<SoftrstCon8Spec> {
        PresetnPcieReqW::new(self, 1)
    }
    #[doc = "Bit 2 - resetn_pcie_core request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_pcie_core_req(&mut self) -> ResetnPcieCoreReqW<SoftrstCon8Spec> {
        ResetnPcieCoreReqW::new(self, 2)
    }
    #[doc = "Bit 3 - resetn_pcie_mgmt request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_pcie_mgmt_req(&mut self) -> ResetnPcieMgmtReqW<SoftrstCon8Spec> {
        ResetnPcieMgmtReqW::new(self, 3)
    }
    #[doc = "Bit 4 - resetn_pcie_mgmt_sticky request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_pcie_mgmt_sticky_req(&mut self) -> ResetnPcieMgmtStickyReqW<SoftrstCon8Spec> {
        ResetnPcieMgmtStickyReqW::new(self, 4)
    }
    #[doc = "Bit 5 - resetn_pcie_pipe request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_pcie_pipe_req(&mut self) -> ResetnPciePipeReqW<SoftrstCon8Spec> {
        ResetnPciePipeReqW::new(self, 5)
    }
    #[doc = "Bit 6 - resetn_pcie_pm request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_pcie_pm_req(&mut self) -> ResetnPciePmReqW<SoftrstCon8Spec> {
        ResetnPciePmReqW::new(self, 6)
    }
    #[doc = "Bit 7 - resetn_pciephy request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_pciephy_req(&mut self) -> ResetnPciephyReqW<SoftrstCon8Spec> {
        ResetnPciephyReqW::new(self, 7)
    }
    #[doc = "Bit 8 - aresetn_gmac_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_gmac_noc_req(&mut self) -> AresetnGmacNocReqW<SoftrstCon8Spec> {
        AresetnGmacNocReqW::new(self, 8)
    }
    #[doc = "Bit 9 - aresetn_gmac request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_gmac_req(&mut self) -> AresetnGmacReqW<SoftrstCon8Spec> {
        AresetnGmacReqW::new(self, 9)
    }
    #[doc = "Bit 10 - presetn_gmac_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_gmac_noc_req(&mut self) -> PresetnGmacNocReqW<SoftrstCon8Spec> {
        PresetnGmacNocReqW::new(self, 10)
    }
    #[doc = "Bit 12 - presetn_gmac_grf request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_gmac_grf_req(&mut self) -> PresetnGmacGrfReqW<SoftrstCon8Spec> {
        PresetnGmacGrfReqW::new(self, 12)
    }
    #[doc = "Bit 14 - hsicphy_por_rstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hsicphy_por_rstn_req(&mut self) -> HsicphyPorRstnReqW<SoftrstCon8Spec> {
        HsicphyPorRstnReqW::new(self, 14)
    }
    #[doc = "Bit 15 - hsicphy_utmi_rstn request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hsicphy_utmi_rstn_req(&mut self) -> HsicphyUtmiRstnReqW<SoftrstCon8Spec> {
        HsicphyUtmiRstnReqW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<SoftrstCon8Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal software reset control register8\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`softrst_con8::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`softrst_con8::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SoftrstCon8Spec;
impl crate::RegisterSpec for SoftrstCon8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`softrst_con8::R`](R) reader structure"]
impl crate::Readable for SoftrstCon8Spec {}
#[doc = "`write(|w| ..)` method takes [`softrst_con8::W`](W) writer structure"]
impl crate::Writable for SoftrstCon8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOFTRST_CON8 to value 0xbc"]
impl crate::Resettable for SoftrstCon8Spec {
