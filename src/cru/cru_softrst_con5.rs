#[doc = "Register `CRU_SOFTRST_CON5` reader"]
...
#[doc = "Internal software reset control register5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_softrst_con5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_softrst_con5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruSoftrstCon5Spec;
impl crate::RegisterSpec for CruSoftrstCon5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_softrst_con5::R`](R) reader structure"]
impl crate::Readable for CruSoftrstCon5Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_softrst_con5::W`](W) writer structure"]
impl crate::Writable for CruSoftrstCon5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_SOFTRST_CON5 to value 0"]
impl crate::Resettable for CruSoftrstCon5Spec {
