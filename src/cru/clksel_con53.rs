#[doc = "Register `CLKSEL_CON53` reader"]
pub type R = crate::R<ClkselCon53Spec>;
#[doc = "Register `CLKSEL_CON53` writer"]
pub type W = crate::W<ClkselCon53Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_isp0_div_con(&mut self) -> AclkIsp0DivConW<ClkselCon53Spec> {
        AclkIsp0DivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - aclk_isp0 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_isp0_pll_sel(&mut self) -> AclkIsp0PllSelW<ClkselCon53Spec> {
        AclkIsp0PllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - hclk_isp0 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_isp0_div_con(&mut self) -> HclkIsp0DivConW<ClkselCon53Spec> {
        HclkIsp0DivConW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon53Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register53\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con53::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con53::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon53Spec;
impl crate::RegisterSpec for ClkselCon53Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con53::R`](R) reader structure"]
impl crate::Readable for ClkselCon53Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con53::W`](W) writer structure"]
impl crate::Writable for ClkselCon53Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON53 to value 0x0101"]
impl crate::Resettable for ClkselCon53Spec {
