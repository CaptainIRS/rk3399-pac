#[doc = "Register `CRU_CLKSEL_CON14` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_usbphy_480m_ch_sel(&mut self) -> ClkUsbphy480mChSelW<CruClkselCon14Spec> {
...
pub struct CruClkselCon14Spec;
impl crate::RegisterSpec for CruClkselCon14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con14::R`](R) reader structure"]
impl crate::Readable for CruClkselCon14Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con14::W`](W) writer structure"]
impl crate::Writable for CruClkselCon14Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON14 to value 0x3181"]
impl crate::Resettable for CruClkselCon14Spec {
