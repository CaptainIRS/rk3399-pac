...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn atclk_core_b_div_con(&mut self) -> AtclkCoreBDivConW<ClkselCon3Spec> {
        AtclkCoreBDivConW::new(self, 0)
    }
    #[doc = "Bits 8:12 - pclk_dbg_b divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_dbg_b_div_con(&mut self) -> PclkDbgBDivConW<ClkselCon3Spec> {
        PclkDbgBDivConW::new(self, 8)
    }
    #[doc = "Bits 13:14 - pclken_dbg_b divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn pclken_dbg_b_div_con(&mut self) -> PclkenDbgBDivConW<ClkselCon3Spec> {
...
#[doc = "`reset()` method sets CLKSEL_CON3 to value 0x6303"]
