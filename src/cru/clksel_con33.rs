#[doc = "Register `CLKSEL_CON33` reader"]
pub type R = crate::R<ClkselCon33Spec>;
#[doc = "Register `CLKSEL_CON33` writer"]
pub type W = crate::W<ClkselCon33Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_uart0_div_con(&mut self) -> ClkUart0DivConW<ClkselCon33Spec> {
        ClkUart0DivConW::new(self, 0)
    }
    #[doc = "Bits 8:9 - clk_uart0 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uart0_sel(&mut self) -> ClkUart0SelW<ClkselCon33Spec> {
        ClkUart0SelW::new(self, 8)
    }
    #[doc = "Bits 12:13 - clk_uart0_src clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uart0_src_sel(&mut self) -> ClkUart0SrcSelW<ClkselCon33Spec> {
        ClkUart0SrcSelW::new(self, 12)
    }
    #[doc = "Bit 15 - clk_uart clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uart_pll_sel(&mut self) -> ClkUartPllSelW<ClkselCon33Spec> {
        ClkUartPllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon33Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register33\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con33::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con33::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon33Spec;
impl crate::RegisterSpec for ClkselCon33Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con33::R`](R) reader structure"]
impl crate::Readable for ClkselCon33Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con33::W`](W) writer structure"]
impl crate::Writable for ClkselCon33Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON33 to value 0x0200"]
impl crate::Resettable for ClkselCon33Spec {
