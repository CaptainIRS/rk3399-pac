...
#[doc = "Field `CLK_CORE_L_LPLL_SRC_EN` reader - clk_core_l_lpll clock disable bit When HIGH, disable clock"]
pub type ClkCoreLLpllSrcEnR = crate::BitReader;
#[doc = "Field `CLK_CORE_L_LPLL_SRC_EN` writer - clk_core_l_lpll clock disable bit When HIGH, disable clock"]
pub type ClkCoreLLpllSrcEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CLK_CORE_L_BPLL_SRC_EN` reader - clk_core_l_bpll clock disable bit When HIGH, disable clock"]
pub type ClkCoreLBpllSrcEnR = crate::BitReader;
#[doc = "Field `CLK_CORE_L_BPLL_SRC_EN` writer - clk_core_l_bpll clock disable bit When HIGH, disable clock"]
pub type ClkCoreLBpllSrcEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CLK_CORE_L_DPLL_SRC_EN` reader - clk_core_l_dpll clock disable bit When HIGH, disable clock"]
pub type ClkCoreLDpllSrcEnR = crate::BitReader;
#[doc = "Field `CLK_CORE_L_DPLL_SRC_EN` writer - clk_core_l_dpll clock disable bit When HIGH, disable clock"]
pub type ClkCoreLDpllSrcEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CLK_CORE_L_GPLL_SRC_EN` reader - clk_core_l_gpll clock disable bit When HIGH, disable clock"]
pub type ClkCoreLGpllSrcEnR = crate::BitReader;
#[doc = "Field `CLK_CORE_L_GPLL_SRC_EN` writer - clk_core_l_gpll clock disable bit When HIGH, disable clock"]
pub type ClkCoreLGpllSrcEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ACLKM_CORE_L_EN` reader - aclkm_core_l clock disable bit When HIGH, disable clock"]
pub type AclkmCoreLEnR = crate::BitReader;
#[doc = "Field `ACLKM_CORE_L_EN` writer - aclkm_core_l clock disable bit When HIGH, disable clock"]
pub type AclkmCoreLEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ATCLK_CORE_L_EN` reader - atclk_core_l clock disable bit When HIGH, disable clock"]
pub type AtclkCoreLEnR = crate::BitReader;
#[doc = "Field `ATCLK_CORE_L_EN` writer - atclk_core_l clock disable bit When HIGH, disable clock"]
pub type AtclkCoreLEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PCLK_COREDBG_L_EN` reader - pclk_coredbg_l clock disable bit When HIGH, disable clock"]
pub type PclkCoredbgLEnR = crate::BitReader;
#[doc = "Field `PCLK_COREDBG_L_EN` writer - pclk_coredbg_l clock disable bit When HIGH, disable clock"]
pub type PclkCoredbgLEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CLK_PVTM_CORE_L_EN` reader - clk_pvtm_core_l clock disable bit When HIGH, disable clock"]
pub type ClkPvtmCoreLEnR = crate::BitReader;
#[doc = "Field `CLK_PVTM_CORE_L_EN` writer - clk_pvtm_core_l clock disable bit When HIGH, disable clock"]
pub type ClkPvtmCoreLEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `WRITE_MASK` writer - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
pub type WriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bit 0 - clk_core_l_lpll clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn clk_core_l_lpll_src_en(&self) -> ClkCoreLLpllSrcEnR {
        ClkCoreLLpllSrcEnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - clk_core_l_bpll clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn clk_core_l_bpll_src_en(&self) -> ClkCoreLBpllSrcEnR {
        ClkCoreLBpllSrcEnR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - clk_core_l_dpll clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn clk_core_l_dpll_src_en(&self) -> ClkCoreLDpllSrcEnR {
        ClkCoreLDpllSrcEnR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - clk_core_l_gpll clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn clk_core_l_gpll_src_en(&self) -> ClkCoreLGpllSrcEnR {
        ClkCoreLGpllSrcEnR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - aclkm_core_l clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn aclkm_core_l_en(&self) -> AclkmCoreLEnR {
        AclkmCoreLEnR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - atclk_core_l clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn atclk_core_l_en(&self) -> AtclkCoreLEnR {
        AtclkCoreLEnR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - pclk_coredbg_l clock disable bit When HIGH, disable clock"]
    #[inline(always)]
    pub fn pclk_coredbg_l_en(&self) -> PclkCoredbgLEnR {
        PclkCoredbgLEnR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - clk_pvtm_core_l clock disable bit When HIGH, disable clock"]
    #[inline(always)]
