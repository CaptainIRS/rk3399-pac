#[doc = "Register `CLKSEL_CON54` reader"]
pub type R = crate::R<ClkselCon54Spec>;
#[doc = "Register `CLKSEL_CON54` writer"]
pub type W = crate::W<ClkselCon54Spec>;
#[doc = "Field `ACLK_ISP1_DIV_CON` reader - aclk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type AclkIsp1DivConR = crate::FieldReader;
#[doc = "Field `ACLK_ISP1_DIV_CON` writer - aclk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
...
#[doc = "Field `HCLK_ISP1_DIV_CON` reader - hclk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type HclkIsp1DivConR = crate::FieldReader;
#[doc = "Field `HCLK_ISP1_DIV_CON` writer - hclk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type HclkIsp1DivConW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `WRITE_MASK` writer - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
pub type WriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:4 - aclk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:12 - hclk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_isp1_div_con(&mut self) -> AclkIsp1DivConW<ClkselCon54Spec> {
        AclkIsp1DivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - aclk_isp1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_isp1_pll_sel(&mut self) -> AclkIsp1PllSelW<ClkselCon54Spec> {
        AclkIsp1PllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - hclk_isp1 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_isp1_div_con(&mut self) -> HclkIsp1DivConW<ClkselCon54Spec> {
        HclkIsp1DivConW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon54Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register54\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con54::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con54::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon54Spec;
impl crate::RegisterSpec for ClkselCon54Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con54::R`](R) reader structure"]
impl crate::Readable for ClkselCon54Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con54::W`](W) writer structure"]
impl crate::Writable for ClkselCon54Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON54 to value 0x0101"]
impl crate::Resettable for ClkselCon54Spec {
