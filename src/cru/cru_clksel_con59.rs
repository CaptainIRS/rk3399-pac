#[doc = "Register `CRU_CLKSEL_CON59` reader"]
pub type R = crate::R<CruClkselCon59Spec>;
#[doc = "Register `CRU_CLKSEL_CON59` writer"]
pub type W = crate::W<CruClkselCon59Spec>;
#[doc = "Field `CLK_SPI0_DIV_CON` reader - spi0 divider control register clk=clk_src/(div_con+1)"]
pub type ClkSpi0DivConR = crate::FieldReader;
#[doc = "Field `CLK_SPI0_DIV_CON` writer - spi0 divider control register clk=clk_src/(div_con+1)"]
...
#[doc = "Field `CLK_SPI1_DIV_CON` reader - spi1 divider control register clk=clk_src/(div_con+1)"]
pub type ClkSpi1DivConR = crate::FieldReader;
#[doc = "Field `CLK_SPI1_DIV_CON` writer - spi1 divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:6 - spi0 divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:14 - spi1 divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_spi0_div_con(&mut self) -> ClkSpi0DivConW<CruClkselCon59Spec> {
        ClkSpi0DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_spi0 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi0_pll_sel(&mut self) -> ClkSpi0PllSelW<CruClkselCon59Spec> {
        ClkSpi0PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:14 - spi1 divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi1_div_con(&mut self) -> ClkSpi1DivConW<CruClkselCon59Spec> {
        ClkSpi1DivConW::new(self, 8)
    }
    #[doc = "Bit 15 - clk_spi1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi1_pll_sel(&mut self) -> ClkSpi1PllSelW<CruClkselCon59Spec> {
        ClkSpi1PllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon59Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register59\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con59::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con59::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon59Spec;
impl crate::RegisterSpec for CruClkselCon59Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con59::R`](R) reader structure"]
impl crate::Readable for CruClkselCon59Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con59::W`](W) writer structure"]
impl crate::Writable for CruClkselCon59Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON59 to value 0x0707"]
impl crate::Resettable for CruClkselCon59Spec {
