#[doc = "Register `DPLL_CON3` reader"]
pub type R = crate::R<DpllCon3Spec>;
#[doc = "Register `DPLL_CON3` writer"]
pub type W = crate::W<DpllCon3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn power_down(&mut self) -> PowerDownW<DpllCon3Spec> {
        PowerDownW::new(self, 0)
    }
    #[doc = "Bit 1 - PLL Bypass. FREF bypasses PLL to FOUTPOSTDIV"]
    #[inline(always)]
    #[must_use]
    pub fn bypass(&mut self) -> BypassW<DpllCon3Spec> {
        BypassW::new(self, 1)
    }
    #[doc = "Bit 2 - Power down quantization noise cancellation DAC"]
    #[inline(always)]
    #[must_use]
    pub fn dacpd(&mut self) -> DacpdW<DpllCon3Spec> {
        DacpdW::new(self, 2)
    }
    #[doc = "Bit 3 - PLL saturation behavior enable"]
    #[inline(always)]
    #[must_use]
    pub fn dsmpd(&mut self) -> DsmpdW<DpllCon3Spec> {
        DsmpdW::new(self, 3)
    }
    #[doc = "Bit 4 - Power down all outputs except for buffered VCO clock"]
    #[inline(always)]
    #[must_use]
    pub fn foutpostdivpd(&mut self) -> FoutpostdivpdW<DpllCon3Spec> {
        FoutpostdivpdW::new(self, 4)
    }
    #[doc = "Bit 5 - Power down buffered VCO clock"]
    #[inline(always)]
    #[must_use]
    pub fn foutvcopd(&mut self) -> FoutvcopdW<DpllCon3Spec> {
        FoutvcopdW::new(self, 5)
    }
    #[doc = "Bit 6 - Power down 4-phase clocks and 2X, 3X, 4X clocks"]
    #[inline(always)]
    #[must_use]
    pub fn fout4phasepd(&mut self) -> Fout4phasepdW<DpllCon3Spec> {
        Fout4phasepdW::new(self, 6)
    }
    #[doc = "Bits 8:9 - PLL work mode select"]
    #[inline(always)]
    #[must_use]
    pub fn pll_work_mode(&mut self) -> PllWorkModeW<DpllCon3Spec> {
        PllWorkModeW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<DpllCon3Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "DPLL configuration register3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dpll_con3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dpll_con3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DpllCon3Spec;
impl crate::RegisterSpec for DpllCon3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dpll_con3::R`](R) reader structure"]
impl crate::Readable for DpllCon3Spec {}
#[doc = "`write(|w| ..)` method takes [`dpll_con3::W`](W) writer structure"]
impl crate::Writable for DpllCon3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DPLL_CON3 to value 0x08"]
impl crate::Resettable for DpllCon3Spec {
