...
#[doc = "Field `GLB_SRST_SND_VALUE` reader - The second global software reset config value If config 0xeca8, it will generate second global software reset"]
pub type GlbSrstSndValueR = crate::FieldReader<u16>;
#[doc = "Field `GLB_SRST_SND_VALUE` writer - The second global software reset config value If config 0xeca8, it will generate second global software reset"]
pub type GlbSrstSndValueW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - The second global software reset config value If config 0xeca8, it will generate second global software reset"]
    #[inline(always)]
