#[doc = "Register `CLKSEL_CON22` reader"]
pub type R = crate::R<ClkselCon22Spec>;
#[doc = "Register `CLKSEL_CON22` writer"]
pub type W = crate::W<ClkselCon22Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_emmc_div_con(&mut self) -> ClkEmmcDivConW<ClkselCon22Spec> {
        ClkEmmcDivConW::new(self, 0)
    }
    #[doc = "Bits 8:10 - clk_emmc clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_emmc_pll_sel(&mut self) -> ClkEmmcPllSelW<ClkselCon22Spec> {
        ClkEmmcPllSelW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon22Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register22\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con22::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con22::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon22Spec;
impl crate::RegisterSpec for ClkselCon22Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con22::R`](R) reader structure"]
impl crate::Readable for ClkselCon22Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con22::W`](W) writer structure"]
impl crate::Writable for ClkselCon22Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON22 to value 0x0400"]
impl crate::Resettable for ClkselCon22Spec {
