#[doc = "Register `CLKSEL_CON52` reader"]
pub type R = crate::R<ClkselCon52Spec>;
#[doc = "Register `CLKSEL_CON52` writer"]
pub type W = crate::W<ClkselCon52Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_vop1_pwm_div_con(&mut self) -> ClkVop1PwmDivConW<ClkselCon52Spec> {
        ClkVop1PwmDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - vop1_pwm_src clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_vop1_pwm_src_sel(&mut self) -> ClkVop1PwmSrcSelW<ClkselCon52Spec> {
        ClkVop1PwmSrcSelW::new(self, 6)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon52Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register52\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con52::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con52::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon52Spec;
impl crate::RegisterSpec for ClkselCon52Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con52::R`](R) reader structure"]
impl crate::Readable for ClkselCon52Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con52::W`](W) writer structure"]
impl crate::Writable for ClkselCon52Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON52 to value 0x05"]
impl crate::Resettable for ClkselCon52Spec {
