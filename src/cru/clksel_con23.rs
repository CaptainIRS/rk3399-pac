#[doc = "Register `CLKSEL_CON23` reader"]
pub type R = crate::R<ClkselCon23Spec>;
#[doc = "Register `CLKSEL_CON23` writer"]
pub type W = crate::W<ClkselCon23Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_perilp0_div_con(&mut self) -> AclkPerilp0DivConW<ClkselCon23Spec> {
        AclkPerilp0DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - aclk_perilp0 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_perilp0_pll_sel(&mut self) -> AclkPerilp0PllSelW<ClkselCon23Spec> {
        AclkPerilp0PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:9 - perilp0_hclk divider control register\n\nclk=aclk_perilp0/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_perilp0_div_con(&mut self) -> HclkPerilp0DivConW<ClkselCon23Spec> {
        HclkPerilp0DivConW::new(self, 8)
    }
    #[doc = "Bits 12:14 - perilp0_pclk divider control register\n\nclk=aclk_perilp0/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_perilp0_div_con(&mut self) -> PclkPerilp0DivConW<ClkselCon23Spec> {
        PclkPerilp0DivConW::new(self, 12)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon23Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register23\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con23::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con23::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon23Spec;
impl crate::RegisterSpec for ClkselCon23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con23::R`](R) reader structure"]
impl crate::Readable for ClkselCon23Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con23::W`](W) writer structure"]
impl crate::Writable for ClkselCon23Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON23 to value 0x3181"]
impl crate::Resettable for ClkselCon23Spec {
