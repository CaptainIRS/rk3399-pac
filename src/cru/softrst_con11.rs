#[doc = "Register `SOFTRST_CON11` reader"]
pub type R = crate::R<SoftrstCon11Spec>;
#[doc = "Register `SOFTRST_CON11` writer"]
pub type W = crate::W<SoftrstCon11Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn presetn_dcf_req(&mut self) -> PresetnDcfReqW<SoftrstCon11Spec> {
        PresetnDcfReqW::new(self, 0)
    }
    #[doc = "Bit 1 - hresetn_cm0s_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_cm0s_noc_req(&mut self) -> HresetnCm0sNocReqW<SoftrstCon11Spec> {
        HresetnCm0sNocReqW::new(self, 1)
    }
    #[doc = "Bit 2 - hresetn_cm0s request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_cm0s_req(&mut self) -> HresetnCm0sReqW<SoftrstCon11Spec> {
        HresetnCm0sReqW::new(self, 2)
    }
    #[doc = "Bit 3 - dbgresetn_cm0s request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn dbgresetn_cm0s_req(&mut self) -> DbgresetnCm0sReqW<SoftrstCon11Spec> {
        DbgresetnCm0sReqW::new(self, 3)
    }
    #[doc = "Bit 4 - poresetn_cm0s request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn poresetn_cm0s_req(&mut self) -> PoresetnCm0sReqW<SoftrstCon11Spec> {
        PoresetnCm0sReqW::new(self, 4)
    }
    #[doc = "Bit 5 - resetn_crypto0 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_crypto0_req(&mut self) -> ResetnCrypto0ReqW<SoftrstCon11Spec> {
        ResetnCrypto0ReqW::new(self, 5)
    }
    #[doc = "Bit 6 - presetn_perilp1_sgrf request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_perilp1_sgrf_req(&mut self) -> PresetnPerilp1SgrfReqW<SoftrstCon11Spec> {
        PresetnPerilp1SgrfReqW::new(self, 6)
    }
    #[doc = "Bit 7 - presetn_perilp1_grf request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_perilp1_grf_req(&mut self) -> PresetnPerilp1GrfReqW<SoftrstCon11Spec> {
        PresetnPerilp1GrfReqW::new(self, 7)
    }
    #[doc = "Bit 8 - hresetn_crypto1_s request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_crypto1_s_req(&mut self) -> HresetnCrypto1SReqW<SoftrstCon11Spec> {
        HresetnCrypto1SReqW::new(self, 8)
    }
    #[doc = "Bit 9 - hresetn_crypto1_m request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_crypto1_m_req(&mut self) -> HresetnCrypto1MReqW<SoftrstCon11Spec> {
        HresetnCrypto1MReqW::new(self, 9)
    }
    #[doc = "Bit 10 - resetn_crypto1 request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_crypto1_req(&mut self) -> ResetnCrypto1ReqW<SoftrstCon11Spec> {
        ResetnCrypto1ReqW::new(self, 10)
    }
    #[doc = "Bit 12 - aresetn_gic_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_gic_noc_req(&mut self) -> AresetnGicNocReqW<SoftrstCon11Spec> {
        AresetnGicNocReqW::new(self, 12)
    }
    #[doc = "Bit 13 - hresetn_sd_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_sd_noc_req(&mut self) -> HresetnSdNocReqW<SoftrstCon11Spec> {
        HresetnSdNocReqW::new(self, 13)
    }
    #[doc = "Bit 14 - hresetn_sdioaudio_brg request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_sdioaudio_brg_req(&mut self) -> HresetnSdioaudioBrgReqW<SoftrstCon11Spec> {
        HresetnSdioaudioBrgReqW::new(self, 14)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<SoftrstCon11Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal software reset control register11\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`softrst_con11::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`softrst_con11::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SoftrstCon11Spec;
impl crate::RegisterSpec for SoftrstCon11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`softrst_con11::R`](R) reader structure"]
impl crate::Readable for SoftrstCon11Spec {}
#[doc = "`write(|w| ..)` method takes [`softrst_con11::W`](W) writer structure"]
impl crate::Writable for SoftrstCon11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOFTRST_CON11 to value 0x14"]
impl crate::Resettable for SoftrstCon11Spec {
