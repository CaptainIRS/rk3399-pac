#[doc = "Register `CLKSEL_CON25` reader"]
pub type R = crate::R<ClkselCon25Spec>;
#[doc = "Register `CLKSEL_CON25` writer"]
pub type W = crate::W<ClkselCon25Spec>;
#[doc = "Field `HCLK_PERILP1_DIV_CON` reader - hclk_perilp1 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type HclkPerilp1DivConR = crate::FieldReader;
#[doc = "Field `HCLK_PERILP1_DIV_CON` writer - hclk_perilp1 divider control register\n\nclk=clk_src/(div_con+1)"]
...
#[doc = "Field `PCLK_PERILP1_DIV_CON` reader - pclk_perilp1 divider control register\n\nclk=hclk_perilp1/(div_con+1)"]
pub type PclkPerilp1DivConR = crate::FieldReader;
#[doc = "Field `PCLK_PERILP1_DIV_CON` writer - pclk_perilp1 divider control register\n\nclk=hclk_perilp1/(div_con+1)"]
pub type PclkPerilp1DivConW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `WRITE_MASK` writer - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
pub type WriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:4 - hclk_perilp1 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:10 - pclk_perilp1 divider control register\n\nclk=hclk_perilp1/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hclk_perilp1_div_con(&mut self) -> HclkPerilp1DivConW<ClkselCon25Spec> {
        HclkPerilp1DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - hclk_perilp1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn hclk_perilp1_pll_sel(&mut self) -> HclkPerilp1PllSelW<ClkselCon25Spec> {
        HclkPerilp1PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:10 - pclk_perilp1 divider control register\n\nclk=hclk_perilp1/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_perilp1_div_con(&mut self) -> PclkPerilp1DivConW<ClkselCon25Spec> {
        PclkPerilp1DivConW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon25Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register25\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con25::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con25::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon25Spec;
impl crate::RegisterSpec for ClkselCon25Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con25::R`](R) reader structure"]
impl crate::Readable for ClkselCon25Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con25::W`](W) writer structure"]
impl crate::Writable for ClkselCon25Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON25 to value 0x0183"]
impl crate::Resettable for ClkselCon25Spec {
