#[doc = "Register `CLKSEL_CON58` reader"]
pub type R = crate::R<ClkselCon58Spec>;
#[doc = "Register `CLKSEL_CON58` writer"]
pub type W = crate::W<ClkselCon58Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_test_div_con(&mut self) -> ClkTestDivConW<ClkselCon58Spec> {
        ClkTestDivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_frac clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_testfrac_pll_sel(&mut self) -> ClkTestfracPllSelW<ClkselCon58Spec> {
        ClkTestfracPllSelW::new(self, 7)
    }
    #[doc = "Bits 8:14 - spi5 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi5_div_con(&mut self) -> ClkSpi5DivConW<ClkselCon58Spec> {
        ClkSpi5DivConW::new(self, 8)
    }
    #[doc = "Bit 15 - clk_spi5 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi5_pll_sel(&mut self) -> ClkSpi5PllSelW<ClkselCon58Spec> {
        ClkSpi5PllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon58Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register58\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con58::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con58::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon58Spec;
impl crate::RegisterSpec for ClkselCon58Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con58::R`](R) reader structure"]
impl crate::Readable for ClkselCon58Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con58::W`](W) writer structure"]
impl crate::Writable for ClkselCon58Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON58 to value 0x071f"]
impl crate::Resettable for ClkselCon58Spec {
