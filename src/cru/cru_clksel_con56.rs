...
#[doc = "Field `CLK_CIF_DIV_CON` reader - clk_cif divider control register clk=clk_src/(div_con+1)"]
pub type ClkCifDivConR = crate::FieldReader;
#[doc = "Field `CLK_CIF_DIV_CON` writer - clk_cif divider control register clk=clk_src/(div_con+1)"]
...
#[doc = "Field `ACLK_GIC_DIV_CON` reader - aclk_gic divider control register clk=clk_src/(div_con+1)"]
pub type AclkGicDivConR = crate::FieldReader;
#[doc = "Field `ACLK_GIC_DIV_CON` writer - aclk_gic divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:4 - clk_cif divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:12 - aclk_gic divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
