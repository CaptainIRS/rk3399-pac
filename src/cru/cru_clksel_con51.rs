#[doc = "Register `CRU_CLKSEL_CON51` reader"]
pub type R = crate::R<CruClkselCon51Spec>;
#[doc = "Register `CRU_CLKSEL_CON51` writer"]
pub type W = crate::W<CruClkselCon51Spec>;
#[doc = "Field `CLK_VOP0_PWM_DIV_CON` reader - vop0_pwm divider control register clk=clk_src/(div_con+1)"]
pub type ClkVop0PwmDivConR = crate::FieldReader;
#[doc = "Field `CLK_VOP0_PWM_DIV_CON` writer - vop0_pwm divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:4 - vop0_pwm divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_vop0_pwm_div_con(&mut self) -> ClkVop0PwmDivConW<CruClkselCon51Spec> {
        ClkVop0PwmDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - vop0_pwm_src clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_vop0_pwm_src_sel(&mut self) -> ClkVop0PwmSrcSelW<CruClkselCon51Spec> {
        ClkVop0PwmSrcSelW::new(self, 6)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon51Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register51\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con51::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con51::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon51Spec;
impl crate::RegisterSpec for CruClkselCon51Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con51::R`](R) reader structure"]
impl crate::Readable for CruClkselCon51Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con51::W`](W) writer structure"]
impl crate::Writable for CruClkselCon51Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON51 to value 0x05"]
impl crate::Resettable for CruClkselCon51Spec {
