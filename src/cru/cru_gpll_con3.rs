#[doc = "Register `CRU_GPLL_CON3` reader"]
pub type R = crate::R<CruGpllCon3Spec>;
#[doc = "Register `CRU_GPLL_CON3` writer"]
pub type W = crate::W<CruGpllCon3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn power_down(&mut self) -> PowerDownW<CruGpllCon3Spec> {
        PowerDownW::new(self, 0)
    }
    #[doc = "Bit 1 - PLL Bypass. FREF bypasses PLL to FOUTPOSTDIV"]
    #[inline(always)]
    #[must_use]
    pub fn bypass(&mut self) -> BypassW<CruGpllCon3Spec> {
        BypassW::new(self, 1)
    }
    #[doc = "Bit 2 - Power down quantization noise cancellation DAC"]
    #[inline(always)]
    #[must_use]
    pub fn dacpd(&mut self) -> DacpdW<CruGpllCon3Spec> {
        DacpdW::new(self, 2)
    }
    #[doc = "Bit 3 - PLL saturation behavior enable"]
    #[inline(always)]
    #[must_use]
    pub fn dsmpd(&mut self) -> DsmpdW<CruGpllCon3Spec> {
        DsmpdW::new(self, 3)
    }
    #[doc = "Bit 4 - Power down all outputs except for buffered VCO clock"]
    #[inline(always)]
    #[must_use]
    pub fn foutpostdivpd(&mut self) -> FoutpostdivpdW<CruGpllCon3Spec> {
        FoutpostdivpdW::new(self, 4)
    }
    #[doc = "Bit 5 - Power down buffered VCO clock"]
    #[inline(always)]
    #[must_use]
    pub fn foutvcopd(&mut self) -> FoutvcopdW<CruGpllCon3Spec> {
        FoutvcopdW::new(self, 5)
    }
    #[doc = "Bit 6 - Power down 4-phase clocks and 2X, 3X, 4X clocks"]
    #[inline(always)]
    #[must_use]
    pub fn fout4phasepd(&mut self) -> Fout4phasepdW<CruGpllCon3Spec> {
        Fout4phasepdW::new(self, 6)
    }
    #[doc = "Bits 8:9 - PLL work mode select"]
    #[inline(always)]
    #[must_use]
    pub fn pll_work_mode(&mut self) -> PllWorkModeW<CruGpllCon3Spec> {
        PllWorkModeW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruGpllCon3Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "GPLL configuration register3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_gpll_con3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_gpll_con3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruGpllCon3Spec;
impl crate::RegisterSpec for CruGpllCon3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_gpll_con3::R`](R) reader structure"]
impl crate::Readable for CruGpllCon3Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_gpll_con3::W`](W) writer structure"]
impl crate::Writable for CruGpllCon3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_GPLL_CON3 to value 0x08"]
impl crate::Resettable for CruGpllCon3Spec {
