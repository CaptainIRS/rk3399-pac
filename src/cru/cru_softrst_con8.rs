...
#[doc = "Field `ARESETN_PCIE_REQ` reader - aresetn_pcie request bit When HIGH, reset relative logic"]
pub type AresetnPcieReqR = crate::BitReader;
#[doc = "Field `ARESETN_PCIE_REQ` writer - aresetn_pcie request bit When HIGH, reset relative logic"]
pub type AresetnPcieReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PRESETN_PCIE_REQ` reader - presetn_pcie request bit When HIGH, reset relative logic"]
pub type PresetnPcieReqR = crate::BitReader;
#[doc = "Field `PRESETN_PCIE_REQ` writer - presetn_pcie request bit When HIGH, reset relative logic"]
pub type PresetnPcieReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESETN_PCIE_CORE_REQ` reader - resetn_pcie_core request bit When HIGH, reset relative logic"]
pub type ResetnPcieCoreReqR = crate::BitReader;
#[doc = "Field `RESETN_PCIE_CORE_REQ` writer - resetn_pcie_core request bit When HIGH, reset relative logic"]
pub type ResetnPcieCoreReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESETN_PCIE_MGMT_REQ` reader - resetn_pcie_mgmt request bit When HIGH, reset relative logic"]
pub type ResetnPcieMgmtReqR = crate::BitReader;
#[doc = "Field `RESETN_PCIE_MGMT_REQ` writer - resetn_pcie_mgmt request bit When HIGH, reset relative logic"]
pub type ResetnPcieMgmtReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESETN_PCIE_MGMT_STICKY_REQ` reader - resetn_pcie_mgmt_sticky request bit When HIGH, reset relative logic"]
pub type ResetnPcieMgmtStickyReqR = crate::BitReader;
#[doc = "Field `RESETN_PCIE_MGMT_STICKY_REQ` writer - resetn_pcie_mgmt_sticky request bit When HIGH, reset relative logic"]
pub type ResetnPcieMgmtStickyReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESETN_PCIE_PIPE_REQ` reader - resetn_pcie_pipe request bit When HIGH, reset relative logic"]
pub type ResetnPciePipeReqR = crate::BitReader;
#[doc = "Field `RESETN_PCIE_PIPE_REQ` writer - resetn_pcie_pipe request bit When HIGH, reset relative logic"]
pub type ResetnPciePipeReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESETN_PCIE_PM_REQ` reader - resetn_pcie_pm request bit When HIGH, reset relative logic"]
pub type ResetnPciePmReqR = crate::BitReader;
#[doc = "Field `RESETN_PCIE_PM_REQ` writer - resetn_pcie_pm request bit When HIGH, reset relative logic"]
pub type ResetnPciePmReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESETN_PCIEPHY_REQ` reader - resetn_pciephy request bit When HIGH, reset relative logic"]
pub type ResetnPciephyReqR = crate::BitReader;
#[doc = "Field `RESETN_PCIEPHY_REQ` writer - resetn_pciephy request bit When HIGH, reset relative logic"]
pub type ResetnPciephyReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ARESETN_GMAC_NOC_REQ` reader - aresetn_gmac_noc request bit When HIGH, reset relative logic"]
pub type AresetnGmacNocReqR = crate::BitReader;
#[doc = "Field `ARESETN_GMAC_NOC_REQ` writer - aresetn_gmac_noc request bit When HIGH, reset relative logic"]
pub type AresetnGmacNocReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ARESETN_GMAC_REQ` reader - aresetn_gmac request bit When HIGH, reset relative logic"]
pub type AresetnGmacReqR = crate::BitReader;
#[doc = "Field `ARESETN_GMAC_REQ` writer - aresetn_gmac request bit When HIGH, reset relative logic"]
pub type AresetnGmacReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PRESETN_GMAC_NOC_REQ` reader - presetn_gmac_noc request bit When HIGH, reset relative logic"]
pub type PresetnGmacNocReqR = crate::BitReader;
#[doc = "Field `PRESETN_GMAC_NOC_REQ` writer - presetn_gmac_noc request bit When HIGH, reset relative logic"]
pub type PresetnGmacNocReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PRESETN_GMAC_GRF_REQ` reader - presetn_gmac_grf request bit When HIGH, reset relative logic"]
pub type PresetnGmacGrfReqR = crate::BitReader;
#[doc = "Field `PRESETN_GMAC_GRF_REQ` writer - presetn_gmac_grf request bit When HIGH, reset relative logic"]
pub type PresetnGmacGrfReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HSICPHY_POR_RSTN_REQ` reader - hsicphy_por_rstn request bit When HIGH, reset relative logic"]
pub type HsicphyPorRstnReqR = crate::BitReader;
#[doc = "Field `HSICPHY_POR_RSTN_REQ` writer - hsicphy_por_rstn request bit When HIGH, reset relative logic"]
pub type HsicphyPorRstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HSICPHY_UTMI_RSTN_REQ` reader - hsicphy_utmi_rstn request bit When HIGH, reset relative logic"]
pub type HsicphyUtmiRstnReqR = crate::BitReader;
#[doc = "Field `HSICPHY_UTMI_RSTN_REQ` writer - hsicphy_utmi_rstn request bit When HIGH, reset relative logic"]
pub type HsicphyUtmiRstnReqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `WRITE_MASK` writer - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
pub type WriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bit 0 - aresetn_pcie request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn aresetn_pcie_req(&self) -> AresetnPcieReqR {
        AresetnPcieReqR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - presetn_pcie request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn presetn_pcie_req(&self) -> PresetnPcieReqR {
        PresetnPcieReqR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - resetn_pcie_core request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn resetn_pcie_core_req(&self) -> ResetnPcieCoreReqR {
        ResetnPcieCoreReqR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - resetn_pcie_mgmt request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn resetn_pcie_mgmt_req(&self) -> ResetnPcieMgmtReqR {
        ResetnPcieMgmtReqR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - resetn_pcie_mgmt_sticky request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn resetn_pcie_mgmt_sticky_req(&self) -> ResetnPcieMgmtStickyReqR {
        ResetnPcieMgmtStickyReqR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - resetn_pcie_pipe request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn resetn_pcie_pipe_req(&self) -> ResetnPciePipeReqR {
        ResetnPciePipeReqR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - resetn_pcie_pm request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn resetn_pcie_pm_req(&self) -> ResetnPciePmReqR {
        ResetnPciePmReqR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - resetn_pciephy request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn resetn_pciephy_req(&self) -> ResetnPciephyReqR {
        ResetnPciephyReqR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - aresetn_gmac_noc request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn aresetn_gmac_noc_req(&self) -> AresetnGmacNocReqR {
        AresetnGmacNocReqR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - aresetn_gmac request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn aresetn_gmac_req(&self) -> AresetnGmacReqR {
        AresetnGmacReqR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - presetn_gmac_noc request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn presetn_gmac_noc_req(&self) -> PresetnGmacNocReqR {
        PresetnGmacNocReqR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 12 - presetn_gmac_grf request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn presetn_gmac_grf_req(&self) -> PresetnGmacGrfReqR {
        PresetnGmacGrfReqR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 14 - hsicphy_por_rstn request bit When HIGH, reset relative logic"]
    #[inline(always)]
    pub fn hsicphy_por_rstn_req(&self) -> HsicphyPorRstnReqR {
        HsicphyPorRstnReqR::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - hsicphy_utmi_rstn request bit When HIGH, reset relative logic"]
    #[inline(always)]
