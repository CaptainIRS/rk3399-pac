#[doc = "Register `CLKSEL_CON32` reader"]
pub type R = crate::R<ClkselCon32Spec>;
#[doc = "Register `CLKSEL_CON32` writer"]
pub type W = crate::W<ClkselCon32Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_spdif_8ch_pll_div_con(&mut self) -> ClkSpdif8chPllDivConW<ClkselCon32Spec> {
        ClkSpdif8chPllDivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_spdif_8ch clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spdif_8ch_pll_sel(&mut self) -> ClkSpdif8chPllSelW<ClkselCon32Spec> {
        ClkSpdif8chPllSelW::new(self, 7)
    }
    #[doc = "Bits 8:12 - clk_dptx_spdif_rec divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_dptx_spdif_rec_div_con(&mut self) -> ClkDptxSpdifRecDivConW<ClkselCon32Spec> {
        ClkDptxSpdifRecDivConW::new(self, 8)
    }
    #[doc = "Bits 13:14 - clk_spdif_8ch clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spdif_8ch_clk_sel(&mut self) -> ClkSpdif8chClkSelW<ClkselCon32Spec> {
        ClkSpdif8chClkSelW::new(self, 13)
    }
    #[doc = "Bit 15 - clk_dptx_spdif_rec clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_dptx_spdif_rec_pll_sel(&mut self) -> ClkDptxSpdifRecPllSelW<ClkselCon32Spec> {
        ClkDptxSpdifRecPllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon32Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register32\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con32::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con32::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon32Spec;
impl crate::RegisterSpec for ClkselCon32Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con32::R`](R) reader structure"]
impl crate::Readable for ClkselCon32Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con32::W`](W) writer structure"]
impl crate::Writable for ClkselCon32Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON32 to value 0x6300"]
impl crate::Resettable for ClkselCon32Spec {
