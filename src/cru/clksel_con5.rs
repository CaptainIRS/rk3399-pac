...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_cci_div_con(&mut self) -> AclkCciDivConW<ClkselCon5Spec> {
        AclkCciDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - aclk_cci clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_cci_pll_sel(&mut self) -> AclkCciPllSelW<ClkselCon5Spec> {
        AclkCciPllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - clk_cci_trace divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_cci_trace_div_con(&mut self) -> ClkCciTraceDivConW<ClkselCon5Spec> {
        ClkCciTraceDivConW::new(self, 8)
    }
    #[doc = "Bit 15 - clk_cci_trace clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_cci_trace_pll_sel(&mut self) -> ClkCciTracePllSelW<ClkselCon5Spec> {
...
#[doc = "`reset()` method sets CLKSEL_CON5 to value 0x8341"]
