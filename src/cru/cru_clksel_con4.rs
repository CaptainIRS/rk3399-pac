#[doc = "Register `CRU_CLKSEL_CON4` reader"]
pub type R = crate::R<CruClkselCon4Spec>;
#[doc = "Register `CRU_CLKSEL_CON4` writer"]
pub type W = crate::W<CruClkselCon4Spec>;
#[doc = "Field `CLK_CS_DIV_CON` reader - clk_cs divider control register clk=clk_src/(div_con+1)"]
pub type ClkCsDivConR = crate::FieldReader;
#[doc = "Field `CLK_CS_DIV_CON` writer - clk_cs divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:4 - clk_cs divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_cs_div_con(&mut self) -> ClkCsDivConW<CruClkselCon4Spec> {
        ClkCsDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - clk_cs clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_cs_pll_sel(&mut self) -> ClkCsPllSelW<CruClkselCon4Spec> {
        ClkCsPllSelW::new(self, 6)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon4Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon4Spec;
impl crate::RegisterSpec for CruClkselCon4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con4::R`](R) reader structure"]
impl crate::Readable for CruClkselCon4Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con4::W`](W) writer structure"]
impl crate::Writable for CruClkselCon4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON4 to value 0x41"]
impl crate::Resettable for CruClkselCon4Spec {
