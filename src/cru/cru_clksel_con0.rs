#[doc = "Register `CRU_CLKSEL_CON0` reader"]
pub type R = crate::R<CruClkselCon0Spec>;
#[doc = "Register `CRU_CLKSEL_CON0` writer"]
pub type W = crate::W<CruClkselCon0Spec>;
#[doc = "Field `CLK_CORE_L_DIV_CON` reader - clk_core_l divider control register clk=clk_src/(div_con+1)"]
pub type ClkCoreLDivConR = crate::FieldReader;
#[doc = "Field `CLK_CORE_L_DIV_CON` writer - clk_core_l divider control register clk=clk_src/(div_con+1)"]
...
#[doc = "Field `ACLKM_CORE_L_DIV_CON` reader - aclkm_core_l divider control register clk=clk_src/(div_con+1)"]
pub type AclkmCoreLDivConR = crate::FieldReader;
#[doc = "Field `ACLKM_CORE_L_DIV_CON` writer - aclkm_core_l divider control register clk=clk_src/(div_con+1)"]
pub type AclkmCoreLDivConW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `WRITE_MASK` writer - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
pub type WriteMaskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:4 - clk_core_l divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:12 - aclkm_core_l divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_core_l_div_con(&mut self) -> ClkCoreLDivConW<CruClkselCon0Spec> {
        ClkCoreLDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - clk_core_l clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_core_l_pll_sel(&mut self) -> ClkCoreLPllSelW<CruClkselCon0Spec> {
        ClkCoreLPllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - aclkm_core_l divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn aclkm_core_l_div_con(&mut self) -> AclkmCoreLDivConW<CruClkselCon0Spec> {
        AclkmCoreLDivConW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon0Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon0Spec;
impl crate::RegisterSpec for CruClkselCon0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con0::R`](R) reader structure"]
impl crate::Readable for CruClkselCon0Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con0::W`](W) writer structure"]
impl crate::Writable for CruClkselCon0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON0 to value 0x0101"]
impl crate::Resettable for CruClkselCon0Spec {
