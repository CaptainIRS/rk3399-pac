#[doc = "Register `CRU_CLKSEL_CON24` reader"]
pub type R = crate::R<CruClkselCon24Spec>;
#[doc = "Register `CRU_CLKSEL_CON24` writer"]
pub type W = crate::W<CruClkselCon24Spec>;
#[doc = "Field `CLK_CRYPTO0_DIV_CON` reader - clk_crypto0 divider control register clk=clk_src/(div_con+1)"]
pub type ClkCrypto0DivConR = crate::FieldReader;
#[doc = "Field `CLK_CRYPTO0_DIV_CON` writer - clk_crypto0 divider control register clk=clk_src/(div_con+1)"]
...
#[doc = "Field `FCLK_CM0S_DIV_CON` reader - fclk_cm0s divider control register clk=clk_src/(div_con+1)"]
pub type FclkCm0sDivConR = crate::FieldReader;
#[doc = "Field `FCLK_CM0S_DIV_CON` writer - fclk_cm0s divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:4 - clk_crypto0 divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:12 - fclk_cm0s divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_crypto0_div_con(&mut self) -> ClkCrypto0DivConW<CruClkselCon24Spec> {
        ClkCrypto0DivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - clk_crypto0 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_crypto0_pll_sel(&mut self) -> ClkCrypto0PllSelW<CruClkselCon24Spec> {
        ClkCrypto0PllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - fclk_cm0s divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn fclk_cm0s_div_con(&mut self) -> FclkCm0sDivConW<CruClkselCon24Spec> {
        FclkCm0sDivConW::new(self, 8)
    }
    #[doc = "Bit 15 - fclk_cm0s clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn fclk_cm0s_pll_sel(&mut self) -> FclkCm0sPllSelW<CruClkselCon24Spec> {
        FclkCm0sPllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon24Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register24\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con24::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con24::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon24Spec;
impl crate::RegisterSpec for CruClkselCon24Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con24::R`](R) reader structure"]
impl crate::Readable for CruClkselCon24Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con24::W`](W) writer structure"]
impl crate::Writable for CruClkselCon24Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON24 to value 0x8103"]
impl crate::Resettable for CruClkselCon24Spec {
