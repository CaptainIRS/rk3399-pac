#[doc = "Register `CLKSEL_CON60` reader"]
pub type R = crate::R<ClkselCon60Spec>;
#[doc = "Register `CLKSEL_CON60` writer"]
pub type W = crate::W<ClkselCon60Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_spi2_div_con(&mut self) -> ClkSpi2DivConW<ClkselCon60Spec> {
        ClkSpi2DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_spi2 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi2_pll_sel(&mut self) -> ClkSpi2PllSelW<ClkselCon60Spec> {
        ClkSpi2PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:14 - spi4 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi4_div_con(&mut self) -> ClkSpi4DivConW<ClkselCon60Spec> {
        ClkSpi4DivConW::new(self, 8)
    }
    #[doc = "Bit 15 - clk_spi4 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi4_pll_sel(&mut self) -> ClkSpi4PllSelW<ClkselCon60Spec> {
        ClkSpi4PllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon60Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register60\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con60::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con60::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon60Spec;
impl crate::RegisterSpec for ClkselCon60Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con60::R`](R) reader structure"]
impl crate::Readable for ClkselCon60Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con60::W`](W) writer structure"]
impl crate::Writable for ClkselCon60Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON60 to value 0x0707"]
impl crate::Resettable for ClkselCon60Spec {
