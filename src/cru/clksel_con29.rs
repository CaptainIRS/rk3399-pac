#[doc = "Register `CLKSEL_CON29` reader"]
pub type R = crate::R<ClkselCon29Spec>;
#[doc = "Register `CLKSEL_CON29` writer"]
pub type W = crate::W<ClkselCon29Spec>;
#[doc = "Field `CLK_I2S1_DIV_CON` reader - clk_i2s1 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type ClkI2s1DivConR = crate::FieldReader;
#[doc = "Field `CLK_I2S1_DIV_CON` writer - clk_i2s1 divider control register\n\nclk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:6 - clk_i2s1 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_i2s1_div_con(&mut self) -> ClkI2s1DivConW<ClkselCon29Spec> {
        ClkI2s1DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_i2s1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2s1_pll_sel(&mut self) -> ClkI2s1PllSelW<ClkselCon29Spec> {
        ClkI2s1PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:9 - clk_i2s1 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_i2s1_sel(&mut self) -> ClkI2s1SelW<ClkselCon29Spec> {
        ClkI2s1SelW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon29Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register29\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con29::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con29::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon29Spec;
impl crate::RegisterSpec for ClkselCon29Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con29::R`](R) reader structure"]
impl crate::Readable for ClkselCon29Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con29::W`](W) writer structure"]
impl crate::Writable for ClkselCon29Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON29 to value 0x0300"]
impl crate::Resettable for ClkselCon29Spec {
