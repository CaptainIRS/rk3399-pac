#[doc = "Register `CLKSEL_CON56` reader"]
pub type R = crate::R<ClkselCon56Spec>;
#[doc = "Register `CLKSEL_CON56` writer"]
pub type W = crate::W<ClkselCon56Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_cif_div_con(&mut self) -> ClkCifDivConW<ClkselCon56Spec> {
        ClkCifDivConW::new(self, 0)
    }
    #[doc = "Bit 5 - clk_cif clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_cif_clk_sel(&mut self) -> ClkCifClkSelW<ClkselCon56Spec> {
        ClkCifClkSelW::new(self, 5)
    }
    #[doc = "Bits 6:7 - clk_cif clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_cif_pll_sel(&mut self) -> ClkCifPllSelW<ClkselCon56Spec> {
        ClkCifPllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - aclk_gic divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_gic_div_con(&mut self) -> AclkGicDivConW<ClkselCon56Spec> {
        AclkGicDivConW::new(self, 8)
    }
    #[doc = "Bit 15 - aclk_gic source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_gic_pll_sel(&mut self) -> AclkGicPllSelW<ClkselCon56Spec> {
        AclkGicPllSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon56Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register56\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con56::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con56::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon56Spec;
impl crate::RegisterSpec for ClkselCon56Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con56::R`](R) reader structure"]
impl crate::Readable for ClkselCon56Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con56::W`](W) writer structure"]
impl crate::Writable for ClkselCon56Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON56 to value 0x0320"]
impl crate::Resettable for ClkselCon56Spec {
