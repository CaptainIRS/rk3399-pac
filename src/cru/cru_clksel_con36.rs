#[doc = "Register `CRU_CLKSEL_CON36` reader"]
pub type R = crate::R<CruClkselCon36Spec>;
#[doc = "Register `CRU_CLKSEL_CON36` writer"]
pub type W = crate::W<CruClkselCon36Spec>;
#[doc = "Field `CLK_UART3_DIV_CON` reader - clk_uart3 divider control register clk=clk_src/(div_con+1)"]
pub type ClkUart3DivConR = crate::FieldReader;
#[doc = "Field `CLK_UART3_DIV_CON` writer - clk_uart3 divider control register clk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:6 - clk_uart3 divider control register clk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_uart3_div_con(&mut self) -> ClkUart3DivConW<CruClkselCon36Spec> {
        ClkUart3DivConW::new(self, 0)
    }
    #[doc = "Bits 8:9 - clk_uart3 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uart3_sel(&mut self) -> ClkUart3SelW<CruClkselCon36Spec> {
        ClkUart3SelW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits When every bit HIGH, enable the writing corresponding bit When every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<CruClkselCon36Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register36\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cru_clksel_con36::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cru_clksel_con36::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CruClkselCon36Spec;
impl crate::RegisterSpec for CruClkselCon36Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cru_clksel_con36::R`](R) reader structure"]
impl crate::Readable for CruClkselCon36Spec {}
#[doc = "`write(|w| ..)` method takes [`cru_clksel_con36::W`](W) writer structure"]
impl crate::Writable for CruClkselCon36Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRU_CLKSEL_CON36 to value 0x0200"]
impl crate::Resettable for CruClkselCon36Spec {
