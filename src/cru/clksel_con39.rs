#[doc = "Register `CLKSEL_CON39` reader"]
pub type R = crate::R<ClkselCon39Spec>;
#[doc = "Register `CLKSEL_CON39` writer"]
pub type W = crate::W<ClkselCon39Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_usb3_div_con(&mut self) -> AclkUsb3DivConW<ClkselCon39Spec> {
        AclkUsb3DivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - aclk_usb3 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_usb3_pll_sel(&mut self) -> AclkUsb3PllSelW<ClkselCon39Spec> {
        AclkUsb3PllSelW::new(self, 6)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon39Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register39\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con39::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con39::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon39Spec;
impl crate::RegisterSpec for ClkselCon39Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con39::R`](R) reader structure"]
impl crate::Readable for ClkselCon39Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con39::W`](W) writer structure"]
impl crate::Writable for ClkselCon39Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON39 to value 0x41"]
impl crate::Resettable for ClkselCon39Spec {
