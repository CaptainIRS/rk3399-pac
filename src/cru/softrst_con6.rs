#[doc = "Register `SOFTRST_CON6` reader"]
pub type R = crate::R<SoftrstCon6Spec>;
#[doc = "Register `SOFTRST_CON6` writer"]
pub type W = crate::W<SoftrstCon6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aresetn_iep_noc_req(&mut self) -> AresetnIepNocReqW<SoftrstCon6Spec> {
        AresetnIepNocReqW::new(self, 0)
    }
    #[doc = "Bit 1 - aresetn_vop_iep request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_vop_iep_req(&mut self) -> AresetnVopIepReqW<SoftrstCon6Spec> {
        AresetnVopIepReqW::new(self, 1)
    }
    #[doc = "Bit 2 - aresetn_iep request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_iep_req(&mut self) -> AresetnIepReqW<SoftrstCon6Spec> {
        AresetnIepReqW::new(self, 2)
    }
    #[doc = "Bit 3 - hresetn_iep_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_iep_noc_req(&mut self) -> HresetnIepNocReqW<SoftrstCon6Spec> {
        HresetnIepNocReqW::new(self, 3)
    }
    #[doc = "Bit 4 - hresetn_iep request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_iep_req(&mut self) -> HresetnIepReqW<SoftrstCon6Spec> {
        HresetnIepReqW::new(self, 4)
    }
    #[doc = "Bit 6 - aresetn_rga_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_rga_noc_req(&mut self) -> AresetnRgaNocReqW<SoftrstCon6Spec> {
        AresetnRgaNocReqW::new(self, 6)
    }
    #[doc = "Bit 7 - aresetn_rga request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_rga_req(&mut self) -> AresetnRgaReqW<SoftrstCon6Spec> {
        AresetnRgaReqW::new(self, 7)
    }
    #[doc = "Bit 8 - hresetn_rga_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_rga_noc_req(&mut self) -> HresetnRgaNocReqW<SoftrstCon6Spec> {
        HresetnRgaNocReqW::new(self, 8)
    }
    #[doc = "Bit 9 - hresetn_rga request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_rga_req(&mut self) -> HresetnRgaReqW<SoftrstCon6Spec> {
        HresetnRgaReqW::new(self, 9)
    }
    #[doc = "Bit 10 - resetn_rga_core request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_rga_core_req(&mut self) -> ResetnRgaCoreReqW<SoftrstCon6Spec> {
        ResetnRgaCoreReqW::new(self, 10)
    }
    #[doc = "Bit 12 - aresetn_emmc_noc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_emmc_noc_req(&mut self) -> AresetnEmmcNocReqW<SoftrstCon6Spec> {
        AresetnEmmcNocReqW::new(self, 12)
    }
    #[doc = "Bit 13 - aresetn_emmc request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_emmc_req(&mut self) -> AresetnEmmcReqW<SoftrstCon6Spec> {
        AresetnEmmcReqW::new(self, 13)
    }
    #[doc = "Bit 14 - aresetn_emmc_grf request bit\n\nWhen HIGH, reset relative logic"]
    #[inline(always)]
    #[must_use]
    pub fn aresetn_emmc_grf_req(&mut self) -> AresetnEmmcGrfReqW<SoftrstCon6Spec> {
        AresetnEmmcGrfReqW::new(self, 14)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<SoftrstCon6Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal software reset control register6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`softrst_con6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`softrst_con6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SoftrstCon6Spec;
impl crate::RegisterSpec for SoftrstCon6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`softrst_con6::R`](R) reader structure"]
impl crate::Readable for SoftrstCon6Spec {}
#[doc = "`write(|w| ..)` method takes [`softrst_con6::W`](W) writer structure"]
impl crate::Writable for SoftrstCon6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOFTRST_CON6 to value 0"]
impl crate::Resettable for SoftrstCon6Spec {
