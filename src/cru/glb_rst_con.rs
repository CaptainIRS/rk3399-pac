#[doc = "Register `GLB_RST_CON` reader"]
pub type R = crate::R<GlbRstConSpec>;
#[doc = "Register `GLB_RST_CON` writer"]
pub type W = crate::W<GlbRstConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsadc_glb_srst_ctrl(&mut self) -> TsadcGlbSrstCtrlW<GlbRstConSpec> {
        TsadcGlbSrstCtrlW::new(self, 0)
    }
    #[doc = "Bit 1 - watch_dog trigger global soft reset select"]
    #[inline(always)]
    #[must_use]
    pub fn wdt_glb_srst_ctrl(&mut self) -> WdtGlbSrstCtrlW<GlbRstConSpec> {
        WdtGlbSrstCtrlW::new(self, 1)
    }
    #[doc = "Bits 2:3 - pmu reset by global soft reset select"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_glb_srst_ctrl(&mut self) -> PmuGlbSrstCtrlW<GlbRstConSpec> {
        PmuGlbSrstCtrlW::new(self, 2)
    }
    #[doc = "Bit 4 - if pmu reset by wdt resetn src select"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_glbrst_wdt_ctrl(&mut self) -> PmuGlbrstWdtCtrlW<GlbRstConSpec> {
        PmuGlbrstWdtCtrlW::new(self, 4)
    }
}
#[doc = "Global reset trigger select\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`glb_rst_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`glb_rst_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GlbRstConSpec;
impl crate::RegisterSpec for GlbRstConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`glb_rst_con::R`](R) reader structure"]
impl crate::Readable for GlbRstConSpec {}
#[doc = "`write(|w| ..)` method takes [`glb_rst_con::W`](W) writer structure"]
impl crate::Writable for GlbRstConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GLB_RST_CON to value 0"]
impl crate::Resettable for GlbRstConSpec {
