#[doc = "Register `CLKSEL_CON35` reader"]
pub type R = crate::R<ClkselCon35Spec>;
#[doc = "Register `CLKSEL_CON35` writer"]
pub type W = crate::W<ClkselCon35Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_uart2_div_con(&mut self) -> ClkUart2DivConW<ClkselCon35Spec> {
        ClkUart2DivConW::new(self, 0)
    }
    #[doc = "Bits 8:9 - clk_uart2 clock select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uart2_sel(&mut self) -> ClkUart2SelW<ClkselCon35Spec> {
        ClkUart2SelW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon35Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register35\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con35::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con35::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon35Spec;
impl crate::RegisterSpec for ClkselCon35Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con35::R`](R) reader structure"]
impl crate::Readable for ClkselCon35Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con35::W`](W) writer structure"]
impl crate::Writable for ClkselCon35Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON35 to value 0x0200"]
impl crate::Resettable for ClkselCon35Spec {
