#[doc = "Register `CLKGATE_CON32` reader"]
pub type R = crate::R<ClkgateCon32Spec>;
#[doc = "Register `CLKGATE_CON32` writer"]
pub type W = crate::W<ClkgateCon32Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclk_gmac_en(&mut self) -> AclkGmacEnW<ClkgateCon32Spec> {
        AclkGmacEnW::new(self, 0)
    }
    #[doc = "Bit 1 - aclk_gmac_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_gmac_noc_en(&mut self) -> AclkGmacNocEnW<ClkgateCon32Spec> {
        AclkGmacNocEnW::new(self, 1)
    }
    #[doc = "Bit 2 - pclk_gmac clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_gmac_en(&mut self) -> PclkGmacEnW<ClkgateCon32Spec> {
        PclkGmacEnW::new(self, 2)
    }
    #[doc = "Bit 3 - pclk_gmac_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_gmac_noc_en(&mut self) -> PclkGmacNocEnW<ClkgateCon32Spec> {
        PclkGmacNocEnW::new(self, 3)
    }
    #[doc = "Bit 4 - aclk_perf_gmac clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_perf_gmac_en(&mut self) -> AclkPerfGmacEnW<ClkgateCon32Spec> {
        AclkPerfGmacEnW::new(self, 4)
    }
    #[doc = "Bit 8 - aclk_emmc_core clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_emmc_core_en(&mut self) -> AclkEmmcCoreEnW<ClkgateCon32Spec> {
        AclkEmmcCoreEnW::new(self, 8)
    }
    #[doc = "Bit 9 - aclk_emmc_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_emmc_noc_en(&mut self) -> AclkEmmcNocEnW<ClkgateCon32Spec> {
        AclkEmmcNocEnW::new(self, 9)
    }
    #[doc = "Bit 10 - aclk_emmc_grf clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_emmc_grf_en(&mut self) -> AclkEmmcGrfEnW<ClkgateCon32Spec> {
        AclkEmmcGrfEnW::new(self, 10)
    }
    #[doc = "Bit 12 - pclk_edp_noc clock disable bit\n\nWhen HIGH, disable clock\n\nSuggest always on"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_edp_noc_en(&mut self) -> PclkEdpNocEnW<ClkgateCon32Spec> {
        PclkEdpNocEnW::new(self, 12)
    }
    #[doc = "Bit 13 - pclk_edp_ctrl clock disable bit\n\nWhen HIGH, disable clock"]
    #[inline(always)]
    #[must_use]
    pub fn pclk_edp_ctrl_en(&mut self) -> PclkEdpCtrlEnW<ClkgateCon32Spec> {
        PclkEdpCtrlEnW::new(self, 13)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkgateCon32Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock gating register32\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clkgate_con32::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clkgate_con32::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkgateCon32Spec;
impl crate::RegisterSpec for ClkgateCon32Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clkgate_con32::R`](R) reader structure"]
impl crate::Readable for ClkgateCon32Spec {}
#[doc = "`write(|w| ..)` method takes [`clkgate_con32::W`](W) writer structure"]
impl crate::Writable for ClkgateCon32Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKGATE_CON32 to value 0"]
impl crate::Resettable for ClkgateCon32Spec {
