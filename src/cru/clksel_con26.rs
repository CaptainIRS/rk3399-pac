#[doc = "Register `CLKSEL_CON26` reader"]
pub type R = crate::R<ClkselCon26Spec>;
#[doc = "Register `CLKSEL_CON26` writer"]
pub type W = crate::W<ClkselCon26Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_crypto1_div_con(&mut self) -> ClkCrypto1DivConW<ClkselCon26Spec> {
        ClkCrypto1DivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - clk_crypto1 clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_crypto1_pll_sel(&mut self) -> ClkCrypto1PllSelW<ClkselCon26Spec> {
        ClkCrypto1PllSelW::new(self, 6)
    }
    #[doc = "Bits 8:15 - clk_saradc divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_saradc_div_con(&mut self) -> ClkSaradcDivConW<ClkselCon26Spec> {
        ClkSaradcDivConW::new(self, 8)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon26Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register26\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con26::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con26::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon26Spec;
impl crate::RegisterSpec for ClkselCon26Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con26::R`](R) reader structure"]
impl crate::Readable for ClkselCon26Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con26::W`](W) writer structure"]
impl crate::Writable for ClkselCon26Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON26 to value 0x0103"]
impl crate::Resettable for ClkselCon26Spec {
