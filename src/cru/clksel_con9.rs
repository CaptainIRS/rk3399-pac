#[doc = "Register `CLKSEL_CON9` reader"]
pub type R = crate::R<ClkselCon9Spec>;
#[doc = "Register `CLKSEL_CON9` writer"]
pub type W = crate::W<ClkselCon9Spec>;
#[doc = "Field `CLK_VDU_CORE_DIV_CON` reader - clk_vdu_core divider control register\n\nclk=clk_src/(div_con+1)"]
pub type ClkVduCoreDivConR = crate::FieldReader;
#[doc = "Field `CLK_VDU_CORE_DIV_CON` writer - clk_vdu_core divider control register\n\nclk=clk_src/(div_con+1)"]
...
#[doc = "Field `CLK_VDU_CA_DIV_CON` reader - clk_vdu_ca divider control register\n\nclk=clk_src/(div_con+1)"]
pub type ClkVduCaDivConR = crate::FieldReader;
#[doc = "Field `CLK_VDU_CA_DIV_CON` writer - clk_vdu_ca divider control register\n\nclk=clk_src/(div_con+1)"]
...
impl R {
    #[doc = "Bits 0:4 - clk_vdu_core divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:12 - clk_vdu_ca divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_vdu_core_div_con(&mut self) -> ClkVduCoreDivConW<ClkselCon9Spec> {
        ClkVduCoreDivConW::new(self, 0)
    }
    #[doc = "Bits 6:7 - clk_vdu_core clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_vdu_core_pll_sel(&mut self) -> ClkVduCorePllSelW<ClkselCon9Spec> {
        ClkVduCorePllSelW::new(self, 6)
    }
    #[doc = "Bits 8:12 - clk_vdu_ca divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_vdu_ca_div_con(&mut self) -> ClkVduCaDivConW<ClkselCon9Spec> {
        ClkVduCaDivConW::new(self, 8)
    }
    #[doc = "Bits 14:15 - clk_vdu_ca clock source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_vdu_ca_pll_sel(&mut self) -> ClkVduCaPllSelW<ClkselCon9Spec> {
        ClkVduCaPllSelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon9Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register9\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon9Spec;
impl crate::RegisterSpec for ClkselCon9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con9::R`](R) reader structure"]
impl crate::Readable for ClkselCon9Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con9::W`](W) writer structure"]
impl crate::Writable for ClkselCon9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON9 to value 0x4141"]
impl crate::Resettable for ClkselCon9Spec {
