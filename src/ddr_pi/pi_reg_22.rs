#[doc = "Register `PI_REG_22` reader"]
pub type R = crate::R<PiReg22Spec>;
#[doc = "Register `PI_REG_22` writer"]
pub type W = crate::W<PiReg22Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_control_error_status(&mut self) -> PiControlErrorStatusW<PiReg22Spec> {
        PiControlErrorStatusW::new(self, 0)
    }
    #[doc = "Bit 16 - Releases the DFI bus after complete initialization CA training and requests DFI bus again for the remaining initialization training. The DFI bus release is for the controller to issue MRW/ZQ after the PI completes initialization CA leveling, based on the JEDEC protocol requirement."]
    #[inline(always)]
    #[must_use]
    pub fn pi_exit_after_init_calvl(&mut self) -> PiExitAfterInitCalvlW<PiReg22Spec> {
        PiExitAfterInitCalvlW::new(self, 16)
    }
}
#[doc = "DDR PHY Independent Register 22\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_22::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_22::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg22Spec;
impl crate::RegisterSpec for PiReg22Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_22::R`](R) reader structure"]
impl crate::Readable for PiReg22Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_22::W`](W) writer structure"]
impl crate::Writable for PiReg22Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_22 to value 0x0001_0000"]
impl crate::Resettable for PiReg22Spec {
