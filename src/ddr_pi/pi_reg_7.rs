#[doc = "Register `PI_REG_7` reader"]
pub type R = crate::R<PiReg7Spec>;
#[doc = "Register `PI_REG_7` writer"]
pub type W = crate::W<PiReg7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_phymstr_resp_f2(&mut self) -> PiTdfiPhymstrRespF2W<PiReg7Spec> {
        PiTdfiPhymstrRespF2W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Defines the DFI tPHYUPD_RESP timing parameter (in DFI clocks), the maximum cycles between a dfi_phyupd_req assertion and a dfi_phyupd_ack assertion. If programmed to a non-zero, a timing violation causes an interrupt and bit8 set in the PI_REG_193.pi_update_error_status parameter and bit8 set in the PI_REG_22.pi_control_error_status parameter. The suffix f0 of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_phyupd_resp_f0(&mut self) -> PiTdfiPhyupdRespF0W<PiReg7Spec> {
        PiTdfiPhyupdRespF0W::new(self, 16)
    }
}
#[doc = "DDR PHY Independent Register 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg7Spec;
impl crate::RegisterSpec for PiReg7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_7::R`](R) reader structure"]
impl crate::Readable for PiReg7Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_7::W`](W) writer structure"]
impl crate::Writable for PiReg7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_7 to value 0"]
impl crate::Resettable for PiReg7Spec {
