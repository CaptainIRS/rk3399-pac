#[doc = "Register `PI_REG_140` reader"]
pub type R = crate::R<PiReg140Spec>;
#[doc = "Register `PI_REG_140` writer"]
pub type W = crate::W<PiReg140Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_mr14_data_f2_1(&mut self) -> PiMr14DataF2_1W<PiReg140Spec> {
        PiMr14DataF2_1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Indicates data to program into memory mode register 13 for chip select 0."]
    #[inline(always)]
    #[must_use]
    pub fn pi_mr13_data_1(&mut self) -> PiMr13Data1W<PiReg140Spec> {
        PiMr13Data1W::new(self, 8)
    }
}
#[doc = "DDR PHY Independent Register 140\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_140::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_140::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg140Spec;
impl crate::RegisterSpec for PiReg140Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_140::R`](R) reader structure"]
impl crate::Readable for PiReg140Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_140::W`](W) writer structure"]
impl crate::Writable for PiReg140Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_140 to value 0"]
impl crate::Resettable for PiReg140Spec {
