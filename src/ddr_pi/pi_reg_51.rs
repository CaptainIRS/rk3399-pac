#[doc = "Register `PI_REG_51` reader"]
pub type R = crate::R<PiReg51Spec>;
...
#[doc = "DDR PHY Independent Register 51\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_51::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg51Spec;
impl crate::RegisterSpec for PiReg51Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_51::R`](R) reader structure"]
impl crate::Readable for PiReg51Spec {}
#[doc = "`reset()` method sets PI_REG_51 to value 0"]
impl crate::Resettable for PiReg51Spec {
