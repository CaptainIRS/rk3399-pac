#[doc = "Register `PI_REG_47` reader"]
pub type R = crate::R<PiReg47Spec>;
#[doc = "Register `PI_REG_47` writer"]
pub type W = crate::W<PiReg47Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_trfc_f1(&mut self) -> PiTrfcF1W<PiReg47Spec> {
        PiTrfcF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Indicates DRAM TREF value in cycles. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tref_f1(&mut self) -> PiTrefF1W<PiReg47Spec> {
        PiTrefF1W::new(self, 16)
    }
}
#[doc = "DDR PHY Independent Register 47\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_47::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_47::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg47Spec;
impl crate::RegisterSpec for PiReg47Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_47::R`](R) reader structure"]
impl crate::Readable for PiReg47Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_47::W`](W) writer structure"]
impl crate::Writable for PiReg47Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_47 to value 0"]
impl crate::Resettable for PiReg47Spec {
