#[doc = "Register `PI_REG_161` reader"]
pub type R = crate::R<PiReg161Spec>;
#[doc = "Register `PI_REG_161` writer"]
pub type W = crate::W<PiReg161Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tmod_f0(&mut self) -> PiTmodF0W<PiReg161Spec> {
        PiTmodF0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Indicates DRAM TRTP value in cycles. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_trtp_f1(&mut self) -> PiTrtpF1W<PiReg161Spec> {
        PiTrtpF1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Indicates DRAM TRP value in cycles. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_trp_f1(&mut self) -> PiTrpF1W<PiReg161Spec> {
        PiTrpF1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Indicates DRAM TRCD value in cycles. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_trcd_f1(&mut self) -> PiTrcdF1W<PiReg161Spec> {
        PiTrcdF1W::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 161\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_161::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_161::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg161Spec;
impl crate::RegisterSpec for PiReg161Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_161::R`](R) reader structure"]
impl crate::Readable for PiReg161Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_161::W`](W) writer structure"]
impl crate::Writable for PiReg161Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_161 to value 0"]
impl crate::Resettable for PiReg161Spec {
