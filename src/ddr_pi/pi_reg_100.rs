#[doc = "Register `PI_REG_100` reader"]
pub type R = crate::R<PiReg100Spec>;
#[doc = "Register `PI_REG_100` writer"]
pub type W = crate::W<PiReg100Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_calvl_resp_mask(&mut self) -> PiCalvlRespMaskW<PiReg100Spec> {
        PiCalvlRespMaskW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Enables the PI CA training module. Bit1 represents the support when non-initialization. Bit0 represents the support when initialization. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn pi_calvl_en(&mut self) -> PiCalvlEnW<PiReg100Spec> {
        PiCalvlEnW::new(self, 8)
    }
}
#[doc = "DDR PHY Independent Register 100\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_100::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_100::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg100Spec;
impl crate::RegisterSpec for PiReg100Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_100::R`](R) reader structure"]
impl crate::Readable for PiReg100Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_100::W`](W) writer structure"]
impl crate::Writable for PiReg100Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_100 to value 0"]
impl crate::Resettable for PiReg100Spec {
