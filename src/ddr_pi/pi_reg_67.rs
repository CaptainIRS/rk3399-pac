#[doc = "Register `PI_REG_67` reader"]
pub type R = crate::R<PiReg67Spec>;
#[doc = "Register `PI_REG_67` writer"]
pub type W = crate::W<PiReg67Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_odt_en_f0(&mut self) -> PiOdtEnF0W<PiReg67Spec> {
        PiOdtEnF0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Defines the DRAM delay from an ODT de-assertion to the next non-write, non-read command. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_todtl_2cmd_f1(&mut self) -> PiTodtl2cmdF1W<PiReg67Spec> {
        PiTodtl2cmdF1W::new(self, 8)
    }
    #[doc = "Bit 16 - Enables support of DRAM ODT. When enabled, PI asserts and de-asserts ODT output to DRAM as needed. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_odt_en_f1(&mut self) -> PiOdtEnF1W<PiReg67Spec> {
        PiOdtEnF1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Defines the DRAM delay from an ODT de-assertion to the next non-write, non-read command. The suffix \"_f2\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_todtl_2cmd_f2(&mut self) -> PiTodtl2cmdF2W<PiReg67Spec> {
        PiTodtl2cmdF2W::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 67\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_67::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_67::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg67Spec;
impl crate::RegisterSpec for PiReg67Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_67::R`](R) reader structure"]
impl crate::Readable for PiReg67Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_67::W`](W) writer structure"]
impl crate::Writable for PiReg67Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_67 to value 0"]
impl crate::Resettable for PiReg67Spec {
