#[doc = "Register `PI_REG_101` reader"]
pub type R = crate::R<PiReg101Spec>;
#[doc = "Register `PI_REG_101` writer"]
pub type W = crate::W<PiReg101Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_calvl_interval(&mut self) -> PiCalvlIntervalW<PiReg101Spec> {
        PiCalvlIntervalW::new(self, 0)
    }
    #[doc = "Bits 16:20 - Indicates DRAM TCACKEL value in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tcackel(&mut self) -> PiTcackelW<PiReg101Spec> {
        PiTcackelW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Indicates DRAM TCAMRD value in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tcamrd(&mut self) -> PiTcamrdW<PiReg101Spec> {
        PiTcamrdW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 101\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_101::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_101::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg101Spec;
impl crate::RegisterSpec for PiReg101Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_101::R`](R) reader structure"]
impl crate::Readable for PiReg101Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_101::W`](W) writer structure"]
impl crate::Writable for PiReg101Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_101 to value 0"]
impl crate::Resettable for PiReg101Spec {
