#[doc = "Register `PI_REG_59` reader"]
pub type R = crate::R<PiReg59Spec>;
#[doc = "Register `PI_REG_59` writer"]
pub type W = crate::W<PiReg59Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_ctrl_delay_f2(&mut self) -> PiTdfiCtrlDelayF2W<PiReg59Spec> {
        PiTdfiCtrlDelayF2W::new(self, 0)
    }
    #[doc = "Bit 8 - Indicates user request to initiate write leveling. Set to 1 to trigger."]
    #[inline(always)]
    #[must_use]
    pub fn pi_wrlvl_req(&mut self) -> PiWrlvlReqW<PiReg59Spec> {
        PiWrlvlReqW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Specifies the target chip select for the write leveling operation that is initiated through the PI_REG_59.pi_wrlvl_req parameter."]
    #[inline(always)]
    #[must_use]
    pub fn pi_wrlvl_cs(&mut self) -> PiWrlvlCsW<PiReg59Spec> {
        PiWrlvlCsW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Indicates delay from the issuing MRS to the first DQS strobe for write leveling."]
    #[inline(always)]
    #[must_use]
    pub fn pi_wldqsen(&mut self) -> PiWldqsenW<PiReg59Spec> {
        PiWldqsenW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 59\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_59::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_59::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg59Spec;
impl crate::RegisterSpec for PiReg59Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_59::R`](R) reader structure"]
impl crate::Readable for PiReg59Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_59::W`](W) writer structure"]
impl crate::Writable for PiReg59Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_59 to value 0"]
impl crate::Resettable for PiReg59Spec {
