#[doc = "Register `PI_REG_83` reader"]
pub type R = crate::R<PiReg83Spec>;
#[doc = "Register `PI_REG_83` writer"]
pub type W = crate::W<PiReg83Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_rdlvl_gate_interval(&mut self) -> PiRdlvlGateIntervalW<PiReg83Spec> {
        PiRdlvlGateIntervalW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Defines the start pattern in read leveling."]
    #[inline(always)]
    #[must_use]
    pub fn pi_rdlvl_pattern_start(&mut self) -> PiRdlvlPatternStartW<PiReg83Spec> {
        PiRdlvlPatternStartW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Defines the number of patterns that are supported in read leveling."]
    #[inline(always)]
    #[must_use]
    pub fn pi_rdlvl_pattern_num(&mut self) -> PiRdlvlPatternNumW<PiReg83Spec> {
        PiRdlvlPatternNumW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 83\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_83::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_83::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg83Spec;
impl crate::RegisterSpec for PiReg83Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_83::R`](R) reader structure"]
impl crate::Readable for PiReg83Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_83::W`](W) writer structure"]
impl crate::Writable for PiReg83Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_83 to value 0"]
impl crate::Resettable for PiReg83Spec {
