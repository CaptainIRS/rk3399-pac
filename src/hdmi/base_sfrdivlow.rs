...
#[doc = "Field `BASE_SFRDIV_LO` reader - SFR clock divider Low This register must be configured with the 8 least- significant bits of the value sfrclk frequency divided by 1000 (for example, for 27 MHz base_sfrdiv\\[14:0\\]
...
#[doc = "Field `BASE_SFRDIV_LO` writer - SFR clock divider Low This register must be configured with the 8 least- significant bits of the value sfrclk frequency divided by 1000 (for example, for 27 MHz base_sfrdiv\\[14:0\\]
= 27027). The configured data is used to generate a reference pulse of 1ms period that is needed by several timers within the controller."]
pub type BaseSfrdivLoW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - SFR clock divider Low This register must be configured with the 8 least- significant bits of the value sfrclk frequency divided by 1000 (for example, for 27 MHz base_sfrdiv\\[14:0\\]
= 27027). The configured data is used to generate a reference pulse of 1ms period that is needed by several timers within the controller."]
    #[inline(always)]
