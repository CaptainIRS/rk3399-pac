...
#[doc = "Field `DONE` reader - The current transmission is successful (for initiator only)"]
pub type DoneR = crate::BitReader;
#[doc = "Field `DONE` writer - The current transmission is successful (for initiator only)"]
pub type DoneW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EOM` reader - EOM is detected so that the received data is ready in the receiver data buffer (for follower only)"]
pub type EomR = crate::BitReader;
#[doc = "Field `EOM` writer - EOM is detected so that the received data is ready in the receiver data buffer (for follower only)"]
pub type EomW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `NACK` reader - A frame is not acknowledged in a directly addressed message. Or a frame is negatively acknowledged in a broadcast message (for initiator only)"]
pub type NackR = crate::BitReader;
#[doc = "Field `NACK` writer - A frame is not acknowledged in a directly addressed message. Or a frame is negatively acknowledged in a broadcast message (for initiator only)"]
pub type NackW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ARB_LOST` reader - The initiator losses the CEC line arbitration to a second initiator. (specification CEC 9)"]
pub type ArbLostR = crate::BitReader;
#[doc = "Field `ARB_LOST` writer - The initiator losses the CEC line arbitration to a second initiator. (specification CEC 9)"]
...
#[doc = "Field `ERROR_FLOW` reader - An error is notified by a follower. Abnormal logic data bit error (for follower)"]
pub type ErrorFlowR = crate::BitReader;
#[doc = "Field `ERROR_FLOW` writer - An error is notified by a follower. Abnormal logic data bit error (for follower)"]
...
impl R {
    #[doc = "Bit 0 - The current transmission is successful (for initiator only)"]
    #[inline(always)]
    pub fn done(&self) -> DoneR {
        DoneR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - EOM is detected so that the received data is ready in the receiver data buffer (for follower only)"]
    #[inline(always)]
    pub fn eom(&self) -> EomR {
        EomR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - A frame is not acknowledged in a directly addressed message. Or a frame is negatively acknowledged in a broadcast message (for initiator only)"]
    #[inline(always)]
    pub fn nack(&self) -> NackR {
        NackR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - The initiator losses the CEC line arbitration to a second initiator. (specification CEC 9)"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - An error is notified by a follower. Abnormal logic data bit error (for follower)"]
    #[inline(always)]
