...
#[doc = "Field `I2CM_READ_BUFF7` reader - Byte 7 of a I2C read buffer sequential read (from address i2cm_address+7)"]
pub type I2cmReadBuff7R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - Byte 7 of a I2C read buffer sequential read (from address i2cm_address+7)"]
    #[inline(always)]
