...
#[doc = "Field `CSC_COEF_A3_MSB` reader - Color Space Converter Matrix A3 Coefficient\n\nRegister MSB"]
pub type CscCoefA3MsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_A3_MSB` writer - Color Space Converter Matrix A3 Coefficient\n\nRegister MSB"]
