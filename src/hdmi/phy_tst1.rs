...
#[doc = "Field `TESTDIN` reader - Test Data input Otherwise, this field is a \"spare\" bit with no associated functionality."]
pub type TestdinR = crate::FieldReader;
#[doc = "Field `TESTDIN` writer - Test Data input Otherwise, this field is a \"spare\" bit with no associated functionality."]
pub type TestdinW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Test Data input Otherwise, this field is a \"spare\" bit with no associated functionality."]
    #[inline(always)]
