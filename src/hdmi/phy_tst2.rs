...
#[doc = "Field `TESTDOUT` reader - Test Data output. Otherwise, this field is a \"spare\" bit with no associated functionality."]
pub type TestdoutR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - Test Data output. Otherwise, this field is a \"spare\" bit with no associated functionality."]
    #[inline(always)]
