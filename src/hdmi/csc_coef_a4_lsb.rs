...
#[doc = "Field `CSC_COEF_A4_LSB` reader - Color Space Converter Matrix A4 Coefficient Register LSB"]
pub type CscCoefA4LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_A4_LSB` writer - Color Space Converter Matrix A4 Coefficient Register LSB"]
pub type CscCoefA4LsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix A4 Coefficient Register LSB"]
    #[inline(always)]
