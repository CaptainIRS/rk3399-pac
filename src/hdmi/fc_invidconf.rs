...
#[doc = "Field `R_V_BLANK_IN_OSC` reader - Used for CEA861-D modes with fractional Vblank (for example, modes 5, 6, 7, 10, 11, 20, 21, and 22). For more modes, see the CEA861-D specification. Note: Set this field to 1 for video mode 39, although there is no Vblank oscillation. 1b: Active high"]
pub type RVBlankInOscR = crate::BitReader;
#[doc = "Field `R_V_BLANK_IN_OSC` writer - Used for CEA861-D modes with fractional Vblank (for example, modes 5, 6, 7, 10, 11, 20, 21, and 22). For more modes, see the CEA861-D specification. Note: Set this field to 1 for video mode 39, although there is no Vblank oscillation. 1b: Active high"]
pub type RVBlankInOscW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DVI_MODEZ` reader - Active low 0b: DVI mode selected 1b: HDMI mode selected"]
pub type DviModezR = crate::BitReader;
#[doc = "Field `DVI_MODEZ` writer - Active low 0b: DVI mode selected 1b: HDMI mode selected"]
pub type DviModezW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DE_IN_POLARITY` reader - Data enable input polarity 1b: Active high 0b: Active low"]
pub type DeInPolarityR = crate::BitReader;
#[doc = "Field `DE_IN_POLARITY` writer - Data enable input polarity 1b: Active high 0b: Active low"]
pub type DeInPolarityW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HSYNC_IN_POLARITY` reader - Hsync input polarity 1b: Active high 0b: Active low"]
pub type HsyncInPolarityR = crate::BitReader;
#[doc = "Field `HSYNC_IN_POLARITY` writer - Hsync input polarity 1b: Active high 0b: Active low"]
pub type HsyncInPolarityW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `VSYNC_IN_POLARITY` reader - Vsync input polarity 1b: Active high 0b: Active low"]
pub type VsyncInPolarityR = crate::BitReader;
#[doc = "Field `VSYNC_IN_POLARITY` writer - Vsync input polarity 1b: Active high 0b: Active low"]
pub type VsyncInPolarityW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HDCP_KEEPOUT` reader - Start/stop HDCP keepout window generation 1b: Active"]
pub type HdcpKeepoutR = crate::BitReader;
#[doc = "Field `HDCP_KEEPOUT` writer - Start/stop HDCP keepout window generation 1b: Active"]
pub type HdcpKeepoutW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 1 - Used for CEA861-D modes with fractional Vblank (for example, modes 5, 6, 7, 10, 11, 20, 21, and 22). For more modes, see the CEA861-D specification. Note: Set this field to 1 for video mode 39, although there is no Vblank oscillation. 1b: Active high"]
    #[inline(always)]
    pub fn r_v_blank_in_osc(&self) -> RVBlankInOscR {
        RVBlankInOscR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 3 - Active low 0b: DVI mode selected 1b: HDMI mode selected"]
    #[inline(always)]
    pub fn dvi_modez(&self) -> DviModezR {
        DviModezR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Data enable input polarity 1b: Active high 0b: Active low"]
    #[inline(always)]
    pub fn de_in_polarity(&self) -> DeInPolarityR {
        DeInPolarityR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Hsync input polarity 1b: Active high 0b: Active low"]
    #[inline(always)]
    pub fn hsync_in_polarity(&self) -> HsyncInPolarityR {
        HsyncInPolarityR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Vsync input polarity 1b: Active high 0b: Active low"]
    #[inline(always)]
    pub fn vsync_in_polarity(&self) -> VsyncInPolarityR {
        VsyncInPolarityR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Start/stop HDCP keepout window generation 1b: Active"]
    #[inline(always)]
