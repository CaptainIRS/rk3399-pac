...
#[doc = "Field `CSC_COEF_C3_MSB` reader - Color Space Converter Matrix C3 Coefficient Register MSB"]
pub type CscCoefC3MsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_C3_MSB` writer - Color Space Converter Matrix C3 Coefficient Register MSB"]
pub type CscCoefC3MsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix C3 Coefficient Register MSB"]
    #[inline(always)]
