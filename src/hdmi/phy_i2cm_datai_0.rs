...
#[doc = "Field `DATAI` reader - Data LSB (datai\\[7:0\\]) read from register pointed by phy_i2cm_address\\[7:0\\]."]
pub type DataiR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - Data LSB (datai\\[7:0\\]) read from register pointed by phy_i2cm_address\\[7:0\\]."]
    #[inline(always)]
