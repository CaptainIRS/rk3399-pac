...
#[doc = "Field `SLAVEADDR` reader - Slave address to be sent during read and write\n\noperations.\n\nPHY Gen2 slave address: 7'h69\n\nHEAC PHY slave address: 7'h49"]
pub type SlaveaddrR = crate::FieldReader;
#[doc = "Field `SLAVEADDR` writer - Slave address to be sent during read and write\n\noperations.\n\nPHY Gen2 slave address: 7'h69\n\nHEAC PHY slave address: 7'h49"]
pub type SlaveaddrW<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    #[doc = "Bits 0:6 - Slave address to be sent during read and write\n\noperations.\n\nPHY Gen2 slave address: 7'h69\n\nHEAC PHY slave address: 7'h49"]
    #[inline(always)]
