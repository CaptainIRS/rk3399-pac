...
#[doc = "Field `CH2_PREAMBLE_FILTER` reader - When in control mode, configures 6 bits that fill the\n\nchannel 2 data lines not used to transmit the\n\npreamble (for more clarification, refer to the HDMI\n\n1.4b specification)."]
pub type Ch2PreambleFilterR = crate::FieldReader;
#[doc = "Field `CH2_PREAMBLE_FILTER` writer - When in control mode, configures 6 bits that fill the\n\nchannel 2 data lines not used to transmit the\n\npreamble (for more clarification, refer to the HDMI\n\n1.4b specification)."]
