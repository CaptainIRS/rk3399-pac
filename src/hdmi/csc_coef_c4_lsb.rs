...
#[doc = "Field `CSC_COEF_C4_LSB` reader - Color Space Converter Matrix C4 Coefficient Register LSB"]
pub type CscCoefC4LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_C4_LSB` writer - Color Space Converter Matrix C4 Coefficient Register LSB"]
pub type CscCoefC4LsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix C4 Coefficient Register LSB"]
    #[inline(always)]
