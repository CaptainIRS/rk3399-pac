...
#[doc = "Field `HDMIDVI` reader - Configures the transmitter to operate with a HDMI capable device or with a DVI device."]
pub type HdmidviR = crate::BitReader;
#[doc = "Field `HDMIDVI` writer - Configures the transmitter to operate with a HDMI capable device or with a DVI device."]
pub type HdmidviW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EN11FEATURE` reader - Enable the use of features 1.1 from the transmitter's side"]
pub type En11featureR = crate::BitReader;
#[doc = "Field `EN11FEATURE` writer - Enable the use of features 1.1 from the transmitter's side"]
pub type En11featureW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RXDETECT` reader - Information that a sink device was detected connected to the HDMI port"]
pub type RxdetectR = crate::BitReader;
#[doc = "Field `RXDETECT` writer - Information that a sink device was detected connected to the HDMI port"]
pub type RxdetectW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `AVMUTE` reader - This register holds the current AVMUTE state of the Hdmi_tx controller, as expected to be perceived by the connected HDMI/HDCP sink device."]
pub type AvmuteR = crate::BitReader;
#[doc = "Field `SYNCRICHECK` reader - Configures if the Ri check should be done at every 2s even or synchronously to every 128 encrypted frame."]
pub type SyncricheckR = crate::BitReader;
#[doc = "Field `SYNCRICHECK` writer - Configures if the Ri check should be done at every 2s even or synchronously to every 128 encrypted frame."]
pub type SyncricheckW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BYPENCRYPTION` reader - Bypasses all the data encryption stages Reset Value: (HDMI_HDCP_BYPASS== 1) ? 1 : 0"]
pub type BypencryptionR = crate::BitReader;
#[doc = "Field `BYPENCRYPTION` writer - Bypasses all the data encryption stages Reset Value: (HDMI_HDCP_BYPASS== 1) ? 1 : 0"]
pub type BypencryptionW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `I2CFASTMODE` reader - Enable the I2C fast mode option from the transmitter's side."]
pub type I2cfastmodeR = crate::BitReader;
#[doc = "Field `I2CFASTMODE` writer - Enable the I2C fast mode option from the transmitter's side."]
pub type I2cfastmodeW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ELVENA` reader - Enables the Enhanced Link Verification from the transmitter's side"]
pub type ElvenaR = crate::BitReader;
#[doc = "Field `ELVENA` writer - Enables the Enhanced Link Verification from the transmitter's side"]
pub type ElvenaW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures the transmitter to operate with a HDMI capable device or with a DVI device."]
    #[inline(always)]
    pub fn hdmidvi(&self) -> HdmidviR {
        HdmidviR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Enable the use of features 1.1 from the transmitter's side"]
    #[inline(always)]
    pub fn en11feature(&self) -> En11featureR {
        En11featureR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Information that a sink device was detected connected to the HDMI port"]
    #[inline(always)]
    pub fn rxdetect(&self) -> RxdetectR {
        RxdetectR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - This register holds the current AVMUTE state of the Hdmi_tx controller, as expected to be perceived by the connected HDMI/HDCP sink device."]
    #[inline(always)]
    pub fn avmute(&self) -> AvmuteR {
        AvmuteR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Configures if the Ri check should be done at every 2s even or synchronously to every 128 encrypted frame."]
    #[inline(always)]
    pub fn syncricheck(&self) -> SyncricheckR {
        SyncricheckR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Bypasses all the data encryption stages Reset Value: (HDMI_HDCP_BYPASS== 1) ? 1 : 0"]
    #[inline(always)]
    pub fn bypencryption(&self) -> BypencryptionR {
        BypencryptionR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Enable the I2C fast mode option from the transmitter's side."]
    #[inline(always)]
    pub fn i2cfastmode(&self) -> I2cfastmodeR {
        I2cfastmodeR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Enables the Enhanced Link Verification from the transmitter's side"]
    #[inline(always)]
