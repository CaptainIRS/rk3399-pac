...
#[doc = "Field `CSC_COEF_C3_LSB` reader - Color Space Converter Matrix C3 Coefficient Register LSB"]
pub type CscCoefC3LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_C3_LSB` writer - Color Space Converter Matrix C3 Coefficient Register LSB"]
pub type CscCoefC3LsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix C3 Coefficient Register LSB"]
    #[inline(always)]
