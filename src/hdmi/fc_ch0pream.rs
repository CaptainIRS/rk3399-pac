...
#[doc = "Field `CH0_PREAMBLE_FILTER` reader - When in control mode, configures 8 bits that fill the channel 0 data lines not used to transmit the preamble (for more clarification, refer to the HDMI 1.4b specification)."]
pub type Ch0PreambleFilterR = crate::FieldReader;
#[doc = "Field `CH0_PREAMBLE_FILTER` writer - When in control mode, configures 8 bits that fill the channel 0 data lines not used to transmit the preamble (for more clarification, refer to the HDMI 1.4b specification)."]
pub type Ch0PreambleFilterW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - When in control mode, configures 8 bits that fill the channel 0 data lines not used to transmit the preamble (for more clarification, refer to the HDMI 1.4b specification)."]
    #[inline(always)]
