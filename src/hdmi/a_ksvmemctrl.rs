...
#[doc = "Field `KSVMEMREQUEST` reader - Request access to the KSV memory; must be de- asserted after the access is completed by the system."]
pub type KsvmemrequestR = crate::BitReader;
#[doc = "Field `KSVMEMREQUEST` writer - Request access to the KSV memory; must be de- asserted after the access is completed by the system."]
...
#[doc = "Field `KSVCTRLUPD` reader - Set to inform that the KSV list in memory has been analyzed and the response to the Message Digest has been updated if on configurations on software SHA-1 calculation."]
pub type KsvctrlupdR = crate::BitReader;
#[doc = "Field `KSVCTRLUPD` writer - Set to inform that the KSV list in memory has been analyzed and the response to the Message Digest has been updated if on configurations on software SHA-1 calculation."]
pub type KsvctrlupdW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SHA1FAIL` reader - Notification whether the KSV list message digest is correct."]
pub type Sha1failR = crate::BitReader;
#[doc = "Field `SHA1FAIL` writer - Notification whether the KSV list message digest is correct."]
pub type Sha1failW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `KSVSHA1STATUS` reader - Notification whether the KSV list message digest is correct from the controller: 1'b1 if digest message verification failed 1'b0 if digest message verification succeeded"]
pub type Ksvsha1statusR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Request access to the KSV memory; must be de- asserted after the access is completed by the system."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Set to inform that the KSV list in memory has been analyzed and the response to the Message Digest has been updated if on configurations on software SHA-1 calculation."]
    #[inline(always)]
    pub fn ksvctrlupd(&self) -> KsvctrlupdR {
        KsvctrlupdR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Notification whether the KSV list message digest is correct."]
    #[inline(always)]
    pub fn sha1fail(&self) -> Sha1failR {
        Sha1failR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Notification whether the KSV list message digest is correct from the controller: 1'b1 if digest message verification failed 1'b0 if digest message verification succeeded"]
    #[inline(always)]
