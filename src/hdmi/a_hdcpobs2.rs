...
#[doc = "Field `STATEEEG` reader - Observability register informs in which state the EESS machine is on."]
pub type StateeegR = crate::FieldReader;
#[doc = "Field `STATEE` reader - Observability register informs in which state the cipher machine is on."]
pub type StateeR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:2 - Observability register informs in which state the EESS machine is on."]
    #[inline(always)]
    pub fn stateeeg(&self) -> StateeegR {
        StateeegR::new(self.bits & 7)
    }
    #[doc = "Bits 3:5 - Observability register informs in which state the cipher machine is on."]
    #[inline(always)]
