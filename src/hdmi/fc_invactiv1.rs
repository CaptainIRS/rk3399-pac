...
#[doc = "Field `V_IN_ACTIV` reader - Input video Vertical active pixel region width. This bit field holds bits 9:8 of number of Vertical active pixels."]
pub type VInActivR = crate::FieldReader;
#[doc = "Field `V_IN_ACTIV` writer - Input video Vertical active pixel region width. This bit field holds bits 9:8 of number of Vertical active pixels."]
pub type VInActivW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `V_IN_ACTIV_12_11` reader - Input video Vertical active pixel region width. If the configuration parameter HDMI_TX_14 = True (1), this bit field holds bits 12:10 of number of Vertical active pixels."]
pub type VInActiv12_11R = crate::FieldReader;
#[doc = "Field `V_IN_ACTIV_12_11` writer - Input video Vertical active pixel region width. If the configuration parameter HDMI_TX_14 = True (1), this bit field holds bits 12:10 of number of Vertical active pixels."]
pub type VInActiv12_11W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:2 - Input video Vertical active pixel region width. This bit field holds bits 9:8 of number of Vertical active pixels."]
    #[inline(always)]
    pub fn v_in_activ(&self) -> VInActivR {
        VInActivR::new(self.bits & 7)
    }
    #[doc = "Bits 3:4 - Input video Vertical active pixel region width. If the configuration parameter HDMI_TX_14 = True (1), this bit field holds bits 12:10 of number of Vertical active pixels."]
    #[inline(always)]
