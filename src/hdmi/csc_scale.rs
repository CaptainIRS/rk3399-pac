...
#[doc = "Field `SPARE` reader - The is a Reserved as \"spare\" register with no\n\nassociated functionality."]
pub type SpareR = crate::FieldReader;
#[doc = "Field `SPARE` writer - The is a Reserved as \"spare\" register with no\n\nassociated functionality."]
pub type SpareW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `CSC_COLOR_DEPTH` reader - Color space converter color depth configuration:\n\ncsc_colordepth\\[3:0\\]
...
#[doc = "Field `CSC_COLOR_DEPTH` writer - Color space converter color depth configuration:\n\ncsc_colordepth\\[3:0\\]
| Action\n\n0000 | 24 bit per pixel video (8 bit per\n\ncomponent).\n\n0001-0011 | Reserved. Not used.\n\n0100 | 24 bit per pixel video (8 bit per\n\ncomponent).\n\n0101 | 30 bit per pixel video (10 bit per\n\ncomponent).\n\n0110 | 36 bit per pixel video (12 bit per\n\ncomponent).\n\n0111 | 48 bit per pixel video (16 bit per\n\ncomponent).\n\nother | Reserved. Not used."]
...
scale factor to apply to all\n\ncoefficients in Color Space Conversion. This scale\n\nfactor is expressed in the number of left shifts to\n\napply to each of the coefficients, ranging from 0 to\n\n2."]
    ...
    #[doc = "Bits 2:3 - The is a Reserved as \"spare\" register with no\n\nassociated functionality."]
    #[inline(always)]
    pub fn spare(&self) -> SpareR {
        SpareR::new((self.bits >> 2) & 3)
    }
    #[doc = "Bits 4:7 - Color space converter color depth configuration:\n\ncsc_colordepth\\[3:0\\]
| Action\n\n0000 | 24 bit per pixel video (8 bit per\n\ncomponent).\n\n0001-0011 | Reserved. Not used.\n\n0100 | 24 bit per pixel video (8 bit per\n\ncomponent).\n\n0101 | 30 bit per pixel video (10 bit per\n\ncomponent).\n\n0110 | 36 bit per pixel video (12 bit per\n\ncomponent).\n\n0111 | 48 bit per pixel video (16 bit per\n\ncomponent).\n\nother | Reserved. Not used."]
    #[inline(always)]
