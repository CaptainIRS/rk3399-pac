...
#[doc = "Field `H_IN_WIDTH` reader - Input video Hsync active pulse width. Integer number of pixel clock cycles \\[0...511\\]."]
pub type HInWidthR = crate::FieldReader;
#[doc = "Field `H_IN_WIDTH` writer - Input video Hsync active pulse width. Integer number of pixel clock cycles \\[0...511\\]."]
pub type HInWidthW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Input video Hsync active pulse width. Integer number of pixel clock cycles \\[0...511\\]."]
    #[inline(always)]
