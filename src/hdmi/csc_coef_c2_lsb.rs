...
#[doc = "Field `CSC_COEF_C2_LSB` reader - Color Space Converter Matrix C2 Coefficient Register LSB"]
pub type CscCoefC2LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_C2_LSB` writer - Color Space Converter Matrix C2 Coefficient Register LSB"]
pub type CscCoefC2LsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix C2 Coefficient Register LSB"]
    #[inline(always)]
