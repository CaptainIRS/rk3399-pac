...
#[doc = "Field `CSC_COEF_A1_MSB` reader - Color Space Converter Matrix A1 Coefficient Register MSB"]
pub type CscCoefA1MsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_A1_MSB` writer - Color Space Converter Matrix A1 Coefficient Register MSB"]
pub type CscCoefA1MsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix A1 Coefficient Register MSB"]
    #[inline(always)]
