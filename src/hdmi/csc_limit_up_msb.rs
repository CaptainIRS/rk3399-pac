...
#[doc = "Field `CSC_LIMIT_UP_MSB` reader - Color Space Converter Matrix Output Upper Limit\n\nRegister MSB"]
pub type CscLimitUpMsbR = crate::FieldReader;
#[doc = "Field `CSC_LIMIT_UP_MSB` writer - Color Space Converter Matrix Output Upper Limit\n\nRegister MSB"]
