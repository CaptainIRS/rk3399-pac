...
#[doc = "Field `HIGHPRIORITY_OVERFLOW` reader - Mask bit for FC_INT2.HighPriority_overflow interrupt\n\nbit"]
pub type HighpriorityOverflowR = crate::BitReader;
#[doc = "Field `HIGHPRIORITY_OVERFLOW` writer - Mask bit for FC_INT2.HighPriority_overflow interrupt\n\nbit"]
pub type HighpriorityOverflowW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LOWPRIORITY_OVERFLOW` reader - Mask bit for FC_INT2.LowPriority_overflow interrupt\n\nbit"]
pub type LowpriorityOverflowR = crate::BitReader;
#[doc = "Field `LOWPRIORITY_OVERFLOW` writer - Mask bit for FC_INT2.LowPriority_overflow interrupt\n\nbit"]
pub type LowpriorityOverflowW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DRM` reader - Mask bit for FC_INT2.DRM interrupt bit.\n\nReset Value: (HDMI_TX_20== 1) ? 1 : 0"]
pub type DrmR = crate::BitReader;
#[doc = "Field `DRM` writer - Mask bit for FC_INT2.DRM interrupt bit.\n\nReset Value: (HDMI_TX_20== 1) ? 1 : 0"]
pub type DrmW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Mask bit for FC_INT2.HighPriority_overflow interrupt\n\nbit"]
    #[inline(always)]
    pub fn highpriority_overflow(&self) -> HighpriorityOverflowR {
        HighpriorityOverflowR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Mask bit for FC_INT2.LowPriority_overflow interrupt\n\nbit"]
    #[inline(always)]
    pub fn lowpriority_overflow(&self) -> LowpriorityOverflowR {
        LowpriorityOverflowR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 4 - Mask bit for FC_INT2.DRM interrupt bit.\n\nReset Value: (HDMI_TX_20== 1) ? 1 : 0"]
    #[inline(always)]
