...
#[doc = "Field `HDCP_REVOC_SIZE_0` reader - Register containing the LSB of KSV list size (ksv_list_size\\[7:0\\]). If Attr has not been granted (see register a_ksvmemctrl), the value read is 8'hff."]
pub type HdcpRevocSize0R = crate::FieldReader;
#[doc = "Field `HDCP_REVOC_SIZE_0` writer - Register containing the LSB of KSV list size (ksv_list_size\\[7:0\\]). If Attr has not been granted (see register a_ksvmemctrl), the value read is 8'hff."]
pub type HdcpRevocSize0W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Register containing the LSB of KSV list size (ksv_list_size\\[7:0\\]). If Attr has not been granted (see register a_ksvmemctrl), the value read is 8'hff."]
    #[inline(always)]
