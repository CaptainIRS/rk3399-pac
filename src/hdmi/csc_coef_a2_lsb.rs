...
#[doc = "Field `CSC_COEF_A2_LSB` reader - Color Space Converter Matrix A2 Coefficient\n\nRegister LSB"]
pub type CscCoefA2LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_A2_LSB` writer - Color Space Converter Matrix A2 Coefficient\n\nRegister LSB"]
