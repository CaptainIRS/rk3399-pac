...
#[doc = "Field `TESTCLK` reader - Test Clock signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
pub type TestclkR = crate::BitReader;
#[doc = "Field `TESTCLK` writer - Test Clock signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
...
#[doc = "Field `TESTEN` reader - Test Enable signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
pub type TestenR = crate::BitReader;
#[doc = "Field `TESTEN` writer - Test Enable signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
pub type TestenW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TESTCLR` reader - Test Clear signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
pub type TestclrR = crate::BitReader;
#[doc = "Field `TESTCLR` writer - Test Clear signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
...
impl R {
    #[doc = "Bit 0 - Test Clock signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
    #[inline(always)]
    pub fn testclk(&self) -> TestclkR {
        TestclkR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:3 - Reserved as \"spare\" bit with no associated functionality."]
    #[inline(always)]
    pub fn spare_1(&self) -> Spare1R {
        Spare1R::new((self.bits >> 1) & 7)
    }
    #[doc = "Bit 4 - Test Enable signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
    #[inline(always)]
    pub fn testen(&self) -> TestenR {
        TestenR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Test Clear signal. Otherwise, this field is a \"spare\" bit with no associated functionality."]
    #[inline(always)]
    pub fn testclr(&self) -> TestclrR {
        TestclrR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bits 6:7 - Reserved as \"spare\" bit with no associated functionality."]
    #[inline(always)]
