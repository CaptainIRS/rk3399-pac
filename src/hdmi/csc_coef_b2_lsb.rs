...
#[doc = "Field `CSC_COEF_B2_LSB` reader - Color Space Converter Matrix B2 Coefficient\n\nRegister LSB"]
pub type CscCoefB2LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_B2_LSB` writer - Color Space Converter Matrix B2 Coefficient\n\nRegister LSB"]
pub type CscCoefB2LsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix B2 Coefficient\n\nRegister LSB"]
    #[inline(always)]
