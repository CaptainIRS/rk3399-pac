...
#[doc = "Field `DATAO` reader - Data LSB (datao\\[7:0\\]) to be written on register\n\npointed by phy_i2cm_address \\[7:0\\]."]
pub type DataoR = crate::FieldReader;
#[doc = "Field `DATAO` writer - Data LSB (datao\\[7:0\\]) to be written on register\n\npointed by phy_i2cm_address \\[7:0\\]."]
pub type DataoW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Data LSB (datao\\[7:0\\]) to be written on register\n\npointed by phy_i2cm_address \\[7:0\\]."]
    #[inline(always)]
