...
#[doc = "Field `V_IN_DELAY` reader - Input video Vsync active edge delay. Integer number of Hsync pulses from \"de\" non active edge of the last \"de\" valid period. \\[0...255\\]."]
pub type VInDelayR = crate::FieldReader;
#[doc = "Field `V_IN_DELAY` writer - Input video Vsync active edge delay. Integer number of Hsync pulses from \"de\" non active edge of the last \"de\" valid period. \\[0...255\\]."]
pub type VInDelayW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Input video Vsync active edge delay. Integer number of Hsync pulses from \"de\" non active edge of the last \"de\" valid period. \\[0...255\\]."]
    #[inline(always)]
