...
#[doc = "Field `NACK_STATUS` reader - Not acknowledge error status bit. Error on I2C not acknowledge. Note: This bit field is read by the sticky bits present on the ih_i2cmphy_stat0 register."]
pub type NackStatusR = crate::BitReader;
#[doc = "Field `NACK_INTERRUPT` reader - Not acknowledge error interrupt bit. Only lasts for one SFR clock cycle and is auto cleared after it. {nack_interrupt = (nack_mask==0b) &amp;&amp; (nack_status==nack_pol)}. Note: This bit field is read by the sticky bits present on the ih_i2cmphy_stat0 register."]
...
#[doc = "Field `NACK_POL` reader - Not acknowledge error interrupt polarity configuration"]
...
impl R {
    ...
    #[doc = "Bit 4 - Not acknowledge error status bit. Error on I2C not acknowledge. Note: This bit field is read by the sticky bits present on the ih_i2cmphy_stat0 register."]
    #[inline(always)]
    pub fn nack_status(&self) -> NackStatusR {
        NackStatusR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Not acknowledge error interrupt bit. Only lasts for one SFR clock cycle and is auto cleared after it. {nack_interrupt = (nack_mask==0b) &amp;&amp; (nack_status==nack_pol)}. Note: This bit field is read by the sticky bits present on the ih_i2cmphy_stat0 register."]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Not acknowledge error interrupt polarity configuration"]
    #[inline(always)]
