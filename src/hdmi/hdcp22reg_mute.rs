...
#[doc = "Field `MUTE_HDCP2_CAPABLE` reader - Active high interrupt mute to HDCP 2.2 capable rise\n\ninterrupt status"]
pub type MuteHdcp2CapableR = crate::BitReader;
#[doc = "Field `MUTE_HDCP2_CAPABLE` writer - Active high interrupt mute to HDCP 2.2 capable rise\n\ninterrupt status"]
pub type MuteHdcp2CapableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MUTE_HDCP2_NOT_CAPABLE` reader - Active high interrupt mute to HDCP 2.2 not capable\n\nrise interrupt status"]
pub type MuteHdcp2NotCapableR = crate::BitReader;
#[doc = "Field `MUTE_HDCP2_NOT_CAPABLE` writer - Active high interrupt mute to HDCP 2.2 not capable\n\nrise interrupt status"]
pub type MuteHdcp2NotCapableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MUTE_HDCP_AUTHENTICATION_LOST` reader - Active high interrupt mute to HDCP 2.2\n\nauthentication lost interrupt status"]
pub type MuteHdcpAuthenticationLostR = crate::BitReader;
#[doc = "Field `MUTE_HDCP_AUTHENTICATION_LOST` writer - Active high interrupt mute to HDCP 2.2\n\nauthentication lost interrupt status"]
pub type MuteHdcpAuthenticationLostW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MUTE_HDCP_AUTHENTICATED` reader - Active high interrupt mute to HDCP 2.2\n\nauthenticated interrupt status"]
pub type MuteHdcpAuthenticatedR = crate::BitReader;
#[doc = "Field `MUTE_HDCP_AUTHENTICATED` writer - Active high interrupt mute to HDCP 2.2\n\nauthenticated interrupt status"]
pub type MuteHdcpAuthenticatedW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MUTE_HDCP_AUTHENTICATION_FAIL` reader - Active high interrupt mute to HDCP 2.2\n\nauthentication fail interrupt status"]
pub type MuteHdcpAuthenticationFailR = crate::BitReader;
#[doc = "Field `MUTE_HDCP_AUTHENTICATION_FAIL` writer - Active high interrupt mute to HDCP 2.2\n\nauthentication fail interrupt status"]
pub type MuteHdcpAuthenticationFailW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MUTE_HDCP_DECRYPTED_CHG` reader - Active high interrupt mute to HDCP 2.2 decrypted\n\nvalue change interrupt status"]
pub type MuteHdcpDecryptedChgR = crate::BitReader;
#[doc = "Field `MUTE_HDCP_DECRYPTED_CHG` writer - Active high interrupt mute to HDCP 2.2 decrypted\n\nvalue change interrupt status"]
pub type MuteHdcpDecryptedChgW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Active high interrupt mute to HDCP 2.2 capable rise\n\ninterrupt status"]
    #[inline(always)]
    pub fn mute_hdcp2_capable(&self) -> MuteHdcp2CapableR {
        MuteHdcp2CapableR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Active high interrupt mute to HDCP 2.2 not capable\n\nrise interrupt status"]
    #[inline(always)]
    pub fn mute_hdcp2_not_capable(&self) -> MuteHdcp2NotCapableR {
        MuteHdcp2NotCapableR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Active high interrupt mute to HDCP 2.2\n\nauthentication lost interrupt status"]
    #[inline(always)]
    pub fn mute_hdcp_authentication_lost(&self) -> MuteHdcpAuthenticationLostR {
        MuteHdcpAuthenticationLostR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Active high interrupt mute to HDCP 2.2\n\nauthenticated interrupt status"]
    #[inline(always)]
    pub fn mute_hdcp_authenticated(&self) -> MuteHdcpAuthenticatedR {
        MuteHdcpAuthenticatedR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Active high interrupt mute to HDCP 2.2\n\nauthentication fail interrupt status"]
    #[inline(always)]
    pub fn mute_hdcp_authentication_fail(&self) -> MuteHdcpAuthenticationFailR {
        MuteHdcpAuthenticationFailR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Active high interrupt mute to HDCP 2.2 decrypted\n\nvalue change interrupt status"]
    #[inline(always)]
