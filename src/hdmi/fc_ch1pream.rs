...
#[doc = "Field `CH1_PREAMBLE_FILTER` reader - When in control mode, configures 6 bits that fill the channel 1 data lines not used to transmit the preamble (for more clarification, refer to the HDMI 1.4b specification)."]
pub type Ch1PreambleFilterR = crate::FieldReader;
#[doc = "Field `CH1_PREAMBLE_FILTER` writer - When in control mode, configures 6 bits that fill the channel 1 data lines not used to transmit the preamble (for more clarification, refer to the HDMI 1.4b specification)."]
pub type Ch1PreambleFilterW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - When in control mode, configures 6 bits that fill the channel 1 data lines not used to transmit the preamble (for more clarification, refer to the HDMI 1.4b specification)."]
    #[inline(always)]
