...
#[doc = "Field `FIFOEMPTYREMAP` reader - Video Packetizer pixel YCC 422 re-mapper FIFO empty interrupt"]
pub type FifoemptyremapR = crate::BitReader;
#[doc = "Field `FIFOEMPTYREMAP` writer - Video Packetizer pixel YCC 422 re-mapper FIFO empty interrupt"]
pub type FifoemptyremapW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `FIFOFULLREMAP` reader - Video Packetizer pixel YCC 422 re-mapper FIFO full interrupt"]
pub type FifofullremapR = crate::BitReader;
#[doc = "Field `FIFOFULLREMAP` writer - Video Packetizer pixel YCC 422 re-mapper FIFO full interrupt"]
pub type FifofullremapW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `FIFOEMPTYPP` reader - Video Packetizer pixel packing FIFO empty interrupt"]
pub type FifoemptyppR = crate::BitReader;
#[doc = "Field `FIFOEMPTYPP` writer - Video Packetizer pixel packing FIFO empty interrupt"]
...
#[doc = "Field `FIFOEMPTYREPET` reader - Video Packetizer pixel repeater FIFO empty interrupt"]
pub type FifoemptyrepetR = crate::BitReader;
#[doc = "Field `FIFOEMPTYREPET` writer - Video Packetizer pixel repeater FIFO empty interrupt"]
...
impl R {
    #[doc = "Bit 2 - Video Packetizer pixel YCC 422 re-mapper FIFO empty interrupt"]
    #[inline(always)]
    pub fn fifoemptyremap(&self) -> FifoemptyremapR {
        FifoemptyremapR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Video Packetizer pixel YCC 422 re-mapper FIFO full interrupt"]
    #[inline(always)]
    pub fn fifofullremap(&self) -> FifofullremapR {
        FifofullremapR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Video Packetizer pixel packing FIFO empty interrupt"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Video Packetizer pixel repeater FIFO empty interrupt"]
    #[inline(always)]
