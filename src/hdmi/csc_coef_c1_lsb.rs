...
#[doc = "Field `CSC_COEF_C1_LSB` reader - Color Space Converter Matrix C1 Coefficient\n\nRegister LSB"]
pub type CscCoefC1LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_C1_LSB` writer - Color Space Converter Matrix C1 Coefficient\n\nRegister LSB"]
