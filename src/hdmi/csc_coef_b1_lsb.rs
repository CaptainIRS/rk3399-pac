...
#[doc = "Field `CSC_COEF_B1_LSB` reader - Color Space Converter Matrix B1 Coefficient Register LSB"]
pub type CscCoefB1LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_B1_LSB` writer - Color Space Converter Matrix B1 Coefficient Register LSB"]
pub type CscCoefB1LsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix B1 Coefficient Register LSB"]
    #[inline(always)]
