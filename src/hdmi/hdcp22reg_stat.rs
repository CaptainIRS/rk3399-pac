...
#[doc = "Field `ST_HDCP2_CAPABLE` reader - HDCP 2.2 capable rise interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
pub type StHdcp2CapableR = crate::BitReader;
#[doc = "Field `ST_HDCP2_CAPABLE` writer - HDCP 2.2 capable rise interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
pub type StHdcp2CapableW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ST_HDCP2_NOT_CAPABLE` reader - HDCP 2.2 not capable rise interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
pub type StHdcp2NotCapableR = crate::BitReader;
#[doc = "Field `ST_HDCP2_NOT_CAPABLE` writer - HDCP 2.2 not capable rise interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
pub type StHdcp2NotCapableW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ST_HDCP_AUTHENTICATION_LOST` reader - HDCP 2.2 authentication lost interrupt status sticky\n\nbit. Clear by Write 1 to this bit field"]
pub type StHdcpAuthenticationLostR = crate::BitReader;
#[doc = "Field `ST_HDCP_AUTHENTICATION_LOST` writer - HDCP 2.2 authentication lost interrupt status sticky\n\nbit. Clear by Write 1 to this bit field"]
pub type StHdcpAuthenticationLostW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ST_HDCP_AUTHENTICATED` reader - HDCP 2.2 authenticated interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
pub type StHdcpAuthenticatedR = crate::BitReader;
#[doc = "Field `ST_HDCP_AUTHENTICATED` writer - HDCP 2.2 authenticated interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
pub type StHdcpAuthenticatedW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ST_HDCP_AUTHENTICATION_FAIL` reader - HDCP 2.2 authentication fail interrupt status sticky\n\nbit. Clear by Write 1 to this bit field"]
pub type StHdcpAuthenticationFailR = crate::BitReader;
#[doc = "Field `ST_HDCP_AUTHENTICATION_FAIL` writer - HDCP 2.2 authentication fail interrupt status sticky\n\nbit. Clear by Write 1 to this bit field"]
pub type StHdcpAuthenticationFailW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ST_HDCP_DECRYPTED_CHG` reader - HDCP 2.2 decrypted value change interrupt status\n\nsticky bit. Clear by Write 1 to this bit field"]
pub type StHdcpDecryptedChgR = crate::BitReader;
#[doc = "Field `ST_HDCP_DECRYPTED_CHG` writer - HDCP 2.2 decrypted value change interrupt status\n\nsticky bit. Clear by Write 1 to this bit field"]
pub type StHdcpDecryptedChgW<'a, REG> = crate::BitWriter1C<'a, REG>;
impl R {
    #[doc = "Bit 0 - HDCP 2.2 capable rise interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
    #[inline(always)]
    pub fn st_hdcp2_capable(&self) -> StHdcp2CapableR {
        StHdcp2CapableR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - HDCP 2.2 not capable rise interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
    #[inline(always)]
    pub fn st_hdcp2_not_capable(&self) -> StHdcp2NotCapableR {
        StHdcp2NotCapableR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - HDCP 2.2 authentication lost interrupt status sticky\n\nbit. Clear by Write 1 to this bit field"]
    #[inline(always)]
    pub fn st_hdcp_authentication_lost(&self) -> StHdcpAuthenticationLostR {
        StHdcpAuthenticationLostR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - HDCP 2.2 authenticated interrupt status sticky bit.\n\nClear by Write 1 to this bit field"]
    #[inline(always)]
    pub fn st_hdcp_authenticated(&self) -> StHdcpAuthenticatedR {
        StHdcpAuthenticatedR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - HDCP 2.2 authentication fail interrupt status sticky\n\nbit. Clear by Write 1 to this bit field"]
    #[inline(always)]
    pub fn st_hdcp_authentication_fail(&self) -> StHdcpAuthenticationFailR {
        StHdcpAuthenticationFailR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - HDCP 2.2 decrypted value change interrupt status\n\nsticky bit. Clear by Write 1 to this bit field"]
    #[inline(always)]
