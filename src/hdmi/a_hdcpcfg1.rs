...
#[doc = "Field `SWRESET` reader - Software reset signal, active by writing a zero and\n\nauto cleared to 1 in the following cycle."]
pub type SwresetR = crate::BitReader;
#[doc = "Field `SWRESET` writer - Software reset signal, active by writing a zero and\n\nauto cleared to 1 in the following cycle."]
...
#[doc = "Field `PH2UPSHFTENC` reader - Enables the encoding of packet header in the\n\ntmdsch0 bit\\[0\\]
with cipher\\[2\\]
instead of the\n\ntmdsch0 bit\\[2\\]\n\nNote: This bit must always be set to 1 for all PHYs."]
pub type Ph2upshftencR = crate::BitReader;
#[doc = "Field `PH2UPSHFTENC` writer - Enables the encoding of packet header in the\n\ntmdsch0 bit\\[0\\]
with cipher\\[2\\]
instead of the\n\ntmdsch0 bit\\[2\\]\n\nNote: This bit must always be set to 1 for all PHYs."]
pub type Ph2upshftencW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DISSHA1CHECK` reader - Disables the request to the API processor to verify\n\nthe SHA1 message digest of a received KSV List"]
pub type Dissha1checkR = crate::BitReader;
#[doc = "Field `DISSHA1CHECK` writer - Disables the request to the API processor to verify\n\nthe SHA1 message digest of a received KSV List"]
pub type Dissha1checkW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Lock the HDCP bypass and encryption disable\n\nmechanisms:\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum HdcpLock {
    #[doc = "0: The default 1'b0 value enables you to bypass HDCP through bit 5 (bypencryption) of the A_HDCPCFG0 register or to disable the encryption through bit 1 (encryptiondisable) of A_HDCPCFG1."]
    B0 = 0,
...
#[doc = "Field `HDCP_LOCK` reader - Lock the HDCP bypass and encryption disable\n\nmechanisms:"]
...
impl HdcpLockR {
    ...
    #[doc = "The default 1'b0 value enables you to bypass HDCP through bit 5 (bypencryption) of the A_HDCPCFG0 register or to disable the encryption through bit 1 (encryptiondisable) of A_HDCPCFG1."]
    #[inline(always)]
...
#[doc = "Field `HDCP_LOCK` writer - Lock the HDCP bypass and encryption disable\n\nmechanisms:"]
...
impl R {
    #[doc = "Bit 0 - Software reset signal, active by writing a zero and\n\nauto cleared to 1 in the following cycle."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Enables the encoding of packet header in the\n\ntmdsch0 bit\\[0\\]
with cipher\\[2\\]
instead of the\n\ntmdsch0 bit\\[2\\]\n\nNote: This bit must always be set to 1 for all PHYs."]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - Disables the request to the API processor to verify\n\nthe SHA1 message digest of a received KSV List"]
    #[inline(always)]
    pub fn dissha1check(&self) -> Dissha1checkR {
        Dissha1checkR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Lock the HDCP bypass and encryption disable\n\nmechanisms:"]
    #[inline(always)]
    pub fn hdcp_lock(&self) -> HdcpLockR {
        HdcpLockR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 5:7 - Reserved as \"spare\" register with no associated\n\nfunctionality."]
    #[inline(always)]
