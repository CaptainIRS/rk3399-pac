...
#[doc = "Field `HDCP22_EXTERNALIF` reader - Indicates that External HDCP 2.2 interface is present. Reset Value: (HTX_HDCP22_EXTERNAL_NONE== 1) ? 1 : 0"]
pub type Hdcp22ExternalifR = crate::BitReader;
#[doc = "Field `HDCP22_3RDPARTY` reader - Indicates that External HDCP 2.2 interface is present and 3rd party HDCP 2.2 module is connected to this interface. Reset Value: (HTX_HDCP22_EXTERNAL_ELLP== 1) ? 1 : 0"]
pub type Hdcp22_3rdpartyR = crate::BitReader;
impl R {
    #[doc = "Bit 1 - Indicates that External HDCP 2.2 interface is present. Reset Value: (HTX_HDCP22_EXTERNAL_NONE== 1) ? 1 : 0"]
    #[inline(always)]
    pub fn hdcp22_externalif(&self) -> Hdcp22ExternalifR {
        Hdcp22ExternalifR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Indicates that External HDCP 2.2 interface is present and 3rd party HDCP 2.2 module is connected to this interface. Reset Value: (HTX_HDCP22_EXTERNAL_ELLP== 1) ? 1 : 0"]
    #[inline(always)]
