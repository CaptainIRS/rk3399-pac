...
#[doc = "Field `HDCP_REVOC_SIZE_1` reader - Register containing the MSB of KSV list size (ksv_list_size\\[15:8\\]). If Attr has not been granted (see register a_ksvmemctrl), the value read is 8'hff."]
pub type HdcpRevocSize1R = crate::FieldReader;
#[doc = "Field `HDCP_REVOC_SIZE_1` writer - Register containing the MSB of KSV list size (ksv_list_size\\[15:8\\]). If Attr has not been granted (see register a_ksvmemctrl), the value read is 8'hff."]
pub type HdcpRevocSize1W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Register containing the MSB of KSV list size (ksv_list_size\\[15:8\\]). If Attr has not been granted (see register a_ksvmemctrl), the value read is 8'hff."]
    #[inline(always)]
