...
#[doc = "Field `MASK_HDCP2_CAPABLE` reader - Active high interrupt mask to HDCP 2.2 capable rise\n\ninterrupt status"]
pub type MaskHdcp2CapableR = crate::BitReader;
#[doc = "Field `MASK_HDCP2_CAPABLE` writer - Active high interrupt mask to HDCP 2.2 capable rise\n\ninterrupt status"]
pub type MaskHdcp2CapableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MASK_HDCP2_NOT_CAPABLE` reader - Active high interrupt mask to HDCP 2.2 not capable\n\nrise interrupt status"]
pub type MaskHdcp2NotCapableR = crate::BitReader;
#[doc = "Field `MASK_HDCP2_NOT_CAPABLE` writer - Active high interrupt mask to HDCP 2.2 not capable\n\nrise interrupt status"]
pub type MaskHdcp2NotCapableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MASK_HDCP_AUTHENTICATION_LOST` reader - Active high interrupt mask to HDCP 2.2\n\nauthentication lost interrupt status"]
pub type MaskHdcpAuthenticationLostR = crate::BitReader;
#[doc = "Field `MASK_HDCP_AUTHENTICATION_LOST` writer - Active high interrupt mask to HDCP 2.2\n\nauthentication lost interrupt status"]
pub type MaskHdcpAuthenticationLostW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MASK_HDCP_AUTHENTICATED` reader - Active high interrupt mask to HDCP 2.2\n\nauthenticated interrupt status"]
pub type MaskHdcpAuthenticatedR = crate::BitReader;
#[doc = "Field `MASK_HDCP_AUTHENTICATED` writer - Active high interrupt mask to HDCP 2.2\n\nauthenticated interrupt status"]
pub type MaskHdcpAuthenticatedW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MASK_HDCP_AUTHENTICATION_FAIL` reader - Active high interrupt mask to HDCP 2.2\n\nauthentication fail interrupt status"]
pub type MaskHdcpAuthenticationFailR = crate::BitReader;
#[doc = "Field `MASK_HDCP_AUTHENTICATION_FAIL` writer - Active high interrupt mask to HDCP 2.2\n\nauthentication fail interrupt status"]
pub type MaskHdcpAuthenticationFailW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MASK_HDCP_DECRYPTED_CHG` reader - Active high interrupt mask to HDCP 2.2 decrypted\n\nvalue change interrupt status"]
pub type MaskHdcpDecryptedChgR = crate::BitReader;
#[doc = "Field `MASK_HDCP_DECRYPTED_CHG` writer - Active high interrupt mask to HDCP 2.2 decrypted\n\nvalue change interrupt status"]
pub type MaskHdcpDecryptedChgW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Active high interrupt mask to HDCP 2.2 capable rise\n\ninterrupt status"]
    #[inline(always)]
    pub fn mask_hdcp2_capable(&self) -> MaskHdcp2CapableR {
        MaskHdcp2CapableR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Active high interrupt mask to HDCP 2.2 not capable\n\nrise interrupt status"]
    #[inline(always)]
    pub fn mask_hdcp2_not_capable(&self) -> MaskHdcp2NotCapableR {
        MaskHdcp2NotCapableR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Active high interrupt mask to HDCP 2.2\n\nauthentication lost interrupt status"]
    #[inline(always)]
    pub fn mask_hdcp_authentication_lost(&self) -> MaskHdcpAuthenticationLostR {
        MaskHdcpAuthenticationLostR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Active high interrupt mask to HDCP 2.2\n\nauthenticated interrupt status"]
    #[inline(always)]
    pub fn mask_hdcp_authenticated(&self) -> MaskHdcpAuthenticatedR {
        MaskHdcpAuthenticatedR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Active high interrupt mask to HDCP 2.2\n\nauthentication fail interrupt status"]
    #[inline(always)]
    pub fn mask_hdcp_authentication_fail(&self) -> MaskHdcpAuthenticationFailR {
        MaskHdcpAuthenticationFailR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Active high interrupt mask to HDCP 2.2 decrypted\n\nvalue change interrupt status"]
    #[inline(always)]
