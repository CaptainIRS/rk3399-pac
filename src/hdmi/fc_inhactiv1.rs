...
#[doc = "Field `H_IN_ACTIV_13` reader - Input video Horizontal active pixel region width\n\n(0 .. 16383) If the configuration parameter\n\nHDMI_TX_20 = True (1), this bit field holds bit 13."]
pub type HInActiv13R = crate::BitReader;
#[doc = "Field `H_IN_ACTIV_13` writer - Input video Horizontal active pixel region width\n\n(0 .. 16383) If the configuration parameter\n\nHDMI_TX_20 = True (1), this bit field holds bit 13."]
pub type HInActiv13W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 5 - Input video Horizontal active pixel region width\n\n(0 .. 16383) If the configuration parameter\n\nHDMI_TX_20 = True (1), this bit field holds bit 13."]
    #[inline(always)]
