...
#[doc = "Field `CSC_COEF_B4_LSB` reader - Color Space Converter Matrix B4 Coefficient\n\nRegister LSB"]
pub type CscCoefB4LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_B4_LSB` writer - Color Space Converter Matrix B4 Coefficient\n\nRegister LSB"]
