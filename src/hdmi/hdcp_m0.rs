...
#[doc = "Field `M0` reader - HDCP M0\\[32:0\\]. If Attr has not been granted (see register a_ksvmemctrl) , the value read will be 8'hff. These values are only available on a configuration that has the SHA1 calculation by software."]
pub type M0R = crate::FieldReader;
#[doc = "Field `M0` writer - HDCP M0\\[32:0\\]. If Attr has not been granted (see register a_ksvmemctrl) , the value read will be 8'hff. These values are only available on a configuration that has the SHA1 calculation by software."]
pub type M0W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - HDCP M0\\[32:0\\]. If Attr has not been granted (see register a_ksvmemctrl) , the value read will be 8'hff. These values are only available on a configuration that has the SHA1 calculation by software."]
    #[inline(always)]
    pub fn m0(&self) -> M0R {
        M0R::new(self.bits)
    }
