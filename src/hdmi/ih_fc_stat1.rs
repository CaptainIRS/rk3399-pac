...
#[doc = "Field `GCP` reader - Active after successful transmission of an General\n\nControl Packet."]
pub type GcpR = crate::BitReader;
#[doc = "Field `GCP` writer - Active after successful transmission of an General\n\nControl Packet."]
pub type GcpW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `AVI` reader - Active after successful transmission of an AVI\n\nInfoFrame packet."]
pub type AviR = crate::BitReader;
#[doc = "Field `AVI` writer - Active after successful transmission of an AVI\n\nInfoFrame packet."]
pub type AviW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `AMP` reader - Active after successful transmission of an Audio\n\nMetadata packet"]
pub type AmpR = crate::BitReader;
#[doc = "Field `AMP` writer - Active after successful transmission of an Audio\n\nMetadata packet"]
pub type AmpW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SPD` reader - Active after successful transmission of an Source\n\nProduct Descriptor InfoFrame packet."]
pub type SpdR = crate::BitReader;
#[doc = "Field `SPD` writer - Active after successful transmission of an Source\n\nProduct Descriptor InfoFrame packet."]
pub type SpdW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `VSD` reader - Active after successful transmission of an Vendor\n\nSpecific Data InfoFrame packet."]
pub type VsdR = crate::BitReader;
#[doc = "Field `VSD` writer - Active after successful transmission of an Vendor\n\nSpecific Data InfoFrame packet."]
pub type VsdW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ISCR2` reader - Active after successful transmission of an\n\nInternational Standard Recording Code 2 packet"]
pub type Iscr2R = crate::BitReader;
#[doc = "Field `ISCR2` writer - Active after successful transmission of an\n\nInternational Standard Recording Code 2 packet"]
pub type Iscr2W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ISCR1` reader - Active after successful transmission of an\n\nInternational Standard Recording Code 1 packet."]
pub type Iscr1R = crate::BitReader;
#[doc = "Field `ISCR1` writer - Active after successful transmission of an\n\nInternational Standard Recording Code 1 packet."]
pub type Iscr1W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `GMD` reader - Active after successful transmission of an Gamut\n\nmetadata packet."]
pub type GmdR = crate::BitReader;
#[doc = "Field `GMD` writer - Active after successful transmission of an Gamut\n\nmetadata packet."]
pub type GmdW<'a, REG> = crate::BitWriter1C<'a, REG>;
impl R {
    #[doc = "Bit 0 - Active after successful transmission of an General\n\nControl Packet."]
    #[inline(always)]
    pub fn gcp(&self) -> GcpR {
        GcpR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Active after successful transmission of an AVI\n\nInfoFrame packet."]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - Active after successful transmission of an Source\n\nProduct Descriptor InfoFrame packet."]
    #[inline(always)]
    pub fn spd(&self) -> SpdR {
        SpdR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Active after successful transmission of an Vendor\n\nSpecific Data InfoFrame packet."]
    #[inline(always)]
    pub fn vsd(&self) -> VsdR {
        VsdR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Active after successful transmission of an\n\nInternational Standard Recording Code 2 packet"]
    #[inline(always)]
    pub fn iscr2(&self) -> Iscr2R {
        Iscr2R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Active after successful transmission of an\n\nInternational Standard Recording Code 1 packet."]
    #[inline(always)]
    pub fn iscr1(&self) -> Iscr1R {
        Iscr1R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Active after successful transmission of an Gamut\n\nmetadata packet."]
    #[inline(always)]
