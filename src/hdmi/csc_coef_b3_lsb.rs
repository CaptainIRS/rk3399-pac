...
#[doc = "Field `CSC_COEF_B3_LSB` reader - Color Space Converter Matrix B3 Coefficient\n\nRegister LSB"]
pub type CscCoefB3LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_B3_LSB` writer - Color Space Converter Matrix B3 Coefficient\n\nRegister LSB"]
