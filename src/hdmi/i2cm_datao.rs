...
#[doc = "Field `DATAO` reader - Data to be written on register pointed by\n\naddress\\[7:0\\]."]
pub type DataoR = crate::FieldReader;
#[doc = "Field `DATAO` writer - Data to be written on register pointed by\n\naddress\\[7:0\\]."]
pub type DataoW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Data to be written on register pointed by\n\naddress\\[7:0\\]."]
    #[inline(always)]
