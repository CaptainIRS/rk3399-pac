...
#[doc = "Field `CSC_COEF_A1_LSB` reader - Color Space Converter Matrix A1 Coefficient Register LSB"]
pub type CscCoefA1LsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_A1_LSB` writer - Color Space Converter Matrix A1 Coefficient Register LSB"]
pub type CscCoefA1LsbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Color Space Converter Matrix A1 Coefficient Register LSB"]
    #[inline(always)]
