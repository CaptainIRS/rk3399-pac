...
#[doc = "Field `AUD_PACKET_LAYOUT` reader - Set the audio packet layout to be sent in the packet: 1b: layout 1 0b: layout 0 If HDMI_TX_20 is defined and register field fc_multistream_ctrl.fc_mas_packet_en is active, this bit has no effect."]
pub type AudPacketLayoutR = crate::BitReader;
#[doc = "Field `AUD_PACKET_LAYOUT` writer - Set the audio packet layout to be sent in the packet: 1b: layout 1 0b: layout 0 If HDMI_TX_20 is defined and register field fc_multistream_ctrl.fc_mas_packet_en is active, this bit has no effect."]
pub type AudPacketLayoutW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `AUD_PACKET_SAMPFLT` reader - Set the audio packet sample flat value to be sent on the packet."]
pub type AudPacketSampfltR = crate::FieldReader;
#[doc = "Field `AUD_PACKET_SAMPFLT` writer - Set the audio packet sample flat value to be sent on the packet."]
pub type AudPacketSampfltW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - Set the audio packet layout to be sent in the packet: 1b: layout 1 0b: layout 0 If HDMI_TX_20 is defined and register field fc_multistream_ctrl.fc_mas_packet_en is active, this bit has no effect."]
    #[inline(always)]
    pub fn aud_packet_layout(&self) -> AudPacketLayoutR {
        AudPacketLayoutR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 4:7 - Set the audio packet sample flat value to be sent on the packet."]
    #[inline(always)]
