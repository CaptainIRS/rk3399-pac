...
#[doc = "Field `GMDPACKETLINESPACING` reader - Number of line spacing between the transmitted GMD packets"]
pub type GmdpacketlinespacingR = crate::FieldReader;
#[doc = "Field `GMDPACKETLINESPACING` writer - Number of line spacing between the transmitted GMD packets"]
pub type GmdpacketlinespacingW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `GMDPACKETSINFRAME` reader - Number of GMD packets per frame or video field (profile P0)"]
pub type GmdpacketsinframeR = crate::FieldReader;
#[doc = "Field `GMDPACKETSINFRAME` writer - Number of GMD packets per frame or video field (profile P0)"]
pub type GmdpacketsinframeW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bits 0:3 - Number of line spacing between the transmitted GMD packets"]
    #[inline(always)]
    pub fn gmdpacketlinespacing(&self) -> GmdpacketlinespacingR {
        GmdpacketlinespacingR::new(self.bits & 0x0f)
    }
    #[doc = "Bits 4:7 - Number of GMD packets per frame or video field (profile P0)"]
    #[inline(always)]
