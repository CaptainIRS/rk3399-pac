...
#[doc = "Field `OINTEMPTYREMAP` reader - Mask bit for Video Packetizer pixel YCC 422 re-\n\nmapper FIFO empty"]
pub type OintemptyremapR = crate::BitReader;
#[doc = "Field `OINTEMPTYREMAP` writer - Mask bit for Video Packetizer pixel YCC 422 re-\n\nmapper FIFO empty"]
pub type OintemptyremapW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OINTFULLREMAP` reader - Mask bit for Video Packetizer pixel YCC 422 re-\n\nmapper FIFO full"]
pub type OintfullremapR = crate::BitReader;
#[doc = "Field `OINTFULLREMAP` writer - Mask bit for Video Packetizer pixel YCC 422 re-\n\nmapper FIFO full"]
pub type OintfullremapW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OINTEMPTYPP` reader - Mask bit for Video Packetizer pixel packing FIFO\n\nempty"]
pub type OintemptyppR = crate::BitReader;
#[doc = "Field `OINTEMPTYPP` writer - Mask bit for Video Packetizer pixel packing FIFO\n\nempty"]
pub type OintemptyppW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OINTFULLPP` reader - Mask bit for Video Packetizer pixel packing FIFO\n\nfull"]
pub type OintfullppR = crate::BitReader;
#[doc = "Field `OINTFULLPP` writer - Mask bit for Video Packetizer pixel packing FIFO\n\nfull"]
pub type OintfullppW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OINTEMPTYREPET` reader - Mask bit for Video Packetizer pixel repeater FIFO\n\nempty"]
pub type OintemptyrepetR = crate::BitReader;
#[doc = "Field `OINTEMPTYREPET` writer - Mask bit for Video Packetizer pixel repeater FIFO\n\nempty"]
pub type OintemptyrepetW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OINTFULLREPET` reader - Mask bit for Video Packetizer pixel repeater FIFO\n\nfull"]
pub type OintfullrepetR = crate::BitReader;
#[doc = "Field `OINTFULLREPET` writer - Mask bit for Video Packetizer pixel repeater FIFO\n\nfull"]
