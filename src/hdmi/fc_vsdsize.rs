...
#[doc = "Field `VSDSIZE` reader - Packet size as described in the HDMI Vendor\n\nSpecific InfoFrame (from the HDMI specification)."]
pub type VsdsizeR = crate::FieldReader;
#[doc = "Field `VSDSIZE` writer - Packet size as described in the HDMI Vendor\n\nSpecific InfoFrame (from the HDMI specification)."]
pub type VsdsizeW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:4 - Packet size as described in the HDMI Vendor\n\nSpecific InfoFrame (from the HDMI specification)."]
    #[inline(always)]
