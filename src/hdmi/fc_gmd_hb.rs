...
impl R {
    ...
    #[doc = "Bits 4:6 - GMD profile bits. Hdmi_tx only supports Profile 0\n\n(P0) of the Gamut Boundary Description Metadata\n\nProfiles described in the HDMI 1.4 Specification\n\n(which defines four profiles, P0-P4)."]
    #[inline(always)]
