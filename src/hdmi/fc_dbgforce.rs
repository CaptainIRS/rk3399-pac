...
#[doc = "Field `FORCEVIDEO` reader - Force fixed video output with FC_DBGTMDSx register contents."]
pub type ForcevideoR = crate::BitReader;
#[doc = "Field `FORCEVIDEO` writer - Force fixed video output with FC_DBGTMDSx register contents."]
pub type ForcevideoW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FORCEAUDIO` reader - Force fixed audio output with FC_DBGAUDxCHx register contents."]
pub type ForceaudioR = crate::BitReader;
#[doc = "Field `FORCEAUDIO` writer - Force fixed audio output with FC_DBGAUDxCHx register contents."]
pub type ForceaudioW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Force fixed video output with FC_DBGTMDSx register contents."]
    #[inline(always)]
    pub fn forcevideo(&self) -> ForcevideoR {
        ForcevideoR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 4 - Force fixed audio output with FC_DBGAUDxCHx register contents."]
    #[inline(always)]
