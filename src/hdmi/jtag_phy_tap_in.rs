...
#[doc = "Field `JTAG_TDI` reader - Configures the JTAG PHY interface pin JTAG_TDI when in internal control mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tdi when PHY_EXTERNAL=1."]
pub type JtagTdiR = crate::BitReader;
#[doc = "Field `JTAG_TDI` writer - Configures the JTAG PHY interface pin JTAG_TDI when in internal control mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tdi when PHY_EXTERNAL=1."]
pub type JtagTdiW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `JTAG_TMS` reader - Configures the JTAG PHY interface pin JTAG_TMS when in internal control mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tms when PHY_EXTERNAL=1."]
pub type JtagTmsR = crate::BitReader;
#[doc = "Field `JTAG_TMS` writer - Configures the JTAG PHY interface pin JTAG_TMS when in internal control mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tms when PHY_EXTERNAL=1."]
pub type JtagTmsW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures the JTAG PHY interface pin JTAG_TDI when in internal control mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tdi when PHY_EXTERNAL=1."]
    #[inline(always)]
    pub fn jtag_tdi(&self) -> JtagTdiR {
        JtagTdiR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 4 - Configures the JTAG PHY interface pin JTAG_TMS when in internal control mode (iphy_ext_ctrl=1'b0) or ophyext_jtag_tms when PHY_EXTERNAL=1."]
    #[inline(always)]
