...
#[doc = "Field `DATAO` reader - Data MSB (datao\\[15:8\\]) to be written on register pointed by phy_i2cm_address \\[7:0\\]."]
pub type DataoR = crate::FieldReader;
#[doc = "Field `DATAO` writer - Data MSB (datao\\[15:8\\]) to be written on register pointed by phy_i2cm_address \\[7:0\\]."]
pub type DataoW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Data MSB (datao\\[15:8\\]) to be written on register pointed by phy_i2cm_address \\[7:0\\]."]
    #[inline(always)]
