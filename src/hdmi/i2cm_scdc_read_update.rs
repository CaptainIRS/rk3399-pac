...
#[doc = "Field `READ_UPDATE` writer - When set to 1'b1, a SCDC Update Read is performed and the read data loaded into registers i2cm_scdc_update0 and i2cm_scdc_update1."]
pub type ReadUpdateW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `READ_REQUEST_EN` reader - Read request enabled. When active (1'b1) an SCDC Update Read shall be performed whenever a SCDC read request is detected."]
pub type ReadRequestEnR = crate::BitReader;
#[doc = "Field `READ_REQUEST_EN` writer - Read request enabled. When active (1'b1) an SCDC Update Read shall be performed whenever a SCDC read request is detected."]
pub type ReadRequestEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UPDTRD_VSYNCPOLL_EN` reader - Update read polling enabled. When active (1'b1), an SCDC Update Read is performed at the fall of the active edge of the vertical sync pulse."]
pub type UpdtrdVsyncpollEnR = crate::BitReader;
#[doc = "Field `UPDTRD_VSYNCPOLL_EN` writer - Update read polling enabled. When active (1'b1), an SCDC Update Read is performed at the fall of the active edge of the vertical sync pulse."]
pub type UpdtrdVsyncpollEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 4 - Read request enabled. When active (1'b1) an SCDC Update Read shall be performed whenever a SCDC read request is detected."]
    #[inline(always)]
    pub fn read_request_en(&self) -> ReadRequestEnR {
        ReadRequestEnR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Update read polling enabled. When active (1'b1), an SCDC Update Read is performed at the fall of the active edge of the vertical sync pulse."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - When set to 1'b1, a SCDC Update Read is performed and the read data loaded into registers i2cm_scdc_update0 and i2cm_scdc_update1."]
    #[inline(always)]
    #[must_use]
