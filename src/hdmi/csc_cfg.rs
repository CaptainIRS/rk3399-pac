...
#[doc = "Field `DECMODE` reader - Chroma decimation configuration: decmode\\[1:0\\]
...
#[doc = "Field `DECMODE` writer - Chroma decimation configuration: decmode\\[1:0\\]
| Chroma Decimation 00 | decimation disabled 01 | Hd (z) =1 10 | Hd(z)=1/ 4 + 1/2z^(-1 )+1/4 z^(-2) 11 | Hd(z)x2^(11)= -5+12z^(-2) - 22z^(- 4)+39z^(-8) +109z^(-10) -204z^(-12)+648z^(-14) + 1024z^(-15) +648z^(-16) - 204z^(-18) +109z^(-20)- 65z^(-22) +39z^(-24) - 22z^(-26) +12z^(- 28)-5z^(-30)"]
pub type DecmodeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `SPARE_1` reader - Reserved as \"spare\" register with no associated functionality."]
pub type Spare1R = crate::FieldReader;
#[doc = "Field `SPARE_1` writer - Reserved as \"spare\" register with no associated functionality."]
pub type Spare1W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `INTMODE` reader - Chroma interpolation configuration: intmode\\[1:0\\]
| Chroma Interpolation 00 | interpolation disabled 01 | Hu (z) =1 + z^(-1) 10 | Hu(z)=1/ 2 + z^(-11)+1/2 z^(-2) 11 | interpolation disabled"]
pub type IntmodeR = crate::FieldReader;
#[doc = "Field `INTMODE` writer - Chroma interpolation configuration: intmode\\[1:0\\]
| Chroma Interpolation 00 | interpolation disabled 01 | Hu (z) =1 + z^(-1) 10 | Hu(z)=1/ 2 + z^(-11)+1/2 z^(-2) 11 | interpolation disabled"]
pub type IntmodeW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `SPARE_2` reader - Reserved as \"spare\" register with no associated functionality."]
pub type Spare2R = crate::BitReader;
#[doc = "Field `SPARE_2` writer - Reserved as \"spare\" register with no associated functionality."]
pub type Spare2W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CSC_LIMIT` reader - When set (1'b1), the range limitation values defined in registers csc_mat_uplim and csc_mat_dnlim are applied to the output of the Color Space Conversion matrix. This feature ensures that the video output range is always respected, independently of the matrix coefficient configuration or of the video input stream."]
pub type CscLimitR = crate::BitReader;
#[doc = "Field `CSC_LIMIT` writer - When set (1'b1), the range limitation values defined in registers csc_mat_uplim and csc_mat_dnlim are applied to the output of the Color Space Conversion matrix. This feature ensures that the video output range is always respected, independently of the matrix coefficient configuration or of the video input stream."]
pub type CscLimitW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:1 - Chroma decimation configuration: decmode\\[1:0\\]
| Chroma Decimation 00 | decimation disabled 01 | Hd (z) =1 10 | Hd(z)=1/ 4 + 1/2z^(-1 )+1/4 z^(-2) 11 | Hd(z)x2^(11)= -5+12z^(-2) - 22z^(- 4)+39z^(-8) +109z^(-10) -204z^(-12)+648z^(-14) + 1024z^(-15) +648z^(-16) - 204z^(-18) +109z^(-20)- 65z^(-22) +39z^(-24) - 22z^(-26) +12z^(- 28)-5z^(-30)"]
    #[inline(always)]
    pub fn decmode(&self) -> DecmodeR {
        DecmodeR::new(self.bits & 3)
    }
    #[doc = "Bits 2:3 - Reserved as \"spare\" register with no associated functionality."]
    #[inline(always)]
    pub fn spare_1(&self) -> Spare1R {
        Spare1R::new((self.bits >> 2) & 3)
    }
    #[doc = "Bits 4:5 - Chroma interpolation configuration: intmode\\[1:0\\]
| Chroma Interpolation 00 | interpolation disabled 01 | Hu (z) =1 + z^(-1) 10 | Hu(z)=1/ 2 + z^(-11)+1/2 z^(-2) 11 | interpolation disabled"]
    #[inline(always)]
    pub fn intmode(&self) -> IntmodeR {
        IntmodeR::new((self.bits >> 4) & 3)
    }
    #[doc = "Bit 6 - Reserved as \"spare\" register with no associated functionality."]
    #[inline(always)]
