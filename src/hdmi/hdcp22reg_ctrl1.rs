...
pub enum Hdcp22CdOvrEn {
    #[doc = "0: Although the used color depth for pixel encoding is defined by the field vp_pr_cd.color_depth register, the color depth sent to the external interface is the one defined in register field hdcp22reg_ctrl1.hdcp22_cd_ovr_val."]
    B0 = 0,
...
#[doc = "Field `HDCP22_CD_OVR_VAL` reader - HDCP color depth override value, which is sent through the HDCP 2.2 external interface when hdcp22reg_ctrl1.hdcp22_cd_ovr_en is set. For reference on the HDMI allowed values consult the HDMI 1.4b specification, Table 6-1."]
pub type Hdcp22CdOvrValR = crate::FieldReader;
#[doc = "Field `HDCP22_CD_OVR_VAL` writer - HDCP color depth override value, which is sent through the HDCP 2.2 external interface when hdcp22reg_ctrl1.hdcp22_cd_ovr_en is set. For reference on the HDMI allowed values consult the HDMI 1.4b specification, Table 6-1."]
...
impl R {
    ...
    #[doc = "Bits 4:7 - HDCP color depth override value, which is sent through the HDCP 2.2 external interface when hdcp22reg_ctrl1.hdcp22_cd_ovr_en is set. For reference on the HDMI allowed values consult the HDMI 1.4b specification, Table 6-1."]
    #[inline(always)]
