...
#[doc = "Field `CSC_COEF_A4_MSB` reader - Color Space Converter Matrix A4 Coefficient\n\nRegister MSB"]
pub type CscCoefA4MsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_A4_MSB` writer - Color Space Converter Matrix A4 Coefficient\n\nRegister MSB"]
