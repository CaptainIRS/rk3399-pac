...
#[doc = "Field `V_IN_WIDTH` reader - Description: Input video Vsync active pulse width. Integer number of video lines \\[0...63\\]."]
pub type VInWidthR = crate::FieldReader;
#[doc = "Field `V_IN_WIDTH` writer - Description: Input video Vsync active pulse width. Integer number of video lines \\[0...63\\]."]
pub type VInWidthW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Description: Input video Vsync active pulse width. Integer number of video lines \\[0...63\\]."]
    #[inline(always)]
