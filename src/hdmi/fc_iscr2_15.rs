...
#[doc = "Field `FC_ISCR2_15` reader - Frame Composer ISRC2 Packet Body Register 15; configures the ISRC2 packet body of the ISRC2 packet"]
pub type FcIscr2_15R = crate::FieldReader;
#[doc = "Field `FC_ISCR2_15` writer - Frame Composer ISRC2 Packet Body Register 15; configures the ISRC2 packet body of the ISRC2 packet"]
pub type FcIscr2_15W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Frame Composer ISRC2 Packet Body Register 15; configures the ISRC2 packet body of the ISRC2 packet"]
    #[inline(always)]
