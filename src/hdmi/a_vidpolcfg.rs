...
#[doc = "Field `HSYNCPOL` reader - Configuration of the video Horizontal synchronism\n\npolarity."]
pub type HsyncpolR = crate::BitReader;
#[doc = "Field `HSYNCPOL` writer - Configuration of the video Horizontal synchronism\n\npolarity."]
...
#[doc = "Field `VSYNCPOL` reader - Configuration of the video Vertical synchronism\n\npolarity"]
pub type VsyncpolR = crate::BitReader;
#[doc = "Field `VSYNCPOL` writer - Configuration of the video Vertical synchronism\n\npolarity"]
...
#[doc = "Field `UNENCRYPTCONF` reader - Configuration of the color sent when sending\n\nunencrypted video data"]
pub type UnencryptconfR = crate::FieldReader;
#[doc = "Field `UNENCRYPTCONF` writer - Configuration of the color sent when sending\n\nunencrypted video data"]
...
impl R {
    ...
    #[doc = "Bit 1 - Configuration of the video Horizontal synchronism\n\npolarity."]
    #[inline(always)]
    pub fn hsyncpol(&self) -> HsyncpolR {
        HsyncpolR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Reserved as \"spare\" bit with no associated\n\nfunctionality."]
    #[inline(always)]
    pub fn spare_2(&self) -> Spare2R {
        Spare2R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Configuration of the video Vertical synchronism\n\npolarity"]
    #[inline(always)]
    ...
    #[doc = "Bits 5:6 - Configuration of the color sent when sending\n\nunencrypted video data"]
    #[inline(always)]
