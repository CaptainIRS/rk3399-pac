...
#[doc = "Field `OUTPUT_SELECTOR_0` reader - Video Packetizer output selection 0b: Data from pixel packing block 1b: Data from YCC422 remap block"]
pub type OutputSelector0R = crate::BitReader;
#[doc = "Field `OUTPUT_SELECTOR_0` writer - Video Packetizer output selection 0b: Data from pixel packing block 1b: Data from YCC422 remap block"]
...
pub enum BypassSelect {
    #[doc = "0: Data from input of Video Packetizer block"]
    B0 = 0,
...
#[doc = "Field `YCC422_EN` reader - YCC 422 select enable. Disabling forces bypass module to output always zeros."]
pub type Ycc422EnR = crate::BitReader;
#[doc = "Field `YCC422_EN` writer - YCC 422 select enable. Disabling forces bypass module to output always zeros."]
pub type Ycc422EnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PR_EN` reader - Pixel repeater enable. When set to 0, the pixel repetition block is disabled."]
pub type PrEnR = crate::BitReader;
#[doc = "Field `PR_EN` writer - Pixel repeater enable. When set to 0, the pixel repetition block is disabled."]
pub type PrEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PP_EN` reader - Pixel packing enable. When set to 0, the pixel packing block is disabled if bypass_en is 1’b0."]
pub type PpEnR = crate::BitReader;
#[doc = "Field `PP_EN` writer - Pixel packing enable. When set to 0, the pixel packing block is disabled if bypass_en is 1’b0."]
pub type PpEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BYPASS_EN` reader - When set to 1'b1, Pixel packing enable. When set to 1b'0, the pixel packing block is controlled by pp_en."]
pub type BypassEnR = crate::BitReader;
#[doc = "Field `BYPASS_EN` writer - When set to 1'b1, Pixel packing enable. When set to 1b'0, the pixel packing block is controlled by pp_en."]
pub type BypassEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Video Packetizer output selection 0b: Data from pixel packing block 1b: Data from YCC422 remap block"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - YCC 422 select enable. Disabling forces bypass module to output always zeros."]
    #[inline(always)]
    pub fn ycc422_en(&self) -> Ycc422EnR {
        Ycc422EnR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Pixel repeater enable. When set to 0, the pixel repetition block is disabled."]
    #[inline(always)]
    pub fn pr_en(&self) -> PrEnR {
        PrEnR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Pixel packing enable. When set to 0, the pixel packing block is disabled if bypass_en is 1’b0."]
    #[inline(always)]
    pub fn pp_en(&self) -> PpEnR {
        PpEnR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - When set to 1'b1, Pixel packing enable. When set to 1b'0, the pixel packing block is controlled by pp_en."]
    #[inline(always)]
