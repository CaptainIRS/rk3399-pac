...
#[doc = "Field `CSC_COEF_C2_MSB` reader - Color Space Converter Matrix C2 Coefficient\n\nRegister MSB"]
pub type CscCoefC2MsbR = crate::FieldReader;
#[doc = "Field `CSC_COEF_C2_MSB` writer - Color Space Converter Matrix C2 Coefficient\n\nRegister MSB"]
