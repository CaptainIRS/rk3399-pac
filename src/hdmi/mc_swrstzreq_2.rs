...
#[doc = "Field `AHBDMASWRST_REQ` reader - AHB audio DMA software reset request. Writing 1'b1 does not result in any action. Writing 1'b0 to this register resets all AHB audio logic."]
pub type AhbdmaswrstReqR = crate::BitReader;
#[doc = "Field `AHBDMASWRST_REQ` writer - AHB audio DMA software reset request. Writing 1'b1 does not result in any action. Writing 1'b0 to this register resets all AHB audio logic."]
pub type AhbdmaswrstReqW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - AHB audio DMA software reset request. Writing 1'b1 does not result in any action. Writing 1'b0 to this register resets all AHB audio logic."]
    #[inline(always)]
