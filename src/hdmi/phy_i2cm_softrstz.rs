...
#[doc = "Field `I2C_SOFTRSTZ` reader - I2C Master Software Reset. Active by writing a zero and auto cleared to one in the following cycle."]
pub type I2cSoftrstzR = crate::BitReader;
#[doc = "Field `I2C_SOFTRSTZ` writer - I2C Master Software Reset. Active by writing a zero and auto cleared to one in the following cycle."]
pub type I2cSoftrstzW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - I2C Master Software Reset. Active by writing a zero and auto cleared to one in the following cycle."]
    #[inline(always)]
