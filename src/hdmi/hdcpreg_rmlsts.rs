...
#[doc = "Field `IDPK_DATA_INDEX` reader - Current Device Private Key being written plus one.\n\nPosition 0 is occupied by the AKSV."]
pub type IdpkDataIndexR = crate::FieldReader;
#[doc = "Field `IDPK_WR_OK_STS` reader - When high (1'b1), it indicates that a DPK write is\n\nallowed."]
pub type IdpkWrOkStsR = crate::BitReader;
impl R {
    #[doc = "Bits 0:5 - Current Device Private Key being written plus one.\n\nPosition 0 is occupied by the AKSV."]
    #[inline(always)]
    pub fn idpk_data_index(&self) -> IdpkDataIndexR {
        IdpkDataIndexR::new(self.bits & 0x3f)
    }
    #[doc = "Bit 6 - When high (1'b1), it indicates that a DPK write is\n\nallowed."]
    #[inline(always)]
