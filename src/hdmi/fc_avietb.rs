...
#[doc = "Field `FC_AVIETB` reader - Defines the AVI InfoFrame End of Top Bar value. For more information, refer to the CEA-861-E specification."]
pub type FcAvietbR = crate::FieldReader;
#[doc = "Field `FC_AVIETB` writer - Defines the AVI InfoFrame End of Top Bar value. For more information, refer to the CEA-861-E specification."]
pub type FcAvietbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Defines the AVI InfoFrame End of Top Bar value. For more information, refer to the CEA-861-E specification."]
    #[inline(always)]
