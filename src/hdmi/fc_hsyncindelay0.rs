...
#[doc = "Field `H_IN_DELAY` reader - Input video Hsync active edge delay. Integer\n\nnumber of pixel clock cycles from \"de\" non active\n\nedge of the last \"de\" valid period \\[0...4095\\]."]
pub type HInDelayR = crate::FieldReader;
#[doc = "Field `H_IN_DELAY` writer - Input video Hsync active edge delay. Integer\n\nnumber of pixel clock cycles from \"de\" non active\n\nedge of the last \"de\" valid period \\[0...4095\\]."]
pub type HInDelayW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Input video Hsync active edge delay. Integer\n\nnumber of pixel clock cycles from \"de\" non active\n\nedge of the last \"de\" valid period \\[0...4095\\]."]
    #[inline(always)]
