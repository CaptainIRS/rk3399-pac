...
#[doc = "Field `STOP_DMA_TRANSACTION` reader - Stop DMA transaction This register is auto-cleared when the transfer operation is stopped (done)."]
pub type StopDmaTransactionR = crate::BitReader;
#[doc = "Field `STOP_DMA_TRANSACTION` writer - Stop DMA transaction This register is auto-cleared when the transfer operation is stopped (done)."]
pub type StopDmaTransactionW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Stop DMA transaction This register is auto-cleared when the transfer operation is stopped (done)."]
    #[inline(always)]
