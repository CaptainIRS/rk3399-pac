...
#[doc = "Field `CONFGPAUD` reader - Indicates that the audio interface is Generic Parallel\n\nAudio (GPAUD)\n\nReset Value: (GPAUDPORTS== 1) ? 1 : 0"]
pub type ConfgpaudR = crate::BitReader;
#[doc = "Field `CONFAHBAUDDMA` reader - Indicates that the audio interface is AHB AUD DMA\n\nReset Value: (AHBAUDDMAIF== 1) ? 1 : 0"]
pub type ConfahbauddmaR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Indicates that the audio interface is Generic Parallel\n\nAudio (GPAUD)\n\nReset Value: (GPAUDPORTS== 1) ? 1 : 0"]
    #[inline(always)]
    pub fn confgpaud(&self) -> ConfgpaudR {
        ConfgpaudR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Indicates that the audio interface is AHB AUD DMA\n\nReset Value: (AHBAUDDMAIF== 1) ? 1 : 0"]
    #[inline(always)]
