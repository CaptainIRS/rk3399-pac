...
#[doc = "Field `CTS_MANUAL` reader - If the CTS_manual bit equals 0b, this registers contains audCTS\\[19:0\\]
generated by the Cycle time counter according to the specified timing. If the CTS_manual bit equals 1b, this register is configured with the audCTS\\[7:0\\]
value that is output by the Audio Packetizer. Note: When the General Parallel Audio Interface (GPAUD) is enabled (AUDIO_IF = 6) or the AHB DMA Audio Interface is enabled (AUDIO_IF = 8), writing to these bits has no effect; reading these bits always return 0."]
pub type CtsManualR = crate::BitReader;
#[doc = "Field `CTS_MANUAL` writer - If the CTS_manual bit equals 0b, this registers contains audCTS\\[19:0\\]
generated by the Cycle time counter according to the specified timing. If the CTS_manual bit equals 1b, this register is configured with the audCTS\\[7:0\\]
value that is output by the Audio Packetizer. Note: When the General Parallel Audio Interface (GPAUD) is enabled (AUDIO_IF = 6) or the AHB DMA Audio Interface is enabled (AUDIO_IF = 8), writing to these bits has no effect; reading these bits always return 0."]
pub type CtsManualW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPARE_BITS` reader - Reserved as \"spare\" bits with no associated functionality."]
pub type SpareBitsR = crate::FieldReader;
#[doc = "Field `SPARE_BITS` writer - Reserved as \"spare\" bits with no associated functionality."]
pub type SpareBitsW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:3 - HDMI Audio Clock Regenerator CTS calculated value. This value can be manually set using the CTS_manual (AUD_CTS3) mechanism."]
    #[inline(always)]
    pub fn audcts(&self) -> AudctsR {
        AudctsR::new(self.bits & 0x0f)
    }
    #[doc = "Bit 4 - If the CTS_manual bit equals 0b, this registers contains audCTS\\[19:0\\]
generated by the Cycle time counter according to the specified timing. If the CTS_manual bit equals 1b, this register is configured with the audCTS\\[7:0\\]
value that is output by the Audio Packetizer. Note: When the General Parallel Audio Interface (GPAUD) is enabled (AUDIO_IF = 6) or the AHB DMA Audio Interface is enabled (AUDIO_IF = 8), writing to these bits has no effect; reading these bits always return 0."]
    #[inline(always)]
    ...
    #[doc = "Bits 5:7 - Reserved as \"spare\" bits with no associated functionality."]
    #[inline(always)]
