...
#[doc = "Field `HPD` reader - HDMI Hot Plug Detect indication. You may need to mask or change polarity of this interrupt after it has become active."]
pub type HpdR = crate::BitReader;
#[doc = "Field `HPD` writer - HDMI Hot Plug Detect indication. You may need to mask or change polarity of this interrupt after it has become active."]
...
#[doc = "Field `RX_SENSE_0` reader - TX PHY RX_SENSE indication for driver 0. You may need to mask or change polarity of this interrupt after it has become active."]
pub type RxSense0R = crate::BitReader;
#[doc = "Field `RX_SENSE_0` writer - TX PHY RX_SENSE indication for driver 0. You may need to mask or change polarity of this interrupt after it has become active."]
pub type RxSense0W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `RX_SENSE_1` reader - TX PHY RX_SENSE indication for driver 1. You may need to mask or change polarity of this interrupt after it has become active."]
pub type RxSense1R = crate::BitReader;
#[doc = "Field `RX_SENSE_1` writer - TX PHY RX_SENSE indication for driver 1. You may need to mask or change polarity of this interrupt after it has become active."]
pub type RxSense1W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `RX_SENSE_2` reader - TX PHY RX_SENSE indication for driver 2. You may need to mask or change polarity of this interrupt after it has become active."]
pub type RxSense2R = crate::BitReader;
#[doc = "Field `RX_SENSE_2` writer - TX PHY RX_SENSE indication for driver 2. You may need to mask or change polarity of this interrupt after it has become active."]
pub type RxSense2W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `RX_SENSE_3` reader - TX PHY RX_SENSE indication for driver 3. You may need to mask or change polarity of this interrupt after it has become active."]
pub type RxSense3R = crate::BitReader;
#[doc = "Field `RX_SENSE_3` writer - TX PHY RX_SENSE indication for driver 3. You may need to mask or change polarity of this interrupt after it has become active."]
pub type RxSense3W<'a, REG> = crate::BitWriter1C<'a, REG>;
impl R {
    #[doc = "Bit 0 - HDMI Hot Plug Detect indication. You may need to mask or change polarity of this interrupt after it has become active."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - TX PHY RX_SENSE indication for driver 0. You may need to mask or change polarity of this interrupt after it has become active."]
    #[inline(always)]
    pub fn rx_sense_0(&self) -> RxSense0R {
        RxSense0R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - TX PHY RX_SENSE indication for driver 1. You may need to mask or change polarity of this interrupt after it has become active."]
    #[inline(always)]
    pub fn rx_sense_1(&self) -> RxSense1R {
        RxSense1R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - TX PHY RX_SENSE indication for driver 2. You may need to mask or change polarity of this interrupt after it has become active."]
    #[inline(always)]
    pub fn rx_sense_2(&self) -> RxSense2R {
        RxSense2R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - TX PHY RX_SENSE indication for driver 3. You may need to mask or change polarity of this interrupt after it has become active."]
    #[inline(always)]
