...
#[doc = "Field `FIFO_THREMPTY_MASK` reader - Audio FIFO empty interrupt mask when audio FIFO has less than the number of enabled audio channels."]
pub type FifoThremptyMaskR = crate::BitReader;
#[doc = "Field `FIFO_THREMPTY_MASK` writer - Audio FIFO empty interrupt mask when audio FIFO has less than the number of enabled audio channels."]
pub type FifoThremptyMaskW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ERROR_MASK` reader - Error interrupt mask. Active when slave indicates error through the isresp\\[1:0\\]."]
pub type ErrorMaskR = crate::BitReader;
#[doc = "Field `ERROR_MASK` writer - Error interrupt mask. Active when slave indicates error through the isresp\\[1:0\\]."]
pub type ErrorMaskW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LOSTOWNERSHIP_MASK` reader - Master lost ownership interrupt mask when in burst transfer. Active when AHB master loses BUS ownership within the course of a burst transfer."]
pub type LostownershipMaskR = crate::BitReader;
#[doc = "Field `LOSTOWNERSHIP_MASK` writer - Master lost ownership interrupt mask when in burst transfer. Active when AHB master loses BUS ownership within the course of a burst transfer."]
pub type LostownershipMaskW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RETRYSPLIT_MASK` reader - Retry/split interrupt mask. Active when AHB master receives a RETRY or SPLIT response from slave."]
pub type RetrysplitMaskR = crate::BitReader;
#[doc = "Field `RETRYSPLIT_MASK` writer - Retry/split interrupt mask. Active when AHB master receives a RETRY or SPLIT response from slave."]
pub type RetrysplitMaskW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DONE_MASK` reader - DMA end of operation interrupt mask. Active when DMA engine reaches final_addr\\[15:0\\]
or when stop DMA operation is activated."]
pub type DoneMaskR = crate::BitReader;
#[doc = "Field `DONE_MASK` writer - DMA end of operation interrupt mask. Active when DMA engine reaches final_addr\\[15:0\\]
or when stop DMA operation is activated."]
...
impl R {
    ...
    #[doc = "Bit 2 - Audio FIFO empty interrupt mask when audio FIFO has less than the number of enabled audio channels."]
    #[inline(always)]
    pub fn fifo_thrempty_mask(&self) -> FifoThremptyMaskR {
        FifoThremptyMaskR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 4 - Error interrupt mask. Active when slave indicates error through the isresp\\[1:0\\]."]
    #[inline(always)]
    pub fn error_mask(&self) -> ErrorMaskR {
        ErrorMaskR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Master lost ownership interrupt mask when in burst transfer. Active when AHB master loses BUS ownership within the course of a burst transfer."]
    #[inline(always)]
    pub fn lostownership_mask(&self) -> LostownershipMaskR {
        LostownershipMaskR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Retry/split interrupt mask. Active when AHB master receives a RETRY or SPLIT response from slave."]
    #[inline(always)]
    pub fn retrysplit_mask(&self) -> RetrysplitMaskR {
        RetrysplitMaskR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - DMA end of operation interrupt mask. Active when DMA engine reaches final_addr\\[15:0\\]
or when stop DMA operation is activated."]
    #[inline(always)]
