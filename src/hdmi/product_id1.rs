...
#[doc = "Field `PRODUCT_ID1_TX` reader - This bit Identifies H Controller according to HDMI product line."]
pub type ProductId1TxR = crate::BitReader;
#[doc = "Field `PRODUCT_ID1_RX` reader - This bit Identifies HDMI 's DWC_hdmi_rx Controller according to HDMI product line."]
pub type ProductId1RxR = crate::BitReader;
#[doc = "Field `PRODUCT_ID1_HDCP` reader - These bits identify a HDMI Controller with HDCP encryption according to HDMI product line. Reset Value: (HDCP== 1) ? 3 : 0"]
pub type ProductId1HdcpR = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - This bit Identifies H Controller according to HDMI product line."]
    #[inline(always)]
    pub fn product_id1_tx(&self) -> ProductId1TxR {
        ProductId1TxR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - This bit Identifies HDMI 's DWC_hdmi_rx Controller according to HDMI product line."]
    #[inline(always)]
    pub fn product_id1_rx(&self) -> ProductId1RxR {
        ProductId1RxR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 6:7 - These bits identify a HDMI Controller with HDCP encryption according to HDMI product line. Reset Value: (HDCP== 1) ? 3 : 0"]
    #[inline(always)]
