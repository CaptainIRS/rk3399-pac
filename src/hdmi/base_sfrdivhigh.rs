...
#[doc = "Field `BASE_SFRDIV_HI` reader - SFR clock divider High This register must be configured with the 7 most- significant bits of the value sfrclk frequency divided by 1000 (for example, for 27 MHz base_sfrdiv\\[14:0\\]
...
#[doc = "Field `BASE_SFRDIV_HI` writer - SFR clock divider High This register must be configured with the 7 most- significant bits of the value sfrclk frequency divided by 1000 (for example, for 27 MHz base_sfrdiv\\[14:0\\]
= 27027). The configured data is used to generate a reference pulse of 1ms period that is needed by several timers within the controller."]
pub type BaseSfrdivHiW<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    #[doc = "Bits 0:6 - SFR clock divider High This register must be configured with the 7 most- significant bits of the value sfrclk frequency divided by 1000 (for example, for 27 MHz base_sfrdiv\\[14:0\\]
= 27027). The configured data is used to generate a reference pulse of 1ms period that is needed by several timers within the controller."]
    #[inline(always)]
