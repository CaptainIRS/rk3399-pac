...
#[doc = "Field `H_IN_BLANK` reader - Input video Horizontal blanking pixel region width this bit field holds bits 9:8 of number of Horizontal blanking pixels."]
pub type HInBlankR = crate::FieldReader;
#[doc = "Field `H_IN_BLANK` writer - Input video Horizontal blanking pixel region width this bit field holds bits 9:8 of number of Horizontal blanking pixels."]
pub type HInBlankW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `H_IN_BLANK_12` reader - Input video Horizontal blanking pixel region width If configuration parameter HDMI_TX_14 = True (1), this bit field holds bit 12:10 of number of horizontal blanking pixels."]
pub type HInBlank12R = crate::FieldReader;
#[doc = "Field `H_IN_BLANK_12` writer - Input video Horizontal blanking pixel region width If configuration parameter HDMI_TX_14 = True (1), this bit field holds bit 12:10 of number of horizontal blanking pixels."]
pub type HInBlank12W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:1 - Input video Horizontal blanking pixel region width this bit field holds bits 9:8 of number of Horizontal blanking pixels."]
    #[inline(always)]
    pub fn h_in_blank(&self) -> HInBlankR {
        HInBlankR::new(self.bits & 3)
    }
    #[doc = "Bits 2:4 - Input video Horizontal blanking pixel region width If configuration parameter HDMI_TX_14 = True (1), this bit field holds bit 12:10 of number of horizontal blanking pixels."]
    #[inline(always)]
