...
#[doc = "Field `FC_INVACT_2D_0` reader - 2D Input video vertical active pixel region width.\n\nNumber of 2D video vertical active lines \\[7:0\\]."]
pub type FcInvact2d0R = crate::FieldReader;
#[doc = "Field `FC_INVACT_2D_0` writer - 2D Input video vertical active pixel region width.\n\nNumber of 2D video vertical active lines \\[7:0\\]."]
pub type FcInvact2d0W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - 2D Input video vertical active pixel region width.\n\nNumber of 2D video vertical active lines \\[7:0\\]."]
    #[inline(always)]
