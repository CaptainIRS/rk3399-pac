...
#[doc = "Field `PACKING_PHASE` reader - Read only register that holds the \"packing phase\" output of the Video Packetizer block."]
pub type PackingPhaseR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:3 - Read only register that holds the \"packing phase\" output of the Video Packetizer block."]
    #[inline(always)]
