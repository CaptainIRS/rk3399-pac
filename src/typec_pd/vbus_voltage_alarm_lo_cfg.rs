#[doc = "Register `VBUS_VOLTAGE_ALARM_LO_CFG` reader"]
pub type R = crate::R<VbusVoltageAlarmLoCfgSpec>;
#[doc = "Register `VBUS_VOLTAGE_ALARM_LO_CFG` writer"]
pub type W = crate::W<VbusVoltageAlarmLoCfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn voltage_trip_point(&mut self) -> VoltageTripPointW<VbusVoltageAlarmLoCfgSpec> {
        VoltageTripPointW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Not used. Always write as 0 and \n\nignore read \n\nvalue."]
    #[inline(always)]
    #[must_use]
    pub fn not_used(&mut self) -> NotUsedW<VbusVoltageAlarmLoCfgSpec> {
        NotUsedW::new(self, 16)
    }
}
#[doc = "Vbus Voltage Alarm Low Cfg Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vbus_voltage_alarm_lo_cfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`vbus_voltage_alarm_lo_cfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VbusVoltageAlarmLoCfgSpec;
impl crate::RegisterSpec for VbusVoltageAlarmLoCfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vbus_voltage_alarm_lo_cfg::R`](R) reader structure"]
impl crate::Readable for VbusVoltageAlarmLoCfgSpec {}
#[doc = "`write(|w| ..)` method takes [`vbus_voltage_alarm_lo_cfg::W`](W) writer structure"]
impl crate::Writable for VbusVoltageAlarmLoCfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VBUS_VOLTAGE_ALARM_LO_CFG to value 0"]
impl crate::Resettable for VbusVoltageAlarmLoCfgSpec {
