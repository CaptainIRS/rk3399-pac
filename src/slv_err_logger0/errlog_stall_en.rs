#[doc = "Register `ERRLOG_StallEn` reader"]
...
#[doc = "Error logger mode selection\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`errlog_stall_en::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`errlog_stall_en::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ErrlogStallEnSpec;
impl crate::RegisterSpec for ErrlogStallEnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`errlog_stall_en::R`](R) reader structure"]
impl crate::Readable for ErrlogStallEnSpec {}
#[doc = "`write(|w| ..)` method takes [`errlog_stall_en::W`](W) writer structure"]
impl crate::Writable for ErrlogStallEnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ERRLOG_StallEn to value 0"]
impl crate::Resettable for ErrlogStallEnSpec {
