...
#[doc = "Field `ADDR` reader - PVR DMA transaction starting address\n\nPVR DMA transaction starting address"]
pub type AddrR = crate::FieldReader<u32>;
#[doc = "Field `ADDR` writer - PVR DMA transaction starting address\n\nPVR DMA transaction starting address"]
pub type AddrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - PVR DMA transaction starting address\n\nPVR DMA transaction starting address"]
    #[inline(always)]
