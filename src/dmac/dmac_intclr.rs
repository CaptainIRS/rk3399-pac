...
#[doc = "Field `DMAC_INTCLR_BITS_0` writer - Controls the clearing of the irq outputs: Bit \\[N\\]
= 0 The status of irq\\[N\\]
does not change. Bit \\[N\\]
= 1 The DMAC sets irq\\[N\\]
LOW if the INTEN Register programs the DMAC to signal an interrupt. Otherwise, the status of irq\\[N\\]
does not change."]
pub type DmacIntclrBits0W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl W {
    #[doc = "Bits 0:31 - Controls the clearing of the irq outputs: Bit \\[N\\]
= 0 The status of irq\\[N\\]
does not change. Bit \\[N\\]
= 1 The DMAC sets irq\\[N\\]
LOW if the INTEN Register programs the DMAC to signal an interrupt. Otherwise, the status of irq\\[N\\]
