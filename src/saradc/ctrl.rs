...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_input_src_sel(&mut self) -> AdcInputSrcSelW<CtrlSpec> {
        AdcInputSrcSelW::new(self, 0)
    }
    #[doc = "Bit 3 - ADC power down control bit"]
    #[inline(always)]
    #[must_use]
    pub fn adc_power_ctrl(&mut self) -> AdcPowerCtrlW<CtrlSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int_status(&mut self) -> IntStatusW<CtrlSpec> {
