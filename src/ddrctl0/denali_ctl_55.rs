#[doc = "Register `DENALI_CTL_55` reader"]
pub type R = crate::R<DenaliCtl55Spec>;
#[doc = "Register `DENALI_CTL_55` writer"]
pub type W = crate::W<DenaliCtl55Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmrri_f0(&mut self) -> TmrriF0W<DenaliCtl55Spec> {
        TmrriF0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TMRRI value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tmrri_f1(&mut self) -> TmrriF1W<DenaliCtl55Spec> {
        TmrriF1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DRAM TMRRI value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tmrri_f2(&mut self) -> TmrriF2W<DenaliCtl55Spec> {
        TmrriF2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DRAM TCSCKE value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tcscke_f0(&mut self) -> TcsckeF0W<DenaliCtl55Spec> {
        TcsckeF0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_55::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_55::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl55Spec;
impl crate::RegisterSpec for DenaliCtl55Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_55::R`](R) reader structure"]
impl crate::Readable for DenaliCtl55Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_55::W`](W) writer structure"]
impl crate::Writable for DenaliCtl55Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_55 to value 0"]
impl crate::Resettable for DenaliCtl55Spec {
