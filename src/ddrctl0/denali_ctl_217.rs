#[doc = "Register `DENALI_CTL_217` reader"]
pub type R = crate::R<DenaliCtl217Spec>;
#[doc = "Register `DENALI_CTL_217` writer"]
pub type W = crate::W<DenaliCtl217Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn r2w_diffcs_dly_f0(&mut self) -> R2wDiffcsDlyF0W<DenaliCtl217Spec> {
        R2wDiffcsDlyF0W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Additional delay to insert between writes and reads to different chip selects. Allowed programming dependent on memory system."]
    #[inline(always)]
    #[must_use]
    pub fn w2r_diffcs_dly_f0(&mut self) -> W2rDiffcsDlyF0W<DenaliCtl217Spec> {
        W2rDiffcsDlyF0W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Additional delay to insert between writes to different chip selects. Program to a non-zero value."]
    #[inline(always)]
    #[must_use]
    pub fn w2w_diffcs_dly_f0(&mut self) -> W2wDiffcsDlyF0W<DenaliCtl217Spec> {
        W2wDiffcsDlyF0W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Additional delay to insert between reads to different chip selects. Allowed programming dependent on memory system."]
    #[inline(always)]
    #[must_use]
    pub fn r2r_diffcs_dly_f1(&mut self) -> R2rDiffcsDlyF1W<DenaliCtl217Spec> {
        R2rDiffcsDlyF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_217::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_217::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl217Spec;
impl crate::RegisterSpec for DenaliCtl217Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_217::R`](R) reader structure"]
impl crate::Readable for DenaliCtl217Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_217::W`](W) writer structure"]
impl crate::Writable for DenaliCtl217Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_217 to value 0x0101_0101"]
impl crate::Resettable for DenaliCtl217Spec {
