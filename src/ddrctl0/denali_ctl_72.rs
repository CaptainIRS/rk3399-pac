#[doc = "Register `DENALI_CTL_72` reader"]
pub type R = crate::R<DenaliCtl72Spec>;
#[doc = "Register `DENALI_CTL_72` writer"]
pub type W = crate::W<DenaliCtl72Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfs_promote_threshold_f1(&mut self) -> DfsPromoteThresholdF1W<DenaliCtl72Spec> {
        DfsPromoteThresholdF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - DFS promotion number of long counts until the high priority request is asserted for frequency copy 2. Applies to SW and HW DFS commands."]
    #[inline(always)]
    #[must_use]
    pub fn dfs_promote_threshold_f2(&mut self) -> DfsPromoteThresholdF2W<DenaliCtl72Spec> {
        DfsPromoteThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_72::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_72::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl72Spec;
impl crate::RegisterSpec for DenaliCtl72Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_72::R`](R) reader structure"]
impl crate::Readable for DenaliCtl72Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_72::W`](W) writer structure"]
impl crate::Writable for DenaliCtl72Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_72 to value 0"]
impl crate::Resettable for DenaliCtl72Spec {
