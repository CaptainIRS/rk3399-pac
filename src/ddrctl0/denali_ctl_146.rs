#[doc = "Register `DENALI_CTL_146` reader"]
pub type R = crate::R<DenaliCtl146Spec>;
#[doc = "Register `DENALI_CTL_146` writer"]
pub type W = crate::W<DenaliCtl146Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr22_data_f1_0(&mut self) -> Mr22DataF1_0W<DenaliCtl146Spec> {
        Mr22DataF1_0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 22 for chip select 0."]
    #[inline(always)]
    #[must_use]
    pub fn mr22_data_f2_0(&mut self) -> Mr22DataF2_0W<DenaliCtl146Spec> {
        Mr22DataF2_0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_146::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_146::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl146Spec;
impl crate::RegisterSpec for DenaliCtl146Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_146::R`](R) reader structure"]
impl crate::Readable for DenaliCtl146Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_146::W`](W) writer structure"]
impl crate::Writable for DenaliCtl146Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_146 to value 0"]
impl crate::Resettable for DenaliCtl146Spec {
