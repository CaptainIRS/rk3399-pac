#[doc = "Register `DENALI_CTL_196` reader"]
pub type R = crate::R<DenaliCtl196Spec>;
#[doc = "Register `DENALI_CTL_196` writer"]
pub type W = crate::W<DenaliCtl196Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cs_map(&mut self) -> CsMapW<DenaliCtl196Spec> {
        CsMapW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Identifies the burst-on-fly bit in the memory mode registers."]
    #[inline(always)]
    #[must_use]
    pub fn burst_on_fly_bit(&mut self) -> BurstOnFlyBitW<DenaliCtl196Spec> {
        BurstOnFlyBitW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable the half datapath feature of the controller. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn reduc(&mut self) -> ReducW<DenaliCtl196Spec> {
        ReducW::new(self, 16)
    }
    #[doc = "Bit 24 - Set byte ordering as little endian or big endian. Set to 1 for big endian."]
    #[inline(always)]
    #[must_use]
    pub fn big_endian_en(&mut self) -> BigEndianEnW<DenaliCtl196Spec> {
        BigEndianEnW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_196::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_196::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl196Spec;
impl crate::RegisterSpec for DenaliCtl196Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_196::R`](R) reader structure"]
impl crate::Readable for DenaliCtl196Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_196::W`](W) writer structure"]
impl crate::Writable for DenaliCtl196Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_196 to value 0"]
impl crate::Resettable for DenaliCtl196Spec {
