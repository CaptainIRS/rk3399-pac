#[doc = "Register `DENALI_CTL_305` reader"]
pub type R = crate::R<DenaliCtl305Spec>;
#[doc = "Register `DENALI_CTL_305` writer"]
pub type W = crate::W<DenaliCtl305Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_resp_mask(&mut self) -> RdlvlRespMaskW<DenaliCtl305Spec> {
        RdlvlRespMaskW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable the MC data eye training module. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_en(&mut self) -> RdlvlEnW<DenaliCtl305Spec> {
        RdlvlEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable the MC gate training module. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_gate_en(&mut self) -> RdlvlGateEnW<DenaliCtl305Spec> {
        RdlvlGateEnW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_305::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_305::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl305Spec;
impl crate::RegisterSpec for DenaliCtl305Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_305::R`](R) reader structure"]
impl crate::Readable for DenaliCtl305Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_305::W`](W) writer structure"]
impl crate::Writable for DenaliCtl305Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_305 to value 0"]
impl crate::Resettable for DenaliCtl305Spec {
