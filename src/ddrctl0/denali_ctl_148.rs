#[doc = "Register `DENALI_CTL_148` reader"]
pub type R = crate::R<DenaliCtl148Spec>;
#[doc = "Register `DENALI_CTL_148` writer"]
pub type W = crate::W<DenaliCtl148Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr2_data_f0_1(&mut self) -> Mr2DataF0_1W<DenaliCtl148Spec> {
        Mr2DataF0_1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 0 for chip select 1 for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn mr0_data_f1_1(&mut self) -> Mr0DataF1_1W<DenaliCtl148Spec> {
        Mr0DataF1_1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_148::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_148::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl148Spec;
impl crate::RegisterSpec for DenaliCtl148Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_148::R`](R) reader structure"]
impl crate::Readable for DenaliCtl148Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_148::W`](W) writer structure"]
impl crate::Writable for DenaliCtl148Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_148 to value 0"]
impl crate::Resettable for DenaliCtl148Spec {
