#[doc = "Register `DENALI_PHY_70` reader"]
pub type R = crate::R<DenaliPhy70Spec>;
#[doc = "Register `DENALI_PHY_70` writer"]
pub type W = crate::W<DenaliPhy70Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq1_fall_slave_delay_0(
        &mut self,
    ) -> PhyRddqsDq1FallSlaveDelay0W<DenaliPhy70Spec> {
    ...
    pub fn phy_rddqs_dq2_rise_slave_delay_0(
        &mut self,
    ) -> PhyRddqsDq2RiseSlaveDelay0W<DenaliPhy70Spec> {
        PhyRddqsDq2RiseSlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_70::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_70::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy70Spec;
impl crate::RegisterSpec for DenaliPhy70Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_70::R`](R) reader structure"]
impl crate::Readable for DenaliPhy70Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_70::W`](W) writer structure"]
impl crate::Writable for DenaliPhy70Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_70 to value 0"]
impl crate::Resettable for DenaliPhy70Spec {
