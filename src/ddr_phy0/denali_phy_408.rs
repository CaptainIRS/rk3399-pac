#[doc = "Register `DENALI_PHY_408` reader"]
pub type R = crate::R<DenaliPhy408Spec>;
#[doc = "Register `DENALI_PHY_408` writer"]
pub type W = crate::W<DenaliPhy408Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rdlvl_op_mode_3(&mut self) -> PhyRdlvlOpMode3W<DenaliPhy408Spec> {
    ...
    pub fn phy_rdlvl_rddqs_dq_obs_select_3(
        &mut self,
    ) -> PhyRdlvlRddqsDqObsSelect3W<DenaliPhy408Spec> {
        PhyRdlvlRddqsDqObsSelect3W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Per-bit mask for read leveling for slice 3. If all bits are not used, only 1 bit should be cleared to 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rdlvl_data_mask_3(&mut self) -> PhyRdlvlDataMask3W<DenaliPhy408Spec> {
        PhyRdlvlDataMask3W::new(self, 16)
    }
    #[doc = "Bits 24:29 - Defines the write/read burst length in bytes during the write data leveling sequence for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_burst_cnt_3(&mut self) -> PhyWdqlvlBurstCnt3W<DenaliPhy408Spec> {
        PhyWdqlvlBurstCnt3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_408::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_408::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy408Spec;
impl crate::RegisterSpec for DenaliPhy408Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_408::R`](R) reader structure"]
impl crate::Readable for DenaliPhy408Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_408::W`](W) writer structure"]
impl crate::Writable for DenaliPhy408Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_408 to value 0"]
impl crate::Resettable for DenaliPhy408Spec {
