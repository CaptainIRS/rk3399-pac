#[doc = "Register `DENALI_PHY_59` reader"]
pub type R = crate::R<DenaliPhy59Spec>;
#[doc = "Register `DENALI_PHY_59` writer"]
pub type W = crate::W<DenaliPhy59Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq0_slave_delay_0(&mut self) -> PhyClkWrdq0SlaveDelay0W<DenaliPhy59Spec> {
        PhyClkWrdq0SlaveDelay0W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ1 for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq1_slave_delay_0(&mut self) -> PhyClkWrdq1SlaveDelay0W<DenaliPhy59Spec> {
        PhyClkWrdq1SlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_59::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_59::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy59Spec;
impl crate::RegisterSpec for DenaliPhy59Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_59::R`](R) reader structure"]
impl crate::Readable for DenaliPhy59Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_59::W`](W) writer structure"]
impl crate::Writable for DenaliPhy59Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_59 to value 0"]
impl crate::Resettable for DenaliPhy59Spec {
