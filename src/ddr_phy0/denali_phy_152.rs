#[doc = "Register `DENALI_PHY_152` reader"]
pub type R = crate::R<DenaliPhy152Spec>;
#[doc = "Register `DENALI_PHY_152` writer"]
pub type W = crate::W<DenaliPhy152Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rdlvl_op_mode_1(&mut self) -> PhyRdlvlOpMode1W<DenaliPhy152Spec> {
    ...
    pub fn phy_rdlvl_rddqs_dq_obs_select_1(
        &mut self,
    ) -> PhyRdlvlRddqsDqObsSelect1W<DenaliPhy152Spec> {
        PhyRdlvlRddqsDqObsSelect1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Per-bit mask for read leveling for slice 1. If all bits are not used, only 1 bit should be cleared to 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rdlvl_data_mask_1(&mut self) -> PhyRdlvlDataMask1W<DenaliPhy152Spec> {
        PhyRdlvlDataMask1W::new(self, 16)
    }
    #[doc = "Bits 24:29 - Defines the write/read burst length in bytes during the write data leveling sequence for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_burst_cnt_1(&mut self) -> PhyWdqlvlBurstCnt1W<DenaliPhy152Spec> {
        PhyWdqlvlBurstCnt1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_152::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_152::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy152Spec;
impl crate::RegisterSpec for DenaliPhy152Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_152::R`](R) reader structure"]
impl crate::Readable for DenaliPhy152Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_152::W`](W) writer structure"]
impl crate::Writable for DenaliPhy152Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_152 to value 0"]
impl crate::Resettable for DenaliPhy152Spec {
