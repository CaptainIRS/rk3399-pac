#[doc = "Register `DENALI_PHY_315` reader"]
pub type R = crate::R<DenaliPhy315Spec>;
#[doc = "Register `DENALI_PHY_315` writer"]
pub type W = crate::W<DenaliPhy315Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq0_slave_delay_2(&mut self) -> PhyClkWrdq0SlaveDelay2W<DenaliPhy315Spec> {
        PhyClkWrdq0SlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ1 for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq1_slave_delay_2(&mut self) -> PhyClkWrdq1SlaveDelay2W<DenaliPhy315Spec> {
        PhyClkWrdq1SlaveDelay2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_315::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_315::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy315Spec;
impl crate::RegisterSpec for DenaliPhy315Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_315::R`](R) reader structure"]
impl crate::Readable for DenaliPhy315Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_315::W`](W) writer structure"]
impl crate::Writable for DenaliPhy315Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_315 to value 0"]
impl crate::Resettable for DenaliPhy315Spec {
