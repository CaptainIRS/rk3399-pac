...
#[doc = "Field `PHY_CAL_RESULT2_OBS_0` reader - Pad calibration results (CKE/ RESET_N) observation values for block 0. READ-ONLY"]
pub type PhyCalResult2Obs0R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:23 - Pad calibration results (CKE/ RESET_N) observation values for block 0. READ-ONLY"]
    #[inline(always)]
