#[doc = "Register `DENALI_PHY_130` reader"]
pub type R = crate::R<DenaliPhy130Spec>;
#[doc = "Register `DENALI_PHY_130` writer"]
pub type W = crate::W<DenaliPhy130Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_gate_bypass_slave_delay_1(
        &mut self,
    ) -> PhyRddqsGateBypassSlaveDelay1W<DenaliPhy130Spec> {
        PhyRddqsGateBypassSlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:17 - PHY two_cycle_preamble for bypass mode for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_bypass_two_cyc_preamble_1(&mut self) -> PhyBypassTwoCycPreamble1W<DenaliPhy130Spec> {
        PhyBypassTwoCycPreamble1W::new(self, 16)
    }
    #[doc = "Bit 24 - Bypass mode override setting for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_bypass_override_1(&mut self) -> PhyClkBypassOverride1W<DenaliPhy130Spec> {
        PhyClkBypassOverride1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_130::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_130::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy130Spec;
impl crate::RegisterSpec for DenaliPhy130Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_130::R`](R) reader structure"]
impl crate::Readable for DenaliPhy130Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_130::W`](W) writer structure"]
impl crate::Writable for DenaliPhy130Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_130 to value 0"]
impl crate::Resettable for DenaliPhy130Spec {
