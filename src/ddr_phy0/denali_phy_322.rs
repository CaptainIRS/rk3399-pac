#[doc = "Register `DENALI_PHY_322` reader"]
pub type R = crate::R<DenaliPhy322Spec>;
#[doc = "Register `DENALI_PHY_322` writer"]
pub type W = crate::W<DenaliPhy322Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq4_slave_delay_2(&mut self) -> PhyRddq4SlaveDelay2W<DenaliPhy322Spec> {
        PhyRddq4SlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQ5 slave delay setting for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq5_slave_delay_2(&mut self) -> PhyRddq5SlaveDelay2W<DenaliPhy322Spec> {
        PhyRddq5SlaveDelay2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_322::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_322::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy322Spec;
impl crate::RegisterSpec for DenaliPhy322Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_322::R`](R) reader structure"]
impl crate::Readable for DenaliPhy322Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_322::W`](W) writer structure"]
impl crate::Writable for DenaliPhy322Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_322 to value 0"]
impl crate::Resettable for DenaliPhy322Spec {
