#[doc = "Register `DDR_DENALI_CTL_29` reader"]
pub type R = crate::R<DdrDenaliCtl29Spec>;
#[doc = "Register `DDR_DENALI_CTL_29` writer"]
pub type W = crate::W<DdrDenaliCtl29Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn twtr_f1(&mut self) -> TwtrF1W<DdrDenaliCtl29Spec> {
        TwtrF1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TRP value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trp_f1(&mut self) -> TrpF1W<DdrDenaliCtl29Spec> {
        TrpF1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DRAM TFAW value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tfaw_f1(&mut self) -> TfawF1W<DdrDenaliCtl29Spec> {
        TfawF1W::new(self, 16)
    }
    #[doc = "Bit 24 - Defines how unused address/ command bits are driven for frequency copy 1. Set to 1 to use last value or clear to 0 to drive low."]
    #[inline(always)]
    #[must_use]
    pub fn ca_default_val_f1(&mut self) -> CaDefaultValF1W<DdrDenaliCtl29Spec> {
        CaDefaultValF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_29::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_29::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl29Spec;
impl crate::RegisterSpec for DdrDenaliCtl29Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_29::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl29Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_29::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl29Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_29 to value 0"]
impl crate::Resettable for DdrDenaliCtl29Spec {
