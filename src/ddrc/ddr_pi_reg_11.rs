...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_phyupd_type3_f0(&mut self) -> PiTdfiPhyupdType3F0W<DdrPiReg11Spec> {
...
pub struct DdrPiReg11Spec;
impl crate::RegisterSpec for DdrPiReg11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_pi_reg_11::R`](R) reader structure"]
impl crate::Readable for DdrPiReg11Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_pi_reg_11::W`](W) writer structure"]
impl crate::Writable for DdrPiReg11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_PI_REG_11 to value 0"]
impl crate::Resettable for DdrPiReg11Spec {
