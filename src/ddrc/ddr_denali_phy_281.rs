#[doc = "Register `DDR_DENALI_PHY_281` reader"]
pub type R = crate::R<DdrDenaliPhy281Spec>;
#[doc = "Register `DDR_DENALI_PHY_281` writer"]
pub type W = crate::W<DdrDenaliPhy281Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_patt_2(&mut self) -> PhyWdqlvlPatt2W<DdrDenaliPhy281Spec> {
    ...
    pub fn phy_wdqlvl_dqdm_slv_dly_jump_offset_2(
        &mut self,
    ) -> PhyWdqlvlDqdmSlvDlyJumpOffset2W<DdrDenaliPhy281Spec> {
        PhyWdqlvlDqdmSlvDlyJumpOffset2W::new(self, 8)
    }
    #[doc = "Bits 24:27 - Number of cycles to wait after changing the DQ slave delay setting during write data leveling for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_updt_wait_cnt_2(&mut self) -> PhyWdqlvlUpdtWaitCnt2W<DdrDenaliPhy281Spec> {
        PhyWdqlvlUpdtWaitCnt2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_281::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_281::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy281Spec;
impl crate::RegisterSpec for DdrDenaliPhy281Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_281::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy281Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_281::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy281Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_281 to value 0"]
impl crate::Resettable for DdrDenaliPhy281Spec {
