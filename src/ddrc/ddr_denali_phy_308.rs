#[doc = "Register `DDR_DENALI_PHY_308` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rx_cal_override_2(&mut self) -> PhyRxCalOverride2W<DdrDenaliPhy308Spec> {
        PhyRxCalOverride2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - RX Calibration state machine wait count for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rx_cal_sample_wait_2(&mut self) -> PhyRxCalSampleWait2W<DdrDenaliPhy308Spec> {
        PhyRxCalSampleWait2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_308::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_308::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy308Spec;
impl crate::RegisterSpec for DdrDenaliPhy308Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_308::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy308Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_308::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy308Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_308 to value 0"]
impl crate::Resettable for DdrDenaliPhy308Spec {
