#[doc = "Register `DDR_DENALI_CTL_156` reader"]
pub type R = crate::R<DdrDenaliCtl156Spec>;
#[doc = "Register `DDR_DENALI_CTL_156` writer"]
pub type W = crate::W<DdrDenaliCtl156Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr13_data_1(&mut self) -> Mr13Data1W<DdrDenaliCtl156Spec> {
        Mr13Data1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 14 for chip select 1."]
    #[inline(always)]
    #[must_use]
    pub fn mr14_data_f0_1(&mut self) -> Mr14DataF0_1W<DdrDenaliCtl156Spec> {
        Mr14DataF0_1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_156::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_156::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl156Spec;
impl crate::RegisterSpec for DdrDenaliCtl156Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_156::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl156Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_156::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl156Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_156 to value 0"]
impl crate::Resettable for DdrDenaliCtl156Spec {
