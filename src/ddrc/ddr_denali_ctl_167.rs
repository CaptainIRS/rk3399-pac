#[doc = "Register `DDR_DENALI_CTL_167` reader"]
pub type R = crate::R<DdrDenaliCtl167Spec>;
#[doc = "Register `DDR_DENALI_CTL_167` writer"]
pub type W = crate::W<DdrDenaliCtl167Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zq_cs_norm_threshold_f0(&mut self) -> ZqCsNormThresholdF0W<DdrDenaliCtl167Spec> {
        ZqCsNormThresholdF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - ZQ CS number of long counts until the high priority request is asserted for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn zq_cs_high_threshold_f0(&mut self) -> ZqCsHighThresholdF0W<DdrDenaliCtl167Spec> {
        ZqCsHighThresholdF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_167::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_167::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl167Spec;
impl crate::RegisterSpec for DdrDenaliCtl167Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_167::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl167Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_167::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl167Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_167 to value 0"]
impl crate::Resettable for DdrDenaliCtl167Spec {
