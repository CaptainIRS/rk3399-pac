#[doc = "Register `DENALI_CTL_31` reader"]
pub type R = crate::R<DenaliCtl31Spec>;
#[doc = "Register `DENALI_CTL_31` writer"]
pub type W = crate::W<DenaliCtl31Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trp_f2(&mut self) -> TrpF2W<DenaliCtl31Spec> {
        TrpF2W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TFAW value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tfaw_f2(&mut self) -> TfawF2W<DenaliCtl31Spec> {
        TfawF2W::new(self, 8)
    }
    #[doc = "Bit 16 - Defines how unused address/ command bits are driven for frequency copy 2. Set to 1 to use last value or clear to 0 to drive low."]
    #[inline(always)]
    #[must_use]
    pub fn ca_default_val_f2(&mut self) -> CaDefaultValF2W<DenaliCtl31Spec> {
        CaDefaultValF2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - DRAM TRTP value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trtp_f0(&mut self) -> TrtpF0W<DenaliCtl31Spec> {
        TrtpF0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_31::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_31::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl31Spec;
impl crate::RegisterSpec for DenaliCtl31Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_31::R`](R) reader structure"]
impl crate::Readable for DenaliCtl31Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_31::W`](W) writer structure"]
impl crate::Writable for DenaliCtl31Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_31 to value 0"]
impl crate::Resettable for DenaliCtl31Spec {
