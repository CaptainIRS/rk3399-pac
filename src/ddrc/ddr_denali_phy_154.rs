#[doc = "Register `DDR_DENALI_PHY_154` reader"]
pub type R = crate::R<DdrDenaliPhy154Spec>;
#[doc = "Register `DDR_DENALI_PHY_154` writer"]
pub type W = crate::W<DdrDenaliPhy154Spec>;
...
#[doc = "Field `SC_PHY_WDQLVL_CLR_PREV_RESULTS_1` writer - Clears the previous result value to allow a clean slate comparison for future write DQ leveling results for slice 1. Set to 1 to trigger."]
...
impl W {
    ...
    pub fn phy_wdqlvl_dqdm_obs_select_1(
        &mut self,
    ) -> PhyWdqlvlDqdmObsSelect1W<DdrDenaliPhy154Spec> {
        PhyWdqlvlDqdmObsSelect1W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the step granularity for the logic to use once an edge is found. When this occurs, the logic jumps back to the previous invalid value and uses this step size to determine a more accurate delay value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_qtr_dly_step_1(&mut self) -> PhyWdqlvlQtrDlyStep1W<DdrDenaliPhy154Spec> {
        PhyWdqlvlQtrDlyStep1W::new(self, 8)
    }
    #[doc = "Bit 16 - Clears the previous result value to allow a clean slate comparison for future write DQ leveling results for slice 1. Set to 1 to trigger."]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_wdqlvl_clr_prev_results_1(
        &mut self,
    ) -> ScPhyWdqlvlClrPrevResults1W<DdrDenaliPhy154Spec> {
        ScPhyWdqlvlClrPrevResults1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_154::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_154::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy154Spec;
impl crate::RegisterSpec for DdrDenaliPhy154Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_154::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy154Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_154::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy154Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_154 to value 0"]
impl crate::Resettable for DdrDenaliPhy154Spec {
