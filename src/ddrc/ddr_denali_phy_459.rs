#[doc = "Register `DDR_DENALI_PHY_459` reader"]
pub type R = crate::R<DdrDenaliPhy459Spec>;
#[doc = "Register `DDR_DENALI_PHY_459` writer"]
pub type W = crate::W<DdrDenaliPhy459Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq6_fall_slave_delay_3(
        &mut self,
    ) -> PhyRddqsDq6FallSlaveDelay3W<DdrDenaliPhy459Spec> {
    ...
    pub fn phy_rddqs_dq7_rise_slave_delay_3(
        &mut self,
    ) -> PhyRddqsDq7RiseSlaveDelay3W<DdrDenaliPhy459Spec> {
        PhyRddqsDq7RiseSlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_459::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_459::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy459Spec;
impl crate::RegisterSpec for DdrDenaliPhy459Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_459::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy459Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_459::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy459Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_459 to value 0"]
impl crate::Resettable for DdrDenaliPhy459Spec {
