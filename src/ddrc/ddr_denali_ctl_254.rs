#[doc = "Register `DDR_DENALI_CTL_254` reader"]
pub type R = crate::R<DdrDenaliCtl254Spec>;
#[doc = "Register `DDR_DENALI_CTL_254` writer"]
pub type W = crate::W<DdrDenaliCtl254Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_gate_timeout_f2(&mut self) -> RdlvlGateTimeoutF2W<DdrDenaliCtl254Spec> {
    ...
    pub fn rdlvl_gate_sw_promote_threshold_f2(
        &mut self,
    ) -> RdlvlGateSwPromoteThresholdF2W<DdrDenaliCtl254Spec> {
        RdlvlGateSwPromoteThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_254::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_254::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl254Spec;
impl crate::RegisterSpec for DdrDenaliCtl254Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_254::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl254Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_254::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl254Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_254 to value 0"]
impl crate::Resettable for DdrDenaliCtl254Spec {
