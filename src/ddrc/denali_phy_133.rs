#[doc = "Register `DENALI_PHY_133` reader"]
pub type R = crate::R<DenaliPhy133Spec>;
#[doc = "Register `DENALI_PHY_133` writer"]
pub type W = crate::W<DenaliPhy133Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdm_shift_1(&mut self) -> PhySwWrdmShift1W<DenaliPhy133Spec> {
        PhySwWrdmShift1W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Manual override of automatic half_cycle_shift/cycle_shift for write DQS for slice 1. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bit (3) is the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdqs_shift_1(&mut self) -> PhySwWrdqsShift1W<DenaliPhy133Spec> {
        PhySwWrdqsShift1W::new(self, 8)
    }
    #[doc = "Bits 16:18 - Operation type tsel enables for DQ/ DM signals for slice 1. Bit (0) enables tsel_en during read cycles. Bit (1) enables tsel_en during write cycles. Bit (2) enables tsel_en during idle cycles. Set each bit to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_tsel_enable_1(&mut self) -> PhyDqTselEnable1W<DenaliPhy133Spec> {
        PhyDqTselEnable1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_133::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_133::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy133Spec;
impl crate::RegisterSpec for DenaliPhy133Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_133::R`](R) reader structure"]
impl crate::Readable for DenaliPhy133Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_133::W`](W) writer structure"]
impl crate::Writable for DenaliPhy133Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_133 to value 0"]
impl crate::Resettable for DenaliPhy133Spec {
