#[doc = "Register `DDR_DENALI_PHY_518` reader"]
pub type R = crate::R<DdrDenaliPhy518Spec>;
#[doc = "Register `DDR_DENALI_PHY_518` writer"]
pub type W = crate::W<DdrDenaliPhy518Spec>;
#[doc = "Field `SC_PHY_ADR_SNAP_OBS_REGS_0` writer - Initiates a snapshot of the internal observation registers for address slice 0. Set to 1 to trigger."]
...
impl W {
    #[doc = "Bit 0 - Initiates a snapshot of the internal observation registers for address slice 0. Set to 1 to trigger."]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_adr_snap_obs_regs_0(&mut self) -> ScPhyAdrSnapObsRegs0W<DdrDenaliPhy518Spec> {
        ScPhyAdrSnapObsRegs0W::new(self, 0)
    }
    #[doc = "Bit 8 - Enables tsel_en for address slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_tsel_enable_0(&mut self) -> PhyAdrTselEnable0W<DdrDenaliPhy518Spec> {
        PhyAdrTselEnable0W::new(self, 8)
    }
    #[doc = "Bits 16:21 - Loopback control bits for address slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_lpbk_control_0(&mut self) -> PhyAdrLpbkControl0W<DdrDenaliPhy518Spec> {
        PhyAdrLpbkControl0W::new(self, 16)
    }
    #[doc = "Bit 24 - adr slice power reduction disable for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_pwr_rdc_disable_0(&mut self) -> PhyAdrPwrRdcDisable0W<DdrDenaliPhy518Spec> {
        PhyAdrPwrRdcDisable0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_518::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_518::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy518Spec;
impl crate::RegisterSpec for DdrDenaliPhy518Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_518::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy518Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_518::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy518Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_518 to value 0"]
impl crate::Resettable for DdrDenaliPhy518Spec {
