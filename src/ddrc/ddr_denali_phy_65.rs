#[doc = "Register `DDR_DENALI_PHY_65` reader"]
pub type R = crate::R<DdrDenaliPhy65Spec>;
#[doc = "Register `DDR_DENALI_PHY_65` writer"]
pub type W = crate::W<DdrDenaliPhy65Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq2_slave_delay_0(&mut self) -> PhyRddq2SlaveDelay0W<DdrDenaliPhy65Spec> {
        PhyRddq2SlaveDelay0W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQ3 slave delay setting for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq3_slave_delay_0(&mut self) -> PhyRddq3SlaveDelay0W<DdrDenaliPhy65Spec> {
        PhyRddq3SlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_65::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_65::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy65Spec;
impl crate::RegisterSpec for DdrDenaliPhy65Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_65::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy65Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_65::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy65Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_65 to value 0"]
impl crate::Resettable for DdrDenaliPhy65Spec {
