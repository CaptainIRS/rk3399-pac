#[doc = "Register `DENALI_PHY_901` reader"]
pub type R = crate::R<DenaliPhy901Spec>;
#[doc = "Register `DENALI_PHY_901` writer"]
pub type W = crate::W<DenaliPhy901Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_cslvl_coarse_dly(&mut self) -> PhyCslvlCoarseDlyW<DenaliPhy901Spec> {
        PhyCslvlCoarseDlyW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Defines the number of samples to take at each GRP slave delay setting during coarse CS training."]
    #[inline(always)]
    #[must_use]
    pub fn phy_cslvl_coarse_capture_cnt(&mut self) -> PhyCslvlCoarseCaptureCntW<DenaliPhy901Spec> {
        PhyCslvlCoarseCaptureCntW::new(self, 16)
    }
    #[doc = "Bit 24 - Enables CS training debug mode. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_cslvl_debug_mode(&mut self) -> PhyCslvlDebugModeW<DenaliPhy901Spec> {
        PhyCslvlDebugModeW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_901::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_901::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy901Spec;
impl crate::RegisterSpec for DenaliPhy901Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_901::R`](R) reader structure"]
impl crate::Readable for DenaliPhy901Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_901::W`](W) writer structure"]
impl crate::Writable for DenaliPhy901Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_901 to value 0"]
impl crate::Resettable for DenaliPhy901Spec {
