#[doc = "Register `DDR_DENALI_CTL_225` reader"]
pub type R = crate::R<DdrDenaliCtl225Spec>;
#[doc = "Register `DDR_DENALI_CTL_225` writer"]
pub type W = crate::W<DdrDenaliCtl225Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_cs(&mut self) -> WrlvlCsW<DdrDenaliCtl225Spec> {
        WrlvlCsW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Delay from issuing MRS to first DQS strobe for write leveling."]
    #[inline(always)]
    #[must_use]
    pub fn wldqsen(&mut self) -> WldqsenW<DdrDenaliCtl225Spec> {
        WldqsenW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_225::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_225::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl225Spec;
impl crate::RegisterSpec for DdrDenaliCtl225Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_225::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl225Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_225::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl225Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_225 to value 0"]
impl crate::Resettable for DdrDenaliCtl225Spec {
