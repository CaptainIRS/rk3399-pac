#[doc = "Register `DDR_DENALI_PHY_137` reader"]
pub type R = crate::R<DdrDenaliPhy137Spec>;
#[doc = "Register `DDR_DENALI_PHY_137` writer"]
pub type W = crate::W<DdrDenaliPhy137Spec>;
...
impl W {
    ...
    pub fn phy_lp4_boot_rddata_en_ie_dly_1(
        &mut self,
    ) -> PhyLp4BootRddataEnIeDly1W<DdrDenaliPhy137Spec> {
        PhyLp4BootRddataEnIeDly1W::new(self, 0)
    }
    #[doc = "Bits 8:11 - For LPDDR4 boot frequency, the number of cycles that the dfi_rddata_en signal is early for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lp4_boot_rddata_en_dly_1(&mut self) -> PhyLp4BootRddataEnDly1W<DdrDenaliPhy137Spec> {
    ...
    pub fn phy_lp4_boot_rddata_en_tsel_dly_1(
        &mut self,
    ) -> PhyLp4BootRddataEnTselDly1W<DdrDenaliPhy137Spec> {
        PhyLp4BootRddataEnTselDly1W::new(self, 16)
    }
    #[doc = "Bits 24:27 - For LPDDR4 boot frequency, the offset in cycles from the dfi_rddata_en signal to release data from the entry FIFO for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lp4_boot_rptr_update_1(&mut self) -> PhyLp4BootRptrUpdate1W<DdrDenaliPhy137Spec> {
        PhyLp4BootRptrUpdate1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_137::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_137::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy137Spec;
impl crate::RegisterSpec for DdrDenaliPhy137Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_137::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy137Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_137::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy137Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_137 to value 0"]
impl crate::Resettable for DdrDenaliPhy137Spec {
