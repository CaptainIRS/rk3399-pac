#[doc = "Register `DDR_DENALI_CTL_30` reader"]
pub type R = crate::R<DdrDenaliCtl30Spec>;
#[doc = "Register `DDR_DENALI_CTL_30` writer"]
pub type W = crate::W<DdrDenaliCtl30Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trrd_f2(&mut self) -> TrrdF2W<DdrDenaliCtl30Spec> {
        TrrdF2W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TRC value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trc_f2(&mut self) -> TrcF2W<DdrDenaliCtl30Spec> {
        TrcF2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DRAM TRAS_MIN value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tras_min_f2(&mut self) -> TrasMinF2W<DdrDenaliCtl30Spec> {
        TrasMinF2W::new(self, 16)
    }
    #[doc = "Bits 24:29 - DRAM TWTR value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn twtr_f2(&mut self) -> TwtrF2W<DdrDenaliCtl30Spec> {
        TwtrF2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_30::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_30::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl30Spec;
impl crate::RegisterSpec for DdrDenaliCtl30Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_30::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl30Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_30::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl30Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_30 to value 0"]
impl crate::Resettable for DdrDenaliCtl30Spec {
