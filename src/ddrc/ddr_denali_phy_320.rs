#[doc = "Register `DDR_DENALI_PHY_320` reader"]
pub type R = crate::R<DdrDenaliPhy320Spec>;
#[doc = "Register `DDR_DENALI_PHY_320` writer"]
pub type W = crate::W<DdrDenaliPhy320Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq0_slave_delay_2(&mut self) -> PhyRddq0SlaveDelay2W<DdrDenaliPhy320Spec> {
        PhyRddq0SlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQ1 slave delay setting for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq1_slave_delay_2(&mut self) -> PhyRddq1SlaveDelay2W<DdrDenaliPhy320Spec> {
        PhyRddq1SlaveDelay2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_320::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_320::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy320Spec;
impl crate::RegisterSpec for DdrDenaliPhy320Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_320::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy320Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_320::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy320Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_320 to value 0"]
impl crate::Resettable for DdrDenaliPhy320Spec {
