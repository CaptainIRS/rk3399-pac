#[doc = "Register `DENALI_CTL_34` reader"]
pub type R = crate::R<DenaliCtl34Spec>;
#[doc = "Register `DENALI_CTL_34` writer"]
pub type W = crate::W<DenaliCtl34Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tckesr_f0(&mut self) -> TckesrF0W<DenaliCtl34Spec> {
        TckesrF0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TRTP value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trtp_f1(&mut self) -> TrtpF1W<DenaliCtl34Spec> {
        TrtpF1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DRAM TMRD value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tmrd_f1(&mut self) -> TmrdF1W<DenaliCtl34Spec> {
        TmrdF1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - DRAM TMOD value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tmod_f1(&mut self) -> TmodF1W<DenaliCtl34Spec> {
        TmodF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_34::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_34::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl34Spec;
impl crate::RegisterSpec for DenaliCtl34Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_34::R`](R) reader structure"]
impl crate::Readable for DenaliCtl34Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_34::W`](W) writer structure"]
impl crate::Writable for DenaliCtl34Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_34 to value 0"]
impl crate::Resettable for DenaliCtl34Spec {
