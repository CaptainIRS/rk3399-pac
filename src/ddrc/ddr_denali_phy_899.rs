#[doc = "Register `DDR_DENALI_PHY_899` reader"]
pub type R = crate::R<DdrDenaliPhy899Spec>;
#[doc = "Register `DDR_DENALI_PHY_899` writer"]
pub type W = crate::W<DdrDenaliPhy899Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_cslvl_enable(&mut self) -> PhyCslvlEnableW<DdrDenaliPhy899Spec> {
        PhyCslvlEnableW::new(self, 0)
    }
    #[doc = "Bits 8:11 - CS training map. Set each CS bit to 1 to allow that CS to participate in CS training results. NOT CURRENTLY USED."]
    #[inline(always)]
    #[must_use]
    pub fn phy_cslvl_cs_map(&mut self) -> PhyCslvlCsMapW<DdrDenaliPhy899Spec> {
        PhyCslvlCsMapW::new(self, 8)
    }
    #[doc = "Bits 16:26 - Defines the CS training DLL start value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_cslvl_start(&mut self) -> PhyCslvlStartW<DdrDenaliPhy899Spec> {
        PhyCslvlStartW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_899::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_899::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy899Spec;
impl crate::RegisterSpec for DdrDenaliPhy899Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_899::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy899Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_899::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy899Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_899 to value 0"]
impl crate::Resettable for DdrDenaliPhy899Spec {
