#[doc = "Register `DENALI_PHY_138` reader"]
pub type R = crate::R<DenaliPhy138Spec>;
#[doc = "Register `DENALI_PHY_138` writer"]
pub type W = crate::W<DenaliPhy138Spec>;
...
impl W {
    ...
    pub fn phy_lp4_boot_rddqs_latency_adjust_1(
        &mut self,
    ) -> PhyLp4BootRddqsLatencyAdjust1W<DenaliPhy138Spec> {
        PhyLp4BootRddqsLatencyAdjust1W::new(self, 0)
    }
    #[doc = "Bits 8:14 - Loopback control bits for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lpbk_control_1(&mut self) -> PhyLpbkControl1W<DenaliPhy138Spec> {
        PhyLpbkControl1W::new(self, 8)
    }
    #[doc = "Bit 16 - data slice power reduction disable for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_slice_pwr_rdc_disable_1(&mut self) -> PhySlicePwrRdcDisable1W<DenaliPhy138Spec> {
        PhySlicePwrRdcDisable1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_138::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_138::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy138Spec;
impl crate::RegisterSpec for DenaliPhy138Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_138::R`](R) reader structure"]
impl crate::Readable for DenaliPhy138Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_138::W`](W) writer structure"]
impl crate::Writable for DenaliPhy138Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_138 to value 0"]
impl crate::Resettable for DenaliPhy138Spec {
