...
#[doc = "Field `PI_WRLVL_CS` reader - Specifies the target chip select for the write leveling operation that\n\nis initiated through the PI_REG_59.pi_wrlvl_req parameter."]
pub type PiWrlvlCsR = crate::FieldReader;
#[doc = "Field `PI_WRLVL_CS` writer - Specifies the target chip select for the write leveling operation that\n\nis initiated through the PI_REG_59.pi_wrlvl_req parameter."]
pub type PiWrlvlCsW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `PI_WLDQSEN` reader - Indicates delay from the issuing MRS to the first DQS strobe for\n\nwrite leveling."]
...
impl R {
    ...
    #[doc = "Bits 16:17 - Specifies the target chip select for the write leveling operation that\n\nis initiated through the PI_REG_59.pi_wrlvl_req parameter."]
    #[inline(always)]
    pub fn pi_wrlvl_cs(&self) -> PiWrlvlCsR {
        PiWrlvlCsR::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bits 24:29 - Indicates delay from the issuing MRS to the first DQS strobe for\n\nwrite leveling."]
    #[inline(always)]
