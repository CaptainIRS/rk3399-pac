#[doc = "Register `DDR_DENALI_CTL_68` reader"]
pub type R = crate::R<DdrDenaliCtl68Spec>;
#[doc = "Register `DDR_DENALI_CTL_68` writer"]
pub type W = crate::W<DdrDenaliCtl68Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcsckeh_f2(&mut self) -> TcsckehF2W<DdrDenaliCtl68Spec> {
        TcsckehF2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - DRAM TCMDCKE value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tcmdcke_f2(&mut self) -> TcmdckeF2W<DdrDenaliCtl68Spec> {
        TcmdckeF2W::new(self, 8)
    }
    #[doc = "Bit 16 - Allow powerup via self-refresh instead of full memory initialization. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn pwrup_srefresh_exit(&mut self) -> PwrupSrefreshExitW<DdrDenaliCtl68Spec> {
        PwrupSrefreshExitW::new(self, 16)
    }
    #[doc = "Bit 24 - Disables the automatic refresh request associated with self-refresh exit. Set to 1 to disable."]
    #[inline(always)]
    #[must_use]
    pub fn srefresh_exit_no_refresh(&mut self) -> SrefreshExitNoRefreshW<DdrDenaliCtl68Spec> {
        SrefreshExitNoRefreshW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_68::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_68::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl68Spec;
impl crate::RegisterSpec for DdrDenaliCtl68Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_68::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl68Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_68::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl68Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_68 to value 0"]
impl crate::Resettable for DdrDenaliCtl68Spec {
