#[doc = "Register `DDR_DENALI_CTL_140` reader"]
pub type R = crate::R<DdrDenaliCtl140Spec>;
#[doc = "Register `DDR_DENALI_CTL_140` writer"]
pub type W = crate::W<DdrDenaliCtl140Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr11_data_f1_0(&mut self) -> Mr11DataF1_0W<DdrDenaliCtl140Spec> {
        Mr11DataF1_0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data to program into memory mode register 11 for chip select 0 for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn mr11_data_f2_0(&mut self) -> Mr11DataF2_0W<DdrDenaliCtl140Spec> {
        Mr11DataF2_0W::new(self, 8)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 12 for chip select 0."]
    #[inline(always)]
    #[must_use]
    pub fn mr12_data_f0_0(&mut self) -> Mr12DataF0_0W<DdrDenaliCtl140Spec> {
        Mr12DataF0_0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_140::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_140::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl140Spec;
impl crate::RegisterSpec for DdrDenaliCtl140Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_140::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl140Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_140::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl140Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_140 to value 0"]
impl crate::Resettable for DdrDenaliCtl140Spec {
