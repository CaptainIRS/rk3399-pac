#[doc = "Register `DDR_DENALI_PHY_06` reader"]
pub type R = crate::R<DdrDenaliPhy06Spec>;
#[doc = "Register `DDR_DENALI_PHY_06` writer"]
pub type W = crate::W<DdrDenaliPhy06Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_tsel_select_0(&mut self) -> PhyDqTselSelect0W<DdrDenaliPhy06Spec> {
        PhyDqTselSelect0W::new(self, 0)
    }
    #[doc = "Bits 24:26 - Operation type tsel enables for DQS signals for slice 0. Bit (0) enables tsel_en during read cycles. Bit (1) enables tsel_en during write cycles. Bit (2) enables tsel_en during idle cycles. Set each bit to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_tsel_enable_0(&mut self) -> PhyDqsTselEnable0W<DdrDenaliPhy06Spec> {
        PhyDqsTselEnable0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_06::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_06::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy06Spec;
impl crate::RegisterSpec for DdrDenaliPhy06Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_06::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy06Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_06::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy06Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_06 to value 0"]
impl crate::Resettable for DdrDenaliPhy06Spec {
