#[doc = "Register `DDR_DENALI_PHY_191` reader"]
pub type R = crate::R<DdrDenaliPhy191Spec>;
#[doc = "Register `DDR_DENALI_PHY_191` writer"]
pub type W = crate::W<DdrDenaliPhy191Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdm_slave_delay_1(&mut self) -> PhyClkWrdmSlaveDelay1W<DdrDenaliPhy191Spec> {
        PhyClkWrdmSlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Write clock slave delay setting for DQS for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdqs_slave_delay_1(&mut self) -> PhyClkWrdqsSlaveDelay1W<DdrDenaliPhy191Spec> {
        PhyClkWrdqsSlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_191::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_191::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy191Spec;
impl crate::RegisterSpec for DdrDenaliPhy191Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_191::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy191Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_191::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy191Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_191 to value 0"]
impl crate::Resettable for DdrDenaliPhy191Spec {
