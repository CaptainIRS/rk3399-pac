#[doc = "Register `DDR_DENALI_PHY_22` reader"]
pub type R = crate::R<DdrDenaliPhy22Spec>;
#[doc = "Register `DDR_DENALI_PHY_22` writer"]
pub type W = crate::W<DdrDenaliPhy22Spec>;
...
#[doc = "Field `SC_PHY_LVL_DEBUG_CONT_0` writer - Allows the leveling state machine to advance (when in debug mode) for slice 0. Set to 1 to trigger."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_lvl_debug_mode_0(&mut self) -> PhyLvlDebugMode0W<DdrDenaliPhy22Spec> {
        PhyLvlDebugMode0W::new(self, 0)
    }
    #[doc = "Bit 8 - Allows the leveling state machine to advance (when in debug mode) for slice 0. Set to 1 to trigger."]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_lvl_debug_cont_0(&mut self) -> ScPhyLvlDebugCont0W<DdrDenaliPhy22Spec> {
        ScPhyLvlDebugCont0W::new(self, 8)
    }
    #[doc = "Bits 16:21 - Number of samples to take at each DQS slave delay setting during write leveling for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_capture_cnt_0(&mut self) -> PhyWrlvlCaptureCnt0W<DdrDenaliPhy22Spec> {
        PhyWrlvlCaptureCnt0W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Number of cycles to wait after changing DQS slave delay setting during write leveling for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_updt_wait_cnt_0(&mut self) -> PhyWrlvlUpdtWaitCnt0W<DdrDenaliPhy22Spec> {
        PhyWrlvlUpdtWaitCnt0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_22::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_22::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy22Spec;
impl crate::RegisterSpec for DdrDenaliPhy22Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_22::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy22Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_22::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy22Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_22 to value 0"]
impl crate::Resettable for DdrDenaliPhy22Spec {
