#[doc = "Register `DDR_DENALI_PHY_194` reader"]
pub type R = crate::R<DdrDenaliPhy194Spec>;
#[doc = "Register `DDR_DENALI_PHY_194` writer"]
pub type W = crate::W<DdrDenaliPhy194Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq4_slave_delay_1(&mut self) -> PhyRddq4SlaveDelay1W<DdrDenaliPhy194Spec> {
        PhyRddq4SlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQ5 slave delay setting for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq5_slave_delay_1(&mut self) -> PhyRddq5SlaveDelay1W<DdrDenaliPhy194Spec> {
        PhyRddq5SlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_194::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_194::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy194Spec;
impl crate::RegisterSpec for DdrDenaliPhy194Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_194::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy194Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_194::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy194Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_194 to value 0"]
impl crate::Resettable for DdrDenaliPhy194Spec {
