#[doc = "Register `DENALI_CTL_188` reader"]
pub type R = crate::R<DenaliCtl188Spec>;
#[doc = "Register `DENALI_CTL_188` writer"]
pub type W = crate::W<DenaliCtl188Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zqreset_f1(&mut self) -> ZqresetF1W<DenaliCtl188Spec> {
        ZqresetF1W::new(self, 0)
    }
    #[doc = "Bits 16:27 - Number of cycles needed for a ZQRESET command for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn zqreset_f2(&mut self) -> ZqresetF2W<DenaliCtl188Spec> {
        ZqresetF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_188::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_188::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl188Spec;
impl crate::RegisterSpec for DenaliCtl188Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_188::R`](R) reader structure"]
impl crate::Readable for DenaliCtl188Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_188::W`](W) writer structure"]
impl crate::Writable for DenaliCtl188Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_188 to value 0"]
impl crate::Resettable for DenaliCtl188Spec {
