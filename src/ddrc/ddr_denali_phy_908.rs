#[doc = "Register `DDR_DENALI_PHY_908` reader"]
pub type R = crate::R<DdrDenaliPhy908Spec>;
#[doc = "Register `DDR_DENALI_PHY_908` writer"]
pub type W = crate::W<DdrDenaliPhy908Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_lpddr3_cs(&mut self) -> PhyLpddr3CsW<DdrDenaliPhy908Spec> {
        PhyLpddr3CsW::new(self, 0)
    }
    #[doc = "Bits 8:10 - Mask bits to ignore ADR slice CA training results from the address slices. Bit (0) correlates to address slice 0 and bit (1) correlates to address slice 1. Set each bit to 1 to ignore."]
    #[inline(always)]
    #[must_use]
    pub fn phy_calvl_result_mask(&mut self) -> PhyCalvlResultMaskW<DdrDenaliPhy908Spec> {
    ...
    pub fn sc_phy_update_clk_cal_values(
        &mut self,
    ) -> ScPhyUpdateClkCalValuesW<DdrDenaliPhy908Spec> {
    ...
    pub fn phy_continuous_clk_cal_update(
        &mut self,
    ) -> PhyContinuousClkCalUpdateW<DdrDenaliPhy908Spec> {
        PhyContinuousClkCalUpdateW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_908::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_908::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy908Spec;
impl crate::RegisterSpec for DdrDenaliPhy908Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_908::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy908Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_908::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy908Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_908 to value 0x01"]
impl crate::Resettable for DdrDenaliPhy908Spec {
