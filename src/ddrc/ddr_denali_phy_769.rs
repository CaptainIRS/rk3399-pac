#[doc = "Register `DDR_DENALI_PHY_769` reader"]
pub type R = crate::R<DdrDenaliPhy769Spec>;
#[doc = "Register `DDR_DENALI_PHY_769` writer"]
pub type W = crate::W<DdrDenaliPhy769Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_adr4_sw_wraddr_shift_2(&mut self) -> PhyAdr4SwWraddrShift2W<DdrDenaliPhy769Spec> {
        PhyAdr4SwWraddrShift2W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Manual override of automatic half_cycle_shift/cycle_shift for address slice 2. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) is the cycle_shift value. For bits (4:3), clear to 0x0 for no offset, program to 0x1 for -1 cycle, program to 0x2 for +1 cycle, or program to 0x3 for -2 cycles."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr5_sw_wraddr_shift_2(&mut self) -> PhyAdr5SwWraddrShift2W<DdrDenaliPhy769Spec> {
    ...
    pub fn phy_adr_clk_wr_bypass_slave_delay_2(
        &mut self,
    ) -> PhyAdrClkWrBypassSlaveDelay2W<DdrDenaliPhy769Spec> {
        PhyAdrClkWrBypassSlaveDelay2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_769::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_769::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy769Spec;
impl crate::RegisterSpec for DdrDenaliPhy769Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_769::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy769Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_769::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy769Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_769 to value 0"]
impl crate::Resettable for DdrDenaliPhy769Spec {
