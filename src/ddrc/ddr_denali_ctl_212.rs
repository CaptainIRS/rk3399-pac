#[doc = "Register `DDR_DENALI_CTL_212` reader"]
pub type R = crate::R<DdrDenaliCtl212Spec>;
#[doc = "Register `DDR_DENALI_CTL_212` writer"]
pub type W = crate::W<DdrDenaliCtl212Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn odt_wr_map_cs1(&mut self) -> OdtWrMapCs1W<DdrDenaliCtl212Spec> {
        OdtWrMapCs1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Defines the DRAM delay from an ODT de-assertion to the next non- write, non-read command."]
    #[inline(always)]
    #[must_use]
    pub fn todtl_2cmd_f0(&mut self) -> Todtl2cmdF0W<DdrDenaliCtl212Spec> {
        Todtl2cmdF0W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Defines the DRAM delay from an ODT de-assertion to the next non- write, non-read command."]
    #[inline(always)]
    #[must_use]
    pub fn todtl_2cmd_f1(&mut self) -> Todtl2cmdF1W<DdrDenaliCtl212Spec> {
        Todtl2cmdF1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Defines the DRAM delay from an ODT de-assertion to the next non- write, non-read command."]
    #[inline(always)]
    #[must_use]
    pub fn todtl_2cmd_f2(&mut self) -> Todtl2cmdF2W<DdrDenaliCtl212Spec> {
        Todtl2cmdF2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_212::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_212::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl212Spec;
impl crate::RegisterSpec for DdrDenaliCtl212Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_212::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl212Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_212::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl212Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_212 to value 0"]
impl crate::Resettable for DdrDenaliCtl212Spec {
