#[doc = "Register `DDR_DENALI_PHY_62` reader"]
pub type R = crate::R<DdrDenaliPhy62Spec>;
#[doc = "Register `DDR_DENALI_PHY_62` writer"]
pub type W = crate::W<DdrDenaliPhy62Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq6_slave_delay_0(&mut self) -> PhyClkWrdq6SlaveDelay0W<DdrDenaliPhy62Spec> {
        PhyClkWrdq6SlaveDelay0W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ7 for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq7_slave_delay_0(&mut self) -> PhyClkWrdq7SlaveDelay0W<DdrDenaliPhy62Spec> {
        PhyClkWrdq7SlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_62::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_62::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy62Spec;
impl crate::RegisterSpec for DdrDenaliPhy62Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_62::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy62Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_62::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy62Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_62 to value 0"]
impl crate::Resettable for DdrDenaliPhy62Spec {
