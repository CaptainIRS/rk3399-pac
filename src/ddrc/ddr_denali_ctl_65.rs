#[doc = "Register `DDR_DENALI_CTL_65` reader"]
pub type R = crate::R<DdrDenaliCtl65Spec>;
#[doc = "Register `DDR_DENALI_CTL_65` writer"]
pub type W = crate::W<DdrDenaliCtl65Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tckckel_f1(&mut self) -> TckckelF1W<DdrDenaliCtl65Spec> {
        TckckelF1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TSR value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tsr_f1(&mut self) -> TsrF1W<DdrDenaliCtl65Spec> {
        TsrF1W::new(self, 8)
    }
    #[doc = "Bits 16:18 - DRAM TESCKE value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tescke_f1(&mut self) -> TesckeF1W<DdrDenaliCtl65Spec> {
        TesckeF1W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DRAM TCKELPD value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tckelpd_f1(&mut self) -> TckelpdF1W<DdrDenaliCtl65Spec> {
        TckelpdF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_65::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_65::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl65Spec;
impl crate::RegisterSpec for DdrDenaliCtl65Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_65::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl65Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_65::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl65Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_65 to value 0"]
impl crate::Resettable for DdrDenaliCtl65Spec {
