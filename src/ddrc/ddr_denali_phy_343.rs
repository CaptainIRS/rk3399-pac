#[doc = "Register `DDR_DENALI_PHY_343` reader"]
pub type R = crate::R<DdrDenaliPhy343Spec>;
#[doc = "Register `DDR_DENALI_PHY_343` writer"]
pub type W = crate::W<DdrDenaliPhy343Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_master_delay_step_2(&mut self) -> PhyMasterDelayStep2W<DdrDenaliPhy343Spec> {
        PhyMasterDelayStep2W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Wait cycles for master delay line locking algorithm for slice 2. Bits (3:0) are the cycle wait count after a calibration clock setting change. Bits (7:4) are the cycle wait count after a master delay setting change."]
    #[inline(always)]
    #[must_use]
    pub fn phy_master_delay_wait_2(&mut self) -> PhyMasterDelayWait2W<DdrDenaliPhy343Spec> {
        PhyMasterDelayWait2W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Offset in cycles from the dfi_rddata_en signal to release data from the entry FIFO for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rptr_update_2(&mut self) -> PhyRptrUpdate2W<DdrDenaliPhy343Spec> {
        PhyRptrUpdate2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DQS slave delay step size during write leveling for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_dly_step_2(&mut self) -> PhyWrlvlDlyStep2W<DdrDenaliPhy343Spec> {
        PhyWrlvlDlyStep2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_343::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_343::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy343Spec;
impl crate::RegisterSpec for DdrDenaliPhy343Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_343::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy343Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_343::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy343Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_343 to value 0"]
impl crate::Resettable for DdrDenaliPhy343Spec {
