#[doc = "Register `DDR_DENALI_PHY_450` reader"]
pub type R = crate::R<DdrDenaliPhy450Spec>;
#[doc = "Register `DDR_DENALI_PHY_450` writer"]
pub type W = crate::W<DdrDenaliPhy450Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq4_slave_delay_3(&mut self) -> PhyRddq4SlaveDelay3W<DdrDenaliPhy450Spec> {
        PhyRddq4SlaveDelay3W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQ5 slave delay setting for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq5_slave_delay_3(&mut self) -> PhyRddq5SlaveDelay3W<DdrDenaliPhy450Spec> {
        PhyRddq5SlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_450::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_450::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy450Spec;
impl crate::RegisterSpec for DdrDenaliPhy450Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_450::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy450Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_450::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy450Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_450 to value 0"]
impl crate::Resettable for DdrDenaliPhy450Spec {
