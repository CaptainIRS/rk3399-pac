#[doc = "Register `DDR_DENALI_PHY_339` reader"]
pub type R = crate::R<DdrDenaliPhy339Spec>;
#[doc = "Register `DDR_DENALI_PHY_339` writer"]
pub type W = crate::W<DdrDenaliPhy339Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_oe_timing_2(&mut self) -> PhyDqOeTiming2W<DdrDenaliPhy339Spec> {
        PhyDqOeTiming2W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Start/end timing values for DQ/DM read based termination enable and select signals for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_tsel_rd_timing_2(&mut self) -> PhyDqTselRdTiming2W<DdrDenaliPhy339Spec> {
        PhyDqTselRdTiming2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Start/end timing values for DQ/DM write based termination enable and select signals for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_tsel_wr_timing_2(&mut self) -> PhyDqTselWrTiming2W<DdrDenaliPhy339Spec> {
        PhyDqTselWrTiming2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Start/end timing values for DQS output enable signals for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_oe_timing_2(&mut self) -> PhyDqsOeTiming2W<DdrDenaliPhy339Spec> {
        PhyDqsOeTiming2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_339::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_339::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy339Spec;
impl crate::RegisterSpec for DdrDenaliPhy339Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_339::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy339Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_339::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy339Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_339 to value 0"]
impl crate::Resettable for DdrDenaliPhy339Spec {
