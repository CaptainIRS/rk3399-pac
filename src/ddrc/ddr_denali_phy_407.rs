#[doc = "Register `DDR_DENALI_PHY_407` reader"]
pub type R = crate::R<DdrDenaliPhy407Spec>;
#[doc = "Register `DDR_DENALI_PHY_407` writer"]
pub type W = crate::W<DdrDenaliPhy407Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_capture_cnt_3(&mut self) -> PhyGtlvlCaptureCnt3W<DdrDenaliPhy407Spec> {
        PhyGtlvlCaptureCnt3W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Number of cycles + 4 to wait after changing DQS slave delay setting during gate training for slice 3. The valid range is 0x0 to 0xB."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_updt_wait_cnt_3(&mut self) -> PhyGtlvlUpdtWaitCnt3W<DdrDenaliPhy407Spec> {
        PhyGtlvlUpdtWaitCnt3W::new(self, 8)
    }
    #[doc = "Bits 16:21 - Number of samples to take at each DQS slave delay setting during read leveling for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rdlvl_capture_cnt_3(&mut self) -> PhyRdlvlCaptureCnt3W<DdrDenaliPhy407Spec> {
        PhyRdlvlCaptureCnt3W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Number of cycles to wait after changing DQS slave delay setting during read leveling for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rdlvl_updt_wait_cnt_3(&mut self) -> PhyRdlvlUpdtWaitCnt3W<DdrDenaliPhy407Spec> {
        PhyRdlvlUpdtWaitCnt3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_407::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_407::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy407Spec;
impl crate::RegisterSpec for DdrDenaliPhy407Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_407::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy407Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_407::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy407Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_407 to value 0"]
impl crate::Resettable for DdrDenaliPhy407Spec {
