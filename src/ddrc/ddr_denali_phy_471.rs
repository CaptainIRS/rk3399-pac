#[doc = "Register `DDR_DENALI_PHY_471` reader"]
pub type R = crate::R<DdrDenaliPhy471Spec>;
#[doc = "Register `DDR_DENALI_PHY_471` writer"]
pub type W = crate::W<DdrDenaliPhy471Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_master_delay_step_3(&mut self) -> PhyMasterDelayStep3W<DdrDenaliPhy471Spec> {
        PhyMasterDelayStep3W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Wait cycles for master delay line locking algorithm for slice 3. Bits (3:0) are the cycle wait count after a calibration clock setting change. Bits (7:4) are the cycle wait count after a master delay setting change."]
    #[inline(always)]
    #[must_use]
    pub fn phy_master_delay_wait_3(&mut self) -> PhyMasterDelayWait3W<DdrDenaliPhy471Spec> {
        PhyMasterDelayWait3W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Offset in cycles from the dfi_rddata_en signal to release data from the entry FIFO for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rptr_update_3(&mut self) -> PhyRptrUpdate3W<DdrDenaliPhy471Spec> {
        PhyRptrUpdate3W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DQS slave delay step size during write leveling for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_dly_step_3(&mut self) -> PhyWrlvlDlyStep3W<DdrDenaliPhy471Spec> {
        PhyWrlvlDlyStep3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_471::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_471::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy471Spec;
impl crate::RegisterSpec for DdrDenaliPhy471Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_471::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy471Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_471::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy471Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_471 to value 0"]
impl crate::Resettable for DdrDenaliPhy471Spec {
