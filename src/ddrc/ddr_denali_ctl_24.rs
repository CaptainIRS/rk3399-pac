#[doc = "Register `DDR_DENALI_CTL_24` reader"]
pub type R = crate::R<DdrDenaliCtl24Spec>;
#[doc = "Register `DDR_DENALI_CTL_24` writer"]
pub type W = crate::W<DdrDenaliCtl24Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn additive_lat_f0(&mut self) -> AdditiveLatF0W<DdrDenaliCtl24Spec> {
        AdditiveLatF0W::new(self, 0)
    }
    #[doc = "Bits 8:14 - Sets latency from read command send to data receive from/to controller for frequency copy 1. Bit (0) is half-cycle increment and the upper bits define memory CAS latency for the controller."]
    #[inline(always)]
    #[must_use]
    pub fn caslat_lin_f1(&mut self) -> CaslatLinF1W<DdrDenaliCtl24Spec> {
        CaslatLinF1W::new(self, 8)
    }
    #[doc = "Bits 16:20 - DRAM WRLAT value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn wrlat_f1(&mut self) -> WrlatF1W<DdrDenaliCtl24Spec> {
        WrlatF1W::new(self, 16)
    }
    #[doc = "Bits 24:29 - DRAM additive latency value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn additive_lat_f1(&mut self) -> AdditiveLatF1W<DdrDenaliCtl24Spec> {
        AdditiveLatF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_24::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_24::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl24Spec;
impl crate::RegisterSpec for DdrDenaliCtl24Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_24::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl24Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_24::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl24Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_24 to value 0"]
impl crate::Resettable for DdrDenaliCtl24Spec {
