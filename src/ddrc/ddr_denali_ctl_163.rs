#[doc = "Register `DDR_DENALI_CTL_163` reader"]
pub type R = crate::R<DdrDenaliCtl163Spec>;
#[doc = "Register `DDR_DENALI_CTL_163` writer"]
pub type W = crate::W<DdrDenaliCtl163Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsp0_frc_valid(&mut self) -> Fsp0FrcValidW<DdrDenaliCtl163Spec> {
        Fsp0FrcValidW::new(self, 0)
    }
    #[doc = "Bit 8 - Specifies whether the FSP set defined in the FSP1_FRC parameter reflects the frequency used to program the FSP1 registers."]
    #[inline(always)]
    #[must_use]
    pub fn fsp1_frc_valid(&mut self) -> Fsp1FrcValidW<DdrDenaliCtl163Spec> {
        Fsp1FrcValidW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Identifies which of the controllersfrequencycopyisassociat edwithFSP0.'"]
    #[inline(always)]
    #[must_use]
    pub fn fsp0_frc(&mut self) -> Fsp0FrcW<DdrDenaliCtl163Spec> {
        Fsp0FrcW::new(self, 16)
    }
    #[doc = "Bits 24:25 - Identifies which of the controllersfrequencycopyisassociat edwithFSP1.'"]
    #[inline(always)]
    #[must_use]
    pub fn fsp1_frc(&mut self) -> Fsp1FrcW<DdrDenaliCtl163Spec> {
        Fsp1FrcW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_163::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_163::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl163Spec;
impl crate::RegisterSpec for DdrDenaliCtl163Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_163::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl163Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_163::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl163Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_163 to value 0"]
impl crate::Resettable for DdrDenaliCtl163Spec {
