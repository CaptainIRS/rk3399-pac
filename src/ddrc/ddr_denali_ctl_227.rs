#[doc = "Register `DDR_DENALI_CTL_227` reader"]
pub type R = crate::R<DdrDenaliCtl227Spec>;
#[doc = "Register `DDR_DENALI_CTL_227` writer"]
pub type W = crate::W<DdrDenaliCtl227Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_on_sref_exit(&mut self) -> WrlvlOnSrefExitW<DdrDenaliCtl227Spec> {
        WrlvlOnSrefExitW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Mask for the dfi_wrlvl_resp signal during write leveling."]
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_resp_mask(&mut self) -> WrlvlRespMaskW<DdrDenaliCtl227Spec> {
        WrlvlRespMaskW::new(self, 8)
    }
    #[doc = "Bit 16 - Enables refreshes and other non- data commands to execute in the middle of write leveling. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_aref_en(&mut self) -> WrlvlArefEnW<DdrDenaliCtl227Spec> {
        WrlvlArefEnW::new(self, 16)
    }
    #[doc = "Bit 24 - Enables rotational CS for interval write leveling. Set to 1 for rotating CS."]
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_rotate(&mut self) -> WrlvlRotateW<DdrDenaliCtl227Spec> {
        WrlvlRotateW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_227::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_227::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl227Spec;
impl crate::RegisterSpec for DdrDenaliCtl227Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_227::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl227Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_227::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl227Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_227 to value 0"]
impl crate::Resettable for DdrDenaliCtl227Spec {
