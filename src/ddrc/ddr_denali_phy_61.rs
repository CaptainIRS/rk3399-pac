#[doc = "Register `DDR_DENALI_PHY_61` reader"]
pub type R = crate::R<DdrDenaliPhy61Spec>;
#[doc = "Register `DDR_DENALI_PHY_61` writer"]
pub type W = crate::W<DdrDenaliPhy61Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq4_slave_delay_0(&mut self) -> PhyClkWrdq4SlaveDelay0W<DdrDenaliPhy61Spec> {
        PhyClkWrdq4SlaveDelay0W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ5 for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq5_slave_delay_0(&mut self) -> PhyClkWrdq5SlaveDelay0W<DdrDenaliPhy61Spec> {
        PhyClkWrdq5SlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_61::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_61::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy61Spec;
impl crate::RegisterSpec for DdrDenaliPhy61Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_61::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy61Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_61::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy61Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_61 to value 0"]
impl crate::Resettable for DdrDenaliPhy61Spec {
