#[doc = "Register `DDR_DENALI_CTL_69` reader"]
pub type R = crate::R<DdrDenaliCtl69Spec>;
#[doc = "Register `DDR_DENALI_CTL_69` writer"]
pub type W = crate::W<DdrDenaliCtl69Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enable_quick_srefresh(&mut self) -> EnableQuickSrefreshW<DdrDenaliCtl69Spec> {
        EnableQuickSrefreshW::new(self, 0)
    }
    #[doc = "Bits 8:10 - Additional cycles to delay CKE for status reporting."]
    #[inline(always)]
    #[must_use]
    pub fn cke_delay(&mut self) -> CkeDelayW<DdrDenaliCtl69Spec> {
        CkeDelayW::new(self, 8)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_69::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_69::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl69Spec;
impl crate::RegisterSpec for DdrDenaliCtl69Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_69::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl69Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_69::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl69Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_69 to value 0"]
impl crate::Resettable for DdrDenaliCtl69Spec {
