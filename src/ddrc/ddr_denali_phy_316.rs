#[doc = "Register `DDR_DENALI_PHY_316` reader"]
pub type R = crate::R<DdrDenaliPhy316Spec>;
#[doc = "Register `DDR_DENALI_PHY_316` writer"]
pub type W = crate::W<DdrDenaliPhy316Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq2_slave_delay_2(&mut self) -> PhyClkWrdq2SlaveDelay2W<DdrDenaliPhy316Spec> {
        PhyClkWrdq2SlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ3 for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq3_slave_delay_2(&mut self) -> PhyClkWrdq3SlaveDelay2W<DdrDenaliPhy316Spec> {
        PhyClkWrdq3SlaveDelay2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_316::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_316::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy316Spec;
impl crate::RegisterSpec for DdrDenaliPhy316Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_316::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy316Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_316::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy316Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_316 to value 0"]
impl crate::Resettable for DdrDenaliPhy316Spec {
