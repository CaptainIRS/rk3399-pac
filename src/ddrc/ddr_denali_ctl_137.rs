#[doc = "Register `DDR_DENALI_CTL_137` reader"]
pub type R = crate::R<DdrDenaliCtl137Spec>;
#[doc = "Register `DDR_DENALI_CTL_137` writer"]
pub type W = crate::W<DdrDenaliCtl137Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr2_data_f2_0(&mut self) -> Mr2DataF2_0W<DdrDenaliCtl137Spec> {
        Mr2DataF2_0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register single write to chip select 0."]
    #[inline(always)]
    #[must_use]
    pub fn mrsingle_data_0(&mut self) -> MrsingleData0W<DdrDenaliCtl137Spec> {
        MrsingleData0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_137::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_137::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl137Spec;
impl crate::RegisterSpec for DdrDenaliCtl137Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_137::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl137Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_137::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl137Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_137 to value 0"]
impl crate::Resettable for DdrDenaliCtl137Spec {
