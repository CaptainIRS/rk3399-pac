#[doc = "Register `DDR_PI_REG_24` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_power_on_seq_bypass_array(&mut self) -> PiPowerOnSeqBypassArrayW<DdrPiReg24Spec> {
        PiPowerOnSeqBypassArrayW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Indicates the step that is the last step of the power-on sequence."]
    #[inline(always)]
    #[must_use]
    pub fn pi_power_on_seq_end_array(&mut self) -> PiPowerOnSeqEndArrayW<DdrPiReg24Spec> {
        PiPowerOnSeqEndArrayW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 24\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_pi_reg_24::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_pi_reg_24::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrPiReg24Spec;
impl crate::RegisterSpec for DdrPiReg24Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_pi_reg_24::R`](R) reader structure"]
impl crate::Readable for DdrPiReg24Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_pi_reg_24::W`](W) writer structure"]
impl crate::Writable for DdrPiReg24Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_PI_REG_24 to value 0x0100"]
impl crate::Resettable for DdrPiReg24Spec {
