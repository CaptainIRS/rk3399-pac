#[doc = "Register `DDR_DENALI_PHY_311` reader"]
pub type R = crate::R<DdrDenaliPhy311Spec>;
#[doc = "Register `DDR_DENALI_PHY_311` writer"]
pub type W = crate::W<DdrDenaliPhy311Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rx_cal_dq4_2(&mut self) -> PhyRxCalDq4_2W<DdrDenaliPhy311Spec> {
        PhyRxCalDq4_2W::new(self, 0)
    }
    #[doc = "Bits 16:27 - RX Calibration codes for DQ5 for slice 2. Bits (5:0) contain rx_cal_code_down. Bits (11:6) contain rx_cal_code_up. Bits (17:12) contain rx_cal_code2_down. Bits (23:18) contain rx_cal_code2_up."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rx_cal_dq5_2(&mut self) -> PhyRxCalDq5_2W<DdrDenaliPhy311Spec> {
        PhyRxCalDq5_2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_311::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_311::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy311Spec;
impl crate::RegisterSpec for DdrDenaliPhy311Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_311::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy311Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_311::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy311Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_311 to value 0"]
impl crate::Resettable for DdrDenaliPhy311Spec {
