#[doc = "Register `DDR_DENALI_CTL_46` reader"]
pub type R = crate::R<DdrDenaliCtl46Spec>;
#[doc = "Register `DDR_DENALI_CTL_46` writer"]
pub type W = crate::W<DdrDenaliCtl46Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn address_mirroring(&mut self) -> AddressMirroringW<DdrDenaliCtl46Spec> {
        AddressMirroringW::new(self, 0)
    }
    #[doc = "Bit 24 - Indicates that the external DRAM does not support DM masking. Set to 1 for no DM masking at the DRAM."]
    #[inline(always)]
    #[must_use]
    pub fn no_memory_dm(&mut self) -> NoMemoryDmW<DdrDenaliCtl46Spec> {
        NoMemoryDmW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_46::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_46::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl46Spec;
impl crate::RegisterSpec for DdrDenaliCtl46Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_46::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl46Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_46::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl46Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_46 to value 0"]
impl crate::Resettable for DdrDenaliCtl46Spec {
