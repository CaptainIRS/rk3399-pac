#[doc = "Register `DDR_DENALI_PHY_406` reader"]
pub type R = crate::R<DdrDenaliPhy406Spec>;
#[doc = "Register `DDR_DENALI_PHY_406` writer"]
pub type W = crate::W<DdrDenaliPhy406Spec>;
...
#[doc = "Field `SC_PHY_LVL_DEBUG_CONT_3` writer - Allows the leveling state machine to advance (when in debug mode) for slice 3. Set to 1 to trigger. WRITE-ONLY"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_lvl_debug_mode_3(&mut self) -> PhyLvlDebugMode3W<DdrDenaliPhy406Spec> {
        PhyLvlDebugMode3W::new(self, 0)
    }
    #[doc = "Bit 8 - Allows the leveling state machine to advance (when in debug mode) for slice 3. Set to 1 to trigger. WRITE-ONLY"]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_lvl_debug_cont_3(&mut self) -> ScPhyLvlDebugCont3W<DdrDenaliPhy406Spec> {
        ScPhyLvlDebugCont3W::new(self, 8)
    }
    #[doc = "Bits 16:21 - Number of samples to take at each DQS slave delay setting during write leveling for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_capture_cnt_3(&mut self) -> PhyWrlvlCaptureCnt3W<DdrDenaliPhy406Spec> {
        PhyWrlvlCaptureCnt3W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Number of cycles to wait after changing DQS slave delay setting during write leveling for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_updt_wait_cnt_3(&mut self) -> PhyWrlvlUpdtWaitCnt3W<DdrDenaliPhy406Spec> {
        PhyWrlvlUpdtWaitCnt3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_406::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_406::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy406Spec;
impl crate::RegisterSpec for DdrDenaliPhy406Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_406::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy406Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_406::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy406Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_406 to value 0"]
impl crate::Resettable for DdrDenaliPhy406Spec {
