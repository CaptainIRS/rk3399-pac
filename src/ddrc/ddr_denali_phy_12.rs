#[doc = "Register `DDR_DENALI_PHY_12` reader"]
pub type R = crate::R<DdrDenaliPhy12Spec>;
#[doc = "Register `DDR_DENALI_PHY_12` writer"]
pub type W = crate::W<DdrDenaliPhy12Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_lpddr_0(&mut self) -> PhyLpddr0W<DdrDenaliPhy12Spec> {
        PhyLpddr0W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Indicates the type of DRAM for slice 0. Clear to 0 for DDR3 or DDR4, program to 1 for LPDDR3, or program to 2 for LPDDR4."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lpddr_type_0(&mut self) -> PhyLpddrType0W<DdrDenaliPhy12Spec> {
        PhyLpddrType0W::new(self, 8)
    }
    #[doc = "Bits 16:24 - Number of cycles to delay the read DQS gate signal to generate gate1 signal for on the fly read DQS training for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_smpl1_slave_delay_0(&mut self) -> PhyGateSmpl1SlaveDelay0W<DdrDenaliPhy12Spec> {
        PhyGateSmpl1SlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_12::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_12::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy12Spec;
impl crate::RegisterSpec for DdrDenaliPhy12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_12::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy12Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_12::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy12Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_12 to value 0"]
impl crate::Resettable for DdrDenaliPhy12Spec {
