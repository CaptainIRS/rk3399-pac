#[doc = "Register `DDR_DENALI_CTL_62` reader"]
pub type R = crate::R<DdrDenaliCtl62Spec>;
#[doc = "Register `DDR_DENALI_CTL_62` writer"]
pub type W = crate::W<DdrDenaliCtl62Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txsnr_f2(&mut self) -> TxsnrF2W<DdrDenaliCtl62Spec> {
        TxsnrF2W::new(self, 0)
    }
    #[doc = "Bits 16:19 - DRAM TCKELCMD value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tckelcmd_f0(&mut self) -> TckelcmdF0W<DdrDenaliCtl62Spec> {
        TckelcmdF0W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DRAM TCKEHCMD value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tckehcmd_f0(&mut self) -> TckehcmdF0W<DdrDenaliCtl62Spec> {
        TckehcmdF0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_62::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_62::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl62Spec;
impl crate::RegisterSpec for DdrDenaliCtl62Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_62::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl62Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_62::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl62Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_62 to value 0"]
impl crate::Resettable for DdrDenaliCtl62Spec {
