#[doc = "Register `DDR_DENALI_CTL_232` reader"]
pub type R = crate::R<DdrDenaliCtl232Spec>;
#[doc = "Register `DDR_DENALI_CTL_232` writer"]
pub type W = crate::W<DdrDenaliCtl232Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_timeout_f1(&mut self) -> WrlvlTimeoutF1W<DdrDenaliCtl232Spec> {
    ...
    pub fn wrlvl_sw_promote_threshold_f1(
        &mut self,
    ) -> WrlvlSwPromoteThresholdF1W<DdrDenaliCtl232Spec> {
        WrlvlSwPromoteThresholdF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_232::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_232::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl232Spec;
impl crate::RegisterSpec for DdrDenaliCtl232Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_232::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl232Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_232::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl232Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_232 to value 0"]
impl crate::Resettable for DdrDenaliCtl232Spec {
