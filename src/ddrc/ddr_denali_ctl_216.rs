#[doc = "Register `DDR_DENALI_CTL_216` reader"]
pub type R = crate::R<DdrDenaliCtl216Spec>;
#[doc = "Register `DDR_DENALI_CTL_216` writer"]
pub type W = crate::W<DdrDenaliCtl216Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rw2mrw_dly_f0(&mut self) -> Rw2mrwDlyF0W<DdrDenaliCtl216Spec> {
        Rw2mrwDlyF0W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Additional delay to insert between read or write and mode_reg_write. Allowed programming dependent on memory system."]
    #[inline(always)]
    #[must_use]
    pub fn rw2mrw_dly_f1(&mut self) -> Rw2mrwDlyF1W<DdrDenaliCtl216Spec> {
        Rw2mrwDlyF1W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Additional delay to insert between read or write and mode_reg_write. Allowed programming dependent on memory system."]
    #[inline(always)]
    #[must_use]
    pub fn rw2mrw_dly_f2(&mut self) -> Rw2mrwDlyF2W<DdrDenaliCtl216Spec> {
        Rw2mrwDlyF2W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Additional delay to insert between reads to different chip selects. Allowed programming dependent on memory system."]
    #[inline(always)]
    #[must_use]
    pub fn r2r_diffcs_dly_f0(&mut self) -> R2rDiffcsDlyF0W<DdrDenaliCtl216Spec> {
        R2rDiffcsDlyF0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_216::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_216::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl216Spec;
impl crate::RegisterSpec for DdrDenaliCtl216Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_216::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl216Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_216::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl216Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_216 to value 0x0108_0808"]
impl crate::Resettable for DdrDenaliCtl216Spec {
