#[doc = "Register `DDR_DENALI_PHY_342` reader"]
pub type R = crate::R<DdrDenaliPhy342Spec>;
#[doc = "Register `DDR_DENALI_PHY_342` writer"]
pub type W = crate::W<DdrDenaliPhy342Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddata_en_tsel_dly_2(&mut self) -> PhyRddataEnTselDly2W<DdrDenaliPhy342Spec> {
        PhyRddataEnTselDly2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Master delay line override settings for slice 2. Bit (0) enables software half clock mode. Bit (1) is the software half clock mode value. Bit (2) enables software bypass mode. Bit (3) is the software bypass mode value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_master_mode_2(&mut self) -> PhySwMasterMode2W<DdrDenaliPhy342Spec> {
        PhySwMasterMode2W::new(self, 8)
    }
    #[doc = "Bits 16:25 - Start value for master delay line locking algorithm for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_master_delay_start_2(&mut self) -> PhyMasterDelayStart2W<DdrDenaliPhy342Spec> {
        PhyMasterDelayStart2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_342::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_342::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy342Spec;
impl crate::RegisterSpec for DdrDenaliPhy342Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_342::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy342Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_342::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy342Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_342 to value 0"]
impl crate::Resettable for DdrDenaliPhy342Spec {
