#[doc = "Register `DDR_DENALI_PHY_646` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_tsel_enable_1(&mut self) -> PhyAdrTselEnable1W<DdrDenaliPhy646Spec> {
        PhyAdrTselEnable1W::new(self, 8)
    }
    #[doc = "Bits 16:21 - Loopback control bits for address slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_lpbk_control_1(&mut self) -> PhyAdrLpbkControl1W<DdrDenaliPhy646Spec> {
        PhyAdrLpbkControl1W::new(self, 16)
    }
    #[doc = "Bit 24 - adr slice power reduction disable for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_pwr_rdc_disable_1(&mut self) -> PhyAdrPwrRdcDisable1W<DdrDenaliPhy646Spec> {
        PhyAdrPwrRdcDisable1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_646::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_646::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy646Spec;
impl crate::RegisterSpec for DdrDenaliPhy646Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_646::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy646Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_646::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy646Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_646 to value 0"]
impl crate::Resettable for DdrDenaliPhy646Spec {
