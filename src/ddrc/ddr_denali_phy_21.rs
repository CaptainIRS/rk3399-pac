#[doc = "Register `DDR_DENALI_PHY_21` reader"]
pub type R = crate::R<DdrDenaliPhy21Spec>;
#[doc = "Register `DDR_DENALI_PHY_21` writer"]
pub type W = crate::W<DdrDenaliPhy21Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq_enc_obs_select_0(
        &mut self,
    ) -> PhyRddqsDqEncObsSelect0W<DdrDenaliPhy21Spec> {
        PhyRddqsDqEncObsSelect0W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Select value to map the internal write DQ slave delay encoded settings to the accessible write DQ encoded slave delay observation register for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wr_enc_obs_select_0(&mut self) -> PhyWrEncObsSelect0W<DdrDenaliPhy21Spec> {
        PhyWrEncObsSelect0W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Select value to map the internal write DQ/DQS automatic cycle/ half_cycle shift settings to the accessible write DQ/DQS shift observation register for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wr_shift_obs_select_0(&mut self) -> PhyWrShiftObsSelect0W<DdrDenaliPhy21Spec> {
        PhyWrShiftObsSelect0W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Select value to map the internal read entry FIFO read/write pointers to the accessible read entry FIFO pointer observation register for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_fifo_ptr_obs_select_0(&mut self) -> PhyFifoPtrObsSelect0W<DdrDenaliPhy21Spec> {
        PhyFifoPtrObsSelect0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_21::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_21::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy21Spec;
impl crate::RegisterSpec for DdrDenaliPhy21Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_21::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy21Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_21::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy21Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_21 to value 0"]
impl crate::Resettable for DdrDenaliPhy21Spec {
