#[doc = "Register `DDR_DENALI_PHY_67` reader"]
pub type R = crate::R<DdrDenaliPhy67Spec>;
#[doc = "Register `DDR_DENALI_PHY_67` writer"]
pub type W = crate::W<DdrDenaliPhy67Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq6_slave_delay_0(&mut self) -> PhyRddq6SlaveDelay0W<DdrDenaliPhy67Spec> {
        PhyRddq6SlaveDelay0W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQ7 slave delay setting for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq7_slave_delay_0(&mut self) -> PhyRddq7SlaveDelay0W<DdrDenaliPhy67Spec> {
        PhyRddq7SlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_67::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_67::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy67Spec;
impl crate::RegisterSpec for DdrDenaliPhy67Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_67::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy67Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_67::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy67Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_67 to value 0"]
impl crate::Resettable for DdrDenaliPhy67Spec {
