#[doc = "Register `DDR_DENALI_CTL_162` reader"]
pub type R = crate::R<DdrDenaliCtl162Spec>;
#[doc = "Register `DDR_DENALI_CTL_162` writer"]
pub type W = crate::W<DdrDenaliCtl162Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfs_always_write_fsp(&mut self) -> DfsAlwaysWriteFspW<DdrDenaliCtl162Spec> {
        DfsAlwaysWriteFspW::new(self, 0)
    }
    #[doc = "Bit 8 - Indicates that a DFS event caused the FSP mode registers to be updated. Value of 1 means that the FSP mode registers were changed."]
    #[inline(always)]
    #[must_use]
    pub fn fsp_status(&mut self) -> FspStatusW<DdrDenaliCtl162Spec> {
        FspStatusW::new(self, 8)
    }
    #[doc = "Bit 16 - Reports which FSP set the memory is currently using."]
    #[inline(always)]
    #[must_use]
    pub fn fsp_op_current(&mut self) -> FspOpCurrentW<DdrDenaliCtl162Spec> {
        FspOpCurrentW::new(self, 16)
    }
    #[doc = "Bit 24 - Reports which FSP set the memory will target with write commands."]
    #[inline(always)]
    #[must_use]
    pub fn fsp_wr_current(&mut self) -> FspWrCurrentW<DdrDenaliCtl162Spec> {
        FspWrCurrentW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_162::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_162::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl162Spec;
impl crate::RegisterSpec for DdrDenaliCtl162Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_162::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl162Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_162::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl162Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_162 to value 0"]
impl crate::Resettable for DdrDenaliCtl162Spec {
