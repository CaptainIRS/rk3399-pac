#[doc = "Register `DDR_DENALI_CTL_28` reader"]
pub type R = crate::R<DdrDenaliCtl28Spec>;
#[doc = "Register `DDR_DENALI_CTL_28` writer"]
pub type W = crate::W<DdrDenaliCtl28Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ca_default_val_f0(&mut self) -> CaDefaultValF0W<DdrDenaliCtl28Spec> {
        CaDefaultValF0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TRRD value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trrd_f1(&mut self) -> TrrdF1W<DdrDenaliCtl28Spec> {
        TrrdF1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DRAM TRC value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trc_f1(&mut self) -> TrcF1W<DdrDenaliCtl28Spec> {
        TrcF1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - DRAM TRAS_MIN value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tras_min_f1(&mut self) -> TrasMinF1W<DdrDenaliCtl28Spec> {
        TrasMinF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_28::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_28::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl28Spec;
impl crate::RegisterSpec for DdrDenaliCtl28Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_28::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl28Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_28::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl28Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_28 to value 0"]
impl crate::Resettable for DdrDenaliCtl28Spec {
