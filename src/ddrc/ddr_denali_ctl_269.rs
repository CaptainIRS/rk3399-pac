#[doc = "Register `DDR_DENALI_CTL_269` reader"]
pub type R = crate::R<DdrDenaliCtl269Spec>;
#[doc = "Register `DDR_DENALI_CTL_269` writer"]
pub type W = crate::W<DdrDenaliCtl269Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn calvl_high_threshold_f1(&mut self) -> CalvlHighThresholdF1W<DdrDenaliCtl269Spec> {
        CalvlHighThresholdF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - CA training timeout number of long counts until the timeout is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn calvl_timeout_f1(&mut self) -> CalvlTimeoutF1W<DdrDenaliCtl269Spec> {
        CalvlTimeoutF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_269::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_269::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl269Spec;
impl crate::RegisterSpec for DdrDenaliCtl269Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_269::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl269Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_269::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl269Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_269 to value 0"]
impl crate::Resettable for DdrDenaliCtl269Spec {
