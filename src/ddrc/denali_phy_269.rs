#[doc = "Register `DENALI_PHY_269` reader"]
pub type R = crate::R<DenaliPhy269Spec>;
#[doc = "Register `DENALI_PHY_269` writer"]
pub type W = crate::W<DenaliPhy269Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_smpl2_slave_delay_2(&mut self) -> PhyGateSmpl2SlaveDelay2W<DenaliPhy269Spec> {
        PhyGateSmpl2SlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Control the on the fly gate adjustment for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn on_fly_gate_adjust_en_2(&mut self) -> OnFlyGateAdjustEn2W<DenaliPhy269Spec> {
        OnFlyGateAdjustEn2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_269::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_269::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy269Spec;
impl crate::RegisterSpec for DenaliPhy269Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_269::R`](R) reader structure"]
impl crate::Readable for DenaliPhy269Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_269::W`](W) writer structure"]
impl crate::Writable for DenaliPhy269Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_269 to value 0"]
impl crate::Resettable for DenaliPhy269Spec {
