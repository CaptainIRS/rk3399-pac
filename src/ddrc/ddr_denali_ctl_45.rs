#[doc = "Register `DDR_DENALI_CTL_45` reader"]
pub type R = crate::R<DdrDenaliCtl45Spec>;
#[doc = "Register `DDR_DENALI_CTL_45` writer"]
pub type W = crate::W<DdrDenaliCtl45Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trp_ab_f0(&mut self) -> TrpAbF0W<DdrDenaliCtl45Spec> {
        TrpAbF0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TRP all bank value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trp_ab_f1(&mut self) -> TrpAbF1W<DdrDenaliCtl45Spec> {
        TrpAbF1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DRAM TRP all bank value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trp_ab_f2(&mut self) -> TrpAbF2W<DdrDenaliCtl45Spec> {
        TrpAbF2W::new(self, 16)
    }
    #[doc = "Bit 24 - Enable registered DIMM operation of the controller. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn reg_dimm_enable(&mut self) -> RegDimmEnableW<DdrDenaliCtl45Spec> {
        RegDimmEnableW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_45::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_45::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl45Spec;
impl crate::RegisterSpec for DdrDenaliCtl45Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_45::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl45Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_45::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl45Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_45 to value 0"]
impl crate::Resettable for DdrDenaliCtl45Spec {
