#[doc = "Register `DDR_PI_REG_0` reader"]
pub type R = crate::R<DdrPiReg0Spec>;
#[doc = "Register `DDR_PI_REG_0` writer"]
pub type W = crate::W<DdrPiReg0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_start(&mut self) -> PiStartW<DdrPiReg0Spec> {
        PiStartW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the mode of operation of the PI."]
    #[inline(always)]
    #[must_use]
    pub fn pi_dram_class(&mut self) -> PiDramClassW<DdrPiReg0Spec> {
        PiDramClassW::new(self, 8)
    }
}
#[doc = "DDR PHY Independent Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_pi_reg_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_pi_reg_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrPiReg0Spec;
impl crate::RegisterSpec for DdrPiReg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_pi_reg_0::R`](R) reader structure"]
impl crate::Readable for DdrPiReg0Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_pi_reg_0::W`](W) writer structure"]
impl crate::Writable for DdrPiReg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_PI_REG_0 to value 0"]
impl crate::Resettable for DdrPiReg0Spec {
