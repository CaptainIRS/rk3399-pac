#[doc = "Register `DDR_DENALI_CTL_36` reader"]
pub type R = crate::R<DdrDenaliCtl36Spec>;
#[doc = "Register `DDR_DENALI_CTL_36` writer"]
pub type W = crate::W<DdrDenaliCtl36Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tckesr_f1(&mut self) -> TckesrF1W<DdrDenaliCtl36Spec> {
        TckesrF1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TRTP value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trtp_f2(&mut self) -> TrtpF2W<DdrDenaliCtl36Spec> {
        TrtpF2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DRAM TMRD value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tmrd_f2(&mut self) -> TmrdF2W<DdrDenaliCtl36Spec> {
        TmrdF2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - DRAM TMOD value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tmod_f2(&mut self) -> TmodF2W<DdrDenaliCtl36Spec> {
        TmodF2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_36::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_36::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl36Spec;
impl crate::RegisterSpec for DdrDenaliCtl36Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_36::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl36Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_36::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl36Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_36 to value 0"]
impl crate::Resettable for DdrDenaliCtl36Spec {
