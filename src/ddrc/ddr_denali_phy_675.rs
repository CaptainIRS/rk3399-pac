#[doc = "Register `DDR_DENALI_PHY_675` reader"]
pub type R = crate::R<DdrDenaliPhy675Spec>;
#[doc = "Register `DDR_DENALI_PHY_675` writer"]
pub type W = crate::W<DdrDenaliPhy675Spec>;
...
impl W {
    ...
    pub fn phy_adr5_clk_wr_slave_delay_1(
        &mut self,
    ) -> PhyAdr5ClkWrSlaveDelay1W<DdrDenaliPhy675Spec> {
        PhyAdr5ClkWrSlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:19 - Master delay line override settings for address slice 1. Bit (0) enables software half clock mode. Bit (1) is the software half clock mode value. Bit (2) enables software bypass mode. Bit (3) is the software bypass mode value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_sw_master_mode_1(&mut self) -> PhyAdrSwMasterMode1W<DdrDenaliPhy675Spec> {
        PhyAdrSwMasterMode1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_675::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_675::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy675Spec;
impl crate::RegisterSpec for DdrDenaliPhy675Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_675::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy675Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_675::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy675Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_675 to value 0"]
impl crate::Resettable for DdrDenaliPhy675Spec {
