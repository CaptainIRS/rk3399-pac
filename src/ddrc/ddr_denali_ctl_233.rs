#[doc = "Register `DDR_DENALI_CTL_233` reader"]
pub type R = crate::R<DdrDenaliCtl233Spec>;
#[doc = "Register `DDR_DENALI_CTL_233` writer"]
pub type W = crate::W<DdrDenaliCtl233Spec>;
...
impl W {
    ...
    pub fn wrlvl_dfi_promote_threshold_f1(
        &mut self,
    ) -> WrlvlDfiPromoteThresholdF1W<DdrDenaliCtl233Spec> {
        WrlvlDfiPromoteThresholdF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Write leveling normal threshold number of long counts until the normal priority request is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_norm_threshold_f2(&mut self) -> WrlvlNormThresholdF2W<DdrDenaliCtl233Spec> {
        WrlvlNormThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_233::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_233::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl233Spec;
impl crate::RegisterSpec for DdrDenaliCtl233Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_233::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl233Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_233::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl233Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_233 to value 0"]
impl crate::Resettable for DdrDenaliCtl233Spec {
