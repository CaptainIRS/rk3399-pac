#[doc = "Register `DDR_DENALI_CTL_313` reader"]
pub type R = crate::R<DdrDenaliCtl313Spec>;
#[doc = "Register `DDR_DENALI_CTL_313` writer"]
pub type W = crate::W<DdrDenaliCtl313Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn calvl_resp_mask(&mut self) -> CalvlRespMaskW<DdrDenaliCtl313Spec> {
        CalvlRespMaskW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable the MC CA training module. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn calvl_en(&mut self) -> CalvlEnW<DdrDenaliCtl313Spec> {
        CalvlEnW::new(self, 8)
    }
    #[doc = "Bits 24:26 - Defines the DFI tPHY_WRDATA timing parameter (in DFI PHY clocks), the maximum cycles between a dfi_wrdata_en assertion and a dfi_wrdata signal."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_phy_wrdata(&mut self) -> TdfiPhyWrdataW<DdrDenaliCtl313Spec> {
        TdfiPhyWrdataW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_313::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_313::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl313Spec;
impl crate::RegisterSpec for DdrDenaliCtl313Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_313::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl313Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_313::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl313Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_313 to value 0"]
impl crate::Resettable for DdrDenaliCtl313Spec {
