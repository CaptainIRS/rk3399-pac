#[doc = "Register `DDR_PI_REG_110` reader"]
pub type R = crate::R<DdrPiReg110Spec>;
#[doc = "Register `DDR_PI_REG_110` writer"]
pub type W = crate::W<DdrPiReg110Spec>;
...
impl W {
    ...
    pub fn pi_calvl_vref_initial_stepsize(
        &mut self,
    ) -> PiCalvlVrefInitialStepsizeW<DdrPiReg110Spec> {
        PiCalvlVrefInitialStepsizeW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Indicates the adjust step for the Vref(ca) training."]
    #[inline(always)]
    #[must_use]
    pub fn pi_calvl_vref_normal_stepsize(&mut self) -> PiCalvlVrefNormalStepsizeW<DdrPiReg110Spec> {
...
#[doc = "DDR PHY Independent Register 110\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_pi_reg_110::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_pi_reg_110::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrPiReg110Spec;
impl crate::RegisterSpec for DdrPiReg110Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_pi_reg_110::R`](R) reader structure"]
impl crate::Readable for DdrPiReg110Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_pi_reg_110::W`](W) writer structure"]
impl crate::Writable for DdrPiReg110Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_PI_REG_110 to value 0"]
impl crate::Resettable for DdrPiReg110Spec {
