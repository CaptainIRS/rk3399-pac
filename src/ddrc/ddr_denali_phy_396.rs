#[doc = "Register `DDR_DENALI_PHY_396` reader"]
pub type R = crate::R<DdrDenaliPhy396Spec>;
#[doc = "Register `DDR_DENALI_PHY_396` writer"]
pub type W = crate::W<DdrDenaliPhy396Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_lpddr_3(&mut self) -> PhyLpddr3W<DdrDenaliPhy396Spec> {
        PhyLpddr3W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Indicates the type of DRAM for slice 3. Clear to 0 for DDR3 or DDR4, program to 1 for LPDDR3, or program to 2 for LPDDR4."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lpddr_type_3(&mut self) -> PhyLpddrType3W<DdrDenaliPhy396Spec> {
        PhyLpddrType3W::new(self, 8)
    }
    #[doc = "Bits 16:24 - Number of cycles to delay the read DQS gate signal to generate gate1 signal for on the fly read DQS training for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_smpl1_slave_delay_3(
        &mut self,
    ) -> PhyGateSmpl1SlaveDelay3W<DdrDenaliPhy396Spec> {
        PhyGateSmpl1SlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_396::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_396::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy396Spec;
impl crate::RegisterSpec for DdrDenaliPhy396Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_396::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy396Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_396::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy396Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_396 to value 0"]
impl crate::Resettable for DdrDenaliPhy396Spec {
