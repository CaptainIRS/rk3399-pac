#[doc = "Register `DDR_DENALI_CTL_194` reader"]
pub type R = crate::R<DdrDenaliCtl194Spec>;
#[doc = "Register `DDR_DENALI_CTL_194` writer"]
pub type W = crate::W<DdrDenaliCtl194Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rw_same_page_en(&mut self) -> RwSamePageEnW<DdrDenaliCtl194Spec> {
        RwSamePageEnW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable chip select grouping when read/write grouping as a rule for command queue placement. This is only valid when the RW_SAME_EN parameter is set. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn cs_same_en(&mut self) -> CsSameEnW<DdrDenaliCtl194Spec> {
        CsSameEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable splitting of commands to the same chip select from a write to a read command as a rule for command queue placement."]
    #[inline(always)]
    #[must_use]
    pub fn w2r_split_en(&mut self) -> W2rSplitEnW<DdrDenaliCtl194Spec> {
    ...
    pub fn disable_rw_group_w_bnk_conflict(
        &mut self,
    ) -> DisableRwGroupWBnkConflictW<DdrDenaliCtl194Spec> {
        DisableRwGroupWBnkConflictW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_194::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_194::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl194Spec;
impl crate::RegisterSpec for DdrDenaliCtl194Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_194::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl194Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_194::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl194Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_194 to value 0"]
impl crate::Resettable for DdrDenaliCtl194Spec {
