#[doc = "Register `DDR_DENALI_CTL_192` reader"]
pub type R = crate::R<DdrDenaliCtl192Spec>;
#[doc = "Register `DDR_DENALI_CTL_192` writer"]
pub type W = crate::W<DdrDenaliCtl192Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn age_count(&mut self) -> AgeCountW<DdrDenaliCtl192Spec> {
        AgeCountW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Initial value of individual command aging counters for command aging."]
    #[inline(always)]
    #[must_use]
    pub fn command_age_count(&mut self) -> CommandAgeCountW<DdrDenaliCtl192Spec> {
        CommandAgeCountW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable address collision detection as a rule for command queue placement. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn addr_cmp_en(&mut self) -> AddrCmpEnW<DdrDenaliCtl192Spec> {
        AddrCmpEnW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_192::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_192::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl192Spec;
impl crate::RegisterSpec for DdrDenaliCtl192Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_192::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl192Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_192::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl192Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_192 to value 0"]
impl crate::Resettable for DdrDenaliCtl192Spec {
