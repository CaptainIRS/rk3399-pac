#[doc = "Register `DDR_DENALI_CTL_299` reader"]
pub type R = crate::R<DdrDenaliCtl299Spec>;
#[doc = "Register `DDR_DENALI_CTL_299` writer"]
pub type W = crate::W<DdrDenaliCtl299Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_ctrl_delay_f2(&mut self) -> TdfiCtrlDelayF2W<DdrDenaliCtl299Spec> {
        TdfiCtrlDelayF2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the DFI tDRAM_CLK_DISABLE timing parameter (in DFI clocks), the delay between a dfi_dram_clock_disable assertion and the memory clock disable."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_dram_clk_disable(&mut self) -> TdfiDramClkDisableW<DdrDenaliCtl299Spec> {
        TdfiDramClkDisableW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Defines the DFI tDRAM_CLK_ENABLE timing parameter (in DFI clocks), the delay between a dfi_dram_clk_disable de-assertion and the memory clock enable."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_dram_clk_enable(&mut self) -> TdfiDramClkEnableW<DdrDenaliCtl299Spec> {
        TdfiDramClkEnableW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Defines the DFI tWRLVL_EN timing parameter (in DFI clocks), the minimum cycles from a dfi_wrlvl_en assertion to the first dfi_wrlvl_strobe assertion."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_wrlvl_en(&mut self) -> TdfiWrlvlEnW<DdrDenaliCtl299Spec> {
        TdfiWrlvlEnW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_299::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_299::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl299Spec;
impl crate::RegisterSpec for DdrDenaliCtl299Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_299::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl299Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_299::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl299Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_299 to value 0x02"]
impl crate::Resettable for DdrDenaliCtl299Spec {
