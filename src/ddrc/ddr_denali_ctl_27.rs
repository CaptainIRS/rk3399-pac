#[doc = "Register `DDR_DENALI_CTL_27` reader"]
pub type R = crate::R<DdrDenaliCtl27Spec>;
#[doc = "Register `DDR_DENALI_CTL_27` writer"]
pub type W = crate::W<DdrDenaliCtl27Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tras_min_f0(&mut self) -> TrasMinF0W<DdrDenaliCtl27Spec> {
        TrasMinF0W::new(self, 0)
    }
    #[doc = "Bits 8:13 - DRAM TWTR value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn twtr_f0(&mut self) -> TwtrF0W<DdrDenaliCtl27Spec> {
        TwtrF0W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DRAM TRP value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trp_f0(&mut self) -> TrpF0W<DdrDenaliCtl27Spec> {
        TrpF0W::new(self, 16)
    }
    #[doc = "Bits 24:31 - DRAM TFAW value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tfaw_f0(&mut self) -> TfawF0W<DdrDenaliCtl27Spec> {
        TfawF0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_27::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_27::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl27Spec;
impl crate::RegisterSpec for DdrDenaliCtl27Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_27::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl27Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_27::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl27Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_27 to value 0"]
impl crate::Resettable for DdrDenaliCtl27Spec {
