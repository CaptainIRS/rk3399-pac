#[doc = "Register `DDR_DENALI_PHY_08` reader"]
pub type R = crate::R<DdrDenaliPhy08Spec>;
#[doc = "Register `DDR_DENALI_PHY_08` writer"]
pub type W = crate::W<DdrDenaliPhy08Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dbi_mode_0(&mut self) -> PhyDbiMode0W<DdrDenaliPhy08Spec> {
        PhyDbiMode0W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Per-rank CS map for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_rank_cs_map_0(&mut self) -> PhyPerRankCsMap0W<DdrDenaliPhy08Spec> {
    ...
    pub fn phy_per_cs_training_multicast_en_0(
        &mut self,
    ) -> PhyPerCsTrainingMulticastEn0W<DdrDenaliPhy08Spec> {
        PhyPerCsTrainingMulticastEn0W::new(self, 16)
    }
    #[doc = "Bit 24 - For per-rank training, indicates which ranksparamtersareread/ writtenforslice0.'"]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_cs_training_index_0(&mut self) -> PhyPerCsTrainingIndex0W<DdrDenaliPhy08Spec> {
        PhyPerCsTrainingIndex0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_08::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_08::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy08Spec;
impl crate::RegisterSpec for DdrDenaliPhy08Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_08::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy08Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_08::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy08Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_08 to value 0x0001_0000"]
impl crate::Resettable for DdrDenaliPhy08Spec {
