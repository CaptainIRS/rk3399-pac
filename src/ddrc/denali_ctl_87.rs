#[doc = "Register `DENALI_CTL_87` reader"]
pub type R = crate::R<DenaliCtl87Spec>;
#[doc = "Register `DENALI_CTL_87` writer"]
pub type W = crate::W<DenaliCtl87Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phymstr_no_aref(&mut self) -> PhymstrNoArefW<DenaliCtl87Spec> {
        PhymstrNoArefW::new(self, 0)
    }
    #[doc = "Bits 16:31 - MRR temp check number of long counts until the normal priority request is asserted for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn mrr_tempchk_norm_threshold_f0(&mut self) -> MrrTempchkNormThresholdF0W<DenaliCtl87Spec> {
        MrrTempchkNormThresholdF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_87::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_87::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl87Spec;
impl crate::RegisterSpec for DenaliCtl87Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_87::R`](R) reader structure"]
impl crate::Readable for DenaliCtl87Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_87::W`](W) writer structure"]
impl crate::Writable for DenaliCtl87Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_87 to value 0"]
impl crate::Resettable for DenaliCtl87Spec {
