#[doc = "Register `DENALI_PHY_63` reader"]
pub type R = crate::R<DenaliPhy63Spec>;
#[doc = "Register `DENALI_PHY_63` writer"]
pub type W = crate::W<DenaliPhy63Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdm_slave_delay_0(&mut self) -> PhyClkWrdmSlaveDelay0W<DenaliPhy63Spec> {
        PhyClkWrdmSlaveDelay0W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Write clock slave delay setting for DQS for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdqs_slave_delay_0(&mut self) -> PhyClkWrdqsSlaveDelay0W<DenaliPhy63Spec> {
        PhyClkWrdqsSlaveDelay0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_63::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_63::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy63Spec;
impl crate::RegisterSpec for DenaliPhy63Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_63::R`](R) reader structure"]
impl crate::Readable for DenaliPhy63Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_63::W`](W) writer structure"]
impl crate::Writable for DenaliPhy63Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_63 to value 0"]
impl crate::Resettable for DenaliPhy63Spec {
