#[doc = "Register `DDR_DENALI_PHY_02` reader"]
pub type R = crate::R<DdrDenaliPhy02Spec>;
#[doc = "Register `DDR_DENALI_PHY_02` writer"]
pub type W = crate::W<DdrDenaliPhy02Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_gate_bypass_slave_delay_0(
        &mut self,
    ) -> PhyRddqsGateBypassSlaveDelay0W<DdrDenaliPhy02Spec> {
    ...
    pub fn phy_bypass_two_cyc_preamble_0(
        &mut self,
    ) -> PhyBypassTwoCycPreamble0W<DdrDenaliPhy02Spec> {
        PhyBypassTwoCycPreamble0W::new(self, 16)
    }
    #[doc = "Bit 24 - Bypass mode override setting for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_bypass_override_0(&mut self) -> PhyClkBypassOverride0W<DdrDenaliPhy02Spec> {
        PhyClkBypassOverride0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_02::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_02::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy02Spec;
impl crate::RegisterSpec for DdrDenaliPhy02Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_02::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy02Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_02::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy02Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_02 to value 0"]
impl crate::Resettable for DdrDenaliPhy02Spec {
