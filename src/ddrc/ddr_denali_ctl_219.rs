#[doc = "Register `DDR_DENALI_CTL_219` reader"]
pub type R = crate::R<DdrDenaliCtl219Spec>;
#[doc = "Register `DDR_DENALI_CTL_219` writer"]
pub type W = crate::W<DdrDenaliCtl219Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn r2w_diffcs_dly_f2(&mut self) -> R2wDiffcsDlyF2W<DdrDenaliCtl219Spec> {
        R2wDiffcsDlyF2W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Additional delay to insert between writes and reads to different chip selects. Allowed programming dependent on memory system."]
    #[inline(always)]
    #[must_use]
    pub fn w2r_diffcs_dly_f2(&mut self) -> W2rDiffcsDlyF2W<DdrDenaliCtl219Spec> {
        W2rDiffcsDlyF2W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Additional delay to insert between writes to different chip selects. Program to a non-zero value."]
    #[inline(always)]
    #[must_use]
    pub fn w2w_diffcs_dly_f2(&mut self) -> W2wDiffcsDlyF2W<DdrDenaliCtl219Spec> {
        W2wDiffcsDlyF2W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Additional delay to insert between two reads to the same chip select. Any value including 0x0 supported."]
    #[inline(always)]
    #[must_use]
    pub fn r2r_samecs_dly(&mut self) -> R2rSamecsDlyW<DdrDenaliCtl219Spec> {
        R2rSamecsDlyW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_219::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_219::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl219Spec;
impl crate::RegisterSpec for DdrDenaliCtl219Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_219::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl219Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_219::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl219Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_219 to value 0x0001_0101"]
impl crate::Resettable for DdrDenaliCtl219Spec {
