#[doc = "Register `DDR_DENALI_PHY_804` reader"]
pub type R = crate::R<DdrDenaliPhy804Spec>;
#[doc = "Register `DDR_DENALI_PHY_804` writer"]
pub type W = crate::W<DdrDenaliPhy804Spec>;
...
impl W {
    ...
    pub fn phy_adr_master_delay_start_2(
        &mut self,
    ) -> PhyAdrMasterDelayStart2W<DdrDenaliPhy804Spec> {
        PhyAdrMasterDelayStart2W::new(self, 0)
    }
    #[doc = "Bits 16:21 - Incremental step size for master delay line locking algorithm for address slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_master_delay_step_2(&mut self) -> PhyAdrMasterDelayStep2W<DdrDenaliPhy804Spec> {
        PhyAdrMasterDelayStep2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Wait cycles for master delay line locking algorithm for address slice 2. Bits (3:0) is the cycle wait count after a calibration clock setting change. Bits (7:4) is the cycle wait count after a master delay setting change."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_master_delay_wait_2(&mut self) -> PhyAdrMasterDelayWait2W<DdrDenaliPhy804Spec> {
        PhyAdrMasterDelayWait2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_804::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_804::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy804Spec;
impl crate::RegisterSpec for DdrDenaliPhy804Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_804::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy804Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_804::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy804Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_804 to value 0"]
impl crate::Resettable for DdrDenaliPhy804Spec {
