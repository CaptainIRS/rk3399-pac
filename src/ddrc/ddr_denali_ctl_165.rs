#[doc = "Register `DDR_DENALI_CTL_165` reader"]
pub type R = crate::R<DdrDenaliCtl165Spec>;
#[doc = "Register `DDR_DENALI_CTL_165` writer"]
pub type W = crate::W<DdrDenaliCtl165Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aref_max_credit(&mut self) -> ArefMaxCreditW<DdrDenaliCtl165Spec> {
    ...
    pub fn zq_calstart_norm_threshold_f0(
        &mut self,
    ) -> ZqCalstartNormThresholdF0W<DdrDenaliCtl165Spec> {
        ZqCalstartNormThresholdF0W::new(self, 8)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_165::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_165::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl165Spec;
impl crate::RegisterSpec for DdrDenaliCtl165Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_165::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl165Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_165::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl165Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_165 to value 0"]
impl crate::Resettable for DdrDenaliCtl165Spec {
