#[doc = "Register `DENALI_CTL_100` reader"]
pub type R = crate::R<DenaliCtl100Spec>;
#[doc = "Register `DENALI_CTL_100` writer"]
pub type W = crate::W<DenaliCtl100Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpi_wakeup_timeout(&mut self) -> LpiWakeupTimeoutW<DenaliCtl100Spec> {
        LpiWakeupTimeoutW::new(self, 0)
    }
    #[doc = "Bits 16:18 - Defines the DFI tLP_RESP timing parameter (in DFI clocks), the maximum cycles between a dfi_lp_req assertion and a dfi_lp_ack assertion."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_lp_resp(&mut self) -> TdfiLpRespW<DenaliCtl100Spec> {
        TdfiLpRespW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_100::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_100::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl100Spec;
impl crate::RegisterSpec for DenaliCtl100Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_100::R`](R) reader structure"]
impl crate::Readable for DenaliCtl100Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_100::W`](W) writer structure"]
impl crate::Writable for DenaliCtl100Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_100 to value 0x2000_0000"]
impl crate::Resettable for DenaliCtl100Spec {
