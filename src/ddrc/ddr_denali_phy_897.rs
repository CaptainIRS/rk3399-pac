#[doc = "Register `DDR_DENALI_PHY_897` reader"]
pub type R = crate::R<DdrDenaliPhy897Spec>;
#[doc = "Register `DDR_DENALI_PHY_897` writer"]
pub type W = crate::W<DdrDenaliPhy897Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_grp_shift_2(&mut self) -> PhySwGrpShift2W<DdrDenaliPhy897Spec> {
        PhySwGrpShift2W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Address/control group slice 3 manual override of automatic half_cycle_shift/cycle_shift. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bit (3) is the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_grp_shift_3(&mut self) -> PhySwGrpShift3W<DdrDenaliPhy897Spec> {
        PhySwGrpShift3W::new(self, 8)
    }
    #[doc = "Bits 16:26 - Address/control group slice bypass mode slave delay setting."]
    #[inline(always)]
    #[must_use]
    pub fn phy_grp_bypass_slave_delay(&mut self) -> PhyGrpBypassSlaveDelayW<DdrDenaliPhy897Spec> {
        PhyGrpBypassSlaveDelayW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_897::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_897::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy897Spec;
impl crate::RegisterSpec for DdrDenaliPhy897Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_897::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy897Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_897::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy897Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_897 to value 0"]
impl crate::Resettable for DdrDenaliPhy897Spec {
