#[doc = "Register `DDR_DENALI_CTL_17` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfi_inv_data_cs(&mut self) -> DfiInvDataCsW<DdrDenaliCtl17Spec> {
        DfiInvDataCsW::new(self, 8)
    }
    #[doc = "Bit 16 - Disable MRW commands before training during initialization. Set to 1 to disable."]
    #[inline(always)]
    #[must_use]
    pub fn no_mrw_bt_init(&mut self) -> NoMrwBtInitW<DdrDenaliCtl17Spec> {
        NoMrwBtInitW::new(self, 16)
    }
    #[doc = "Bit 24 - Disable MRW commands after training during initialization. Set to 1 to disable."]
    #[inline(always)]
    #[must_use]
    pub fn no_mrw_init(&mut self) -> NoMrwInitW<DdrDenaliCtl17Spec> {
        NoMrwInitW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_17::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_17::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl17Spec;
impl crate::RegisterSpec for DdrDenaliCtl17Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_17::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl17Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_17::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl17Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_17 to value 0"]
impl crate::Resettable for DdrDenaliCtl17Spec {
