...
#[doc = "\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_945::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy945Spec;
impl crate::RegisterSpec for DdrDenaliPhy945Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_945::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy945Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_945 to value 0"]
impl crate::Resettable for DdrDenaliPhy945Spec {
