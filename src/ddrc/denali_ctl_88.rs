#[doc = "Register `DENALI_CTL_88` reader"]
pub type R = crate::R<DenaliCtl88Spec>;
#[doc = "Register `DENALI_CTL_88` writer"]
pub type W = crate::W<DenaliCtl88Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mrr_tempchk_high_threshold_f0(&mut self) -> MrrTempchkHighThresholdF0W<DenaliCtl88Spec> {
        MrrTempchkHighThresholdF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - MRR temp check number of long counts until the timeout is asserted for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn mrr_tempchk_timeout_f0(&mut self) -> MrrTempchkTimeoutF0W<DenaliCtl88Spec> {
        MrrTempchkTimeoutF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_88::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_88::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl88Spec;
impl crate::RegisterSpec for DenaliCtl88Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_88::R`](R) reader structure"]
impl crate::Readable for DenaliCtl88Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_88::W`](W) writer structure"]
impl crate::Writable for DenaliCtl88Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_88 to value 0"]
impl crate::Resettable for DenaliCtl88Spec {
