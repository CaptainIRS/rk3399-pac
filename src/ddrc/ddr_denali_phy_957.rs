#[doc = "Register `DDR_DENALI_PHY_957` reader"]
pub type R = crate::R<DdrDenaliPhy957Spec>;
#[doc = "Register `DDR_DENALI_PHY_957` writer"]
pub type W = crate::W<DdrDenaliPhy957Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_ddl_ac_mode(&mut self) -> PhyDdlAcModeW<DdrDenaliPhy957Spec> {
        PhyDdlAcModeW::new(self, 0)
    }
    #[doc = "Bit 16 - PHY background pad calibration enable"]
    #[inline(always)]
    #[must_use]
    pub fn phy_pad_background_cal(&mut self) -> PhyPadBackgroundCalW<DdrDenaliPhy957Spec> {
        PhyPadBackgroundCalW::new(self, 16)
    }
    #[doc = "Bits 24:25 - PHY DLL reset software interface enable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dll_rst_en(&mut self) -> PhyDllRstEnW<DdrDenaliPhy957Spec> {
        PhyDllRstEnW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_957::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_957::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy957Spec;
impl crate::RegisterSpec for DdrDenaliPhy957Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_957::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy957Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_957::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy957Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_957 to value 0"]
impl crate::Resettable for DdrDenaliPhy957Spec {
