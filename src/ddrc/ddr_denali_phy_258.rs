#[doc = "Register `DDR_DENALI_PHY_258` reader"]
pub type R = crate::R<DdrDenaliPhy258Spec>;
#[doc = "Register `DDR_DENALI_PHY_258` writer"]
pub type W = crate::W<DdrDenaliPhy258Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_gate_bypass_slave_delay_2(
        &mut self,
    ) -> PhyRddqsGateBypassSlaveDelay2W<DdrDenaliPhy258Spec> {
        PhyRddqsGateBypassSlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:17 - PHY two_cycle_preamble for bypass mode for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_bypass_two_cyc_preamble_2(
        &mut self,
    ) -> PhyBypassTwoCycPreamble2W<DdrDenaliPhy258Spec> {
        PhyBypassTwoCycPreamble2W::new(self, 16)
    }
    #[doc = "Bit 24 - Bypass mode override setting for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_bypass_override_2(&mut self) -> PhyClkBypassOverride2W<DdrDenaliPhy258Spec> {
        PhyClkBypassOverride2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_258::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_258::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy258Spec;
impl crate::RegisterSpec for DdrDenaliPhy258Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_258::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy258Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_258::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy258Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_258 to value 0"]
impl crate::Resettable for DdrDenaliPhy258Spec {
