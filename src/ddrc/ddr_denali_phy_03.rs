#[doc = "Register `DDR_DENALI_PHY_03` reader"]
pub type R = crate::R<DdrDenaliPhy03Spec>;
#[doc = "Register `DDR_DENALI_PHY_03` writer"]
pub type W = crate::W<DdrDenaliPhy03Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq0_shift_0(&mut self) -> PhySwWrdq0Shift0W<DdrDenaliPhy03Spec> {
        PhySwWrdq0Shift0W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ1 for slice 0. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq1_shift_0(&mut self) -> PhySwWrdq1Shift0W<DdrDenaliPhy03Spec> {
        PhySwWrdq1Shift0W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ2 for slice 0. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq2_shift_0(&mut self) -> PhySwWrdq2Shift0W<DdrDenaliPhy03Spec> {
        PhySwWrdq2Shift0W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ3 for slice 0. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq3_shift_0(&mut self) -> PhySwWrdq3Shift0W<DdrDenaliPhy03Spec> {
        PhySwWrdq3Shift0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_03::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_03::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy03Spec;
impl crate::RegisterSpec for DdrDenaliPhy03Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_03::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy03Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_03::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy03Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_03 to value 0"]
impl crate::Resettable for DdrDenaliPhy03Spec {
