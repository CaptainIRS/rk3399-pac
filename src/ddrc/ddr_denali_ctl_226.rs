#[doc = "Register `DDR_DENALI_CTL_226` reader"]
pub type R = crate::R<DdrDenaliCtl226Spec>;
#[doc = "Register `DDR_DENALI_CTL_226` writer"]
pub type W = crate::W<DdrDenaliCtl226Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wlmrd(&mut self) -> WlmrdW<DdrDenaliCtl226Spec> {
        WlmrdW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable the MC write leveling module. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_en(&mut self) -> WrlvlEnW<DdrDenaliCtl226Spec> {
        WrlvlEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Specifies the PHY support for DFI write leveling. Set to 1 for supported."]
    #[inline(always)]
    #[must_use]
    pub fn dfi_phy_wrlvl_mode(&mut self) -> DfiPhyWrlvlModeW<DdrDenaliCtl226Spec> {
        DfiPhyWrlvlModeW::new(self, 16)
    }
    #[doc = "Bit 24 - Enables the use of the dfi_lvl_periodic signal during write leveling. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_periodic(&mut self) -> WrlvlPeriodicW<DdrDenaliCtl226Spec> {
        WrlvlPeriodicW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_226::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_226::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl226Spec;
impl crate::RegisterSpec for DdrDenaliCtl226Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_226::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl226Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_226::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl226Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_226 to value 0"]
impl crate::Resettable for DdrDenaliCtl226Spec {
