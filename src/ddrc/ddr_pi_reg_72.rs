...
#[doc = "Field `PI_ODTLON_F2` reader - Defines the latency from a CAS-2 command to the tODTon\n\nreference. The suffix '_f2' of the parameter name is omitted when\n\nin non-DFS mode."]
pub type PiOdtlonF2R = crate::FieldReader;
#[doc = "Field `PI_ODTLON_F2` writer - Defines the latency from a CAS-2 command to the tODTon\n\nreference. The suffix '_f2' of the parameter name is omitted when\n\nin non-DFS mode."]
pub type PiOdtlonF2W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `PI_TODTON_MIN_F2` reader - Defines the point in time when the device termination circuit leaves\n\nHigh-Z and ODT resistance begins to turn on. The suffix '_f2' of the\n\nparameter name is omitted when in non-DFS mode."]
pub type PiTodtonMinF2R = crate::FieldReader;
#[doc = "Field `PI_TODTON_MIN_F2` writer - Defines the point in time when the device termination circuit leaves\n\nHigh-Z and ODT resistance begins to turn on. The suffix '_f2' of the\n\nparameter name is omitted when in non-DFS mode."]
pub type PiTodtonMinF2W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `PI_WR_TO_ODTH_F0` reader - Defines the DRAM Write command to ODT set in cycles. The suffix\n\n'_f0' of the parameter name is omitted when in non-DFS mode."]
pub type PiWrToOdthF0R = crate::FieldReader;
#[doc = "Field `PI_WR_TO_ODTH_F0` writer - Defines the DRAM Write command to ODT set in cycles. The suffix\n\n'_f0' of the parameter name is omitted when in non-DFS mode."]
pub type PiWrToOdthF0W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `PI_WR_TO_ODTH_F1` reader - Defines the DRAM Write command to ODT set in cycles. The suffix\n\n'_f1' of the parameter name is omitted when in non-DFS mode."]
pub type PiWrToOdthF1R = crate::FieldReader;
#[doc = "Field `PI_WR_TO_ODTH_F1` writer - Defines the DRAM Write command to ODT set in cycles. The suffix\n\n'_f1' of the parameter name is omitted when in non-DFS mode."]
...
impl R {
    ...
    #[doc = "Bits 16:21 - Defines the DRAM Write command to ODT set in cycles. The suffix\n\n'_f0' of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    pub fn pi_wr_to_odth_f0(&self) -> PiWrToOdthF0R {
        PiWrToOdthF0R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bits 24:29 - Defines the DRAM Write command to ODT set in cycles. The suffix\n\n'_f1' of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
