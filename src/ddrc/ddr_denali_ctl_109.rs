#[doc = "Register `DDR_DENALI_CTL_109` reader"]
pub type R = crate::R<DdrDenaliCtl109Spec>;
#[doc = "Register `DDR_DENALI_CTL_109` writer"]
pub type W = crate::W<DdrDenaliCtl109Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_init_start_f0(&mut self) -> TdfiInitStartF0W<DdrDenaliCtl109Spec> {
        TdfiInitStartF0W::new(self, 0)
    }
    #[doc = "Bits 8:23 - Defines the DFI tINIT_COMPLETE timing parameter (in DFI clocks) for frequency copy 0, the maximum cycles between a dfi_init_start de- assertion and a dfi_init_complete assertion from the PHY."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_init_complete_f0(&mut self) -> TdfiInitCompleteF0W<DdrDenaliCtl109Spec> {
        TdfiInitCompleteF0W::new(self, 8)
    }
    #[doc = "Bits 24:31 - Defines the DFI tINIT_START timing parameter (in DFI clocks) for frequency copy 1, the maximum number of cycles between a dfi_init_start assertion and a dfi_init_complete de-assertion from the PHY."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_init_start_f1(&mut self) -> TdfiInitStartF1W<DdrDenaliCtl109Spec> {
        TdfiInitStartF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_109::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_109::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl109Spec;
impl crate::RegisterSpec for DdrDenaliCtl109Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_109::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl109Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_109::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl109Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_109 to value 0"]
impl crate::Resettable for DdrDenaliCtl109Spec {
