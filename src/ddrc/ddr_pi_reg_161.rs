...
#[doc = "Field `PI_TMOD_F0` reader - Indicates TMOD value in cycles. The suffix '_f0' of the parameter\n\nname is omitted when in non-DFS mode."]
pub type PiTmodF0R = crate::FieldReader;
#[doc = "Field `PI_TMOD_F0` writer - Indicates TMOD value in cycles. The suffix '_f0' of the parameter\n\nname is omitted when in non-DFS mode."]
pub type PiTmodF0W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `PI_TRTP_F1` reader - Indicates DRAM TRTP value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
pub type PiTrtpF1R = crate::FieldReader;
#[doc = "Field `PI_TRTP_F1` writer - Indicates DRAM TRTP value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
pub type PiTrtpF1W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `PI_TRP_F1` reader - Indicates DRAM TRP value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
pub type PiTrpF1R = crate::FieldReader;
#[doc = "Field `PI_TRP_F1` writer - Indicates DRAM TRP value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
pub type PiTrpF1W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `PI_TRCD_F1` reader - Indicates DRAM TRCD value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
pub type PiTrcdF1R = crate::FieldReader;
#[doc = "Field `PI_TRCD_F1` writer - Indicates DRAM TRCD value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
pub type PiTrcdF1W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Indicates TMOD value in cycles. The suffix '_f0' of the parameter\n\nname is omitted when in non-DFS mode."]
    #[inline(always)]
    pub fn pi_tmod_f0(&self) -> PiTmodF0R {
        PiTmodF0R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Indicates DRAM TRTP value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    pub fn pi_trtp_f1(&self) -> PiTrtpF1R {
        PiTrtpF1R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Indicates DRAM TRP value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    pub fn pi_trp_f1(&self) -> PiTrpF1R {
        PiTrpF1R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Indicates DRAM TRCD value in cycles. The suffix '_f1' of the\n\nparameter name is omitted when in non-DFS mode."]
    #[inline(always)]
