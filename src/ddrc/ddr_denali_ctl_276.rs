#[doc = "Register `DDR_DENALI_CTL_276` reader"]
pub type R = crate::R<DdrDenaliCtl276Spec>;
#[doc = "Register `DDR_DENALI_CTL_276` writer"]
pub type W = crate::W<DdrDenaliCtl276Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_phy_rdlat_f2(&mut self) -> TdfiPhyRdlatF2W<DdrDenaliCtl276Spec> {
        TdfiPhyRdlatF2W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Set value for the dfi_dram_clk_disable signal. Bit (0) controls cs0, bit (1) controls cs1, etc. Set each bit to 1 to disable."]
    #[inline(always)]
    #[must_use]
    pub fn dram_clk_disable(&mut self) -> DramClkDisableW<DdrDenaliCtl276Spec> {
        DramClkDisableW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Reports the DFI tCTRLUPD_MIN timing parameter (in DFI clocks), the minimum cycles that dfi_ctrlupd_req must be asserted."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_ctrlupd_min(&mut self) -> TdfiCtrlupdMinW<DdrDenaliCtl276Spec> {
        TdfiCtrlupdMinW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_276::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_276::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl276Spec;
impl crate::RegisterSpec for DdrDenaliCtl276Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_276::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl276Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_276::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl276Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_276 to value 0x06"]
impl crate::Resettable for DdrDenaliCtl276Spec {
