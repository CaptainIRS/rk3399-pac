#[doc = "Register `DDR_DENALI_CTL_245` reader"]
pub type R = crate::R<DdrDenaliCtl245Spec>;
#[doc = "Register `DDR_DENALI_CTL_245` writer"]
pub type W = crate::W<DdrDenaliCtl245Spec>;
...
impl W {
    ...
    pub fn rdlvl_gate_dfi_promote_threshold_f0(
        &mut self,
    ) -> RdlvlGateDfiPromoteThresholdF0W<DdrDenaliCtl245Spec> {
        RdlvlGateDfiPromoteThresholdF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Read leveling normal threshold number of long counts until the normal priority request is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_norm_threshold_f1(&mut self) -> RdlvlNormThresholdF1W<DdrDenaliCtl245Spec> {
        RdlvlNormThresholdF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_245::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_245::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl245Spec;
impl crate::RegisterSpec for DdrDenaliCtl245Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_245::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl245Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_245::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl245Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_245 to value 0"]
impl crate::Resettable for DdrDenaliCtl245Spec {
