#[doc = "Register `DDR_DENALI_CTL_172` reader"]
pub type R = crate::R<DdrDenaliCtl172Spec>;
#[doc = "Register `DDR_DENALI_CTL_172` writer"]
pub type W = crate::W<DdrDenaliCtl172Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zq_cs_high_threshold_f1(&mut self) -> ZqCsHighThresholdF1W<DdrDenaliCtl172Spec> {
        ZqCsHighThresholdF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - ZQ START number of long counts until the timeout is asserted for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn zq_calstart_timeout_f1(&mut self) -> ZqCalstartTimeoutF1W<DdrDenaliCtl172Spec> {
        ZqCalstartTimeoutF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_172::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_172::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl172Spec;
impl crate::RegisterSpec for DdrDenaliCtl172Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_172::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl172Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_172::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl172Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_172 to value 0"]
impl crate::Resettable for DdrDenaliCtl172Spec {
