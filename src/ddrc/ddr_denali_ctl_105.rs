#[doc = "Register `DDR_DENALI_CTL_105` reader"]
pub type R = crate::R<DdrDenaliCtl105Spec>;
#[doc = "Register `DDR_DENALI_CTL_105` writer"]
pub type W = crate::W<DdrDenaliCtl105Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpc_promote_threshold_f0(&mut self) -> LpcPromoteThresholdF0W<DdrDenaliCtl105Spec> {
        LpcPromoteThresholdF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - LPC promotion number of long counts until the high priority request is asserted for frequency copy 1. Applies to SW and auto low power commands."]
    #[inline(always)]
    #[must_use]
    pub fn lpc_promote_threshold_f1(&mut self) -> LpcPromoteThresholdF1W<DdrDenaliCtl105Spec> {
        LpcPromoteThresholdF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_105::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_105::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl105Spec;
impl crate::RegisterSpec for DdrDenaliCtl105Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_105::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl105Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_105::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl105Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_105 to value 0"]
impl crate::Resettable for DdrDenaliCtl105Spec {
