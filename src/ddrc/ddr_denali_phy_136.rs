#[doc = "Register `DDR_DENALI_PHY_136` reader"]
pub type R = crate::R<DdrDenaliPhy136Spec>;
#[doc = "Register `DDR_DENALI_PHY_136` writer"]
pub type W = crate::W<DdrDenaliPhy136Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dbi_mode_1(&mut self) -> PhyDbiMode1W<DdrDenaliPhy136Spec> {
        PhyDbiMode1W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Per-rank CS map for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_rank_cs_map_1(&mut self) -> PhyPerRankCsMap1W<DdrDenaliPhy136Spec> {
    ...
    pub fn phy_per_cs_training_multicast_en_1(
        &mut self,
    ) -> PhyPerCsTrainingMulticastEn1W<DdrDenaliPhy136Spec> {
        PhyPerCsTrainingMulticastEn1W::new(self, 16)
    }
    #[doc = "Bit 24 - For per-rank training, indicates which ranksparamtersareread/ writtenforslice1.'"]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_cs_training_index_1(&mut self) -> PhyPerCsTrainingIndex1W<DdrDenaliPhy136Spec> {
        PhyPerCsTrainingIndex1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_136::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_136::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy136Spec;
impl crate::RegisterSpec for DdrDenaliPhy136Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_136::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy136Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_136::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy136Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_136 to value 0x0001_0000"]
impl crate::Resettable for DdrDenaliPhy136Spec {
