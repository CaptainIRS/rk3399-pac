#[doc = "Register `DDR_DENALI_PHY_212` reader"]
pub type R = crate::R<DdrDenaliPhy212Spec>;
#[doc = "Register `DDR_DENALI_PHY_212` writer"]
pub type W = crate::W<DdrDenaliPhy212Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_tsel_rd_timing_1(&mut self) -> PhyDqsTselRdTiming1W<DdrDenaliPhy212Spec> {
        PhyDqsTselRdTiming1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Start/end timing values for DQS write based termination enable and select signals for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_tsel_wr_timing_1(&mut self) -> PhyDqsTselWrTiming1W<DdrDenaliPhy212Spec> {
        PhyDqsTselWrTiming1W::new(self, 8)
    }
    #[doc = "Bit 16 - Enables the per-rank training and read/write timing capabilities. Must have same value in all slices."]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_cs_training_en_1(&mut self) -> PhyPerCsTrainingEn1W<DdrDenaliPhy212Spec> {
        PhyPerCsTrainingEn1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Start/end timing values for DQ/DM input enable signals for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_ie_timing_1(&mut self) -> PhyDqIeTiming1W<DdrDenaliPhy212Spec> {
        PhyDqIeTiming1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_212::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_212::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy212Spec;
impl crate::RegisterSpec for DdrDenaliPhy212Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_212::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy212Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_212::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy212Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_212 to value 0"]
impl crate::Resettable for DdrDenaliPhy212Spec {
