#[doc = "Register `DDR_DENALI_PHY_386` reader"]
pub type R = crate::R<DdrDenaliPhy386Spec>;
#[doc = "Register `DDR_DENALI_PHY_386` writer"]
pub type W = crate::W<DdrDenaliPhy386Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_gate_bypass_slave_delay_3(
        &mut self,
    ) -> PhyRddqsGateBypassSlaveDelay3W<DdrDenaliPhy386Spec> {
        PhyRddqsGateBypassSlaveDelay3W::new(self, 0)
    }
    #[doc = "Bits 16:17 - PHY two_cycle_preamble for bypass mode for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_bypass_two_cyc_preamble_3(
        &mut self,
    ) -> PhyBypassTwoCycPreamble3W<DdrDenaliPhy386Spec> {
        PhyBypassTwoCycPreamble3W::new(self, 16)
    }
    #[doc = "Bit 24 - Bypass mode override setting for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_bypass_override_3(&mut self) -> PhyClkBypassOverride3W<DdrDenaliPhy386Spec> {
        PhyClkBypassOverride3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_386::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_386::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy386Spec;
impl crate::RegisterSpec for DdrDenaliPhy386Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_386::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy386Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_386::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy386Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_386 to value 0"]
impl crate::Resettable for DdrDenaliPhy386Spec {
