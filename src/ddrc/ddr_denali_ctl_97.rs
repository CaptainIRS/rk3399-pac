#[doc = "Register `DDR_DENALI_CTL_97` reader"]
pub type R = crate::R<DdrDenaliCtl97Spec>;
#[doc = "Register `DDR_DENALI_CTL_97` writer"]
pub type W = crate::W<DdrDenaliCtl97Spec>;
...
impl W {
    ...
    pub fn lpi_srpd_deep_mcclk_gate_wakeup_f1(
        &mut self,
    ) -> LpiSrpdDeepMcclkGateWakeupF1W<DdrDenaliCtl97Spec> {
        LpiSrpdDeepMcclkGateWakeupF1W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when the LPI timer expires for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_timer_wakeup_f1(&mut self) -> LpiTimerWakeupF1W<DdrDenaliCtl97Spec> {
        LpiTimerWakeupF1W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when memory is in power-down for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_pd_wakeup_f2(&mut self) -> LpiPdWakeupF2W<DdrDenaliCtl97Spec> {
        LpiPdWakeupF2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when memory is in self- refresh for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_sr_wakeup_f2(&mut self) -> LpiSrWakeupF2W<DdrDenaliCtl97Spec> {
        LpiSrWakeupF2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_97::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_97::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl97Spec;
impl crate::RegisterSpec for DdrDenaliCtl97Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_97::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl97Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_97::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl97Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_97 to value 0"]
impl crate::Resettable for DdrDenaliCtl97Spec {
