#[doc = "Register `DDR_DENALI_CTL_150` reader"]
pub type R = crate::R<DdrDenaliCtl150Spec>;
#[doc = "Register `DDR_DENALI_CTL_150` writer"]
pub type W = crate::W<DdrDenaliCtl150Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr0_data_f2_1(&mut self) -> Mr0DataF2_1W<DdrDenaliCtl150Spec> {
        Mr0DataF2_1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 1 for chip select 1 for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn mr1_data_f2_1(&mut self) -> Mr1DataF2_1W<DdrDenaliCtl150Spec> {
        Mr1DataF2_1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_150::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_150::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl150Spec;
impl crate::RegisterSpec for DdrDenaliCtl150Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_150::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl150Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_150::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl150Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_150 to value 0"]
impl crate::Resettable for DdrDenaliCtl150Spec {
