#[doc = "Register `DDR_DENALI_PHY_642` reader"]
pub type R = crate::R<DdrDenaliPhy642Spec>;
#[doc = "Register `DDR_DENALI_PHY_642` writer"]
pub type W = crate::W<DdrDenaliPhy642Spec>;
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_642::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_642::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy642Spec;
impl crate::RegisterSpec for DdrDenaliPhy642Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_642::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy642Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_642::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy642Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_642 to value 0"]
impl crate::Resettable for DdrDenaliPhy642Spec {
