#[doc = "Register `DDR_DENALI_PHY_421` reader"]
pub type R = crate::R<DdrDenaliPhy421Spec>;
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_421::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy421Spec;
impl crate::RegisterSpec for DdrDenaliPhy421Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_421::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy421Spec {}
#[doc = "`reset()` method sets DDR_DENALI_PHY_421 to value 0"]
impl crate::Resettable for DdrDenaliPhy421Spec {
