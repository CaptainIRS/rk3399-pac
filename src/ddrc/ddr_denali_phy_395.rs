#[doc = "Register `DDR_DENALI_PHY_395` reader"]
pub type R = crate::R<DdrDenaliPhy395Spec>;
#[doc = "Register `DDR_DENALI_PHY_395` writer"]
pub type W = crate::W<DdrDenaliPhy395Spec>;
...
#[doc = "Field `SC_PHY_SNAP_OBS_REGS_3` writer - Initiates a snapshot of the internal observation registers for slice 3. Set to 1 to trigger. WRITE-ONLY"]
...
impl W {
    ...
    pub fn phy_rddqs_dq_bypass_slave_delay_3(
        &mut self,
    ) -> PhyRddqsDqBypassSlaveDelay3W<DdrDenaliPhy395Spec> {
        PhyRddqsDqBypassSlaveDelay3W::new(self, 0)
    }
    #[doc = "Bits 16:20 - Number of cycles to wait for the DQS gate to close before flagging an error for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_error_delay_select_3(
        &mut self,
    ) -> PhyGateErrorDelaySelect3W<DdrDenaliPhy395Spec> {
        PhyGateErrorDelaySelect3W::new(self, 16)
    }
    #[doc = "Bit 24 - Initiates a snapshot of the internal observation registers for slice 3. Set to 1 to trigger. WRITE-ONLY"]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_snap_obs_regs_3(&mut self) -> ScPhySnapObsRegs3W<DdrDenaliPhy395Spec> {
        ScPhySnapObsRegs3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_395::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_395::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy395Spec;
impl crate::RegisterSpec for DdrDenaliPhy395Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_395::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy395Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_395::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy395Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_395 to value 0"]
impl crate::Resettable for DdrDenaliPhy395Spec {
