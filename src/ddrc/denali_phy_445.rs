#[doc = "Register `DENALI_PHY_445` reader"]
pub type R = crate::R<DenaliPhy445Spec>;
#[doc = "Register `DENALI_PHY_445` writer"]
pub type W = crate::W<DenaliPhy445Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq4_slave_delay_3(&mut self) -> PhyClkWrdq4SlaveDelay3W<DenaliPhy445Spec> {
        PhyClkWrdq4SlaveDelay3W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ5 for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq5_slave_delay_3(&mut self) -> PhyClkWrdq5SlaveDelay3W<DenaliPhy445Spec> {
        PhyClkWrdq5SlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_445::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_445::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy445Spec;
impl crate::RegisterSpec for DenaliPhy445Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_445::R`](R) reader structure"]
impl crate::Readable for DenaliPhy445Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_445::W`](W) writer structure"]
impl crate::Writable for DenaliPhy445Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_445 to value 0"]
impl crate::Resettable for DenaliPhy445Spec {
