#[doc = "Register `DDR_DENALI_CTL_190` reader"]
pub type R = crate::R<DdrDenaliCtl190Spec>;
#[doc = "Register `DDR_DENALI_CTL_190` writer"]
pub type W = crate::W<DdrDenaliCtl190Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zq_cal_start_map_1(&mut self) -> ZqCalStartMap1W<DdrDenaliCtl190Spec> {
        ZqCalStartMap1W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Defines which chip select(s) will receive ZQ calibration latch commands simultaneously on iteration 1 of the ZQ LATCH initialization and periodic command sequences. Clear to all zeros for no ZQ LATCH commands."]
    #[inline(always)]
    #[must_use]
    pub fn zq_cal_latch_map_1(&mut self) -> ZqCalLatchMap1W<DdrDenaliCtl190Spec> {
        ZqCalLatchMap1W::new(self, 8)
    }
    #[doc = "Bits 16:17 - Encoded number of banks on the DRAM(s)."]
    #[inline(always)]
    #[must_use]
    pub fn bank_diff(&mut self) -> BankDiffW<DdrDenaliCtl190Spec> {
        BankDiffW::new(self, 16)
    }
    #[doc = "Bits 24:26 - Difference between number of address pins available and number being used."]
    #[inline(always)]
    #[must_use]
    pub fn row_diff(&mut self) -> RowDiffW<DdrDenaliCtl190Spec> {
        RowDiffW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_190::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_190::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl190Spec;
impl crate::RegisterSpec for DdrDenaliCtl190Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_190::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl190Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_190::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl190Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_190 to value 0x0202"]
impl crate::Resettable for DdrDenaliCtl190Spec {
