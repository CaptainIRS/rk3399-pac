#[doc = "Register `DDR_DENALI_CTL_154` reader"]
pub type R = crate::R<DdrDenaliCtl154Spec>;
#[doc = "Register `DDR_DENALI_CTL_154` writer"]
pub type W = crate::W<DdrDenaliCtl154Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr11_data_f1_1(&mut self) -> Mr11DataF1_1W<DdrDenaliCtl154Spec> {
        Mr11DataF1_1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data to program into memory mode register 11 for chip select 1 for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn mr11_data_f2_1(&mut self) -> Mr11DataF2_1W<DdrDenaliCtl154Spec> {
        Mr11DataF2_1W::new(self, 8)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 12 for chip select 1."]
    #[inline(always)]
    #[must_use]
    pub fn mr12_data_f0_1(&mut self) -> Mr12DataF0_1W<DdrDenaliCtl154Spec> {
        Mr12DataF0_1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_154::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_154::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl154Spec;
impl crate::RegisterSpec for DdrDenaliCtl154Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_154::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl154Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_154::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl154Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_154 to value 0"]
impl crate::Resettable for DdrDenaliCtl154Spec {
