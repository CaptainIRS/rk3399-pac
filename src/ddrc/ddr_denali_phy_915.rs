#[doc = "Register `DDR_DENALI_PHY_915` reader"]
pub type R = crate::R<DdrDenaliPhy915Spec>;
#[doc = "Register `DDR_DENALI_PHY_915` writer"]
pub type W = crate::W<DdrDenaliPhy915Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_pad_vref_ctrl_dq_3(&mut self) -> PhyPadVrefCtrlDq3W<DdrDenaliPhy915Spec> {
        PhyPadVrefCtrlDq3W::new(self, 0)
    }
    #[doc = "Bits 16:27 - Pad VREF control settings for the address/control."]
    #[inline(always)]
    #[must_use]
    pub fn phy_pad_vref_ctrl_ac(&mut self) -> PhyPadVrefCtrlAcW<DdrDenaliPhy915Spec> {
        PhyPadVrefCtrlAcW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_915::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_915::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy915Spec;
impl crate::RegisterSpec for DdrDenaliPhy915Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_915::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy915Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_915::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy915Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_915 to value 0"]
impl crate::Resettable for DdrDenaliPhy915Spec {
