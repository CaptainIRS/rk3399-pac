#[doc = "Register `DDR_DENALI_CTL_77` reader"]
pub type R = crate::R<DdrDenaliCtl77Spec>;
#[doc = "Register `DDR_DENALI_CTL_77` writer"]
pub type W = crate::W<DdrDenaliCtl77Spec>;
...
impl W {
    ...
    pub fn upd_phyupd_dfi_promote_threshold_f0(
        &mut self,
    ) -> UpdPhyupdDfiPromoteThresholdF0W<DdrDenaliCtl77Spec> {
    ...
    pub fn upd_ctrlupd_norm_threshold_f1(
        &mut self,
    ) -> UpdCtrlupdNormThresholdF1W<DdrDenaliCtl77Spec> {
        UpdCtrlupdNormThresholdF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_77::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_77::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl77Spec;
impl crate::RegisterSpec for DdrDenaliCtl77Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_77::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl77Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_77::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl77Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_77 to value 0"]
impl crate::Resettable for DdrDenaliCtl77Spec {
