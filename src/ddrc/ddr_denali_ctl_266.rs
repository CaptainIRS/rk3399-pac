#[doc = "Register `DDR_DENALI_CTL_266` reader"]
pub type R = crate::R<DdrDenaliCtl266Spec>;
#[doc = "Register `DDR_DENALI_CTL_266` writer"]
pub type W = crate::W<DdrDenaliCtl266Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn calvl_norm_threshold_f0(&mut self) -> CalvlNormThresholdF0W<DdrDenaliCtl266Spec> {
        CalvlNormThresholdF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - CA training high threshold number of long counts until the high priority request is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn calvl_high_threshold_f0(&mut self) -> CalvlHighThresholdF0W<DdrDenaliCtl266Spec> {
        CalvlHighThresholdF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_266::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_266::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl266Spec;
impl crate::RegisterSpec for DdrDenaliCtl266Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_266::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl266Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_266::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl266Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_266 to value 0"]
impl crate::Resettable for DdrDenaliCtl266Spec {
