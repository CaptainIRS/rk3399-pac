#[doc = "Register `DDR_DENALI_PHY_444` reader"]
pub type R = crate::R<DdrDenaliPhy444Spec>;
#[doc = "Register `DDR_DENALI_PHY_444` writer"]
pub type W = crate::W<DdrDenaliPhy444Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq2_slave_delay_3(&mut self) -> PhyClkWrdq2SlaveDelay3W<DdrDenaliPhy444Spec> {
        PhyClkWrdq2SlaveDelay3W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ3 for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq3_slave_delay_3(&mut self) -> PhyClkWrdq3SlaveDelay3W<DdrDenaliPhy444Spec> {
        PhyClkWrdq3SlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_444::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_444::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy444Spec;
impl crate::RegisterSpec for DdrDenaliPhy444Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_444::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy444Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_444::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy444Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_444 to value 0"]
impl crate::Resettable for DdrDenaliPhy444Spec {
