#[doc = "Register `DDR_DENALI_CTL_218` reader"]
pub type R = crate::R<DdrDenaliCtl218Spec>;
#[doc = "Register `DDR_DENALI_CTL_218` writer"]
pub type W = crate::W<DdrDenaliCtl218Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn r2w_diffcs_dly_f1(&mut self) -> R2wDiffcsDlyF1W<DdrDenaliCtl218Spec> {
        R2wDiffcsDlyF1W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Additional delay to insert between writes and reads to different chip selects. Allowed programming dependent on memory system."]
    #[inline(always)]
    #[must_use]
    pub fn w2r_diffcs_dly_f1(&mut self) -> W2rDiffcsDlyF1W<DdrDenaliCtl218Spec> {
        W2rDiffcsDlyF1W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Additional delay to insert between writes to different chip selects. Program to a non-zero value."]
    #[inline(always)]
    #[must_use]
    pub fn w2w_diffcs_dly_f1(&mut self) -> W2wDiffcsDlyF1W<DdrDenaliCtl218Spec> {
        W2wDiffcsDlyF1W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Additional delay to insert between reads to different chip selects. Allowed programming dependent on memory system."]
    #[inline(always)]
    #[must_use]
    pub fn r2r_diffcs_dly_f2(&mut self) -> R2rDiffcsDlyF2W<DdrDenaliCtl218Spec> {
        R2rDiffcsDlyF2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_218::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_218::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl218Spec;
impl crate::RegisterSpec for DdrDenaliCtl218Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_218::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl218Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_218::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl218Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_218 to value 0x0101_0101"]
impl crate::Resettable for DdrDenaliCtl218Spec {
