#[doc = "Register `DDR_DENALI_PHY_42` reader"]
pub type R = crate::R<DdrDenaliPhy42Spec>;
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_42::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy42Spec;
impl crate::RegisterSpec for DdrDenaliPhy42Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_42::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy42Spec {}
#[doc = "`reset()` method sets DDR_DENALI_PHY_42 to value 0"]
impl crate::Resettable for DdrDenaliPhy42Spec {
