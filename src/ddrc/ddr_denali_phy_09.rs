#[doc = "Register `DDR_DENALI_PHY_09` reader"]
pub type R = crate::R<DdrDenaliPhy09Spec>;
#[doc = "Register `DDR_DENALI_PHY_09` writer"]
pub type W = crate::W<DdrDenaliPhy09Spec>;
...
impl W {
    ...
    pub fn phy_lp4_boot_rddata_en_ie_dly_0(
        &mut self,
    ) -> PhyLp4BootRddataEnIeDly0W<DdrDenaliPhy09Spec> {
        PhyLp4BootRddataEnIeDly0W::new(self, 0)
    }
    #[doc = "Bits 8:11 - For LPDDR4 boot frequency, the number of cycles that the dfi_rddata_en signal is early for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lp4_boot_rddata_en_dly_0(&mut self) -> PhyLp4BootRddataEnDly0W<DdrDenaliPhy09Spec> {
    ...
    pub fn phy_lp4_boot_rddata_en_tsel_dly_0(
        &mut self,
    ) -> PhyLp4BootRddataEnTselDly0W<DdrDenaliPhy09Spec> {
        PhyLp4BootRddataEnTselDly0W::new(self, 16)
    }
    #[doc = "Bits 24:27 - For LPDDR4 boot frequency, the offset in cycles from the dfi_rddata_en signal to release data from the entry FIFO for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lp4_boot_rptr_update_0(&mut self) -> PhyLp4BootRptrUpdate0W<DdrDenaliPhy09Spec> {
        PhyLp4BootRptrUpdate0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_09::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_09::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy09Spec;
impl crate::RegisterSpec for DdrDenaliPhy09Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_09::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy09Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_09::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy09Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_09 to value 0"]
impl crate::Resettable for DdrDenaliPhy09Spec {
