#[doc = "Register `DDR_DENALI_CTL_144` reader"]
pub type R = crate::R<DdrDenaliCtl144Spec>;
#[doc = "Register `DDR_DENALI_CTL_144` writer"]
pub type W = crate::W<DdrDenaliCtl144Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr_fsp_data_valid_f0_0(&mut self) -> MrFspDataValidF0_0W<DdrDenaliCtl144Spec> {
        MrFspDataValidF0_0W::new(self, 0)
    }
    #[doc = "Bit 8 - Indicates that, at this frequency, memory was trained and the associated data has been loaded into the MRx_DATA parameter(s). Value of 1 means memory was trained."]
    #[inline(always)]
    #[must_use]
    pub fn mr_fsp_data_valid_f1_0(&mut self) -> MrFspDataValidF1_0W<DdrDenaliCtl144Spec> {
        MrFspDataValidF1_0W::new(self, 8)
    }
    #[doc = "Bit 16 - Indicates that, at this frequency, memory was trained and the associated data has been loaded into the MRx_DATA parameter(s). Value of 1 means memory was trained."]
    #[inline(always)]
    #[must_use]
    pub fn mr_fsp_data_valid_f2_0(&mut self) -> MrFspDataValidF2_0W<DdrDenaliCtl144Spec> {
        MrFspDataValidF2_0W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data to program into memory mode register 16 for chip select 0."]
    #[inline(always)]
    #[must_use]
    pub fn mr16_data_0(&mut self) -> Mr16Data0W<DdrDenaliCtl144Spec> {
        Mr16Data0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_144::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_144::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl144Spec;
impl crate::RegisterSpec for DdrDenaliCtl144Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_144::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl144Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_144::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl144Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_144 to value 0"]
impl crate::Resettable for DdrDenaliCtl144Spec {
