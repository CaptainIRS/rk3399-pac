#[doc = "Register `DDR_DENALI_PHY_78` reader"]
pub type R = crate::R<DdrDenaliPhy78Spec>;
#[doc = "Register `DDR_DENALI_PHY_78` writer"]
pub type W = crate::W<DdrDenaliPhy78Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddqs_latency_adjust_0(&mut self) -> PhyRddqsLatencyAdjust0W<DdrDenaliPhy78Spec> {
        PhyRddqsLatencyAdjust0W::new(self, 0)
    }
    #[doc = "Bits 8:10 - Number of cycles to delay the incoming dfi_wrdata_en/dfi_wrdata signals for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_write_path_lat_add_0(&mut self) -> PhyWritePathLatAdd0W<DdrDenaliPhy78Spec> {
    ...
    pub fn phy_wrlvl_delay_early_threshold_0(
        &mut self,
    ) -> PhyWrlvlDelayEarlyThreshold0W<DdrDenaliPhy78Spec> {
        PhyWrlvlDelayEarlyThreshold0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_78::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_78::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy78Spec;
impl crate::RegisterSpec for DdrDenaliPhy78Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_78::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy78Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_78::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy78Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_78 to value 0"]
impl crate::Resettable for DdrDenaliPhy78Spec {
