#[doc = "Register `DDR_DENALI_PHY_394` reader"]
pub type R = crate::R<DdrDenaliPhy394Spec>;
#[doc = "Register `DDR_DENALI_PHY_394` writer"]
pub type W = crate::W<DdrDenaliPhy394Spec>;
...
impl W {
    ...
    pub fn phy_lp4_boot_rddqs_latency_adjust_3(
        &mut self,
    ) -> PhyLp4BootRddqsLatencyAdjust3W<DdrDenaliPhy394Spec> {
        PhyLp4BootRddqsLatencyAdjust3W::new(self, 0)
    }
    #[doc = "Bits 8:14 - Loopback control bits for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lpbk_control_3(&mut self) -> PhyLpbkControl3W<DdrDenaliPhy394Spec> {
        PhyLpbkControl3W::new(self, 8)
    }
    #[doc = "Bit 16 - data slice power reduction disable for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_slice_pwr_rdc_disable_3(&mut self) -> PhySlicePwrRdcDisable3W<DdrDenaliPhy394Spec> {
        PhySlicePwrRdcDisable3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_394::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_394::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy394Spec;
impl crate::RegisterSpec for DdrDenaliPhy394Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_394::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy394Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_394::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy394Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_394 to value 0"]
impl crate::Resettable for DdrDenaliPhy394Spec {
