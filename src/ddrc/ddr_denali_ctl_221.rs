#[doc = "Register `DDR_DENALI_CTL_221` reader"]
pub type R = crate::R<DdrDenaliCtl221Spec>;
#[doc = "Register `DDR_DENALI_CTL_221` writer"]
pub type W = crate::W<DdrDenaliCtl221Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn w2w_samecs_dly(&mut self) -> W2wSamecsDlyW<DdrDenaliCtl221Spec> {
        W2wSamecsDlyW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Additional delay needed for tDQSCK."]
    #[inline(always)]
    #[must_use]
    pub fn tdqsck_max_f0(&mut self) -> TdqsckMaxF0W<DdrDenaliCtl221Spec> {
        TdqsckMaxF0W::new(self, 8)
    }
    #[doc = "Bits 16:17 - Additional delay needed for tDQSCK."]
    #[inline(always)]
    #[must_use]
    pub fn tdqsck_min_f0(&mut self) -> TdqsckMinF0W<DdrDenaliCtl221Spec> {
        TdqsckMinF0W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Additional delay needed for tDQSCK."]
    #[inline(always)]
    #[must_use]
    pub fn tdqsck_max_f1(&mut self) -> TdqsckMaxF1W<DdrDenaliCtl221Spec> {
        TdqsckMaxF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_221::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_221::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl221Spec;
impl crate::RegisterSpec for DdrDenaliCtl221Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_221::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl221Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_221::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl221Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_221 to value 0"]
impl crate::Resettable for DdrDenaliCtl221Spec {
