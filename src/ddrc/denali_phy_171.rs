#[doc = "Register `DENALI_PHY_171` reader"]
pub type R = crate::R<DenaliPhy171Spec>;
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_171::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy171Spec;
impl crate::RegisterSpec for DenaliPhy171Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_171::R`](R) reader structure"]
impl crate::Readable for DenaliPhy171Spec {}
#[doc = "`reset()` method sets DENALI_PHY_171 to value 0"]
impl crate::Resettable for DenaliPhy171Spec {
