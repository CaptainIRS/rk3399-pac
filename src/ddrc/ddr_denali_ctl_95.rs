#[doc = "Register `DDR_DENALI_CTL_95` reader"]
pub type R = crate::R<DdrDenaliCtl95Spec>;
#[doc = "Register `DDR_DENALI_CTL_95` writer"]
pub type W = crate::W<DdrDenaliCtl95Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpi_srpd_deep_wakeup_f0(&mut self) -> LpiSrpdDeepWakeupF0W<DdrDenaliCtl95Spec> {
    ...
    pub fn lpi_srpd_deep_mcclk_gate_wakeup_f0(
        &mut self,
    ) -> LpiSrpdDeepMcclkGateWakeupF0W<DdrDenaliCtl95Spec> {
        LpiSrpdDeepMcclkGateWakeupF0W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when the LPI timer expires for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_timer_wakeup_f0(&mut self) -> LpiTimerWakeupF0W<DdrDenaliCtl95Spec> {
        LpiTimerWakeupF0W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Defines the DFI tLP_WAKEUP timing parameter (in DFI clocks) to be driven when memory is in power-down for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn lpi_pd_wakeup_f1(&mut self) -> LpiPdWakeupF1W<DdrDenaliCtl95Spec> {
        LpiPdWakeupF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_95::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_95::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl95Spec;
impl crate::RegisterSpec for DdrDenaliCtl95Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_95::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl95Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_95::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl95Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_95 to value 0"]
impl crate::Resettable for DdrDenaliCtl95Spec {
