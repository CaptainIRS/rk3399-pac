#[doc = "Register `DDR_DENALI_CTL_239` reader"]
pub type R = crate::R<DdrDenaliCtl239Spec>;
#[doc = "Register `DDR_DENALI_CTL_239` writer"]
pub type W = crate::W<DdrDenaliCtl239Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_gate_aref_en(&mut self) -> RdlvlGateArefEnW<DdrDenaliCtl239Spec> {
        RdlvlGateArefEnW::new(self, 0)
    }
    #[doc = "Bit 16 - Enables rotational CS for interval data eye training. Set to 1 for rotating CS."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_rotate(&mut self) -> RdlvlRotateW<DdrDenaliCtl239Spec> {
        RdlvlRotateW::new(self, 16)
    }
    #[doc = "Bit 24 - Enables rotational CS for interval gate training. Set to 1 for rotating CS."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_gate_rotate(&mut self) -> RdlvlGateRotateW<DdrDenaliCtl239Spec> {
        RdlvlGateRotateW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_239::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_239::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl239Spec;
impl crate::RegisterSpec for DdrDenaliCtl239Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_239::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl239Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_239::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl239Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_239 to value 0"]
impl crate::Resettable for DdrDenaliCtl239Spec {
