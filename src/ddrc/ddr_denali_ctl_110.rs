#[doc = "Register `DDR_DENALI_CTL_110` reader"]
pub type R = crate::R<DdrDenaliCtl110Spec>;
#[doc = "Register `DDR_DENALI_CTL_110` writer"]
pub type W = crate::W<DdrDenaliCtl110Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_init_complete_f1(&mut self) -> TdfiInitCompleteF1W<DdrDenaliCtl110Spec> {
        TdfiInitCompleteF1W::new(self, 0)
    }
    #[doc = "Bits 16:23 - Defines the DFI tINIT_START timing parameter (in DFI clocks) for frequency copy 2, the maximum number of cycles between a dfi_init_start assertion and a dfi_init_complete de-assertion from the PHY."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_init_start_f2(&mut self) -> TdfiInitStartF2W<DdrDenaliCtl110Spec> {
        TdfiInitStartF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_110::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_110::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl110Spec;
impl crate::RegisterSpec for DdrDenaliCtl110Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_110::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl110Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_110::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl110Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_110 to value 0"]
impl crate::Resettable for DdrDenaliCtl110Spec {
