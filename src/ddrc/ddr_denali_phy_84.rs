#[doc = "Register `DDR_DENALI_PHY_84` reader"]
pub type R = crate::R<DdrDenaliPhy84Spec>;
#[doc = "Register `DDR_DENALI_PHY_84` writer"]
pub type W = crate::W<DdrDenaliPhy84Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_tsel_rd_timing_0(&mut self) -> PhyDqsTselRdTiming0W<DdrDenaliPhy84Spec> {
        PhyDqsTselRdTiming0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Start/end timing values for DQS write based termination enable and select signals for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_tsel_wr_timing_0(&mut self) -> PhyDqsTselWrTiming0W<DdrDenaliPhy84Spec> {
        PhyDqsTselWrTiming0W::new(self, 8)
    }
    #[doc = "Bit 16 - Enables the per-rank training and read/write timing capabilities. Must have same value in all slices."]
    #[inline(always)]
    #[must_use]
    pub fn phy_per_cs_training_en_0(&mut self) -> PhyPerCsTrainingEn0W<DdrDenaliPhy84Spec> {
        PhyPerCsTrainingEn0W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Start/end timing values for DQ/DM input enable signals for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_ie_timing_0(&mut self) -> PhyDqIeTiming0W<DdrDenaliPhy84Spec> {
        PhyDqIeTiming0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_84::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_84::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy84Spec;
impl crate::RegisterSpec for DdrDenaliPhy84Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_84::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy84Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_84::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy84Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_84 to value 0"]
impl crate::Resettable for DdrDenaliPhy84Spec {
