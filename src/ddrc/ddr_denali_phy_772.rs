#[doc = "Register `DDR_DENALI_PHY_772` reader"]
pub type R = crate::R<DdrDenaliPhy772Spec>;
#[doc = "Register `DDR_DENALI_PHY_772` writer"]
pub type W = crate::W<DdrDenaliPhy772Spec>;
#[doc = "Field `PHY_ADR_LPBK_ERROR_COUNT_OBS_2` reader - Observation register containing total number of loopback error data for address slice 2. READ-ONLY"]
...
impl R {
    #[doc = "Bits 0:15 - Observation register containing total number of loopback error data for address slice 2. READ-ONLY"]
    #[inline(always)]
...
impl W {
    ...
    pub fn phy_adr_master_dly_lock_obs_select_2(
        &mut self,
    ) -> PhyAdrMasterDlyLockObsSelect2W<DdrDenaliPhy772Spec> {
        PhyAdrMasterDlyLockObsSelect2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_772::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_772::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy772Spec;
impl crate::RegisterSpec for DdrDenaliPhy772Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_772::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy772Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_772::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy772Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_772 to value 0"]
impl crate::Resettable for DdrDenaliPhy772Spec {
