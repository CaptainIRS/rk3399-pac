#[doc = "Register `DDR_DENALI_PHY_472` reader"]
pub type R = crate::R<DdrDenaliPhy472Spec>;
#[doc = "Register `DDR_DENALI_PHY_472` writer"]
pub type W = crate::W<DdrDenaliPhy472Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_resp_wait_cnt_3(&mut self) -> PhyWrlvlRespWaitCnt3W<DdrDenaliPhy472Spec> {
        PhyWrlvlRespWaitCnt3W::new(self, 0)
    }
    #[doc = "Bits 8:11 - DQS slave delay step size during gate training for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_dly_step_3(&mut self) -> PhyGtlvlDlyStep3W<DdrDenaliPhy472Spec> {
        PhyGtlvlDlyStep3W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Number of cycles + 4 to wait between dfi_rddata_en and the sampling of the DQS during gate training for slice 3. The valid range is 0x0 to 0xB."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_resp_wait_cnt_3(&mut self) -> PhyGtlvlRespWaitCnt3W<DdrDenaliPhy472Spec> {
        PhyGtlvlRespWaitCnt3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_472::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_472::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy472Spec;
impl crate::RegisterSpec for DdrDenaliPhy472Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_472::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy472Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_472::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy472Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_472 to value 0"]
impl crate::Resettable for DdrDenaliPhy472Spec {
