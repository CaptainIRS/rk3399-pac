#[doc = "Register `DDR_DENALI_PHY_11` reader"]
pub type R = crate::R<DdrDenaliPhy11Spec>;
#[doc = "Register `DDR_DENALI_PHY_11` writer"]
pub type W = crate::W<DdrDenaliPhy11Spec>;
...
#[doc = "Field `SC_PHY_SNAP_OBS_REGS_0` writer - Initiates a snapshot of the internal observation registers for slice 0. Set to 1 to trigger. WRITE-ONLY"]
...
impl W {
    ...
    pub fn phy_rddqs_dq_bypass_slave_delay_0(
        &mut self,
    ) -> PhyRddqsDqBypassSlaveDelay0W<DdrDenaliPhy11Spec> {
    ...
    pub fn phy_gate_error_delay_select_0(
        &mut self,
    ) -> PhyGateErrorDelaySelect0W<DdrDenaliPhy11Spec> {
        PhyGateErrorDelaySelect0W::new(self, 16)
    }
    #[doc = "Bit 24 - Initiates a snapshot of the internal observation registers for slice 0. Set to 1 to trigger. WRITE-ONLY"]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_snap_obs_regs_0(&mut self) -> ScPhySnapObsRegs0W<DdrDenaliPhy11Spec> {
        ScPhySnapObsRegs0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_11::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_11::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy11Spec;
impl crate::RegisterSpec for DdrDenaliPhy11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_11::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy11Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_11::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_11 to value 0"]
impl crate::Resettable for DdrDenaliPhy11Spec {
