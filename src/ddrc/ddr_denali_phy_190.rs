#[doc = "Register `DDR_DENALI_PHY_190` reader"]
pub type R = crate::R<DdrDenaliPhy190Spec>;
#[doc = "Register `DDR_DENALI_PHY_190` writer"]
pub type W = crate::W<DdrDenaliPhy190Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq6_slave_delay_1(&mut self) -> PhyClkWrdq6SlaveDelay1W<DdrDenaliPhy190Spec> {
        PhyClkWrdq6SlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ7 for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq7_slave_delay_1(&mut self) -> PhyClkWrdq7SlaveDelay1W<DdrDenaliPhy190Spec> {
        PhyClkWrdq7SlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_190::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_190::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy190Spec;
impl crate::RegisterSpec for DdrDenaliPhy190Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_190::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy190Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_190::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy190Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_190 to value 0"]
impl crate::Resettable for DdrDenaliPhy190Spec {
