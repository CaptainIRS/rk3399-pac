#[doc = "Register `DENALI_PHY_397` reader"]
pub type R = crate::R<DenaliPhy397Spec>;
#[doc = "Register `DENALI_PHY_397` writer"]
pub type W = crate::W<DenaliPhy397Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_smpl2_slave_delay_3(&mut self) -> PhyGateSmpl2SlaveDelay3W<DenaliPhy397Spec> {
        PhyGateSmpl2SlaveDelay3W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Control the on the fly gate adjustment for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn on_fly_gate_adjust_en_3(&mut self) -> OnFlyGateAdjustEn3W<DenaliPhy397Spec> {
        OnFlyGateAdjustEn3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_397::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_397::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy397Spec;
impl crate::RegisterSpec for DenaliPhy397Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_397::R`](R) reader structure"]
impl crate::Readable for DenaliPhy397Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_397::W`](W) writer structure"]
impl crate::Writable for DenaliPhy397Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_397 to value 0"]
impl crate::Resettable for DenaliPhy397Spec {
