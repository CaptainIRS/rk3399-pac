#[doc = "Register `DDR_DENALI_PHY_416` reader"]
pub type R = crate::R<DdrDenaliPhy416Spec>;
#[doc = "Register `DDR_DENALI_PHY_416` writer"]
pub type W = crate::W<DdrDenaliPhy416Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_user_patt4_3(&mut self) -> PhyUserPatt4_3W<DdrDenaliPhy416Spec> {
    ...
    pub fn phy_calvl_vref_driving_slice_3(
        &mut self,
    ) -> PhyCalvlVrefDrivingSlice3W<DdrDenaliPhy416Spec> {
        PhyCalvlVrefDrivingSlice3W::new(self, 16)
    }
    #[doc = "Bits 24:29 - Manual reset/clear of internal logic for slice 3. Bit (0) initiates manual setup of the read DQS gate. Bit (1) is reset of read entry FIFO pointers. Bit (2) is reset of master delay min/ max lock values. Bit (3) is manual reset of master delay unlock counter. Bit (4) is reset of leveling error bit in the leveling status registers. Bit (5) is clearing of the gate tracking observation register. Set each bit to 1 to initiate/reset. WRITE-ONLY"]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_manual_clear_3(&mut self) -> ScPhyManualClear3W<DdrDenaliPhy416Spec> {
        ScPhyManualClear3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_416::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_416::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy416Spec;
impl crate::RegisterSpec for DdrDenaliPhy416Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_416::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy416Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_416::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy416Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_416 to value 0"]
impl crate::Resettable for DdrDenaliPhy416Spec {
