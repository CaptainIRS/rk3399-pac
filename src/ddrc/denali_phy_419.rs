...
#[doc = "Field `PHY_LPBK_ERROR_COUNT_OBS_3` reader - Observation register containing total number of loopback error data for slice 3."]
pub type PhyLpbkErrorCountObs3R = crate::FieldReader<u16>;
#[doc = "Field `PHY_MASTER_DLY_LOCK_OBS_3` reader - Observation register for master delay results for slice 3."]
pub type PhyMasterDlyLockObs3R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:15 - Observation register containing total number of loopback error data for slice 3."]
    #[inline(always)]
    pub fn phy_lpbk_error_count_obs_3(&self) -> PhyLpbkErrorCountObs3R {
        PhyLpbkErrorCountObs3R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:25 - Observation register for master delay results for slice 3."]
    #[inline(always)]
