#[doc = "Register `DDR_DENALI_CTL_201` reader"]
pub type R = crate::R<DdrDenaliCtl201Spec>;
#[doc = "Register `DDR_DENALI_CTL_201` writer"]
pub type W = crate::W<DdrDenaliCtl201Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rd_preamble_training_en(&mut self) -> RdPreambleTrainingEnW<DdrDenaliCtl201Spec> {
        RdPreambleTrainingEnW::new(self, 0)
    }
    #[doc = "Bit 8 - Enables controller support of DRAM DBI feature for write data with DDR4 devices. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn wr_dbi_en(&mut self) -> WrDbiEnW<DdrDenaliCtl201Spec> {
        WrDbiEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Enables controller support of DRAM DBI feature for read data with DDR4 devices. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn rd_dbi_en(&mut self) -> RdDbiEnW<DdrDenaliCtl201Spec> {
        RdDbiEnW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_201::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_201::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl201Spec;
impl crate::RegisterSpec for DdrDenaliCtl201Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_201::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl201Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_201::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl201Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_201 to value 0"]
impl crate::Resettable for DdrDenaliCtl201Spec {
