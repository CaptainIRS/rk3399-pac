#[doc = "Register `DDR_DENALI_PHY_214` reader"]
pub type R = crate::R<DdrDenaliPhy214Spec>;
#[doc = "Register `DDR_DENALI_PHY_214` writer"]
pub type W = crate::W<DdrDenaliPhy214Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddata_en_tsel_dly_1(&mut self) -> PhyRddataEnTselDly1W<DdrDenaliPhy214Spec> {
        PhyRddataEnTselDly1W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Master delay line override settings for slice 1. Bit (0) enables software half clock mode. Bit (1) is the software half clock mode value. Bit (2) enables software bypass mode. Bit (3) is the software bypass mode value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_master_mode_1(&mut self) -> PhySwMasterMode1W<DdrDenaliPhy214Spec> {
        PhySwMasterMode1W::new(self, 8)
    }
    #[doc = "Bits 16:25 - Start value for master delay line locking algorithm for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_master_delay_start_1(&mut self) -> PhyMasterDelayStart1W<DdrDenaliPhy214Spec> {
        PhyMasterDelayStart1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_214::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_214::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy214Spec;
impl crate::RegisterSpec for DdrDenaliPhy214Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_214::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy214Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_214::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy214Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_214 to value 0"]
impl crate::Resettable for DdrDenaliPhy214Spec {
