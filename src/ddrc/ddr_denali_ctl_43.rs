#[doc = "Register `DDR_DENALI_CTL_43` reader"]
pub type R = crate::R<DdrDenaliCtl43Spec>;
#[doc = "Register `DDR_DENALI_CTL_43` writer"]
pub type W = crate::W<DdrDenaliCtl43Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmrz_f2(&mut self) -> TmrzF2W<DdrDenaliCtl43Spec> {
        TmrzF2W::new(self, 0)
    }
    #[doc = "Bit 8 - Enable auto pre-charge mode of controller. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn ap(&mut self) -> ApW<DdrDenaliCtl43Spec> {
        ApW::new(self, 8)
    }
    #[doc = "Bit 16 - IF the DRAM supports it, this allows the controller to issue commands to other banks while a bank is in auto pre-charge. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn concurrentap(&mut self) -> ConcurrentapW<DdrDenaliCtl43Spec> {
        ConcurrentapW::new(self, 16)
    }
    #[doc = "Bit 24 - IF the DRAM supports it, this allows the controller to execute auto pre- charge commands before the TRAS_MIN parameter expires. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn tras_lockout(&mut self) -> TrasLockoutW<DdrDenaliCtl43Spec> {
        TrasLockoutW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_43::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_43::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl43Spec;
impl crate::RegisterSpec for DdrDenaliCtl43Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_43::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl43Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_43::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl43Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_43 to value 0"]
impl crate::Resettable for DdrDenaliCtl43Spec {
