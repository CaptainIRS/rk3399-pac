...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_01::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl01Spec;
impl crate::RegisterSpec for DdrDenaliCtl01Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_01::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl01Spec {}
#[doc = "`reset()` method sets DDR_DENALI_CTL_01 to value 0x0002_0c10"]
impl crate::Resettable for DdrDenaliCtl01Spec {
