#[doc = "Register `DDR_DENALI_PHY_409` reader"]
pub type R = crate::R<DdrDenaliPhy409Spec>;
#[doc = "Register `DDR_DENALI_PHY_409` writer"]
pub type W = crate::W<DdrDenaliPhy409Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_patt_3(&mut self) -> PhyWdqlvlPatt3W<DdrDenaliPhy409Spec> {
    ...
    pub fn phy_wdqlvl_dqdm_slv_dly_jump_offset_3(
        &mut self,
    ) -> PhyWdqlvlDqdmSlvDlyJumpOffset3W<DdrDenaliPhy409Spec> {
        PhyWdqlvlDqdmSlvDlyJumpOffset3W::new(self, 8)
    }
    #[doc = "Bits 24:27 - Number of cycles to wait after changing the DQ slave delay setting during write data leveling for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_updt_wait_cnt_3(&mut self) -> PhyWdqlvlUpdtWaitCnt3W<DdrDenaliPhy409Spec> {
        PhyWdqlvlUpdtWaitCnt3W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_409::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_409::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy409Spec;
impl crate::RegisterSpec for DdrDenaliPhy409Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_409::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy409Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_409::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy409Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_409 to value 0"]
impl crate::Resettable for DdrDenaliPhy409Spec {
