#[doc = "Register `DENALI_CTL_228` reader"]
pub type R = crate::R<DenaliCtl228Spec>;
#[doc = "Register `DENALI_CTL_228` writer"]
pub type W = crate::W<DenaliCtl228Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_cs_map(&mut self) -> WrlvlCsMapW<DenaliCtl228Spec> {
        WrlvlCsMapW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Write leveling normal threshold number of long counts until the normal priority request is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn wrlvl_norm_threshold_f0(&mut self) -> WrlvlNormThresholdF0W<DenaliCtl228Spec> {
        WrlvlNormThresholdF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_228::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_228::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl228Spec;
impl crate::RegisterSpec for DenaliCtl228Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_228::R`](R) reader structure"]
impl crate::Readable for DenaliCtl228Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_228::W`](W) writer structure"]
impl crate::Writable for DenaliCtl228Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_228 to value 0"]
impl crate::Resettable for DenaliCtl228Spec {
