#[doc = "Register `DDR_DENALI_PHY_896` reader"]
pub type R = crate::R<DdrDenaliPhy896Spec>;
#[doc = "Register `DDR_DENALI_PHY_896` writer"]
pub type W = crate::W<DdrDenaliPhy896Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_freq_sel_multicast_en(&mut self) -> PhyFreqSelMulticastEnW<DdrDenaliPhy896Spec> {
        PhyFreqSelMulticastEnW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Selects which frequency set to update."]
    #[inline(always)]
    #[must_use]
    pub fn phy_freq_sel_index(&mut self) -> PhyFreqSelIndexW<DdrDenaliPhy896Spec> {
        PhyFreqSelIndexW::new(self, 8)
    }
    #[doc = "Bits 16:20 - Address/control group slice 0 manual override of automatic half_cycle_shift/cycle_shift. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bit (3) is the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_grp_shift_0(&mut self) -> PhySwGrpShift0W<DdrDenaliPhy896Spec> {
        PhySwGrpShift0W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Address/control group slice 1 manual override of automatic half_cycle_shift/cycle_shift. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bit (3) is the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_grp_shift_1(&mut self) -> PhySwGrpShift1W<DdrDenaliPhy896Spec> {
        PhySwGrpShift1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_896::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_896::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy896Spec;
impl crate::RegisterSpec for DdrDenaliPhy896Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_896::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy896Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_896::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy896Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_896 to value 0x01"]
impl crate::Resettable for DdrDenaliPhy896Spec {
