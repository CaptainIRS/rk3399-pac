#[doc = "Register `DDR_DENALI_CTL_132` reader"]
pub type R = crate::R<DdrDenaliCtl132Spec>;
#[doc = "Register `DDR_DENALI_CTL_132` writer"]
pub type W = crate::W<DdrDenaliCtl132Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mrw_promote_threshold_f1(&mut self) -> MrwPromoteThresholdF1W<DdrDenaliCtl132Spec> {
        MrwPromoteThresholdF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - MRW promotion number of long counts until the high priority request is asserted for frequency copy 2. Applies to SW MRW commands."]
    #[inline(always)]
    #[must_use]
    pub fn mrw_promote_threshold_f2(&mut self) -> MrwPromoteThresholdF2W<DdrDenaliCtl132Spec> {
        MrwPromoteThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_132::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_132::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl132Spec;
impl crate::RegisterSpec for DdrDenaliCtl132Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_132::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl132Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_132::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl132Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_132 to value 0"]
impl crate::Resettable for DdrDenaliCtl132Spec {
