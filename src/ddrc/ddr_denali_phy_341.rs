#[doc = "Register `DDR_DENALI_PHY_341` reader"]
pub type R = crate::R<DdrDenaliPhy341Spec>;
#[doc = "Register `DDR_DENALI_PHY_341` writer"]
pub type W = crate::W<DdrDenaliPhy341Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_ie_timing_2(&mut self) -> PhyDqsIeTiming2W<DdrDenaliPhy341Spec> {
        PhyDqsIeTiming2W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Number of cycles that the dfi_rddata_en signal is earlier than necessary for input enable generation for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddata_en_ie_dly_2(&mut self) -> PhyRddataEnIeDly2W<DdrDenaliPhy341Spec> {
        PhyRddataEnIeDly2W::new(self, 8)
    }
    #[doc = "Bits 16:17 - Input enable mode bits for slice 2. Bit (0) enables the mode where the input enables are always on; set to 1 to enable. Bit (1) disables the input enable on the DM signal; set to 1 to disable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_ie_mode_2(&mut self) -> PhyIeMode2W<DdrDenaliPhy341Spec> {
        PhyIeMode2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Number of cycles that the dfi_rddata_en signal is early for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddata_en_dly_2(&mut self) -> PhyRddataEnDly2W<DdrDenaliPhy341Spec> {
        PhyRddataEnDly2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_341::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_341::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy341Spec;
impl crate::RegisterSpec for DdrDenaliPhy341Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_341::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy341Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_341::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy341Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_341 to value 0"]
impl crate::Resettable for DdrDenaliPhy341Spec {
