#[doc = "Register `DDR_DENALI_PHY_140` reader"]
pub type R = crate::R<DdrDenaliPhy140Spec>;
#[doc = "Register `DDR_DENALI_PHY_140` writer"]
pub type W = crate::W<DdrDenaliPhy140Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_lpddr_1(&mut self) -> PhyLpddr1W<DdrDenaliPhy140Spec> {
        PhyLpddr1W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Indicates the type of DRAM for slice 1. Clear to 0 for DDR3 or DDR4, program to 1 for LPDDR3, or program to 2 for LPDDR4."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lpddr_type_1(&mut self) -> PhyLpddrType1W<DdrDenaliPhy140Spec> {
    ...
    pub fn phy_gate_smpl1_slave_delay_1(
        &mut self,
    ) -> PhyGateSmpl1SlaveDelay1W<DdrDenaliPhy140Spec> {
        PhyGateSmpl1SlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_140::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_140::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy140Spec;
impl crate::RegisterSpec for DdrDenaliPhy140Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_140::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy140Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_140::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy140Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_140 to value 0"]
impl crate::Resettable for DdrDenaliPhy140Spec {
