#[doc = "Register `DDR_DENALI_PHY_187` reader"]
pub type R = crate::R<DdrDenaliPhy187Spec>;
#[doc = "Register `DDR_DENALI_PHY_187` writer"]
pub type W = crate::W<DdrDenaliPhy187Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq0_slave_delay_1(&mut self) -> PhyClkWrdq0SlaveDelay1W<DdrDenaliPhy187Spec> {
        PhyClkWrdq0SlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Write clock slave delay setting for DQ1 for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_clk_wrdq1_slave_delay_1(&mut self) -> PhyClkWrdq1SlaveDelay1W<DdrDenaliPhy187Spec> {
        PhyClkWrdq1SlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_187::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_187::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy187Spec;
impl crate::RegisterSpec for DdrDenaliPhy187Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_187::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy187Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_187::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy187Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_187 to value 0"]
impl crate::Resettable for DdrDenaliPhy187Spec {
