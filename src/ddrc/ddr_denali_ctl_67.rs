#[doc = "Register `DDR_DENALI_CTL_67` reader"]
pub type R = crate::R<DdrDenaliCtl67Spec>;
#[doc = "Register `DDR_DENALI_CTL_67` writer"]
pub type W = crate::W<DdrDenaliCtl67Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tckckel_f2(&mut self) -> TckckelF2W<DdrDenaliCtl67Spec> {
        TckckelF2W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TSR value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tsr_f2(&mut self) -> TsrF2W<DdrDenaliCtl67Spec> {
        TsrF2W::new(self, 8)
    }
    #[doc = "Bits 16:18 - DRAM TESCKE value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tescke_f2(&mut self) -> TesckeF2W<DdrDenaliCtl67Spec> {
        TesckeF2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DRAM TCKELPD value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tckelpd_f2(&mut self) -> TckelpdF2W<DdrDenaliCtl67Spec> {
        TckelpdF2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_67::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_67::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl67Spec;
impl crate::RegisterSpec for DdrDenaliCtl67Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_67::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl67Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_67::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl67Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_67 to value 0"]
impl crate::Resettable for DdrDenaliCtl67Spec {
