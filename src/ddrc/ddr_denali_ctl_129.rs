#[doc = "Register `DDR_DENALI_CTL_129` reader"]
pub type R = crate::R<DdrDenaliCtl129Spec>;
#[doc = "Register `DDR_DENALI_CTL_129` writer"]
pub type W = crate::W<DdrDenaliCtl129Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tckfspe_f2(&mut self) -> TckfspeF2W<DdrDenaliCtl129Spec> {
        TckfspeF2W::new(self, 0)
    }
    #[doc = "Bits 8:12 - JEDEC TCKFSPX, the valid clock requirement before 1st valid command after FSP change."]
    #[inline(always)]
    #[must_use]
    pub fn tckfspx_f2(&mut self) -> TckfspxF2W<DdrDenaliCtl129Spec> {
        TckfspxF2W::new(self, 8)
    }
    #[doc = "Bits 16:31 - JEDEC TVREF, design will always use the long value."]
    #[inline(always)]
    #[must_use]
    pub fn tvref_long_f2(&mut self) -> TvrefLongF2W<DdrDenaliCtl129Spec> {
        TvrefLongF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_129::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_129::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl129Spec;
impl crate::RegisterSpec for DdrDenaliCtl129Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_129::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl129Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_129::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl129Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_129 to value 0"]
impl crate::Resettable for DdrDenaliCtl129Spec {
