#[doc = "Register `DDR_DENALI_CTL_271` reader"]
pub type R = crate::R<DdrDenaliCtl271Spec>;
#[doc = "Register `DDR_DENALI_CTL_271` writer"]
pub type W = crate::W<DdrDenaliCtl271Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn calvl_norm_threshold_f2(&mut self) -> CalvlNormThresholdF2W<DdrDenaliCtl271Spec> {
        CalvlNormThresholdF2W::new(self, 0)
    }
    #[doc = "Bits 16:31 - CA training high threshold number of long counts until the high priority request is asserted."]
    #[inline(always)]
    #[must_use]
    pub fn calvl_high_threshold_f2(&mut self) -> CalvlHighThresholdF2W<DdrDenaliCtl271Spec> {
        CalvlHighThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_271::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_271::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl271Spec;
impl crate::RegisterSpec for DdrDenaliCtl271Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_271::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl271Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_271::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl271Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_271 to value 0"]
impl crate::Resettable for DdrDenaliCtl271Spec {
