#[doc = "Register `DDR_DENALI_CTL_00` reader"]
pub type R = crate::R<DdrDenaliCtl00Spec>;
#[doc = "Register `DDR_DENALI_CTL_00` writer"]
pub type W = crate::W<DdrDenaliCtl00Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> StartW<DdrDenaliCtl00Spec> {
        StartW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the class of DRAM memory which is connected to the controller."]
    #[inline(always)]
    #[must_use]
    pub fn dram_class(&mut self) -> DramClassW<DdrDenaliCtl00Spec> {
        DramClassW::new(self, 8)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_00::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_00::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl00Spec;
impl crate::RegisterSpec for DdrDenaliCtl00Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_00::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl00Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_00::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl00Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_00 to value 0x2041_0000"]
impl crate::Resettable for DdrDenaliCtl00Spec {
