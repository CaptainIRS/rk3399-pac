#[doc = "Register `DDR_DENALI_CTL_18` reader"]
pub type R = crate::R<DdrDenaliCtl18Spec>;
#[doc = "Register `DDR_DENALI_CTL_18` writer"]
pub type W = crate::W<DdrDenaliCtl18Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn no_phy_ind_train_init(&mut self) -> NoPhyIndTrainInitW<DdrDenaliCtl18Spec> {
        NoPhyIndTrainInitW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable PHY independent training mode commands during initialization. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_indep_train_mode(&mut self) -> PhyIndepTrainModeW<DdrDenaliCtl18Spec> {
        PhyIndepTrainModeW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Defines the initial DFI bus frequency."]
    #[inline(always)]
    #[must_use]
    pub fn dfibus_freq_init(&mut self) -> DfibusFreqInitW<DdrDenaliCtl18Spec> {
        DfibusFreqInitW::new(self, 16)
    }
    #[doc = "Bits 24:25 - Defines the DFI bus boot frequency."]
    #[inline(always)]
    #[must_use]
    pub fn dfibus_boot_freq(&mut self) -> DfibusBootFreqW<DdrDenaliCtl18Spec> {
        DfibusBootFreqW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_18::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_18::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl18Spec;
impl crate::RegisterSpec for DdrDenaliCtl18Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_18::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl18Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_18::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl18Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_18 to value 0"]
impl crate::Resettable for DdrDenaliCtl18Spec {
