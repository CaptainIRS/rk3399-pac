...
#[doc = "Field `PI_BSTLEN` reader - Indicates encoded burst length that is sent to DRAMs during\n\ninitialization. Set to 1 for BL2, set to 2 for BL4, or set to 3 for BL8."]
pub type PiBstlenR = crate::FieldReader;
#[doc = "Field `PI_BSTLEN` writer - Indicates encoded burst length that is sent to DRAMs during\n\ninitialization. Set to 1 for BL2, set to 2 for BL4, or set to 3 for BL8."]
pub type PiBstlenW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `PI_LONG_COUNT_MASK` reader - Reduces the length of the long counter from 1024 cycles. The only\n\nsupported values are 0x00 (1024 cycles), 0x10 (512 clocks), 0x18\n\n(256 clocks), 0x1C (128 clocks), 0x1E (64 clocks), and 0x1F (32\n\nclocks)."]
pub type PiLongCountMaskR = crate::FieldReader;
#[doc = "Field `PI_LONG_COUNT_MASK` writer - Reduces the length of the long counter from 1024 cycles. The only\n\nsupported values are 0x00 (1024 cycles), 0x10 (512 clocks), 0x18\n\n(256 clocks), 0x1C (128 clocks), 0x1E (64 clocks), and 0x1F (32\n\nclocks)."]
pub type PiLongCountMaskW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `PI_CTRLUPD_REQ_PER_AREF_EN` reader - Enables an automatic PI-initiated update (dfi_ctrlupd_req) after\n\nevery refresh. Set to 1 to enable."]
pub type PiCtrlupdReqPerArefEnR = crate::BitReader;
#[doc = "Field `PI_CTRLUPD_REQ_PER_AREF_EN` writer - Enables an automatic PI-initiated update (dfi_ctrlupd_req) after\n\nevery refresh. Set to 1 to enable."]
pub type PiCtrlupdReqPerArefEnW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 8:12 - Indicates encoded burst length that is sent to DRAMs during\n\ninitialization. Set to 1 for BL2, set to 2 for BL4, or set to 3 for BL8."]
    #[inline(always)]
    pub fn pi_bstlen(&self) -> PiBstlenR {
        PiBstlenR::new(((self.bits >> 8) & 0x1f) as u8)
    }
    #[doc = "Bits 16:20 - Reduces the length of the long counter from 1024 cycles. The only\n\nsupported values are 0x00 (1024 cycles), 0x10 (512 clocks), 0x18\n\n(256 clocks), 0x1C (128 clocks), 0x1E (64 clocks), and 0x1F (32\n\nclocks)."]
    #[inline(always)]
    pub fn pi_long_count_mask(&self) -> PiLongCountMaskR {
        PiLongCountMaskR::new(((self.bits >> 16) & 0x1f) as u8)
    }
    #[doc = "Bit 24 - Enables an automatic PI-initiated update (dfi_ctrlupd_req) after\n\nevery refresh. Set to 1 to enable."]
    #[inline(always)]
