#[doc = "Register `DDR_DENALI_PHY_169` reader"]
pub type R = crate::R<DdrDenaliPhy169Spec>;
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_169::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy169Spec;
impl crate::RegisterSpec for DdrDenaliPhy169Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_169::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy169Spec {}
#[doc = "`reset()` method sets DDR_DENALI_PHY_169 to value 0"]
impl crate::Resettable for DdrDenaliPhy169Spec {
