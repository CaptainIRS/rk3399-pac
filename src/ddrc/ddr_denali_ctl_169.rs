#[doc = "Register `DDR_DENALI_CTL_169` reader"]
pub type R = crate::R<DdrDenaliCtl169Spec>;
#[doc = "Register `DDR_DENALI_CTL_169` writer"]
pub type W = crate::W<DdrDenaliCtl169Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zq_cs_timeout_f0(&mut self) -> ZqCsTimeoutF0W<DdrDenaliCtl169Spec> {
        ZqCsTimeoutF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - ZQ SW promotion number of long counts until the high priority request is asserted for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn zq_promote_threshold_f0(&mut self) -> ZqPromoteThresholdF0W<DdrDenaliCtl169Spec> {
        ZqPromoteThresholdF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_169::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_169::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl169Spec;
impl crate::RegisterSpec for DdrDenaliCtl169Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_169::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl169Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_169::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl169Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_169 to value 0"]
impl crate::Resettable for DdrDenaliCtl169Spec {
