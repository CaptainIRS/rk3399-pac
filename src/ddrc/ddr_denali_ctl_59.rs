#[doc = "Register `DDR_DENALI_CTL_59` reader"]
pub type R = crate::R<DdrDenaliCtl59Spec>;
#[doc = "Register `DDR_DENALI_CTL_59` writer"]
pub type W = crate::W<DdrDenaliCtl59Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmrwckel_f2(&mut self) -> TmrwckelF2W<DdrDenaliCtl59Spec> {
        TmrwckelF2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - DRAM TZQCKE value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tzqcke_f2(&mut self) -> TzqckeF2W<DdrDenaliCtl59Spec> {
        TzqckeF2W::new(self, 8)
    }
    #[doc = "Bits 16:31 - DRAM TXSR value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn txsr_f0(&mut self) -> TxsrF0W<DdrDenaliCtl59Spec> {
        TxsrF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_59::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_59::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl59Spec;
impl crate::RegisterSpec for DdrDenaliCtl59Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_59::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl59Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_59::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl59Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_59 to value 0"]
impl crate::Resettable for DdrDenaliCtl59Spec {
