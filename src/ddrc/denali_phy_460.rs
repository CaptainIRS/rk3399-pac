#[doc = "Register `DENALI_PHY_460` reader"]
pub type R = crate::R<DenaliPhy460Spec>;
#[doc = "Register `DENALI_PHY_460` writer"]
pub type W = crate::W<DenaliPhy460Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq7_fall_slave_delay_3(
        &mut self,
    ) -> PhyRddqsDq7FallSlaveDelay3W<DenaliPhy460Spec> {
    ...
    pub fn phy_rddqs_dm_rise_slave_delay_3(
        &mut self,
    ) -> PhyRddqsDmRiseSlaveDelay3W<DenaliPhy460Spec> {
        PhyRddqsDmRiseSlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_460::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_460::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy460Spec;
impl crate::RegisterSpec for DenaliPhy460Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_460::R`](R) reader structure"]
impl crate::Readable for DenaliPhy460Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_460::W`](W) writer structure"]
impl crate::Writable for DenaliPhy460Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_460 to value 0"]
impl crate::Resettable for DenaliPhy460Spec {
