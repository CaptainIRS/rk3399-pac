#[doc = "Register `DDR_DENALI_PHY_676` reader"]
pub type R = crate::R<DdrDenaliPhy676Spec>;
#[doc = "Register `DDR_DENALI_PHY_676` writer"]
pub type W = crate::W<DdrDenaliPhy676Spec>;
...
impl W {
    ...
    pub fn phy_adr_master_delay_start_1(
        &mut self,
    ) -> PhyAdrMasterDelayStart1W<DdrDenaliPhy676Spec> {
        PhyAdrMasterDelayStart1W::new(self, 0)
    }
    #[doc = "Bits 16:21 - Incremental step size for master delay line locking algorithm for address slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_master_delay_step_1(&mut self) -> PhyAdrMasterDelayStep1W<DdrDenaliPhy676Spec> {
        PhyAdrMasterDelayStep1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Wait cycles for master delay line locking algorithm for address slice 1. Bits (3:0) is the cycle wait count after a calibration clock setting change. Bits (7:4) is the cycle wait count after a master delay setting change."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_master_delay_wait_1(&mut self) -> PhyAdrMasterDelayWait1W<DdrDenaliPhy676Spec> {
        PhyAdrMasterDelayWait1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_676::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_676::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy676Spec;
impl crate::RegisterSpec for DdrDenaliPhy676Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_676::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy676Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_676::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy676Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_676 to value 0"]
impl crate::Resettable for DdrDenaliPhy676Spec {
