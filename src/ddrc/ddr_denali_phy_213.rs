#[doc = "Register `DDR_DENALI_PHY_213` reader"]
pub type R = crate::R<DdrDenaliPhy213Spec>;
#[doc = "Register `DDR_DENALI_PHY_213` writer"]
pub type W = crate::W<DdrDenaliPhy213Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_ie_timing_1(&mut self) -> PhyDqsIeTiming1W<DdrDenaliPhy213Spec> {
        PhyDqsIeTiming1W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Number of cycles that the dfi_rddata_en signal is earlier than necessary for input enable generation for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddata_en_ie_dly_1(&mut self) -> PhyRddataEnIeDly1W<DdrDenaliPhy213Spec> {
        PhyRddataEnIeDly1W::new(self, 8)
    }
    #[doc = "Bits 16:17 - Input enable mode bits for slice 1. Bit (0) enables the mode where the input enables are always on; set to 1 to enable. Bit (1) disables the input enable on the DM signal; set to 1 to disable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_ie_mode_1(&mut self) -> PhyIeMode1W<DdrDenaliPhy213Spec> {
        PhyIeMode1W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Number of cycles that the dfi_rddata_en signal is early for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddata_en_dly_1(&mut self) -> PhyRddataEnDly1W<DdrDenaliPhy213Spec> {
        PhyRddataEnDly1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_213::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_213::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy213Spec;
impl crate::RegisterSpec for DdrDenaliPhy213Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_213::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy213Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_213::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy213Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_213 to value 0"]
impl crate::Resettable for DdrDenaliPhy213Spec {
