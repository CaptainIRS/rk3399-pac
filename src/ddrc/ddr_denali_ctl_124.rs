#[doc = "Register `DDR_DENALI_CTL_124` reader"]
pub type R = crate::R<DdrDenaliCtl124Spec>;
#[doc = "Register `DDR_DENALI_CTL_124` writer"]
pub type W = crate::W<DdrDenaliCtl124Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tckfspe_f0(&mut self) -> TckfspeF0W<DdrDenaliCtl124Spec> {
        TckfspeF0W::new(self, 0)
    }
    #[doc = "Bits 8:12 - JEDEC TCKFSPX, the valid clock requirement before 1st valid command after FSP change."]
    #[inline(always)]
    #[must_use]
    pub fn tckfspx_f0(&mut self) -> TckfspxF0W<DdrDenaliCtl124Spec> {
        TckfspxF0W::new(self, 8)
    }
    #[doc = "Bits 16:31 - JEDEC TVREF, design will always use the long value."]
    #[inline(always)]
    #[must_use]
    pub fn tvref_long_f0(&mut self) -> TvrefLongF0W<DdrDenaliCtl124Spec> {
        TvrefLongF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_124::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_124::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl124Spec;
impl crate::RegisterSpec for DdrDenaliCtl124Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_124::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl124Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_124::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl124Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_124 to value 0"]
impl crate::Resettable for DdrDenaliCtl124Spec {
