#[doc = "Register `DENALI_CTL_160` reader"]
pub type R = crate::R<DenaliCtl160Spec>;
#[doc = "Register `DENALI_CTL_160` writer"]
pub type W = crate::W<DenaliCtl160Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr22_data_f1_1(&mut self) -> Mr22DataF1_1W<DenaliCtl160Spec> {
        Mr22DataF1_1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 22 for chip select 1."]
    #[inline(always)]
    #[must_use]
    pub fn mr22_data_f2_1(&mut self) -> Mr22DataF2_1W<DenaliCtl160Spec> {
        Mr22DataF2_1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_160::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_160::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl160Spec;
impl crate::RegisterSpec for DenaliCtl160Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_160::R`](R) reader structure"]
impl crate::Readable for DenaliCtl160Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_160::W`](W) writer structure"]
impl crate::Writable for DenaliCtl160Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_160 to value 0"]
impl crate::Resettable for DenaliCtl160Spec {
