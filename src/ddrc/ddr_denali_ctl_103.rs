#[doc = "Register `DDR_DENALI_CTL_103` reader"]
pub type R = crate::R<DdrDenaliCtl103Spec>;
#[doc = "Register `DDR_DENALI_CTL_103` writer"]
pub type W = crate::W<DdrDenaliCtl103Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_auto_sr_idle(&mut self) -> LpAutoSrIdleW<DdrDenaliCtl103Spec> {
        LpAutoSrIdleW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Number of long count sequences until the controller will place memory in self-refresh with controller and memory clock gating."]
    #[inline(always)]
    #[must_use]
    pub fn lp_auto_sr_mc_gate_idle(&mut self) -> LpAutoSrMcGateIdleW<DdrDenaliCtl103Spec> {
        LpAutoSrMcGateIdleW::new(self, 8)
    }
    #[doc = "Bits 16:31 - HW interface promotion number of long counts until the high priority request is asserted for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn hw_promote_threshold_f0(&mut self) -> HwPromoteThresholdF0W<DdrDenaliCtl103Spec> {
        HwPromoteThresholdF0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_103::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_103::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl103Spec;
impl crate::RegisterSpec for DdrDenaliCtl103Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_103::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl103Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_103::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl103Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_103 to value 0"]
impl crate::Resettable for DdrDenaliCtl103Spec {
