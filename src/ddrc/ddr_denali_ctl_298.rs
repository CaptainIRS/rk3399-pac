#[doc = "Register `DDR_DENALI_CTL_298` reader"]
pub type R = crate::R<DdrDenaliCtl298Spec>;
#[doc = "Register `DDR_DENALI_CTL_298` writer"]
pub type W = crate::W<DdrDenaliCtl298Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdlat_adj_f2(&mut self) -> RdlatAdjF2W<DdrDenaliCtl298Spec> {
        RdlatAdjF2W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Adjustment value for PHY write timing."]
    #[inline(always)]
    #[must_use]
    pub fn wrlat_adj_f2(&mut self) -> WrlatAdjF2W<DdrDenaliCtl298Spec> {
        WrlatAdjF2W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Defines the DFI tCTRL_DELAY timing parameter (in DFI clocks), the delay between a DFI command change and a memory command."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_ctrl_delay_f0(&mut self) -> TdfiCtrlDelayF0W<DdrDenaliCtl298Spec> {
        TdfiCtrlDelayF0W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Defines the DFI tCTRL_DELAY timing parameter (in DFI clocks), the delay between a DFI command change and a memory command."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_ctrl_delay_f1(&mut self) -> TdfiCtrlDelayF1W<DdrDenaliCtl298Spec> {
        TdfiCtrlDelayF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_298::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_298::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl298Spec;
impl crate::RegisterSpec for DdrDenaliCtl298Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_298::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl298Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_298::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl298Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_298 to value 0x0202_0000"]
impl crate::Resettable for DdrDenaliCtl298Spec {
