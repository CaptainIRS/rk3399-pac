...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_210::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl210Spec;
impl crate::RegisterSpec for DdrDenaliCtl210Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_210::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl210Spec {}
#[doc = "`reset()` method sets DDR_DENALI_CTL_210 to value 0"]
impl crate::Resettable for DdrDenaliCtl210Spec {
