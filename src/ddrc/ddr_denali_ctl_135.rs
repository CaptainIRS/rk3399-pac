#[doc = "Register `DDR_DENALI_CTL_135` reader"]
pub type R = crate::R<DdrDenaliCtl135Spec>;
#[doc = "Register `DDR_DENALI_CTL_135` writer"]
pub type W = crate::W<DdrDenaliCtl135Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr1_data_f1_0(&mut self) -> Mr1DataF1_0W<DdrDenaliCtl135Spec> {
        Mr1DataF1_0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Data to program into memory mode register 2 for chip select 0 for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn mr2_data_f1_0(&mut self) -> Mr2DataF1_0W<DdrDenaliCtl135Spec> {
        Mr2DataF1_0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_135::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_135::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl135Spec;
impl crate::RegisterSpec for DdrDenaliCtl135Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_135::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl135Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_135::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl135Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_135 to value 0"]
impl crate::Resettable for DdrDenaliCtl135Spec {
