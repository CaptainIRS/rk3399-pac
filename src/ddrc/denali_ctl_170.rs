#[doc = "Register `DENALI_CTL_170` reader"]
pub type R = crate::R<DenaliCtl170Spec>;
#[doc = "Register `DENALI_CTL_170` writer"]
pub type W = crate::W<DenaliCtl170Spec>;
...
impl W {
    ...
    pub fn zq_calstart_norm_threshold_f1(
        &mut self,
    ) -> ZqCalstartNormThresholdF1W<DenaliCtl170Spec> {
    ...
    pub fn zq_calstart_high_threshold_f1(
        &mut self,
    ) -> ZqCalstartHighThresholdF1W<DenaliCtl170Spec> {
        ZqCalstartHighThresholdF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_170::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_170::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl170Spec;
impl crate::RegisterSpec for DenaliCtl170Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_170::R`](R) reader structure"]
impl crate::Readable for DenaliCtl170Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_170::W`](W) writer structure"]
impl crate::Writable for DenaliCtl170Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_170 to value 0"]
impl crate::Resettable for DenaliCtl170Spec {
