#[doc = "Register `DENALI_CTL_153` reader"]
pub type R = crate::R<DenaliCtl153Spec>;
#[doc = "Register `DENALI_CTL_153` writer"]
pub type W = crate::W<DenaliCtl153Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr3_data_f2_1(&mut self) -> Mr3DataF2_1W<DenaliCtl153Spec> {
        Mr3DataF2_1W::new(self, 0)
    }
    #[doc = "Bits 24:31 - Data to program into memory mode register 11 for chip select 1 for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn mr11_data_f0_1(&mut self) -> Mr11DataF0_1W<DenaliCtl153Spec> {
        Mr11DataF0_1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_153::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_153::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl153Spec;
impl crate::RegisterSpec for DenaliCtl153Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_153::R`](R) reader structure"]
impl crate::Readable for DenaliCtl153Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_153::W`](W) writer structure"]
impl crate::Writable for DenaliCtl153Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_153 to value 0"]
impl crate::Resettable for DenaliCtl153Spec {
