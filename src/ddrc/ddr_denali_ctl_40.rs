#[doc = "Register `DDR_DENALI_CTL_40` reader"]
pub type R = crate::R<DdrDenaliCtl40Spec>;
#[doc = "Register `DDR_DENALI_CTL_40` writer"]
pub type W = crate::W<DdrDenaliCtl40Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn twr_f1(&mut self) -> TwrF1W<DdrDenaliCtl40Spec> {
        TwrF1W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TRCD value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trcd_f2(&mut self) -> TrcdF2W<DdrDenaliCtl40Spec> {
        TrcdF2W::new(self, 8)
    }
    #[doc = "Bits 16:21 - DRAM TWR value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn twr_f2(&mut self) -> TwrF2W<DdrDenaliCtl40Spec> {
        TwrF2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DRAM TMRR value in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tmrr(&mut self) -> TmrrW<DdrDenaliCtl40Spec> {
        TmrrW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_40::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_40::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl40Spec;
impl crate::RegisterSpec for DdrDenaliCtl40Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_40::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl40Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_40::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl40Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_40 to value 0"]
impl crate::Resettable for DdrDenaliCtl40Spec {
