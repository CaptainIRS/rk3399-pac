#[doc = "Register `DDR_DENALI_CTL_213` reader"]
pub type R = crate::R<DdrDenaliCtl213Spec>;
#[doc = "Register `DDR_DENALI_CTL_213` writer"]
pub type W = crate::W<DdrDenaliCtl213Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn todth_wr(&mut self) -> TodthWrW<DdrDenaliCtl213Spec> {
        TodthWrW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the DRAM minimum ODT high time after an ODT assertion for a read command."]
    #[inline(always)]
    #[must_use]
    pub fn todth_rd(&mut self) -> TodthRdW<DdrDenaliCtl213Spec> {
        TodthRdW::new(self, 8)
    }
    #[doc = "Bit 16 - Enable support of DRAM ODT. When enabled, controller will assert and de-assert ODT output to DRAM as needed."]
    #[inline(always)]
    #[must_use]
    pub fn odt_en_f0(&mut self) -> OdtEnF0W<DdrDenaliCtl213Spec> {
        OdtEnF0W::new(self, 16)
    }
    #[doc = "Bit 24 - Enable support of DRAM ODT. When enabled, controller will assert and de-assert ODT output to DRAM as needed."]
    #[inline(always)]
    #[must_use]
    pub fn odt_en_f1(&mut self) -> OdtEnF1W<DdrDenaliCtl213Spec> {
        OdtEnF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_213::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_213::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl213Spec;
impl crate::RegisterSpec for DdrDenaliCtl213Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_213::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl213Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_213::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl213Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_213 to value 0"]
impl crate::Resettable for DdrDenaliCtl213Spec {
