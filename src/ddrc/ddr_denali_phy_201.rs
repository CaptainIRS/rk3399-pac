#[doc = "Register `DDR_DENALI_PHY_201` reader"]
pub type R = crate::R<DdrDenaliPhy201Spec>;
#[doc = "Register `DDR_DENALI_PHY_201` writer"]
pub type W = crate::W<DdrDenaliPhy201Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq4_fall_slave_delay_1(
        &mut self,
    ) -> PhyRddqsDq4FallSlaveDelay1W<DdrDenaliPhy201Spec> {
    ...
    pub fn phy_rddqs_dq5_rise_slave_delay_1(
        &mut self,
    ) -> PhyRddqsDq5RiseSlaveDelay1W<DdrDenaliPhy201Spec> {
        PhyRddqsDq5RiseSlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_201::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_201::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy201Spec;
impl crate::RegisterSpec for DdrDenaliPhy201Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_201::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy201Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_201::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy201Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_201 to value 0"]
impl crate::Resettable for DdrDenaliPhy201Spec {
