#[doc = "Register `DDR_DENALI_CTL_39` reader"]
pub type R = crate::R<DdrDenaliCtl39Spec>;
#[doc = "Register `DDR_DENALI_CTL_39` writer"]
pub type W = crate::W<DdrDenaliCtl39Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn writeinterp(&mut self) -> WriteinterpW<DdrDenaliCtl39Spec> {
        WriteinterpW::new(self, 0)
    }
    #[doc = "Bits 8:15 - DRAM TRCD value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trcd_f0(&mut self) -> TrcdF0W<DdrDenaliCtl39Spec> {
        TrcdF0W::new(self, 8)
    }
    #[doc = "Bits 16:21 - DRAM TWR value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn twr_f0(&mut self) -> TwrF0W<DdrDenaliCtl39Spec> {
        TwrF0W::new(self, 16)
    }
    #[doc = "Bits 24:31 - DRAM TRCD value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn trcd_f1(&mut self) -> TrcdF1W<DdrDenaliCtl39Spec> {
        TrcdF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_39::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_39::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl39Spec;
impl crate::RegisterSpec for DdrDenaliCtl39Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_39::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl39Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_39::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl39Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_39 to value 0"]
impl crate::Resettable for DdrDenaliCtl39Spec {
