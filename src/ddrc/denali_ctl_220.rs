#[doc = "Register `DENALI_CTL_220` reader"]
pub type R = crate::R<DenaliCtl220Spec>;
#[doc = "Register `DENALI_CTL_220` writer"]
pub type W = crate::W<DenaliCtl220Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn r2w_samecs_dly_f0(&mut self) -> R2wSamecsDlyF0W<DenaliCtl220Spec> {
        R2wSamecsDlyF0W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Additional delay to insert between reads and writes to the same chip select. Program to a non-zero value."]
    #[inline(always)]
    #[must_use]
    pub fn r2w_samecs_dly_f1(&mut self) -> R2wSamecsDlyF1W<DenaliCtl220Spec> {
        R2wSamecsDlyF1W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Additional delay to insert between reads and writes to the same chip select. Program to a non-zero value."]
    #[inline(always)]
    #[must_use]
    pub fn r2w_samecs_dly_f2(&mut self) -> R2wSamecsDlyF2W<DenaliCtl220Spec> {
        R2wSamecsDlyF2W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Additional delay to insert between writes and reads to the same chip select."]
    #[inline(always)]
    #[must_use]
    pub fn w2r_samecs_dly(&mut self) -> W2rSamecsDlyW<DenaliCtl220Spec> {
        W2rSamecsDlyW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_220::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_220::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl220Spec;
impl crate::RegisterSpec for DenaliCtl220Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_220::R`](R) reader structure"]
impl crate::Readable for DenaliCtl220Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_220::W`](W) writer structure"]
impl crate::Writable for DenaliCtl220Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_220 to value 0x0002_0202"]
impl crate::Resettable for DenaliCtl220Spec {
