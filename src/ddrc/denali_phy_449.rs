#[doc = "Register `DENALI_PHY_449` reader"]
pub type R = crate::R<DenaliPhy449Spec>;
#[doc = "Register `DENALI_PHY_449` writer"]
pub type W = crate::W<DenaliPhy449Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq2_slave_delay_3(&mut self) -> PhyRddq2SlaveDelay3W<DenaliPhy449Spec> {
        PhyRddq2SlaveDelay3W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQ3 slave delay setting for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq3_slave_delay_3(&mut self) -> PhyRddq3SlaveDelay3W<DenaliPhy449Spec> {
        PhyRddq3SlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_449::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_449::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy449Spec;
impl crate::RegisterSpec for DenaliPhy449Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_449::R`](R) reader structure"]
impl crate::Readable for DenaliPhy449Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_449::W`](W) writer structure"]
impl crate::Writable for DenaliPhy449Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_449 to value 0"]
impl crate::Resettable for DenaliPhy449Spec {
