#[doc = "Register `DDR_DENALI_PHY_461` reader"]
pub type R = crate::R<DdrDenaliPhy461Spec>;
#[doc = "Register `DDR_DENALI_PHY_461` writer"]
pub type W = crate::W<DdrDenaliPhy461Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dm_fall_slave_delay_3(
        &mut self,
    ) -> PhyRddqsDmFallSlaveDelay3W<DdrDenaliPhy461Spec> {
        PhyRddqsDmFallSlaveDelay3W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQS slave delay setting for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddqs_gate_slave_delay_3(
        &mut self,
    ) -> PhyRddqsGateSlaveDelay3W<DdrDenaliPhy461Spec> {
        PhyRddqsGateSlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_461::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_461::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy461Spec;
impl crate::RegisterSpec for DdrDenaliPhy461Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_461::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy461Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_461::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy461Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_461 to value 0"]
impl crate::Resettable for DdrDenaliPhy461Spec {
