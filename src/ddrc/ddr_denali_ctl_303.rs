#[doc = "Register `DDR_DENALI_CTL_303` reader"]
pub type R = crate::R<DdrDenaliCtl303Spec>;
#[doc = "Register `DDR_DENALI_CTL_303` writer"]
pub type W = crate::W<DdrDenaliCtl303Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_rdlvl_en(&mut self) -> TdfiRdlvlEnW<DdrDenaliCtl303Spec> {
        TdfiRdlvlEnW::new(self, 0)
    }
    #[doc = "Bits 8:17 - Defines the DFI tRDLVL_RR timing parameter (in DFI clocks), the minimum cycles between read commands."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_rdlvl_rr(&mut self) -> TdfiRdlvlRrW<DdrDenaliCtl303Spec> {
        TdfiRdlvlRrW::new(self, 8)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_303::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_303::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl303Spec;
impl crate::RegisterSpec for DdrDenaliCtl303Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_303::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl303Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_303::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl303Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_303 to value 0"]
impl crate::Resettable for DdrDenaliCtl303Spec {
