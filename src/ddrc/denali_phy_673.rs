#[doc = "Register `DENALI_PHY_673` reader"]
pub type R = crate::R<DenaliPhy673Spec>;
#[doc = "Register `DENALI_PHY_673` writer"]
pub type W = crate::W<DenaliPhy673Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_adr1_clk_wr_slave_delay_1(&mut self) -> PhyAdr1ClkWrSlaveDelay1W<DenaliPhy673Spec> {
        PhyAdr1ClkWrSlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Address slice slave delay setting for address slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr2_clk_wr_slave_delay_1(&mut self) -> PhyAdr2ClkWrSlaveDelay1W<DenaliPhy673Spec> {
        PhyAdr2ClkWrSlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_673::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_673::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy673Spec;
impl crate::RegisterSpec for DenaliPhy673Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_673::R`](R) reader structure"]
impl crate::Readable for DenaliPhy673Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_673::W`](W) writer structure"]
impl crate::Writable for DenaliPhy673Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_673 to value 0"]
impl crate::Resettable for DenaliPhy673Spec {
