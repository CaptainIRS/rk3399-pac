#[doc = "Register `DDR_DENALI_CTL_237` reader"]
pub type R = crate::R<DdrDenaliCtl237Spec>;
#[doc = "Register `DDR_DENALI_CTL_237` writer"]
pub type W = crate::W<DdrDenaliCtl237Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_gate_seq_en(&mut self) -> RdlvlGateSeqEnW<DdrDenaliCtl237Spec> {
        RdlvlGateSeqEnW::new(self, 0)
    }
    #[doc = "Bit 8 - Specifies the PHY support for DFI data eye training. Set to 1 for supported."]
    #[inline(always)]
    #[must_use]
    pub fn dfi_phy_rdlvl_mode(&mut self) -> DfiPhyRdlvlModeW<DdrDenaliCtl237Spec> {
        DfiPhyRdlvlModeW::new(self, 8)
    }
    #[doc = "Bit 16 - Specifies the PHY support for DFI gate training. Set to 1 for supported."]
    #[inline(always)]
    #[must_use]
    pub fn dfi_phy_rdlvl_gate_mode(&mut self) -> DfiPhyRdlvlGateModeW<DdrDenaliCtl237Spec> {
        DfiPhyRdlvlGateModeW::new(self, 16)
    }
    #[doc = "Bit 24 - Enables the use of the dfi_lvl_periodic signal during data eye training. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_periodic(&mut self) -> RdlvlPeriodicW<DdrDenaliCtl237Spec> {
        RdlvlPeriodicW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_237::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_237::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl237Spec;
impl crate::RegisterSpec for DdrDenaliCtl237Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_237::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl237Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_237::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl237Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_237 to value 0"]
impl crate::Resettable for DdrDenaliCtl237Spec {
