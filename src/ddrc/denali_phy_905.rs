#[doc = "Register `DENALI_PHY_905` reader"]
pub type R = crate::R<DenaliPhy905Spec>;
#[doc = "Register `DENALI_PHY_905` writer"]
pub type W = crate::W<DenaliPhy905Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_calvl_cs_map(&mut self) -> PhyCalvlCsMapW<DenaliPhy905Spec> {
    ...
    pub fn phy_grp_slv_dly_enc_obs_select(
        &mut self,
    ) -> PhyGrpSlvDlyEncObsSelectW<DenaliPhy905Spec> {
        PhyGrpSlvDlyEncObsSelectW::new(self, 8)
    }
    #[doc = "Bits 24:28 - Select value to map an individual address/control group slice automatic cycle/half_cycle shift settings to the observation register."]
    #[inline(always)]
    #[must_use]
    pub fn phy_grp_shift_obs_select(&mut self) -> PhyGrpShiftObsSelectW<DenaliPhy905Spec> {
        PhyGrpShiftObsSelectW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_905::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_905::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy905Spec;
impl crate::RegisterSpec for DenaliPhy905Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_905::R`](R) reader structure"]
impl crate::Readable for DenaliPhy905Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_905::W`](W) writer structure"]
impl crate::Writable for DenaliPhy905Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_905 to value 0"]
impl crate::Resettable for DenaliPhy905Spec {
