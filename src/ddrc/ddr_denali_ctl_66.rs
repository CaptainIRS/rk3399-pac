#[doc = "Register `DDR_DENALI_CTL_66` reader"]
pub type R = crate::R<DdrDenaliCtl66Spec>;
#[doc = "Register `DDR_DENALI_CTL_66` writer"]
pub type W = crate::W<DdrDenaliCtl66Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcsckeh_f1(&mut self) -> TcsckehF1W<DdrDenaliCtl66Spec> {
        TcsckehF1W::new(self, 0)
    }
    #[doc = "Bits 8:11 - DRAM TCMDCKE value for frequency copy 1 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tcmdcke_f1(&mut self) -> TcmdckeF1W<DdrDenaliCtl66Spec> {
        TcmdckeF1W::new(self, 8)
    }
    #[doc = "Bits 16:19 - DRAM TCKELCMD value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tckelcmd_f2(&mut self) -> TckelcmdF2W<DdrDenaliCtl66Spec> {
        TckelcmdF2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DRAM TCKEHCMD value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tckehcmd_f2(&mut self) -> TckehcmdF2W<DdrDenaliCtl66Spec> {
        TckehcmdF2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_66::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_66::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl66Spec;
impl crate::RegisterSpec for DdrDenaliCtl66Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_66::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl66Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_66::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl66Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_66 to value 0"]
impl crate::Resettable for DdrDenaliCtl66Spec {
