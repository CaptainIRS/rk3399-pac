#[doc = "Register `DDR_DENALI_PHY_900` reader"]
pub type R = crate::R<DdrDenaliPhy900Spec>;
#[doc = "Register `DDR_DENALI_PHY_900` writer"]
pub type W = crate::W<DdrDenaliPhy900Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_cslvl_qtr(&mut self) -> PhyCslvlQtrW<DdrDenaliPhy900Spec> {
        PhyCslvlQtrW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Defines the number of samples to take at each GRP slave delay setting during CS training."]
    #[inline(always)]
    #[must_use]
    pub fn phy_cslvl_capture_cnt(&mut self) -> PhyCslvlCaptureCntW<DdrDenaliPhy900Spec> {
        PhyCslvlCaptureCntW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_900::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_900::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy900Spec;
impl crate::RegisterSpec for DdrDenaliPhy900Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_900::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy900Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_900::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy900Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_900 to value 0"]
impl crate::Resettable for DdrDenaliPhy900Spec {
