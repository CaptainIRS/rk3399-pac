#[doc = "Register `DDR_DENALI_CTL_273` reader"]
pub type R = crate::R<DdrDenaliCtl273Spec>;
#[doc = "Register `DDR_DENALI_CTL_273` writer"]
pub type W = crate::W<DdrDenaliCtl273Spec>;
...
impl W {
    ...
    pub fn calvl_dfi_promote_threshold_f2(
        &mut self,
    ) -> CalvlDfiPromoteThresholdF2W<DdrDenaliCtl273Spec> {
        CalvlDfiPromoteThresholdF2W::new(self, 0)
    }
    #[doc = "Bit 16 - Enables use of the ALLDATAUSED signal for DENALI port 0. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn denali0_alldataused_enable(&mut self) -> Denali0AlldatausedEnableW<DdrDenaliCtl273Spec> {
        Denali0AlldatausedEnableW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_273::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_273::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl273Spec;
impl crate::RegisterSpec for DdrDenaliCtl273Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_273::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl273Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_273::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl273Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_273 to value 0"]
impl crate::Resettable for DdrDenaliCtl273Spec {
