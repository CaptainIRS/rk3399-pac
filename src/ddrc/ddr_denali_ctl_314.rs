#[doc = "Register `DDR_DENALI_CTL_314` reader"]
pub type R = crate::R<DdrDenaliCtl314Spec>;
#[doc = "Register `DDR_DENALI_CTL_314` writer"]
pub type W = crate::W<DdrDenaliCtl314Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_rdcslat_f0(&mut self) -> TdfiRdcslatF0W<DdrDenaliCtl314Spec> {
        TdfiRdcslatF0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Defines the DFI tPHY_WRCSLAT timing parameter (in DFI PHY clocks), the maximum cycles between a write command and a dfi_wrdata_cs_n assertion."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_wrcslat_f0(&mut self) -> TdfiWrcslatF0W<DdrDenaliCtl314Spec> {
        TdfiWrcslatF0W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Defines the DFI tPHY_RDCSLAT timing parameter (in DFI PHY clocks), the maximum cycles between a read command and a dfi_rddata_cs_n assertion."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_rdcslat_f1(&mut self) -> TdfiRdcslatF1W<DdrDenaliCtl314Spec> {
        TdfiRdcslatF1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Defines the DFI tPHY_WRCSLAT timing parameter (in DFI PHY clocks), the maximum cycles between a write command and a dfi_wrdata_cs_n assertion."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_wrcslat_f1(&mut self) -> TdfiWrcslatF1W<DdrDenaliCtl314Spec> {
        TdfiWrcslatF1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_314::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_314::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl314Spec;
impl crate::RegisterSpec for DdrDenaliCtl314Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_314::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl314Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_314::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl314Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_314 to value 0"]
impl crate::Resettable for DdrDenaliCtl314Spec {
