#[doc = "Register `DDR_DENALI_PHY_785` reader"]
pub type R = crate::R<DdrDenaliPhy785Spec>;
#[doc = "Register `DDR_DENALI_PHY_785` writer"]
pub type W = crate::W<DdrDenaliPhy785Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_calvl_rank_ctrl_2(&mut self) -> PhyAdrCalvlRankCtrl2W<DdrDenaliPhy785Spec> {
    ...
    pub fn phy_adr_calvl_num_patterns_2(
        &mut self,
    ) -> PhyAdrCalvlNumPatterns2W<DdrDenaliPhy785Spec> {
        PhyAdrCalvlNumPatterns2W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Number of samples to take at each ADDR slave delay setting during CA training for address slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_calvl_capture_cnt_2(&mut self) -> PhyAdrCalvlCaptureCnt2W<DdrDenaliPhy785Spec> {
    ...
    pub fn phy_adr_calvl_resp_wait_cnt_2(
        &mut self,
    ) -> PhyAdrCalvlRespWaitCnt2W<DdrDenaliPhy785Spec> {
        PhyAdrCalvlRespWaitCnt2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_785::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_785::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy785Spec;
impl crate::RegisterSpec for DdrDenaliPhy785Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_785::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy785Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_785::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy785Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_785 to value 0"]
impl crate::Resettable for DdrDenaliPhy785Spec {
