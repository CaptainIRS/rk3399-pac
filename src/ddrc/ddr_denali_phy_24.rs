#[doc = "Register `DDR_DENALI_PHY_24` reader"]
pub type R = crate::R<DdrDenaliPhy24Spec>;
#[doc = "Register `DDR_DENALI_PHY_24` writer"]
pub type W = crate::W<DdrDenaliPhy24Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_rdlvl_op_mode_0(&mut self) -> PhyRdlvlOpMode0W<DdrDenaliPhy24Spec> {
    ...
    pub fn phy_rdlvl_rddqs_dq_obs_select_0(
        &mut self,
    ) -> PhyRdlvlRddqsDqObsSelect0W<DdrDenaliPhy24Spec> {
        PhyRdlvlRddqsDqObsSelect0W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Per-bit mask for read leveling for slice 0. If all bits are not used, only 1 bit should be cleared to 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rdlvl_data_mask_0(&mut self) -> PhyRdlvlDataMask0W<DdrDenaliPhy24Spec> {
        PhyRdlvlDataMask0W::new(self, 16)
    }
    #[doc = "Bits 24:29 - Defines the write/read burst length in bytes during the write data leveling sequence for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_burst_cnt_0(&mut self) -> PhyWdqlvlBurstCnt0W<DdrDenaliPhy24Spec> {
        PhyWdqlvlBurstCnt0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_24::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_24::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy24Spec;
impl crate::RegisterSpec for DdrDenaliPhy24Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_24::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy24Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_24::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy24Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_24 to value 0"]
impl crate::Resettable for DdrDenaliPhy24Spec {
