#[doc = "Register `DDR_DENALI_CTL_19` reader"]
pub type R = crate::R<DdrDenaliCtl19Spec>;
#[doc = "Register `DDR_DENALI_CTL_19` writer"]
pub type W = crate::W<DdrDenaliCtl19Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfibus_freq_f0(&mut self) -> DfibusFreqF0W<DdrDenaliCtl19Spec> {
        DfibusFreqF0W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Defines the DFI bus frequency for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn dfibus_freq_f1(&mut self) -> DfibusFreqF1W<DdrDenaliCtl19Spec> {
        DfibusFreqF1W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Defines the DFI bus frequency for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn dfibus_freq_f2(&mut self) -> DfibusFreqF2W<DdrDenaliCtl19Spec> {
        DfibusFreqF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_19::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_19::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl19Spec;
impl crate::RegisterSpec for DdrDenaliCtl19Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_19::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl19Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_19::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl19Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_19 to value 0"]
impl crate::Resettable for DdrDenaliCtl19Spec {
