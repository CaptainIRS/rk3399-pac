#[doc = "Register `DDR_DENALI_CTL_85` reader"]
pub type R = crate::R<DdrDenaliCtl85Spec>;
#[doc = "Register `DDR_DENALI_CTL_85` writer"]
pub type W = crate::W<DdrDenaliCtl85Spec>;
...
impl W {
    ...
    pub fn phymstr_dfi_promote_threshold_f1(
        &mut self,
    ) -> PhymstrDfiPromoteThresholdF1W<DdrDenaliCtl85Spec> {
        PhymstrDfiPromoteThresholdF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Defines the DFI tPHYMSTR_MAX timing parameter (in DFI clocks), the maximum cycles that dfi_phymstr_req following the assertion of dfi_phymstr_ack can be asserted, for frequency copy 2. If programmed to a non-zero, a timing violation will cause an interrupt and bit (0) set in the PHYMSTR_ERROR_STATUS parameter."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_phymstr_max_f2(&mut self) -> TdfiPhymstrMaxF2W<DdrDenaliCtl85Spec> {
        TdfiPhymstrMaxF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_85::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_85::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl85Spec;
impl crate::RegisterSpec for DdrDenaliCtl85Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_85::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl85Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_85::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl85Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_85 to value 0"]
impl crate::Resettable for DdrDenaliCtl85Spec {
