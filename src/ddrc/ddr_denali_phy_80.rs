#[doc = "Register `DDR_DENALI_PHY_80` reader"]
pub type R = crate::R<DdrDenaliPhy80Spec>;
#[doc = "Register `DDR_DENALI_PHY_80` writer"]
pub type W = crate::W<DdrDenaliPhy80Spec>;
...
impl W {
    ...
    pub fn phy_gtlvl_rddqs_slv_dly_start_0(
        &mut self,
    ) -> PhyGtlvlRddqsSlvDlyStart0W<DdrDenaliPhy80Spec> {
        PhyGtlvlRddqsSlvDlyStart0W::new(self, 0)
    }
    #[doc = "Bits 16:19 - Initial read DQS gate cycle delay from dfi_rddata_en during gate training for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_lat_adj_start_0(&mut self) -> PhyGtlvlLatAdjStart0W<DdrDenaliPhy80Spec> {
        PhyGtlvlLatAdjStart0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_80::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_80::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy80Spec;
impl crate::RegisterSpec for DdrDenaliPhy80Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_80::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy80Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_80::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy80Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_80 to value 0"]
impl crate::Resettable for DdrDenaliPhy80Spec {
