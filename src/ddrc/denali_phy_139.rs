#[doc = "Register `DENALI_PHY_139` reader"]
pub type R = crate::R<DenaliPhy139Spec>;
#[doc = "Register `DENALI_PHY_139` writer"]
pub type W = crate::W<DenaliPhy139Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq_bypass_slave_delay_1(
        &mut self,
    ) -> PhyRddqsDqBypassSlaveDelay1W<DenaliPhy139Spec> {
        PhyRddqsDqBypassSlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:20 - Number of cycles to wait for the DQS gate to close before flagging an error for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_error_delay_select_1(&mut self) -> PhyGateErrorDelaySelect1W<DenaliPhy139Spec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_snap_obs_regs_1(&mut self) -> ScPhySnapObsRegs1W<DenaliPhy139Spec> {
        ScPhySnapObsRegs1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_139::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_139::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy139Spec;
impl crate::RegisterSpec for DenaliPhy139Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_139::R`](R) reader structure"]
impl crate::Readable for DenaliPhy139Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_139::W`](W) writer structure"]
impl crate::Writable for DenaliPhy139Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_139 to value 0"]
impl crate::Resettable for DenaliPhy139Spec {
