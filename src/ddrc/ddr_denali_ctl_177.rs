#[doc = "Register `DDR_DENALI_CTL_177` reader"]
pub type R = crate::R<DdrDenaliCtl177Spec>;
#[doc = "Register `DDR_DENALI_CTL_177` writer"]
pub type W = crate::W<DdrDenaliCtl177Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zq_calstart_timeout_f2(&mut self) -> ZqCalstartTimeoutF2W<DdrDenaliCtl177Spec> {
        ZqCalstartTimeoutF2W::new(self, 0)
    }
    #[doc = "Bits 16:31 - ZQ LATCH number of long counts until the timeout is asserted for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn zq_callatch_timeout_f2(&mut self) -> ZqCallatchTimeoutF2W<DdrDenaliCtl177Spec> {
        ZqCallatchTimeoutF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_177::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_177::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl177Spec;
impl crate::RegisterSpec for DdrDenaliCtl177Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_177::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl177Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_177::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl177Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_177 to value 0"]
impl crate::Resettable for DdrDenaliCtl177Spec {
