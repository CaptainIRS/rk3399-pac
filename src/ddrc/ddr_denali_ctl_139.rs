#[doc = "Register `DDR_DENALI_CTL_139` reader"]
pub type R = crate::R<DdrDenaliCtl139Spec>;
#[doc = "Register `DDR_DENALI_CTL_139` writer"]
pub type W = crate::W<DdrDenaliCtl139Spec>;
...
#[doc = "Field `MR8_DATA_0` reader - Data read from MR8 for chip select 0. READ-ONLY"]
...
impl R {
    ...
    #[doc = "Bits 16:23 - Data read from MR8 for chip select 0. READ-ONLY"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mr3_data_f2_0(&mut self) -> Mr3DataF2_0W<DdrDenaliCtl139Spec> {
        Mr3DataF2_0W::new(self, 0)
    }
    #[doc = "Bits 24:31 - Data to program into memory mode register 11 for chip select 0 for frequency copy 0."]
    #[inline(always)]
    #[must_use]
    pub fn mr11_data_f0_0(&mut self) -> Mr11DataF0_0W<DdrDenaliCtl139Spec> {
        Mr11DataF0_0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_139::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_139::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl139Spec;
impl crate::RegisterSpec for DdrDenaliCtl139Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_139::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl139Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_139::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl139Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_139 to value 0"]
impl crate::Resettable for DdrDenaliCtl139Spec {
