#[doc = "Register `DDR_DENALI_CTL_173` reader"]
pub type R = crate::R<DdrDenaliCtl173Spec>;
#[doc = "Register `DDR_DENALI_CTL_173` writer"]
pub type W = crate::W<DdrDenaliCtl173Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zq_callatch_timeout_f1(&mut self) -> ZqCallatchTimeoutF1W<DdrDenaliCtl173Spec> {
        ZqCallatchTimeoutF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - ZQ CS number of long counts until the timeout is asserted for frequency copy 1."]
    #[inline(always)]
    #[must_use]
    pub fn zq_cs_timeout_f1(&mut self) -> ZqCsTimeoutF1W<DdrDenaliCtl173Spec> {
        ZqCsTimeoutF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_173::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_173::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl173Spec;
impl crate::RegisterSpec for DdrDenaliCtl173Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_173::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl173Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_173::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl173Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_173 to value 0"]
impl crate::Resettable for DdrDenaliCtl173Spec {
