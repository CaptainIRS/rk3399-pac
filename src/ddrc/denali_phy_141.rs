#[doc = "Register `DENALI_PHY_141` reader"]
pub type R = crate::R<DenaliPhy141Spec>;
#[doc = "Register `DENALI_PHY_141` writer"]
pub type W = crate::W<DenaliPhy141Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_smpl2_slave_delay_1(&mut self) -> PhyGateSmpl2SlaveDelay1W<DenaliPhy141Spec> {
        PhyGateSmpl2SlaveDelay1W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Control the on the fly gate adjustment for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn on_fly_gate_adjust_en_1(&mut self) -> OnFlyGateAdjustEn1W<DenaliPhy141Spec> {
        OnFlyGateAdjustEn1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_141::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_141::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy141Spec;
impl crate::RegisterSpec for DenaliPhy141Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_141::R`](R) reader structure"]
impl crate::Readable for DenaliPhy141Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_141::W`](W) writer structure"]
impl crate::Writable for DenaliPhy141Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_141 to value 0"]
impl crate::Resettable for DenaliPhy141Spec {
