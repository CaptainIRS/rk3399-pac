#[doc = "Register `DDR_DENALI_PHY_913` reader"]
pub type R = crate::R<DdrDenaliPhy913Spec>;
#[doc = "Register `DDR_DENALI_PHY_913` writer"]
pub type W = crate::W<DdrDenaliPhy913Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_low_freq_sel(&mut self) -> PhyLowFreqSelW<DdrDenaliPhy913Spec> {
        PhyLowFreqSelW::new(self, 0)
    }
    #[doc = "Bits 8:19 - Pad VREF control settings for DQ slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_pad_vref_ctrl_dq_0(&mut self) -> PhyPadVrefCtrlDq0W<DdrDenaliPhy913Spec> {
        PhyPadVrefCtrlDq0W::new(self, 8)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_913::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_913::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy913Spec;
impl crate::RegisterSpec for DdrDenaliPhy913Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_913::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy913Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_913::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy913Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_913 to value 0"]
impl crate::Resettable for DdrDenaliPhy913Spec {
