#[doc = "Register `DDR_DENALI_PHY_13` reader"]
pub type R = crate::R<DdrDenaliPhy13Spec>;
#[doc = "Register `DDR_DENALI_PHY_13` writer"]
pub type W = crate::W<DdrDenaliPhy13Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_smpl2_slave_delay_0(&mut self) -> PhyGateSmpl2SlaveDelay0W<DdrDenaliPhy13Spec> {
        PhyGateSmpl2SlaveDelay0W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Control the on the fly gate adjustment for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn on_fly_gate_adjust_en_0(&mut self) -> OnFlyGateAdjustEn0W<DdrDenaliPhy13Spec> {
        OnFlyGateAdjustEn0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_13::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_13::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy13Spec;
impl crate::RegisterSpec for DdrDenaliPhy13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_13::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy13Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_13::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy13Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_13 to value 0"]
impl crate::Resettable for DdrDenaliPhy13Spec {
