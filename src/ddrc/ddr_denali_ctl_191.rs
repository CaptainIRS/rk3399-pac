#[doc = "Register `DDR_DENALI_CTL_191` reader"]
pub type R = crate::R<DdrDenaliCtl191Spec>;
#[doc = "Register `DDR_DENALI_CTL_191` writer"]
pub type W = crate::W<DdrDenaliCtl191Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn col_diff(&mut self) -> ColDiffW<DdrDenaliCtl191Spec> {
        ColDiffW::new(self, 0)
    }
    #[doc = "Bits 8:12 - Defines the LSbit of the bank address within the page of the user address when the BANK_ADDR_INTLV_EN parameter is set."]
    #[inline(always)]
    #[must_use]
    pub fn bank_start_bit(&mut self) -> BankStartBitW<DdrDenaliCtl191Spec> {
        BankStartBitW::new(self, 8)
    }
    #[doc = "Bit 16 - Enables the capability to interleave the bank address within the row address bits. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn bank_addr_intlv_en(&mut self) -> BankAddrIntlvEnW<DdrDenaliCtl191Spec> {
        BankAddrIntlvEnW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Location of the auto pre-charge bit in the DRAM address."]
    #[inline(always)]
    #[must_use]
    pub fn aprebit(&mut self) -> AprebitW<DdrDenaliCtl191Spec> {
        AprebitW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_191::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_191::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl191Spec;
impl crate::RegisterSpec for DdrDenaliCtl191Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_191::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl191Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_191::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl191Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_191 to value 0x0a00_0000"]
impl crate::Resettable for DdrDenaliCtl191Spec {
