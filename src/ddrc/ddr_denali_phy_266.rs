#[doc = "Register `DDR_DENALI_PHY_266` reader"]
pub type R = crate::R<DdrDenaliPhy266Spec>;
#[doc = "Register `DDR_DENALI_PHY_266` writer"]
pub type W = crate::W<DdrDenaliPhy266Spec>;
...
impl W {
    ...
    pub fn phy_lp4_boot_rddqs_latency_adjust_2(
        &mut self,
    ) -> PhyLp4BootRddqsLatencyAdjust2W<DdrDenaliPhy266Spec> {
        PhyLp4BootRddqsLatencyAdjust2W::new(self, 0)
    }
    #[doc = "Bits 8:14 - Loopback control bits for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lpbk_control_2(&mut self) -> PhyLpbkControl2W<DdrDenaliPhy266Spec> {
        PhyLpbkControl2W::new(self, 8)
    }
    #[doc = "Bit 16 - data slice power reduction disable for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_slice_pwr_rdc_disable_2(&mut self) -> PhySlicePwrRdcDisable2W<DdrDenaliPhy266Spec> {
        PhySlicePwrRdcDisable2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_266::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_266::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy266Spec;
impl crate::RegisterSpec for DdrDenaliPhy266Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_266::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy266Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_266::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy266Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_266 to value 0"]
impl crate::Resettable for DdrDenaliPhy266Spec {
