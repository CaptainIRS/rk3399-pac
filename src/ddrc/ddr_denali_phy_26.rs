#[doc = "Register `DDR_DENALI_PHY_26` reader"]
pub type R = crate::R<DdrDenaliPhy26Spec>;
#[doc = "Register `DDR_DENALI_PHY_26` writer"]
pub type W = crate::W<DdrDenaliPhy26Spec>;
...
#[doc = "Field `SC_PHY_WDQLVL_CLR_PREV_RESULTS_0` writer - Clears the previous result value to allow a clean slate comparison for future write DQ leveling results for slice 0. Set to 1 to trigger."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_dqdm_obs_select_0(&mut self) -> PhyWdqlvlDqdmObsSelect0W<DdrDenaliPhy26Spec> {
        PhyWdqlvlDqdmObsSelect0W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the step granularity for the logic to use once an edge is found. When this occurs, the logic jumps back to the previous invalid value and uses this step size to determine a more accurate delay value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_qtr_dly_step_0(&mut self) -> PhyWdqlvlQtrDlyStep0W<DdrDenaliPhy26Spec> {
        PhyWdqlvlQtrDlyStep0W::new(self, 8)
    }
    #[doc = "Bit 16 - Clears the previous result value to allow a clean slate comparison for future write DQ leveling results for slice 0. Set to 1 to trigger."]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_wdqlvl_clr_prev_results_0(
        &mut self,
    ) -> ScPhyWdqlvlClrPrevResults0W<DdrDenaliPhy26Spec> {
        ScPhyWdqlvlClrPrevResults0W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_26::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_26::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy26Spec;
impl crate::RegisterSpec for DdrDenaliPhy26Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_26::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy26Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_26::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy26Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_26 to value 0"]
impl crate::Resettable for DdrDenaliPhy26Spec {
