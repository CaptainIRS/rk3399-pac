#[doc = "Register `DDR_DENALI_PHY_153` reader"]
pub type R = crate::R<DdrDenaliPhy153Spec>;
#[doc = "Register `DDR_DENALI_PHY_153` writer"]
pub type W = crate::W<DdrDenaliPhy153Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_patt_1(&mut self) -> PhyWdqlvlPatt1W<DdrDenaliPhy153Spec> {
    ...
    pub fn phy_wdqlvl_dqdm_slv_dly_jump_offset_1(
        &mut self,
    ) -> PhyWdqlvlDqdmSlvDlyJumpOffset1W<DdrDenaliPhy153Spec> {
        PhyWdqlvlDqdmSlvDlyJumpOffset1W::new(self, 8)
    }
    #[doc = "Bits 24:27 - Number of cycles to wait after changing the DQ slave delay setting during write data leveling for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wdqlvl_updt_wait_cnt_1(&mut self) -> PhyWdqlvlUpdtWaitCnt1W<DdrDenaliPhy153Spec> {
        PhyWdqlvlUpdtWaitCnt1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_153::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_153::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy153Spec;
impl crate::RegisterSpec for DdrDenaliPhy153Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_153::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy153Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_153::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy153Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_153 to value 0"]
impl crate::Resettable for DdrDenaliPhy153Spec {
