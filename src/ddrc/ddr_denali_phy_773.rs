#[doc = "Register `DDR_DENALI_PHY_773` reader"]
...
impl W {
    ...
    pub fn phy_adr_slave_loop_cnt_update_2(
        &mut self,
    ) -> PhyAdrSlaveLoopCntUpdate2W<DdrDenaliPhy773Spec> {
    ...
    pub fn phy_adr_slv_dly_enc_obs_select_2(
        &mut self,
    ) -> PhyAdrSlvDlyEncObsSelect2W<DdrDenaliPhy773Spec> {
        PhyAdrSlvDlyEncObsSelect2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_773::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_773::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy773Spec;
impl crate::RegisterSpec for DdrDenaliPhy773Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_773::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy773Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_773::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy773Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_773 to value 0"]
impl crate::Resettable for DdrDenaliPhy773Spec {
