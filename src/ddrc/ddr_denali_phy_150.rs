#[doc = "Register `DDR_DENALI_PHY_150` reader"]
pub type R = crate::R<DdrDenaliPhy150Spec>;
#[doc = "Register `DDR_DENALI_PHY_150` writer"]
pub type W = crate::W<DdrDenaliPhy150Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_capture_cnt_1(&mut self) -> PhyWrlvlCaptureCnt1W<DdrDenaliPhy150Spec> {
        PhyWrlvlCaptureCnt1W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Number of cycles to wait after changing DQS slave delay setting during write leveling for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_updt_wait_cnt_1(&mut self) -> PhyWrlvlUpdtWaitCnt1W<DdrDenaliPhy150Spec> {
        PhyWrlvlUpdtWaitCnt1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_phy_150::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_phy_150::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliPhy150Spec;
impl crate::RegisterSpec for DdrDenaliPhy150Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_phy_150::R`](R) reader structure"]
impl crate::Readable for DdrDenaliPhy150Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_phy_150::W`](W) writer structure"]
impl crate::Writable for DdrDenaliPhy150Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_PHY_150 to value 0"]
impl crate::Resettable for DdrDenaliPhy150Spec {
