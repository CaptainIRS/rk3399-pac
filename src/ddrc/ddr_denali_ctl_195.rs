#[doc = "Register `DDR_DENALI_CTL_195` reader"]
pub type R = crate::R<DdrDenaliCtl195Spec>;
#[doc = "Register `DDR_DENALI_CTL_195` writer"]
pub type W = crate::W<DdrDenaliCtl195Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn num_q_entries_act_disable(&mut self) -> NumQEntriesActDisableW<DdrDenaliCtl195Spec> {
        NumQEntriesActDisableW::new(self, 0)
    }
    #[doc = "Bit 8 - Enable command swapping logic in execution unit. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn swap_en(&mut self) -> SwapEnW<DdrDenaliCtl195Spec> {
        SwapEnW::new(self, 8)
    }
    #[doc = "Bit 16 - Disable read data interleaving for commands from the same port, regardless of the requestor ID."]
    #[inline(always)]
    #[must_use]
    pub fn disable_rd_interleave(&mut self) -> DisableRdInterleaveW<DdrDenaliCtl195Spec> {
        DisableRdInterleaveW::new(self, 16)
    }
    #[doc = "Bits 24:25 - Inhibit command types from being executed from the command queue. Clear to 0 to enable any command, program to 1 to inhibit read/write and bank commands, program to 2 to inhibit MRR and peripheral MRR commands, or program to 3 to inhibit MRR and read/write commands."]
    #[inline(always)]
    #[must_use]
    pub fn inhibit_dram_cmd(&mut self) -> InhibitDramCmdW<DdrDenaliCtl195Spec> {
        InhibitDramCmdW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_denali_ctl_195::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_denali_ctl_195::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrDenaliCtl195Spec;
impl crate::RegisterSpec for DdrDenaliCtl195Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_denali_ctl_195::R`](R) reader structure"]
impl crate::Readable for DdrDenaliCtl195Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_denali_ctl_195::W`](W) writer structure"]
impl crate::Writable for DdrDenaliCtl195Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_DENALI_CTL_195 to value 0"]
impl crate::Resettable for DdrDenaliCtl195Spec {
