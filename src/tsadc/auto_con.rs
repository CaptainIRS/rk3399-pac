#[doc = "Register `AUTO_CON` reader"]
pub type R = crate::R<AutoConSpec>;
#[doc = "Register `AUTO_CON` writer"]
pub type W = crate::W<AutoConSpec>;
#[doc = "\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn auto_en(&mut self) -> AutoEnW<AutoConSpec> {
        AutoEnW::new(self, 0)
    }
    #[doc = "Bit 1 - temperature coefficient"]
    #[inline(always)]
    #[must_use]
    pub fn tsadc_q_sel(&mut self) -> TsadcQSelW<AutoConSpec> {
        TsadcQSelW::new(self, 1)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn src0_en(&mut self) -> Src0EnW<AutoConSpec> {
        Src0EnW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn src1_en(&mut self) -> Src1EnW<AutoConSpec> {
        Src1EnW::new(self, 5)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn tshut_prolarity(&mut self) -> TshutProlarityW<AutoConSpec> {
        TshutProlarityW::new(self, 8)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn src0_lt_en(&mut self) -> Src0LtEnW<AutoConSpec> {
        Src0LtEnW::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn src1_lt_en(&mut self) -> Src1LtEnW<AutoConSpec> {
        Src1LtEnW::new(self, 13)
    }
    #[doc = "Bit 24 - last_tshut_2gpio for hardware reset\n\nTSHUT status.\n\nThis bit will set to 1 when tshut is valid, and only be cleared when\n\napplication write 1 to it.\n\nThis bit will not be cleared by system reset."]
    #[inline(always)]
    #[must_use]
    pub fn last_tshut_2gpio(&mut self) -> LastTshut2gpioW<AutoConSpec> {
        LastTshut2gpioW::new(self, 24)
    }
    #[doc = "Bit 25 - last_tshut_2cru for cru first/second reset\n\nTSHUT status.\n\nThis bit will set to 1 when tshut is valid, and only be cleared when\n\napplication write 1 to it.\n\nThis bit will not be cleared by system reset."]
    #[inline(always)]
    #[must_use]
    pub fn last_tshut_2cru(&mut self) -> LastTshut2cruW<AutoConSpec> {
        LastTshut2cruW::new(self, 25)
    }
}
#[doc = "TSADC auto mode control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`auto_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`auto_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AutoConSpec;
impl crate::RegisterSpec for AutoConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`auto_con::R`](R) reader structure"]
impl crate::Readable for AutoConSpec {}
#[doc = "`write(|w| ..)` method takes [`auto_con::W`](W) writer structure"]
impl crate::Writable for AutoConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AUTO_CON to value 0"]
impl crate::Resettable for AutoConSpec {
