...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ht_inten_src0(&mut self) -> HtIntenSrc0W<IntEnSpec> {
        HtIntenSrc0W::new(self, 0)
    }
    #[doc = "Bit 1 - high temperature interrupt enable for src1"]
    #[inline(always)]
    #[must_use]
    pub fn ht_inten_src1(&mut self) -> HtIntenSrc1W<IntEnSpec> {
        HtIntenSrc1W::new(self, 1)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn tshut_2gpio_en_src0(&mut self) -> Tshut2gpioEnSrc0W<IntEnSpec> {
        Tshut2gpioEnSrc0W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn tshut_2gpio_en_src1(&mut self) -> Tshut2gpioEnSrc1W<IntEnSpec> {
        Tshut2gpioEnSrc1W::new(self, 5)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn tshut_2cru_en_src0(&mut self) -> Tshut2cruEnSrc0W<IntEnSpec> {
        Tshut2cruEnSrc0W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn tshut_2cru_en_src1(&mut self) -> Tshut2cruEnSrc1W<IntEnSpec> {
        Tshut2cruEnSrc1W::new(self, 9)
    }
    #[doc = "Bit 12 - low temperature interrupt enable for src0"]
    #[inline(always)]
    #[must_use]
    pub fn lt_inten_src0(&mut self) -> LtIntenSrc0W<IntEnSpec> {
        LtIntenSrc0W::new(self, 12)
    }
    #[doc = "Bit 13 - low temperature interrupt enable for src1"]
    #[inline(always)]
    #[must_use]
    pub fn lt_inten_src1(&mut self) -> LtIntenSrc1W<IntEnSpec> {
        LtIntenSrc1W::new(self, 13)
    }
    #[doc = "Bit 16 - eoc_Interrupt enable.\n\neoc_interrupt enable in user defined mode"]
    #[inline(always)]
    #[must_use]
    pub fn eoc_int_en(&mut self) -> EocIntEnW<IntEnSpec> {
