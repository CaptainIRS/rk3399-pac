#[doc = "Register `TSADC_USER_CON` reader"]
pub type R = crate::R<TsadcUserConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_input_src_sel(&mut self) -> AdcInputSrcSelW<TsadcUserConSpec> {
        AdcInputSrcSelW::new(self, 0)
    }
    #[doc = "Bit 3 - ADC power down control bit"]
    #[inline(always)]
    #[must_use]
    pub fn adc_power_ctrl(&mut self) -> AdcPowerCtrlW<TsadcUserConSpec> {
...
= 1'b1 take effect."]
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> StartW<TsadcUserConSpec> {
        StartW::new(self, 5)
    }
    #[doc = "Bits 6:11 - interleave between power down and start of conversion"]
    #[inline(always)]
    #[must_use]
    pub fn inter_pd_soc(&mut self) -> InterPdSocW<TsadcUserConSpec> {
        InterPdSocW::new(self, 6)
    }
}
#[doc = "The control register of A/D Converter.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tsadc_user_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tsadc_user_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TsadcUserConSpec;
impl crate::RegisterSpec for TsadcUserConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tsadc_user_con::R`](R) reader structure"]
impl crate::Readable for TsadcUserConSpec {}
#[doc = "`write(|w| ..)` method takes [`tsadc_user_con::W`](W) writer structure"]
impl crate::Writable for TsadcUserConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TSADC_USER_CON to value 0x0208"]
impl crate::Resettable for TsadcUserConSpec {
