#[doc = "Register `AN_ADV` reader"]
pub type R = crate::R<AnAdvSpec>;
#[doc = "Register `AN_ADV` writer"]
pub type W = crate::W<AnAdvSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fd(&mut self) -> FdW<AnAdvSpec> {
        FdW::new(self, 5)
    }
    #[doc = "Bit 6 - Half-Duplex\n\nThis bit, when set high, indicates that the GMAC supports Half-\n\nDuplex. This bit is tied to low (and RO) when the GMAC is\n\nconfigured for Full-Duplex-only operation."]
    #[inline(always)]
    #[must_use]
    pub fn hd(&mut self) -> HdW<AnAdvSpec> {
        HdW::new(self, 6)
    }
    #[doc = "Bits 7:8 - Pause Encoding\n\nThese 2 bits provide an encoding for the PAUSE bits, indicating\n\nthat the GMAC is capable of configuring the PAUSE function as\n\ndefined in IEEE 802.3x."]
    #[inline(always)]
    #[must_use]
    pub fn pse(&mut self) -> PseW<AnAdvSpec> {
        PseW::new(self, 7)
    }
    #[doc = "Bits 12:13 - Remote Fault Encoding\n\nThese 2 bits provide a remote fault encoding, indicating to a link\n\npartner that a fault or error condition has occurred."]
    #[inline(always)]
    #[must_use]
    pub fn rfe(&mut self) -> RfeW<AnAdvSpec> {
        RfeW::new(self, 12)
    }
}
#[doc = "Auto Negotiation Advertisement Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`an_adv::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`an_adv::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AnAdvSpec;
impl crate::RegisterSpec for AnAdvSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`an_adv::R`](R) reader structure"]
impl crate::Readable for AnAdvSpec {}
#[doc = "`write(|w| ..)` method takes [`an_adv::W`](W) writer structure"]
impl crate::Writable for AnAdvSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AN_ADV to value 0x01e0"]
impl crate::Resettable for AnAdvSpec {
