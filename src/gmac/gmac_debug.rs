#[doc = "Register `GMAC_DEBUG` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rfiford(&mut self) -> RfifordW<GmacDebugSpec> {
        RfifordW::new(self, 5)
    }
    #[doc = "Bits 8:9 - This gives the status of the RxFIFO Fill-level:"]
    #[inline(always)]
...
pub struct GmacDebugSpec;
impl crate::RegisterSpec for GmacDebugSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gmac_debug::R`](R) reader structure"]
impl crate::Readable for GmacDebugSpec {}
#[doc = "`write(|w| ..)` method takes [`gmac_debug::W`](W) writer structure"]
impl crate::Writable for GmacDebugSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GMAC_DEBUG to value 0"]
impl crate::Resettable for GmacDebugSpec {
