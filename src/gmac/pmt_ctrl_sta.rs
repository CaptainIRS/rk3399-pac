#[doc = "Register `PMT_CTRL_STA` reader"]
pub type R = crate::R<PmtCtrlStaSpec>;
#[doc = "Register `PMT_CTRL_STA` writer"]
pub type W = crate::W<PmtCtrlStaSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd(&mut self) -> PdW<PmtCtrlStaSpec> {
        PdW::new(self, 0)
    }
    #[doc = "Bit 1 - Magic Packet Enable\n\nWhen set, enables generation of a power management event due\n\nto Magic Packet reception."]
    #[inline(always)]
    #[must_use]
    pub fn mpe(&mut self) -> MpeW<PmtCtrlStaSpec> {
        MpeW::new(self, 1)
    }
    #[doc = "Bit 2 - Wake-Up Frame Enable\n\nWhen set, enables generation of a power management event due\n\nto wake-up frame reception."]
    #[inline(always)]
    #[must_use]
    pub fn wfe(&mut self) -> WfeW<PmtCtrlStaSpec> {
        WfeW::new(self, 2)
    }
    #[doc = "Bit 9 - Global Unicast\n\nWhen set, enables any unicast packet filtered by the GMAC (DAF)\n\naddress recognition to be a wake-up frame."]
    #[inline(always)]
    #[must_use]
    pub fn gu(&mut self) -> GuW<PmtCtrlStaSpec> {
        GuW::new(self, 9)
    }
    #[doc = "Bit 31 - Wake-Up Frame Filter Register Pointer Reset\n\nWhen set, resets the Remote Wake-up Frame Filter register\n\npointer to 3'b000. It is automatically cleared after 1 clock cycle."]
    #[inline(always)]
    #[must_use]
    pub fn wffrpr(&mut self) -> WffrprW<PmtCtrlStaSpec> {
        WffrprW::new(self, 31)
    }
}
...
pub struct PmtCtrlStaSpec;
impl crate::RegisterSpec for PmtCtrlStaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmt_ctrl_sta::R`](R) reader structure"]
impl crate::Readable for PmtCtrlStaSpec {}
#[doc = "`write(|w| ..)` method takes [`pmt_ctrl_sta::W`](W) writer structure"]
impl crate::Writable for PmtCtrlStaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x8000_0000;
}
#[doc = "`reset()` method sets PMT_CTRL_STA to value 0"]
impl crate::Resettable for PmtCtrlStaSpec {
