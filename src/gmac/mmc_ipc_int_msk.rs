#[doc = "Register `MMC_IPC_INT_MSK` reader"]
pub type R = crate::R<MmcIpcIntMskSpec>;
#[doc = "Register `MMC_IPC_INT_MSK` writer"]
pub type W = crate::W<MmcIpcIntMskSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int0(&mut self) -> Int0W<MmcIpcIntMskSpec> {
        Int0W::new(self, 0)
    }
    #[doc = "Bit 1 - Setting this bit masks the interrupt when the rxipv4_hdrerr_frms\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int1(&mut self) -> Int1W<MmcIpcIntMskSpec> {
        Int1W::new(self, 1)
    }
    #[doc = "Bit 5 - Setting this bit masks the interrupt when the rxipv6_gd_frms\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int5(&mut self) -> Int5W<MmcIpcIntMskSpec> {
        Int5W::new(self, 5)
    }
    #[doc = "Bit 6 - Setting this bit masks the interrupt when the rxipv6_hdrerr_frms\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int6(&mut self) -> Int6W<MmcIpcIntMskSpec> {
        Int6W::new(self, 6)
    }
    #[doc = "Bit 9 - Setting this bit masks the interrupt when the rxudp_err_frms\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int9(&mut self) -> Int9W<MmcIpcIntMskSpec> {
        Int9W::new(self, 9)
    }
    #[doc = "Bit 11 - Setting this bit masks the interrupt when the rxtcp_err_frms\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int11(&mut self) -> Int11W<MmcIpcIntMskSpec> {
        Int11W::new(self, 11)
    }
    #[doc = "Bit 13 - Setting this bit masks the interrupt when the rxicmp_err_frms\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int13(&mut self) -> Int13W<MmcIpcIntMskSpec> {
        Int13W::new(self, 13)
    }
    #[doc = "Bit 17 - Setting this bit masks the interrupt when the\n\nrxipv4_hdrerr_octets counter reaches half the maximum value,\n\nand also when it reaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int17(&mut self) -> Int17W<MmcIpcIntMskSpec> {
        Int17W::new(self, 17)
    }
    #[doc = "Bit 22 - Setting this bit masks the interrupt when the\n\nrxipv6_hdrerr_octets counter reaches half the maximum value,\n\nand also when it reaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int22(&mut self) -> Int22W<MmcIpcIntMskSpec> {
        Int22W::new(self, 22)
    }
    #[doc = "Bit 25 - Setting this bit masks the interrupt when the rxudp_err_octets\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int25(&mut self) -> Int25W<MmcIpcIntMskSpec> {
        Int25W::new(self, 25)
    }
    #[doc = "Bit 27 - Setting this bit masks the interrupt when the rxtcp_err_octets\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int27(&mut self) -> Int27W<MmcIpcIntMskSpec> {
        Int27W::new(self, 27)
    }
    #[doc = "Bit 29 - Setting this bit masks the interrupt when the rxicmp_err_octets\n\ncounter reaches half the maximum value, and also when it\n\nreaches the maximum value."]
    #[inline(always)]
    #[must_use]
    pub fn int29(&mut self) -> Int29W<MmcIpcIntMskSpec> {
        Int29W::new(self, 29)
    }
}
#[doc = "MMC Receive Checksum Offload Interrupt Mask Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mmc_ipc_int_msk::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mmc_ipc_int_msk::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MmcIpcIntMskSpec;
impl crate::RegisterSpec for MmcIpcIntMskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mmc_ipc_int_msk::R`](R) reader structure"]
impl crate::Readable for MmcIpcIntMskSpec {}
#[doc = "`write(|w| ..)` method takes [`mmc_ipc_int_msk::W`](W) writer structure"]
impl crate::Writable for MmcIpcIntMskSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MMC_IPC_INT_MSK to value 0"]
impl crate::Resettable for MmcIpcIntMskSpec {
