#[doc = "Register `OVERFLOW_CNT` reader"]
pub type R = crate::R<OverflowCntSpec>;
...
#[doc = "Missed Frame and Buffer Overflow Counter Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`overflow_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OverflowCntSpec;
impl crate::RegisterSpec for OverflowCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`overflow_cnt::R`](R) reader structure"]
impl crate::Readable for OverflowCntSpec {}
#[doc = "`reset()` method sets OVERFLOW_CNT to value 0"]
impl crate::Resettable for OverflowCntSpec {
