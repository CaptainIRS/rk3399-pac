#[doc = "Register `AN_LINK_PART_AB` reader"]
pub type R = crate::R<AnLinkPartAbSpec>;
...
#[doc = "Auto Negotiation Link Partner Ability Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`an_link_part_ab::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AnLinkPartAbSpec;
impl crate::RegisterSpec for AnLinkPartAbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`an_link_part_ab::R`](R) reader structure"]
impl crate::Readable for AnLinkPartAbSpec {}
#[doc = "`reset()` method sets AN_LINK_PART_AB to value 0"]
impl crate::Resettable for AnLinkPartAbSpec {
