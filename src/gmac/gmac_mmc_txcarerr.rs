#[doc = "Register `GMAC_MMC_TXCARERR` reader"]
...
#[doc = "MMC TX Carrier Error\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gmac_mmc_txcarerr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gmac_mmc_txcarerr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GmacMmcTxcarerrSpec;
impl crate::RegisterSpec for GmacMmcTxcarerrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gmac_mmc_txcarerr::R`](R) reader structure"]
impl crate::Readable for GmacMmcTxcarerrSpec {}
#[doc = "`write(|w| ..)` method takes [`gmac_mmc_txcarerr::W`](W) writer structure"]
impl crate::Writable for GmacMmcTxcarerrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GMAC_MMC_TXCARERR to value 0"]
impl crate::Resettable for GmacMmcTxcarerrSpec {
