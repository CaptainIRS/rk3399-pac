...
#[doc = "Field `NPR` reader - New Page Received When set, this bit indicates that a new page has been received by the GMAC. This bit will be cleared when read."]
pub type NprR = crate::BitReader;
#[doc = "Field `NPA` reader - Next Page Ability This bit is tied to low, because the GMAC does not support next page function."]
pub type NpaR = crate::BitReader;
impl R {
    #[doc = "Bit 1 - New Page Received When set, this bit indicates that a new page has been received by the GMAC. This bit will be cleared when read."]
    #[inline(always)]
    pub fn npr(&self) -> NprR {
        NprR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Next Page Ability This bit is tied to low, because the GMAC does not support next page function."]
    #[inline(always)]
