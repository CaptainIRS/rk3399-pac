...
pub type R = crate::R<UartCtrSpec>;
...
#[doc = "Component Type Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uart_ctr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UartCtrSpec;
impl crate::RegisterSpec for UartCtrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart_ctr::R`](R) reader structure"]
impl crate::Readable for UartCtrSpec {}
#[doc = "`reset()` method sets UART_CTR to value 0x4457_0110"]
impl crate::Resettable for UartCtrSpec {
