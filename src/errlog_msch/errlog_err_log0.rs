#[doc = "Register `ERRLOG_ErrLog0` reader"]
pub type R = crate::R<ErrlogErrLog0Spec>;
...
#[doc = "Transport protocol header information register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`errlog_err_log0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ErrlogErrLog0Spec;
impl crate::RegisterSpec for ErrlogErrLog0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`errlog_err_log0::R`](R) reader structure"]
impl crate::Readable for ErrlogErrLog0Spec {}
#[doc = "`reset()` method sets ERRLOG_ErrLog0 to value 0x8000_0000"]
impl crate::Resettable for ErrlogErrLog0Spec {
