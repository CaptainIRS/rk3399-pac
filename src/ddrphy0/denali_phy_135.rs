#[doc = "Register `DENALI_PHY_135` reader"]
pub type R = crate::R<DenaliPhy135Spec>;
#[doc = "Register `DENALI_PHY_135` writer"]
pub type W = crate::W<DenaliPhy135Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_tsel_select_1(&mut self) -> PhyDqsTselSelect1W<DenaliPhy135Spec> {
        PhyDqsTselSelect1W::new(self, 0)
    }
    #[doc = "Bits 24:25 - cycle preamble support for slice 1. Bit (0) controls the 2 cycle read preamble. Bit (1) controls the 2 cycle write preamble. Set each bit to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_two_cyc_preamble_1(&mut self) -> PhyTwoCycPreamble1W<DenaliPhy135Spec> {
        PhyTwoCycPreamble1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_135::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_135::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy135Spec;
impl crate::RegisterSpec for DenaliPhy135Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_135::R`](R) reader structure"]
impl crate::Readable for DenaliPhy135Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_135::W`](W) writer structure"]
impl crate::Writable for DenaliPhy135Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_135 to value 0"]
impl crate::Resettable for DenaliPhy135Spec {
