#[doc = "Register `DENALI_PHY_463` reader"]
pub type R = crate::R<DenaliPhy463Spec>;
#[doc = "Register `DENALI_PHY_463` writer"]
pub type W = crate::W<DenaliPhy463Spec>;
...
impl W {
    ...
    pub fn phy_wrlvl_delay_period_threshold_3(
        &mut self,
    ) -> PhyWrlvlDelayPeriodThreshold3W<DenaliPhy463Spec> {
        PhyWrlvlDelayPeriodThreshold3W::new(self, 0)
    }
    #[doc = "Bit 16 - Force the final write level delay value (that meets the early threshold) to 0 for slice 3."]
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_early_force_zero_3(&mut self) -> PhyWrlvlEarlyForceZero3W<DenaliPhy463Spec> {
        PhyWrlvlEarlyForceZero3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_463::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_463::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy463Spec;
impl crate::RegisterSpec for DenaliPhy463Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_463::R`](R) reader structure"]
impl crate::Readable for DenaliPhy463Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_463::W`](W) writer structure"]
impl crate::Writable for DenaliPhy463Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_463 to value 0"]
impl crate::Resettable for DenaliPhy463Spec {
