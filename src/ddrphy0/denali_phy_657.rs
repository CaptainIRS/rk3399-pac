#[doc = "Register `DENALI_PHY_657` reader"]
pub type R = crate::R<DenaliPhy657Spec>;
#[doc = "Register `DENALI_PHY_657` writer"]
pub type W = crate::W<DenaliPhy657Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_calvl_rank_ctrl_1(&mut self) -> PhyAdrCalvlRankCtrl1W<DenaliPhy657Spec> {
        PhyAdrCalvlRankCtrl1W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Sets the number of patterns to use during CA training for address slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_calvl_num_patterns_1(&mut self) -> PhyAdrCalvlNumPatterns1W<DenaliPhy657Spec> {
        PhyAdrCalvlNumPatterns1W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Number of samples to take at each ADDR slave delay setting during CA training for address slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_calvl_capture_cnt_1(&mut self) -> PhyAdrCalvlCaptureCnt1W<DenaliPhy657Spec> {
        PhyAdrCalvlCaptureCnt1W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Number of samples to wait for response during CA training for address slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_calvl_resp_wait_cnt_1(&mut self) -> PhyAdrCalvlRespWaitCnt1W<DenaliPhy657Spec> {
        PhyAdrCalvlRespWaitCnt1W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_657::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_657::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy657Spec;
impl crate::RegisterSpec for DenaliPhy657Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_657::R`](R) reader structure"]
impl crate::Readable for DenaliPhy657Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_657::W`](W) writer structure"]
impl crate::Writable for DenaliPhy657Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_657 to value 0"]
impl crate::Resettable for DenaliPhy657Spec {
