#[doc = "Register `DENALI_PHY_265` reader"]
pub type R = crate::R<DenaliPhy265Spec>;
#[doc = "Register `DENALI_PHY_265` writer"]
pub type W = crate::W<DenaliPhy265Spec>;
...
impl W {
    ...
    pub fn phy_lp4_boot_rddata_en_ie_dly_2(
        &mut self,
    ) -> PhyLp4BootRddataEnIeDly2W<DenaliPhy265Spec> {
        PhyLp4BootRddataEnIeDly2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - For LPDDR4 boot frequency, the number of cycles that the dfi_rddata_en signal is early for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lp4_boot_rddata_en_dly_2(&mut self) -> PhyLp4BootRddataEnDly2W<DenaliPhy265Spec> {
    ...
    pub fn phy_lp4_boot_rddata_en_tsel_dly_2(
        &mut self,
    ) -> PhyLp4BootRddataEnTselDly2W<DenaliPhy265Spec> {
        PhyLp4BootRddataEnTselDly2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - For LPDDR4 boot frequency, the offset in cycles from the dfi_rddata_en signal to release data from the entry FIFO for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lp4_boot_rptr_update_2(&mut self) -> PhyLp4BootRptrUpdate2W<DenaliPhy265Spec> {
        PhyLp4BootRptrUpdate2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_265::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_265::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy265Spec;
impl crate::RegisterSpec for DenaliPhy265Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_265::R`](R) reader structure"]
impl crate::Readable for DenaliPhy265Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_265::W`](W) writer structure"]
impl crate::Writable for DenaliPhy265Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_265 to value 0"]
impl crate::Resettable for DenaliPhy265Spec {
