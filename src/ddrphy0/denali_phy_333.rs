#[doc = "Register `DENALI_PHY_333` reader"]
pub type R = crate::R<DenaliPhy333Spec>;
#[doc = "Register `DENALI_PHY_333` writer"]
pub type W = crate::W<DenaliPhy333Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dm_fall_slave_delay_2(
        &mut self,
    ) -> PhyRddqsDmFallSlaveDelay2W<DenaliPhy333Spec> {
        PhyRddqsDmFallSlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Read DQS slave delay setting for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddqs_gate_slave_delay_2(&mut self) -> PhyRddqsGateSlaveDelay2W<DenaliPhy333Spec> {
        PhyRddqsGateSlaveDelay2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_333::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_333::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy333Spec;
impl crate::RegisterSpec for DenaliPhy333Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_333::R`](R) reader structure"]
impl crate::Readable for DenaliPhy333Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_333::W`](W) writer structure"]
impl crate::Writable for DenaliPhy333Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_333 to value 0"]
impl crate::Resettable for DenaliPhy333Spec {
