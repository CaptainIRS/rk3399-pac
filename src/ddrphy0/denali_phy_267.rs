#[doc = "Register `DENALI_PHY_267` reader"]
pub type R = crate::R<DenaliPhy267Spec>;
#[doc = "Register `DENALI_PHY_267` writer"]
pub type W = crate::W<DenaliPhy267Spec>;
...
#[doc = "Field `SC_PHY_SNAP_OBS_REGS_2` writer - Initiates a snapshot of the internal observation registers for slice 2. Set to 1 to trigger. WRITE-ONLY"]
...
impl W {
    ...
    pub fn phy_rddqs_dq_bypass_slave_delay_2(
        &mut self,
    ) -> PhyRddqsDqBypassSlaveDelay2W<DenaliPhy267Spec> {
        PhyRddqsDqBypassSlaveDelay2W::new(self, 0)
    }
    #[doc = "Bits 16:20 - Number of cycles to wait for the DQS gate to close before flagging an error for slice 2."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gate_error_delay_select_2(&mut self) -> PhyGateErrorDelaySelect2W<DenaliPhy267Spec> {
        PhyGateErrorDelaySelect2W::new(self, 16)
    }
    #[doc = "Bit 24 - Initiates a snapshot of the internal observation registers for slice 2. Set to 1 to trigger. WRITE-ONLY"]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_snap_obs_regs_2(&mut self) -> ScPhySnapObsRegs2W<DenaliPhy267Spec> {
        ScPhySnapObsRegs2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_267::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_267::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy267Spec;
impl crate::RegisterSpec for DenaliPhy267Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_267::R`](R) reader structure"]
impl crate::Readable for DenaliPhy267Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_267::W`](W) writer structure"]
impl crate::Writable for DenaliPhy267Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_267 to value 0"]
impl crate::Resettable for DenaliPhy267Spec {
