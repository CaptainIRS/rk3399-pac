#[doc = "Register `DENALI_PHY_202` reader"]
pub type R = crate::R<DenaliPhy202Spec>;
#[doc = "Register `DENALI_PHY_202` writer"]
pub type W = crate::W<DenaliPhy202Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq5_fall_slave_delay_1(
        &mut self,
    ) -> PhyRddqsDq5FallSlaveDelay1W<DenaliPhy202Spec> {
    ...
    pub fn phy_rddqs_dq6_rise_slave_delay_1(
        &mut self,
    ) -> PhyRddqsDq6RiseSlaveDelay1W<DenaliPhy202Spec> {
        PhyRddqsDq6RiseSlaveDelay1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_202::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_202::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy202Spec;
impl crate::RegisterSpec for DenaliPhy202Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_202::R`](R) reader structure"]
impl crate::Readable for DenaliPhy202Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_202::W`](W) writer structure"]
impl crate::Writable for DenaliPhy202Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_202 to value 0"]
impl crate::Resettable for DenaliPhy202Spec {
