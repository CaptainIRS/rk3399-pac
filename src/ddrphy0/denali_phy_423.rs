...
#[doc = "Field `PHY_WRLVL_HARD1_DELAY_OBS_3` reader - Observation register for write leveling first hard 1 DQS slave delay for slice 3. READ-ONLY"]
pub type PhyWrlvlHard1DelayObs3R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:9 - Observation register for write leveling first hard 1 DQS slave delay for slice 3. READ-ONLY"]
    #[inline(always)]
