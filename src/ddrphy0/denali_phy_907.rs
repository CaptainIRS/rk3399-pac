#[doc = "Register `DENALI_PHY_907` reader"]
pub type R = crate::R<DenaliPhy907Spec>;
#[doc = "Register `DENALI_PHY_907` writer"]
pub type W = crate::W<DenaliPhy907Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_adrctl_snap_obs_regs(&mut self) -> PhyAdrctlSnapObsRegsW<DenaliPhy907Spec> {
        PhyAdrctlSnapObsRegsW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Defines the value of the dfi_phyupd_type output signal to MC."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dfi_phyupd_type(&mut self) -> PhyDfiPhyupdTypeW<DenaliPhy907Spec> {
        PhyDfiPhyupdTypeW::new(self, 8)
    }
    #[doc = "Bit 16 - Adds a cycle of delay for the address/control slices to match the address slice."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adrctl_lpddr(&mut self) -> PhyAdrctlLpddrW<DenaliPhy907Spec> {
        PhyAdrctlLpddrW::new(self, 16)
    }
    #[doc = "Bit 24 - Indicates LPDDR4 device is connected to the PHY."]
    #[inline(always)]
    #[must_use]
    pub fn phy_lp4_active(&mut self) -> PhyLp4ActiveW<DenaliPhy907Spec> {
        PhyLp4ActiveW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_907::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_907::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy907Spec;
impl crate::RegisterSpec for DenaliPhy907Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_907::R`](R) reader structure"]
impl crate::Readable for DenaliPhy907Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_907::W`](W) writer structure"]
impl crate::Writable for DenaliPhy907Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_907 to value 0"]
impl crate::Resettable for DenaliPhy907Spec {
