#[doc = "Register `VF_PWR_STATUS` reader"]
pub type R = crate::R<VfPwrStatusSpec>;
...
#[doc = "Virtual function power status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vf_pwr_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VfPwrStatusSpec;
impl crate::RegisterSpec for VfPwrStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vf_pwr_status::R`](R) reader structure"]
impl crate::Readable for VfPwrStatusSpec {}
#[doc = "`reset()` method sets VF_PWR_STATUS to value 0"]
impl crate::Resettable for VfPwrStatusSpec {
