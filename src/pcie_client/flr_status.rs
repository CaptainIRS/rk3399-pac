#[doc = "Register `FLR_STATUS` reader"]
pub type R = crate::R<FlrStatusSpec>;
...
#[doc = "Function level reset status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`flr_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlrStatusSpec;
impl crate::RegisterSpec for FlrStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flr_status::R`](R) reader structure"]
impl crate::Readable for FlrStatusSpec {}
#[doc = "`reset()` method sets FLR_STATUS to value 0"]
impl crate::Resettable for FlrStatusSpec {
