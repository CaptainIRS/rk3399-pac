...
#[doc = "Field `LENGTH1` reader - Length1 Length1, record the recently received message length.\n\nThe field is **cleared** (set to zero) following a read operation."]
pub type Length1R = crate::FieldReader;
#[doc = "Field `LENGTH2` reader - Length2 Length2, record the 2nd recently received message length.\n\nThe field is **cleared** (set to zero) following a read operation."]
pub type Length2R = crate::FieldReader;
#[doc = "Field `LENGTH3` reader - Length3 Length3, record the 3rd recently received message length.\n\nThe field is **cleared** (set to zero) following a read operation."]
pub type Length3R = crate::FieldReader;
#[doc = "Field `LENGTH4` reader - Length4 Length4, record the 4th recently received message length.\n\nThe field is **cleared** (set to zero) following a read operation."]
pub type Length4R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - Length1 Length1, record the recently received message length."]
    #[inline(always)]
    pub fn length1(&self) -> Length1R {
        Length1R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Length2 Length2, record the 2nd recently received message length."]
    #[inline(always)]
    pub fn length2(&self) -> Length2R {
        Length2R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Length3 Length3, record the 3rd recently received message length."]
    #[inline(always)]
    pub fn length3(&self) -> Length3R {
        Length3R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Length4 Length4, record the 4th recently received message length."]
    #[inline(always)]
