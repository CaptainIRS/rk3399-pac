#[doc = "Register `BASIC_STATUS0` reader"]
pub type R = crate::R<BasicStatus0Spec>;
...
#[doc = "Basic status 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`basic_status0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BasicStatus0Spec;
impl crate::RegisterSpec for BasicStatus0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`basic_status0::R`](R) reader structure"]
impl crate::Readable for BasicStatus0Spec {}
#[doc = "`reset()` method sets BASIC_STATUS0 to value 0x0280"]
impl crate::Resettable for BasicStatus0Spec {
