...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn corr_err_int(&mut self) -> CorrErrIntW<IntStatusSpec> {
        CorrErrIntW::new(self, 9)
    }
    #[doc = "Bit 10 - Non-fatal error interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nfatal_err_int(&mut self) -> NfatalErrIntW<IntStatusSpec> {
        NfatalErrIntW::new(self, 10)
    }
    #[doc = "Bit 11 - Fatal error interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn fatal_err_int(&mut self) -> FatalErrIntW<IntStatusSpec> {
        FatalErrIntW::new(self, 11)
    }
    #[doc = "Bit 12 - DPA interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn dpa_int(&mut self) -> DpaIntW<IntStatusSpec> {
        DpaIntW::new(self, 12)
    }
    #[doc = "Bit 13 - Hot reset interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn hot_reset_int(&mut self) -> HotResetIntW<IntStatusSpec> {
        HotResetIntW::new(self, 13)
    }
    #[doc = "Bit 14 - Message receive done interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn msg_int(&mut self) -> MsgIntW<IntStatusSpec> {
        MsgIntW::new(self, 14)
    }
    #[doc = "Bit 15 - Legacy interrupt send done interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn legacy_done_int(&mut self) -> LegacyDoneIntW<IntStatusSpec> {
