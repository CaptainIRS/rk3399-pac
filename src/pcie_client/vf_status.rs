#[doc = "Register `VF_STATUS` reader"]
pub type R = crate::R<VfStatusSpec>;
...
#[doc = "Virtual function status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vf_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VfStatusSpec;
impl crate::RegisterSpec for VfStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vf_status::R`](R) reader structure"]
impl crate::Readable for VfStatusSpec {}
#[doc = "`reset()` method sets VF_STATUS to value 0"]
impl crate::Resettable for VfStatusSpec {
