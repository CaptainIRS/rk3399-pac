#[doc = "Register `ERR_CTRL` reader"]
pub type R = crate::R<ErrCtrlSpec>;
#[doc = "Register `ERR_CTRL` writer"]
pub type W = crate::W<ErrCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uncorr_err_in_en(&mut self) -> UncorrErrInEnW<ErrCtrlSpec> {
        UncorrErrInEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Assert a correctable error input to core"]
    #[inline(always)]
    #[must_use]
    pub fn corr_err_in_en(&mut self) -> CorrErrInEnW<ErrCtrlSpec> {
        CorrErrInEnW::new(self, 1)
    }
    #[doc = "Bit 8 - Enable fatal error counter"]
    #[inline(always)]
    #[must_use]
    pub fn fatal_err_cnt_en(&mut self) -> FatalErrCntEnW<ErrCtrlSpec> {
        FatalErrCntEnW::new(self, 8)
    }
    #[doc = "Bit 9 - Enable non-fatal error counter"]
    #[inline(always)]
    #[must_use]
    pub fn nfatal_err_cnt_en(&mut self) -> NfatalErrCntEnW<ErrCtrlSpec> {
        NfatalErrCntEnW::new(self, 9)
    }
    #[doc = "Bit 10 - Enable correctable error counter"]
    #[inline(always)]
    #[must_use]
    pub fn corr_err_cnt_en(&mut self) -> CorrErrCntEnW<ErrCtrlSpec> {
        CorrErrCntEnW::new(self, 10)
    }
    #[doc = "Bits 16:31 - Write mask\n\nFor each served bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ErrCtrlSpec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Error control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`err_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`err_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ErrCtrlSpec;
impl crate::RegisterSpec for ErrCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`err_ctrl::R`](R) reader structure"]
impl crate::Readable for ErrCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`err_ctrl::W`](W) writer structure"]
impl crate::Writable for ErrCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ERR_CTRL to value 0"]
impl crate::Resettable for ErrCtrlSpec {
