#[doc = "Register `PCIE_CLIENT_POWER_CTRL` reader"]
pub type R = crate::R<PcieClientPowerCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clt_req_exit_l2(&mut self) -> CltReqExitL2W<PcieClientPowerCtrlSpec> {
        CltReqExitL2W::new(self, 0)
    }
    #[doc = "Bit 1 - Request transition to L23_Ready state"]
    #[inline(always)]
    #[must_use]
    pub fn req_trn_l23ready(&mut self) -> ReqTrnL23readyW<PcieClientPowerCtrlSpec> {
        ReqTrnL23readyW::new(self, 1)
    }
    #[doc = "Bit 2 - Client request exit L1 power state"]
    #[inline(always)]
    #[must_use]
    pub fn clt_req_exit_l1(&mut self) -> CltReqExitL1W<PcieClientPowerCtrlSpec> {
        CltReqExitL1W::new(self, 2)
    }
    #[doc = "Bit 4 - Hardware clear exit L2 request"]
    #[inline(always)]
    #[must_use]
    pub fn hwclr_exit_l2_req(&mut self) -> HwclrExitL2ReqW<PcieClientPowerCtrlSpec> {
        HwclrExitL2ReqW::new(self, 4)
    }
    #[doc = "Bit 6 - Hardware clear exit L1 request"]
    #[inline(always)]
    #[must_use]
    pub fn hwclr_exit_l1_req(&mut self) -> HwclrExitL1ReqW<PcieClientPowerCtrlSpec> {
        HwclrExitL1ReqW::new(self, 6)
    }
    #[doc = "Bit 8 - Power state change ack"]
    #[inline(always)]
    #[must_use]
    pub fn pwr_stcg_ack(&mut self) -> PwrStcgAckW<PcieClientPowerCtrlSpec> {
...
#[doc = "PCIe client power control configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_client_power_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcie_client_power_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcieClientPowerCtrlSpec;
impl crate::RegisterSpec for PcieClientPowerCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_client_power_ctrl::R`](R) reader structure"]
impl crate::Readable for PcieClientPowerCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pcie_client_power_ctrl::W`](W) writer structure"]
impl crate::Writable for PcieClientPowerCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_CLIENT_POWER_CTRL to value 0"]
impl crate::Resettable for PcieClientPowerCtrlSpec {
