...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwr_stcg_int_mask(&mut self) -> PwrStcgIntMaskW<IntMaskSpec> {
        PwrStcgIntMaskW::new(self, 0)
    }
    #[doc = "Bit 1 - Hot plug interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn hot_plug_int_mask(&mut self) -> HotPlugIntMaskW<IntMaskSpec> {
        HotPlugIntMaskW::new(self, 1)
    }
    #[doc = "Bit 2 - Phy interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn phy_int_mask(&mut self) -> PhyIntMaskW<IntMaskSpec> {
        PhyIntMaskW::new(self, 2)
    }
    #[doc = "Bit 3 - uDMA interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn udma_int_mask(&mut self) -> UdmaIntMaskW<IntMaskSpec> {
        UdmaIntMaskW::new(self, 3)
    }
    #[doc = "Bit 4 - Local interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn local_int_mask(&mut self) -> LocalIntMaskW<IntMaskSpec> {
        LocalIntMaskW::new(self, 4)
    }
    #[doc = "Bit 5 - INTA interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn inta_mask(&mut self) -> IntaMaskW<IntMaskSpec> {
        IntaMaskW::new(self, 5)
    }
    #[doc = "Bit 6 - INTB interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn intb_mask(&mut self) -> IntbMaskW<IntMaskSpec> {
        IntbMaskW::new(self, 6)
    }
    #[doc = "Bit 7 - INTC interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn intc_mask(&mut self) -> IntcMaskW<IntMaskSpec> {
        IntcMaskW::new(self, 7)
    }
    #[doc = "Bit 8 - INTD interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn intd_mask(&mut self) -> IntdMaskW<IntMaskSpec> {
        IntdMaskW::new(self, 8)
    }
    #[doc = "Bit 9 - Correctable error interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn corr_err_int_mask(&mut self) -> CorrErrIntMaskW<IntMaskSpec> {
        CorrErrIntMaskW::new(self, 9)
    }
    #[doc = "Bit 10 - Non-fatal error interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn nfatal_err_int_mask(&mut self) -> NfatalErrIntMaskW<IntMaskSpec> {
        NfatalErrIntMaskW::new(self, 10)
    }
    #[doc = "Bit 11 - Fatal error interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn fatal_err_int_mask(&mut self) -> FatalErrIntMaskW<IntMaskSpec> {
        FatalErrIntMaskW::new(self, 11)
    }
    #[doc = "Bit 12 - DPA interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn dpa_int_mask(&mut self) -> DpaIntMaskW<IntMaskSpec> {
        DpaIntMaskW::new(self, 12)
    }
    #[doc = "Bit 13 - Hot reset interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn hot_reset_int_mask(&mut self) -> HotResetIntMaskW<IntMaskSpec> {
        HotResetIntMaskW::new(self, 13)
    }
    #[doc = "Bit 14 - Message receive done interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn msg_int_mask(&mut self) -> MsgIntMaskW<IntMaskSpec> {
        MsgIntMaskW::new(self, 14)
    }
    #[doc = "Bit 15 - Legacy interrupt send done interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn legacy_done_int_mask(&mut self) -> LegacyDoneIntMaskW<IntMaskSpec> {
        LegacyDoneIntMaskW::new(self, 15)
    }
    #[doc = "Bits 16:31 - Write mask\n\nFor each served bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<IntMaskSpec> {
