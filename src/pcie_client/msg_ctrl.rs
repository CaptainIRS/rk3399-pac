#[doc = "Register `MSG_CTRL` reader"]
pub type R = crate::R<MsgCtrlSpec>;
#[doc = "Register `MSG_CTRL` writer"]
pub type W = crate::W<MsgCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn msg_fifo_en(&mut self) -> MsgFifoEnW<MsgCtrlSpec> {
        MsgFifoEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Message fifo receive mode select"]
    #[inline(always)]
    #[must_use]
    pub fn msg_fifo_rx_mode(&mut self) -> MsgFifoRxModeW<MsgCtrlSpec> {
        MsgFifoRxModeW::new(self, 1)
    }
    #[doc = "Bits 8:12 - Almost full water mark\n\nalmost full water mark configuration"]
    #[inline(always)]
    #[must_use]
    pub fn almfull_water_mark(&mut self) -> AlmfullWaterMarkW<MsgCtrlSpec> {
        AlmfullWaterMarkW::new(self, 8)
    }
    #[doc = "Bits 16:31 - Write mask\n\nFor each served bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<MsgCtrlSpec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Message receive control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`msg_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`msg_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MsgCtrlSpec;
impl crate::RegisterSpec for MsgCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`msg_ctrl::R`](R) reader structure"]
impl crate::Readable for MsgCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`msg_ctrl::W`](W) writer structure"]
impl crate::Writable for MsgCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSG_CTRL to value 0"]
impl crate::Resettable for MsgCtrlSpec {
