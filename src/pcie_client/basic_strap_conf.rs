#[doc = "Register `BASIC_STRAP_CONF` reader"]
pub type R = crate::R<BasicStrapConfSpec>;
#[doc = "Register `BASIC_STRAP_CONF` writer"]
pub type W = crate::W<BasicStrapConfSpec>;
#[doc = "Config enable\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn conf_en(&mut self) -> ConfEnW<BasicStrapConfSpec> {
        ConfEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Link training enable"]
    #[inline(always)]
    #[must_use]
    pub fn link_train_en(&mut self) -> LinkTrainEnW<BasicStrapConfSpec> {
        LinkTrainEnW::new(self, 1)
    }
    #[doc = "Bit 2 - Single root I/O virtualization feature enable"]
    #[inline(always)]
    #[must_use]
    pub fn sr_iov_en(&mut self) -> SrIovEnW<BasicStrapConfSpec> {
        SrIovEnW::new(self, 2)
    }
    #[doc = "Bit 3 - Alternate interpretation enable"]
    #[inline(always)]
    #[must_use]
    pub fn ari_en(&mut self) -> AriEnW<BasicStrapConfSpec> {
        AriEnW::new(self, 3)
    }
    #[doc = "Bits 4:5 - configure the lane count supported\n\n2’b11: reserved\n\n2’b10: X4\n\n2’b01: X2\n\n2’b00: X1"]
    #[inline(always)]
    #[must_use]
    pub fn lane_count_in(&mut self) -> LaneCountInW<BasicStrapConfSpec> {
        LaneCountInW::new(self, 4)
    }
    #[doc = "Bit 6 - Controller operation mode select"]
    #[inline(always)]
    #[must_use]
    pub fn mode_select(&mut self) -> ModeSelectW<BasicStrapConfSpec> {
        ModeSelectW::new(self, 6)
    }
    #[doc = "Bit 7 - Generation support select"]
    #[inline(always)]
    #[must_use]
    pub fn pcie_gen_sel(&mut self) -> PcieGenSelW<BasicStrapConfSpec> {
        PcieGenSelW::new(self, 7)
    }
    #[doc = "Bits 16:31 - Write mask bits\n\nFor each served bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<BasicStrapConfSpec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Basic strap configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`basic_strap_conf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`basic_strap_conf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BasicStrapConfSpec;
impl crate::RegisterSpec for BasicStrapConfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`basic_strap_conf::R`](R) reader structure"]
impl crate::Readable for BasicStrapConfSpec {}
#[doc = "`write(|w| ..)` method takes [`basic_strap_conf::W`](W) writer structure"]
impl crate::Writable for BasicStrapConfSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BASIC_STRAP_CONF to value 0xc1"]
impl crate::Resettable for BasicStrapConfSpec {
