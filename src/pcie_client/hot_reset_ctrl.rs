#[doc = "Register `HOT_RESET_CTRL` reader"]
pub type R = crate::R<HotResetCtrlSpec>;
#[doc = "Register `HOT_RESET_CTRL` writer"]
pub type W = crate::W<HotResetCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hot_reset_in(&mut self) -> HotResetInW<HotResetCtrlSpec> {
        HotResetInW::new(self, 0)
    }
    #[doc = "Bit 1 - Mask link down reset client logic"]
    #[inline(always)]
    #[must_use]
    pub fn link_down_rst_clt_mask(&mut self) -> LinkDownRstCltMaskW<HotResetCtrlSpec> {
        LinkDownRstCltMaskW::new(self, 1)
    }
    #[doc = "Bits 16:17 - Write mask\n\nFor each served bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<HotResetCtrlSpec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Hot reset control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hot_reset_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hot_reset_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HotResetCtrlSpec;
impl crate::RegisterSpec for HotResetCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hot_reset_ctrl::R`](R) reader structure"]
impl crate::Readable for HotResetCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`hot_reset_ctrl::W`](W) writer structure"]
impl crate::Writable for HotResetCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HOT_RESET_CTRL to value 0"]
impl crate::Resettable for HotResetCtrlSpec {
