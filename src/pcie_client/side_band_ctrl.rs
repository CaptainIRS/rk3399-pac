#[doc = "Register `SIDE_BAND_CTRL` reader"]
pub type R = crate::R<SideBandCtrlSpec>;
#[doc = "Register `SIDE_BAND_CTRL` writer"]
pub type W = crate::W<SideBandCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn non_posted_rej(&mut self) -> NonPostedRejW<SideBandCtrlSpec> {
        NonPostedRejW::new(self, 0)
    }
    #[doc = "Bits 4:5 - PIPE phy extended de-emphasis configuration, it combine with\n\nthe standard pipe de-emphasis."]
    #[inline(always)]
    #[must_use]
    pub fn tx_deemphasis_ext(&mut self) -> TxDeemphasisExtW<SideBandCtrlSpec> {
        TxDeemphasisExtW::new(self, 4)
    }
    #[doc = "Bit 6 - PIPE bypass codec configuration\n\nControls whether the PHY performs 8b/10b encode and decode:"]
    #[inline(always)]
    #[must_use]
    pub fn bypass_codec(&mut self) -> BypassCodecW<SideBandCtrlSpec> {
        BypassCodecW::new(self, 6)
    }
    #[doc = "Bits 8:11 - PCIe phy receiver control\n\nControls whether the PHY RX is active when the PHY is in P0 or\n\nP0s states."]
    #[inline(always)]
    #[must_use]
    pub fn rx_standby(&mut self) -> RxStandbyW<SideBandCtrlSpec> {
        RxStandbyW::new(self, 8)
    }
    #[doc = "Bits 16:31 - Write mask\n\nFor each served bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<SideBandCtrlSpec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Side band control configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`side_band_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`side_band_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SideBandCtrlSpec;
impl crate::RegisterSpec for SideBandCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`side_band_ctrl::R`](R) reader structure"]
impl crate::Readable for SideBandCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`side_band_ctrl::W`](W) writer structure"]
impl crate::Writable for SideBandCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SIDE_BAND_CTRL to value 0x04"]
impl crate::Resettable for SideBandCtrlSpec {
