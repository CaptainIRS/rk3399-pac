#[doc = "Register `n_CONTROLREG` reader"]
pub type R = crate::R<NControlregSpec>;
#[doc = "Register `n_CONTROLREG` writer"]
pub type W = crate::W<NControlregSpec>;
#[doc = "Timer enable.\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer_en(&mut self) -> TimerEnW<NControlregSpec> {
        TimerEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Timer mode."]
    #[inline(always)]
    #[must_use]
    pub fn timer_mode(&mut self) -> TimerModeW<NControlregSpec> {
        TimerModeW::new(self, 1)
    }
    #[doc = "Bit 2 - Timer interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn int_en(&mut self) -> IntEnW<NControlregSpec> {
        IntEnW::new(self, 2)
    }
}
#[doc = "Timer n Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`n_controlreg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`n_controlreg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NControlregSpec;
impl crate::RegisterSpec for NControlregSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`n_controlreg::R`](R) reader structure"]
impl crate::Readable for NControlregSpec {}
#[doc = "`write(|w| ..)` method takes [`n_controlreg::W`](W) writer structure"]
impl crate::Writable for NControlregSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets n_CONTROLREG to value 0"]
impl crate::Resettable for NControlregSpec {
