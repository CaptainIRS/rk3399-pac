#[doc = "Register `A2B_STATUS` reader"]
pub type R = crate::R<A2bStatusSpec>;
#[doc = "Register `A2B_STATUS` writer"]
pub type W = crate::W<A2bStatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int0(&mut self) -> Int0W<A2bStatusSpec> {
        Int0W::new(self, 0)
    }
    #[doc = "Bit 1 - interrupt status for int1.\n\nwhen writte 1, int is cleared."]
    #[inline(always)]
    #[must_use]
    pub fn int1(&mut self) -> Int1W<A2bStatusSpec> {
        Int1W::new(self, 1)
    }
    #[doc = "Bit 2 - interrupt status for int2.\n\nwhen writte 1, int is cleared."]
    #[inline(always)]
    #[must_use]
    pub fn int2(&mut self) -> Int2W<A2bStatusSpec> {
        Int2W::new(self, 2)
    }
    #[doc = "Bit 3 - interrupt status for int3.\n\nwhen writte 1, int is cleared."]
    #[inline(always)]
    #[must_use]
    pub fn int3(&mut self) -> Int3W<A2bStatusSpec> {
        Int3W::new(self, 3)
    }
}
#[doc = "Cortex-A53/Cortex-A72 to Cortex-M0 interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`a2b_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`a2b_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct A2bStatusSpec;
impl crate::RegisterSpec for A2bStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`a2b_status::R`](R) reader structure"]
impl crate::Readable for A2bStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`a2b_status::W`](W) writer structure"]
impl crate::Writable for A2bStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets A2B_STATUS to value 0"]
impl crate::Resettable for A2bStatusSpec {
