#[doc = "Register `B2A_INTEN` reader"]
pub type R = crate::R<B2aIntenSpec>;
#[doc = "Register `B2A_INTEN` writer"]
pub type W = crate::W<B2aIntenSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int0(&mut self) -> Int0W<B2aIntenSpec> {
        Int0W::new(self, 0)
    }
    #[doc = "Bit 1 - interrupt enable for int1"]
    #[inline(always)]
    #[must_use]
    pub fn int1(&mut self) -> Int1W<B2aIntenSpec> {
        Int1W::new(self, 1)
    }
    #[doc = "Bit 2 - interrupt enable for int2"]
    #[inline(always)]
    #[must_use]
    pub fn int2(&mut self) -> Int2W<B2aIntenSpec> {
        Int2W::new(self, 2)
    }
    #[doc = "Bit 3 - interrupt enable for int3"]
    #[inline(always)]
    #[must_use]
    pub fn int3(&mut self) -> Int3W<B2aIntenSpec> {
        Int3W::new(self, 3)
    }
}
#[doc = "Cortex-A53/Cortex-A72 to Cortex-M0 interrupt enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`b2a_inten::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`b2a_inten::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct B2aIntenSpec;
impl crate::RegisterSpec for B2aIntenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`b2a_inten::R`](R) reader structure"]
impl crate::Readable for B2aIntenSpec {}
#[doc = "`write(|w| ..)` method takes [`b2a_inten::W`](W) writer structure"]
impl crate::Writable for B2aIntenSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets B2A_INTEN to value 0"]
impl crate::Resettable for B2aIntenSpec {
