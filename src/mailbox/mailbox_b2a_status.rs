#[doc = "Register `MAILBOX_B2A_STATUS` reader"]
pub type R = crate::R<MailboxB2aStatusSpec>;
#[doc = "Register `MAILBOX_B2A_STATUS` writer"]
pub type W = crate::W<MailboxB2aStatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int0(&mut self) -> Int0W<MailboxB2aStatusSpec> {
        Int0W::new(self, 0)
    }
    #[doc = "Bit 1 - interrupt status for int1.\n\nwhen writte 1, int is cleared."]
    #[inline(always)]
    #[must_use]
    pub fn int1(&mut self) -> Int1W<MailboxB2aStatusSpec> {
        Int1W::new(self, 1)
    }
    #[doc = "Bit 2 - interrupt status for int2.\n\nwhen writte 1, int is cleared."]
    #[inline(always)]
    #[must_use]
    pub fn int2(&mut self) -> Int2W<MailboxB2aStatusSpec> {
        Int2W::new(self, 2)
    }
    #[doc = "Bit 3 - interrupt status for int3.\n\nwhen writte 1, int is cleared."]
    #[inline(always)]
    #[must_use]
    pub fn int3(&mut self) -> Int3W<MailboxB2aStatusSpec> {
        Int3W::new(self, 3)
    }
}
#[doc = "Cortex-M0 to Cortex-A53/Cortex-A72 interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mailbox_b2a_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mailbox_b2a_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MailboxB2aStatusSpec;
impl crate::RegisterSpec for MailboxB2aStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mailbox_b2a_status::R`](R) reader structure"]
impl crate::Readable for MailboxB2aStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`mailbox_b2a_status::W`](W) writer structure"]
impl crate::Writable for MailboxB2aStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MAILBOX_B2A_STATUS to value 0"]
impl crate::Resettable for MailboxB2aStatusSpec {
