...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0_intsts(&mut self) -> Ch0IntstsW<IntstsSpec> {
        Ch0IntstsW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel 1 Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_intsts(&mut self) -> Ch1IntstsW<IntstsSpec> {
        Ch1IntstsW::new(self, 1)
    }
    #[doc = "Bit 2 - Channel 2 Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn ch2_intsts(&mut self) -> Ch2IntstsW<IntstsSpec> {
        Ch2IntstsW::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 3 Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn ch3_intsts(&mut self) -> Ch3IntstsW<IntstsSpec> {
