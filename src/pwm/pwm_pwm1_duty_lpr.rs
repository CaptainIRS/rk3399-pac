#[doc = "Register `PWM_PWM1_DUTY_LPR` reader"]
pub type R = crate::R<PwmPwm1DutyLprSpec>;
#[doc = "Register `PWM_PWM1_DUTY_LPR` writer"]
pub type W = crate::W<PwmPwm1DutyLprSpec>;
...
is taken into account. If PWM is operated at the capture mode, this value indicates the effective low polarity cycles of input waveform. This value is based on the PWM clock. The value ranges from 0 to (2^32-1)."]
    #[inline(always)]
    #[must_use]
    pub fn duty_lpr(&mut self) -> DutyLprW<PwmPwm1DutyLprSpec> {
        DutyLprW::new(self, 0)
    }
}
#[doc = "PWM Channel 1 Duty Register/Low Polarity Capture Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm_pwm1_duty_lpr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm_pwm1_duty_lpr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwmPwm1DutyLprSpec;
impl crate::RegisterSpec for PwmPwm1DutyLprSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm_pwm1_duty_lpr::R`](R) reader structure"]
impl crate::Readable for PwmPwm1DutyLprSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm_pwm1_duty_lpr::W`](W) writer structure"]
impl crate::Writable for PwmPwm1DutyLprSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM_PWM1_DUTY_LPR to value 0"]
impl crate::Resettable for PwmPwm1DutyLprSpec {
