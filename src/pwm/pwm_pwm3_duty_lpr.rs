#[doc = "Register `PWM_PWM3_DUTY_LPR` reader"]
pub type R = crate::R<PwmPwm3DutyLprSpec>;
#[doc = "Register `PWM_PWM3_DUTY_LPR` writer"]
pub type W = crate::W<PwmPwm3DutyLprSpec>;
...
is taken into\n\naccount.\n\nIf PWM is operated at the capture mode, this value indicates the\n\neffective low polarity cycles of input waveform.\n\nThis value is based on the PWM clock. The value ranges from 0 to\n\n(2^32-1)."]
    #[inline(always)]
    #[must_use]
    pub fn duty_lpr(&mut self) -> DutyLprW<PwmPwm3DutyLprSpec> {
        DutyLprW::new(self, 0)
    }
}
...
pub struct PwmPwm3DutyLprSpec;
impl crate::RegisterSpec for PwmPwm3DutyLprSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm_pwm3_duty_lpr::R`](R) reader structure"]
impl crate::Readable for PwmPwm3DutyLprSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm_pwm3_duty_lpr::W`](W) writer structure"]
impl crate::Writable for PwmPwm3DutyLprSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM_PWM3_DUTY_LPR to value 0"]
impl crate::Resettable for PwmPwm3DutyLprSpec {
