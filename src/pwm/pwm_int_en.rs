#[doc = "Register `PWM_INT_EN` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0_int_en(&mut self) -> Ch0IntEnW<PwmIntEnSpec> {
        Ch0IntEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_int_en(&mut self) -> Ch1IntEnW<PwmIntEnSpec> {
        Ch1IntEnW::new(self, 1)
    }
    #[doc = "Bit 2 - Channel 2 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch2_int_en(&mut self) -> Ch2IntEnW<PwmIntEnSpec> {
        Ch2IntEnW::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 3 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch3_int_en(&mut self) -> Ch3IntEnW<PwmIntEnSpec> {
        Ch3IntEnW::new(self, 3)
    }
}
#[doc = "Interrupt Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm_int_en::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm_int_en::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwmIntEnSpec;
impl crate::RegisterSpec for PwmIntEnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm_int_en::R`](R) reader structure"]
impl crate::Readable for PwmIntEnSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm_int_en::W`](W) writer structure"]
impl crate::Writable for PwmIntEnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM_INT_EN to value 0"]
