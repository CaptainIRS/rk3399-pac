#[doc = "Register `PWM_PWM3_CTRL` reader"]
pub type R = crate::R<PwmPwm3CtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_en(&mut self) -> PwmEnW<PwmPwm3CtrlSpec> {
        PwmEnW::new(self, 0)
    }
    #[doc = "Bits 1:2 - PWM Operation Mode"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn output_mode(&mut self) -> OutputModeW<PwmPwm3CtrlSpec> {
        OutputModeW::new(self, 5)
    }
    #[doc = "Bit 8 - Low Power Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lp_en(&mut self) -> LpEnW<PwmPwm3CtrlSpec> {
        LpEnW::new(self, 8)
    }
    #[doc = "Bit 9 - Clock Source Select"]
    #[inline(always)]
...
#[doc = "PWM Channel 3 Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm_pwm3_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm_pwm3_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwmPwm3CtrlSpec;
impl crate::RegisterSpec for PwmPwm3CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm_pwm3_ctrl::R`](R) reader structure"]
impl crate::Readable for PwmPwm3CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm_pwm3_ctrl::W`](W) writer structure"]
impl crate::Writable for PwmPwm3CtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM_PWM3_CTRL to value 0"]
impl crate::Resettable for PwmPwm3CtrlSpec {
