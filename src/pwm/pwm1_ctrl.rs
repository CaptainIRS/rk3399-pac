...
pub type R = crate::R<Pwm1CtrlSpec>;
#[doc = "Register `PWM1_CTRL` writer"]
pub type W = crate::W<Pwm1CtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_en(&mut self) -> PwmEnW<Pwm1CtrlSpec> {
        PwmEnW::new(self, 0)
    }
    #[doc = "Bits 1:2 - PWM Operation Mode"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_mode(&mut self) -> PwmModeW<Pwm1CtrlSpec> {
        PwmModeW::new(self, 1)
    }
    #[doc = "Bit 3 - Duty Cycle Output Polarity\n\nThis defines the polarity for duty cycle. PWM starts the output\n\nwaveform with duty cycle."]
    #[inline(always)]
    #[must_use]
    pub fn duty_pol(&mut self) -> DutyPolW<Pwm1CtrlSpec> {
        DutyPolW::new(self, 3)
    }
    #[doc = "Bit 4 - Inactive State Output Polarity\n\nThis defines the output waveform polarity when PWM channel is\n\nin inactive state. The inactive state means that PWM finishes the\n\ncomplete waveform in one-shot mode or PWM channel is\n\ndisabled."]
    #[inline(always)]
    #[must_use]
    pub fn inactive_pol(&mut self) -> InactivePolW<Pwm1CtrlSpec> {
        InactivePolW::new(self, 4)
    }
    #[doc = "Bit 5 - PWM Output mode"]
    #[inline(always)]
    #[must_use]
    pub fn output_mode(&mut self) -> OutputModeW<Pwm1CtrlSpec> {
        OutputModeW::new(self, 5)
    }
    #[doc = "Bit 8 - Low Power Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lp_en(&mut self) -> LpEnW<Pwm1CtrlSpec> {
        LpEnW::new(self, 8)
    }
    #[doc = "Bit 9 - Clock Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sel(&mut self) -> ClkSelW<Pwm1CtrlSpec> {
        ClkSelW::new(self, 9)
    }
    #[doc = "Bits 12:14 - Prescale Factor\n\nThis field defines the prescale factor applied to input clock. The\n\nvalue N means that the input clock is divided by 2^N."]
    #[inline(always)]
    #[must_use]
    pub fn prescale(&mut self) -> PrescaleW<Pwm1CtrlSpec> {
        PrescaleW::new(self, 12)
    }
    #[doc = "Bits 16:23 - Scale Factor\n\nThis field defines the scale factor applied to prescaled clock. The\n\nvalue N means the clock is divided by 2*N. If N is 0, it means\n\nthat the clock is divided by 512(2*256)."]
    #[inline(always)]
    #[must_use]
    pub fn scale(&mut self) -> ScaleW<Pwm1CtrlSpec> {
        ScaleW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Repeat Counter\n\nThis field defines the repeated effective periods of output\n\nwaveform in one-shot mode. The value N means N+1 repeated\n\neffective periods."]
    #[inline(always)]
    #[must_use]
    pub fn rpt(&mut self) -> RptW<Pwm1CtrlSpec> {
        RptW::new(self, 24)
    }
}
#[doc = "PWM Channel 1 Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm1_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm1_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pwm1CtrlSpec;
impl crate::RegisterSpec for Pwm1CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm1_ctrl::R`](R) reader structure"]
impl crate::Readable for Pwm1CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm1_ctrl::W`](W) writer structure"]
impl crate::Writable for Pwm1CtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM1_CTRL to value 0"]
impl crate::Resettable for Pwm1CtrlSpec {
