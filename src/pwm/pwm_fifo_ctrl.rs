#[doc = "Register `PWM_FIFO_CTRL` reader"]
pub type R = crate::R<PwmFifoCtrlSpec>;
#[doc = "Register `PWM_FIFO_CTRL` writer"]
pub type W = crate::W<PwmFifoCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fifo_mode_sel(&mut self) -> FifoModeSelW<PwmFifoCtrlSpec> {
        FifoModeSelW::new(self, 0)
    }
    #[doc = "Bit 1 - FIFO Full Interrupt Enable\n\nWhen high, an interrupt asserts when the channel 3 FIFO is full."]
    #[inline(always)]
    #[must_use]
    pub fn full_int_en(&mut self) -> FullIntEnW<PwmFifoCtrlSpec> {
        FullIntEnW::new(self, 1)
    }
    #[doc = "Bit 2 - FIFO Overflow Interrupt Enable\n\nWhen high, an interrupt asserts when the channel 3 FIFO is\n\noverflow."]
    #[inline(always)]
    #[must_use]
    pub fn overflow_int_en(&mut self) -> OverflowIntEnW<PwmFifoCtrlSpec> {
        OverflowIntEnW::new(self, 2)
    }
    #[doc = "Bit 3 - Watermark Full Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn watermark_int_en(&mut self) -> WatermarkIntEnW<PwmFifoCtrlSpec> {
        WatermarkIntEnW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Almost Full Watermark Level"]
    #[inline(always)]
    #[must_use]
    pub fn almost_full_watermark(&mut self) -> AlmostFullWatermarkW<PwmFifoCtrlSpec> {
        AlmostFullWatermarkW::new(self, 4)
    }
    #[doc = "Bit 8 - DMA Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_mode_en(&mut self) -> DmaModeEnW<PwmFifoCtrlSpec> {
        DmaModeEnW::new(self, 8)
    }
    #[doc = "Bit 9 - FIFO Timeout Enable"]
    #[inline(always)]
    #[must_use]
    pub fn timeout_en(&mut self) -> TimeoutEnW<PwmFifoCtrlSpec> {
        TimeoutEnW::new(self, 9)
    }
}
#[doc = "PWM Channel 3 FIFO Mode Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm_fifo_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm_fifo_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwmFifoCtrlSpec;
impl crate::RegisterSpec for PwmFifoCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm_fifo_ctrl::R`](R) reader structure"]
impl crate::Readable for PwmFifoCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm_fifo_ctrl::W`](W) writer structure"]
impl crate::Writable for PwmFifoCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM_FIFO_CTRL to value 0"]
impl crate::Resettable for PwmFifoCtrlSpec {
