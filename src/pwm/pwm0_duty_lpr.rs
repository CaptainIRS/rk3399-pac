#[doc = "Register `PWM0_DUTY_LPR` reader"]
pub type R = crate::R<Pwm0DutyLprSpec>;
#[doc = "Register `PWM0_DUTY_LPR` writer"]
pub type W = crate::W<Pwm0DutyLprSpec>;
...
is taken into\n\naccount.\n\nIf PWM is operated at the capture mode, this value indicates the\n\neffective low polarity cycles of input waveform.\n\nThis value is based on the PWM clock. The value ranges from 0 to\n\n(2^32-1)."]
    #[inline(always)]
    #[must_use]
    pub fn duty_lpr(&mut self) -> DutyLprW<Pwm0DutyLprSpec> {
        DutyLprW::new(self, 0)
    }
}
#[doc = "PWM Channel 0 Duty Register/Low Polarity Capture Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm0_duty_lpr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm0_duty_lpr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pwm0DutyLprSpec;
impl crate::RegisterSpec for Pwm0DutyLprSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm0_duty_lpr::R`](R) reader structure"]
impl crate::Readable for Pwm0DutyLprSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm0_duty_lpr::W`](W) writer structure"]
impl crate::Writable for Pwm0DutyLprSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM0_DUTY_LPR to value 0"]
impl crate::Resettable for Pwm0DutyLprSpec {
