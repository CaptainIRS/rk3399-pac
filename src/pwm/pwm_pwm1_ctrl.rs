#[doc = "Register `PWM_PWM1_CTRL` reader"]
pub type R = crate::R<PwmPwm1CtrlSpec>;
#[doc = "Register `PWM_PWM1_CTRL` writer"]
pub type W = crate::W<PwmPwm1CtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_en(&mut self) -> PwmEnW<PwmPwm1CtrlSpec> {
        PwmEnW::new(self, 0)
    }
    #[doc = "Bits 1:2 - PWM Operation Mode"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_mode(&mut self) -> PwmModeW<PwmPwm1CtrlSpec> {
        PwmModeW::new(self, 1)
    }
    #[doc = "Bit 3 - Duty Cycle Output Polarity This defines the polarity for duty cycle. PWM starts the output waveform with duty cycle."]
    #[inline(always)]
    #[must_use]
    pub fn duty_pol(&mut self) -> DutyPolW<PwmPwm1CtrlSpec> {
        DutyPolW::new(self, 3)
    }
    #[doc = "Bit 4 - Inactive State Output Polarity This defines the output waveform polarity when PWM channel is in inactive state. The inactive state means that PWM finishes the complete waveform in one-shot mode or PWM channel is disabled."]
    #[inline(always)]
    #[must_use]
    pub fn inactive_pol(&mut self) -> InactivePolW<PwmPwm1CtrlSpec> {
        InactivePolW::new(self, 4)
    }
    #[doc = "Bit 5 - PWM Output mode"]
    #[inline(always)]
    #[must_use]
    pub fn output_mode(&mut self) -> OutputModeW<PwmPwm1CtrlSpec> {
        OutputModeW::new(self, 5)
    }
    #[doc = "Bit 8 - Low Power Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lp_en(&mut self) -> LpEnW<PwmPwm1CtrlSpec> {
        LpEnW::new(self, 8)
    }
    #[doc = "Bit 9 - Clock Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sel(&mut self) -> ClkSelW<PwmPwm1CtrlSpec> {
        ClkSelW::new(self, 9)
    }
    #[doc = "Bits 12:14 - Prescale Factor This field defines the prescale factor applied to input clock. The value N means that the input clock is divided by 2^N."]
    #[inline(always)]
    #[must_use]
    pub fn prescale(&mut self) -> PrescaleW<PwmPwm1CtrlSpec> {
        PrescaleW::new(self, 12)
    }
    #[doc = "Bits 16:23 - Scale Factor This field defines the scale factor applied to prescaled clock. The value N means the clock is divided by 2*N. If N is 0, it means that the clock is divided by 512(2*256)."]
    #[inline(always)]
    #[must_use]
    pub fn scale(&mut self) -> ScaleW<PwmPwm1CtrlSpec> {
        ScaleW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Repeat Counter This field defines the repeated effective periods of output waveform in one-shot mode. The value N means N+1 repeated effective periods."]
    #[inline(always)]
    #[must_use]
    pub fn rpt(&mut self) -> RptW<PwmPwm1CtrlSpec> {
        RptW::new(self, 24)
    }
}
...
pub struct PwmPwm1CtrlSpec;
impl crate::RegisterSpec for PwmPwm1CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm_pwm1_ctrl::R`](R) reader structure"]
impl crate::Readable for PwmPwm1CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm_pwm1_ctrl::W`](W) writer structure"]
impl crate::Writable for PwmPwm1CtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM_PWM1_CTRL to value 0"]
impl crate::Resettable for PwmPwm1CtrlSpec {
