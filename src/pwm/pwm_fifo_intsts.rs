#[doc = "Register `PWM_FIFO_INTSTS` reader"]
pub type R = crate::R<PwmFifoIntstsSpec>;
#[doc = "Register `PWM_FIFO_INTSTS` writer"]
pub type W = crate::W<PwmFifoIntstsSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fifo_full_intsts(&mut self) -> FifoFullIntstsW<PwmFifoIntstsSpec> {
        FifoFullIntstsW::new(self, 0)
    }
    #[doc = "Bit 1 - FIFO Overflow Interrupt Status\n\nThis bit indicates the FIFO is overflow"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_overflow_intsts(&mut self) -> FifoOverflowIntstsW<PwmFifoIntstsSpec> {
        FifoOverflowIntstsW::new(self, 1)
    }
    #[doc = "Bit 2 - FIFO Watermark Full Interrupt Status\n\nThis bit indicates the FIFO is Watermark Full"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_watermark_full_intsts(&mut self) -> FifoWatermarkFullIntstsW<PwmFifoIntstsSpec> {
        FifoWatermarkFullIntstsW::new(self, 2)
    }
    #[doc = "Bit 3 - Timeout Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn timeout_intsts(&mut self) -> TimeoutIntstsW<PwmFifoIntstsSpec> {
        TimeoutIntstsW::new(self, 3)
    }
}
#[doc = "FIFO Interrupts Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm_fifo_intsts::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm_fifo_intsts::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwmFifoIntstsSpec;
impl crate::RegisterSpec for PwmFifoIntstsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm_fifo_intsts::R`](R) reader structure"]
impl crate::Readable for PwmFifoIntstsSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm_fifo_intsts::W`](W) writer structure"]
impl crate::Writable for PwmFifoIntstsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0f;
}
#[doc = "`reset()` method sets PWM_FIFO_INTSTS to value 0"]
impl crate::Resettable for PwmFifoIntstsSpec {
