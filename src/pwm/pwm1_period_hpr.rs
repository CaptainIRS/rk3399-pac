#[doc = "Register `PWM1_PERIOD_HPR` reader"]
pub type R = crate::R<Pwm1PeriodHprSpec>;
#[doc = "Register `PWM1_PERIOD_HPR` writer"]
pub type W = crate::W<Pwm1PeriodHprSpec>;
...
always considered as 0.\n\nIf PWM is operated at the capture mode, this value indicates the\n\neffective high polarity cycles of input waveform.\n\nThis value is based on the PWM clock. The value ranges from 0 to\n\n(2^32-1)."]
    #[inline(always)]
    #[must_use]
    pub fn period_hpr(&mut self) -> PeriodHprW<Pwm1PeriodHprSpec> {
        PeriodHprW::new(self, 0)
    }
}
#[doc = "PWM Channel 1 Period Register/High Polarity Capture Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm1_period_hpr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm1_period_hpr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pwm1PeriodHprSpec;
impl crate::RegisterSpec for Pwm1PeriodHprSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm1_period_hpr::R`](R) reader structure"]
impl crate::Readable for Pwm1PeriodHprSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm1_period_hpr::W`](W) writer structure"]
impl crate::Writable for Pwm1PeriodHprSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWM1_PERIOD_HPR to value 0"]
impl crate::Resettable for Pwm1PeriodHprSpec {
