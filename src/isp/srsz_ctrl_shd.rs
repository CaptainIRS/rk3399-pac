#[doc = "Register `SRSZ_CTRL_SHD` reader"]
pub type R = crate::R<SrszCtrlShdSpec>;
#[doc = "\n\nValue on reset: 0"]
...
#[doc = "global control shadow register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`srsz_ctrl_shd::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SrszCtrlShdSpec;
impl crate::RegisterSpec for SrszCtrlShdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`srsz_ctrl_shd::R`](R) reader structure"]
impl crate::Readable for SrszCtrlShdSpec {}
#[doc = "`reset()` method sets SRSZ_CTRL_SHD to value 0"]
impl crate::Resettable for SrszCtrlShdSpec {
