#[doc = "Register `MRSZ_CTRL` reader"]
pub type R = crate::R<MrszCtrlSpec>;
#[doc = "Register `MRSZ_CTRL` writer"]
pub type W = crate::W<MrszCtrlSpec>;
#[doc = "\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scale_hy_enable(&mut self) -> ScaleHyEnableW<MrszCtrlSpec> {
        ScaleHyEnableW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn scale_hc_enable(&mut self) -> ScaleHcEnableW<MrszCtrlSpec> {
        ScaleHcEnableW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn scale_vy_enable(&mut self) -> ScaleVyEnableW<MrszCtrlSpec> {
        ScaleVyEnableW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn scale_vc_enable(&mut self) -> ScaleVcEnableW<MrszCtrlSpec> {
        ScaleVcEnableW::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn scale_hy_up(&mut self) -> ScaleHyUpW<MrszCtrlSpec> {
        ScaleHyUpW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn scale_hc_up(&mut self) -> ScaleHcUpW<MrszCtrlSpec> {
        ScaleHcUpW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn scale_vy_up(&mut self) -> ScaleVyUpW<MrszCtrlSpec> {
        ScaleVyUpW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn scale_vc_up(&mut self) -> ScaleVcUpW<MrszCtrlSpec> {
        ScaleVcUpW::new(self, 7)
    }
    #[doc = "Bit 8 - write 0: nothing happens\n\nwrite 1: update shadow registers read: always 0\n\n"]
    #[inline(always)]
    #[must_use]
    pub fn cfg_upd(&mut self) -> CfgUpdW<MrszCtrlSpec> {
        CfgUpdW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn auto_upd(&mut self) -> AutoUpdW<MrszCtrlSpec> {
        AutoUpdW::new(self, 9)
    }
}
#[doc = "global control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mrsz_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mrsz_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MrszCtrlSpec;
impl crate::RegisterSpec for MrszCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrsz_ctrl::R`](R) reader structure"]
impl crate::Readable for MrszCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`mrsz_ctrl::W`](W) writer structure"]
impl crate::Writable for MrszCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MRSZ_CTRL to value 0"]
impl crate::Resettable for MrszCtrlSpec {
