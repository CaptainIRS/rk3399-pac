#[doc = "Register `PI_REG_155` reader"]
pub type R = crate::R<PiReg155Spec>;
#[doc = "Register `PI_REG_155` writer"]
pub type W = crate::W<PiReg155Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_bank_diff(&mut self) -> PiBankDiffW<PiReg155Spec> {
        PiBankDiffW::new(self, 16)
    }
    #[doc = "Bits 24:26 - Indicates the difference between the number of address pins available and the number being used."]
    #[inline(always)]
    #[must_use]
    pub fn pi_row_diff(&mut self) -> PiRowDiffW<PiReg155Spec> {
        PiRowDiffW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 155\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_155::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_155::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg155Spec;
impl crate::RegisterSpec for PiReg155Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_155::R`](R) reader structure"]
impl crate::Readable for PiReg155Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_155::W`](W) writer structure"]
impl crate::Writable for PiReg155Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_155 to value 0"]
impl crate::Resettable for PiReg155Spec {
