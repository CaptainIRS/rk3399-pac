#[doc = "Register `PI_REG_52` reader"]
pub type R = crate::R<PiReg52Spec>;
#[doc = "Register `PI_REG_52` writer"]
pub type W = crate::W<PiReg52Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_sw_leveling_mode(&mut self) -> PiSwLevelingModeW<PiReg52Spec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_swlvl_start(&mut self) -> PiSwlvlStartW<PiReg52Spec> {
        PiSwlvlStartW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 52\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_52::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_52::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg52Spec;
impl crate::RegisterSpec for PiReg52Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_52::R`](R) reader structure"]
impl crate::Readable for PiReg52Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_52::W`](W) writer structure"]
impl crate::Writable for PiReg52Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_52 to value 0"]
impl crate::Resettable for PiReg52Spec {
