#[doc = "Register `PI_REG_103` reader"]
pub type R = crate::R<PiReg103Spec>;
#[doc = "Register `PI_REG_103` writer"]
pub type W = crate::W<PiReg103Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tmrz_f1(&mut self) -> PiTmrzF1W<PiReg103Spec> {
        PiTmrzF1W::new(self, 0)
    }
    #[doc = "Bits 8:21 - Indicates DRAM TCAENT value in cycles. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tcaent_f1(&mut self) -> PiTcaentF1W<PiReg103Spec> {
        PiTcaentF1W::new(self, 8)
    }
    #[doc = "Bits 24:28 - Indicates DRAM TMRZ value in cycles. The suffix \"_f2\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tmrz_f2(&mut self) -> PiTmrzF2W<PiReg103Spec> {
        PiTmrzF2W::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 103\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_103::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_103::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg103Spec;
impl crate::RegisterSpec for PiReg103Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_103::R`](R) reader structure"]
impl crate::Readable for PiReg103Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_103::W`](W) writer structure"]
impl crate::Writable for PiReg103Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_103 to value 0"]
impl crate::Resettable for PiReg103Spec {
