#[doc = "Register `PI_REG_187` reader"]
pub type R = crate::R<PiReg187Spec>;
#[doc = "Register `PI_REG_187` writer"]
pub type W = crate::W<PiReg187Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_ctrlupd_max_f0(&mut self) -> PiTdfiCtrlupdMaxF0W<PiReg187Spec> {
        PiTdfiCtrlupdMaxF0W::new(self, 8)
    }
}
#[doc = "DDR PHY Independent Register 187\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_187::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_187::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg187Spec;
impl crate::RegisterSpec for PiReg187Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_187::R`](R) reader structure"]
impl crate::Readable for PiReg187Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_187::W`](W) writer structure"]
impl crate::Writable for PiReg187Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_187 to value 0"]
impl crate::Resettable for PiReg187Spec {
