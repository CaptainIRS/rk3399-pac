#[doc = "Register `PI_REG_72` reader"]
pub type R = crate::R<PiReg72Spec>;
#[doc = "Register `PI_REG_72` writer"]
pub type W = crate::W<PiReg72Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_odtlon_f2(&mut self) -> PiOdtlonF2W<PiReg72Spec> {
        PiOdtlonF2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Defines the point in time when the device termination circuit leaves High-Z and ODT resistance begins to turn on. The suffix \"_f2\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_todton_min_f2(&mut self) -> PiTodtonMinF2W<PiReg72Spec> {
        PiTodtonMinF2W::new(self, 8)
    }
    #[doc = "Bits 16:21 - Defines the DRAM Write command to ODT set in cycles. The suffix \"_f0\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_wr_to_odth_f0(&mut self) -> PiWrToOdthF0W<PiReg72Spec> {
        PiWrToOdthF0W::new(self, 16)
    }
    #[doc = "Bits 24:29 - Defines the DRAM Write command to ODT set in cycles. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_wr_to_odth_f1(&mut self) -> PiWrToOdthF1W<PiReg72Spec> {
        PiWrToOdthF1W::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 72\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_72::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_72::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg72Spec;
impl crate::RegisterSpec for PiReg72Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_72::R`](R) reader structure"]
impl crate::Readable for PiReg72Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_72::W`](W) writer structure"]
impl crate::Writable for PiReg72Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_72 to value 0"]
impl crate::Resettable for PiReg72Spec {
