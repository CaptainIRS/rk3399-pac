#[doc = "Register `PI_REG_50` reader"]
pub type R = crate::R<PiReg50Spec>;
#[doc = "Field `PI_SWLVL_OP_DONE` reader - Indicates signals that software leveling is currently in progress. Value of 1 indicates operation complete."]
...
impl R {
    #[doc = "Bit 0 - Indicates signals that software leveling is currently in progress. Value of 1 indicates operation complete."]
    #[inline(always)]
...
#[doc = "DDR PHY Independent Register 50\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_50::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg50Spec;
impl crate::RegisterSpec for PiReg50Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_50::R`](R) reader structure"]
impl crate::Readable for PiReg50Spec {}
#[doc = "`reset()` method sets PI_REG_50 to value 0"]
impl crate::Resettable for PiReg50Spec {
