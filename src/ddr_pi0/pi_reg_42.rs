#[doc = "Register `PI_REG_42` reader"]
pub type R = crate::R<PiReg42Spec>;
#[doc = "Register `PI_REG_42` writer"]
pub type W = crate::W<PiReg42Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdelay_rdwr_2_bus_idle_f0(&mut self) -> PiTdelayRdwr2BusIdleF0W<PiReg42Spec> {
        PiTdelayRdwr2BusIdleF0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Indicates the delay from read or write to bus idle. Recommended setting is delay time from read command that issued to the last read data received. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tdelay_rdwr_2_bus_idle_f1(&mut self) -> PiTdelayRdwr2BusIdleF1W<PiReg42Spec> {
        PiTdelayRdwr2BusIdleF1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Indicates the delay from read or write to bus idle. Recommended setting is delay time from read command that issued to the last read data received. The suffix \"_f2\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tdelay_rdwr_2_bus_idle_f2(&mut self) -> PiTdelayRdwr2BusIdleF2W<PiReg42Spec> {
        PiTdelayRdwr2BusIdleF2W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Indicates DRAM TMRR value in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tmrr(&mut self) -> PiTmrrW<PiReg42Spec> {
        PiTmrrW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 42\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_42::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_42::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg42Spec;
impl crate::RegisterSpec for PiReg42Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_42::R`](R) reader structure"]
impl crate::Readable for PiReg42Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_42::W`](W) writer structure"]
impl crate::Writable for PiReg42Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_42 to value 0"]
impl crate::Resettable for PiReg42Spec {
