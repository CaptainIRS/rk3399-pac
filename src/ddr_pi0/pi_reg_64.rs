#[doc = "Register `PI_REG_64` reader"]
pub type R = crate::R<PiReg64Spec>;
#[doc = "Register `PI_REG_64` writer"]
pub type W = crate::W<PiReg64Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_wrlvl_resp(&mut self) -> PiTdfiWrlvlRespW<PiReg64Spec> {
        PiTdfiWrlvlRespW::new(self, 0)
    }
}
#[doc = "DDR PHY Independent Register 64\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_64::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_64::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg64Spec;
impl crate::RegisterSpec for PiReg64Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_64::R`](R) reader structure"]
impl crate::Readable for PiReg64Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_64::W`](W) writer structure"]
impl crate::Writable for PiReg64Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_64 to value 0"]
impl crate::Resettable for PiReg64Spec {
