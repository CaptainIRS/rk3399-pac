#[doc = "Register `PI_REG_41` reader"]
pub type R = crate::R<PiReg41Spec>;
#[doc = "Register `PI_REG_41` writer"]
pub type W = crate::W<PiReg41Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_wdt_disable(&mut self) -> PiWdtDisableW<PiReg41Spec> {
        PiWdtDisableW::new(self, 0)
    }
    #[doc = "Bit 8 - Indicates user request to reset the whole system except parameter DFFs. Set 0 to reset, set to 1 to release."]
    #[inline(always)]
    #[must_use]
    pub fn pi_sw_rst_n(&mut self) -> PiSwRstNW<PiReg41Spec> {
        PiSwRstNW::new(self, 8)
    }
    #[doc = "Bits 24:25 - Defines the chip selects that are active."]
    #[inline(always)]
    #[must_use]
    pub fn pi_cs_map(&mut self) -> PiCsMapW<PiReg41Spec> {
        PiCsMapW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 41\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_41::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_41::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg41Spec;
impl crate::RegisterSpec for PiReg41Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_41::R`](R) reader structure"]
impl crate::Readable for PiReg41Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_41::W`](W) writer structure"]
impl crate::Writable for PiReg41Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_41 to value 0x0101"]
impl crate::Resettable for PiReg41Spec {
