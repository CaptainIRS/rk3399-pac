#[doc = "Register `PI_REG_112` reader"]
pub type R = crate::R<PiReg112Spec>;
#[doc = "Register `PI_REG_112` writer"]
pub type W = crate::W<PiReg112Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tckckeh(&mut self) -> PiTckckehW<PiReg112Spec> {
        PiTckckehW::new(self, 0)
    }
    #[doc = "Bits 8:12 - Indicates the consecutive dfi_calvl_strobe number when updating the CA VREF data."]
    #[inline(always)]
    #[must_use]
    pub fn pi_calvl_strobe_num(&mut self) -> PiCalvlStrobeNumW<PiReg112Spec> {
        PiCalvlStrobeNumW::new(self, 8)
    }
    #[doc = "Bits 16:22 - Indicates the VREF value, which is set for software step-by-step CA training."]
    #[inline(always)]
    #[must_use]
    pub fn pi_sw_ca_train_vref(&mut self) -> PiSwCaTrainVrefW<PiReg112Spec> {
        PiSwCaTrainVrefW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Defines the DFI tINIT_START timing parameter (in DFI clocks), the maximum number or cycles between a dfi_init_start assertion and a dfi_init_complete de-assertion from the PHY. The suffix \"_f0\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_init_start_f0(&mut self) -> PiTdfiInitStartF0W<PiReg112Spec> {
        PiTdfiInitStartF0W::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 112\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_112::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_112::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg112Spec;
impl crate::RegisterSpec for PiReg112Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_112::R`](R) reader structure"]
impl crate::Readable for PiReg112Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_112::W`](W) writer structure"]
impl crate::Writable for PiReg112Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_112 to value 0"]
impl crate::Resettable for PiReg112Spec {
