#[doc = "Register `PI_REG_56` reader"]
pub type R = crate::R<PiReg56Spec>;
#[doc = "Register `PI_REG_56` writer"]
pub type W = crate::W<PiReg56Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_sw_wdqlvl_vref(&mut self) -> PiSwWdqlvlVrefW<PiReg56Spec> {
        PiSwWdqlvlVrefW::new(self, 8)
    }
    #[doc = "Bit 16 - Indicates software leveling start command for stage 2."]
    #[inline(always)]
    #[must_use]
    pub fn pi_swlvl_sm2_start(&mut self) -> PiSwlvlSm2StartW<PiReg56Spec> {
        PiSwlvlSm2StartW::new(self, 16)
    }
    #[doc = "Bit 24 - Indicates software leveling write command for stage 2."]
    #[inline(always)]
    #[must_use]
    pub fn pi_swlvl_sm2_wr(&mut self) -> PiSwlvlSm2WrW<PiReg56Spec> {
        PiSwlvlSm2WrW::new(self, 24)
    }
}
#[doc = "DDR PHY Independent Register 56\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_56::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_56::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg56Spec;
impl crate::RegisterSpec for PiReg56Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_56::R`](R) reader structure"]
impl crate::Readable for PiReg56Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_56::W`](W) writer structure"]
impl crate::Writable for PiReg56Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_56 to value 0"]
impl crate::Resettable for PiReg56Spec {
