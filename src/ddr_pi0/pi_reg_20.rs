...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_phyupd_type2_f2(&mut self) -> PiTdfiPhyupdType2F2W<PiReg20Spec> {
        PiTdfiPhyupdType2F2W::new(self, 0)
    }
}
#[doc = "DDR PHY Independent Register 20\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_20::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_20::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg20Spec;
impl crate::RegisterSpec for PiReg20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_20::R`](R) reader structure"]
impl crate::Readable for PiReg20Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_20::W`](W) writer structure"]
impl crate::Writable for PiReg20Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_20 to value 0"]
impl crate::Resettable for PiReg20Spec {
