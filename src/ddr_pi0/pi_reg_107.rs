#[doc = "Register `PI_REG_107` reader"]
pub type R = crate::R<PiReg107Spec>;
#[doc = "Register `PI_REG_107` writer"]
pub type W = crate::W<PiReg107Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tvref_short_f1(&mut self) -> PiTvrefShortF1W<PiReg107Spec> {
        PiTvrefShortF1W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Indicates delay from dfi_calvl_strobe to next CMD (more than one param_calvl_vref_stepsize Vref change). The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tvref_long_f1(&mut self) -> PiTvrefLongF1W<PiReg107Spec> {
        PiTvrefLongF1W::new(self, 16)
    }
}
#[doc = "DDR PHY Independent Register 107\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_107::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_107::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg107Spec;
impl crate::RegisterSpec for PiReg107Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_107::R`](R) reader structure"]
impl crate::Readable for PiReg107Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_107::W`](W) writer structure"]
impl crate::Writable for PiReg107Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_107 to value 0"]
impl crate::Resettable for PiReg107Spec {
