#[doc = "Register `PI_REG_96` reader"]
pub type R = crate::R<PiReg96Spec>;
#[doc = "Register `PI_REG_96` writer"]
pub type W = crate::W<PiReg96Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_calvl_cc_f1(&mut self) -> PiTdfiCalvlCcF1W<PiReg96Spec> {
        PiTdfiCalvlCcF1W::new(self, 0)
    }
    #[doc = "Bits 16:25 - Defines the DFI tCALVL_CAPTURE timing parameter (in DFI clocks), the minimum cycles between a calibration command and a dfi_calvl_capture pulse. The suffix \"_f1\" of the parameter name is omitted when in non-DFS mode."]
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_calvl_capture_f1(&mut self) -> PiTdfiCalvlCaptureF1W<PiReg96Spec> {
        PiTdfiCalvlCaptureF1W::new(self, 16)
    }
}
#[doc = "DDR PHY Independent Register 96\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pi_reg_96::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pi_reg_96::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PiReg96Spec;
impl crate::RegisterSpec for PiReg96Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_96::R`](R) reader structure"]
impl crate::Readable for PiReg96Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_96::W`](W) writer structure"]
impl crate::Writable for PiReg96Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_96 to value 0"]
impl crate::Resettable for PiReg96Spec {
