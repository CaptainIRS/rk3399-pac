#[doc = "Register `PI_REG_17` reader"]
pub type R = crate::R<PiReg17Spec>;
#[doc = "Register `PI_REG_17` writer"]
pub type W = crate::W<PiReg17Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pi_tdfi_phyupd_resp_f2(&mut self) -> PiTdfiPhyupdRespF2W<PiReg17Spec> {
...
pub struct PiReg17Spec;
impl crate::RegisterSpec for PiReg17Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pi_reg_17::R`](R) reader structure"]
impl crate::Readable for PiReg17Spec {}
#[doc = "`write(|w| ..)` method takes [`pi_reg_17::W`](W) writer structure"]
impl crate::Writable for PiReg17Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PI_REG_17 to value 0"]
impl crate::Resettable for PiReg17Spec {
