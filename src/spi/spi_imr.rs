...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfeim(&mut self) -> TfeimW<SpiImrSpec> {
        TfeimW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit FIFO Overflow Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn tfoim(&mut self) -> TfoimW<SpiImrSpec> {
        TfoimW::new(self, 1)
    }
    #[doc = "Bit 2 - Receive FIFO Underflow Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rfuim(&mut self) -> RfuimW<SpiImrSpec> {
        RfuimW::new(self, 2)
    }
    #[doc = "Bit 3 - Receive FIFO Overflow Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rfoim(&mut self) -> RfoimW<SpiImrSpec> {
        RfoimW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive FIFO Full Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rffim(&mut self) -> RffimW<SpiImrSpec> {
        RffimW::new(self, 4)
    }
}
#[doc = "Interrupt Mask\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spi_imr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spi_imr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SpiImrSpec;
impl crate::RegisterSpec for SpiImrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_imr::R`](R) reader structure"]
impl crate::Readable for SpiImrSpec {}
#[doc = "`write(|w| ..)` method takes [`spi_imr::W`](W) writer structure"]
impl crate::Writable for SpiImrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SPI_IMR to value 0"]
impl crate::Resettable for SpiImrSpec {
