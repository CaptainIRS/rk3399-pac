#[doc = "Register `SPI_DMARDLR` reader"]
...
#[doc = "DMA Receive Data Level\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spi_dmardlr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spi_dmardlr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SpiDmardlrSpec;
impl crate::RegisterSpec for SpiDmardlrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_dmardlr::R`](R) reader structure"]
impl crate::Readable for SpiDmardlrSpec {}
#[doc = "`write(|w| ..)` method takes [`spi_dmardlr::W`](W) writer structure"]
impl crate::Writable for SpiDmardlrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SPI_DMARDLR to value 0"]
impl crate::Resettable for SpiDmardlrSpec {
