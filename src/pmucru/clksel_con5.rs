#[doc = "Register `CLKSEL_CON5` reader"]
pub type R = crate::R<ClkselCon5Spec>;
#[doc = "Register `CLKSEL_CON5` writer"]
pub type W = crate::W<ClkselCon5Spec>;
#[doc = "Field `UART4_DIV_CON` reader - uart4 divider control register\n\nclk=clk_src/(div_con+1)"]
pub type Uart4DivConR = crate::FieldReader;
#[doc = "Field `UART4_DIV_CON` writer - uart4 divider control register\n\nclk=clk_src/(div_con+1)"]
...
pub enum Uart4ClkSel {
    #[doc = "0: clk_uart4_divout"]
    B00 = 0,
    #[doc = "1: clk_uart4_frac"]
    B01 = 1,
    #[doc = "2: xin_24m"]
    B10 = 2,
}
...
impl R {
    #[doc = "Bits 0:6 - uart4 divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uart4_div_con(&mut self) -> Uart4DivConW<ClkselCon5Spec> {
        Uart4DivConW::new(self, 0)
    }
    #[doc = "Bits 8:9 - uart4_clk source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn uart4_clk_sel(&mut self) -> Uart4ClkSelW<ClkselCon5Spec> {
        Uart4ClkSelW::new(self, 8)
    }
    #[doc = "Bit 10 - clk_uart_pll source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_uart_pll_sel(&mut self) -> ClkUartPllSelW<ClkselCon5Spec> {
        ClkUartPllSelW::new(self, 10)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<ClkselCon5Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal clock select and divide register5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clksel_con5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clksel_con5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkselCon5Spec;
impl crate::RegisterSpec for ClkselCon5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clksel_con5::R`](R) reader structure"]
impl crate::Readable for ClkselCon5Spec {}
#[doc = "`write(|w| ..)` method takes [`clksel_con5::W`](W) writer structure"]
impl crate::Writable for ClkselCon5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKSEL_CON5 to value 0x0200"]
impl crate::Resettable for ClkselCon5Spec {
