#[doc = "Register `RSTNHOLD_CON0` reader"]
pub type R = crate::R<RstnholdCon0Spec>;
#[doc = "Register `RSTNHOLD_CON0` writer"]
pub type W = crate::W<RstnholdCon0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn presetn_noc_pmu_hold(&mut self) -> PresetnNocPmuHoldW<RstnholdCon0Spec> {
        PresetnNocPmuHoldW::new(self, 1)
    }
    #[doc = "Bit 2 - presetn_intmem_pmu_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_intmem_pmu_hold(&mut self) -> PresetnIntmemPmuHoldW<RstnholdCon0Spec> {
        PresetnIntmemPmuHoldW::new(self, 2)
    }
    #[doc = "Bit 3 - hresetn_cm0s_pmu_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_cm0s_pmu_hold(&mut self) -> HresetnCm0sPmuHoldW<RstnholdCon0Spec> {
        HresetnCm0sPmuHoldW::new(self, 3)
    }
    #[doc = "Bit 4 - hresetn_cm0s_noc_pmu_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn hresetn_cm0s_noc_pmu_hold(&mut self) -> HresetnCm0sNocPmuHoldW<RstnholdCon0Spec> {
        HresetnCm0sNocPmuHoldW::new(self, 4)
    }
    #[doc = "Bit 5 - dbgresetn_cm0s_pmu_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn dbgresetn_cm0s_pmu_hold(&mut self) -> DbgresetnCm0sPmuHoldW<RstnholdCon0Spec> {
        DbgresetnCm0sPmuHoldW::new(self, 5)
    }
    #[doc = "Bit 6 - poresetn_cm0s_pmu_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn poresetn_cm0s_pmu_hold(&mut self) -> PoresetnCm0sPmuHoldW<RstnholdCon0Spec> {
        PoresetnCm0sPmuHoldW::new(self, 6)
    }
    #[doc = "Bit 7 - presetn_spi3_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_spi3_hold(&mut self) -> PresetnSpi3HoldW<RstnholdCon0Spec> {
        PresetnSpi3HoldW::new(self, 7)
    }
    #[doc = "Bit 8 - resetn_spi3_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_spi3_hold(&mut self) -> ResetnSpi3HoldW<RstnholdCon0Spec> {
        ResetnSpi3HoldW::new(self, 8)
    }
    #[doc = "Bit 9 - presetn_timer_pmu_0_1_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_timer_pmu_0_1_hold(&mut self) -> PresetnTimerPmu0_1HoldW<RstnholdCon0Spec> {
        PresetnTimerPmu0_1HoldW::new(self, 9)
    }
    #[doc = "Bit 10 - resetn_timer_pmu_0_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_timer_pmu_0_hold(&mut self) -> ResetnTimerPmu0HoldW<RstnholdCon0Spec> {
        ResetnTimerPmu0HoldW::new(self, 10)
    }
    #[doc = "Bit 11 - resetn_timer_pmu_1_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_timer_pmu_1_hold(&mut self) -> ResetnTimerPmu1HoldW<RstnholdCon0Spec> {
        ResetnTimerPmu1HoldW::new(self, 11)
    }
    #[doc = "Bit 12 - presetn_uart_m0_pmu_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_uart_m0_pmu_hold(&mut self) -> PresetnUartM0PmuHoldW<RstnholdCon0Spec> {
        PresetnUartM0PmuHoldW::new(self, 12)
    }
    #[doc = "Bit 13 - resetn_uart_m0_pmu_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn resetn_uart_m0_pmu_hold(&mut self) -> ResetnUartM0PmuHoldW<RstnholdCon0Spec> {
        ResetnUartM0PmuHoldW::new(self, 13)
    }
    #[doc = "Bit 14 - presetn_wdt_pmu_hold control bit\n\nWhen HIGH, reset hold, can't be reset by any reset source"]
    #[inline(always)]
    #[must_use]
    pub fn presetn_wdt_pmu_hold(&mut self) -> PresetnWdtPmuHoldW<RstnholdCon0Spec> {
        PresetnWdtPmuHoldW::new(self, 14)
    }
    #[doc = "Bits 16:31 - write mask bits\n\nWhen every bit HIGH, enable the writing corresponding bit\n\nWhen every bit LOW, don't care the writing corresponding bit"]
    #[inline(always)]
    #[must_use]
    pub fn write_mask(&mut self) -> WriteMaskW<RstnholdCon0Spec> {
        WriteMaskW::new(self, 16)
    }
}
#[doc = "Internal reset hold control register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rstnhold_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rstnhold_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RstnholdCon0Spec;
impl crate::RegisterSpec for RstnholdCon0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rstnhold_con0::R`](R) reader structure"]
impl crate::Readable for RstnholdCon0Spec {}
#[doc = "`write(|w| ..)` method takes [`rstnhold_con0::W`](W) writer structure"]
impl crate::Writable for RstnholdCon0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RSTNHOLD_CON0 to value 0"]
impl crate::Resettable for RstnholdCon0Spec {
