...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_spi3_div_con(&mut self) -> ClkSpi3DivConW<ClkselCon1Spec> {
        ClkSpi3DivConW::new(self, 0)
    }
    #[doc = "Bit 7 - clk_spi3_pll source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_spi3_pll_sel(&mut self) -> ClkSpi3PllSelW<ClkselCon1Spec> {
        ClkSpi3PllSelW::new(self, 7)
    }
    #[doc = "Bits 8:12 - clk_wifi divider control register\n\nclk=clk_src/(div_con+1)"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifi_div_con(&mut self) -> ClkWifiDivConW<ClkselCon1Spec> {
        ClkWifiDivConW::new(self, 8)
    }
    #[doc = "Bit 13 - clk_wifi_pll source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifi_pll_sel(&mut self) -> ClkWifiPllSelW<ClkselCon1Spec> {
        ClkWifiPllSelW::new(self, 13)
    }
    #[doc = "Bit 14 - clk_wifi source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifi_sel(&mut self) -> ClkWifiSelW<ClkselCon1Spec> {
        ClkWifiSelW::new(self, 14)
    }
    #[doc = "Bit 15 - clk_timer source select control register"]
    #[inline(always)]
    #[must_use]
    pub fn clk_timer_sel(&mut self) -> ClkTimerSelW<ClkselCon1Spec> {
...
#[doc = "`reset()` method sets CLKSEL_CON1 to value 0x1986"]
