...
Specifies maximum payload size supported by the device. This field reflects the setting of the corresponding field in the PCIe Device Capability Register of PF 0"]
...
Set when device allows the tag field to be extended from 5 to 8 bits. This field reflects the setting of the corresponding field in the PCIe Device Capability Register of PF 0."]
pub type EtfsR = crate::BitReader;
#[doc = "Field `AL0SL` reader - Acceptable L0S Latency \\[AL0SL\\]
Specifies acceptable latency that the Endpoint can tolerate while transitioning from L0S to L0. This field reflects the setting of the corresponding field in the PCIe Device Capability Register of PF 0."]
pub type Al0slR = crate::FieldReader;
#[doc = "Field `AL1SL` reader - Acceptable L1 Latency \\[AL1SL\\]
Specifies acceptable latency that the Endpoint can tolerate while transitioning from L1 to L0. This field reflects the setting of the corresponding field in the PCIe Device Capability Register of PF 0."]
...
This field reflects the setting of the corresponding field in the PCIe Device Capability Register of PF 0."]
...
Set when device has Function-Level Reset capability. Hardwired to 1."]
