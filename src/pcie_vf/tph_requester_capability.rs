#[doc = "Register `TPH_REQUESTER_CAPABILITY` reader"]
pub type R = crate::R<TphRequesterCapabilitySpec>;
...
#[doc = "TPH Requester Capability Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tph_requester_capability::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TphRequesterCapabilitySpec;
impl crate::RegisterSpec for TphRequesterCapabilitySpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tph_requester_capability::R`](R) reader structure"]
impl crate::Readable for TphRequesterCapabilitySpec {}
#[doc = "`reset()` method sets TPH_REQUESTER_CAPABILITY to value 0x0007_0207"]
impl crate::Resettable for TphRequesterCapabilitySpec {
