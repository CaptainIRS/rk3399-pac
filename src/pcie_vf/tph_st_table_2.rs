#[doc = "Register `TPH_ST_TABLE_2` reader"]
pub type R = crate::R<TphStTable2Spec>;
#[doc = "Register `TPH_ST_TABLE_2` writer"]
pub type W = crate::W<TphStTable2Spec>;
...
Lower 8 bits of the first Steering Tag. This is the 8- bit Steering Tag sent out in requests."]
    #[inline(always)]
    #[must_use]
    pub fn st0l(&mut self) -> St0lW<TphStTable2Spec> {
        St0lW::new(self, 0)
    }
    #[doc = "Bits 16:23 - ST 1 Lower \\[ST1L\\]
Lower 8 bits of the second Steering Tag. This is the 8-bit Steering Tag sent out in requests."]
    #[inline(always)]
    #[must_use]
    pub fn st1l(&mut self) -> St1lW<TphStTable2Spec> {
        St1lW::new(self, 16)
    }
}
#[doc = "TPH ST Table 2 This field is used for the upper 8 bits of the second Steering Tag when Extended TPH Requester support is enabled.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tph_st_table_2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tph_st_table_2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TphStTable2Spec;
impl crate::RegisterSpec for TphStTable2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tph_st_table_2::R`](R) reader structure"]
impl crate::Readable for TphStTable2Spec {}
#[doc = "`write(|w| ..)` method takes [`tph_st_table_2::W`](W) writer structure"]
impl crate::Writable for TphStTable2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TPH_ST_TABLE_2 to value 0"]
impl crate::Resettable for TphStTable2Spec {
