#[doc = "Register `TPH_REQUESTER_ENHANCED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<TphRequesterEnhancedCapabilityHeaderSpec>;
...
#[doc = "TPH Requester Enhanced Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tph_requester_enhanced_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TphRequesterEnhancedCapabilityHeaderSpec;
impl crate::RegisterSpec for TphRequesterEnhancedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tph_requester_enhanced_capability_header::R`](R) reader structure"]
impl crate::Readable for TphRequesterEnhancedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets TPH_REQUESTER_ENHANCED_CAPABILITY_HEADER to value 0x0001_0017"]
impl crate::Resettable for TphRequesterEnhancedCapabilityHeaderSpec {
