#[doc = "Register `MSI_X_PENDING_INTERRUPT` reader"]
pub type R = crate::R<MsiXPendingInterruptSpec>;
...
#[doc = "MSI-X Pending Interrupt Register Offset of the memory address where the PBA is located, relative to the selected BAR. The three least significant bits of the address are omitted, as the addresses are QWORD aligned.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`msi_x_pending_interrupt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MsiXPendingInterruptSpec;
impl crate::RegisterSpec for MsiXPendingInterruptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`msi_x_pending_interrupt::R`](R) reader structure"]
impl crate::Readable for MsiXPendingInterruptSpec {}
#[doc = "`reset()` method sets MSI_X_PENDING_INTERRUPT to value 0x08"]
impl crate::Resettable for MsiXPendingInterruptSpec {
