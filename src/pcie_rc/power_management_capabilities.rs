...
Identifies that the capability structure is for Power Management. This field is set by default to 01 hex. This field can be written from the APB bus by setting \\[21\\]
...
Contains pointer to the next PCI Capability Structure. The core sets it to the value defined in the RTL file reg_defaults.h. This field can be written from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
pub type CpR = crate::FieldReader;
#[doc = "Field `VID` reader - Version ID \\[VID\\]
Indicates the version of the PCI Bus Power Management Specifications that the Function implements. This field is set by default to 011 (Version 1.2). This field can be written from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
...
Set if the Function supports the D1 power state. This field can be written from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
...
Indicates whether the Function is capable of sending PME messages when in the D0 state. This field can be written from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
...
Indicates whether the Function is capable of sending PME messages when in the D3hot state. This field can be written from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
pub type PsdhsR = crate::BitReader;
#[doc = "Field `PSDCS` reader - PME Support for D3(cold) State \\[PSDCS\\]
Indicates whether the Function is capable of sending PME messages when in the D3cold state. This field can be written from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
...
#[doc = "`reset()` method sets POWER_MANAGEMENT_CAPABILITIES to value 0xda03_9001"]
