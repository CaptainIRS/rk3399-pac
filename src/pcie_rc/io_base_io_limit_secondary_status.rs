#[doc = "Register `IO_BASE_IO_LIMIT_SECONDARY_STATUS` reader"]
pub type R = crate::R<IoBaseIoLimitSecondaryStatusSpec>;
#[doc = "Register `IO_BASE_IO_LIMIT_SECONDARY_STATUS` writer"]
pub type W = crate::W<IoBaseIoLimitSecondaryStatusSpec>;
...
bit high of the pcie_mgmt_APB_ADDR during a local management register write. Note that this bit can be set only when the Parity Error Response Enable bit is set in the Bridge Control Register"]
    #[inline(always)]
    #[must_use]
    pub fn mpe(&mut self) -> MpeW<IoBaseIoLimitSecondaryStatusSpec> {
        MpeW::new(self, 24)
    }
    #[doc = "Bit 27 - Signaled Target Abort \\[STA\\]
The core does not set this bit by itself. This bit can be cleared by writing a 1 into this bit position from the local management APB bus. This field can be forced to 1 or 0 from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
    #[inline(always)]
    #[must_use]
    pub fn sta(&mut self) -> StaW<IoBaseIoLimitSecondaryStatusSpec> {
        StaW::new(self, 27)
    }
    #[doc = "Bit 28 - Recieved Target Abort \\[RTA\\]
The core does not set this bit by itself. This bit can be cleared by writing a 1 into this bit position from the local management APB bus. This field can be forced to 1 or 0 from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
    #[inline(always)]
    #[must_use]
    pub fn rta(&mut self) -> RtaW<IoBaseIoLimitSecondaryStatusSpec> {
        RtaW::new(self, 28)
    }
    #[doc = "Bit 29 - Received Master Abort \\[RMA\\]
The core does not set this bit by itself. This bit can be cleared by writing a 1 into this bit position from the local management APB bus. This field can be forced to 1 or 0 from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
    #[inline(always)]
    #[must_use]
    pub fn rma(&mut self) -> RmaW<IoBaseIoLimitSecondaryStatusSpec> {
        RmaW::new(self, 29)
    }
    #[doc = "Bit 30 - Received System Error \\[RSE\\]
The core does not set this bit by itself. This bit can be cleared by writing a 1 into this bit position from the local management APB bus. This field can be forced to 1 or 0 from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
    #[inline(always)]
    #[must_use]
    pub fn rse(&mut self) -> RseW<IoBaseIoLimitSecondaryStatusSpec> {
        RseW::new(self, 30)
    }
    #[doc = "Bit 31 - Detected Parity Error \\[DPE\\]
The core does not set this bit by itself. This bit can be cleared by writing a 1 into this bit position from the local management APB bus. This field can be forced to 1 or 0 from the APB bus by setting \\[21\\]
bit high of the pcie_mgmt_APB_ADDR during a local management register write."]
    #[inline(always)]
    #[must_use]
    pub fn dpe(&mut self) -> DpeW<IoBaseIoLimitSecondaryStatusSpec> {
        DpeW::new(self, 31)
    }
}
...
bit high of the pcie_mgmt_APB_ADDR during a local management register write.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`io_base_io_limit_secondary_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`io_base_io_limit_secondary_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IoBaseIoLimitSecondaryStatusSpec;
impl crate::RegisterSpec for IoBaseIoLimitSecondaryStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`io_base_io_limit_secondary_status::R`](R) reader structure"]
impl crate::Readable for IoBaseIoLimitSecondaryStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`io_base_io_limit_secondary_status::W`](W) writer structure"]
impl crate::Writable for IoBaseIoLimitSecondaryStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xf900_0000;
}
#[doc = "`reset()` method sets IO_BASE_IO_LIMIT_SECONDARY_STATUS to value 0"]
impl crate::Resettable for IoBaseIoLimitSecondaryStatusSpec {
