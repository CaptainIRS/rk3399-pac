#[doc = "Register `ERROR_SOURCE_IDENTIFICATION` reader"]
pub type R = crate::R<ErrorSourceIdentificationSpec>;
...
#[doc = "Error Source Identification Register This field captures and stores the Requester ID from an ERR_FATAL or ERROR_NONFATAL message received by the RC, if the ERR_FATAL or NONFATAL Received bit was not set at the time the message was received. STICKY\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`error_source_identification::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ErrorSourceIdentificationSpec;
impl crate::RegisterSpec for ErrorSourceIdentificationSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`error_source_identification::R`](R) reader structure"]
impl crate::Readable for ErrorSourceIdentificationSpec {}
#[doc = "`reset()` method sets ERROR_SOURCE_IDENTIFICATION to value 0"]
impl crate::Resettable for ErrorSourceIdentificationSpec {
