...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn stdby_en_ch0(&mut self) -> StdbyEnCh0W<Ctrl1Spec> {
        StdbyEnCh0W::new(self, 0)
    }
    #[doc = "Bit 1 - Channel 1 standby mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn stdby_en_ch1(&mut self) -> StdbyEnCh1W<Ctrl1Spec> {
        StdbyEnCh1W::new(self, 1)
    }
    #[doc = "Bit 2 - Channel 0 memory clock gating in standby mode"]
    #[inline(always)]
    #[must_use]
    pub fn stdby_memcg_ch0(&mut self) -> StdbyMemcgCh0W<Ctrl1Spec> {
        StdbyMemcgCh0W::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 1 memory clock gating in standby mode"]
    #[inline(always)]
    #[must_use]
    pub fn stdby_memcg_ch1(&mut self) -> StdbyMemcgCh1W<Ctrl1Spec> {
        StdbyMemcgCh1W::new(self, 3)
    }
    #[doc = "Bit 4 - Channel 0 LP command priority in standby mode"]
    #[inline(always)]
    #[must_use]
    pub fn stdby_cmd_prio_ch0(&mut self) -> StdbyCmdPrioCh0W<Ctrl1Spec> {
        StdbyCmdPrioCh0W::new(self, 4)
    }
    #[doc = "Bit 5 - Channel 1 LP command priority in standby mode"]
    #[inline(always)]
    #[must_use]
    pub fn stdby_cmd_prio_ch1(&mut self) -> StdbyCmdPrioCh1W<Ctrl1Spec> {
        StdbyCmdPrioCh1W::new(self, 5)
    }
    #[doc = "Bit 8 - Channel 0 LP command priority in external self-refresh mode"]
    #[inline(always)]
    #[must_use]
    pub fn lp_cmd_prio_ch0(&mut self) -> LpCmdPrioCh0W<Ctrl1Spec> {
        LpCmdPrioCh0W::new(self, 8)
    }
    #[doc = "Bit 9 - Channel 1 LP command priority in external self-refresh mode"]
    #[inline(always)]
    #[must_use]
    pub fn lp_cmd_prio_ch1(&mut self) -> LpCmdPrioCh1W<Ctrl1Spec> {
        LpCmdPrioCh1W::new(self, 9)
    }
    #[doc = "Bit 10 - Channel 0 memory clock gating in self-refresh"]
    #[inline(always)]
    #[must_use]
    pub fn sref_memcg_ch0(&mut self) -> SrefMemcgCh0W<Ctrl1Spec> {
        SrefMemcgCh0W::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 1 memory clock gating in self-refresh"]
    #[inline(always)]
    #[must_use]
    pub fn sref_memcg_ch1(&mut self) -> SrefMemcgCh1W<Ctrl1Spec> {
        SrefMemcgCh1W::new(self, 11)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by software.\n\nWhen bit 16=0, bit 0 cannot be written by software;\n\nWhen bit 17=1, bit 1 can be written by software.\n\nWhen bit 17=0, bit 1 cannot be written by software;\n\n......\n\nWhen bit 31=1, bit 15 can be written by software.\n\nWhen bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Ctrl1Spec> {
