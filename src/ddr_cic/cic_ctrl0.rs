#[doc = "Register `CIC_CTRL0` reader"]
pub type R = crate::R<CicCtrl0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chg_req(&mut self) -> ChgReqW<CicCtrl0Spec> {
        ChgReqW::new(self, 0)
    }
    #[doc = "Bit 1 - Frequency change finish"]
    #[inline(always)]
    #[must_use]
    pub fn chg_freq_finish(&mut self) -> ChgFreqFinishW<CicCtrl0Spec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ddr0_freq_change_ack(&mut self) -> Ddr0FreqChangeAckW<CicCtrl0Spec> {
        Ddr0FreqChangeAckW::new(self, 8)
    }
    #[doc = "Bit 9 - Channel 1 DDR PHY frequency change acknowledge"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_freq_change_ack(&mut self) -> Ddr1FreqChangeAckW<CicCtrl0Spec> {
        Ddr1FreqChangeAckW::new(self, 9)
    }
    #[doc = "Bit 10 - Channel 0 DDR controller frequency change acknowledge"]
    #[inline(always)]
    #[must_use]
    pub fn ddr0_cntrl_freq_change_ack(&mut self) -> Ddr0CntrlFreqChangeAckW<CicCtrl0Spec> {
...
#[doc = "DDR Controller LP Interface Control Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cic_ctrl0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cic_ctrl0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CicCtrl0Spec;
impl crate::RegisterSpec for CicCtrl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cic_ctrl0::R`](R) reader structure"]
impl crate::Readable for CicCtrl0Spec {}
#[doc = "`write(|w| ..)` method takes [`cic_ctrl0::W`](W) writer structure"]
impl crate::Writable for CicCtrl0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CIC_CTRL0 to value 0"]
impl crate::Resettable for CicCtrl0Spec {
