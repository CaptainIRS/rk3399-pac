#[doc = "Register `DENALI_PHY_216` reader"]
pub type R = crate::R<DenaliPhy216Spec>;
#[doc = "Register `DENALI_PHY_216` writer"]
pub type W = crate::W<DenaliPhy216Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_wrlvl_resp_wait_cnt_1(&mut self) -> PhyWrlvlRespWaitCnt1W<DenaliPhy216Spec> {
        PhyWrlvlRespWaitCnt1W::new(self, 0)
    }
    #[doc = "Bits 8:11 - DQS slave delay step size during gate training for slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_dly_step_1(&mut self) -> PhyGtlvlDlyStep1W<DenaliPhy216Spec> {
        PhyGtlvlDlyStep1W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Number of cycles + 4 to wait between dfi_rddata_en and the sampling of the DQS during gate training for slice 1. The valid range is 0x0 to 0xB."]
    #[inline(always)]
    #[must_use]
    pub fn phy_gtlvl_resp_wait_cnt_1(&mut self) -> PhyGtlvlRespWaitCnt1W<DenaliPhy216Spec> {
        PhyGtlvlRespWaitCnt1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_216::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_216::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy216Spec;
impl crate::RegisterSpec for DenaliPhy216Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_216::R`](R) reader structure"]
impl crate::Readable for DenaliPhy216Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_216::W`](W) writer structure"]
impl crate::Writable for DenaliPhy216Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_216 to value 0"]
impl crate::Resettable for DenaliPhy216Spec {
