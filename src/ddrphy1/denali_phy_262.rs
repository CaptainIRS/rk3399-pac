#[doc = "Register `DENALI_PHY_262` reader"]
pub type R = crate::R<DenaliPhy262Spec>;
#[doc = "Register `DENALI_PHY_262` writer"]
pub type W = crate::W<DenaliPhy262Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_tsel_select_2(&mut self) -> PhyDqTselSelect2W<DenaliPhy262Spec> {
        PhyDqTselSelect2W::new(self, 0)
    }
    #[doc = "Bits 24:26 - Operation type tsel enables for DQS signals for slice 2. Bit (0) enables tsel_en during read cycles. Bit (1) enables tsel_en during write cycles. Bit (2) enables tsel_en during idle cycles. Set each bit to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dqs_tsel_enable_2(&mut self) -> PhyDqsTselEnable2W<DenaliPhy262Spec> {
        PhyDqsTselEnable2W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_262::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_262::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy262Spec;
impl crate::RegisterSpec for DenaliPhy262Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_262::R`](R) reader structure"]
impl crate::Readable for DenaliPhy262Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_262::W`](W) writer structure"]
impl crate::Writable for DenaliPhy262Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_262 to value 0"]
impl crate::Resettable for DenaliPhy262Spec {
