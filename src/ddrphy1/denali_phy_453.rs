#[doc = "Register `DENALI_PHY_453` reader"]
pub type R = crate::R<DenaliPhy453Spec>;
#[doc = "Register `DENALI_PHY_453` writer"]
pub type W = crate::W<DenaliPhy453Spec>;
...
impl W {
    ...
    pub fn phy_rddqs_dq0_fall_slave_delay_3(
        &mut self,
    ) -> PhyRddqsDq0FallSlaveDelay3W<DenaliPhy453Spec> {
    ...
    pub fn phy_rddqs_dq1_rise_slave_delay_3(
        &mut self,
    ) -> PhyRddqsDq1RiseSlaveDelay3W<DenaliPhy453Spec> {
        PhyRddqsDq1RiseSlaveDelay3W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_453::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_453::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy453Spec;
impl crate::RegisterSpec for DenaliPhy453Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_453::R`](R) reader structure"]
impl crate::Readable for DenaliPhy453Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_453::W`](W) writer structure"]
impl crate::Writable for DenaliPhy453Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_453 to value 0"]
impl crate::Resettable for DenaliPhy453Spec {
