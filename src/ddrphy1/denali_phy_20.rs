#[doc = "Register `DENALI_PHY_20` reader"]
pub type R = crate::R<DenaliPhy20Spec>;
#[doc = "Register `DENALI_PHY_20` writer"]
pub type W = crate::W<DenaliPhy20Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_slave_loop_cnt_update_0(&mut self) -> PhySlaveLoopCntUpdate0W<DenaliPhy20Spec> {
        PhySlaveLoopCntUpdate0W::new(self, 0)
    }
    #[doc = "Bit 8 - Disables automatic reset of the read entry FIFO pointers for slice 0. Set to 1 to disable automatic resets."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_fifo_ptr_rst_disable_0(&mut self) -> PhySwFifoPtrRstDisable0W<DenaliPhy20Spec> {
    ...
    pub fn phy_master_dly_lock_obs_select_0(
        &mut self,
    ) -> PhyMasterDlyLockObsSelect0W<DenaliPhy20Spec> {
        PhyMasterDlyLockObsSelect0W::new(self, 16)
    }
    #[doc = "Bits 24:26 - Select value to map the internal read DQ slave delay encoded settings to the accessible read DQ encoded slave delay observation register for slice 0."]
    #[inline(always)]
    #[must_use]
    pub fn phy_rddq_enc_obs_select_0(&mut self) -> PhyRddqEncObsSelect0W<DenaliPhy20Spec> {
        PhyRddqEncObsSelect0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_20::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_20::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy20Spec;
impl crate::RegisterSpec for DenaliPhy20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_20::R`](R) reader structure"]
impl crate::Readable for DenaliPhy20Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_20::W`](W) writer structure"]
impl crate::Writable for DenaliPhy20Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_20 to value 0"]
impl crate::Resettable for DenaliPhy20Spec {
