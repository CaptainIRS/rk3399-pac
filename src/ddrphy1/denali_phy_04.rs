#[doc = "Register `DENALI_PHY_04` reader"]
pub type R = crate::R<DenaliPhy04Spec>;
#[doc = "Register `DENALI_PHY_04` writer"]
pub type W = crate::W<DenaliPhy04Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq4_shift_0(&mut self) -> PhySwWrdq4Shift0W<DenaliPhy04Spec> {
        PhySwWrdq4Shift0W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ5 for slice 0. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq5_shift_0(&mut self) -> PhySwWrdq5Shift0W<DenaliPhy04Spec> {
        PhySwWrdq5Shift0W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ6 for slice 0. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq6_shift_0(&mut self) -> PhySwWrdq6Shift0W<DenaliPhy04Spec> {
        PhySwWrdq6Shift0W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Manual override of automatic half_cycle_shift/cycle_shift for write DQ7 for slice 0. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bits (4:3) are the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdq7_shift_0(&mut self) -> PhySwWrdq7Shift0W<DenaliPhy04Spec> {
        PhySwWrdq7Shift0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_04::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_04::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy04Spec;
impl crate::RegisterSpec for DenaliPhy04Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_04::R`](R) reader structure"]
impl crate::Readable for DenaliPhy04Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_04::W`](W) writer structure"]
impl crate::Writable for DenaliPhy04Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_04 to value 0"]
impl crate::Resettable for DenaliPhy04Spec {
