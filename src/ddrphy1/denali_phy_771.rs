...
#[doc = "Field `PHY_ADR_LPBK_RESULT_OBS_2` reader - Observation register containing loopback status/results for address slice 2. READ-ONLY"]
pub type PhyAdrLpbkResultObs2R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Observation register containing loopback status/results for address slice 2. READ-ONLY"]
    #[inline(always)]
