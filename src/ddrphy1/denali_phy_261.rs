#[doc = "Register `DENALI_PHY_261` reader"]
pub type R = crate::R<DenaliPhy261Spec>;
#[doc = "Register `DENALI_PHY_261` writer"]
pub type W = crate::W<DenaliPhy261Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdm_shift_2(&mut self) -> PhySwWrdmShift2W<DenaliPhy261Spec> {
        PhySwWrdmShift2W::new(self, 0)
    }
    #[doc = "Bits 8:11 - Manual override of automatic half_cycle_shift/cycle_shift for write DQS for slice 2. Bit (0) enables override of half_cycle_shift. Bit (1) is the half_cycle_shift value. Bit (2) enables override of cycle shift. Bit (3) is the cycle_shift value."]
    #[inline(always)]
    #[must_use]
    pub fn phy_sw_wrdqs_shift_2(&mut self) -> PhySwWrdqsShift2W<DenaliPhy261Spec> {
        PhySwWrdqsShift2W::new(self, 8)
    }
    #[doc = "Bits 16:18 - Operation type tsel enables for DQ/ DM signals for slice 2. Bit (0) enables tsel_en during read cycles. Bit (1) enables tsel_en during write cycles. Bit (2) enables tsel_en during idle cycles. Set each bit to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn phy_dq_tsel_enable_2(&mut self) -> PhyDqTselEnable2W<DenaliPhy261Spec> {
        PhyDqTselEnable2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_261::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_261::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy261Spec;
impl crate::RegisterSpec for DenaliPhy261Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_261::R`](R) reader structure"]
impl crate::Readable for DenaliPhy261Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_261::W`](W) writer structure"]
impl crate::Writable for DenaliPhy261Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_261 to value 0"]
impl crate::Resettable for DenaliPhy261Spec {
