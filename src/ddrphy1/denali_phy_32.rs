#[doc = "Register `DENALI_PHY_32` reader"]
pub type R = crate::R<DenaliPhy32Spec>;
#[doc = "Register `DENALI_PHY_32` writer"]
pub type W = crate::W<DenaliPhy32Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_user_patt4_0(&mut self) -> PhyUserPatt4_0W<DenaliPhy32Spec> {
    ...
    pub fn phy_calvl_vref_driving_slice_0(
        &mut self,
    ) -> PhyCalvlVrefDrivingSlice0W<DenaliPhy32Spec> {
        PhyCalvlVrefDrivingSlice0W::new(self, 16)
    }
    #[doc = "Bits 24:29 - Manual reset/clear of internal logic for slice 0. Bit (0) initiates manual setup of the read DQS gate. Bit (1) is reset of read entry FIFO pointers. Bit (2) is reset of master delay min/ max lock values. Bit (3) is manual reset of master delay unlock counter. Bit (4) is reset of leveling error bit in the leveling status registers. Bit (5) is clearing of the gate tracking observation register. Set each bit to 1 to initiate/reset. WRITE-ONLY"]
    #[inline(always)]
    #[must_use]
    pub fn sc_phy_manual_clear_0(&mut self) -> ScPhyManualClear0W<DenaliPhy32Spec> {
        ScPhyManualClear0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_32::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_32::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy32Spec;
impl crate::RegisterSpec for DenaliPhy32Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_32::R`](R) reader structure"]
impl crate::Readable for DenaliPhy32Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_32::W`](W) writer structure"]
impl crate::Writable for DenaliPhy32Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_32 to value 0"]
impl crate::Resettable for DenaliPhy32Spec {
