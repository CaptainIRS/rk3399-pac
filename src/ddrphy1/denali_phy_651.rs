#[doc = "Register `DENALI_PHY_651` reader"]
pub type R = crate::R<DenaliPhy651Spec>;
#[doc = "Register `DENALI_PHY_651` writer"]
pub type W = crate::W<DenaliPhy651Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_calvl_start_1(&mut self) -> PhyAdrCalvlStart1W<DenaliPhy651Spec> {
        PhyAdrCalvlStart1W::new(self, 0)
    }
    #[doc = "Bits 16:26 - Coarse CA training DLL increment value for address slice 1."]
    #[inline(always)]
    #[must_use]
    pub fn phy_adr_calvl_coarse_dly_1(&mut self) -> PhyAdrCalvlCoarseDly1W<DenaliPhy651Spec> {
        PhyAdrCalvlCoarseDly1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_phy_651::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_phy_651::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliPhy651Spec;
impl crate::RegisterSpec for DenaliPhy651Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_phy_651::R`](R) reader structure"]
impl crate::Readable for DenaliPhy651Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_phy_651::W`](W) writer structure"]
impl crate::Writable for DenaliPhy651Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_PHY_651 to value 0"]
impl crate::Resettable for DenaliPhy651Spec {
