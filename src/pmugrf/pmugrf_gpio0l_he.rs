#[doc = "Register `PMUGRF_GPIO0L_HE` reader"]
pub type R = crate::R<PmugrfGpio0lHeSpec>;
#[doc = "Register `PMUGRF_GPIO0L_HE` writer"]
pub type W = crate::W<PmugrfGpio0lHeSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0a_sr(&mut self) -> Gpio0aSrW<PmugrfGpio0lHeSpec> {
        Gpio0aSrW::new(self, 0)
    }
    #[doc = "Bits 8:15 - GPIO0B slew rate control for each bit"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0b_sr(&mut self) -> Gpio0bSrW<PmugrfGpio0lHeSpec> {
        Gpio0bSrW::new(self, 8)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<PmugrfGpio0lHeSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO0 A/B HE control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmugrf_gpio0l_he::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmugrf_gpio0l_he::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmugrfGpio0lHeSpec;
impl crate::RegisterSpec for PmugrfGpio0lHeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmugrf_gpio0l_he::R`](R) reader structure"]
impl crate::Readable for PmugrfGpio0lHeSpec {}
#[doc = "`write(|w| ..)` method takes [`pmugrf_gpio0l_he::W`](W) writer structure"]
impl crate::Writable for PmugrfGpio0lHeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMUGRF_GPIO0L_HE to value 0"]
impl crate::Resettable for PmugrfGpio0lHeSpec {
