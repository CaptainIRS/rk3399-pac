...
#[doc = "Field `GPIO0B_SMT` reader - GPIO0B drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO0B_SMT` writer - GPIO0B drive strength control, every GPIO bit corresponding to 2bits"]
