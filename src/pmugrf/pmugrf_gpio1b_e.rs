...
#[doc = "Field `GPIO1B_E` reader - GPIO1B drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO1B_E` writer - GPIO1B drive strength control, every GPIO bit corresponding to 2bits"]
