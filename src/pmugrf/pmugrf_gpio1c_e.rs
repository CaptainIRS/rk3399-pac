...
#[doc = "Field `GPIO1C_E` reader - GPIO1C drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO1C_E` writer - GPIO1C drive strength control, every GPIO bit corresponding to 2bits"]
