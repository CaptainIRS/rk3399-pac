#[doc = "Register `GPIO1L_SR` reader"]
pub type R = crate::R<Gpio1lSrSpec>;
#[doc = "Register `GPIO1L_SR` writer"]
pub type W = crate::W<Gpio1lSrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio1a_sr(&mut self) -> Gpio1aSrW<Gpio1lSrSpec> {
        Gpio1aSrW::new(self, 0)
    }
    #[doc = "Bits 8:15 - GPIO1B slew rate control for each bit"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1b_sr(&mut self) -> Gpio1bSrW<Gpio1lSrSpec> {
        Gpio1bSrW::new(self, 8)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio1lSrSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO1 A/B SR control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio1l_sr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio1l_sr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio1lSrSpec;
impl crate::RegisterSpec for Gpio1lSrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio1l_sr::R`](R) reader structure"]
impl crate::Readable for Gpio1lSrSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio1l_sr::W`](W) writer structure"]
impl crate::Writable for Gpio1lSrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO1L_SR to value 0"]
impl crate::Resettable for Gpio1lSrSpec {
