...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chip_32k_src(&mut self) -> Chip32kSrcW<SocCon0Spec> {
        Chip32kSrcW::new(self, 0)
    }
    #[doc = "Bit 1 - When pmu noc meet illegal access, the noc\n\nwill"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_noc_stall(&mut self) -> PmuNocStallW<SocCon0Spec> {
        PmuNocStallW::new(self, 1)
    }
    #[doc = "Bit 2 - pmu_mcu_niu_obsrv"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_mcu_niu_obsrv(&mut self) -> PmuMcuNiuObsrvW<SocCon0Spec> {
        PmuMcuNiuObsrvW::new(self, 2)
    }
    #[doc = "Bit 3 - pmu_noc_obsrv"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_noc_obsrv(&mut self) -> PmuNocObsrvW<SocCon0Spec> {
        PmuNocObsrvW::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn cru_pmu_pclk_gate(&mut self) -> CruPmuPclkGateW<SocCon0Spec> {
        CruPmuPclkGateW::new(self, 4)
    }
    #[doc = "Bit 5 - Use 2 optional IOs for pwm3."]
    #[inline(always)]
    #[must_use]
    pub fn pwm3_sel(&mut self) -> Pwm3SelW<SocCon0Spec> {
        Pwm3SelW::new(self, 5)
    }
    #[doc = "Bit 6 - pd_alive pclk_niu gating."]
    #[inline(always)]
    #[must_use]
    pub fn pclk_alive_niu_en(&mut self) -> PclkAliveNiuEnW<SocCon0Spec> {
        PclkAliveNiuEnW::new(self, 6)
    }
    #[doc = "Bit 8 - pmu GPIO1 1.8v/3.0v control source select."]
    #[inline(always)]
    #[must_use]
    pub fn pmu1830_volsel(&mut self) -> Pmu1830VolselW<SocCon0Spec> {
        Pmu1830VolselW::new(self, 8)
    }
    #[doc = "Bit 9 - pmu IO 1.8v/3.0v select."]
    #[inline(always)]
    #[must_use]
    pub fn pmu1830_vol(&mut self) -> Pmu1830VolW<SocCon0Spec> {
...
#[doc = "`reset()` method sets SOC_CON0 to value 0x0320"]
