#[doc = "Register `GPIO1B_E` reader"]
pub type R = crate::R<Gpio1bESpec>;
#[doc = "Register `GPIO1B_E` writer"]
pub type W = crate::W<Gpio1bESpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio1b_e(&mut self) -> Gpio1bEW<Gpio1bESpec> {
        Gpio1bEW::new(self, 0)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio1bESpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO1D drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio1b_e::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio1b_e::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio1bESpec;
impl crate::RegisterSpec for Gpio1bESpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio1b_e::R`](R) reader structure"]
impl crate::Readable for Gpio1bESpec {}
#[doc = "`write(|w| ..)` method takes [`gpio1b_e::W`](W) writer structure"]
impl crate::Writable for Gpio1bESpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO1B_E to value 0x15"]
impl crate::Resettable for Gpio1bESpec {
