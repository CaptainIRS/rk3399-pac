#[doc = "Register `EMMCCORE_BLKGAPCTRL` reader"]
pub type R = crate::R<EmmccoreBlkgapctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn stopatblkgapreq(&mut self) -> StopatblkgapreqW<EmmccoreBlkgapctrlSpec> {
        StopatblkgapreqW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn continuerequest(&mut self) -> ContinuerequestW<EmmccoreBlkgapctrlSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spimode(&mut self) -> SpimodeW<EmmccoreBlkgapctrlSpec> {
        SpimodeW::new(self, 4)
    }
    #[doc = "Bit 5 - To start boot code access."]
    #[inline(always)]
    #[must_use]
    pub fn booten(&mut self) -> BootenW<EmmccoreBlkgapctrlSpec> {
        BootenW::new(self, 5)
    }
    #[doc = "Bit 6 - To start boot code access in alternative mode."]
    #[inline(always)]
    #[must_use]
    pub fn altbooten(&mut self) -> AltbootenW<EmmccoreBlkgapctrlSpec> {
        AltbootenW::new(self, 6)
    }
    #[doc = "Bit 7 - To check for the boot acknowledge in boot operation."]
    #[inline(always)]
    #[must_use]
    pub fn bootackchk(&mut self) -> BootackchkW<EmmccoreBlkgapctrlSpec> {
        BootackchkW::new(self, 7)
    }
}
#[doc = "Block gap control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`emmccore_blkgapctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`emmccore_blkgapctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmmccoreBlkgapctrlSpec;
impl crate::RegisterSpec for EmmccoreBlkgapctrlSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`emmccore_blkgapctrl::R`](R) reader structure"]
impl crate::Readable for EmmccoreBlkgapctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`emmccore_blkgapctrl::W`](W) writer structure"]
impl crate::Writable for EmmccoreBlkgapctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets EMMCCORE_BLKGAPCTRL to value 0"]
impl crate::Resettable for EmmccoreBlkgapctrlSpec {
