...
pub enum Resptypesel {
    #[doc = "0: Response length 48 check Busy after response"]
    D0 = 0,
    #[doc = "1: Response length 48 check Busy after response"]
    D1 = 1,
    #[doc = "2: Response length 48 check Busy after response"]
    D2 = 2,
...
#[doc = "Field `CMDCRCCHKENA` reader - If this bit is set to 1, the HC shall check the CRC field in the response. If an error is detected, it is reported as a Command CRC Error. If this bit is set to 0, the CRC field is not checked."]
...
#[doc = "Field `CMDCRCCHKENA` writer - If this bit is set to 1, the HC shall check the CRC field in the response. If an error is detected, it is reported as a Command CRC Error. If this bit is set to 0, the CRC field is not checked."]
...
#[doc = "Field `CMDINDEXCHKENA` reader - If this bit is set to 1, the HC shall check the index field in the response to see if it has the same value as the command index. If it is not, it is reported as a Command Index Error. If this bit is set to 0, the Index field is not checked."]
...
#[doc = "Field `CMDINDEXCHKENA` writer - If this bit is set to 1, the HC shall check the index field in the response to see if it has the same value as the command index. If it is not, it is reported as a Command Index Error. If this bit is set to 0, the Index field is not checked."]
...
pub enum Datapresentsel {
    #[doc = "0: Data Present This bit is set to 1 to indicate that data is present and shall be transferred using the DAT line. If is set to 0 for the following: a. Commands using only CMD line (ex. CMD52) b. Commands with no data transfer but using busy signal on DAT\\[0\\]
...
impl R {
    ...
    #[doc = "Bit 3 - If this bit is set to 1, the HC shall check the CRC field in the response. If an error is detected, it is reported as a Command CRC Error. If this bit is set to 0, the CRC field is not checked."]
    #[inline(always)]
    pub fn cmdcrcchkena(&self) -> CmdcrcchkenaR {
        CmdcrcchkenaR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - If this bit is set to 1, the HC shall check the index field in the response to see if it has the same value as the command index. If it is not, it is reported as a Command Index Error. If this bit is set to 0, the Index field is not checked."]
    #[inline(always)]
