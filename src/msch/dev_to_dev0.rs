#[doc = "Register `DevToDev0` reader"]
pub type R = crate::R<DevToDev0Spec>;
#[doc = "Register `DevToDev0` writer"]
pub type W = crate::W<DevToDev0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn busrdtord(&mut self) -> BusrdtordW<DevToDev0Spec> {
        BusrdtordW::new(self, 0)
    }
    #[doc = "Bits 4:6 - number of cycle between the last read data of a device and the first\n\nwrite data to another device.\n\nThe field must be set according to the third-party DDR controller\n\nspecification."]
    #[inline(always)]
    #[must_use]
    pub fn busrdtowr(&mut self) -> BusrdtowrW<DevToDev0Spec> {
        BusrdtowrW::new(self, 4)
    }
    #[doc = "Bits 8:10 - number of cycle between the last write data to a device and the first\n\nread data of another device.\n\nThe field must be set according to the third-party DDR controller\n\nspecification."]
    #[inline(always)]
    #[must_use]
    pub fn buswrtord(&mut self) -> BuswrtordW<DevToDev0Spec> {
        BuswrtordW::new(self, 8)
    }
    #[doc = "Bits 12:14 - number of cycle between the last write data to a device and the first\n\nwrite data of another device.\n\nThe field must be set according to the third-party DDR controller\n\nspecification."]
    #[inline(always)]
    #[must_use]
    pub fn buswrtowr(&mut self) -> BuswrtowrW<DevToDev0Spec> {
...
pub struct DevToDev0Spec;
impl crate::RegisterSpec for DevToDev0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dev_to_dev0::R`](R) reader structure"]
impl crate::Readable for DevToDev0Spec {}
#[doc = "`write(|w| ..)` method takes [`dev_to_dev0::W`](W) writer structure"]
impl crate::Writable for DevToDev0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DevToDev0 to value 0x0222"]
impl crate::Resettable for DevToDev0Spec {
