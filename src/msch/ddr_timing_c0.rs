#[doc = "Register `DdrTimingC0` reader"]
pub type R = crate::R<DdrTimingC0Spec>;
#[doc = "Register `DdrTimingC0` writer"]
pub type W = crate::W<DdrTimingC0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn burstpenalty(&mut self) -> BurstpenaltyW<DdrTimingC0Spec> {
        BurstpenaltyW::new(self, 0)
    }
    #[doc = "Bits 8:13 - Number of scheduler clock cycles between the last write data to the\n\nfirst data of a masked write command on the same bank.\n\nThis field must be set to 3xBurstPenalty, and must be set to zero for\n\nthe other DRAM."]
    #[inline(always)]
    #[must_use]
    pub fn wrtomwr(&mut self) -> WrtomwrW<DdrTimingC0Spec> {
        WrtomwrW::new(self, 8)
    }
}
#[doc = "DdrTimingC bank 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_timing_c0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_timing_c0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrTimingC0Spec;
impl crate::RegisterSpec for DdrTimingC0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_timing_c0::R`](R) reader structure"]
impl crate::Readable for DdrTimingC0Spec {}
#[doc = "`write(|w| ..)` method takes [`ddr_timing_c0::W`](W) writer structure"]
impl crate::Writable for DdrTimingC0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DdrTimingC0 to value 0x02"]
impl crate::Resettable for DdrTimingC0Spec {
