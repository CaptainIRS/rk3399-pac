...
impl R {
    #[doc = "Bits 0:12 - Field0000 Abstract In Bandwidth Limiter or Bandwidth Regulator mode, the bandwidth threshold in units of 1/256th bytes per cycle. For example, 80 MBps on a 250 MHz interface is value 0x0052. The valid bits may be different for different master NIU."]
    #[inline(always)]
