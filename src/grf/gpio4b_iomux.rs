#[doc = "Register `GPIO4B_IOMUX` reader"]
pub type R = crate::R<Gpio4bIomuxSpec>;
#[doc = "Register `GPIO4B_IOMUX` writer"]
pub type W = crate::W<Gpio4bIomuxSpec>;
#[doc = "GPIO4B\\[0\\]
iomux select\n\nValue on reset: 0"]
...
impl Gpio4b0SelR {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio4b0Sel> {
        match self.bits {
            0 => Some(Gpio4b0Sel::B00),
            1 => Some(Gpio4b0Sel::B01),
            2 => Some(Gpio4b0Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio4b0SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio4b0Sel>;
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b0_sel(&mut self) -> Gpio4b0SelW<Gpio4bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b1_sel(&mut self) -> Gpio4b1SelW<Gpio4bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b2_sel(&mut self) -> Gpio4b2SelW<Gpio4bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b3_sel(&mut self) -> Gpio4b3SelW<Gpio4bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b4_sel(&mut self) -> Gpio4b4SelW<Gpio4bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b5_sel(&mut self) -> Gpio4b5SelW<Gpio4bIomuxSpec> {
        Gpio4b5SelW::new(self, 10)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio4bIomuxSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO4B iomux control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio4b_iomux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio4b_iomux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio4bIomuxSpec;
impl crate::RegisterSpec for Gpio4bIomuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio4b_iomux::R`](R) reader structure"]
impl crate::Readable for Gpio4bIomuxSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio4b_iomux::W`](W) writer structure"]
impl crate::Writable for Gpio4bIomuxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO4B_IOMUX to value 0"]
impl crate::Resettable for Gpio4bIomuxSpec {
