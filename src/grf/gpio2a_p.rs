#[doc = "Register `GPIO2A_P` reader"]
pub type R = crate::R<Gpio2aPSpec>;
#[doc = "Register `GPIO2A_P` writer"]
pub type W = crate::W<Gpio2aPSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio2a0_p(&mut self) -> Gpio2a0PW<Gpio2aPSpec> {
        Gpio2a0PW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO2A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a1_p(&mut self) -> Gpio2a1PW<Gpio2aPSpec> {
        Gpio2a1PW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO2A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a2_p(&mut self) -> Gpio2a2PW<Gpio2aPSpec> {
        Gpio2a2PW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO2A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a3_p(&mut self) -> Gpio2a3PW<Gpio2aPSpec> {
        Gpio2a3PW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO2A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a4_p(&mut self) -> Gpio2a4PW<Gpio2aPSpec> {
        Gpio2a4PW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO2A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a5_p(&mut self) -> Gpio2a5PW<Gpio2aPSpec> {
        Gpio2a5PW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO2A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a6_p(&mut self) -> Gpio2a6PW<Gpio2aPSpec> {
        Gpio2a6PW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO2A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a7_p(&mut self) -> Gpio2a7PW<Gpio2aPSpec> {
        Gpio2a7PW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio2aPSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO2A PU/PD control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio2a_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio2a_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio2aPSpec;
impl crate::RegisterSpec for Gpio2aPSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio2a_p::R`](R) reader structure"]
impl crate::Readable for Gpio2aPSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio2a_p::W`](W) writer structure"]
impl crate::Writable for Gpio2aPSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO2A_P to value 0x6aa5"]
impl crate::Resettable for Gpio2aPSpec {
