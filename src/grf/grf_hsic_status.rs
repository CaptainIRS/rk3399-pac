#[doc = "Register `GRF_HSIC_STATUS` reader"]
pub type R = crate::R<GrfHsicStatusSpec>;
#[doc = "Register `GRF_HSIC_STATUS` writer"]
pub type W = crate::W<GrfHsicStatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hsic_ehci_xfer_cnt(&mut self) -> HsicEhciXferCntW<GrfHsicStatusSpec> {
        HsicEhciXferCntW::new(self, 0)
    }
    #[doc = "Bits 11:16 - hsic_ehci_usbsts"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_ehci_usbsts(&mut self) -> HsicEhciUsbstsW<GrfHsicStatusSpec> {
        HsicEhciUsbstsW::new(self, 11)
    }
    #[doc = "Bits 17:20 - hsic_ehci_lpsms_state"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_ehci_lpsms_state(&mut self) -> HsicEhciLpsmsStateW<GrfHsicStatusSpec> {
        HsicEhciLpsmsStateW::new(self, 17)
    }
    #[doc = "Bit 21 - hsic_ehci_xfer_prdc"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_ehci_xfer_prdc(&mut self) -> HsicEhciXferPrdcW<GrfHsicStatusSpec> {
        HsicEhciXferPrdcW::new(self, 21)
    }
}
#[doc = "hsic controller status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_hsic_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_hsic_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfHsicStatusSpec;
impl crate::RegisterSpec for GrfHsicStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_hsic_status::R`](R) reader structure"]
impl crate::Readable for GrfHsicStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`grf_hsic_status::W`](W) writer structure"]
impl crate::Writable for GrfHsicStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_HSIC_STATUS to value 0"]
impl crate::Resettable for GrfHsicStatusSpec {
