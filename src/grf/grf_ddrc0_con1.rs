#[doc = "Register `GRF_DDRC0_CON1` reader"]
pub type R = crate::R<GrfDdrc0Con1Spec>;
#[doc = "Register `GRF_DDRC0_CON1` writer"]
pub type W = crate::W<GrfDdrc0Con1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_ddrc0_en_stdby(&mut self) -> ClkDdrc0EnStdbyW<GrfDdrc0Con1Spec> {
        ClkDdrc0EnStdbyW::new(self, 4)
    }
    #[doc = "Bit 5 - bit control of clk_ddrc0_en_stdby"]
    #[inline(always)]
    #[must_use]
    pub fn clk_ddrphy_ctrl0_en_stdby(&mut self) -> ClkDdrphyCtrl0EnStdbyW<GrfDdrc0Con1Spec> {
        ClkDdrphyCtrl0EnStdbyW::new(self, 5)
    }
    #[doc = "Bit 6 - bit control of clk_ddrphy0_en_stdby"]
    #[inline(always)]
    #[must_use]
    pub fn clk_ddrphy0_en_stdby(&mut self) -> ClkDdrphy0EnStdbyW<GrfDdrc0Con1Spec> {
        ClkDdrphy0EnStdbyW::new(self, 6)
    }
    #[doc = "Bit 7 - bit control of clk_ddr0_msch_en_stdby"]
    #[inline(always)]
    #[must_use]
    pub fn clk_ddr0_msch_en_stdby(&mut self) -> ClkDdr0MschEnStdbyW<GrfDdrc0Con1Spec> {
        ClkDdr0MschEnStdbyW::new(self, 7)
    }
    #[doc = "Bits 8:9 - bit control of denali0_command_priority"]
    #[inline(always)]
    #[must_use]
    pub fn denali0_command_priority(&mut self) -> Denali0CommandPriorityW<GrfDdrc0Con1Spec> {
        Denali0CommandPriorityW::new(self, 8)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfDdrc0Con1Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "ddrc0 control register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_ddrc0_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_ddrc0_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfDdrc0Con1Spec;
impl crate::RegisterSpec for GrfDdrc0Con1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_ddrc0_con1::R`](R) reader structure"]
impl crate::Readable for GrfDdrc0Con1Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_ddrc0_con1::W`](W) writer structure"]
impl crate::Writable for GrfDdrc0Con1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_DDRC0_CON1 to value 0"]
impl crate::Resettable for GrfDdrc0Con1Spec {
