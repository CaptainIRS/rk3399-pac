#[doc = "Register `USB3PHY1_CON0` reader"]
pub type R = crate::R<Usb3phy1Con0Spec>;
#[doc = "Register `USB3PHY1_CON0` writer"]
pub type W = crate::W<Usb3phy1Con0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn typec_conn_dir(&mut self) -> TypecConnDirW<Usb3phy1Con0Spec> {
        TypecConnDirW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Pipe interface data bus width\n\n0: 32bit data bus width, only support 32bit\n\ndata bus width."]
    #[inline(always)]
    #[must_use]
    pub fn pipe_data_bus_width(&mut self) -> PipeDataBusWidthW<Usb3phy1Con0Spec> {
        PipeDataBusWidthW::new(self, 1)
    }
    #[doc = "Bit 3 - force usb3 to usb2 enable control"]
    #[inline(always)]
    #[must_use]
    pub fn usb3tousb2_en(&mut self) -> Usb3tousb2EnW<Usb3phy1Con0Spec> {
        Usb3tousb2EnW::new(self, 3)
    }
    #[doc = "Bits 4:5 - TCPC role trap"]
    #[inline(always)]
    #[must_use]
    pub fn tcpc_role_strap(&mut self) -> TcpcRoleStrapW<Usb3phy1Con0Spec> {
        TcpcRoleStrapW::new(self, 4)
    }
    #[doc = "Bit 6 - dead_battery_sel"]
    #[inline(always)]
    #[must_use]
    pub fn dead_battery_sel(&mut self) -> DeadBatterySelW<Usb3phy1Con0Spec> {
        DeadBatterySelW::new(self, 6)
    }
    #[doc = "Bit 7 - dead_battery_n"]
    #[inline(always)]
    #[must_use]
    pub fn dead_battery_n(&mut self) -> DeadBatteryNW<Usb3phy1Con0Spec> {
        DeadBatteryNW::new(self, 7)
    }
    #[doc = "Bit 8 - TypeC connect direction select"]
    #[inline(always)]
    #[must_use]
    pub fn typec_conn_dir_sel(&mut self) -> TypecConnDirSelW<Usb3phy1Con0Spec> {
        TypecConnDirSelW::new(self, 8)
    }
    #[doc = "Bit 9 - TCPC Vbus On"]
    #[inline(always)]
    #[must_use]
    pub fn tcpc_vbus_on(&mut self) -> TcpcVbusOnW<Usb3phy1Con0Spec> {
        TcpcVbusOnW::new(self, 9)
    }
    #[doc = "Bit 10 - vbus valid select"]
    #[inline(always)]
    #[must_use]
    pub fn vbus_valid_sel(&mut self) -> VbusValidSelW<Usb3phy1Con0Spec> {
        VbusValidSelW::new(self, 10)
    }
    #[doc = "Bit 11 - cc1 overcurrent"]
    #[inline(always)]
    #[must_use]
    pub fn cc1_overcurrent_n(&mut self) -> Cc1OvercurrentNW<Usb3phy1Con0Spec> {
        Cc1OvercurrentNW::new(self, 11)
    }
    #[doc = "Bit 12 - cc2 overcurrent"]
    #[inline(always)]
    #[must_use]
    pub fn cc2_overcurrent_n(&mut self) -> Cc2OvercurrentNW<Usb3phy1Con0Spec> {
        Cc2OvercurrentNW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb3phy1Con0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "TypeC PHY/TCPD PHY/TCPC Control register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb3phy1_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb3phy1_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb3phy1Con0Spec;
impl crate::RegisterSpec for Usb3phy1Con0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb3phy1_con0::R`](R) reader structure"]
impl crate::Readable for Usb3phy1Con0Spec {}
#[doc = "`write(|w| ..)` method takes [`usb3phy1_con0::W`](W) writer structure"]
impl crate::Writable for Usb3phy1Con0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB3PHY1_CON0 to value 0x19c8"]
impl crate::Resettable for Usb3phy1Con0Spec {
