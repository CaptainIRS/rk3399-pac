#[doc = "Register `GPIO2C_E` reader"]
pub type R = crate::R<Gpio2cESpec>;
#[doc = "Register `GPIO2C_E` writer"]
pub type W = crate::W<Gpio2cESpec>;
#[doc = "GPIO2C0 drive strength control, every GPIO\n\nbit corresponding to 2bits\n\nValue on reset: 0"]
...
#[doc = "Field `GPIO2C0_E` reader - GPIO2C0 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "Field `GPIO2C0_E` writer - GPIO2C0 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "GPIO2C1 drive strength control, every GPIO\n\nbit corresponding to 2bits\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2c1E {
...
#[doc = "Field `GPIO2C1_E` reader - GPIO2C1 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "Field `GPIO2C1_E` writer - GPIO2C1 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "GPIO2C2 drive strength control, every GPIO\n\nbit corresponding to 2bits\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2c2E {
...
#[doc = "Field `GPIO2C2_E` reader - GPIO2C2 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "Field `GPIO2C2_E` writer - GPIO2C2 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "GPIO2C3 drive strength control, every GPIO\n\nbit corresponding to 2bits\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2c3E {
...
#[doc = "Field `GPIO2C3_E` reader - GPIO2C3 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "Field `GPIO2C3_E` writer - GPIO2C3 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "GPIO2C4 drive strength control, every GPIO\n\nbit corresponding to 2bits\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2c4E {
...
#[doc = "Field `GPIO2C4_E` reader - GPIO2C4 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "Field `GPIO2C4_E` writer - GPIO2C4 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "GPIO2C5 drive strength control, every GPIO\n\nbit corresponding to 2bits\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2c5E {
...
#[doc = "Field `GPIO2C5_E` reader - GPIO2C5 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "Field `GPIO2C5_E` writer - GPIO2C5 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "GPIO2C6 drive strength control, every GPIO\n\nbit corresponding to 2bits\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2c6E {
...
#[doc = "Field `GPIO2C6_E` reader - GPIO2C6 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "Field `GPIO2C6_E` writer - GPIO2C6 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "GPIO2C7 drive strength control, every GPIO\n\nbit corresponding to 2bits\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2c7E {
...
#[doc = "Field `GPIO2C7_E` reader - GPIO2C7 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
#[doc = "Field `GPIO2C7_E` writer - GPIO2C7 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio2c0_e(&mut self) -> Gpio2c0EW<Gpio2cESpec> {
        Gpio2c0EW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO2C1 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c1_e(&mut self) -> Gpio2c1EW<Gpio2cESpec> {
        Gpio2c1EW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO2C2 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c2_e(&mut self) -> Gpio2c2EW<Gpio2cESpec> {
        Gpio2c2EW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO2C3 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c3_e(&mut self) -> Gpio2c3EW<Gpio2cESpec> {
        Gpio2c3EW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO2C4 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c4_e(&mut self) -> Gpio2c4EW<Gpio2cESpec> {
        Gpio2c4EW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO2C5 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c5_e(&mut self) -> Gpio2c5EW<Gpio2cESpec> {
        Gpio2c5EW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO2C6 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c6_e(&mut self) -> Gpio2c6EW<Gpio2cESpec> {
        Gpio2c6EW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO2C7 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c7_e(&mut self) -> Gpio2c7EW<Gpio2cESpec> {
        Gpio2c7EW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio2cESpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO2C drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio2c_e::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio2c_e::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio2cESpec;
impl crate::RegisterSpec for Gpio2cESpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio2c_e::R`](R) reader structure"]
impl crate::Readable for Gpio2cESpec {}
#[doc = "`write(|w| ..)` method takes [`gpio2c_e::W`](W) writer structure"]
impl crate::Writable for Gpio2cESpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO2C_E to value 0"]
impl crate::Resettable for Gpio2cESpec {
