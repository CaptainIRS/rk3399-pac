#[doc = "Register `SOC_CON6` reader"]
pub type R = crate::R<SocCon6Spec>;
#[doc = "Register `SOC_CON6` writer"]
pub type W = crate::W<SocCon6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gmac_clk_tx_dl_cfg(&mut self) -> GmacClkTxDlCfgW<SocCon6Spec> {
        GmacClkTxDlCfgW::new(self, 0)
    }
    #[doc = "Bit 7 - RGMII TX clock delayline enable"]
    #[inline(always)]
    #[must_use]
    pub fn gmac_txclk_dly_ena(&mut self) -> GmacTxclkDlyEnaW<SocCon6Spec> {
        GmacTxclkDlyEnaW::new(self, 7)
    }
    #[doc = "Bits 8:14 - RGMII RX clock delayline value"]
    #[inline(always)]
    #[must_use]
    pub fn gmac_clk_rx_dl_cfg(&mut self) -> GmacClkRxDlCfgW<SocCon6Spec> {
        GmacClkRxDlCfgW::new(self, 8)
    }
    #[doc = "Bit 15 - RGMII TX clock delayline enable"]
    #[inline(always)]
    #[must_use]
    pub fn gmac_rxclk_dly_ena(&mut self) -> GmacRxclkDlyEnaW<SocCon6Spec> {
        GmacRxclkDlyEnaW::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SocCon6Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_con6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_con6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocCon6Spec;
impl crate::RegisterSpec for SocCon6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_con6::R`](R) reader structure"]
impl crate::Readable for SocCon6Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_con6::W`](W) writer structure"]
impl crate::Writable for SocCon6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_CON6 to value 0"]
impl crate::Resettable for SocCon6Spec {
