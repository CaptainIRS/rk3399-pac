#[doc = "Register `SOC_CON_5_PCIE` reader"]
pub type R = crate::R<SocCon5PcieSpec>;
#[doc = "Register `SOC_CON_5_PCIE` writer"]
pub type W = crate::W<SocCon5PcieSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcie_tx_elec_idle_sel(&mut self) -> PcieTxElecIdleSelW<SocCon5PcieSpec> {
        PcieTxElecIdleSelW::new(self, 0)
    }
    #[doc = "Bit 1 - pcie_tx_elec_idle_set port control"]
    #[inline(always)]
    #[must_use]
    pub fn pcie_tx_elec_idle_set(&mut self) -> PcieTxElecIdleSetW<SocCon5PcieSpec> {
        PcieTxElecIdleSetW::new(self, 1)
    }
    #[doc = "Bit 2 - pcie_rx_elec_idle_irq_en port control"]
    #[inline(always)]
    #[must_use]
    pub fn pcie_rx_elec_idle_irq_en(&mut self) -> PcieRxElecIdleIrqEnW<SocCon5PcieSpec> {
...
port control"]
    #[inline(always)]
    #[must_use]
    pub fn pcie_tx_elec_idle_off(&mut self) -> PcieTxElecIdleOffW<SocCon5PcieSpec> {
        PcieTxElecIdleOffW::new(self, 3)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SocCon5PcieSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_con_5_pcie::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_con_5_pcie::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocCon5PcieSpec;
impl crate::RegisterSpec for SocCon5PcieSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_con_5_pcie::R`](R) reader structure"]
impl crate::Readable for SocCon5PcieSpec {}
#[doc = "`write(|w| ..)` method takes [`soc_con_5_pcie::W`](W) writer structure"]
impl crate::Writable for SocCon5PcieSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_CON_5_PCIE to value 0x02"]
impl crate::Resettable for SocCon5PcieSpec {
