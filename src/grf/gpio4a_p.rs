#[doc = "Register `GPIO4A_P` reader"]
pub type R = crate::R<Gpio4aPSpec>;
#[doc = "Register `GPIO4A_P` writer"]
pub type W = crate::W<Gpio4aPSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio4a0_p(&mut self) -> Gpio4a0PW<Gpio4aPSpec> {
        Gpio4a0PW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO4A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a1_p(&mut self) -> Gpio4a1PW<Gpio4aPSpec> {
        Gpio4a1PW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO4A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a2_p(&mut self) -> Gpio4a2PW<Gpio4aPSpec> {
        Gpio4a2PW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO4A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a3_p(&mut self) -> Gpio4a3PW<Gpio4aPSpec> {
        Gpio4a3PW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO4A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a4_p(&mut self) -> Gpio4a4PW<Gpio4aPSpec> {
        Gpio4a4PW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO4A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a5_p(&mut self) -> Gpio4a5PW<Gpio4aPSpec> {
        Gpio4a5PW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO4A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a6_p(&mut self) -> Gpio4a6PW<Gpio4aPSpec> {
        Gpio4a6PW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO4A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a7_p(&mut self) -> Gpio4a7PW<Gpio4aPSpec> {
        Gpio4a7PW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio4aPSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO4A PU/PD control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio4a_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio4a_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio4aPSpec;
impl crate::RegisterSpec for Gpio4aPSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio4a_p::R`](R) reader structure"]
impl crate::Readable for Gpio4aPSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio4a_p::W`](W) writer structure"]
impl crate::Writable for Gpio4aPSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO4A_P to value 0xaa96"]
impl crate::Resettable for Gpio4aPSpec {
