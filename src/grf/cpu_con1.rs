#[doc = "Register `CPU_CON1` reader"]
pub type R = crate::R<CpuCon1Spec>;
#[doc = "Register `CPU_CON1` writer"]
pub type W = crate::W<CpuCon1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn awqos_pd_core_l(&mut self) -> AwqosPdCoreLW<CpuCon1Spec> {
        AwqosPdCoreLW::new(self, 0)
    }
    #[doc = "Bits 4:7 - pd_core_l arqos bit control"]
    #[inline(always)]
    #[must_use]
    pub fn arqos_pd_core_l(&mut self) -> ArqosPdCoreLW<CpuCon1Spec> {
        ArqosPdCoreLW::new(self, 4)
    }
    #[doc = "Bits 8:11 - pd_core_l clusteridaff1 bit control"]
    #[inline(always)]
    #[must_use]
    pub fn clusteridaff1_pd_core_l(&mut self) -> Clusteridaff1PdCoreLW<CpuCon1Spec> {
        Clusteridaff1PdCoreLW::new(self, 8)
    }
    #[doc = "Bits 12:15 - pd_core_l gic_active bit control"]
    #[inline(always)]
    #[must_use]
    pub fn gic_active_core_l(&mut self) -> GicActiveCoreLW<CpuCon1Spec> {
        GicActiveCoreLW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<CpuCon1Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "cpu control register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpu_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpu_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpuCon1Spec;
impl crate::RegisterSpec for CpuCon1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpu_con1::R`](R) reader structure"]
impl crate::Readable for CpuCon1Spec {}
#[doc = "`write(|w| ..)` method takes [`cpu_con1::W`](W) writer structure"]
impl crate::Writable for CpuCon1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPU_CON1 to value 0xf000"]
impl crate::Resettable for CpuCon1Spec {
