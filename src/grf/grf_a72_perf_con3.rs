#[doc = "Register `GRF_A72_PERF_CON3` reader"]
pub type R = crate::R<GrfA72PerfCon3Spec>;
#[doc = "Register `GRF_A72_PERF_CON3` writer"]
pub type W = crate::W<GrfA72PerfCon3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mon_id_msk(&mut self) -> MonIdMskW<GrfA72PerfCon3Spec> {
        MonIdMskW::new(self, 0)
    }
    #[doc = "Bit 1 - mon_id_type bit control"]
    #[inline(always)]
    #[must_use]
    pub fn mon_id_type(&mut self) -> MonIdTypeW<GrfA72PerfCon3Spec> {
        MonIdTypeW::new(self, 1)
    }
    #[doc = "Bits 2:8 - mon_id_bmsk bit control"]
    #[inline(always)]
    #[must_use]
    pub fn mon_id_bmsk(&mut self) -> MonIdBmskW<GrfA72PerfCon3Spec> {
        MonIdBmskW::new(self, 2)
    }
    #[doc = "Bits 9:15 - mon_id bit control"]
    #[inline(always)]
    #[must_use]
    pub fn mon_id(&mut self) -> MonIdW<GrfA72PerfCon3Spec> {
        MonIdW::new(self, 9)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfA72PerfCon3Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "a72 performance monitor control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_a72_perf_con3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_a72_perf_con3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfA72PerfCon3Spec;
impl crate::RegisterSpec for GrfA72PerfCon3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_a72_perf_con3::R`](R) reader structure"]
impl crate::Readable for GrfA72PerfCon3Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_a72_perf_con3::W`](W) writer structure"]
impl crate::Writable for GrfA72PerfCon3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_A72_PERF_CON3 to value 0"]
impl crate::Resettable for GrfA72PerfCon3Spec {
