#[doc = "Register `CPU_STATUS0` reader"]
pub type R = crate::R<CpuStatus0Spec>;
#[doc = "Register `CPU_STATUS0` writer"]
pub type W = crate::W<CpuStatus0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrmemattr_pd_core_l(&mut self) -> WrmemattrPdCoreLW<CpuStatus0Spec> {
        WrmemattrPdCoreLW::new(self, 0)
    }
    #[doc = "Bits 8:15 - rdmemattr of pd_core_l status"]
    #[inline(always)]
    #[must_use]
    pub fn rdmemattr_pd_core_l(&mut self) -> RdmemattrPdCoreLW<CpuStatus0Spec> {
        RdmemattrPdCoreLW::new(self, 8)
    }
    #[doc = "Bits 16:23 - rdmemattr of pd_core_b status"]
    #[inline(always)]
    #[must_use]
    pub fn rdmemattr_pd_core_b(&mut self) -> RdmemattrPdCoreBW<CpuStatus0Spec> {
        RdmemattrPdCoreBW::new(self, 16)
    }
    #[doc = "Bits 24:31 - wrmemattr of pd_core_b status"]
    #[inline(always)]
    #[must_use]
    pub fn wrmemattr_pd_core_b(&mut self) -> WrmemattrPdCoreBW<CpuStatus0Spec> {
        WrmemattrPdCoreBW::new(self, 24)
    }
}
#[doc = "cpu status register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpu_status0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpu_status0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpuStatus0Spec;
impl crate::RegisterSpec for CpuStatus0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpu_status0::R`](R) reader structure"]
impl crate::Readable for CpuStatus0Spec {}
#[doc = "`write(|w| ..)` method takes [`cpu_status0::W`](W) writer structure"]
impl crate::Writable for CpuStatus0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPU_STATUS0 to value 0"]
impl crate::Resettable for CpuStatus0Spec {
