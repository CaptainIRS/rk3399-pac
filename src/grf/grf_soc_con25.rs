#[doc = "Register `GRF_SOC_CON25` reader"]
pub type R = crate::R<GrfSocCon25Spec>;
#[doc = "Register `GRF_SOC_CON25` writer"]
pub type W = crate::W<GrfSocCon25Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_tsetdin(&mut self) -> DphyRx0TsetdinW<GrfSocCon25Spec> {
        DphyRx0TsetdinW::new(self, 0)
    }
    #[doc = "Bit 8 - dphy_rx0_tseten bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_tseten(&mut self) -> DphyRx0TsetenW<GrfSocCon25Spec> {
        DphyRx0TsetenW::new(self, 8)
    }
    #[doc = "Bit 9 - dphy_rx0_tsetclk bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_tsetclk(&mut self) -> DphyRx0TsetclkW<GrfSocCon25Spec> {
        DphyRx0TsetclkW::new(self, 9)
    }
    #[doc = "Bit 10 - dphy_rx0_tsetclr bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_tsetclr(&mut self) -> DphyRx0TsetclrW<GrfSocCon25Spec> {
        DphyRx0TsetclrW::new(self, 10)
    }
    #[doc = "Bit 11 - edp_ref_clk_sel bit control"]
    #[inline(always)]
    #[must_use]
    pub fn edp_ref_clk_sel(&mut self) -> EdpRefClkSelW<GrfSocCon25Spec> {
        EdpRefClkSelW::new(self, 11)
    }
    #[doc = "Bits 12:15 - edp_tx_bscan_data bit control"]
    #[inline(always)]
    #[must_use]
    pub fn edp_tx_bscan_data(&mut self) -> EdpTxBscanDataW<GrfSocCon25Spec> {
        EdpTxBscanDataW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfSocCon25Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 25\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_soc_con25::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_soc_con25::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfSocCon25Spec;
impl crate::RegisterSpec for GrfSocCon25Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_soc_con25::R`](R) reader structure"]
impl crate::Readable for GrfSocCon25Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_soc_con25::W`](W) writer structure"]
impl crate::Writable for GrfSocCon25Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_SOC_CON25 to value 0xd45b"]
impl crate::Resettable for GrfSocCon25Spec {
