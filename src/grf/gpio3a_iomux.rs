#[doc = "Register `GPIO3A_IOMUX` reader"]
pub type R = crate::R<Gpio3aIomuxSpec>;
#[doc = "Register `GPIO3A_IOMUX` writer"]
pub type W = crate::W<Gpio3aIomuxSpec>;
#[doc = "GPIO3A\\[0\\]
iomux select\n\nValue on reset: 0"]
...
impl Gpio3a4SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio3a4Sel> {
        match self.bits {
            0 => Some(Gpio3a4Sel::B00),
            1 => Some(Gpio3a4Sel::B01),
            2 => Some(Gpio3a4Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio3a4SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio3a4Sel>;
...
impl Gpio3a5SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio3a5Sel> {
        match self.bits {
            0 => Some(Gpio3a5Sel::B00),
            1 => Some(Gpio3a5Sel::B01),
            2 => Some(Gpio3a5Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio3a5SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio3a5Sel>;
...
impl Gpio3a6SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio3a6Sel> {
        match self.bits {
            0 => Some(Gpio3a6Sel::B00),
            1 => Some(Gpio3a6Sel::B01),
            2 => Some(Gpio3a6Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio3a6SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio3a6Sel>;
...
impl Gpio3a7SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio3a7Sel> {
        match self.bits {
            0 => Some(Gpio3a7Sel::B00),
            1 => Some(Gpio3a7Sel::B01),
            2 => Some(Gpio3a7Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio3a7SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio3a7Sel>;
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a0_sel(&mut self) -> Gpio3a0SelW<Gpio3aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a1_sel(&mut self) -> Gpio3a1SelW<Gpio3aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a2_sel(&mut self) -> Gpio3a2SelW<Gpio3aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a3_sel(&mut self) -> Gpio3a3SelW<Gpio3aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a4_sel(&mut self) -> Gpio3a4SelW<Gpio3aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a5_sel(&mut self) -> Gpio3a5SelW<Gpio3aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a6_sel(&mut self) -> Gpio3a6SelW<Gpio3aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a7_sel(&mut self) -> Gpio3a7SelW<Gpio3aIomuxSpec> {
        Gpio3a7SelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio3aIomuxSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3A iomux control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio3a_iomux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio3a_iomux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio3aIomuxSpec;
impl crate::RegisterSpec for Gpio3aIomuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio3a_iomux::R`](R) reader structure"]
impl crate::Readable for Gpio3aIomuxSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio3a_iomux::W`](W) writer structure"]
impl crate::Writable for Gpio3aIomuxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO3A_IOMUX to value 0"]
impl crate::Resettable for Gpio3aIomuxSpec {
