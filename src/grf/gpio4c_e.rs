#[doc = "Register `GPIO4C_E` reader"]
pub type R = crate::R<Gpio4cESpec>;
#[doc = "Register `GPIO4C_E` writer"]
pub type W = crate::W<Gpio4cESpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio4c0_e(&mut self) -> Gpio4c0EW<Gpio4cESpec> {
        Gpio4c0EW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO4C1 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4c1_e(&mut self) -> Gpio4c1EW<Gpio4cESpec> {
        Gpio4c1EW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO4C2 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4c2_e(&mut self) -> Gpio4c2EW<Gpio4cESpec> {
        Gpio4c2EW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO4C3 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4c3_e(&mut self) -> Gpio4c3EW<Gpio4cESpec> {
        Gpio4c3EW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO4C4 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4c4_e(&mut self) -> Gpio4c4EW<Gpio4cESpec> {
        Gpio4c4EW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO4C5 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4c5_e(&mut self) -> Gpio4c5EW<Gpio4cESpec> {
        Gpio4c5EW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO4C6 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4c6_e(&mut self) -> Gpio4c6EW<Gpio4cESpec> {
        Gpio4c6EW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO4C7 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4c7_e(&mut self) -> Gpio4c7EW<Gpio4cESpec> {
        Gpio4c7EW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio4cESpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO4C drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio4c_e::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio4c_e::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio4cESpec;
impl crate::RegisterSpec for Gpio4cESpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio4c_e::R`](R) reader structure"]
impl crate::Readable for Gpio4cESpec {}
#[doc = "`write(|w| ..)` method takes [`gpio4c_e::W`](W) writer structure"]
impl crate::Writable for Gpio4cESpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO4C_E to value 0"]
impl crate::Resettable for Gpio4cESpec {
