#[doc = "Register `GPIO4D_P` reader"]
pub type R = crate::R<Gpio4dPSpec>;
#[doc = "Register `GPIO4D_P` writer"]
pub type W = crate::W<Gpio4dPSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio4d0_p(&mut self) -> Gpio4d0PW<Gpio4dPSpec> {
        Gpio4d0PW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO4D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d1_p(&mut self) -> Gpio4d1PW<Gpio4dPSpec> {
        Gpio4d1PW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO4D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d2_p(&mut self) -> Gpio4d2PW<Gpio4dPSpec> {
        Gpio4d2PW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO4D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d3_p(&mut self) -> Gpio4d3PW<Gpio4dPSpec> {
        Gpio4d3PW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO4D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d4_p(&mut self) -> Gpio4d4PW<Gpio4dPSpec> {
        Gpio4d4PW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO4D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d5_p(&mut self) -> Gpio4d5PW<Gpio4dPSpec> {
        Gpio4d5PW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO4D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d6_p(&mut self) -> Gpio4d6PW<Gpio4dPSpec> {
        Gpio4d6PW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio4dPSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO4D PU/PD control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio4d_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio4d_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio4dPSpec;
impl crate::RegisterSpec for Gpio4dPSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio4d_p::R`](R) reader structure"]
impl crate::Readable for Gpio4dPSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio4d_p::W`](W) writer structure"]
impl crate::Writable for Gpio4dPSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO4D_P to value 0x2aa9"]
impl crate::Resettable for Gpio4dPSpec {
