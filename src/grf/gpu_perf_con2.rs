#[doc = "Register `GPU_PERF_CON2` reader"]
pub type R = crate::R<GpuPerfCon2Spec>;
#[doc = "Register `GPU_PERF_CON2` writer"]
pub type W = crate::W<GpuPerfCon2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_ar_count_id(&mut self) -> GpuSwArCountIdW<GpuPerfCon2Spec> {
        GpuSwArCountIdW::new(self, 0)
    }
    #[doc = "Bits 8:12 - When sw_aw_cnt_id_type=1, only count\n\nthe id designated by sw_aw_count_id"]
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_aw_count_id(&mut self) -> GpuSwAwCountIdW<GpuPerfCon2Spec> {
        GpuSwAwCountIdW::new(self, 8)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GpuPerfCon2Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "gpu performance monitor control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpu_perf_con2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpu_perf_con2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpuPerfCon2Spec;
impl crate::RegisterSpec for GpuPerfCon2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpu_perf_con2::R`](R) reader structure"]
impl crate::Readable for GpuPerfCon2Spec {}
#[doc = "`write(|w| ..)` method takes [`gpu_perf_con2::W`](W) writer structure"]
impl crate::Writable for GpuPerfCon2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPU_PERF_CON2 to value 0"]
impl crate::Resettable for GpuPerfCon2Spec {
