...
#[doc = "Field `GMAC_SW_AR_COUNT_ID` reader - When sw_ar_cnt_id_type=1, only count the id designated by sw_ar_count_id"]
pub type GmacSwArCountIdR = crate::FieldReader;
#[doc = "Field `GMAC_SW_AR_COUNT_ID` writer - When sw_ar_cnt_id_type=1, only count the id designated by sw_ar_count_id"]
pub type GmacSwArCountIdW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `GMAC_SW_AW_COUNT_ID` reader - When sw_aw_cnt_id_type=1, only count the id designated by sw_aw_count_id"]
pub type GmacSwAwCountIdR = crate::FieldReader;
#[doc = "Field `GMAC_SW_AW_COUNT_ID` writer - When sw_aw_cnt_id_type=1, only count the id designated by sw_aw_count_id"]
