#[doc = "Register `USB20_PHY1_CON2` reader"]
pub type R = crate::R<Usb20Phy1Con2Spec>;
#[doc = "Register `USB20_PHY1_CON2` writer"]
pub type W = crate::W<Usb20Phy1Con2Spec>;
#[doc = "utmi_sel\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn utmi_sel(&mut self) -> UtmiSelW<Usb20Phy1Con2Spec> {
        UtmiSelW::new(self, 0)
    }
    #[doc = "Bit 1 - suspend_n\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn suspend_n(&mut self) -> SuspendNW<Usb20Phy1Con2Spec> {
        SuspendNW::new(self, 1)
    }
    #[doc = "Bits 2:3 - opmode\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn opmode(&mut self) -> OpmodeW<Usb20Phy1Con2Spec> {
        OpmodeW::new(self, 2)
    }
    #[doc = "Bits 4:5 - xcvrselect\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn xcvrselect(&mut self) -> XcvrselectW<Usb20Phy1Con2Spec> {
        XcvrselectW::new(self, 4)
    }
    #[doc = "Bit 6 - termselect\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn termselect(&mut self) -> TermselectW<Usb20Phy1Con2Spec> {
        TermselectW::new(self, 6)
    }
    #[doc = "Bit 7 - dppulldown\n\nUse the value of this register input to\n\ndppulldown of usb2phy"]
    #[inline(always)]
    #[must_use]
    pub fn dppulldown(&mut self) -> DppulldownW<Usb20Phy1Con2Spec> {
        DppulldownW::new(self, 7)
    }
    #[doc = "Bit 8 - dmpulldown\n\nUse the value of this register input to\n\ndmpulldown of usb2phy"]
    #[inline(always)]
    #[must_use]
    pub fn dmpulldown(&mut self) -> DmpulldownW<Usb20Phy1Con2Spec> {
        DmpulldownW::new(self, 8)
    }
    #[doc = "Bit 9 - idpullup\n\nUse the value of this register input to idpullup\n\nof usb2phy"]
    #[inline(always)]
    #[must_use]
    pub fn idpullup(&mut self) -> IdpullupW<Usb20Phy1Con2Spec> {
        IdpullupW::new(self, 9)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb20Phy1Con2Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "USB20 PHY1 GRF Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb20_phy1_con2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb20_phy1_con2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb20Phy1Con2Spec;
impl crate::RegisterSpec for Usb20Phy1Con2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb20_phy1_con2::R`](R) reader structure"]
impl crate::Readable for Usb20Phy1Con2Spec {}
#[doc = "`write(|w| ..)` method takes [`usb20_phy1_con2::W`](W) writer structure"]
impl crate::Writable for Usb20Phy1Con2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB20_PHY1_CON2 to value 0x03d2"]
impl crate::Resettable for Usb20Phy1Con2Spec {
