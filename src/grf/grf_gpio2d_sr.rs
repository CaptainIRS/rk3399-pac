...
#[doc = "Field `GPIO2D_SR` reader - GPIO slew rate programmation section, every GPIO bit corresponding to 1bits"]
...
#[doc = "Field `GPIO2D_SR` writer - GPIO slew rate programmation section, every GPIO bit corresponding to 1bits"]
