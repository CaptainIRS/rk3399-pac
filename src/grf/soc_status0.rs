#[doc = "Register `SOC_STATUS0` reader"]
pub type R = crate::R<SocStatus0Spec>;
#[doc = "Register `SOC_STATUS0` writer"]
pub type W = crate::W<SocStatus0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ddr0_cke_status(&mut self) -> Ddr0CkeStatusW<SocStatus0Spec> {
        Ddr0CkeStatusW::new(self, 0)
    }
    #[doc = "Bits 2:3 - status bit of ddr0_zq_status_out"]
    #[inline(always)]
    #[must_use]
    pub fn ddr0_zq_status_out(&mut self) -> Ddr0ZqStatusOutW<SocStatus0Spec> {
        Ddr0ZqStatusOutW::new(self, 2)
    }
    #[doc = "Bit 4 - status bit of ddr0_port_busy"]
    #[inline(always)]
    #[must_use]
    pub fn ddr0_port_busy(&mut self) -> Ddr0PortBusyW<SocStatus0Spec> {
        Ddr0PortBusyW::new(self, 4)
    }
    #[doc = "Bit 5 - status bit of ddr0_controller_busy"]
    #[inline(always)]
    #[must_use]
    pub fn ddr0_controller_busy(&mut self) -> Ddr0ControllerBusyW<SocStatus0Spec> {
        Ddr0ControllerBusyW::new(self, 5)
    }
    #[doc = "Bit 6 - status bit of ddr0_refresh_in_process"]
    #[inline(always)]
    #[must_use]
    pub fn ddr0_refresh_in_process(&mut self) -> Ddr0RefreshInProcessW<SocStatus0Spec> {
        Ddr0RefreshInProcessW::new(self, 6)
    }
    #[doc = "Bit 7 - status bit of ddr0_q_almost_full"]
    #[inline(always)]
    #[must_use]
    pub fn ddr0_q_almost_full(&mut self) -> Ddr0QAlmostFullW<SocStatus0Spec> {
        Ddr0QAlmostFullW::new(self, 7)
    }
    #[doc = "Bit 8 - status bit of ddr0_mem_rst_valid"]
    #[inline(always)]
    #[must_use]
    pub fn ddr0_mem_rst_valid(&mut self) -> Ddr0MemRstValidW<SocStatus0Spec> {
        Ddr0MemRstValidW::new(self, 8)
    }
    #[doc = "Bits 16:17 - status bit of ddr1_cke_status"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_cke_status(&mut self) -> Ddr1CkeStatusW<SocStatus0Spec> {
        Ddr1CkeStatusW::new(self, 16)
    }
    #[doc = "Bits 18:19 - status bit of ddr1_zq_status_out"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_zq_status_out(&mut self) -> Ddr1ZqStatusOutW<SocStatus0Spec> {
        Ddr1ZqStatusOutW::new(self, 18)
    }
    #[doc = "Bit 20 - status bit of ddr1_port_busy"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_port_busy(&mut self) -> Ddr1PortBusyW<SocStatus0Spec> {
        Ddr1PortBusyW::new(self, 20)
    }
    #[doc = "Bit 21 - status bit of ddr1_controller_busy"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_controller_busy(&mut self) -> Ddr1ControllerBusyW<SocStatus0Spec> {
        Ddr1ControllerBusyW::new(self, 21)
    }
    #[doc = "Bit 22 - status bit of ddr1_refresh_in_process"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_refresh_in_process(&mut self) -> Ddr1RefreshInProcessW<SocStatus0Spec> {
        Ddr1RefreshInProcessW::new(self, 22)
    }
    #[doc = "Bit 23 - status bit of ddr1_q_almost_full"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_q_almost_full(&mut self) -> Ddr1QAlmostFullW<SocStatus0Spec> {
        Ddr1QAlmostFullW::new(self, 23)
    }
    #[doc = "Bit 24 - status bit of ddr1_mem_rst_valid"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_mem_rst_valid(&mut self) -> Ddr1MemRstValidW<SocStatus0Spec> {
        Ddr1MemRstValidW::new(self, 24)
    }
}
#[doc = "SOC status register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_status0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_status0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocStatus0Spec;
impl crate::RegisterSpec for SocStatus0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_status0::R`](R) reader structure"]
impl crate::Readable for SocStatus0Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_status0::W`](W) writer structure"]
impl crate::Writable for SocStatus0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_STATUS0 to value 0x03"]
impl crate::Resettable for SocStatus0Spec {
