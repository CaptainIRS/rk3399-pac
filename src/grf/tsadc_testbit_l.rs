#[doc = "Register `TSADC_TESTBIT_L` reader"]
pub type R = crate::R<TsadcTestbitLSpec>;
#[doc = "Register `TSADC_TESTBIT_L` writer"]
pub type W = crate::W<TsadcTestbitLSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn grf_tsadc_tsen_pd_0(&mut self) -> GrfTsadcTsenPd0W<TsadcTestbitLSpec> {
        GrfTsadcTsenPd0W::new(self, 0)
    }
    #[doc = "Bit 1 - grf_tsadc_tsen_pd_1"]
    #[inline(always)]
    #[must_use]
    pub fn grf_tsadc_tsen_pd_1(&mut self) -> GrfTsadcTsenPd1W<TsadcTestbitLSpec> {
        GrfTsadcTsenPd1W::new(self, 1)
    }
    #[doc = "Bit 2 - grf_tsadc_clk_sel"]
    #[inline(always)]
    #[must_use]
    pub fn grf_tsadc_clk_sel(&mut self) -> GrfTsadcClkSelW<TsadcTestbitLSpec> {
        GrfTsadcClkSelW::new(self, 2)
    }
    #[doc = "Bit 3 - grf_tsadc_dig_bypass"]
    #[inline(always)]
    #[must_use]
    pub fn grf_tsadc_dig_bypass(&mut self) -> GrfTsadcDigBypassW<TsadcTestbitLSpec> {
        GrfTsadcDigBypassW::new(self, 3)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<TsadcTestbitLSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "saradc test bit control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tsadc_testbit_l::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tsadc_testbit_l::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TsadcTestbitLSpec;
impl crate::RegisterSpec for TsadcTestbitLSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tsadc_testbit_l::R`](R) reader structure"]
impl crate::Readable for TsadcTestbitLSpec {}
#[doc = "`write(|w| ..)` method takes [`tsadc_testbit_l::W`](W) writer structure"]
impl crate::Writable for TsadcTestbitLSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TSADC_TESTBIT_L to value 0"]
impl crate::Resettable for TsadcTestbitLSpec {
