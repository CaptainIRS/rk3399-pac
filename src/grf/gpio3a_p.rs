#[doc = "Register `GPIO3A_P` reader"]
pub type R = crate::R<Gpio3aPSpec>;
#[doc = "Register `GPIO3A_P` writer"]
pub type W = crate::W<Gpio3aPSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio3a0_p(&mut self) -> Gpio3a0PW<Gpio3aPSpec> {
        Gpio3a0PW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO3A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a1_p(&mut self) -> Gpio3a1PW<Gpio3aPSpec> {
        Gpio3a1PW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO3A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a2_p(&mut self) -> Gpio3a2PW<Gpio3aPSpec> {
        Gpio3a2PW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO3A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a3_p(&mut self) -> Gpio3a3PW<Gpio3aPSpec> {
        Gpio3a3PW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO3A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a4_p(&mut self) -> Gpio3a4PW<Gpio3aPSpec> {
        Gpio3a4PW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO3A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a5_p(&mut self) -> Gpio3a5PW<Gpio3aPSpec> {
        Gpio3a5PW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO3A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a6_p(&mut self) -> Gpio3a6PW<Gpio3aPSpec> {
        Gpio3a6PW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO3A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3a7_p(&mut self) -> Gpio3a7PW<Gpio3aPSpec> {
        Gpio3a7PW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio3aPSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3A PU/PD control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio3a_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio3a_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio3aPSpec;
impl crate::RegisterSpec for Gpio3aPSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio3a_p::R`](R) reader structure"]
impl crate::Readable for Gpio3aPSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio3a_p::W`](W) writer structure"]
impl crate::Writable for Gpio3aPSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO3A_P to value 0x5a5a"]
impl crate::Resettable for Gpio3aPSpec {
