#[doc = "Register `GRF_GRF_USBHOST1_STATUS` reader"]
pub type R = crate::R<GrfGrfUsbhost1StatusSpec>;
#[doc = "Register `GRF_GRF_USBHOST1_STATUS` writer"]
pub type W = crate::W<GrfGrfUsbhost1StatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn host1_ehci_xfer_cnt(&mut self) -> Host1EhciXferCntW<GrfGrfUsbhost1StatusSpec> {
        Host1EhciXferCntW::new(self, 0)
    }
    #[doc = "Bits 11:16 - host1_ehci_usbsts"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ehci_usbsts(&mut self) -> Host1EhciUsbstsW<GrfGrfUsbhost1StatusSpec> {
        Host1EhciUsbstsW::new(self, 11)
    }
    #[doc = "Bits 17:20 - host1_ehci_lpsmc_state"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ehci_lpsmc_state(&mut self) -> Host1EhciLpsmcStateW<GrfGrfUsbhost1StatusSpec> {
        Host1EhciLpsmcStateW::new(self, 17)
    }
    #[doc = "Bit 21 - host1_ohci_rwe"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ohci_rwe(&mut self) -> Host1OhciRweW<GrfGrfUsbhost1StatusSpec> {
        Host1OhciRweW::new(self, 21)
    }
    #[doc = "Bit 22 - host1_ohci_rmtwkp"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ohci_rmtwkp(&mut self) -> Host1OhciRmtwkpW<GrfGrfUsbhost1StatusSpec> {
        Host1OhciRmtwkpW::new(self, 22)
    }
    #[doc = "Bit 23 - host1_ohci_globalsuspend"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ohci_globalsuspend(
        &mut self,
    ) -> Host1OhciGlobalsuspendW<GrfGrfUsbhost1StatusSpec> {
        Host1OhciGlobalsuspendW::new(self, 23)
    }
    #[doc = "Bit 24 - host1_ohci_drwe"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ohci_drwe(&mut self) -> Host1OhciDrweW<GrfGrfUsbhost1StatusSpec> {
        Host1OhciDrweW::new(self, 24)
    }
    #[doc = "Bit 25 - host1_ohci_ccs"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ohci_ccs(&mut self) -> Host1OhciCcsW<GrfGrfUsbhost1StatusSpec> {
        Host1OhciCcsW::new(self, 25)
    }
    #[doc = "Bit 26 - host1_ohci_bufacc"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ohci_bufacc(&mut self) -> Host1OhciBufaccW<GrfGrfUsbhost1StatusSpec> {
        Host1OhciBufaccW::new(self, 26)
    }
    #[doc = "Bit 27 - host1_ehci_xfer_prdc"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ehci_xfer_prdc(&mut self) -> Host1EhciXferPrdcW<GrfGrfUsbhost1StatusSpec> {
        Host1EhciXferPrdcW::new(self, 27)
    }
    #[doc = "Bit 28 - host1_ehci_bufacc"]
    #[inline(always)]
    #[must_use]
    pub fn host1_ehci_bufacc(&mut self) -> Host1EhciBufaccW<GrfGrfUsbhost1StatusSpec> {
        Host1EhciBufaccW::new(self, 28)
    }
}
#[doc = "usb host1 controller status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_grf_usbhost1_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_grf_usbhost1_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfGrfUsbhost1StatusSpec;
impl crate::RegisterSpec for GrfGrfUsbhost1StatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_grf_usbhost1_status::R`](R) reader structure"]
impl crate::Readable for GrfGrfUsbhost1StatusSpec {}
#[doc = "`write(|w| ..)` method takes [`grf_grf_usbhost1_status::W`](W) writer structure"]
impl crate::Writable for GrfGrfUsbhost1StatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_GRF_USBHOST1_STATUS to value 0"]
impl crate::Resettable for GrfGrfUsbhost1StatusSpec {
