#[doc = "Register `GPU_PERF_CON0` reader"]
pub type R = crate::R<GpuPerfCon0Spec>;
#[doc = "Register `GPU_PERF_CON0` writer"]
pub type W = crate::W<GpuPerfCon0Spec>;
...
#[doc = "Field `GPU_SW_RD_LATENCY_ID` reader - Axi read channel id for latency\n\nAXI_PERFormance test"]
pub type GpuSwRdLatencyIdR = crate::FieldReader;
#[doc = "Field `GPU_SW_RD_LATENCY_ID` writer - Axi read channel id for latency\n\nAXI_PERFormance test"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_axi_perf_work(&mut self) -> GpuSwAxiPerfWorkW<GpuPerfCon0Spec> {
        GpuSwAxiPerfWorkW::new(self, 0)
    }
    #[doc = "Bit 1 - axi_perf clear bit"]
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_axi_perf_clr(&mut self) -> GpuSwAxiPerfClrW<GpuPerfCon0Spec> {
        GpuSwAxiPerfClrW::new(self, 1)
    }
    #[doc = "Bit 2 - axi_perf counter type"]
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_axi_cnt_type(&mut self) -> GpuSwAxiCntTypeW<GpuPerfCon0Spec> {
        GpuSwAxiCntTypeW::new(self, 2)
    }
    #[doc = "Bit 3 - axi_perf counter id control"]
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_ar_cnt_id_type(&mut self) -> GpuSwArCntIdTypeW<GpuPerfCon0Spec> {
        GpuSwArCntIdTypeW::new(self, 3)
    }
    #[doc = "Bit 4 - axi_perf counter id control"]
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_aw_cnt_id_type(&mut self) -> GpuSwAwCntIdTypeW<GpuPerfCon0Spec> {
        GpuSwAwCntIdTypeW::new(self, 4)
    }
    #[doc = "Bits 5:6"]
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_ddr_align_type(&mut self) -> GpuSwDdrAlignTypeW<GpuPerfCon0Spec> {
        GpuSwDdrAlignTypeW::new(self, 5)
    }
    #[doc = "Bits 8:13 - Axi read channel id for latency\n\nAXI_PERFormance test"]
    #[inline(always)]
    #[must_use]
    pub fn gpu_sw_rd_latency_id(&mut self) -> GpuSwRdLatencyIdW<GpuPerfCon0Spec> {
        GpuSwRdLatencyIdW::new(self, 8)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GpuPerfCon0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "gpu performance monitor control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpu_perf_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpu_perf_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpuPerfCon0Spec;
impl crate::RegisterSpec for GpuPerfCon0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpu_perf_con0::R`](R) reader structure"]
impl crate::Readable for GpuPerfCon0Spec {}
#[doc = "`write(|w| ..)` method takes [`gpu_perf_con0::W`](W) writer structure"]
impl crate::Writable for GpuPerfCon0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPU_PERF_CON0 to value 0"]
impl crate::Resettable for GpuPerfCon0Spec {
