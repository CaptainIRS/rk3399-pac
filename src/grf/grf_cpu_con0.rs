#[doc = "Register `GRF_CPU_CON0` reader"]
pub type R = crate::R<GrfCpuCon0Spec>;
#[doc = "Register `GRF_CPU_CON0` writer"]
pub type W = crate::W<GrfCpuCon0Spec>;
...
#[doc = "pd_core_l cpu broadcastcachemaint bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `BROADCASTCACHEMAINT_PD_CORE_L` reader - pd_core_l cpu broadcastcachemaint bit control"]
...
#[doc = "Field `BROADCASTCACHEMAINT_PD_CORE_L` writer - pd_core_l cpu broadcastcachemaint bit control"]
...
impl R {
    ...
    #[doc = "Bit 2 - pd_core_l cpu broadcastcachemaint bit control"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn broadcastinner_pd_core_l(&mut self) -> BroadcastinnerPdCoreLW<GrfCpuCon0Spec> {
        BroadcastinnerPdCoreLW::new(self, 0)
    }
    #[doc = "Bit 1 - pd_core_l cpu broadcastouter bit control"]
    #[inline(always)]
    #[must_use]
    pub fn broadcastouter_pd_core_l(&mut self) -> BroadcastouterPdCoreLW<GrfCpuCon0Spec> {
        BroadcastouterPdCoreLW::new(self, 1)
    }
    #[doc = "Bit 2 - pd_core_l cpu broadcastcachemaint bit control"]
    #[inline(always)]
    #[must_use]
    pub fn broadcastcachemaint_pd_core_l(&mut self) -> BroadcastcachemaintPdCoreLW<GrfCpuCon0Spec> {
        BroadcastcachemaintPdCoreLW::new(self, 2)
    }
    #[doc = "Bit 3 - pd_core_l cpu sysbardisable bit control"]
    #[inline(always)]
    #[must_use]
    pub fn sysbardisable_pd_core_l(&mut self) -> SysbardisablePdCoreLW<GrfCpuCon0Spec> {
        SysbardisablePdCoreLW::new(self, 3)
    }
    #[doc = "Bit 4 - pd_core_l cpu clrexmonreq bit control"]
    #[inline(always)]
    #[must_use]
    pub fn clrexmonreq_pd_core_l(&mut self) -> ClrexmonreqPdCoreLW<GrfCpuCon0Spec> {
        ClrexmonreqPdCoreLW::new(self, 4)
    }
    #[doc = "Bit 6 - pd_core_l cpu dbgl1rstdisable bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dbgl1rstdisable_pd_core_l(&mut self) -> Dbgl1rstdisablePdCoreLW<GrfCpuCon0Spec> {
        Dbgl1rstdisablePdCoreLW::new(self, 6)
    }
    #[doc = "Bit 7 - pd_core_l cpu l2rstdisable bit control"]
    #[inline(always)]
    #[must_use]
    pub fn l2rstdisable_pd_core_l(&mut self) -> L2rstdisablePdCoreLW<GrfCpuCon0Spec> {
        L2rstdisablePdCoreLW::new(self, 7)
    }
    #[doc = "Bits 8:11 - pd_core_l cpu cfgend bit control"]
    #[inline(always)]
    #[must_use]
    pub fn cfgend_pd_core_l(&mut self) -> CfgendPdCoreLW<GrfCpuCon0Spec> {
        CfgendPdCoreLW::new(self, 8)
    }
    #[doc = "Bits 12:15 - pd_core_l cpu cfgte bit control"]
    #[inline(always)]
    #[must_use]
    pub fn cfgte_pd_core_l(&mut self) -> CfgtePdCoreLW<GrfCpuCon0Spec> {
        CfgtePdCoreLW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfCpuCon0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "cpu control register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_cpu_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_cpu_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfCpuCon0Spec;
impl crate::RegisterSpec for GrfCpuCon0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_cpu_con0::R`](R) reader structure"]
impl crate::Readable for GrfCpuCon0Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_cpu_con0::W`](W) writer structure"]
impl crate::Writable for GrfCpuCon0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_CPU_CON0 to value 0x0b"]
impl crate::Resettable for GrfCpuCon0Spec {
