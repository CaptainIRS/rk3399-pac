#[doc = "Register `GPIO3D_IOMUX` reader"]
pub type R = crate::R<Gpio3dIomuxSpec>;
#[doc = "Register `GPIO3D_IOMUX` writer"]
pub type W = crate::W<Gpio3dIomuxSpec>;
#[doc = "GPIO3D\\[0\\]
iomux select\n\nValue on reset: 0"]
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d0_sel(&mut self) -> Gpio3d0SelW<Gpio3dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d1_sel(&mut self) -> Gpio3d1SelW<Gpio3dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d2_sel(&mut self) -> Gpio3d2SelW<Gpio3dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d3_sel(&mut self) -> Gpio3d3SelW<Gpio3dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d4_sel(&mut self) -> Gpio3d4SelW<Gpio3dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d5_sel(&mut self) -> Gpio3d5SelW<Gpio3dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d6_sel(&mut self) -> Gpio3d6SelW<Gpio3dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d7_sel(&mut self) -> Gpio3d7SelW<Gpio3dIomuxSpec> {
        Gpio3d7SelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio3dIomuxSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3D iomux control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio3d_iomux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio3d_iomux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio3dIomuxSpec;
impl crate::RegisterSpec for Gpio3dIomuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio3d_iomux::R`](R) reader structure"]
impl crate::Readable for Gpio3dIomuxSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio3d_iomux::W`](W) writer structure"]
impl crate::Writable for Gpio3dIomuxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO3D_IOMUX to value 0"]
impl crate::Resettable for Gpio3dIomuxSpec {
