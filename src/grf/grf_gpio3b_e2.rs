#[doc = "Register `GRF_GPIO3B_E2` reader"]
pub type R = crate::R<GrfGpio3bE2Spec>;
#[doc = "Register `GRF_GPIO3B_E2` writer"]
pub type W = crate::W<GrfGpio3bE2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio3b5_e12(&mut self) -> Gpio3b5E12W<GrfGpio3bE2Spec> {
        Gpio3b5E12W::new(self, 0)
    }
    #[doc = "Bits 2:4 - GPIO3B6 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b6_e(&mut self) -> Gpio3b6EW<GrfGpio3bE2Spec> {
        Gpio3b6EW::new(self, 2)
    }
    #[doc = "Bits 5:7 - GPIO3B7 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b7_e(&mut self) -> Gpio3b7EW<GrfGpio3bE2Spec> {
        Gpio3b7EW::new(self, 5)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfGpio3bE2Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3B drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_gpio3b_e2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_gpio3b_e2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfGpio3bE2Spec;
impl crate::RegisterSpec for GrfGpio3bE2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_gpio3b_e2::R`](R) reader structure"]
impl crate::Readable for GrfGpio3bE2Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_gpio3b_e2::W`](W) writer structure"]
impl crate::Writable for GrfGpio3bE2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_GPIO3B_E2 to value 0"]
impl crate::Resettable for GrfGpio3bE2Spec {
