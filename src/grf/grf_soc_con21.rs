#[doc = "Register `GRF_SOC_CON21` reader"]
pub type R = crate::R<GrfSocCon21Spec>;
#[doc = "Register `GRF_SOC_CON21` writer"]
pub type W = crate::W<GrfSocCon21Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_enable(&mut self) -> DphyRx0EnableW<GrfSocCon21Spec> {
        DphyRx0EnableW::new(self, 0)
    }
    #[doc = "Bits 4:7 - dphy_rx0_forcerxmode bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_forcerxmode(&mut self) -> DphyRx0ForcerxmodeW<GrfSocCon21Spec> {
        DphyRx0ForcerxmodeW::new(self, 4)
    }
    #[doc = "Bits 8:11 - dphy_rx0_forcetxstopmode bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_forcetxstopmode(&mut self) -> DphyRx0ForcetxstopmodeW<GrfSocCon21Spec> {
        DphyRx0ForcetxstopmodeW::new(self, 8)
    }
    #[doc = "Bits 12:15 - dphy_rx0_turndisable bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_turndisable(&mut self) -> DphyRx0TurndisableW<GrfSocCon21Spec> {
        DphyRx0TurndisableW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfSocCon21Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 21\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_soc_con21::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_soc_con21::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfSocCon21Spec;
impl crate::RegisterSpec for GrfSocCon21Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_soc_con21::R`](R) reader structure"]
impl crate::Readable for GrfSocCon21Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_soc_con21::W`](W) writer structure"]
impl crate::Writable for GrfSocCon21Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_SOC_CON21 to value 0x02cb"]
impl crate::Resettable for GrfSocCon21Spec {
