#[doc = "Register `GPIO3B_P` reader"]
pub type R = crate::R<Gpio3bPSpec>;
#[doc = "Register `GPIO3B_P` writer"]
pub type W = crate::W<Gpio3bPSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio3b0_p(&mut self) -> Gpio3b0PW<Gpio3bPSpec> {
        Gpio3b0PW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO3B PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b1_p(&mut self) -> Gpio3b1PW<Gpio3bPSpec> {
        Gpio3b1PW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO3B PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b2_p(&mut self) -> Gpio3b2PW<Gpio3bPSpec> {
        Gpio3b2PW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO3B PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b3_p(&mut self) -> Gpio3b3PW<Gpio3bPSpec> {
        Gpio3b3PW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO3B PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b4_p(&mut self) -> Gpio3b4PW<Gpio3bPSpec> {
        Gpio3b4PW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO3B PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b5_p(&mut self) -> Gpio3b5PW<Gpio3bPSpec> {
        Gpio3b5PW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO3B PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b6_p(&mut self) -> Gpio3b6PW<Gpio3bPSpec> {
        Gpio3b6PW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO3B PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b7_p(&mut self) -> Gpio3b7PW<Gpio3bPSpec> {
        Gpio3b7PW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio3bPSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3B PU/PD control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio3b_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio3b_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio3bPSpec;
impl crate::RegisterSpec for Gpio3bPSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio3b_p::R`](R) reader structure"]
impl crate::Readable for Gpio3bPSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio3b_p::W`](W) writer structure"]
impl crate::Writable for Gpio3bPSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO3B_P to value 0x5559"]
impl crate::Resettable for Gpio3bPSpec {
