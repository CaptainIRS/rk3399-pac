#[doc = "Register `SOC_STATUS3` reader"]
pub type R = crate::R<SocStatus3Spec>;
#[doc = "Register `SOC_STATUS3` writer"]
pub type W = crate::W<SocStatus3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb20_phy0_stat_dp_attached(&mut self) -> Usb20Phy0StatDpAttachedW<SocStatus3Spec> {
        Usb20Phy0StatDpAttachedW::new(self, 0)
    }
    #[doc = "Bit 1 - usb20_phy0_stat_dcp_detected status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usb20_phy0_stat_dcp_detected(&mut self) -> Usb20Phy0StatDcpDetectedW<SocStatus3Spec> {
        Usb20Phy0StatDcpDetectedW::new(self, 1)
    }
    #[doc = "Bit 2 - usb20_phy0_stat_cp_detected status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usb20_phy0_stat_cp_detected(&mut self) -> Usb20Phy0StatCpDetectedW<SocStatus3Spec> {
        Usb20Phy0StatCpDetectedW::new(self, 2)
    }
    #[doc = "Bit 3 - usb20_phy1_stat_dp_attached status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usb20_phy1_stat_dp_attached(&mut self) -> Usb20Phy1StatDpAttachedW<SocStatus3Spec> {
        Usb20Phy1StatDpAttachedW::new(self, 3)
    }
    #[doc = "Bit 4 - usb20_phy1_stat_dcp_detected status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usb20_phy1_stat_dcp_detected(&mut self) -> Usb20Phy1StatDcpDetectedW<SocStatus3Spec> {
        Usb20Phy1StatDcpDetectedW::new(self, 4)
    }
    #[doc = "Bit 5 - usb20_phy1_stat_cp_detected status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usb20_phy1_stat_cp_detected(&mut self) -> Usb20Phy1StatCpDetectedW<SocStatus3Spec> {
        Usb20Phy1StatCpDetectedW::new(self, 5)
    }
    #[doc = "Bit 6 - usbcphy0_otg_utmi_sessend status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usbcphy0_otg_utmi_sessend(&mut self) -> Usbcphy0OtgUtmiSessendW<SocStatus3Spec> {
        Usbcphy0OtgUtmiSessendW::new(self, 6)
    }
    #[doc = "Bit 7 - usbcphy0_otg_utmi_avalid status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usbcphy0_otg_utmi_avalid(&mut self) -> Usbcphy0OtgUtmiAvalidW<SocStatus3Spec> {
        Usbcphy0OtgUtmiAvalidW::new(self, 7)
    }
    #[doc = "Bit 8 - usbcphy0_otg_utmi_iddig status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usbcphy0_otg_utmi_iddig(&mut self) -> Usbcphy0OtgUtmiIddigW<SocStatus3Spec> {
        Usbcphy0OtgUtmiIddigW::new(self, 8)
    }
    #[doc = "Bit 9 - usbcphy1_otg_utmi_sessend status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usbcphy1_otg_utmi_sessend(&mut self) -> Usbcphy1OtgUtmiSessendW<SocStatus3Spec> {
        Usbcphy1OtgUtmiSessendW::new(self, 9)
    }
    #[doc = "Bit 10 - usbcphy1_otg_utmi_avalid status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usbcphy1_otg_utmi_avalid(&mut self) -> Usbcphy1OtgUtmiAvalidW<SocStatus3Spec> {
        Usbcphy1OtgUtmiAvalidW::new(self, 10)
    }
    #[doc = "Bit 11 - usbcphy1_otg_utmi_iddig status bit"]
    #[inline(always)]
    #[must_use]
    pub fn usbcphy1_otg_utmi_iddig(&mut self) -> Usbcphy1OtgUtmiIddigW<SocStatus3Spec> {
        Usbcphy1OtgUtmiIddigW::new(self, 11)
    }
}
#[doc = "SOC status register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_status3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_status3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocStatus3Spec;
impl crate::RegisterSpec for SocStatus3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_status3::R`](R) reader structure"]
impl crate::Readable for SocStatus3Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_status3::W`](W) writer structure"]
impl crate::Writable for SocStatus3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_STATUS3 to value 0"]
impl crate::Resettable for SocStatus3Spec {
