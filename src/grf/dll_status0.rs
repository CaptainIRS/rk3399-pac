#[doc = "Register `DLL_STATUS0` reader"]
pub type R = crate::R<DllStatus0Spec>;
#[doc = "Register `DLL_STATUS0` writer"]
pub type W = crate::W<DllStatus0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pvtm_core_l_freq_done(&mut self) -> PvtmCoreLFreqDoneW<DllStatus0Spec> {
        PvtmCoreLFreqDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - pd_core_b pvtm frequency calculate done\n\nstutus"]
    #[inline(always)]
    #[must_use]
    pub fn pvtm_core_b_freq_done(&mut self) -> PvtmCoreBFreqDoneW<DllStatus0Spec> {
        PvtmCoreBFreqDoneW::new(self, 1)
    }
    #[doc = "Bit 2 - gpu pvtm frequency calculate done stutus"]
    #[inline(always)]
    #[must_use]
    pub fn pvtm_gpu_freq_done(&mut self) -> PvtmGpuFreqDoneW<DllStatus0Spec> {
        PvtmGpuFreqDoneW::new(self, 2)
    }
    #[doc = "Bit 3 - ddr pvtm frequency calculate done stutus"]
    #[inline(always)]
    #[must_use]
    pub fn pvtm_ddr_freq_done(&mut self) -> PvtmDdrFreqDoneW<DllStatus0Spec> {
        PvtmDdrFreqDoneW::new(self, 3)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<DllStatus0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "pvtm status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dll_status0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dll_status0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DllStatus0Spec;
impl crate::RegisterSpec for DllStatus0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dll_status0::R`](R) reader structure"]
impl crate::Readable for DllStatus0Spec {}
#[doc = "`write(|w| ..)` method takes [`dll_status0::W`](W) writer structure"]
impl crate::Writable for DllStatus0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DLL_STATUS0 to value 0"]
impl crate::Resettable for DllStatus0Spec {
