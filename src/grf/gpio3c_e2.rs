#[doc = "Register `GPIO3C_E2` reader"]
pub type R = crate::R<Gpio3cE2Spec>;
#[doc = "Register `GPIO3C_E2` writer"]
pub type W = crate::W<Gpio3cE2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio3c5_e12(&mut self) -> Gpio3c5E12W<Gpio3cE2Spec> {
        Gpio3c5E12W::new(self, 0)
    }
    #[doc = "Bits 2:4 - GPIO3C6 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3c6_e(&mut self) -> Gpio3c6EW<Gpio3cE2Spec> {
        Gpio3c6EW::new(self, 2)
    }
    #[doc = "Bits 5:7 - GPIO3C7 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3c7_e(&mut self) -> Gpio3c7EW<Gpio3cE2Spec> {
        Gpio3c7EW::new(self, 5)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio3cE2Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3C drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio3c_e2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio3c_e2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio3cE2Spec;
impl crate::RegisterSpec for Gpio3cE2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio3c_e2::R`](R) reader structure"]
impl crate::Readable for Gpio3cE2Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio3c_e2::W`](W) writer structure"]
impl crate::Writable for Gpio3cE2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO3C_E2 to value 0"]
impl crate::Resettable for Gpio3cE2Spec {
