#[doc = "Register `HSIC_CON0` reader"]
pub type R = crate::R<HsicCon0Spec>;
#[doc = "Register `HSIC_CON0` writer"]
pub type W = crate::W<HsicCon0Spec>;
...
#[doc = "Field `HSIC_INCRX_EN` reader - Burst Alignment Enable\n\nForces AHB master to start INCR4/8/16 busts\n\nonly on burst boundaries. AHB requires that\n\ndouble word width burst be addressed-aligned\n\nonly to the double-word boundary."]
...
#[doc = "Field `HSIC_INCRX_EN` writer - Burst Alignment Enable\n\nForces AHB master to start INCR4/8/16 busts\n\nonly on burst boundaries. AHB requires that\n\ndouble word width burst be addressed-aligned\n\nonly to the double-word boundary."]
...
#[doc = "Field `HSIC_SIM_MODE` reader - sim_mode\n\nSimulation only."]
pub type HsicSimModeR = crate::BitReader;
#[doc = "Field `HSIC_SIM_MODE` writer - sim_mode\n\nSimulation only."]
...
impl R {
    ...
    #[doc = "Bit 7 - Burst Alignment Enable\n\nForces AHB master to start INCR4/8/16 busts\n\nonly on burst boundaries. AHB requires that\n\ndouble word width burst be addressed-aligned\n\nonly to the double-word boundary."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hsic_app_prt_ovrcur(&mut self) -> HsicAppPrtOvrcurW<HsicCon0Spec> {
        HsicAppPrtOvrcurW::new(self, 0)
    }
    #[doc = "Bit 1 - app_start_clk"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_app_start_clk(&mut self) -> HsicAppStartClkW<HsicCon0Spec> {
        HsicAppStartClkW::new(self, 1)
    }
    #[doc = "Bit 2 - autoppd_on_overcur"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_autoppd_on_overcur(&mut self) -> HsicAutoppdOnOvercurW<HsicCon0Spec> {
        HsicAutoppdOnOvercurW::new(self, 2)
    }
    #[doc = "Bit 3 - hubsetup_min"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_hubsetup_min(&mut self) -> HsicHubsetupMinW<HsicCon0Spec> {
        HsicHubsetupMinW::new(self, 3)
    }
    #[doc = "Bit 4 - incr16_en"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_incr16_en(&mut self) -> HsicIncr16EnW<HsicCon0Spec> {
        HsicIncr16EnW::new(self, 4)
    }
    #[doc = "Bit 5 - incr4_en"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_incr4_en(&mut self) -> HsicIncr4EnW<HsicCon0Spec> {
        HsicIncr4EnW::new(self, 5)
    }
    #[doc = "Bit 6 - incr8_en"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_incr8_en(&mut self) -> HsicIncr8EnW<HsicCon0Spec> {
        HsicIncr8EnW::new(self, 6)
    }
    #[doc = "Bit 7 - Burst Alignment Enable\n\nForces AHB master to start INCR4/8/16 busts\n\nonly on burst boundaries. AHB requires that\n\ndouble word width burst be addressed-aligned\n\nonly to the double-word boundary."]
    #[inline(always)]
    #[must_use]
    pub fn hsic_incrx_en(&mut self) -> HsicIncrxEnW<HsicCon0Spec> {
        HsicIncrxEnW::new(self, 7)
    }
    #[doc = "Bit 8 - sim_mode\n\nSimulation only."]
    #[inline(always)]
    #[must_use]
    pub fn hsic_sim_mode(&mut self) -> HsicSimModeW<HsicCon0Spec> {
        HsicSimModeW::new(self, 8)
    }
    #[doc = "Bit 9 - word_if"]
    #[inline(always)]
    #[must_use]
    pub fn hsic_word_if(&mut self) -> HsicWordIfW<HsicCon0Spec> {
        HsicWordIfW::new(self, 9)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<HsicCon0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "HSIC controller GRF register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hsic_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hsic_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HsicCon0Spec;
impl crate::RegisterSpec for HsicCon0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hsic_con0::R`](R) reader structure"]
impl crate::Readable for HsicCon0Spec {}
#[doc = "`write(|w| ..)` method takes [`hsic_con0::W`](W) writer structure"]
impl crate::Writable for HsicCon0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSIC_CON0 to value 0x02f0"]
impl crate::Resettable for HsicCon0Spec {
