#[doc = "Register `USB20_PHY1_CON1` reader"]
pub type R = crate::R<Usb20Phy1Con1Spec>;
#[doc = "Register `USB20_PHY1_CON1` writer"]
pub type W = crate::W<Usb20Phy1Con1Spec>;
#[doc = "utmi_sel\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn utmi_sel(&mut self) -> UtmiSelW<Usb20Phy1Con1Spec> {
        UtmiSelW::new(self, 0)
    }
    #[doc = "Bit 1 - suspend_n\n\nutmi_sel=1, select the value of this register to\n\nusb2phy\n\nutmi_sel=0 and bit11 of\n\nUSB20_PHY0_CON1=0, and bit 12 of\n\nUSB20_PHY0_CON1=0 select the value of the\n\nvalue of this bit to usb2phy\n\nutmi_sel=0 and bit11 of\n\nUSB20_PHY0_CON1=0, and bit 12 of\n\nUSB20_PHY0_CON1=1 select suspend_n\n\nsignals from usb3otg0 controller to usb2phy\n\nfor free running utmi clock\n\nutmi_sel=0 and bit11 of\n\nUSB20_PHY0_CON1=1, select\n\nsuspend_com_n signals from usb3otg0\n\ncontroller to usb2phy for not free running utmi\n\nclock"]
    #[inline(always)]
    #[must_use]
    pub fn suspend_n(&mut self) -> SuspendNW<Usb20Phy1Con1Spec> {
        SuspendNW::new(self, 1)
    }
    #[doc = "Bits 2:3 - opmode\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn opmode(&mut self) -> OpmodeW<Usb20Phy1Con1Spec> {
        OpmodeW::new(self, 2)
    }
    #[doc = "Bits 4:5 - xcvrselect\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn xcvrselect(&mut self) -> XcvrselectW<Usb20Phy1Con1Spec> {
        XcvrselectW::new(self, 4)
    }
    #[doc = "Bit 6 - termselect\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn termselect(&mut self) -> TermselectW<Usb20Phy1Con1Spec> {
        TermselectW::new(self, 6)
    }
    #[doc = "Bit 7 - dppulldown\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn dppulldown(&mut self) -> DppulldownW<Usb20Phy1Con1Spec> {
        DppulldownW::new(self, 7)
    }
    #[doc = "Bit 8 - dmpulldown\n\nSelect the value of this register to usb2phy\n\nwhen utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn dmpulldown(&mut self) -> DmpulldownW<Usb20Phy1Con1Spec> {
        DmpulldownW::new(self, 8)
    }
    #[doc = "Bit 9 - iddig_sel"]
    #[inline(always)]
    #[must_use]
    pub fn iddig_sel(&mut self) -> IddigSelW<Usb20Phy1Con1Spec> {
        IddigSelW::new(self, 9)
    }
    #[doc = "Bit 10 - iddig\n\nSelect the value of this register to usb3otg1\n\nregister"]
    #[inline(always)]
    #[must_use]
    pub fn iddig(&mut self) -> IddigW<Usb20Phy1Con1Spec> {
        IddigW::new(self, 10)
    }
    #[doc = "Bit 11 - suspend_n_sel\n\nPls see suspend_n."]
    #[inline(always)]
    #[must_use]
    pub fn suspend_n_sel(&mut self) -> SuspendNSelW<Usb20Phy1Con1Spec> {
        SuspendNSelW::new(self, 11)
    }
    #[doc = "Bit 12 - suspend_n-_sel1\n\nPls see suspend_n."]
    #[inline(always)]
    #[must_use]
    pub fn suspend_n_sel1(&mut self) -> SuspendNSel1W<Usb20Phy1Con1Spec> {
        SuspendNSel1W::new(self, 12)
    }
    #[doc = "Bits 13:28 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb20Phy1Con1Spec> {
        WriteEnableW::new(self, 13)
    }
}
#[doc = "USB20 PHY1GRF Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb20_phy1_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb20_phy1_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb20Phy1Con1Spec;
impl crate::RegisterSpec for Usb20Phy1Con1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb20_phy1_con1::R`](R) reader structure"]
impl crate::Readable for Usb20Phy1Con1Spec {}
#[doc = "`write(|w| ..)` method takes [`usb20_phy1_con1::W`](W) writer structure"]
impl crate::Writable for Usb20Phy1Con1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB20_PHY1_CON1 to value 0x1452"]
impl crate::Resettable for Usb20Phy1Con1Spec {
