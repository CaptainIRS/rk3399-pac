#[doc = "Register `GRF_USB3OTG1_CON0` reader"]
pub type R = crate::R<GrfUsb3otg1Con0Spec>;
#[doc = "Register `GRF_USB3OTG1_CON0` writer"]
pub type W = crate::W<GrfUsb3otg1Con0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bus_filter_bypass(&mut self) -> BusFilterBypassW<GrfUsb3otg1Con0Spec> {
        BusFilterBypassW::new(self, 0)
    }
    #[doc = "Bits 4:5 - hub_port_overcurrent\n\nThis is the per port Overcurrent indication of\n\nthe root-hub ports:"]
    #[inline(always)]
    #[must_use]
    pub fn hub_port_overcurrent(&mut self) -> HubPortOvercurrentW<GrfUsb3otg1Con0Spec> {
        HubPortOvercurrentW::new(self, 4)
    }
    #[doc = "Bits 6:7 - hub_port_perm_attach\n\nIndicates if the device attached to a\n\ndownstream port is permanently attached or\n\nnot."]
    #[inline(always)]
    #[must_use]
    pub fn hub_port_perm_attach(&mut self) -> HubPortPermAttachW<GrfUsb3otg1Con0Spec> {
        HubPortPermAttachW::new(self, 6)
    }
    #[doc = "Bits 8:13 - fladj_30mhz_reg\n\nHS Jitter Adjustment. Indicates the correction\n\nrequired to accommodate mac3 clock and\n\nutmi clock jitter to measure 125 's duration.\n\nWith fladj_30mhz_reg tied to zero, the high\n\nspeed 125us micro-frame is counted for\n\n123933ns. You must program the value in\n\nterms of high speed bit times in a 30 MHz\n\ncycle. The default value that must be driven is\n\n32 (assuming 30 MHz perfect clock)."]
    #[inline(always)]
    #[must_use]
    pub fn fladj_30mhz_reg(&mut self) -> Fladj30mhzRegW<GrfUsb3otg1Con0Spec> {
    ...
    pub fn host_port_power_control_present(
        &mut self,
    ) -> HostPortPowerControlPresentW<GrfUsb3otg1Con0Spec> {
        HostPortPowerControlPresentW::new(self, 14)
    }
    #[doc = "Bit 15 - host_u2_port_disable\n\nUSB2.0 Port Disable control."]
    #[inline(always)]
    #[must_use]
    pub fn host_u2_port_disable(&mut self) -> HostU2PortDisableW<GrfUsb3otg1Con0Spec> {
        HostU2PortDisableW::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfUsb3otg1Con0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "USB3 OTG1 GRF Register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_usb3otg1_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_usb3otg1_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfUsb3otg1Con0Spec;
impl crate::RegisterSpec for GrfUsb3otg1Con0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_usb3otg1_con0::R`](R) reader structure"]
impl crate::Readable for GrfUsb3otg1Con0Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_usb3otg1_con0::W`](W) writer structure"]
impl crate::Writable for GrfUsb3otg1Con0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_USB3OTG1_CON0 to value 0x2000"]
impl crate::Resettable for GrfUsb3otg1Con0Spec {
