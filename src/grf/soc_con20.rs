#[doc = "Register `SOC_CON20` reader"]
pub type R = crate::R<SocCon20Spec>;
#[doc = "Register `SOC_CON20` writer"]
pub type W = crate::W<SocCon20Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsi0_lcdc_sel(&mut self) -> Dsi0LcdcSelW<SocCon20Spec> {
        Dsi0LcdcSelW::new(self, 0)
    }
    #[doc = "Bit 1 - dsi1 dpicolorm bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dsi1_dpicolorm(&mut self) -> Dsi1DpicolormW<SocCon20Spec> {
        Dsi1DpicolormW::new(self, 1)
    }
    #[doc = "Bit 2 - dsi1 dpishutdn bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dsi1_dpishutdn(&mut self) -> Dsi1DpishutdnW<SocCon20Spec> {
        Dsi1DpishutdnW::new(self, 2)
    }
    #[doc = "Bit 3 - dsi1 dpiupdatecfg bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dsi1_dpiupdatecfg(&mut self) -> Dsi1DpiupdatecfgW<SocCon20Spec> {
        Dsi1DpiupdatecfgW::new(self, 3)
    }
    #[doc = "Bit 4 - dsi1 lcdc select"]
    #[inline(always)]
    #[must_use]
    pub fn dsi1_lcdc_sel(&mut self) -> Dsi1LcdcSelW<SocCon20Spec> {
        Dsi1LcdcSelW::new(self, 4)
    }
    #[doc = "Bit 5 - edp lcdc select"]
    #[inline(always)]
    #[must_use]
    pub fn edp_lcdc_sel(&mut self) -> EdpLcdcSelW<SocCon20Spec> {
        EdpLcdcSelW::new(self, 5)
    }
    #[doc = "Bit 6 - hdmi lcdc select"]
    #[inline(always)]
    #[must_use]
    pub fn hdmi_lcdc_sel(&mut self) -> HdmiLcdcSelW<SocCon20Spec> {
        HdmiLcdcSelW::new(self, 6)
    }
    #[doc = "Bit 7 - vop finish select"]
    #[inline(always)]
    #[must_use]
    pub fn vop_finish_sel(&mut self) -> VopFinishSelW<SocCon20Spec> {
        VopFinishSelW::new(self, 7)
    }
    #[doc = "Bit 8 - edp video bist enable"]
    #[inline(always)]
    #[must_use]
    pub fn edp_video_bist_en(&mut self) -> EdpVideoBistEnW<SocCon20Spec> {
        EdpVideoBistEnW::new(self, 8)
    }
    #[doc = "Bit 9 - pclkin dvp clock select"]
    #[inline(always)]
    #[must_use]
    pub fn pclkin_dvp_rev_sel(&mut self) -> PclkinDvpRevSelW<SocCon20Spec> {
        PclkinDvpRevSelW::new(self, 9)
    }
    #[doc = "Bit 11 - vop select"]
    #[inline(always)]
    #[must_use]
    pub fn grf_con_rgb_lcdc_sel(&mut self) -> GrfConRgbLcdcSelW<SocCon20Spec> {
        GrfConRgbLcdcSelW::new(self, 11)
    }
    #[doc = "Bit 12 - dclk phase selct"]
    #[inline(always)]
    #[must_use]
    pub fn grf_vop_rgb_dclk_rev_sel(&mut self) -> GrfVopRgbDclkRevSelW<SocCon20Spec> {
        GrfVopRgbDclkRevSelW::new(self, 12)
    }
    #[doc = "Bit 13 - hdcp_i2c_force_scl control"]
    #[inline(always)]
    #[must_use]
    pub fn hdcp_i2c_force_scl(&mut self) -> HdcpI2cForceSclW<SocCon20Spec> {
        HdcpI2cForceSclW::new(self, 13)
    }
    #[doc = "Bit 14 - hdcp_i2c_force_sda bit control"]
    #[inline(always)]
    #[must_use]
    pub fn hdcp_i2c_force_sda(&mut self) -> HdcpI2cForceSdaW<SocCon20Spec> {
        HdcpI2cForceSdaW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SocCon20Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 20\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_con20::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_con20::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocCon20Spec;
impl crate::RegisterSpec for SocCon20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_con20::R`](R) reader structure"]
impl crate::Readable for SocCon20Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_con20::W`](W) writer structure"]
impl crate::Writable for SocCon20Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_CON20 to value 0x0249"]
impl crate::Resettable for SocCon20Spec {
