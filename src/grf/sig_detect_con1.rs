#[doc = "Register `SIG_DETECT_CON1` reader"]
pub type R = crate::R<SigDetectCon1Spec>;
#[doc = "Register `SIG_DETECT_CON1` writer"]
pub type W = crate::W<SigDetectCon1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn otg0_id_filter_time_sel(&mut self) -> Otg0IdFilterTimeSelW<SigDetectCon1Spec> {
    ...
    pub fn otg0_llinestate_filter_time_sel(
        &mut self,
    ) -> Otg0LlinestateFilterTimeSelW<SigDetectCon1Spec> {
    ...
    pub fn host0_llinestate_filter_time_sel(
        &mut self,
    ) -> Host0LlinestateFilterTimeSelW<SigDetectCon1Spec> {
        Host0LlinestateFilterTimeSelW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SigDetectCon1Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "Singal detect control register1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sig_detect_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sig_detect_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SigDetectCon1Spec;
impl crate::RegisterSpec for SigDetectCon1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sig_detect_con1::R`](R) reader structure"]
impl crate::Readable for SigDetectCon1Spec {}
#[doc = "`write(|w| ..)` method takes [`sig_detect_con1::W`](W) writer structure"]
impl crate::Writable for SigDetectCon1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SIG_DETECT_CON1 to value 0"]
impl crate::Resettable for SigDetectCon1Spec {
