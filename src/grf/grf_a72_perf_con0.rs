...
#[doc = "Field `A72_SW_RD_LATENCY_ID` reader - Axi read channel id for latency AXI_PERFormance test"]
pub type A72SwRdLatencyIdR = crate::FieldReader;
#[doc = "Field `A72_SW_RD_LATENCY_ID` writer - Axi read channel id for latency AXI_PERFormance test"]
...
impl R {
    ...
    #[doc = "Bits 8:14 - Axi read channel id for latency AXI_PERFormance test"]
    #[inline(always)]
