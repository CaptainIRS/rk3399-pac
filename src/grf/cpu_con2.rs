#[doc = "Register `CPU_CON2` reader"]
pub type R = crate::R<CpuCon2Spec>;
#[doc = "Register `CPU_CON2` writer"]
pub type W = crate::W<CpuCon2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn broadcastinner_pd_core_b(&mut self) -> BroadcastinnerPdCoreBW<CpuCon2Spec> {
        BroadcastinnerPdCoreBW::new(self, 0)
    }
    #[doc = "Bit 1 - pd_core_b cpu broadcastouter bit control"]
    #[inline(always)]
    #[must_use]
    pub fn broadcastouter_pd_core_b(&mut self) -> BroadcastouterPdCoreBW<CpuCon2Spec> {
        BroadcastouterPdCoreBW::new(self, 1)
    }
    #[doc = "Bit 2 - pd_core_b cpu broadcastcachemaint bit\n\ncontrol"]
    #[inline(always)]
    #[must_use]
    pub fn broadcastcachemaint_pd_core_b(&mut self) -> BroadcastcachemaintPdCoreBW<CpuCon2Spec> {
        BroadcastcachemaintPdCoreBW::new(self, 2)
    }
    #[doc = "Bit 3 - pd_core_b cpu sysbardisable bit control"]
    #[inline(always)]
    #[must_use]
    pub fn sysbardisable_pd_core_b(&mut self) -> SysbardisablePdCoreBW<CpuCon2Spec> {
        SysbardisablePdCoreBW::new(self, 3)
    }
    #[doc = "Bit 4 - pd_core_b cpu clrexmonreq bit control"]
    #[inline(always)]
    #[must_use]
    pub fn clrexmonreq_pd_core_b(&mut self) -> ClrexmonreqPdCoreBW<CpuCon2Spec> {
        ClrexmonreqPdCoreBW::new(self, 4)
    }
    #[doc = "Bit 6 - pd_core_b cpu dbgl1rstdisable bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dbgl1rstdisable_pd_core_b(&mut self) -> Dbgl1rstdisablePdCoreBW<CpuCon2Spec> {
        Dbgl1rstdisablePdCoreBW::new(self, 6)
    }
    #[doc = "Bit 7 - pd_core_b cpu l2rstdisable bit control"]
    #[inline(always)]
    #[must_use]
    pub fn l2rstdisable_pd_core_b(&mut self) -> L2rstdisablePdCoreBW<CpuCon2Spec> {
        L2rstdisablePdCoreBW::new(self, 7)
    }
    #[doc = "Bits 8:9 - pd_core_b cpu cfgend bit control"]
    #[inline(always)]
    #[must_use]
    pub fn cfgend_pd_core_b(&mut self) -> CfgendPdCoreBW<CpuCon2Spec> {
        CfgendPdCoreBW::new(self, 8)
    }
    #[doc = "Bits 12:13 - pd_core_b cpu cfgte bit control"]
    #[inline(always)]
    #[must_use]
    pub fn cfgte_pd_core_b(&mut self) -> CfgtePdCoreBW<CpuCon2Spec> {
        CfgtePdCoreBW::new(self, 12)
    }
    #[doc = "Bit 14 - gic axi master error acknowledges"]
    #[inline(always)]
    #[must_use]
    pub fn gic_axim_err_ack(&mut self) -> GicAximErrAckW<CpuCon2Spec> {
        GicAximErrAckW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<CpuCon2Spec> {
...
pub struct CpuCon2Spec;
impl crate::RegisterSpec for CpuCon2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpu_con2::R`](R) reader structure"]
impl crate::Readable for CpuCon2Spec {}
#[doc = "`write(|w| ..)` method takes [`cpu_con2::W`](W) writer structure"]
impl crate::Writable for CpuCon2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPU_CON2 to value 0x0b"]
impl crate::Resettable for CpuCon2Spec {
