#[doc = "Register `GPIO2C_IOMUX` reader"]
pub type R = crate::R<Gpio2cIomuxSpec>;
#[doc = "Register `GPIO2C_IOMUX` writer"]
pub type W = crate::W<Gpio2cIomuxSpec>;
#[doc = "GPIO2C\\[0\\]
iomux select\n\nValue on reset: 0"]
...
impl Gpio2c0SelR {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2c0Sel> {
        match self.bits {
            0 => Some(Gpio2c0Sel::B00),
            1 => Some(Gpio2c0Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2c0SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2c0Sel>;
...
impl Gpio2c1SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2c1Sel> {
        match self.bits {
            0 => Some(Gpio2c1Sel::B00),
            1 => Some(Gpio2c1Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2c1SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2c1Sel>;
...
impl Gpio2c2SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2c2Sel> {
        match self.bits {
            0 => Some(Gpio2c2Sel::B00),
            1 => Some(Gpio2c2Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2c2SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2c2Sel>;
...
impl Gpio2c3SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2c3Sel> {
        match self.bits {
            0 => Some(Gpio2c3Sel::B00),
            1 => Some(Gpio2c3Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2c3SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2c3Sel>;
...
impl Gpio2c4SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2c4Sel> {
        match self.bits {
            0 => Some(Gpio2c4Sel::B00),
            1 => Some(Gpio2c4Sel::B01),
            2 => Some(Gpio2c4Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2c4SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2c4Sel>;
...
impl Gpio2c5SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2c5Sel> {
        match self.bits {
            0 => Some(Gpio2c5Sel::B00),
            1 => Some(Gpio2c5Sel::B01),
            2 => Some(Gpio2c5Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2c5SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2c5Sel>;
...
impl Gpio2c6SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2c6Sel> {
        match self.bits {
            0 => Some(Gpio2c6Sel::B00),
            1 => Some(Gpio2c6Sel::B01),
            2 => Some(Gpio2c6Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2c6SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2c6Sel>;
...
impl Gpio2c7SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2c7Sel> {
        match self.bits {
            0 => Some(Gpio2c7Sel::B00),
            1 => Some(Gpio2c7Sel::B01),
            2 => Some(Gpio2c7Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2c7SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2c7Sel>;
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c0_sel(&mut self) -> Gpio2c0SelW<Gpio2cIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c1_sel(&mut self) -> Gpio2c1SelW<Gpio2cIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c2_sel(&mut self) -> Gpio2c2SelW<Gpio2cIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c3_sel(&mut self) -> Gpio2c3SelW<Gpio2cIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c4_sel(&mut self) -> Gpio2c4SelW<Gpio2cIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c5_sel(&mut self) -> Gpio2c5SelW<Gpio2cIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c6_sel(&mut self) -> Gpio2c6SelW<Gpio2cIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2c7_sel(&mut self) -> Gpio2c7SelW<Gpio2cIomuxSpec> {
        Gpio2c7SelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio2cIomuxSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO2C iomux control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio2c_iomux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio2c_iomux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio2cIomuxSpec;
impl crate::RegisterSpec for Gpio2cIomuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio2c_iomux::R`](R) reader structure"]
impl crate::Readable for Gpio2cIomuxSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio2c_iomux::W`](W) writer structure"]
impl crate::Writable for Gpio2cIomuxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO2C_IOMUX to value 0"]
impl crate::Resettable for Gpio2cIomuxSpec {
