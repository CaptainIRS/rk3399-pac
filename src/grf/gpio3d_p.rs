#[doc = "Register `GPIO3D_P` reader"]
pub type R = crate::R<Gpio3dPSpec>;
#[doc = "Register `GPIO3D_P` writer"]
pub type W = crate::W<Gpio3dPSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio3d0_p(&mut self) -> Gpio3d0PW<Gpio3dPSpec> {
        Gpio3d0PW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO3D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d1_p(&mut self) -> Gpio3d1PW<Gpio3dPSpec> {
        Gpio3d1PW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO3D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d2_p(&mut self) -> Gpio3d2PW<Gpio3dPSpec> {
        Gpio3d2PW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO3D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d3_p(&mut self) -> Gpio3d3PW<Gpio3dPSpec> {
        Gpio3d3PW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO3D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d4_p(&mut self) -> Gpio3d4PW<Gpio3dPSpec> {
        Gpio3d4PW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO3D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d5_p(&mut self) -> Gpio3d5PW<Gpio3dPSpec> {
        Gpio3d5PW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO3D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d6_p(&mut self) -> Gpio3d6PW<Gpio3dPSpec> {
        Gpio3d6PW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO3D PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3d7_p(&mut self) -> Gpio3d7PW<Gpio3dPSpec> {
        Gpio3d7PW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio3dPSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3D PU/PD control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio3d_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio3d_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio3dPSpec;
impl crate::RegisterSpec for Gpio3dPSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio3d_p::R`](R) reader structure"]
impl crate::Readable for Gpio3dPSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio3d_p::W`](W) writer structure"]
impl crate::Writable for Gpio3dPSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO3D_P to value 0xaaaa"]
impl crate::Resettable for Gpio3dPSpec {
