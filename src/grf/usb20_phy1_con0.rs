#[doc = "Register `USB20_PHY1_CON0` reader"]
pub type R = crate::R<Usb20Phy1Con0Spec>;
#[doc = "Register `USB20_PHY1_CON0` writer"]
pub type W = crate::W<Usb20Phy1Con0Spec>;
#[doc = "otg_disable_0\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn otg_disable_0(&mut self) -> OtgDisable0W<Usb20Phy1Con0Spec> {
        OtgDisable0W::new(self, 0)
    }
    #[doc = "Bit 1 - otg_disable_1"]
    #[inline(always)]
    #[must_use]
    pub fn otg_disable_1(&mut self) -> OtgDisable1W<Usb20Phy1Con0Spec> {
        OtgDisable1W::new(self, 1)
    }
    #[doc = "Bit 2 - bypassdmen"]
    #[inline(always)]
    #[must_use]
    pub fn bypassdmen(&mut self) -> BypassdmenW<Usb20Phy1Con0Spec> {
        BypassdmenW::new(self, 2)
    }
    #[doc = "Bit 3 - bypasssel"]
    #[inline(always)]
    #[must_use]
    pub fn bypasssel(&mut self) -> BypassselW<Usb20Phy1Con0Spec> {
        BypassselW::new(self, 3)
    }
    #[doc = "Bit 4 - otg_commononn\n\nconfigure pll clock output in suspend mode"]
    #[inline(always)]
    #[must_use]
    pub fn otg_commononn(&mut self) -> OtgCommononnW<Usb20Phy1Con0Spec> {
        OtgCommononnW::new(self, 4)
    }
    #[doc = "Bit 7 - idp_sink_en\n\n1: enable idp_sink for battery charge for\n\nusb3otg1"]
    #[inline(always)]
    #[must_use]
    pub fn idp_sink_en(&mut self) -> IdpSinkEnW<Usb20Phy1Con0Spec> {
        IdpSinkEnW::new(self, 7)
    }
    #[doc = "Bit 8 - idm_sink_en\n\n1: enable idm_sink for battery charge for\n\nusb3otg1"]
    #[inline(always)]
    #[must_use]
    pub fn idm_sink_en(&mut self) -> IdmSinkEnW<Usb20Phy1Con0Spec> {
        IdmSinkEnW::new(self, 8)
    }
    #[doc = "Bit 9 - idp_src_en\n\n1: enable idp_src for battery charge for\n\nusb3otg1"]
    #[inline(always)]
    #[must_use]
    pub fn idp_src_en(&mut self) -> IdpSrcEnW<Usb20Phy1Con0Spec> {
        IdpSrcEnW::new(self, 9)
    }
    #[doc = "Bit 10 - rdm_pdwn_en\n\n1: enable rdm_pdwn for battery charge for\n\nusb3otg1"]
    #[inline(always)]
    #[must_use]
    pub fn rdm_pdwn_en(&mut self) -> RdmPdwnEnW<Usb20Phy1Con0Spec> {
        RdmPdwnEnW::new(self, 10)
    }
    #[doc = "Bit 11 - vdp_src_en\n\n1:enable vdp_src for battery charge for\n\nusb3otg1"]
    #[inline(always)]
    #[must_use]
    pub fn vdp_src_en(&mut self) -> VdpSrcEnW<Usb20Phy1Con0Spec> {
        VdpSrcEnW::new(self, 11)
    }
    #[doc = "Bit 12 - vdm_src_en\n\n1: enable vdm_src for battery charge for\n\nusb3otg1"]
    #[inline(always)]
    #[must_use]
    pub fn vdm_src_en(&mut self) -> VdmSrcEnW<Usb20Phy1Con0Spec> {
        VdmSrcEnW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb20Phy1Con0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "USB20 PHY1 GRF Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb20_phy1_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb20_phy1_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb20Phy1Con0Spec;
impl crate::RegisterSpec for Usb20Phy1Con0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb20_phy1_con0::R`](R) reader structure"]
impl crate::Readable for Usb20Phy1Con0Spec {}
#[doc = "`write(|w| ..)` method takes [`usb20_phy1_con0::W`](W) writer structure"]
impl crate::Writable for Usb20Phy1Con0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB20_PHY1_CON0 to value 0"]
impl crate::Resettable for Usb20Phy1Con0Spec {
