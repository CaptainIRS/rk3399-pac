...
pub enum OtgDisable0 {
    #[doc = "1: enable otg function of usb3otg0"]
    B1 = 1,
...
pub enum OtgDisable1 {
    #[doc = "1: enable otg function of usb20 host0"]
    B1 = 1,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Bypassdmen {
    #[doc = "1: disable bypass uart_sout to DM for usb3otg0"]
    B1 = 1,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Bypasssel {
    #[doc = "1: Normal USB function for usb3otg0"]
    B1 = 1,
...
#[doc = "Field `IDP_SINK_EN` reader - idp_sink_en 1: enable idp_sink for battery charge for usb3otg0"]
pub type IdpSinkEnR = crate::BitReader;
#[doc = "Field `IDP_SINK_EN` writer - idp_sink_en 1: enable idp_sink for battery charge for usb3otg0"]
pub type IdpSinkEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IDM_SINK_EN` reader - idm_sink_en 1: enable idm_sink for battery charge for usb3otg0"]
pub type IdmSinkEnR = crate::BitReader;
#[doc = "Field `IDM_SINK_EN` writer - idm_sink_en 1: enable idm_sink for battery charge for usb3otg0"]
pub type IdmSinkEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IDP_SRC_EN` reader - idp_src_en 1: enable idp_src for battery charge for usb3otg0"]
pub type IdpSrcEnR = crate::BitReader;
#[doc = "Field `IDP_SRC_EN` writer - idp_src_en 1: enable idp_src for battery charge for usb3otg0"]
pub type IdpSrcEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RDM_PDWN_EN` reader - rdm_pdwn_en 1: enable rdm_pdwn for battery charge for usb3otg0"]
pub type RdmPdwnEnR = crate::BitReader;
#[doc = "Field `RDM_PDWN_EN` writer - rdm_pdwn_en 1: enable rdm_pdwn for battery charge for usb3otg0"]
pub type RdmPdwnEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `VDP_SRC_EN` reader - vdp_src_en 1:enable vdp_src for battery charge for usb3otg0"]
pub type VdpSrcEnR = crate::BitReader;
#[doc = "Field `VDP_SRC_EN` writer - vdp_src_en 1:enable vdp_src for battery charge for usb3otg0"]
pub type VdpSrcEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `VDM_SRC_EN` reader - vdm_src_en 1: enable vdm_src for battery charge for usb3otg0"]
pub type VdmSrcEnR = crate::BitReader;
#[doc = "Field `VDM_SRC_EN` writer - vdm_src_en 1: enable vdm_src for battery charge for usb3otg0"]
...
impl R {
    ...
    #[doc = "Bit 7 - idp_sink_en 1: enable idp_sink for battery charge for usb3otg0"]
    #[inline(always)]
    pub fn idp_sink_en(&self) -> IdpSinkEnR {
        IdpSinkEnR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - idm_sink_en 1: enable idm_sink for battery charge for usb3otg0"]
    #[inline(always)]
    pub fn idm_sink_en(&self) -> IdmSinkEnR {
        IdmSinkEnR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - idp_src_en 1: enable idp_src for battery charge for usb3otg0"]
    #[inline(always)]
    pub fn idp_src_en(&self) -> IdpSrcEnR {
        IdpSrcEnR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - rdm_pdwn_en 1: enable rdm_pdwn for battery charge for usb3otg0"]
    #[inline(always)]
    pub fn rdm_pdwn_en(&self) -> RdmPdwnEnR {
        RdmPdwnEnR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - vdp_src_en 1:enable vdp_src for battery charge for usb3otg0"]
    #[inline(always)]
    pub fn vdp_src_en(&self) -> VdpSrcEnR {
        VdpSrcEnR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - vdm_src_en 1: enable vdm_src for battery charge for usb3otg0"]
    #[inline(always)]
