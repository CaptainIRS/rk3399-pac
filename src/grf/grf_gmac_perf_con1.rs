...
#[doc = "Field `GMAC_SW_RD_LATENCY_THR` reader - Axi read channel id for latency AXI_PERFormance test"]
pub type GmacSwRdLatencyThrR = crate::FieldReader<u16>;
#[doc = "Field `GMAC_SW_RD_LATENCY_THR` writer - Axi read channel id for latency AXI_PERFormance test"]
