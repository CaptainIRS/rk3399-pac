#[doc = "Register `GRF_SOC_CON24` reader"]
pub type R = crate::R<GrfSocCon24Spec>;
#[doc = "Register `GRF_SOC_CON24` writer"]
pub type W = crate::W<GrfSocCon24Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dphy_tx1tx1_turnrequest(&mut self) -> DphyTx1tx1TurnrequestW<GrfSocCon24Spec> {
        DphyTx1tx1TurnrequestW::new(self, 0)
    }
    #[doc = "Bit 4 - dphy_rx1_src_sel bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx1_src_sel(&mut self) -> DphyRx1SrcSelW<GrfSocCon24Spec> {
        DphyRx1SrcSelW::new(self, 4)
    }
    #[doc = "Bit 5 - dphy_tx1rx1_basedir bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_tx1rx1_basedir(&mut self) -> DphyTx1rx1BasedirW<GrfSocCon24Spec> {
        DphyTx1rx1BasedirW::new(self, 5)
    }
    #[doc = "Bit 6 - dphy_tx1rx1_enableclk bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_tx1rx1_enableclk(&mut self) -> DphyTx1rx1EnableclkW<GrfSocCon24Spec> {
        DphyTx1rx1EnableclkW::new(self, 6)
    }
    #[doc = "Bit 7 - dphy_tx1rx1_masterslavez bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_tx1rx1_masterslavez(&mut self) -> DphyTx1rx1MasterslavezW<GrfSocCon24Spec> {
        DphyTx1rx1MasterslavezW::new(self, 7)
    }
    #[doc = "Bits 8:9 - vopb_dsi_halt_sel bit control"]
    #[inline(always)]
    #[must_use]
    pub fn vopb_dsi_halt_sel(&mut self) -> VopbDsiHaltSelW<GrfSocCon24Spec> {
        VopbDsiHaltSelW::new(self, 8)
    }
    #[doc = "Bits 10:11 - vopl_dsi_halt_sel bit control"]
    #[inline(always)]
    #[must_use]
    pub fn vopl_dsi_halt_sel(&mut self) -> VoplDsiHaltSelW<GrfSocCon24Spec> {
        VoplDsiHaltSelW::new(self, 10)
    }
    #[doc = "Bits 12:13 - vopb_dsi_ite_sel bit control"]
    #[inline(always)]
    #[must_use]
    pub fn vopb_dsi_ite_sel(&mut self) -> VopbDsiIteSelW<GrfSocCon24Spec> {
...
#[doc = "SoC control register 24\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_soc_con24::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_soc_con24::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfSocCon24Spec;
impl crate::RegisterSpec for GrfSocCon24Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_soc_con24::R`](R) reader structure"]
impl crate::Readable for GrfSocCon24Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_soc_con24::W`](W) writer structure"]
impl crate::Writable for GrfSocCon24Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_SOC_CON24 to value 0x39f0"]
impl crate::Resettable for GrfSocCon24Spec {
