#[doc = "Register `SOC_CON4` reader"]
pub type R = crate::R<SocCon4Spec>;
#[doc = "Register `SOC_CON4` writer"]
pub type W = crate::W<SocCon4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn acchannelens0_cci500(&mut self) -> Acchannelens0Cci500W<SocCon4Spec> {
        Acchannelens0Cci500W::new(self, 0)
    }
    #[doc = "Bits 2:3 - CCI ACCHANNELEN input control.\n\nSlave interface supports DVM messages.\n\nThis is overridden to 0x0 if you set the Control\n\nOverride Register\\[1\\]."]
    #[inline(always)]
    #[must_use]
    pub fn acchannelens1_cci500(&mut self) -> Acchannelens1Cci500W<SocCon4Spec> {
        Acchannelens1Cci500W::new(self, 2)
    }
    #[doc = "Bits 4:5 - cci port ORDERED_WRITE_OBSERVATION\n\ncontrol"]
    #[inline(always)]
    #[must_use]
    pub fn cci_ordered_wr_obsv(&mut self) -> CciOrderedWrObsvW<SocCon4Spec> {
        CciOrderedWrObsvW::new(self, 4)
    }
    #[doc = "Bits 6:7 - cci port QOSOVERRIDE bit control"]
    #[inline(always)]
    #[must_use]
    pub fn cci_qosoverride(&mut self) -> CciQosoverrideW<SocCon4Spec> {
        CciQosoverrideW::new(self, 6)
    }
    #[doc = "Bit 8 - cci force wakeup control"]
    #[inline(always)]
    #[must_use]
    pub fn cci_force_wakeup(&mut self) -> CciForceWakeupW<SocCon4Spec> {
        CciForceWakeupW::new(self, 8)
    }
    #[doc = "Bits 9:11 - select ddr debug port"]
    #[inline(always)]
    #[must_use]
    pub fn ddr_debug_sel(&mut self) -> DdrDebugSelW<SocCon4Spec> {
    ...
    pub fn perilp_fwd_gic_pwrdisctargpwrstall(
        &mut self,
    ) -> PerilpFwdGicPwrdisctargpwrstallW<SocCon4Spec> {
    ...
    pub fn perilp_fwd_sdioaudio_pwrdisctargpwrstall(
        &mut self,
    ) -> PerilpFwdSdioaudioPwrdisctargpwrstallW<SocCon4Spec> {
    ...
    pub fn perilp_fwd_centerslv_pwrdisctargpwrstall(
        &mut self,
    ) -> PerilpFwdCenterslvPwrdisctargpwrstallW<SocCon4Spec> {
        PerilpFwdCenterslvPwrdisctargpwrstallW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SocCon4Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_con4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_con4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocCon4Spec;
impl crate::RegisterSpec for SocCon4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_con4::R`](R) reader structure"]
impl crate::Readable for SocCon4Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_con4::W`](W) writer structure"]
impl crate::Writable for SocCon4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_CON4 to value 0x010f"]
impl crate::Resettable for SocCon4Spec {
