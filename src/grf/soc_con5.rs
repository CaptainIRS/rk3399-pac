#[doc = "Register `SOC_CON5` reader"]
pub type R = crate::R<SocCon5Spec>;
#[doc = "Register `SOC_CON5` writer"]
pub type W = crate::W<SocCon5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rmii_clk_sel(&mut self) -> RmiiClkSelW<SocCon5Spec> {
        RmiiClkSelW::new(self, 3)
    }
    #[doc = "Bits 4:5 - RGMII clock selection"]
    #[inline(always)]
    #[must_use]
    pub fn gmac_clk_sel(&mut self) -> GmacClkSelW<SocCon5Spec> {
        GmacClkSelW::new(self, 4)
    }
    #[doc = "Bit 6 - RMII mode selection"]
    #[inline(always)]
    #[must_use]
    pub fn rmii_mode(&mut self) -> RmiiModeW<SocCon5Spec> {
        RmiiModeW::new(self, 6)
    }
    #[doc = "Bit 7 - MAC speed"]
    #[inline(always)]
    #[must_use]
    pub fn gmac_speed(&mut self) -> GmacSpeedW<SocCon5Spec> {
        GmacSpeedW::new(self, 7)
    }
    #[doc = "Bit 8 - GMAC transmit flow control\n\nWhen set high, instructs the GMAC to transmit\n\nPAUSE Control frames in\n\nFull-duplex mode. In Half-duplex mode, the\n\nGMAC enables the Back-pressure\n\nfunction until this signal is made low again"]
    #[inline(always)]
    #[must_use]
    pub fn gmac_flowctrl(&mut self) -> GmacFlowctrlW<SocCon5Spec> {
        GmacFlowctrlW::new(self, 8)
    }
    #[doc = "Bits 9:11 - PHY interface select"]
    #[inline(always)]
    #[must_use]
    pub fn gmac_phy_intf_sel(&mut self) -> GmacPhyIntfSelW<SocCon5Spec> {
        GmacPhyIntfSelW::new(self, 9)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SocCon5Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_con5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_con5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocCon5Spec;
impl crate::RegisterSpec for SocCon5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_con5::R`](R) reader structure"]
impl crate::Readable for SocCon5Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_con5::W`](W) writer structure"]
impl crate::Writable for SocCon5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_CON5 to value 0x08"]
impl crate::Resettable for SocCon5Spec {
