#[doc = "Register `GRF_CPU_STATUS1` reader"]
pub type R = crate::R<GrfCpuStatus1Spec>;
#[doc = "Register `GRF_CPU_STATUS1` writer"]
pub type W = crate::W<GrfCpuStatus1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn standbywfi_pd_core_l(&mut self) -> StandbywfiPdCoreLW<GrfCpuStatus1Spec> {
        StandbywfiPdCoreLW::new(self, 0)
    }
    #[doc = "Bits 4:7 - standbywfe of pd_core_l status bit"]
    #[inline(always)]
    #[must_use]
    pub fn standbywfe_pd_core_l(&mut self) -> StandbywfePdCoreLW<GrfCpuStatus1Spec> {
        StandbywfePdCoreLW::new(self, 4)
    }
    #[doc = "Bits 8:9 - standbywfi of pd_core_b status bit"]
    #[inline(always)]
    #[must_use]
    pub fn standbywfi_pd_core_b(&mut self) -> StandbywfiPdCoreBW<GrfCpuStatus1Spec> {
        StandbywfiPdCoreBW::new(self, 8)
    }
    #[doc = "Bits 12:13 - standbywfe of pd_core_b status bit"]
    #[inline(always)]
    #[must_use]
    pub fn standbywfe_pd_core_b(&mut self) -> StandbywfePdCoreBW<GrfCpuStatus1Spec> {
        StandbywfePdCoreBW::new(self, 12)
    }
    #[doc = "Bits 16:19 - status of smpen_pd_core_l"]
    #[inline(always)]
    #[must_use]
    pub fn smpen_pd_core_l(&mut self) -> SmpenPdCoreLW<GrfCpuStatus1Spec> {
        SmpenPdCoreLW::new(self, 16)
    }
    #[doc = "Bits 20:21 - status of smpen_pd_core_b"]
    #[inline(always)]
    #[must_use]
    pub fn smpen_pd_core_b(&mut self) -> SmpenPdCoreBW<GrfCpuStatus1Spec> {
        SmpenPdCoreBW::new(self, 20)
    }
    #[doc = "Bit 24 - standbywfil2 of pd_core_l status bit"]
    #[inline(always)]
    #[must_use]
    pub fn standbywfil2_pd_core_l(&mut self) -> Standbywfil2PdCoreLW<GrfCpuStatus1Spec> {
        Standbywfil2PdCoreLW::new(self, 24)
    }
    #[doc = "Bit 25 - standbywfil2 of pd_core_b status bit"]
    #[inline(always)]
    #[must_use]
    pub fn standbywfil2_pd_core_b(&mut self) -> Standbywfil2PdCoreBW<GrfCpuStatus1Spec> {
        Standbywfil2PdCoreBW::new(self, 25)
    }
    #[doc = "Bit 26 - the status of clremonack_pd_core_l"]
    #[inline(always)]
    #[must_use]
    pub fn clremonack_pd_core_l(&mut self) -> ClremonackPdCoreLW<GrfCpuStatus1Spec> {
        ClremonackPdCoreLW::new(self, 26)
    }
    #[doc = "Bit 27 - the status of clremonack_pd_core_b"]
    #[inline(always)]
    #[must_use]
    pub fn clremonack_pd_core_b(&mut self) -> ClremonackPdCoreBW<GrfCpuStatus1Spec> {
        ClremonackPdCoreBW::new(self, 27)
    }
}
#[doc = "cpu status register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_cpu_status1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_cpu_status1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfCpuStatus1Spec;
impl crate::RegisterSpec for GrfCpuStatus1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_cpu_status1::R`](R) reader structure"]
impl crate::Readable for GrfCpuStatus1Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_cpu_status1::W`](W) writer structure"]
impl crate::Writable for GrfCpuStatus1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_CPU_STATUS1 to value 0"]
impl crate::Resettable for GrfCpuStatus1Spec {
