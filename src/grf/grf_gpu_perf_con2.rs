...
#[doc = "Field `GPU_SW_AR_COUNT_ID` reader - When sw_ar_cnt_id_type=1, only count the id designated by sw_ar_count_id"]
pub type GpuSwArCountIdR = crate::FieldReader;
#[doc = "Field `GPU_SW_AR_COUNT_ID` writer - When sw_ar_cnt_id_type=1, only count the id designated by sw_ar_count_id"]
pub type GpuSwArCountIdW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `GPU_SW_AW_COUNT_ID` reader - When sw_aw_cnt_id_type=1, only count the id designated by sw_aw_count_id"]
pub type GpuSwAwCountIdR = crate::FieldReader;
#[doc = "Field `GPU_SW_AW_COUNT_ID` writer - When sw_aw_cnt_id_type=1, only count the id designated by sw_aw_count_id"]
