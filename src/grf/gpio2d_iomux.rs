#[doc = "Register `GPIO2D_IOMUX` reader"]
pub type R = crate::R<Gpio2dIomuxSpec>;
#[doc = "Register `GPIO2D_IOMUX` writer"]
pub type W = crate::W<Gpio2dIomuxSpec>;
#[doc = "GPIO2D\\[0\\]
iomux select\n\nValue on reset: 0"]
...
impl Gpio2d0SelR {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2d0Sel> {
        match self.bits {
            0 => Some(Gpio2d0Sel::B00),
            1 => Some(Gpio2d0Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2d0SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2d0Sel>;
...
impl Gpio2d1SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2d1Sel> {
        match self.bits {
            0 => Some(Gpio2d1Sel::B00),
            1 => Some(Gpio2d1Sel::B01),
            2 => Some(Gpio2d1Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2d1SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2d1Sel>;
...
impl Gpio2d2SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2d2Sel> {
        match self.bits {
            0 => Some(Gpio2d2Sel::B00),
            1 => Some(Gpio2d2Sel::B01),
            2 => Some(Gpio2d2Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2d2SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2d2Sel>;
...
impl Gpio2d3SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2d3Sel> {
        match self.bits {
            0 => Some(Gpio2d3Sel::B00),
            1 => Some(Gpio2d3Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2d3SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2d3Sel>;
...
impl Gpio2d4SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2d4Sel> {
        match self.bits {
            0 => Some(Gpio2d4Sel::B00),
            1 => Some(Gpio2d4Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2d4SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2d4Sel>;
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2d0_sel(&mut self) -> Gpio2d0SelW<Gpio2dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2d1_sel(&mut self) -> Gpio2d1SelW<Gpio2dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2d2_sel(&mut self) -> Gpio2d2SelW<Gpio2dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2d3_sel(&mut self) -> Gpio2d3SelW<Gpio2dIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2d4_sel(&mut self) -> Gpio2d4SelW<Gpio2dIomuxSpec> {
        Gpio2d4SelW::new(self, 8)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio2dIomuxSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO2D iomux control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio2d_iomux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio2d_iomux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio2dIomuxSpec;
impl crate::RegisterSpec for Gpio2dIomuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio2d_iomux::R`](R) reader structure"]
impl crate::Readable for Gpio2dIomuxSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio2d_iomux::W`](W) writer structure"]
impl crate::Writable for Gpio2dIomuxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO2D_IOMUX to value 0"]
impl crate::Resettable for Gpio2dIomuxSpec {
