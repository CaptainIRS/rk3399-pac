#[doc = "Register `IO_VSEL` reader"]
pub type R = crate::R<IoVselSpec>;
#[doc = "Register `IO_VSEL` writer"]
pub type W = crate::W<IoVselSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bt656_gpio2ab_ms(&mut self) -> Bt656Gpio2abMsW<IoVselSpec> {
        Bt656Gpio2abMsW::new(self, 0)
    }
    #[doc = "Bit 1 - audio_gpio3d4a_ms"]
    #[inline(always)]
    #[must_use]
    pub fn audio_gpio3d4a_ms(&mut self) -> AudioGpio3d4aMsW<IoVselSpec> {
        AudioGpio3d4aMsW::new(self, 1)
    }
    #[doc = "Bit 2 - sdmmc_gpio4b_ms"]
    #[inline(always)]
    #[must_use]
    pub fn sdmmc_gpio4b_ms(&mut self) -> SdmmcGpio4bMsW<IoVselSpec> {
        SdmmcGpio4bMsW::new(self, 2)
    }
    #[doc = "Bit 3 - gpio1833_gpio4cd_ms"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1833_gpio4cd_ms(&mut self) -> Gpio1833Gpio4cdMsW<IoVselSpec> {
        Gpio1833Gpio4cdMsW::new(self, 3)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<IoVselSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`io_vsel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`io_vsel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IoVselSpec;
impl crate::RegisterSpec for IoVselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`io_vsel::R`](R) reader structure"]
impl crate::Readable for IoVselSpec {}
#[doc = "`write(|w| ..)` method takes [`io_vsel::W`](W) writer structure"]
impl crate::Writable for IoVselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IO_VSEL to value 0"]
impl crate::Resettable for IoVselSpec {
