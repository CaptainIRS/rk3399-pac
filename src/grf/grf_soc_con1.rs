#[doc = "Register `GRF_SOC_CON1` reader"]
pub type R = crate::R<GrfSocCon1Spec>;
#[doc = "Register `GRF_SOC_CON1` writer"]
pub type W = crate::W<GrfSocCon1Spec>;
...
#[doc = "noc_hdcp_req_msch01_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `HDCP_REQ_MSCH01_PWRDISCTARGPWRSTALL` reader - noc_hdcp_req_msch01_rsp_err_stall bit control"]
...
#[doc = "Field `HDCP_REQ_MSCH01_PWRDISCTARGPWRSTALL` writer - noc_hdcp_req_msch01_rsp_err_stall bit control"]
...
#[doc = "noc_isp0_req_msch01_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `ISP0_REQ_MSCH01_PWRDISCTARGPWRSTALL` reader - noc_isp0_req_msch01_rsp_err_stall bit control"]
...
#[doc = "Field `ISP0_REQ_MSCH01_PWRDISCTARGPWRSTALL` writer - noc_isp0_req_msch01_rsp_err_stall bit control"]
...
#[doc = "noc_isp1_req_msch01_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `ISP1_REQ_MSCH01_PWRDISCTARGPWRSTALL` reader - noc_isp1_req_msch01_rsp_err_stall bit control"]
...
#[doc = "Field `ISP1_REQ_MSCH01_PWRDISCTARGPWRSTALL` writer - noc_isp1_req_msch01_rsp_err_stall bit control"]
...
#[doc = "all noc_msch0regsrv_fwd_msch0_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `MSCH0REGSRV_FWD_MSCH0_PWRDISCTARGPWRST` reader - all noc_msch0regsrv_fwd_msch0_rsp_err_stall bit control"]
...
#[doc = "Field `MSCH0REGSRV_FWD_MSCH0_PWRDISCTARGPWRST` writer - all noc_msch0regsrv_fwd_msch0_rsp_err_stall bit control"]
...
#[doc = "all noc_msch1regsrv_fwd_msch1_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `MSCH1REGSRV_FWD_MSCH1_PWRDISCTARGPWRST` reader - all noc_msch1regsrv_fwd_msch1_rsp_err_stall bit control"]
...
#[doc = "Field `MSCH1REGSRV_FWD_MSCH1_PWRDISCTARGPWRST` writer - all noc_msch1regsrv_fwd_msch1_rsp_err_stall bit control"]
...
#[doc = "noc_perihp_fwd_center_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `PERIHP_FWD_CENTER_PWRDISCTARGPWRSTALL` reader - noc_perihp_fwd_center_rsp_err_stall bit control"]
...
#[doc = "Field `PERIHP_FWD_CENTER_PWRDISCTARGPWRSTALL` writer - noc_perihp_fwd_center_rsp_err_stall bit control"]
...
#[doc = "noc_perihp_req_msch0_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `PERIHP_REQ_MSCH0_PWRDISCTARGPWRSTALL` reader - noc_perihp_req_msch0_rsp_err_stall bit control"]
...
#[doc = "Field `PERIHP_REQ_MSCH0_PWRDISCTARGPWRSTALL` writer - noc_perihp_req_msch0_rsp_err_stall bit control"]
...
#[doc = "noc_perihp_req_msch1_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `PERIHP_REQ_MSCH1_PWRDISCTARGPWRSTALL` reader - noc_perihp_req_msch1_rsp_err_stall bit control"]
...
#[doc = "Field `PERIHP_REQ_MSCH1_PWRDISCTARGPWRSTALL` writer - noc_perihp_req_msch1_rsp_err_stall bit control"]
...
#[doc = "l noc_perihp_cm0_fwd_perihp_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `PERIHP_CM0_FWD_PERIHP_PWRDISCTARGPWRSTAL` reader - l noc_perihp_cm0_fwd_perihp_rsp_err_stall bit control"]
...
#[doc = "Field `PERIHP_CM0_FWD_PERIHP_PWRDISCTARGPWRSTAL` writer - l noc_perihp_cm0_fwd_perihp_rsp_err_stall bit control"]
...
#[doc = "noc_perihp_fwd_alive_rsp_err_stall bit control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `PERIHP_FWD_ALIVE_PWRDISCTARGPWRSTALL` reader - noc_perihp_fwd_alive_rsp_err_stall bit control"]
...
#[doc = "Field `PERIHP_FWD_ALIVE_PWRDISCTARGPWRSTALL` writer - noc_perihp_fwd_alive_rsp_err_stall bit control"]
...
impl R {
    ...
    #[doc = "Bit 2 - noc_hdcp_req_msch01_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - noc_isp0_req_msch01_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - noc_isp1_req_msch01_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - all noc_msch0regsrv_fwd_msch0_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - all noc_msch1regsrv_fwd_msch1_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - noc_perihp_fwd_center_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - noc_perihp_req_msch0_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - noc_perihp_req_msch1_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - l noc_perihp_cm0_fwd_perihp_rsp_err_stall bit control"]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - noc_perihp_fwd_alive_rsp_err_stall bit control"]
    #[inline(always)]
...
impl W {
    ...
    pub fn gpu_req_msch0_pwrdisctargpwrstall(
        &mut self,
    ) -> GpuReqMsch0PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn gpu_req_msch1_pwrdisctargpwrstall(
        &mut self,
    ) -> GpuReqMsch1PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn hdcp_req_msch01_pwrdisctargpwrstall(
        &mut self,
    ) -> HdcpReqMsch01PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn iep_req_msch0_pwrdisctargpwrstall(
        &mut self,
    ) -> IepReqMsch0PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn iep_req_msch1_pwrdisctargpwrstall(
        &mut self,
    ) -> IepReqMsch1PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn isp0_req_msch01_pwrdisctargpwrstall(
        &mut self,
    ) -> Isp0ReqMsch01PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn isp1_req_msch01_pwrdisctargpwrstall(
        &mut self,
    ) -> Isp1ReqMsch01PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn msch0regsrv_fwd_msch0_pwrdisctargpwrst(
        &mut self,
    ) -> Msch0regsrvFwdMsch0PwrdisctargpwrstW<GrfSocCon1Spec> {
    ...
    pub fn msch1regsrv_fwd_msch1_pwrdisctargpwrst(
        &mut self,
    ) -> Msch1regsrvFwdMsch1PwrdisctargpwrstW<GrfSocCon1Spec> {
    ...
    pub fn pcie_fwd_perihp_pwrdisctargpwrstall(
        &mut self,
    ) -> PcieFwdPerihpPwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn perihp_fwd_center_pwrdisctargpwrstall(
        &mut self,
    ) -> PerihpFwdCenterPwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn perihp_req_msch0_pwrdisctargpwrstall(
        &mut self,
    ) -> PerihpReqMsch0PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn perihp_req_msch1_pwrdisctargpwrstall(
        &mut self,
    ) -> PerihpReqMsch1PwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn perihp_cm0_fwd_perihp_pwrdisctargpwrstal(
        &mut self,
    ) -> PerihpCm0FwdPerihpPwrdisctargpwrstalW<GrfSocCon1Spec> {
    ...
    pub fn perihp_fwd_alive_pwrdisctargpwrstall(
        &mut self,
    ) -> PerihpFwdAlivePwrdisctargpwrstallW<GrfSocCon1Spec> {
    ...
    pub fn perihp_fwd_cci_pwrdisctargpwrstall(
        &mut self,
    ) -> PerihpFwdCciPwrdisctargpwrstallW<GrfSocCon1Spec> {
        PerihpFwdCciPwrdisctargpwrstallW::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfSocCon1Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_soc_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_soc_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfSocCon1Spec;
impl crate::RegisterSpec for GrfSocCon1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_soc_con1::R`](R) reader structure"]
impl crate::Readable for GrfSocCon1Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_soc_con1::W`](W) writer structure"]
impl crate::Writable for GrfSocCon1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_SOC_CON1 to value 0"]
impl crate::Resettable for GrfSocCon1Spec {
