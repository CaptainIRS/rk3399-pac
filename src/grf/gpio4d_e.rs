#[doc = "Register `GPIO4D_E` reader"]
pub type R = crate::R<Gpio4dESpec>;
#[doc = "Register `GPIO4D_E` writer"]
pub type W = crate::W<Gpio4dESpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio4d0_e(&mut self) -> Gpio4d0EW<Gpio4dESpec> {
        Gpio4d0EW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO4D1 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d1_e(&mut self) -> Gpio4d1EW<Gpio4dESpec> {
        Gpio4d1EW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO4D2 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d2_e(&mut self) -> Gpio4d2EW<Gpio4dESpec> {
        Gpio4d2EW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO4D3 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d3_e(&mut self) -> Gpio4d3EW<Gpio4dESpec> {
        Gpio4d3EW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO4D4 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d4_e(&mut self) -> Gpio4d4EW<Gpio4dESpec> {
        Gpio4d4EW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO4D5 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d5_e(&mut self) -> Gpio4d5EW<Gpio4dESpec> {
        Gpio4d5EW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO4D6 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d6_e(&mut self) -> Gpio4d6EW<Gpio4dESpec> {
        Gpio4d6EW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO4D7 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4d7_e(&mut self) -> Gpio4d7EW<Gpio4dESpec> {
        Gpio4d7EW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio4dESpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO4D drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio4d_e::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio4d_e::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio4dESpec;
impl crate::RegisterSpec for Gpio4dESpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio4d_e::R`](R) reader structure"]
impl crate::Readable for Gpio4dESpec {}
#[doc = "`write(|w| ..)` method takes [`gpio4d_e::W`](W) writer structure"]
impl crate::Writable for Gpio4dESpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO4D_E to value 0"]
impl crate::Resettable for Gpio4dESpec {
