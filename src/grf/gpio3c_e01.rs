#[doc = "Register `GPIO3C_E01` reader"]
pub type R = crate::R<Gpio3cE01Spec>;
#[doc = "Register `GPIO3C_E01` writer"]
pub type W = crate::W<Gpio3cE01Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio3c0_e(&mut self) -> Gpio3c0EW<Gpio3cE01Spec> {
        Gpio3c0EW::new(self, 0)
    }
    #[doc = "Bits 3:5 - GPIO3C1 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3c1_e(&mut self) -> Gpio3c1EW<Gpio3cE01Spec> {
        Gpio3c1EW::new(self, 3)
    }
    #[doc = "Bits 6:8 - GPIO3C2 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3c2_e(&mut self) -> Gpio3c2EW<Gpio3cE01Spec> {
        Gpio3c2EW::new(self, 6)
    }
    #[doc = "Bits 9:11 - GPIO3C3 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3c3_e(&mut self) -> Gpio3c3EW<Gpio3cE01Spec> {
        Gpio3c3EW::new(self, 9)
    }
    #[doc = "Bits 12:14 - GPIO3C4 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3c4_e(&mut self) -> Gpio3c4EW<Gpio3cE01Spec> {
        Gpio3c4EW::new(self, 12)
    }
    #[doc = "Bit 15 - GPIO3C5 drive strength control bit0"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3c5_e0(&mut self) -> Gpio3c5E0W<Gpio3cE01Spec> {
        Gpio3c5E0W::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio3cE01Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3C drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio3c_e01::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio3c_e01::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio3cE01Spec;
impl crate::RegisterSpec for Gpio3cE01Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio3c_e01::R`](R) reader structure"]
impl crate::Readable for Gpio3cE01Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio3c_e01::W`](W) writer structure"]
impl crate::Writable for Gpio3cE01Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO3C_E01 to value 0"]
impl crate::Resettable for Gpio3cE01Spec {
