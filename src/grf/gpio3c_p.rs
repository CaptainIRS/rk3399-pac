#[doc = "Register `GPIO3C_P` reader"]
pub type R = crate::R<Gpio3cPSpec>;
#[doc = "Register `GPIO3C_P` writer"]
pub type W = crate::W<Gpio3cPSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio3c0_p(&mut self) -> Gpio3c0PW<Gpio3cPSpec> {
        Gpio3c0PW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO3A PU/PD programmation section, every\n\nGPIO bit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3c1_p(&mut self) -> Gpio3c1PW<Gpio3cPSpec> {
        Gpio3c1PW::new(self, 2)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio3cPSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3C PU/PD control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio3c_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio3c_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio3cPSpec;
impl crate::RegisterSpec for Gpio3cPSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio3c_p::R`](R) reader structure"]
impl crate::Readable for Gpio3cPSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio3c_p::W`](W) writer structure"]
impl crate::Writable for Gpio3cPSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO3C_P to value 0x05"]
impl crate::Resettable for Gpio3cPSpec {
