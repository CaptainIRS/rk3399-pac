...
#[doc = "GPIO4D0 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
...
#[doc = "Field `GPIO4D0_E` reader - GPIO4D0 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO4D0_E` writer - GPIO4D0 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO4D1 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio4d1E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO4D1_E` reader - GPIO4D1 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO4D1_E` writer - GPIO4D1 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO4D2 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio4d2E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO4D2_E` reader - GPIO4D2 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO4D2_E` writer - GPIO4D2 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO4D3 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio4d3E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO4D3_E` reader - GPIO4D3 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO4D3_E` writer - GPIO4D3 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO4D4 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio4d4E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO4D4_E` reader - GPIO4D4 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO4D4_E` writer - GPIO4D4 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO4D5 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio4d5E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO4D5_E` reader - GPIO4D5 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO4D5_E` writer - GPIO4D5 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO4D6 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio4d6E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO4D6_E` reader - GPIO4D6 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO4D6_E` writer - GPIO4D6 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO4D7 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio4d7E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO4D7_E` reader - GPIO4D7 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO4D7_E` writer - GPIO4D7 drive strength control, every GPIO bit corresponding to 2bits"]
...
impl R {
    #[doc = "Bits 0:1 - GPIO4D0 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio4d0_e(&self) -> Gpio4d0ER {
        Gpio4d0ER::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 2:3 - GPIO4D1 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio4d1_e(&self) -> Gpio4d1ER {
        Gpio4d1ER::new(((self.bits >> 2) & 3) as u8)
    }
    #[doc = "Bits 4:5 - GPIO4D2 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio4d2_e(&self) -> Gpio4d2ER {
        Gpio4d2ER::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 6:7 - GPIO4D3 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio4d3_e(&self) -> Gpio4d3ER {
        Gpio4d3ER::new(((self.bits >> 6) & 3) as u8)
    }
    #[doc = "Bits 8:9 - GPIO4D4 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio4d4_e(&self) -> Gpio4d4ER {
        Gpio4d4ER::new(((self.bits >> 8) & 3) as u8)
    }
    #[doc = "Bits 10:11 - GPIO4D5 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio4d5_e(&self) -> Gpio4d5ER {
        Gpio4d5ER::new(((self.bits >> 10) & 3) as u8)
    }
    #[doc = "Bits 12:13 - GPIO4D6 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio4d6_e(&self) -> Gpio4d6ER {
        Gpio4d6ER::new(((self.bits >> 12) & 3) as u8)
    }
    #[doc = "Bits 14:15 - GPIO4D7 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
