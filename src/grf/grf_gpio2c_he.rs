...
#[doc = "GPIO2C gpio keep privous state control, every GPIO bit corresponding to 1bit\n\nValue on reset: 0"]
...
#[doc = "Field `GPIO2C_HE` reader - GPIO2C gpio keep privous state control, every GPIO bit corresponding to 1bit"]
...
#[doc = "Field `GPIO2C_HE` writer - GPIO2C gpio keep privous state control, every GPIO bit corresponding to 1bit"]
...
impl R {
    #[doc = "Bits 0:7 - GPIO2C gpio keep privous state control, every GPIO bit corresponding to 1bit"]
    #[inline(always)]
