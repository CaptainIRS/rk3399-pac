#[doc = "Register `GPIO2A_E` reader"]
pub type R = crate::R<Gpio2aESpec>;
#[doc = "Register `GPIO2A_E` writer"]
pub type W = crate::W<Gpio2aESpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio2a0_e(&mut self) -> Gpio2a0EW<Gpio2aESpec> {
        Gpio2a0EW::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIO2A1 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a1_e(&mut self) -> Gpio2a1EW<Gpio2aESpec> {
        Gpio2a1EW::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIO2A2 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a2_e(&mut self) -> Gpio2a2EW<Gpio2aESpec> {
        Gpio2a2EW::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIO2A3 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a3_e(&mut self) -> Gpio2a3EW<Gpio2aESpec> {
        Gpio2a3EW::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIO2A4 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a4_e(&mut self) -> Gpio2a4EW<Gpio2aESpec> {
        Gpio2a4EW::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIO2A5 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a5_e(&mut self) -> Gpio2a5EW<Gpio2aESpec> {
        Gpio2a5EW::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIO2A6 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a6_e(&mut self) -> Gpio2a6EW<Gpio2aESpec> {
        Gpio2a6EW::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIO2A7 drive strength control, every GPIO\n\nbit corresponding to 2bits"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2a7_e(&mut self) -> Gpio2a7EW<Gpio2aESpec> {
        Gpio2a7EW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio2aESpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO2A drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio2a_e::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio2a_e::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio2aESpec;
impl crate::RegisterSpec for Gpio2aESpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio2a_e::R`](R) reader structure"]
impl crate::Readable for Gpio2aESpec {}
#[doc = "`write(|w| ..)` method takes [`gpio2a_e::W`](W) writer structure"]
impl crate::Writable for Gpio2aESpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO2A_E to value 0"]
impl crate::Resettable for Gpio2aESpec {
