...
#[doc = "Field `GPIO4D_SMT` reader - GPIO schmitt trigger control, every GPIO bit corresponding to 1bits ."]
...
#[doc = "Field `GPIO4D_SMT` writer - GPIO schmitt trigger control, every GPIO bit corresponding to 1bits ."]
...
impl R {
    #[doc = "Bits 0:6 - GPIO schmitt trigger control, every GPIO bit corresponding to 1bits ."]
    #[inline(always)]
