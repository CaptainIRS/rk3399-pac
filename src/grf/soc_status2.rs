#[doc = "Register `SOC_STATUS2` reader"]
pub type R = crate::R<SocStatus2Spec>;
#[doc = "Register `SOC_STATUS2` writer"]
pub type W = crate::W<SocStatus2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0_perilp_wakeup(&mut self) -> M0PerilpWakeupW<SocStatus2Spec> {
        M0PerilpWakeupW::new(self, 0)
    }
    #[doc = "Bit 1 - status bit of m0_perilp_sleeping"]
    #[inline(always)]
    #[must_use]
    pub fn m0_perilp_sleeping(&mut self) -> M0PerilpSleepingW<SocStatus2Spec> {
        M0PerilpSleepingW::new(self, 1)
    }
    #[doc = "Bit 2 - status bit of m0_perilp_sleeping"]
    #[inline(always)]
    #[must_use]
    pub fn m0_perilp_sleepdeep(&mut self) -> M0PerilpSleepdeepW<SocStatus2Spec> {
        M0PerilpSleepdeepW::new(self, 2)
    }
    #[doc = "Bit 3 - status bit of m0_perilp_core_lockup"]
    #[inline(always)]
    #[must_use]
    pub fn m0_perilp_core_lockup(&mut self) -> M0PerilpCoreLockupW<SocStatus2Spec> {
        M0PerilpCoreLockupW::new(self, 3)
    }
    #[doc = "Bit 4 - status bit of m0_perilp_halted"]
    #[inline(always)]
    #[must_use]
    pub fn m0_perilp_halted(&mut self) -> M0PerilpHaltedW<SocStatus2Spec> {
        M0PerilpHaltedW::new(self, 4)
    }
    #[doc = "Bit 5 - status bit of m0_perilp_dbgrestarted"]
    #[inline(always)]
    #[must_use]
    pub fn m0_perilp_dbgrestarted(&mut self) -> M0PerilpDbgrestartedW<SocStatus2Spec> {
        M0PerilpDbgrestartedW::new(self, 5)
    }
    #[doc = "Bit 6 - status bit of xev_m0_perilp"]
    #[inline(always)]
    #[must_use]
    pub fn txev_m0_perilp(&mut self) -> TxevM0PerilpW<SocStatus2Spec> {
        TxevM0PerilpW::new(self, 6)
    }
    #[doc = "Bit 7 - status bit of jtagtop_st"]
    #[inline(always)]
    #[must_use]
    pub fn jtagtop_st(&mut self) -> JtagtopStW<SocStatus2Spec> {
        JtagtopStW::new(self, 7)
    }
    #[doc = "Bit 8 - status bit of jtagnsw_st"]
    #[inline(always)]
    #[must_use]
    pub fn jtagnsw_st(&mut self) -> JtagnswStW<SocStatus2Spec> {
        JtagnswStW::new(self, 8)
    }
    #[doc = "Bit 9 - m0_perilp_sysresetreq"]
    #[inline(always)]
    #[must_use]
    pub fn m0_perilp_sysresetreq(&mut self) -> M0PerilpSysresetreqW<SocStatus2Spec> {
        M0PerilpSysresetreqW::new(self, 9)
    }
    #[doc = "Bit 10 - m0_perilp_cdbgpwrupreq status bit"]
    #[inline(always)]
    #[must_use]
    pub fn m0_perilp_cdbgpwrupreq(&mut self) -> M0PerilpCdbgpwrupreqW<SocStatus2Spec> {
        M0PerilpCdbgpwrupreqW::new(self, 10)
    }
}
#[doc = "SOC status register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_status2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_status2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocStatus2Spec;
impl crate::RegisterSpec for SocStatus2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_status2::R`](R) reader structure"]
impl crate::Readable for SocStatus2Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_status2::W`](W) writer structure"]
impl crate::Writable for SocStatus2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_STATUS2 to value 0"]
impl crate::Resettable for SocStatus2Spec {
