#[doc = "Register `DDRC1_CON0` reader"]
pub type R = crate::R<Ddrc1Con0Spec>;
#[doc = "Register `DDRC1_CON0` writer"]
pub type W = crate::W<Ddrc1Con0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ddr1_zq_status_in(&mut self) -> Ddr1ZqStatusInW<Ddrc1Con0Spec> {
        Ddr1ZqStatusInW::new(self, 0)
    }
    #[doc = "Bit 2 - bit control of ddr1_lp4_addr_dup"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_lp4_addr_dup(&mut self) -> Ddr1Lp4AddrDupW<Ddrc1Con0Spec> {
        Ddr1Lp4AddrDupW::new(self, 2)
    }
    #[doc = "Bit 7 - bit control of ddr1_tsel_en_polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_tsel_en_polarity(&mut self) -> Ddr1TselEnPolarityW<Ddrc1Con0Spec> {
        Ddr1TselEnPolarityW::new(self, 7)
    }
    #[doc = "Bit 8 - bit control of ddr1_ie_polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_ie_polarity(&mut self) -> Ddr1IePolarityW<Ddrc1Con0Spec> {
        Ddr1IePolarityW::new(self, 8)
    }
    #[doc = "Bit 9 - bit control of ddr1_io_ctrl_ie_polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_io_ctrl_ie_polarity(&mut self) -> Ddr1IoCtrlIePolarityW<Ddrc1Con0Spec> {
        Ddr1IoCtrlIePolarityW::new(self, 9)
    }
    #[doc = "Bit 10 - bit control of ddr1_io_ctrl_oe_polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_io_ctrl_oe_polarity(&mut self) -> Ddr1IoCtrlOePolarityW<Ddrc1Con0Spec> {
        Ddr1IoCtrlOePolarityW::new(self, 10)
    }
    #[doc = "Bit 11 - bit control of ddr1_dram_clk_enable_polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_dram_clk_enable_polarity(&mut self) -> Ddr1DramClkEnablePolarityW<Ddrc1Con0Spec> {
        Ddr1DramClkEnablePolarityW::new(self, 11)
    }
    #[doc = "Bit 12 - bit control of ddr1_oe_polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_oe_polarity(&mut self) -> Ddr1OePolarityW<Ddrc1Con0Spec> {
        Ddr1OePolarityW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Ddrc1Con0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "ddrc1 control register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddrc1_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddrc1_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ddrc1Con0Spec;
impl crate::RegisterSpec for Ddrc1Con0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddrc1_con0::R`](R) reader structure"]
impl crate::Readable for Ddrc1Con0Spec {}
#[doc = "`write(|w| ..)` method takes [`ddrc1_con0::W`](W) writer structure"]
impl crate::Writable for Ddrc1Con0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDRC1_CON0 to value 0x1f81"]
impl crate::Resettable for Ddrc1Con0Spec {
