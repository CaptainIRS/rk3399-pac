#[doc = "Register `SOC_CON7` reader"]
pub type R = crate::R<SocCon7Spec>;
#[doc = "Register `SOC_CON7` writer"]
pub type W = crate::W<SocCon7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn grf_uart_cts_sel(&mut self) -> GrfUartCtsSelW<SocCon7Spec> {
        GrfUartCtsSelW::new(self, 0)
    }
    #[doc = "Bits 5:9 - uart_rts_sel bit control\n\nUART polarity selection for rts port\n\nEvery bit for one UART."]
    #[inline(always)]
    #[must_use]
    pub fn grf_uart_rts_sel(&mut self) -> GrfUartRtsSelW<SocCon7Spec> {
        GrfUartRtsSelW::new(self, 5)
    }
    #[doc = "Bits 10:11 - grf_uart_dbg_sel"]
    #[inline(always)]
    #[must_use]
    pub fn grf_uart_dbg_sel(&mut self) -> GrfUartDbgSelW<SocCon7Spec> {
        GrfUartDbgSelW::new(self, 10)
    }
    #[doc = "Bit 12 - grf_con_force_jtag"]
    #[inline(always)]
    #[must_use]
    pub fn grf_con_force_jtag(&mut self) -> GrfConForceJtagW<SocCon7Spec> {
        GrfConForceJtagW::new(self, 12)
    }
    #[doc = "Bit 14 - pcie_clkreq_sel port control"]
    #[inline(always)]
    #[must_use]
    pub fn pcie_clkreq_sel(&mut self) -> PcieClkreqSelW<SocCon7Spec> {
        PcieClkreqSelW::new(self, 14)
    }
    #[doc = "Bit 15 - gic_awuser mode select"]
    #[inline(always)]
    #[must_use]
    pub fn gic_awuser_mode(&mut self) -> GicAwuserModeW<SocCon7Spec> {
        GicAwuserModeW::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SocCon7Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_con7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_con7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocCon7Spec;
impl crate::RegisterSpec for SocCon7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_con7::R`](R) reader structure"]
impl crate::Readable for SocCon7Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_con7::W`](W) writer structure"]
impl crate::Writable for SocCon7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_CON7 to value 0x1000"]
impl crate::Resettable for SocCon7Spec {
