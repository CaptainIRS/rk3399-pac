#[doc = "Register `GRF_GPIO3B_IOMUX` reader"]
pub type R = crate::R<GrfGpio3bIomuxSpec>;
#[doc = "Register `GRF_GPIO3B_IOMUX` writer"]
pub type W = crate::W<GrfGpio3bIomuxSpec>;
#[doc = "GPIO3B\\[0\\]
iomux select\n\nValue on reset: 0"]
...
impl Gpio3b0SelR {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Gpio3b0Sel {
        match self.bits {
            0 => Gpio3b0Sel::B00,
            1 => Gpio3b0Sel::B01,
            2 => Gpio3b0Sel::B10,
...
iomux select"]
pub type Gpio3b0SelW<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, Gpio3b0Sel>;
...
impl Gpio3b1SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Gpio3b1Sel {
        match self.bits {
            0 => Gpio3b1Sel::B00,
            1 => Gpio3b1Sel::B01,
            2 => Gpio3b1Sel::B10,
...
iomux select"]
pub type Gpio3b1SelW<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, Gpio3b1Sel>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn b10(self) -> &'a mut crate::W<REG> {
        self.variant(Gpio3b1Sel::B10)
    }
    #[doc = "reserved"]
    #[inline(always)]
    pub fn b11(self) -> &'a mut crate::W<REG> {
        self.variant(Gpio3b1Sel::B11)
    }
}
#[doc = "GPIO3B\\[2\\]
iomux select\n\nValue on reset: 0"]
...
impl Gpio3b2SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Gpio3b2Sel {
        match self.bits {
            0 => Gpio3b2Sel::B00,
            1 => Gpio3b2Sel::B01,
            2 => Gpio3b2Sel::B10,
...
iomux select"]
pub type Gpio3b2SelW<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, Gpio3b2Sel>;
...
impl Gpio3b3SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Gpio3b3Sel {
        match self.bits {
            0 => Gpio3b3Sel::B00,
            1 => Gpio3b3Sel::B01,
            2 => Gpio3b3Sel::B10,
...
iomux select"]
pub type Gpio3b3SelW<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, Gpio3b3Sel>;
...
impl Gpio3b4SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Gpio3b4Sel {
        match self.bits {
            0 => Gpio3b4Sel::B00,
            1 => Gpio3b4Sel::B01,
            2 => Gpio3b4Sel::B10,
...
iomux select"]
pub type Gpio3b4SelW<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, Gpio3b4Sel>;
...
impl Gpio3b5SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Gpio3b5Sel {
        match self.bits {
            0 => Gpio3b5Sel::B00,
            1 => Gpio3b5Sel::B01,
            2 => Gpio3b5Sel::B10,
...
iomux select"]
pub type Gpio3b5SelW<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, Gpio3b5Sel>;
...
impl Gpio3b6SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Gpio3b6Sel {
        match self.bits {
            0 => Gpio3b6Sel::B00,
            1 => Gpio3b6Sel::B01,
            2 => Gpio3b6Sel::B10,
...
iomux select"]
pub type Gpio3b6SelW<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, Gpio3b6Sel>;
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b0_sel(&mut self) -> Gpio3b0SelW<GrfGpio3bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b1_sel(&mut self) -> Gpio3b1SelW<GrfGpio3bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b2_sel(&mut self) -> Gpio3b2SelW<GrfGpio3bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b3_sel(&mut self) -> Gpio3b3SelW<GrfGpio3bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b4_sel(&mut self) -> Gpio3b4SelW<GrfGpio3bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b5_sel(&mut self) -> Gpio3b5SelW<GrfGpio3bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b6_sel(&mut self) -> Gpio3b6SelW<GrfGpio3bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3b7_sel(&mut self) -> Gpio3b7SelW<GrfGpio3bIomuxSpec> {
        Gpio3b7SelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfGpio3bIomuxSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO3B iomux control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_gpio3b_iomux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_gpio3b_iomux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfGpio3bIomuxSpec;
impl crate::RegisterSpec for GrfGpio3bIomuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_gpio3b_iomux::R`](R) reader structure"]
impl crate::Readable for GrfGpio3bIomuxSpec {}
#[doc = "`write(|w| ..)` method takes [`grf_gpio3b_iomux::W`](W) writer structure"]
impl crate::Writable for GrfGpio3bIomuxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_GPIO3B_IOMUX to value 0"]
impl crate::Resettable for GrfGpio3bIomuxSpec {
