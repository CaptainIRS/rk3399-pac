#[doc = "Register `USB3PHY0_CON1` reader"]
pub type R = crate::R<Usb3phy0Con1Spec>;
#[doc = "Register `USB3PHY0_CON1` writer"]
pub type W = crate::W<Usb3phy0Con1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pipe_sel(&mut self) -> PipeSelW<Usb3phy0Con1Spec> {
        PipeSelW::new(self, 0)
    }
    #[doc = "Bit 1 - rx termination\n\npipe_sel=1, select this bit to TypeC PHY"]
    #[inline(always)]
    #[must_use]
    pub fn rxtermination(&mut self) -> RxterminationW<Usb3phy0Con1Spec> {
        RxterminationW::new(self, 1)
    }
    #[doc = "Bit 2 - txelecidle\n\npipe_sel=1, select this bit to TypeC PHY"]
    #[inline(always)]
    #[must_use]
    pub fn txelecidle(&mut self) -> TxelecidleW<Usb3phy0Con1Spec> {
        TxelecidleW::new(self, 2)
    }
    #[doc = "Bits 3:4 - powerdown\n\npipe_sel: select this two bit to TypeC PHY"]
    #[inline(always)]
    #[must_use]
    pub fn powerdown(&mut self) -> PowerdownW<Usb3phy0Con1Spec> {
        PowerdownW::new(self, 3)
    }
    #[doc = "Bit 5 - txdetectrxloopbk\n\npipe_sel=1, select this bit to TypeC PHY"]
    #[inline(always)]
    #[must_use]
    pub fn txdetectrxloopbk(&mut self) -> TxdetectrxloopbkW<Usb3phy0Con1Spec> {
        TxdetectrxloopbkW::new(self, 5)
    }
    #[doc = "Bit 8 - OCDHaltOnReset\n\nTCPC extensa core JTAG OCDHaltOnReset"]
    #[inline(always)]
    #[must_use]
    pub fn ocdhaltonreset(&mut self) -> OcdhaltonresetW<Usb3phy0Con1Spec> {
        OcdhaltonresetW::new(self, 8)
    }
    #[doc = "Bit 9 - BRreset\n\nTCPC extensa core JTAG BRreset"]
    #[inline(always)]
    #[must_use]
    pub fn brreset(&mut self) -> BrresetW<Usb3phy0Con1Spec> {
        BrresetW::new(self, 9)
    }
    #[doc = "Bit 10 - DReset\n\nTCPC extensa core JTAG DReset"]
    #[inline(always)]
    #[must_use]
    pub fn dreset(&mut self) -> DresetW<Usb3phy0Con1Spec> {
        DresetW::new(self, 10)
    }
    #[doc = "Bit 11 - JTRST\n\nTCPC extensa core JTAG JTRST reset control"]
    #[inline(always)]
    #[must_use]
    pub fn jtrst(&mut self) -> JtrstW<Usb3phy0Con1Spec> {
        JtrstW::new(self, 11)
    }
    #[doc = "Bit 12 - vbus overvoltage"]
    #[inline(always)]
    #[must_use]
    pub fn vbus_overvoltage_n(&mut self) -> VbusOvervoltageNW<Usb3phy0Con1Spec> {
        VbusOvervoltageNW::new(self, 12)
    }
    #[doc = "Bit 15 - JTAG_select"]
    #[inline(always)]
    #[must_use]
    pub fn jtag_select(&mut self) -> JtagSelectW<Usb3phy0Con1Spec> {
        JtagSelectW::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb3phy0Con1Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "TypeC PHY/TCPD PHY/TCPC Control register1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb3phy0_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb3phy0_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb3phy0Con1Spec;
impl crate::RegisterSpec for Usb3phy0Con1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb3phy0_con1::R`](R) reader structure"]
impl crate::Readable for Usb3phy0Con1Spec {}
#[doc = "`write(|w| ..)` method takes [`usb3phy0_con1::W`](W) writer structure"]
impl crate::Writable for Usb3phy0Con1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB3PHY0_CON1 to value 0x1000"]
impl crate::Resettable for Usb3phy0Con1Spec {
