#[doc = "Register `GRF_SOC_CON9` reader"]
pub type R = crate::R<GrfSocCon9Spec>;
#[doc = "Register `GRF_SOC_CON9` writer"]
pub type W = crate::W<GrfSocCon9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_turnrequest(&mut self) -> DphyRx0TurnrequestW<GrfSocCon9Spec> {
        DphyRx0TurnrequestW::new(self, 0)
    }
    #[doc = "Bit 8 - isp0 disable control"]
    #[inline(always)]
    #[must_use]
    pub fn disable_isp0(&mut self) -> DisableIsp0W<GrfSocCon9Spec> {
        DisableIsp0W::new(self, 8)
    }
    #[doc = "Bit 9 - isp1 disable control"]
    #[inline(always)]
    #[must_use]
    pub fn disable_isp1(&mut self) -> DisableIsp1W<GrfSocCon9Spec> {
        DisableIsp1W::new(self, 9)
    }
    #[doc = "Bit 10 - dphy rx0 clock inveter select bit"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx0_clk_inv_sel(&mut self) -> DphyRx0ClkInvSelW<GrfSocCon9Spec> {
        DphyRx0ClkInvSelW::new(self, 10)
    }
    #[doc = "Bit 11 - dphy rx1 clock inveter select bit"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_rx1_clk_inv_sel(&mut self) -> DphyRx1ClkInvSelW<GrfSocCon9Spec> {
        DphyRx1ClkInvSelW::new(self, 11)
    }
    #[doc = "Bit 12 - dp lcdc select"]
    #[inline(always)]
    #[must_use]
    pub fn dp_lcdc_sel(&mut self) -> DpLcdcSelW<GrfSocCon9Spec> {
        DpLcdcSelW::new(self, 12)
    }
    #[doc = "Bit 13 - DSI0 dpicolorm bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dsi0_dpicolorm(&mut self) -> Dsi0DpicolormW<GrfSocCon9Spec> {
        Dsi0DpicolormW::new(self, 13)
    }
    #[doc = "Bit 14 - DSI0 dpishutdn bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dsi0_dpishutdn(&mut self) -> Dsi0DpishutdnW<GrfSocCon9Spec> {
        Dsi0DpishutdnW::new(self, 14)
    }
    #[doc = "Bit 15 - DSI host0 dpiupdatecfg bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dsi0_dpiupdatecfg(&mut self) -> Dsi0DpiupdatecfgW<GrfSocCon9Spec> {
        Dsi0DpiupdatecfgW::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfSocCon9Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 9\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_soc_con9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_soc_con9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfSocCon9Spec;
impl crate::RegisterSpec for GrfSocCon9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_soc_con9::R`](R) reader structure"]
impl crate::Readable for GrfSocCon9Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_soc_con9::W`](W) writer structure"]
impl crate::Writable for GrfSocCon9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_SOC_CON9 to value 0"]
impl crate::Resettable for GrfSocCon9Spec {
