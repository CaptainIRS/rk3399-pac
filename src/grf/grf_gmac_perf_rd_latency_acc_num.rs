#[doc = "Register `GRF_GMAC_PERF_RD_LATENCY_ACC_NUM` reader"]
...
#[doc = "gmac performance monitor status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_gmac_perf_rd_latency_acc_num::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_gmac_perf_rd_latency_acc_num::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfGmacPerfRdLatencyAccNumSpec;
impl crate::RegisterSpec for GrfGmacPerfRdLatencyAccNumSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_gmac_perf_rd_latency_acc_num::R`](R) reader structure"]
impl crate::Readable for GrfGmacPerfRdLatencyAccNumSpec {}
#[doc = "`write(|w| ..)` method takes [`grf_gmac_perf_rd_latency_acc_num::W`](W) writer structure"]
impl crate::Writable for GrfGmacPerfRdLatencyAccNumSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_GMAC_PERF_RD_LATENCY_ACC_NUM to value 0"]
impl crate::Resettable for GrfGmacPerfRdLatencyAccNumSpec {
