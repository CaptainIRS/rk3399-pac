#[doc = "Register `GRF_GRF_USBHOST0_STATUS` reader"]
pub type R = crate::R<GrfGrfUsbhost0StatusSpec>;
#[doc = "Register `GRF_GRF_USBHOST0_STATUS` writer"]
pub type W = crate::W<GrfGrfUsbhost0StatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn host0_ehci_xfer_cnt(&mut self) -> Host0EhciXferCntW<GrfGrfUsbhost0StatusSpec> {
        Host0EhciXferCntW::new(self, 0)
    }
    #[doc = "Bits 11:16 - host0_ehci_usbsts"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ehci_usbsts(&mut self) -> Host0EhciUsbstsW<GrfGrfUsbhost0StatusSpec> {
        Host0EhciUsbstsW::new(self, 11)
    }
    #[doc = "Bits 17:20 - host0_ehci_lpsmc_state"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ehci_lpsmc_state(&mut self) -> Host0EhciLpsmcStateW<GrfGrfUsbhost0StatusSpec> {
        Host0EhciLpsmcStateW::new(self, 17)
    }
    #[doc = "Bit 21 - host0_ohci_rwe"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ohci_rwe(&mut self) -> Host0OhciRweW<GrfGrfUsbhost0StatusSpec> {
        Host0OhciRweW::new(self, 21)
    }
    #[doc = "Bit 22 - host0_ohci_rmtwkp"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ohci_rmtwkp(&mut self) -> Host0OhciRmtwkpW<GrfGrfUsbhost0StatusSpec> {
        Host0OhciRmtwkpW::new(self, 22)
    }
    #[doc = "Bit 23 - host0_ohci_globalsuspend"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ohci_globalsuspend(
        &mut self,
    ) -> Host0OhciGlobalsuspendW<GrfGrfUsbhost0StatusSpec> {
        Host0OhciGlobalsuspendW::new(self, 23)
    }
    #[doc = "Bit 24 - host0_ohci_drwe"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ohci_drwe(&mut self) -> Host0OhciDrweW<GrfGrfUsbhost0StatusSpec> {
        Host0OhciDrweW::new(self, 24)
    }
    #[doc = "Bit 25 - host0_ohci_ccs"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ohci_ccs(&mut self) -> Host0OhciCcsW<GrfGrfUsbhost0StatusSpec> {
        Host0OhciCcsW::new(self, 25)
    }
    #[doc = "Bit 26 - host0_ohci_bufacc"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ohci_bufacc(&mut self) -> Host0OhciBufaccW<GrfGrfUsbhost0StatusSpec> {
        Host0OhciBufaccW::new(self, 26)
    }
    #[doc = "Bit 27 - host0_ehci_xfer_prdc"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ehci_xfer_prdc(&mut self) -> Host0EhciXferPrdcW<GrfGrfUsbhost0StatusSpec> {
        Host0EhciXferPrdcW::new(self, 27)
    }
    #[doc = "Bit 28 - host0_ehci_bufacc"]
    #[inline(always)]
    #[must_use]
    pub fn host0_ehci_bufacc(&mut self) -> Host0EhciBufaccW<GrfGrfUsbhost0StatusSpec> {
        Host0EhciBufaccW::new(self, 28)
    }
}
#[doc = "usb host0 controller status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_grf_usbhost0_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_grf_usbhost0_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfGrfUsbhost0StatusSpec;
impl crate::RegisterSpec for GrfGrfUsbhost0StatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_grf_usbhost0_status::R`](R) reader structure"]
impl crate::Readable for GrfGrfUsbhost0StatusSpec {}
#[doc = "`write(|w| ..)` method takes [`grf_grf_usbhost0_status::W`](W) writer structure"]
impl crate::Writable for GrfGrfUsbhost0StatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_GRF_USBHOST0_STATUS to value 0"]
impl crate::Resettable for GrfGrfUsbhost0StatusSpec {
