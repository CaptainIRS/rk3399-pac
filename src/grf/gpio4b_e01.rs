#[doc = "Register `GPIO4B_E01` reader"]
pub type R = crate::R<Gpio4bE01Spec>;
#[doc = "Register `GPIO4B_E01` writer"]
pub type W = crate::W<Gpio4bE01Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio4b0_e(&mut self) -> Gpio4b0EW<Gpio4bE01Spec> {
        Gpio4b0EW::new(self, 0)
    }
    #[doc = "Bits 3:5 - GPIO4B1 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b1_e(&mut self) -> Gpio4b1EW<Gpio4bE01Spec> {
        Gpio4b1EW::new(self, 3)
    }
    #[doc = "Bits 6:8 - GPIO4B2 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b2_e(&mut self) -> Gpio4b2EW<Gpio4bE01Spec> {
        Gpio4b2EW::new(self, 6)
    }
    #[doc = "Bits 9:11 - GPIO4B3 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b3_e(&mut self) -> Gpio4b3EW<Gpio4bE01Spec> {
        Gpio4b3EW::new(self, 9)
    }
    #[doc = "Bits 12:14 - GPIO4B4 drive strength control bit0 to bit2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b4_e(&mut self) -> Gpio4b4EW<Gpio4bE01Spec> {
        Gpio4b4EW::new(self, 12)
    }
    #[doc = "Bit 15 - GPIO4B5 drive strength control bit0"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4b5_e0(&mut self) -> Gpio4b5E0W<Gpio4bE01Spec> {
        Gpio4b5E0W::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio4bE01Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO4B drive strength control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio4b_e01::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio4b_e01::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio4bE01Spec;
impl crate::RegisterSpec for Gpio4bE01Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio4b_e01::R`](R) reader structure"]
impl crate::Readable for Gpio4bE01Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio4b_e01::W`](W) writer structure"]
impl crate::Writable for Gpio4bE01Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO4B_E01 to value 0x9249"]
impl crate::Resettable for Gpio4bE01Spec {
