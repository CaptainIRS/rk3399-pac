#[doc = "Register `GRF_CPU_CON3` reader"]
pub type R = crate::R<GrfCpuCon3Spec>;
#[doc = "Register `GRF_CPU_CON3` writer"]
pub type W = crate::W<GrfCpuCon3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn awqos_pd_core_b(&mut self) -> AwqosPdCoreBW<GrfCpuCon3Spec> {
        AwqosPdCoreBW::new(self, 0)
    }
    #[doc = "Bits 4:5 - pd_core_b arqos bit control"]
    #[inline(always)]
    #[must_use]
    pub fn arqos_pd_core_b(&mut self) -> ArqosPdCoreBW<GrfCpuCon3Spec> {
        ArqosPdCoreBW::new(self, 4)
    }
    #[doc = "Bits 8:9 - pd_core_b clusteridaff1 bit control"]
    #[inline(always)]
    #[must_use]
    pub fn clusteridaff1_pd_core_b(&mut self) -> Clusteridaff1PdCoreBW<GrfCpuCon3Spec> {
        Clusteridaff1PdCoreBW::new(self, 8)
    }
    #[doc = "Bits 12:13 - pd_core_b gic_active bit control"]
    #[inline(always)]
    #[must_use]
    pub fn gic_active_core_b(&mut self) -> GicActiveCoreBW<GrfCpuCon3Spec> {
        GicActiveCoreBW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfCpuCon3Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "cpu control register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_cpu_con3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_cpu_con3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfCpuCon3Spec;
impl crate::RegisterSpec for GrfCpuCon3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_cpu_con3::R`](R) reader structure"]
impl crate::Readable for GrfCpuCon3Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_cpu_con3::W`](W) writer structure"]
impl crate::Writable for GrfCpuCon3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_CPU_CON3 to value 0x3110"]
impl crate::Resettable for GrfCpuCon3Spec {
