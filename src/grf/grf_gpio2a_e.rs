...
#[doc = "GPIO2A0 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
...
#[doc = "Field `GPIO2A0_E` reader - GPIO2A0 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO2A0_E` writer - GPIO2A0 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO2A1 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2a1E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO2A1_E` reader - GPIO2A1 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO2A1_E` writer - GPIO2A1 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO2A2 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2a2E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO2A2_E` reader - GPIO2A2 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO2A2_E` writer - GPIO2A2 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO2A3 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2a3E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO2A3_E` reader - GPIO2A3 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO2A3_E` writer - GPIO2A3 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO2A4 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2a4E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO2A4_E` reader - GPIO2A4 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO2A4_E` writer - GPIO2A4 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO2A5 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2a5E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO2A5_E` reader - GPIO2A5 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO2A5_E` writer - GPIO2A5 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO2A6 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2a6E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO2A6_E` reader - GPIO2A6 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO2A6_E` writer - GPIO2A6 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "GPIO2A7 drive strength control, every GPIO bit corresponding to 2bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio2a7E {
    #[doc = "0: level 3"]
...
#[doc = "Field `GPIO2A7_E` reader - GPIO2A7 drive strength control, every GPIO bit corresponding to 2bits"]
...
#[doc = "Field `GPIO2A7_E` writer - GPIO2A7 drive strength control, every GPIO bit corresponding to 2bits"]
...
impl R {
    #[doc = "Bits 0:1 - GPIO2A0 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio2a0_e(&self) -> Gpio2a0ER {
        Gpio2a0ER::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 2:3 - GPIO2A1 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio2a1_e(&self) -> Gpio2a1ER {
        Gpio2a1ER::new(((self.bits >> 2) & 3) as u8)
    }
    #[doc = "Bits 4:5 - GPIO2A2 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio2a2_e(&self) -> Gpio2a2ER {
        Gpio2a2ER::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 6:7 - GPIO2A3 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio2a3_e(&self) -> Gpio2a3ER {
        Gpio2a3ER::new(((self.bits >> 6) & 3) as u8)
    }
    #[doc = "Bits 8:9 - GPIO2A4 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio2a4_e(&self) -> Gpio2a4ER {
        Gpio2a4ER::new(((self.bits >> 8) & 3) as u8)
    }
    #[doc = "Bits 10:11 - GPIO2A5 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio2a5_e(&self) -> Gpio2a5ER {
        Gpio2a5ER::new(((self.bits >> 10) & 3) as u8)
    }
    #[doc = "Bits 12:13 - GPIO2A6 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
    pub fn gpio2a6_e(&self) -> Gpio2a6ER {
        Gpio2a6ER::new(((self.bits >> 12) & 3) as u8)
    }
    #[doc = "Bits 14:15 - GPIO2A7 drive strength control, every GPIO bit corresponding to 2bits"]
    #[inline(always)]
