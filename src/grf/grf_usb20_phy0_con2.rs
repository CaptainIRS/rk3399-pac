#[doc = "Register `GRF_USB20_PHY0_CON2` reader"]
pub type R = crate::R<GrfUsb20Phy0Con2Spec>;
#[doc = "Register `GRF_USB20_PHY0_CON2` writer"]
pub type W = crate::W<GrfUsb20Phy0Con2Spec>;
#[doc = "utmi_sel\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UtmiSel {
    #[doc = "1: select utmi interface signals from utmi interface of usb20 host0 controller to usb2phy"]
    B1 = 1,
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn utmi_sel(&mut self) -> UtmiSelW<GrfUsb20Phy0Con2Spec> {
        UtmiSelW::new(self, 0)
    }
    #[doc = "Bit 1 - suspend_n Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn suspend_n(&mut self) -> SuspendNW<GrfUsb20Phy0Con2Spec> {
        SuspendNW::new(self, 1)
    }
    #[doc = "Bits 2:3 - opmode Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn opmode(&mut self) -> OpmodeW<GrfUsb20Phy0Con2Spec> {
        OpmodeW::new(self, 2)
    }
    #[doc = "Bits 4:5 - xcvrselect Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn xcvrselect(&mut self) -> XcvrselectW<GrfUsb20Phy0Con2Spec> {
        XcvrselectW::new(self, 4)
    }
    #[doc = "Bit 6 - termselect Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn termselect(&mut self) -> TermselectW<GrfUsb20Phy0Con2Spec> {
        TermselectW::new(self, 6)
    }
    #[doc = "Bit 7 - dppulldown Use the value of this register input to dppulldown of usb2phy"]
    #[inline(always)]
    #[must_use]
    pub fn dppulldown(&mut self) -> DppulldownW<GrfUsb20Phy0Con2Spec> {
        DppulldownW::new(self, 7)
    }
    #[doc = "Bit 8 - dmpulldown Use the value of this register input to dmpulldown of usb2phy"]
    #[inline(always)]
    #[must_use]
    pub fn dmpulldown(&mut self) -> DmpulldownW<GrfUsb20Phy0Con2Spec> {
        DmpulldownW::new(self, 8)
    }
    #[doc = "Bit 9 - idpullup Use the value of this register input to idpullup of usb2phy"]
    #[inline(always)]
    #[must_use]
    pub fn idpullup(&mut self) -> IdpullupW<GrfUsb20Phy0Con2Spec> {
        IdpullupW::new(self, 9)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfUsb20Phy0Con2Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "USB20 PHY0 GRF Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_usb20_phy0_con2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_usb20_phy0_con2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfUsb20Phy0Con2Spec;
impl crate::RegisterSpec for GrfUsb20Phy0Con2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_usb20_phy0_con2::R`](R) reader structure"]
impl crate::Readable for GrfUsb20Phy0Con2Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_usb20_phy0_con2::W`](W) writer structure"]
impl crate::Writable for GrfUsb20Phy0Con2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_USB20_PHY0_CON2 to value 0x03d2"]
impl crate::Resettable for GrfUsb20Phy0Con2Spec {
