#[doc = "Register `SIG_DETECT_CON0` reader"]
pub type R = crate::R<SigDetectCon0Spec>;
#[doc = "Register `SIG_DETECT_CON0` writer"]
pub type W = crate::W<SigDetectCon0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdmmc_card_rise_edge(&mut self) -> SdmmcCardRiseEdgeW<SigDetectCon0Spec> {
        SdmmcCardRiseEdgeW::new(self, 0)
    }
    #[doc = "Bit 1 - sdmmc card fall edge detect control"]
    #[inline(always)]
    #[must_use]
    pub fn sdmmc_card_fall_edge(&mut self) -> SdmmcCardFallEdgeW<SigDetectCon0Spec> {
        SdmmcCardFallEdgeW::new(self, 1)
    }
    #[doc = "Bit 2 - cphy0_otg_linestate_change detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_otg_linestate_change(&mut self) -> Cphy0OtgLinestateChangeW<SigDetectCon0Spec> {
        Cphy0OtgLinestateChangeW::new(self, 2)
    }
    #[doc = "Bit 3 - cphy0_otg_bvalid_rise detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_otg_bvalid_rise(&mut self) -> Cphy0OtgBvalidRiseW<SigDetectCon0Spec> {
        Cphy0OtgBvalidRiseW::new(self, 3)
    }
    #[doc = "Bit 4 - cphy0_otg_id_rise detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_otg_id_rise(&mut self) -> Cphy0OtgIdRiseW<SigDetectCon0Spec> {
        Cphy0OtgIdRiseW::new(self, 4)
    }
    #[doc = "Bit 5 - cphy0_otg_id_fall detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_otg_id_fall(&mut self) -> Cphy0OtgIdFallW<SigDetectCon0Spec> {
        Cphy0OtgIdFallW::new(self, 5)
    }
    #[doc = "Bit 6 - cphy0_host_linestate_change detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_host_linestate_change(&mut self) -> Cphy0HostLinestateChangeW<SigDetectCon0Spec> {
        Cphy0HostLinestateChangeW::new(self, 6)
    }
    #[doc = "Bit 7 - cphy1_otg_linestate_change detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_otg_linestate_change(&mut self) -> Cphy1OtgLinestateChangeW<SigDetectCon0Spec> {
        Cphy1OtgLinestateChangeW::new(self, 7)
    }
    #[doc = "Bit 8 - cphy1_otg_bvalid_rise detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_otg_bvalid_rise(&mut self) -> Cphy1OtgBvalidRiseW<SigDetectCon0Spec> {
        Cphy1OtgBvalidRiseW::new(self, 8)
    }
    #[doc = "Bit 9 - cphy1_otg_id_rise detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_otg_id_rise(&mut self) -> Cphy1OtgIdRiseW<SigDetectCon0Spec> {
        Cphy1OtgIdRiseW::new(self, 9)
    }
    #[doc = "Bit 10 - cphy1_otg_id_fall detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_otg_id_fall(&mut self) -> Cphy1OtgIdFallW<SigDetectCon0Spec> {
        Cphy1OtgIdFallW::new(self, 10)
    }
    #[doc = "Bit 11 - cphy1_host_linestate_change detect control"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_host_linestate_change(&mut self) -> Cphy1HostLinestateChangeW<SigDetectCon0Spec> {
        Cphy1HostLinestateChangeW::new(self, 11)
    }
    #[doc = "Bit 12 - uphy0_rxdet_change detect control"]
    #[inline(always)]
    #[must_use]
    pub fn uphy0_rxdet_change(&mut self) -> Uphy0RxdetChangeW<SigDetectCon0Spec> {
        Uphy0RxdetChangeW::new(self, 12)
    }
    #[doc = "Bit 13 - uphy1_rxdet_change detect control"]
    #[inline(always)]
    #[must_use]
    pub fn uphy1_rxdet_change(&mut self) -> Uphy1RxdetChangeW<SigDetectCon0Spec> {
        Uphy1RxdetChangeW::new(self, 13)
    }
    #[doc = "Bit 14 - uphy0_rxdet phy conrol bit"]
    #[inline(always)]
    #[must_use]
    pub fn uphy0_rxdet_en(&mut self) -> Uphy0RxdetEnW<SigDetectCon0Spec> {
        Uphy0RxdetEnW::new(self, 14)
    }
    #[doc = "Bit 15 - uphy1_rxdet phy conrol bit"]
    #[inline(always)]
    #[must_use]
    pub fn uphy1_rxdet_en(&mut self) -> Uphy1RxdetEnW<SigDetectCon0Spec> {
        Uphy1RxdetEnW::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SigDetectCon0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "Singal detect control register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sig_detect_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sig_detect_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SigDetectCon0Spec;
impl crate::RegisterSpec for SigDetectCon0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sig_detect_con0::R`](R) reader structure"]
impl crate::Readable for SigDetectCon0Spec {}
#[doc = "`write(|w| ..)` method takes [`sig_detect_con0::W`](W) writer structure"]
impl crate::Writable for SigDetectCon0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SIG_DETECT_CON0 to value 0"]
impl crate::Resettable for SigDetectCon0Spec {
