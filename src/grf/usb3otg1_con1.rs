#[doc = "Register `USB3OTG1_CON1` reader"]
pub type R = crate::R<Usb3otg1Con1Spec>;
#[doc = "Register `USB3OTG1_CON1` writer"]
pub type W = crate::W<Usb3otg1Con1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn host_u3_port_disable(&mut self) -> HostU3PortDisableW<Usb3otg1Con1Spec> {
        HostU3PortDisableW::new(self, 0)
    }
    #[doc = "Bit 1 - pme_en\n\nEnable signal for the pme_generation. Enable\n\nthe core to assert pme_generation."]
    #[inline(always)]
    #[must_use]
    pub fn pme_en(&mut self) -> PmeEnW<Usb3otg1Con1Spec> {
        PmeEnW::new(self, 1)
    }
    #[doc = "Bit 4 - host_legacy_smi_pci_cmd\n\nUse this register to support SMI on PCI\n\nCommand defined in xHCI spec.\n\nSW must set this register, then clear this\n\nregister to indicate PCI command register\n\nwritten."]
    #[inline(always)]
    #[must_use]
    pub fn host_legacy_smi_pci_cmd(&mut self) -> HostLegacySmiPciCmdW<Usb3otg1Con1Spec> {
        HostLegacySmiPciCmdW::new(self, 4)
    }
    #[doc = "Bit 5 - host_legacy_smi_bar\n\nUse this register to support SMI on BAR\n\ndefined in xHCI spec.\n\nSW must set this register, then clear this\n\nregister to indicate Base Address Register\n\nwritten"]
    #[inline(always)]
    #[must_use]
    pub fn host_legacy_smi_bar(&mut self) -> HostLegacySmiBarW<Usb3otg1Con1Spec> {
        HostLegacySmiBarW::new(self, 5)
    }
    #[doc = "Bits 8:11 - host_u2_port\n\nxHCI host USB2 port number, default as 1."]
    #[inline(always)]
    #[must_use]
    pub fn host_u2_port(&mut self) -> HostU2PortW<Usb3otg1Con1Spec> {
        HostU2PortW::new(self, 8)
    }
    #[doc = "Bits 12:15 - host_u3_port\n\nxHCI usb3 port number, default as 1."]
    #[inline(always)]
    #[must_use]
    pub fn host_u3_port(&mut self) -> HostU3PortW<Usb3otg1Con1Spec> {
        HostU3PortW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb3otg1Con1Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "USB3 OTG1 GRF Register1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb3otg1_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb3otg1_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb3otg1Con1Spec;
impl crate::RegisterSpec for Usb3otg1Con1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb3otg1_con1::R`](R) reader structure"]
impl crate::Readable for Usb3otg1Con1Spec {}
#[doc = "`write(|w| ..)` method takes [`usb3otg1_con1::W`](W) writer structure"]
impl crate::Writable for Usb3otg1Con1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB3OTG1_CON1 to value 0x1100"]
impl crate::Resettable for Usb3otg1Con1Spec {
