#[doc = "Register `USB20_PHY0_CON3` reader"]
pub type R = crate::R<Usb20Phy0Con3Spec>;
#[doc = "Register `USB20_PHY0_CON3` writer"]
pub type W = crate::W<Usb20Phy0Con3Spec>;
...
pub enum DrvvbusSel {
    #[doc = "1: select the value of bit2 of USB20_PHY0_CON3 to drvvbus of usb2phy and GPIO to external PMIC"]
    B1 = 1,
...
impl DrvvbusSelR {
    ...
    #[doc = "select the value of bit2 of USB20_PHY0_CON3 to drvvbus of usb2phy and GPIO to external PMIC"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn idpullup(&mut self) -> IdpullupW<Usb20Phy0Con3Spec> {
        IdpullupW::new(self, 0)
    }
    #[doc = "Bit 1 - drvvbus_sel"]
    #[inline(always)]
    #[must_use]
    pub fn drvvbus_sel(&mut self) -> DrvvbusSelW<Usb20Phy0Con3Spec> {
        DrvvbusSelW::new(self, 1)
    }
    #[doc = "Bit 2 - drvvbus\n\nPls see drvvbus_sel."]
    #[inline(always)]
    #[must_use]
    pub fn drvvbus(&mut self) -> DrvvbusW<Usb20Phy0Con3Spec> {
        DrvvbusW::new(self, 2)
    }
    #[doc = "Bit 3 - chrgvbus\n\nUse the value of this register input to\n\nchrgvbus of usb2phy"]
    #[inline(always)]
    #[must_use]
    pub fn chrgvbus(&mut self) -> ChrgvbusW<Usb20Phy0Con3Spec> {
        ChrgvbusW::new(self, 3)
    }
    #[doc = "Bit 4 - dischrgvbus\n\nUse the value of this register input to\n\nchrgvbus of usb2phy"]
    #[inline(always)]
    #[must_use]
    pub fn dischrgvbus(&mut self) -> DischrgvbusW<Usb20Phy0Con3Spec> {
        DischrgvbusW::new(self, 4)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb20Phy0Con3Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "USB20 PHY0 GRF Register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb20_phy0_con3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb20_phy0_con3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb20Phy0Con3Spec;
impl crate::RegisterSpec for Usb20Phy0Con3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb20_phy0_con3::R`](R) reader structure"]
impl crate::Readable for Usb20Phy0Con3Spec {}
#[doc = "`write(|w| ..)` method takes [`usb20_phy0_con3::W`](W) writer structure"]
impl crate::Writable for Usb20Phy0Con3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB20_PHY0_CON3 to value 0x01"]
impl crate::Resettable for Usb20Phy0Con3Spec {
