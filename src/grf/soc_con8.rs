#[doc = "Register `SOC_CON8` reader"]
pub type R = crate::R<SocCon8Spec>;
#[doc = "Register `SOC_CON8` writer"]
pub type W = crate::W<SocCon8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcie_test_write(&mut self) -> PcieTestWriteW<SocCon8Spec> {
        PcieTestWriteW::new(self, 0)
    }
    #[doc = "Bits 1:6 - pci test address control"]
    #[inline(always)]
    #[must_use]
    pub fn pcie_test_addr(&mut self) -> PcieTestAddrW<SocCon8Spec> {
        PcieTestAddrW::new(self, 1)
    }
    #[doc = "Bits 7:10 - pci test input"]
    #[inline(always)]
    #[must_use]
    pub fn pcie_test_i(&mut self) -> PcieTestIW<SocCon8Spec> {
        PcieTestIW::new(self, 7)
    }
    #[doc = "Bits 11:14 - i2s0_sclk_oe_n bit control"]
    #[inline(always)]
    #[must_use]
    pub fn i2s0_sclk_oe_n(&mut self) -> I2s0SclkOeNW<SocCon8Spec> {
        I2s0SclkOeNW::new(self, 11)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SocCon8Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 8\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_con8::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_con8::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocCon8Spec;
impl crate::RegisterSpec for SocCon8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_con8::R`](R) reader structure"]
impl crate::Readable for SocCon8Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_con8::W`](W) writer structure"]
impl crate::Writable for SocCon8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_CON8 to value 0"]
impl crate::Resettable for SocCon8Spec {
