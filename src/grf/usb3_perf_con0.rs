#[doc = "Register `USB3_PERF_CON0` reader"]
pub type R = crate::R<Usb3PerfCon0Spec>;
#[doc = "Register `USB3_PERF_CON0` writer"]
pub type W = crate::W<Usb3PerfCon0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb3_sw_axi_perf_work(&mut self) -> Usb3SwAxiPerfWorkW<Usb3PerfCon0Spec> {
        Usb3SwAxiPerfWorkW::new(self, 0)
    }
    #[doc = "Bit 1 - Fi\n\naxi_perf clear bit"]
    #[inline(always)]
    #[must_use]
    pub fn usb3_sw_axi_perf_clr(&mut self) -> Usb3SwAxiPerfClrW<Usb3PerfCon0Spec> {
        Usb3SwAxiPerfClrW::new(self, 1)
    }
    #[doc = "Bit 2 - axi_perf counter type"]
    #[inline(always)]
    #[must_use]
    pub fn usb3_sw_axi_cnt_type(&mut self) -> Usb3SwAxiCntTypeW<Usb3PerfCon0Spec> {
        Usb3SwAxiCntTypeW::new(self, 2)
    }
    #[doc = "Bit 3 - axi_perf counter id control"]
    #[inline(always)]
    #[must_use]
    pub fn usb3_sw_ar_cnt_id_type(&mut self) -> Usb3SwArCntIdTypeW<Usb3PerfCon0Spec> {
        Usb3SwArCntIdTypeW::new(self, 3)
    }
    #[doc = "Bit 4 - axi_perf counter id control"]
    #[inline(always)]
    #[must_use]
    pub fn usb3_sw_aw_cnt_id_type(&mut self) -> Usb3SwAwCntIdTypeW<Usb3PerfCon0Spec> {
        Usb3SwAwCntIdTypeW::new(self, 4)
    }
    #[doc = "Bits 5:6"]
    #[inline(always)]
    #[must_use]
    pub fn usb3_sw_ddr_align_type(&mut self) -> Usb3SwDdrAlignTypeW<Usb3PerfCon0Spec> {
        Usb3SwDdrAlignTypeW::new(self, 5)
    }
    #[doc = "Bits 8:11 - Axi read channel id for latency\n\nAXI_PERFormance test"]
    #[inline(always)]
    #[must_use]
    pub fn usb3_sw_rd_latency_id(&mut self) -> Usb3SwRdLatencyIdW<Usb3PerfCon0Spec> {
        Usb3SwRdLatencyIdW::new(self, 8)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn usb3_rksoc_axi_perf_sel(&mut self) -> Usb3RksocAxiPerfSelW<Usb3PerfCon0Spec> {
        Usb3RksocAxiPerfSelW::new(self, 15)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb3PerfCon0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "usb3 performance monitor control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb3_perf_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb3_perf_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb3PerfCon0Spec;
impl crate::RegisterSpec for Usb3PerfCon0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb3_perf_con0::R`](R) reader structure"]
impl crate::Readable for Usb3PerfCon0Spec {}
#[doc = "`write(|w| ..)` method takes [`usb3_perf_con0::W`](W) writer structure"]
impl crate::Writable for Usb3PerfCon0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB3_PERF_CON0 to value 0"]
impl crate::Resettable for Usb3PerfCon0Spec {
