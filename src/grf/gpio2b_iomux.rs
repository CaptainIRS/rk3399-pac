#[doc = "Register `GPIO2B_IOMUX` reader"]
pub type R = crate::R<Gpio2bIomuxSpec>;
#[doc = "Register `GPIO2B_IOMUX` writer"]
pub type W = crate::W<Gpio2bIomuxSpec>;
#[doc = "GPIO2B\\[0\\]
iomux select\n\nValue on reset: 0"]
...
impl Gpio2b4SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio2b4Sel> {
        match self.bits {
            0 => Some(Gpio2b4Sel::B00),
            1 => Some(Gpio2b4Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio2b4SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio2b4Sel>;
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2b0_sel(&mut self) -> Gpio2b0SelW<Gpio2bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2b1_sel(&mut self) -> Gpio2b1SelW<Gpio2bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2b2_sel(&mut self) -> Gpio2b2SelW<Gpio2bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2b3_sel(&mut self) -> Gpio2b3SelW<Gpio2bIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2b4_sel(&mut self) -> Gpio2b4SelW<Gpio2bIomuxSpec> {
        Gpio2b4SelW::new(self, 8)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio2bIomuxSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO2B iomux control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio2b_iomux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio2b_iomux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio2bIomuxSpec;
impl crate::RegisterSpec for Gpio2bIomuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio2b_iomux::R`](R) reader structure"]
impl crate::Readable for Gpio2bIomuxSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio2b_iomux::W`](W) writer structure"]
impl crate::Writable for Gpio2bIomuxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO2B_IOMUX to value 0"]
impl crate::Resettable for Gpio2bIomuxSpec {
