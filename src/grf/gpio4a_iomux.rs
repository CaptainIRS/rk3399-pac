#[doc = "Register `GPIO4A_IOMUX` reader"]
pub type R = crate::R<Gpio4aIomuxSpec>;
#[doc = "Register `GPIO4A_IOMUX` writer"]
pub type W = crate::W<Gpio4aIomuxSpec>;
#[doc = "GPIO4A\\[0\\]
iomux select\n\nValue on reset: 0"]
...
impl Gpio4a1SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio4a1Sel> {
        match self.bits {
            0 => Some(Gpio4a1Sel::B00),
            1 => Some(Gpio4a1Sel::B01),
            2 => Some(Gpio4a1Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio4a1SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio4a1Sel>;
...
impl Gpio4a2SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio4a2Sel> {
        match self.bits {
            0 => Some(Gpio4a2Sel::B00),
            1 => Some(Gpio4a2Sel::B01),
            2 => Some(Gpio4a2Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio4a2SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio4a2Sel>;
...
impl Gpio4a3SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio4a3Sel> {
        match self.bits {
            0 => Some(Gpio4a3Sel::B00),
            1 => Some(Gpio4a3Sel::B01),
            2 => Some(Gpio4a3Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio4a3SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio4a3Sel>;
...
impl Gpio4a4SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio4a4Sel> {
        match self.bits {
            0 => Some(Gpio4a4Sel::B00),
            1 => Some(Gpio4a4Sel::B01),
            2 => Some(Gpio4a4Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio4a4SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio4a4Sel>;
...
impl Gpio4a5SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio4a5Sel> {
        match self.bits {
            0 => Some(Gpio4a5Sel::B00),
            1 => Some(Gpio4a5Sel::B01),
            2 => Some(Gpio4a5Sel::B10),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio4a5SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio4a5Sel>;
...
impl Gpio4a6SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio4a6Sel> {
        match self.bits {
            0 => Some(Gpio4a6Sel::B00),
            1 => Some(Gpio4a6Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio4a6SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio4a6Sel>;
...
impl Gpio4a7SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Gpio4a7Sel> {
        match self.bits {
            0 => Some(Gpio4a7Sel::B00),
            1 => Some(Gpio4a7Sel::B01),
            _ => None,
        }
    }
    #[doc = "gpio"]
...
iomux select"]
pub type Gpio4a7SelW<'a, REG> = crate::FieldWriter<'a, REG, 2, Gpio4a7Sel>;
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a0_sel(&mut self) -> Gpio4a0SelW<Gpio4aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a1_sel(&mut self) -> Gpio4a1SelW<Gpio4aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a2_sel(&mut self) -> Gpio4a2SelW<Gpio4aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a3_sel(&mut self) -> Gpio4a3SelW<Gpio4aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a4_sel(&mut self) -> Gpio4a4SelW<Gpio4aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a5_sel(&mut self) -> Gpio4a5SelW<Gpio4aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a6_sel(&mut self) -> Gpio4a6SelW<Gpio4aIomuxSpec> {
...
iomux select"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4a7_sel(&mut self) -> Gpio4a7SelW<Gpio4aIomuxSpec> {
        Gpio4a7SelW::new(self, 14)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Gpio4aIomuxSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "GPIO4A iomux control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio4a_iomux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio4a_iomux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio4aIomuxSpec;
impl crate::RegisterSpec for Gpio4aIomuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio4a_iomux::R`](R) reader structure"]
impl crate::Readable for Gpio4aIomuxSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio4a_iomux::W`](W) writer structure"]
impl crate::Writable for Gpio4aIomuxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO4A_IOMUX to value 0"]
impl crate::Resettable for Gpio4aIomuxSpec {
