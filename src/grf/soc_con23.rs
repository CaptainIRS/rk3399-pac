#[doc = "Register `SOC_CON23` reader"]
pub type R = crate::R<SocCon23Spec>;
#[doc = "Register `SOC_CON23` writer"]
pub type W = crate::W<SocCon23Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dphy_tx1rx1_enable(&mut self) -> DphyTx1rx1EnableW<SocCon23Spec> {
        DphyTx1rx1EnableW::new(self, 0)
    }
    #[doc = "Bits 4:7 - dphy_tx1rx1_forcerxmode bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_tx1rx1_forcerxmode(&mut self) -> DphyTx1rx1ForcerxmodeW<SocCon23Spec> {
        DphyTx1rx1ForcerxmodeW::new(self, 4)
    }
    #[doc = "Bits 8:11 - dphy_tx1rx1_forcetxstopmode bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_tx1rx1_forcetxstopmode(&mut self) -> DphyTx1rx1ForcetxstopmodeW<SocCon23Spec> {
        DphyTx1rx1ForcetxstopmodeW::new(self, 8)
    }
    #[doc = "Bits 12:15 - dphy_tx1rx1_turndisable bit control"]
    #[inline(always)]
    #[must_use]
    pub fn dphy_tx1rx1_turndisable(&mut self) -> DphyTx1rx1TurndisableW<SocCon23Spec> {
        DphyTx1rx1TurndisableW::new(self, 12)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<SocCon23Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "SoC control register 23\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soc_con23::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soc_con23::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SocCon23Spec;
impl crate::RegisterSpec for SocCon23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soc_con23::R`](R) reader structure"]
impl crate::Readable for SocCon23Spec {}
#[doc = "`write(|w| ..)` method takes [`soc_con23::W`](W) writer structure"]
impl crate::Writable for SocCon23Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SOC_CON23 to value 0x21"]
impl crate::Resettable for SocCon23Spec {
