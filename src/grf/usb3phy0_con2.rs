#[doc = "Register `USB3PHY0_CON2` reader"]
pub type R = crate::R<Usb3phy0Con2Spec>;
#[doc = "Register `USB3PHY0_CON2` writer"]
pub type W = crate::W<Usb3phy0Con2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vbus_voltage(&mut self) -> VbusVoltageW<Usb3phy0Con2Spec> {
        VbusVoltageW::new(self, 0)
    }
    #[doc = "Bits 10:13 - vbus source overcurrent"]
    #[inline(always)]
    #[must_use]
    pub fn vbus_overcurrent_n(&mut self) -> VbusOvercurrentNW<Usb3phy0Con2Spec> {
        VbusOvercurrentNW::new(self, 10)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Usb3phy0Con2Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "TypeC PHY/TCPD PHY/TCPC Control register2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb3phy0_con2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb3phy0_con2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb3phy0Con2Spec;
impl crate::RegisterSpec for Usb3phy0Con2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb3phy0_con2::R`](R) reader structure"]
impl crate::Readable for Usb3phy0Con2Spec {}
#[doc = "`write(|w| ..)` method takes [`usb3phy0_con2::W`](W) writer structure"]
impl crate::Writable for Usb3phy0Con2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB3PHY0_CON2 to value 0x3cc8"]
impl crate::Resettable for Usb3phy0Con2Spec {
