#[doc = "Register `GRF_USB20_HOST0_CON0` reader"]
pub type R = crate::R<GrfUsb20Host0Con0Spec>;
#[doc = "Register `GRF_USB20_HOST0_CON0` writer"]
pub type W = crate::W<GrfUsb20Host0Con0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_prt_ovrcur(&mut self) -> AppPrtOvrcurW<GrfUsb20Host0Con0Spec> {
        AppPrtOvrcurW::new(self, 0)
    }
    #[doc = "Bit 1 - app_start_clk"]
    #[inline(always)]
    #[must_use]
    pub fn app_start_clk(&mut self) -> AppStartClkW<GrfUsb20Host0Con0Spec> {
        AppStartClkW::new(self, 1)
    }
    #[doc = "Bit 2 - arb_pause"]
    #[inline(always)]
    #[must_use]
    pub fn arb_pause(&mut self) -> ArbPauseW<GrfUsb20Host0Con0Spec> {
        ArbPauseW::new(self, 2)
    }
    #[doc = "Bit 3 - autoppd_on_overcur_en"]
    #[inline(always)]
    #[must_use]
    pub fn autoppd_on_overcur_en(&mut self) -> AutoppdOnOvercurEnW<GrfUsb20Host0Con0Spec> {
        AutoppdOnOvercurEnW::new(self, 3)
    }
    #[doc = "Bit 4 - hubsetup_min"]
    #[inline(always)]
    #[must_use]
    pub fn hubsetup_min(&mut self) -> HubsetupMinW<GrfUsb20Host0Con0Spec> {
        HubsetupMinW::new(self, 4)
    }
    #[doc = "Bit 5 - incr16_en"]
    #[inline(always)]
    #[must_use]
    pub fn incr16_en(&mut self) -> Incr16EnW<GrfUsb20Host0Con0Spec> {
        Incr16EnW::new(self, 5)
    }
    #[doc = "Bit 6 - incr4_en"]
    #[inline(always)]
    #[must_use]
    pub fn incr4_en(&mut self) -> Incr4EnW<GrfUsb20Host0Con0Spec> {
        Incr4EnW::new(self, 6)
    }
    #[doc = "Bit 7 - incr8_en"]
    #[inline(always)]
    #[must_use]
    pub fn incr8_en(&mut self) -> Incr8EnW<GrfUsb20Host0Con0Spec> {
        Incr8EnW::new(self, 7)
    }
    #[doc = "Bit 8 - incrx_en\n\nForces AHB master to start INCR4/8/16 busts\n\nonly on burst boundaries. AHB requires that\n\ndouble word width burst be addressed-aligned\n\nonly to the double-word boundary."]
    #[inline(always)]
    #[must_use]
    pub fn incrx_en(&mut self) -> IncrxEnW<GrfUsb20Host0Con0Spec> {
        IncrxEnW::new(self, 8)
    }
    #[doc = "Bit 9 - ohci_clkcktrst"]
    #[inline(always)]
    #[must_use]
    pub fn ohci_clkcktrst(&mut self) -> OhciClkcktrstW<GrfUsb20Host0Con0Spec> {
        OhciClkcktrstW::new(self, 9)
    }
    #[doc = "Bit 10 - ohci_cntsel"]
    #[inline(always)]
    #[must_use]
    pub fn ohci_cntsel(&mut self) -> OhciCntselW<GrfUsb20Host0Con0Spec> {
        OhciCntselW::new(self, 10)
    }
    #[doc = "Bit 11 - ohci_susp_lgcy"]
    #[inline(always)]
    #[must_use]
    pub fn ohci_susp_lgcy(&mut self) -> OhciSuspLgcyW<GrfUsb20Host0Con0Spec> {
        OhciSuspLgcyW::new(self, 11)
    }
    #[doc = "Bit 12 - sim_mode\n\nSimulation only."]
    #[inline(always)]
    #[must_use]
    pub fn sim_mode(&mut self) -> SimModeW<GrfUsb20Host0Con0Spec> {
        SimModeW::new(self, 12)
    }
    #[doc = "Bit 13 - word_if"]
    #[inline(always)]
    #[must_use]
    pub fn word_if(&mut self) -> WordIfW<GrfUsb20Host0Con0Spec> {
        WordIfW::new(self, 13)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by\n\nsoftware .\n\nWhen bit 16=0, bit 0 cannot be written by\n\nsoftware;\n\nWhen bit 17=1, bit 1 can be written by\n\nsoftware .\n\nWhen bit 17=0, bit 1 cannot be written by\n\nsoftware;\n\n......\n\nWhen bit 31=1, bit 15 can be written by\n\nsoftware .\n\nWhen bit 31=0, bit 15 cannot be written by\n\nsoftware;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfUsb20Host0Con0Spec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "USB20 Host0 GRF register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_usb20_host0_con0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_usb20_host0_con0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfUsb20Host0Con0Spec;
impl crate::RegisterSpec for GrfUsb20Host0Con0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_usb20_host0_con0::R`](R) reader structure"]
impl crate::Readable for GrfUsb20Host0Con0Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_usb20_host0_con0::W`](W) writer structure"]
impl crate::Writable for GrfUsb20Host0Con0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_USB20_HOST0_CON0 to value 0x23e0"]
impl crate::Resettable for GrfUsb20Host0Con0Spec {
