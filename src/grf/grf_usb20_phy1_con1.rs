...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IddigSel {
    #[doc = "1: select the value of bit10 of USB20_PHY0_CON1 to usb3otg1 controller"]
    B1 = 1,
...
impl IddigSelR {
    ...
    #[doc = "select the value of bit10 of USB20_PHY0_CON1 to usb3otg1 controller"]
    #[inline(always)]
    pub fn is_b1(&self) -> bool {
        *self == IddigSel::B1
    }
...
#[doc = "Field `SUSPEND_N_SEL1` reader - suspend_n-_sel1\n\nPls see suspend_n."]
pub type SuspendNSel1R = crate::BitReader;
#[doc = "Field `SUSPEND_N_SEL1` writer - suspend_n-_sel1\n\nPls see suspend_n."]
