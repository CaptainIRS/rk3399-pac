#[doc = "Register `GRF_USB20_PHY1_CON1` reader"]
pub type R = crate::R<GrfUsb20Phy1Con1Spec>;
#[doc = "Register `GRF_USB20_PHY1_CON1` writer"]
pub type W = crate::W<GrfUsb20Phy1Con1Spec>;
#[doc = "utmi_sel\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UtmiSel {
    #[doc = "1: select utmi interface signals from utmi interface of usb3otg1 controller to usb2phy"]
    B1 = 1,
    #[doc = "0: select utmi interface signals from utmi interface of usb3otg1 controller to usb2phy"]
    B0 = 0,
}
...
impl UtmiSelR {
    ...
    #[doc = "select utmi interface signals from utmi interface of usb3otg1 controller to usb2phy"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IddigSel {
    #[doc = "1: select the iddig from usb2phy to usb3otg1 controller"]
    B1 = 1,
    #[doc = "0: select the iddig from usb2phy to usb3otg1 controller"]
    B0 = 0,
}
...
impl IddigSelR {
    ...
    #[doc = "select the iddig from usb2phy to usb3otg1 controller"]
    #[inline(always)]
    pub fn is_b1(&self) -> bool {
        *self == IddigSel::B1
    }
...
#[doc = "Field `IDDIG` reader - iddig Select the value of this register to usb3otg1 register"]
pub type IddigR = crate::BitReader;
#[doc = "Field `IDDIG` writer - iddig Select the value of this register to usb3otg1 register"]
...
#[doc = "Field `SUSPEND_N_SEL1` reader - suspend_n-_sel1 Pls see suspend_n."]
pub type SuspendNSel1R = crate::BitReader;
#[doc = "Field `SUSPEND_N_SEL1` writer - suspend_n-_sel1 Pls see suspend_n."]
...
impl R {
    ...
    #[doc = "Bit 10 - iddig Select the value of this register to usb3otg1 register"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - suspend_n-_sel1 Pls see suspend_n."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn utmi_sel(&mut self) -> UtmiSelW<GrfUsb20Phy1Con1Spec> {
        UtmiSelW::new(self, 0)
    }
    #[doc = "Bit 1 - suspend_n utmi_sel=1, select the value of this register to usb2phy utmi_sel=0 and bit11 of USB20_PHY0_CON1=0, and bit 12 of USB20_PHY0_CON1=0 select the value of the value of this bit to usb2phy utmi_sel=0 and bit11 of USB20_PHY0_CON1=0, and bit 12 of USB20_PHY0_CON1=1 select suspend_n signals from usb3otg0 controller to usb2phy for free running utmi clock utmi_sel=0 and bit11 of USB20_PHY0_CON1=1, select suspend_com_n signals from usb3otg0 controller to usb2phy for not free running utmi clock"]
    #[inline(always)]
    #[must_use]
    pub fn suspend_n(&mut self) -> SuspendNW<GrfUsb20Phy1Con1Spec> {
        SuspendNW::new(self, 1)
    }
    #[doc = "Bits 2:3 - opmode Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn opmode(&mut self) -> OpmodeW<GrfUsb20Phy1Con1Spec> {
        OpmodeW::new(self, 2)
    }
    #[doc = "Bits 4:5 - xcvrselect Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn xcvrselect(&mut self) -> XcvrselectW<GrfUsb20Phy1Con1Spec> {
        XcvrselectW::new(self, 4)
    }
    #[doc = "Bit 6 - termselect Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn termselect(&mut self) -> TermselectW<GrfUsb20Phy1Con1Spec> {
        TermselectW::new(self, 6)
    }
    #[doc = "Bit 7 - dppulldown Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn dppulldown(&mut self) -> DppulldownW<GrfUsb20Phy1Con1Spec> {
        DppulldownW::new(self, 7)
    }
    #[doc = "Bit 8 - dmpulldown Select the value of this register to usb2phy when utmi_sel=1"]
    #[inline(always)]
    #[must_use]
    pub fn dmpulldown(&mut self) -> DmpulldownW<GrfUsb20Phy1Con1Spec> {
        DmpulldownW::new(self, 8)
    }
    #[doc = "Bit 9 - iddig_sel"]
    #[inline(always)]
    #[must_use]
    pub fn iddig_sel(&mut self) -> IddigSelW<GrfUsb20Phy1Con1Spec> {
        IddigSelW::new(self, 9)
    }
    #[doc = "Bit 10 - iddig Select the value of this register to usb3otg1 register"]
    #[inline(always)]
    #[must_use]
    pub fn iddig(&mut self) -> IddigW<GrfUsb20Phy1Con1Spec> {
        IddigW::new(self, 10)
    }
    #[doc = "Bit 11 - suspend_n_sel Pls see suspend_n."]
    #[inline(always)]
    #[must_use]
    pub fn suspend_n_sel(&mut self) -> SuspendNSelW<GrfUsb20Phy1Con1Spec> {
        SuspendNSelW::new(self, 11)
    }
    #[doc = "Bit 12 - suspend_n-_sel1 Pls see suspend_n."]
    #[inline(always)]
    #[must_use]
    pub fn suspend_n_sel1(&mut self) -> SuspendNSel1W<GrfUsb20Phy1Con1Spec> {
        SuspendNSel1W::new(self, 12)
    }
    #[doc = "Bits 13:28 - bit0~15 write enable When bit 16=1, bit 0 can be written by software . When bit 16=0, bit 0 cannot be written by software; When bit 17=1, bit 1 can be written by software . When bit 17=0, bit 1 cannot be written by software; ...... When bit 31=1, bit 15 can be written by software . When bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<GrfUsb20Phy1Con1Spec> {
        WriteEnableW::new(self, 13)
    }
}
#[doc = "USB20 PHY1GRF Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_usb20_phy1_con1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_usb20_phy1_con1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfUsb20Phy1Con1Spec;
impl crate::RegisterSpec for GrfUsb20Phy1Con1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_usb20_phy1_con1::R`](R) reader structure"]
impl crate::Readable for GrfUsb20Phy1Con1Spec {}
#[doc = "`write(|w| ..)` method takes [`grf_usb20_phy1_con1::W`](W) writer structure"]
impl crate::Writable for GrfUsb20Phy1Con1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_USB20_PHY1_CON1 to value 0x1452"]
impl crate::Resettable for GrfUsb20Phy1Con1Spec {
