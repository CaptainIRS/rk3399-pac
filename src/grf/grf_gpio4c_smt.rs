...
#[doc = "Field `GPIO4C_SMT` reader - GPIO schmitt trigger control, every GPIO bit corresponding to 1bits ."]
...
#[doc = "Field `GPIO4C_SMT` writer - GPIO schmitt trigger control, every GPIO bit corresponding to 1bits ."]
