#[doc = "Register `GRF_SIG_DETECT_STATUS` reader"]
pub type R = crate::R<GrfSigDetectStatusSpec>;
#[doc = "Register `GRF_SIG_DETECT_STATUS` writer"]
pub type W = crate::W<GrfSigDetectStatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdmmc_card_rise_edge(&mut self) -> SdmmcCardRiseEdgeW<GrfSigDetectStatusSpec> {
        SdmmcCardRiseEdgeW::new(self, 0)
    }
    #[doc = "Bit 1 - sdmmc card fall edge detect status"]
    #[inline(always)]
    #[must_use]
    pub fn sdmmc_card_fall_edge(&mut self) -> SdmmcCardFallEdgeW<GrfSigDetectStatusSpec> {
        SdmmcCardFallEdgeW::new(self, 1)
    }
    #[doc = "Bit 2 - cphy0_otg_linestate_change detect status"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_otg_linestate_change(
        &mut self,
    ) -> Cphy0OtgLinestateChangeW<GrfSigDetectStatusSpec> {
        Cphy0OtgLinestateChangeW::new(self, 2)
    }
    #[doc = "Bit 3 - cphy0_otg_bvalid_rise detect status"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_otg_bvalid_rise(&mut self) -> Cphy0OtgBvalidRiseW<GrfSigDetectStatusSpec> {
        Cphy0OtgBvalidRiseW::new(self, 3)
    }
    #[doc = "Bit 4 - cphy0_otg_id_rise detect status"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_otg_id_rise(&mut self) -> Cphy0OtgIdRiseW<GrfSigDetectStatusSpec> {
        Cphy0OtgIdRiseW::new(self, 4)
    }
    #[doc = "Bit 5 - cphy0_otg_id_fall detect status"]
    #[inline(always)]
    #[must_use]
    pub fn cphy0_otg_id_fall(&mut self) -> Cphy0OtgIdFallW<GrfSigDetectStatusSpec> {
    ...
    pub fn cphy0_host_linestate_change(
        &mut self,
    ) -> Cphy0HostLinestateChangeW<GrfSigDetectStatusSpec> {
        Cphy0HostLinestateChangeW::new(self, 6)
    }
    #[doc = "Bit 7 - cphy1_otg_linestate_change detect status"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_otg_linestate_change(
        &mut self,
    ) -> Cphy1OtgLinestateChangeW<GrfSigDetectStatusSpec> {
        Cphy1OtgLinestateChangeW::new(self, 7)
    }
    #[doc = "Bit 8 - cphy1_otg_bvalid_rise detect status"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_otg_bvalid_rise(&mut self) -> Cphy1OtgBvalidRiseW<GrfSigDetectStatusSpec> {
        Cphy1OtgBvalidRiseW::new(self, 8)
    }
    #[doc = "Bit 9 - cphy1_otg_id_rise detect status"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_otg_id_rise(&mut self) -> Cphy1OtgIdRiseW<GrfSigDetectStatusSpec> {
        Cphy1OtgIdRiseW::new(self, 9)
    }
    #[doc = "Bit 10 - cphy1_otg_id_fall detect status"]
    #[inline(always)]
    #[must_use]
    pub fn cphy1_otg_id_fall(&mut self) -> Cphy1OtgIdFallW<GrfSigDetectStatusSpec> {
    ...
    pub fn cphy1_host_linestate_change(
        &mut self,
    ) -> Cphy1HostLinestateChangeW<GrfSigDetectStatusSpec> {
        Cphy1HostLinestateChangeW::new(self, 11)
    }
    #[doc = "Bit 12 - uphy0_rxdet_change detect status"]
    #[inline(always)]
    #[must_use]
    pub fn uphy0_rxdet_change(&mut self) -> Uphy0RxdetChangeW<GrfSigDetectStatusSpec> {
        Uphy0RxdetChangeW::new(self, 12)
    }
    #[doc = "Bit 13 - uphy1_rxdet_change detect status"]
    #[inline(always)]
    #[must_use]
    pub fn uphy1_rxdet_change(&mut self) -> Uphy1RxdetChangeW<GrfSigDetectStatusSpec> {
        Uphy1RxdetChangeW::new(self, 13)
    }
}
#[doc = "Signal detect status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grf_sig_detect_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grf_sig_detect_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrfSigDetectStatusSpec;
impl crate::RegisterSpec for GrfSigDetectStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grf_sig_detect_status::R`](R) reader structure"]
impl crate::Readable for GrfSigDetectStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`grf_sig_detect_status::W`](W) writer structure"]
impl crate::Writable for GrfSigDetectStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRF_SIG_DETECT_STATUS to value 0"]
impl crate::Resettable for GrfSigDetectStatusSpec {
