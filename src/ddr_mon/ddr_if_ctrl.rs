#[doc = "Register `DDR_IF_CTRL` reader"]
pub type R = crate::R<DdrIfCtrlSpec>;
#[doc = "Register `DDR_IF_CTRL` writer"]
pub type W = crate::W<DdrIfCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0_direction(&mut self) -> Ch0DirectionW<DdrIfCtrlSpec> {
        Ch0DirectionW::new(self, 0)
    }
    #[doc = "Bit 1 - Write or read monitor in channel 1 for command statistics"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_direction(&mut self) -> Ch1DirectionW<DdrIfCtrlSpec> {
        Ch1DirectionW::new(self, 1)
    }
    #[doc = "Bit 2 - DDR interface and DFI monitor enable"]
    #[inline(always)]
    #[must_use]
    pub fn if_mon_en(&mut self) -> IfMonEnW<DdrIfCtrlSpec> {
        IfMonEnW::new(self, 2)
    }
    #[doc = "Bits 16:31 - bit0~15 write enable\n\nWhen bit 16=1, bit 0 can be written by software.\n\nWhen bit 16=0, bit 0 cannot be written by software;\n\nWhen bit 17=1, bit 1 can be written by software.\n\nWhen bit 17=0, bit 1 cannot be written by software;\n\n......\n\nWhen bit 31=1, bit 15 can be written by software.\n\nWhen bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<DdrIfCtrlSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "DDR interface Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddr_if_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddr_if_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdrIfCtrlSpec;
impl crate::RegisterSpec for DdrIfCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddr_if_ctrl::R`](R) reader structure"]
impl crate::Readable for DdrIfCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ddr_if_ctrl::W`](W) writer structure"]
impl crate::Writable for DdrIfCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDR_IF_CTRL to value 0"]
impl crate::Resettable for DdrIfCtrlSpec {
