#[doc = "Register `GSBUSCFG1` reader"]
pub type R = crate::R<Gsbuscfg1Spec>;
#[doc = "Register `GSBUSCFG1` writer"]
pub type W = crate::W<Gsbuscfg1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pipetranslimit(&mut self) -> PipetranslimitW<Gsbuscfg1Spec> {
        PipetranslimitW::new(self, 8)
    }
    #[doc = "Bit 12 - 1K Page Boundary Enable\n\nBy default (this bit is disabled) the AXI breaks transfers at the 4k\n\npage boundary. When this bit is enabled, the AXI master (DMA\n\ndata) breaks transfers at the 1k page boundary."]
    #[inline(always)]
    #[must_use]
    pub fn en1kpage(&mut self) -> En1kpageW<Gsbuscfg1Spec> {
        En1kpageW::new(self, 12)
    }
}
#[doc = "Global SoC Bus Configuration Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gsbuscfg1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gsbuscfg1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gsbuscfg1Spec;
impl crate::RegisterSpec for Gsbuscfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gsbuscfg1::R`](R) reader structure"]
impl crate::Readable for Gsbuscfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`gsbuscfg1::W`](W) writer structure"]
impl crate::Writable for Gsbuscfg1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GSBUSCFG1 to value 0x0300"]
impl crate::Resettable for Gsbuscfg1Spec {
