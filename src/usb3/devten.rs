#[doc = "Register `DEVTEN` reader"]
pub type R = crate::R<DevtenSpec>;
#[doc = "Register `DEVTEN` writer"]
pub type W = crate::W<DevtenSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dissconnevten(&mut self) -> DissconnevtenW<DevtenSpec> {
        DissconnevtenW::new(self, 0)
    }
    #[doc = "Bit 1 - USB Reset Event Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usbrstevten(&mut self) -> UsbrstevtenW<DevtenSpec> {
        UsbrstevtenW::new(self, 1)
    }
    #[doc = "Bit 2 - Connection Done Event Enable"]
    #[inline(always)]
    #[must_use]
    pub fn connectdoneevten(&mut self) -> ConnectdoneevtenW<DevtenSpec> {
        ConnectdoneevtenW::new(self, 2)
    }
    #[doc = "Bit 3 - USB/Link State Change Event Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ulstcngen(&mut self) -> UlstcngenW<DevtenSpec> {
        UlstcngenW::new(self, 3)
    }
    #[doc = "Bit 4 - Resume/Remote Wakeup Detected Event Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wkupevten(&mut self) -> WkupevtenW<DevtenSpec> {
        WkupevtenW::new(self, 4)
    }
    #[doc = "Bit 5 - Hibernation Request Event Enable"]
    #[inline(always)]
    #[must_use]
    pub fn hibernationreqevten(&mut self) -> HibernationreqevtenW<DevtenSpec> {
        HibernationreqevtenW::new(self, 5)
    }
    #[doc = "Bit 6 - U3/L2-L1 Suspend Event Enable"]
    #[inline(always)]
    #[must_use]
    pub fn u3l2l1suspen(&mut self) -> U3l2l1suspenW<DevtenSpec> {
        U3l2l1suspenW::new(self, 6)
    }
    #[doc = "Bit 7 - Start of (u)frame Event Enable"]
    #[inline(always)]
    #[must_use]
    pub fn softevten(&mut self) -> SoftevtenW<DevtenSpec> {
        SoftevtenW::new(self, 7)
    }
    #[doc = "Bit 9 - Erratic Error Event Enable"]
    #[inline(always)]
    #[must_use]
    pub fn errticerrevten(&mut self) -> ErrticerrevtenW<DevtenSpec> {
        ErrticerrevtenW::new(self, 9)
    }
    #[doc = "Bit 12 - Vendor Device Test LMP Received Event"]
    #[inline(always)]
    #[must_use]
    pub fn vendevtstrcvden(&mut self) -> VendevtstrcvdenW<DevtenSpec> {
        VendevtstrcvdenW::new(self, 12)
    }
}
#[doc = "Device Event Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`devten::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`devten::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DevtenSpec;
impl crate::RegisterSpec for DevtenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devten::R`](R) reader structure"]
impl crate::Readable for DevtenSpec {}
#[doc = "`write(|w| ..)` method takes [`devten::W`](W) writer structure"]
impl crate::Writable for DevtenSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DEVTEN to value 0"]
impl crate::Resettable for DevtenSpec {
