...
#[doc = "Field `RXFDEP_N` reader - RxFIFO Depth This field contains the depth of RxFIFOn in 64-bit words. Minimum value: 32; Maximum value: 16,384"]
pub type RxfdepNR = crate::FieldReader<u16>;
#[doc = "Field `RXFDEP_N` writer - RxFIFO Depth This field contains the depth of RxFIFOn in 64-bit words. Minimum value: 32; Maximum value: 16,384"]
pub type RxfdepNW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `RXFSTADDR_N` reader - RxFIFOn RAM Start Address This field contains the memory start address for RxFIFOn in 64- bit words."]
pub type RxfstaddrNR = crate::FieldReader<u16>;
#[doc = "Field `RXFSTADDR_N` writer - RxFIFOn RAM Start Address This field contains the memory start address for RxFIFOn in 64- bit words."]
pub type RxfstaddrNW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - RxFIFO Depth This field contains the depth of RxFIFOn in 64-bit words. Minimum value: 32; Maximum value: 16,384"]
    #[inline(always)]
    pub fn rxfdep_n(&self) -> RxfdepNR {
        RxfdepNR::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - RxFIFOn RAM Start Address This field contains the memory start address for RxFIFOn in 64- bit words."]
    #[inline(always)]
