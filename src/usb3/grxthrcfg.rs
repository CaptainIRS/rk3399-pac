#[doc = "Register `GRXTHRCFG` reader"]
pub type R = crate::R<GrxthrcfgSpec>;
#[doc = "Register `GRXTHRCFG` writer"]
pub type W = crate::W<GrxthrcfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbmaxrxburstsize(&mut self) -> UsbmaxrxburstsizeW<GrxthrcfgSpec> {
        UsbmaxrxburstsizeW::new(self, 19)
    }
    #[doc = "Bits 24:27 - USB Receive Packet Count\n\nIn host mode, this field specifies the space (in terms of the\n\nnumber of packets) that must be available in the RX FIFO before\n\nthe core can start the corresponding USB RX transaction (burst).\n\nIn device mode, this field specifies the space (in terms of the\n\nnumber of packets) that must be available in the RX FIFO before\n\nthe core can send ERDY for a flow-controlled endpoint.\n\nThis field is valid only when the USB Receive Packet Count Enable\n\nfield is set to 1. The valid values for this field are from 1 to 15.\n\nNote: This field must be less than or equal to the USB Maximum\n\nReceive Burst Size field."]
    #[inline(always)]
    #[must_use]
    pub fn usbrxpktcnt(&mut self) -> UsbrxpktcntW<GrxthrcfgSpec> {
        UsbrxpktcntW::new(self, 24)
    }
    #[doc = "Bit 29 - USB ReceivePacket Count Enable\n\nThis field enables/disables the USB reception multi-packet\n\nthresholding:"]
    #[inline(always)]
    #[must_use]
    pub fn usbrxpktcntsel(&mut self) -> UsbrxpktcntselW<GrxthrcfgSpec> {
        UsbrxpktcntselW::new(self, 29)
    }
}
#[doc = "Global Rx Threshold Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`grxthrcfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`grxthrcfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GrxthrcfgSpec;
impl crate::RegisterSpec for GrxthrcfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grxthrcfg::R`](R) reader structure"]
impl crate::Readable for GrxthrcfgSpec {}
#[doc = "`write(|w| ..)` method takes [`grxthrcfg::W`](W) writer structure"]
impl crate::Writable for GrxthrcfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GRXTHRCFG to value 0"]
impl crate::Resettable for GrxthrcfgSpec {
