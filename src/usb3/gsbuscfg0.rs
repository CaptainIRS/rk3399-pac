#[doc = "Register `GSBUSCFG0` reader"]
pub type R = crate::R<Gsbuscfg0Spec>;
#[doc = "Register `GSBUSCFG0` writer"]
pub type W = crate::W<Gsbuscfg0Spec>;
...
enables (INCR256/128/64/32/16/8/4)."]
    #[inline(always)]
    #[must_use]
    pub fn incrbrstena(&mut self) -> IncrbrstenaW<Gsbuscfg0Spec> {
        IncrbrstenaW::new(self, 0)
    }
    #[doc = "Bit 1 - INCR4 Burst Type Enable\n\nWhen this bit is enabled the controller is allowed to do bursts of\n\nbeat length 1, 2, 3, and 4. It is highly recommended that this bit\n\nis enabled to prevent descriptor reads and writes from being\n\nbroken up into separate transfers."]
    #[inline(always)]
    #[must_use]
    pub fn incr4brstena(&mut self) -> Incr4brstenaW<Gsbuscfg0Spec> {
        Incr4brstenaW::new(self, 1)
    }
    #[doc = "Bit 2 - INCR8 Burst Type Enable\n\nIf software set this bit to 1, the AXI master uses INCR to do the\n\n8-beat burst."]
    #[inline(always)]
    #[must_use]
    pub fn incr8brstena(&mut self) -> Incr8brstenaW<Gsbuscfg0Spec> {
        Incr8brstenaW::new(self, 2)
    }
    #[doc = "Bit 3 - INCR16 Burst Type Enable\n\nIf software set this bit to 1, the AXI master uses INCR to do the\n\n16-beat burst."]
    #[inline(always)]
    #[must_use]
    pub fn incr16brstena(&mut self) -> Incr16brstenaW<Gsbuscfg0Spec> {
        Incr16brstenaW::new(self, 3)
    }
    #[doc = "Bit 4 - INCR32 Burst Type Enable\n\nIf software set this bit to 1, the AXI master uses INCR to do the\n\n32-beat burst."]
    #[inline(always)]
    #[must_use]
    pub fn incr32brstena(&mut self) -> Incr32brstenaW<Gsbuscfg0Spec> {
        Incr32brstenaW::new(self, 4)
    }
    #[doc = "Bit 5 - INCR64 Burst Type Enable\n\nIf software set this bit to 1, AXI master uses INCR to do the 64-\n\nbeat burst."]
    #[inline(always)]
    #[must_use]
    pub fn incr64brstena(&mut self) -> Incr64brstenaW<Gsbuscfg0Spec> {
        Incr64brstenaW::new(self, 5)
    }
    #[doc = "Bit 6 - INCR128 Burst Type Enable\n\nIf software set this bit to 1, the AXI master uses INCR to do the\n\n128-beat burst."]
    #[inline(always)]
    #[must_use]
    pub fn incr128brstena(&mut self) -> Incr128brstenaW<Gsbuscfg0Spec> {
        Incr128brstenaW::new(self, 6)
    }
    #[doc = "Bit 7 - INCR256 Burst Type Enable\n\nIf software set this bit to 1, the AXI master uses INCR to do the\n\n256-beat burst."]
    #[inline(always)]
    #[must_use]
    pub fn incr256brstena(&mut self) -> Incr256brstenaW<Gsbuscfg0Spec> {
        Incr256brstenaW::new(self, 7)
    }
    #[doc = "Bit 10 - Descriptor Access is Big Endian\n\nThis bit controls the endian mode for descriptor accesses. 0,\n\nLittle-endian (default); 1, Big-endian."]
    #[inline(always)]
    #[must_use]
    pub fn desbigend(&mut self) -> DesbigendW<Gsbuscfg0Spec> {
        DesbigendW::new(self, 10)
    }
    #[doc = "Bit 11 - Data Access is Big Endian\n\nThis bit controls the endian mode for data accesses.0, Little-\n\nendian (default); 1, Big-endian;"]
    #[inline(always)]
    #[must_use]
    pub fn datbigend(&mut self) -> DatbigendW<Gsbuscfg0Spec> {
        DatbigendW::new(self, 11)
    }
    #[doc = "Bits 16:19 - DESWRREQINFO\n\nAXI-cache for Descriptor Write (DesWrReqInfo)"]
    #[inline(always)]
    #[must_use]
    pub fn deswrreqinfo(&mut self) -> DeswrreqinfoW<Gsbuscfg0Spec> {
        DeswrreqinfoW::new(self, 16)
    }
    #[doc = "Bits 20:23 - DATWRREQINFO\n\nAXI-cache for Data Write (DatWrReqInfo)."]
    #[inline(always)]
    #[must_use]
    pub fn datwrreqinfo(&mut self) -> DatwrreqinfoW<Gsbuscfg0Spec> {
        DatwrreqinfoW::new(self, 20)
    }
    #[doc = "Bits 24:27 - DESRDREQINFO\n\nAXI-cache for Descriptor Read (DesRdReqInfo)."]
    #[inline(always)]
    #[must_use]
    pub fn desrdreqinfo(&mut self) -> DesrdreqinfoW<Gsbuscfg0Spec> {
        DesrdreqinfoW::new(self, 24)
    }
    #[doc = "Bits 28:31 - DATRDREQINFO\n\nAXI-cache for Data Read (DatRdReqInfo)"]
    #[inline(always)]
    #[must_use]
    pub fn datrdreqinfo(&mut self) -> DatrdreqinfoW<Gsbuscfg0Spec> {
        DatrdreqinfoW::new(self, 28)
    }
}
#[doc = "Global SoC Bus Configuration Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gsbuscfg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gsbuscfg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gsbuscfg0Spec;
impl crate::RegisterSpec for Gsbuscfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gsbuscfg0::R`](R) reader structure"]
impl crate::Readable for Gsbuscfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`gsbuscfg0::W`](W) writer structure"]
impl crate::Writable for Gsbuscfg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GSBUSCFG0 to value 0x01"]
impl crate::Resettable for Gsbuscfg0Spec {
