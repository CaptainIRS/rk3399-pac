...
#[doc = "Field `PARAMETER` reader - PARAMETER This register indicates the physical endpoint command Parameter 1. It must be programmed before issuing the command."]
pub type ParameterR = crate::FieldReader<u32>;
#[doc = "Field `PARAMETER` writer - PARAMETER This register indicates the physical endpoint command Parameter 1. It must be programmed before issuing the command."]
pub type ParameterW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - PARAMETER This register indicates the physical endpoint command Parameter 1. It must be programmed before issuing the command."]
    #[inline(always)]
