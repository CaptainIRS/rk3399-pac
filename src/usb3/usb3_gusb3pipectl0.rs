...
#[doc = "Field `ELASTIC_BUFFER_MODE` reader - Elastic Buffer Mode Drive the setting value to the pipe interface of PHY."]
pub type ElasticBufferModeR = crate::BitReader;
#[doc = "Field `ELASTIC_BUFFER_MODE` writer - Elastic Buffer Mode Drive the setting value to the pipe interface of PHY."]
pub type ElasticBufferModeW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_DE_EPPHASIS` reader - Tx Deemphasis The value driven to the PHY is controlled by the LTSSM during USB3 Compliance mode."]
pub type TxDeEpphasisR = crate::FieldReader;
#[doc = "Field `TX_DE_EPPHASIS` writer - Tx Deemphasis The value driven to the PHY is controlled by the LTSSM during USB3 Compliance mode."]
...
#[doc = "Field `TX_SWING` reader - Tx Swing Drive the setting value to the pipe interface of PHY."]
pub type TxSwingR = crate::BitReader;
#[doc = "Field `TX_SWING` writer - Tx Swing Drive the setting value to the pipe interface of PHY."]
pub type TxSwingW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RX_DETECT_TO_POLLING_L` reader - RX_DETECT to Polling.LFPS Control 1'b0 (Default): Enables a 400us delay to start Polling LFPS after RX_DETECT. This allows VCM offset to settle to a proper level. 1'b1: Disables the 400us delay to start Polling LFPS after RX_DETECT. During controller certification with third party PHY it is observed that the PHY is not able to meet the Tx AC common mode voltage active (VTX-CM-ACPP_ACTIVE &lt;100mv) if the link starts polling within 80us from the time rx.detect is performed. To meet this VTX-CM-ACPP_ACTIVE specification, the polling must be delayed further. If the PHY does not have issue then they can set this bit to 1 which allows polling to start within 80us."]
pub type RxDetectToPollingLR = crate::BitReader;
#[doc = "Field `RX_DETECT_TO_POLLING_L` writer - RX_DETECT to Polling.LFPS Control 1'b0 (Default): Enables a 400us delay to start Polling LFPS after RX_DETECT. This allows VCM offset to settle to a proper level. 1'b1: Disables the 400us delay to start Polling LFPS after RX_DETECT. During controller certification with third party PHY it is observed that the PHY is not able to meet the Tx AC common mode voltage active (VTX-CM-ACPP_ACTIVE &lt;100mv) if the link starts polling within 80us from the time rx.detect is performed. To meet this VTX-CM-ACPP_ACTIVE specification, the polling must be delayed further. If the PHY does not have issue then they can set this bit to 1 which allows polling to start within 80us."]
pub type RxDetectToPollingLW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LFPSFILTER` reader - LFPS Filter When set, filter LFPS reception with pipe3_RxValid in PHY power state P0, that is, ignore LFPS reception from the PHY unless both pipe3_Rxelecidle and pipe3_RxValid are deasserted."]
pub type LfpsfilterR = crate::BitReader;
#[doc = "Field `LFPSFILTER` writer - LFPS Filter When set, filter LFPS reception with pipe3_RxValid in PHY power state P0, that is, ignore LFPS reception from the PHY unless both pipe3_Rxelecidle and pipe3_RxValid are deasserted."]
pub type LfpsfilterW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3EXSIGP2` reader - P3 Exit Signal in P2 When this bit is set, the core always changes the PHY power state to P2, before attempting a U3 exit handshake."]
pub type P3exsigp2R = crate::BitReader;
#[doc = "Field `P3EXSIGP2` writer - P3 Exit Signal in P2 When this bit is set, the core always changes the PHY power state to P2, before attempting a U3 exit handshake."]
pub type P3exsigp2W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3P2TRANOK` reader - P3 P2 Transitions OK When set, the core transitions directly from Phy power state P2 to P3 or from state P3 to P2. When not set, P0 is always entered as an intermediate state during transitions between P2 and P3, as defined in the PIPE3 Specification. According to the PIPE3 Specification, any direct transition between P3 and P2 is illegal."]
pub type P3p2tranokR = crate::BitReader;
#[doc = "Field `P3P2TRANOK` writer - P3 P2 Transitions OK When set, the core transitions directly from Phy power state P2 to P3 or from state P3 to P2. When not set, P0 is always entered as an intermediate state during transitions between P2 and P3, as defined in the PIPE3 Specification. According to the PIPE3 Specification, any direct transition between P3 and P2 is illegal."]
pub type P3p2tranokW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LFPSP0ALGN` reader - LFPS P0 Align When set: 1. The core deasserts LFPS transmission on the clock edge that it requests Phy power state 0 when exiting U1, U2, or U3 low power states. Otherwise, LFPS transmission is asserted one clock earlier. 2. The core requests symbol transmission two pipe3_rx_pclks periods after the PHY asserts PhyStatus as a result of the PHY switching from P1 or P2 state to P0 state."]
pub type Lfpsp0algnR = crate::BitReader;
#[doc = "Field `LFPSP0ALGN` writer - LFPS P0 Align When set: 1. The core deasserts LFPS transmission on the clock edge that it requests Phy power state 0 when exiting U1, U2, or U3 low power states. Otherwise, LFPS transmission is asserted one clock earlier. 2. The core requests symbol transmission two pipe3_rx_pclks periods after the PHY asserts PhyStatus as a result of the PHY switching from P1 or P2 state to P0 state."]
pub type Lfpsp0algnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SKIPRXDET` reader - Skip Rx Detect When set, the core skips Rx Detection if pipe3_RxElecIdle is low. Skip is defined as waiting for the appropriate timeout, then repeating the operation."]
pub type SkiprxdetR = crate::BitReader;
#[doc = "Field `SKIPRXDET` writer - Skip Rx Detect When set, the core skips Rx Detection if pipe3_RxElecIdle is low. Skip is defined as waiting for the appropriate timeout, then repeating the operation."]
pub type SkiprxdetW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ABORTRXDETINU2` reader - Abort Rx Detect in U2 When set and the link state is U2, then the core will abort receiver detection if it receives U2 exit LFPS from the remote link partner. This bit is for the downstream port only."]
pub type Abortrxdetinu2R = crate::BitReader;
#[doc = "Field `ABORTRXDETINU2` writer - Abort Rx Detect in U2 When set and the link state is U2, then the core will abort receiver detection if it receives U2 exit LFPS from the remote link partner. This bit is for the downstream port only."]
pub type Abortrxdetinu2W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "PIPE Data Width\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Datwidth {
    #[doc = "0: 8 bits Note: USB3 controller only support 32-bit width pipe interface."]
    B00 = 0,
    #[doc = "1: 8 bits Note: USB3 controller only support 32-bit width pipe interface."]
    B01 = 1,
...
#[doc = "Field `DELAYP1TRANS` reader - DELAYP1TRANS Delay PHY power change from P0 to P1/P2/P3 when link state changing from U0 to U1/U2/U3 respectively."]
...
#[doc = "Field `DELAYP1TRANS` writer - DELAYP1TRANS Delay PHY power change from P0 to P1/P2/P3 when link state changing from U0 to U1/U2/U3 respectively."]
...
#[doc = "Field `DELAYP1P2P3` reader - Delay P1P2P3 Delay P0 to P1/P2/P3 request when entering U1/U2/U3 until (DWC_USB3_GUSB3PIPECTL_INIT\\[21:19\\]*8) 8B10B error occurs, or Pipe3_RxValid drops to 0. DWC_USB3_GUSB3PIPECTL_INIT\\[18\\]
must be 1 to enable this functionality."]
pub type Delayp1p2p3R = crate::FieldReader;
#[doc = "Field `DELAYP1P2P3` writer - Delay P1P2P3 Delay P0 to P1/P2/P3 request when entering U1/U2/U3 until (DWC_USB3_GUSB3PIPECTL_INIT\\[21:19\\]*8) 8B10B error occurs, or Pipe3_RxValid drops to 0. DWC_USB3_GUSB3PIPECTL_INIT\\[18\\]
must be 1 to enable this functionality."]
pub type Delayp1p2p3W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `DISRXDETU3RXDET` reader - Disable Receiver Detection in U3/Rx.Det When set, the core does not handle receiver detection in either U3 or Rx.Detect states. DWC_USB3_GUSB3PIPECTL_INIT\\[23\\]
must be used to start receiver detection manually. This bit can only be used for the downstream port. This bit must be set to 0 for Upstream ports."]
pub type Disrxdetu3rxdetR = crate::BitReader;
#[doc = "Field `DISRXDETU3RXDET` writer - Disable Receiver Detection in U3/Rx.Det When set, the core does not handle receiver detection in either U3 or Rx.Detect states. DWC_USB3_GUSB3PIPECTL_INIT\\[23\\]
must be used to start receiver detection manually. This bit can only be used for the downstream port. This bit must be set to 0 for Upstream ports."]
pub type Disrxdetu3rxdetW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `STARTRXDETU3RXDET` reader - Start Receiver Detection in U3/Rx.Detect If DWC_USB3_GUSB3PIPECTL_INIT\\[22\\]
is set, and the link is in either U3 or Rx.Detect state, the core starts receiver detection on the rising edge of this bit. This can only be used for Downstream ports. This bit must be set to 0 for Upstream ports."]
pub type Startrxdetu3rxdetR = crate::BitReader;
#[doc = "Field `STARTRXDETU3RXDET` writer - Start Receiver Detection in U3/Rx.Detect If DWC_USB3_GUSB3PIPECTL_INIT\\[22\\]
is set, and the link is in either U3 or Rx.Detect state, the core starts receiver detection on the rising edge of this bit. This can only be used for Downstream ports. This bit must be set to 0 for Upstream ports."]
pub type Startrxdetu3rxdetW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REQUEST_P1P2P3` reader - Always Request P1/P2/P3 for U1/U2/U3 When set, the core always requests PHY power change from P0 to P1/P2/P3 during U0 to U1/U2/U3 transition. If this bit is 0, and immediate Ux exit (remotely initiated, or locally initiated) happens, the core does not request P1/P2/P3 power state change. Note: This bit must be set to 1 for Synopsys PHY. For third-party SS PHY, check with your PHY vendor."]
pub type RequestP1p2p3R = crate::BitReader;
#[doc = "Field `REQUEST_P1P2P3` writer - Always Request P1/P2/P3 for U1/U2/U3 When set, the core always requests PHY power change from P0 to P1/P2/P3 during U0 to U1/U2/U3 transition. If this bit is 0, and immediate Ux exit (remotely initiated, or locally initiated) happens, the core does not request P1/P2/P3 power state change. Note: This bit must be set to 1 for Synopsys PHY. For third-party SS PHY, check with your PHY vendor."]
pub type RequestP1p2p3W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `U1U2EXITFAIL_TO_RECOV` reader - U1U2exitfail to Recovery When set, and U1/U2 LFPS handshake fails, the LTSSM transitions from U1/U2 to Recovery instead of SS Inactive. If Recovery fails, then the LTSSM can enter SS.Inactive. This is an enhancement only. It prevents interoperability issue if the remote link does not do proper handshake."]
pub type U1u2exitfailToRecovR = crate::BitReader;
#[doc = "Field `U1U2EXITFAIL_TO_RECOV` writer - U1U2exitfail to Recovery When set, and U1/U2 LFPS handshake fails, the LTSSM transitions from U1/U2 to Recovery instead of SS Inactive. If Recovery fails, then the LTSSM can enter SS.Inactive. This is an enhancement only. It prevents interoperability issue if the remote link does not do proper handshake."]
pub type U1u2exitfailToRecovW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PING_ENHANCEMENT_EN` reader - Ping Enhancement Enable When set, the Downstream port U1 ping receive timeout becomes 500 ms instead of 300 ms. Minimum Ping.LFPS receive duration is 8 ns (one mac3_clk). This field is valid for the downstream port only."]
pub type PingEnhancementEnR = crate::BitReader;
#[doc = "Field `PING_ENHANCEMENT_EN` writer - Ping Enhancement Enable When set, the Downstream port U1 ping receive timeout becomes 500 ms instead of 300 ms. Minimum Ping.LFPS receive duration is 8 ns (one mac3_clk). This field is valid for the downstream port only."]
pub type PingEnhancementEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Ux Exit in Px\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UxExitInPx {
    #[doc = "0: The core does U1/U2/U3 exit in PHY power state P1/P2/P3 respectively. This bit is added for SS PHY workaround where SS PHY injects a glitch on pipe3_RxElecIdle while receiving Ux exit LFPS, and pipe3_PowerDown change is in progress."]
    B0 = 0,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Disrxdetp3 {
    #[doc = "0: If PHY is in P3 and Core needs to perform receiver detection, The core changes the PHY power state to P2 and then performs receiver detection. After receiver detection, the cores changes PHY power state to P3."]
    B0 = 0,
...
pub enum U2ssinactp3ok {
    #[doc = "0: During link state U2/SS.Inactive, put PHY in P3. Note: For a port, if GUSB3PIPECTL\\[7\\]=1 and GUSB3PIPECTL\\[29\\]=1, set GUSB3PIPECTL\\[11\\]
to 1."]
    B0 = 0,
...
Drive the setting value to the pipe interface of PHY."]
    ...
    #[doc = "Bit 6 - Tx Swing Drive the setting value to the pipe interface of PHY."]
    #[inline(always)]
    pub fn tx_swing(&self) -> TxSwingR {
        TxSwingR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 8 - RX_DETECT to Polling.LFPS Control 1'b0 (Default): Enables a 400us delay to start Polling LFPS after RX_DETECT. This allows VCM offset to settle to a proper level. 1'b1: Disables the 400us delay to start Polling LFPS after RX_DETECT. During controller certification with third party PHY it is observed that the PHY is not able to meet the Tx AC common mode voltage active (VTX-CM-ACPP_ACTIVE &lt;100mv) if the link starts polling within 80us from the time rx.detect is performed. To meet this VTX-CM-ACPP_ACTIVE specification, the polling must be delayed further. If the PHY does not have issue then they can set this bit to 1 which allows polling to start within 80us."]
    #[inline(always)]
    pub fn rx_detect_to_polling_l(&self) -> RxDetectToPollingLR {
        RxDetectToPollingLR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - LFPS Filter When set, filter LFPS reception with pipe3_RxValid in PHY power state P0, that is, ignore LFPS reception from the PHY unless both pipe3_Rxelecidle and pipe3_RxValid are deasserted."]
    #[inline(always)]
    pub fn lfpsfilter(&self) -> LfpsfilterR {
        LfpsfilterR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - P3 Exit Signal in P2 When this bit is set, the core always changes the PHY power state to P2, before attempting a U3 exit handshake."]
    #[inline(always)]
    pub fn p3exsigp2(&self) -> P3exsigp2R {
        P3exsigp2R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - P3 P2 Transitions OK When set, the core transitions directly from Phy power state P2 to P3 or from state P3 to P2. When not set, P0 is always entered as an intermediate state during transitions between P2 and P3, as defined in the PIPE3 Specification. According to the PIPE3 Specification, any direct transition between P3 and P2 is illegal."]
    #[inline(always)]
    pub fn p3p2tranok(&self) -> P3p2tranokR {
        P3p2tranokR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - LFPS P0 Align When set: 1. The core deasserts LFPS transmission on the clock edge that it requests Phy power state 0 when exiting U1, U2, or U3 low power states. Otherwise, LFPS transmission is asserted one clock earlier. 2. The core requests symbol transmission two pipe3_rx_pclks periods after the PHY asserts PhyStatus as a result of the PHY switching from P1 or P2 state to P0 state."]
    #[inline(always)]
    pub fn lfpsp0algn(&self) -> Lfpsp0algnR {
        Lfpsp0algnR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Skip Rx Detect When set, the core skips Rx Detection if pipe3_RxElecIdle is low. Skip is defined as waiting for the appropriate timeout, then repeating the operation."]
    #[inline(always)]
    pub fn skiprxdet(&self) -> SkiprxdetR {
        SkiprxdetR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Abort Rx Detect in U2 When set and the link state is U2, then the core will abort receiver detection if it receives U2 exit LFPS from the remote link partner. This bit is for the downstream port only."]
    #[inline(always)]
    ...
    #[doc = "Bit 17 - Suspend USB3.0 SS PHY When set, and if Suspend conditions are valid, the USB 3.0 PHY enters Suspend mode. For DRD/OTG configurations, it is recommended that this bit is set to '0' during coreConsultant configuration. If it is set to '1', then the application must clear this bit after power-on reset. Application needs to set it to '1' after the core initialization is completed. For all other configurations, this bit can be set to '1' during core configuration."]
    #[inline(always)]
    pub fn suspendenable(&self) -> SuspendenableR {
        SuspendenableR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - DELAYP1TRANS Delay PHY power change from P0 to P1/P2/P3 when link state changing from U0 to U1/U2/U3 respectively."]
    #[inline(always)]
    pub fn delayp1trans(&self) -> Delayp1transR {
        Delayp1transR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bits 19:21 - Delay P1P2P3 Delay P0 to P1/P2/P3 request when entering U1/U2/U3 until (DWC_USB3_GUSB3PIPECTL_INIT\\[21:19\\]*8) 8B10B error occurs, or Pipe3_RxValid drops to 0. DWC_USB3_GUSB3PIPECTL_INIT\\[18\\]
must be 1 to enable this functionality."]
    #[inline(always)]
    pub fn delayp1p2p3(&self) -> Delayp1p2p3R {
        Delayp1p2p3R::new(((self.bits >> 19) & 7) as u8)
    }
    #[doc = "Bit 22 - Disable Receiver Detection in U3/Rx.Det When set, the core does not handle receiver detection in either U3 or Rx.Detect states. DWC_USB3_GUSB3PIPECTL_INIT\\[23\\]
must be used to start receiver detection manually. This bit can only be used for the downstream port. This bit must be set to 0 for Upstream ports."]
    #[inline(always)]
    pub fn disrxdetu3rxdet(&self) -> Disrxdetu3rxdetR {
        Disrxdetu3rxdetR::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Start Receiver Detection in U3/Rx.Detect If DWC_USB3_GUSB3PIPECTL_INIT\\[22\\]
is set, and the link is in either U3 or Rx.Detect state, the core starts receiver detection on the rising edge of this bit. This can only be used for Downstream ports. This bit must be set to 0 for Upstream ports."]
    #[inline(always)]
    pub fn startrxdetu3rxdet(&self) -> Startrxdetu3rxdetR {
        Startrxdetu3rxdetR::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - Always Request P1/P2/P3 for U1/U2/U3 When set, the core always requests PHY power change from P0 to P1/P2/P3 during U0 to U1/U2/U3 transition. If this bit is 0, and immediate Ux exit (remotely initiated, or locally initiated) happens, the core does not request P1/P2/P3 power state change. Note: This bit must be set to 1 for Synopsys PHY. For third-party SS PHY, check with your PHY vendor."]
    #[inline(always)]
    pub fn request_p1p2p3(&self) -> RequestP1p2p3R {
        RequestP1p2p3R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - U1U2exitfail to Recovery When set, and U1/U2 LFPS handshake fails, the LTSSM transitions from U1/U2 to Recovery instead of SS Inactive. If Recovery fails, then the LTSSM can enter SS.Inactive. This is an enhancement only. It prevents interoperability issue if the remote link does not do proper handshake."]
    #[inline(always)]
    pub fn u1u2exitfail_to_recov(&self) -> U1u2exitfailToRecovR {
        U1u2exitfailToRecovR::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - Ping Enhancement Enable When set, the Downstream port U1 ping receive timeout becomes 500 ms instead of 300 ms. Minimum Ping.LFPS receive duration is 8 ns (one mac3_clk). This field is valid for the downstream port only."]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - HstPrtCmpl This feature tests the PIPE PHY compliance patterns without having to have a test fixture on the USB 3.0 cable. This bit enables placing the SS port link into a compliance state. By default, this bit must be set to 1'b0. In compliance lab testing, the SS port link enters compliance after failing the first polling sequence after power on. Set this bit to 0, when you run compliance tests. The sequence for using this functionality is as follows: 1. Disconnect any plugged in devices. 2. Perform USBCMD.HCRST or power-on-chip reset. 3. Set PORTSC.PP=0. 4. Set GUSB3PIPECTL. HstPrtCmpl=1. This places the link into compliance state. To advance the compliance pattern, follow this sequence (toggle the set GUSB3PIPECTL. HstPrtCmpl): 1. Set GUSB3PIPECTL.HstPrtCmpl=0. 2. Set GUSB3PIPECTL.HstPrtCmpl=1. This advances the link to the next compliance pattern. To exit from the compliance state perform USBCMD.HCRST or power-on-chip reset."]
    #[inline(always)]
    pub fn hstprtcmpl(&self) -> HstprtcmplR {
        HstprtcmplR::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - USB3 PHY Soft Reset After setting this bit to 1, the software needs to clear this bit."]
    #[inline(always)]
