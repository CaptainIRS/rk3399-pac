...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_inttype_level(&mut self) -> GpioInttypeLevelW<InttypeLevelSpec> {
        GpioInttypeLevelW::new(self, 0)
    }
}
#[doc = "Interrupt level register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`inttype_level::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`inttype_level::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
