#[doc = "Register `SPDIF_INTCR` reader"]
pub type R = crate::R<SpdifIntcrSpec>;
...
#[doc = "Interrupt Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spdif_intcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spdif_intcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SpdifIntcrSpec;
impl crate::RegisterSpec for SpdifIntcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spdif_intcr::R`](R) reader structure"]
impl crate::Readable for SpdifIntcrSpec {}
#[doc = "`write(|w| ..)` method takes [`spdif_intcr::W`](W) writer structure"]
impl crate::Writable for SpdifIntcrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0003_0000;
}
#[doc = "`reset()` method sets SPDIF_INTCR to value 0"]
impl crate::Resettable for SpdifIntcrSpec {
