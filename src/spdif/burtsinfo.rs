#[doc = "Register `BURTSINFO` reader"]
pub type R = crate::R<BurtsinfoSpec>;
#[doc = "Register `BURTSINFO` writer"]
pub type W = crate::W<BurtsinfoSpec>;
#[doc = "Data type\n\nValue on reset: 0"]
...
#[doc = "Field `DATAINFO` writer - Data-type-dependent info\n\nThis field gives the data-type-dependent info"]
...
#[doc = "Field `BSNUM` writer - Bitstream Number\n\nThis field indicates the bitstream number. Usually the bitstream\n\nnumber is 0."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatype(&mut self) -> DatatypeW<BurtsinfoSpec> {
        DatatypeW::new(self, 0)
    }
    #[doc = "Bit 7 - Error Flag"]
    #[inline(always)]
    #[must_use]
    pub fn errflag(&mut self) -> ErrflagW<BurtsinfoSpec> {
        ErrflagW::new(self, 7)
    }
    #[doc = "Bits 8:12 - Data-type-dependent info\n\nThis field gives the data-type-dependent info"]
    #[inline(always)]
    #[must_use]
    pub fn datainfo(&mut self) -> DatainfoW<BurtsinfoSpec> {
        DatainfoW::new(self, 8)
    }
    #[doc = "Bits 13:15 - Bitstream Number\n\nThis field indicates the bitstream number. Usually the bitstream\n\nnumber is 0."]
    #[inline(always)]
    #[must_use]
    pub fn bsnum(&mut self) -> BsnumW<BurtsinfoSpec> {
        BsnumW::new(self, 13)
    }
    #[doc = "Bits 16:31 - pd\n\nPreamble Pd for non-linear pcm, indicating the length of burst\n\npayload in unit of bytes or bits."]
    #[inline(always)]
    #[must_use]
    pub fn pd(&mut self) -> PdW<BurtsinfoSpec> {
        PdW::new(self, 16)
    }
}
#[doc = "Channel Burst Info Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`burtsinfo::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`burtsinfo::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BurtsinfoSpec;
impl crate::RegisterSpec for BurtsinfoSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`burtsinfo::R`](R) reader structure"]
impl crate::Readable for BurtsinfoSpec {}
#[doc = "`write(|w| ..)` method takes [`burtsinfo::W`](W) writer structure"]
impl crate::Writable for BurtsinfoSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BURTSINFO to value 0"]
impl crate::Resettable for BurtsinfoSpec {
