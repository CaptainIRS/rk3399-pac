...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vdw(&mut self) -> VdwW<CfgrSpec> {
        VdwW::new(self, 0)
    }
    #[doc = "Bit 2 - Halfword word transform enable"]
    #[inline(always)]
    #[must_use]
    pub fn hwt(&mut self) -> HwtW<CfgrSpec> {
        HwtW::new(self, 2)
    }
    #[doc = "Bit 3 - audio data justified"]
    #[inline(always)]
    #[must_use]
    pub fn adj(&mut self) -> AdjW<CfgrSpec> {
        AdjW::new(self, 3)
    }
    #[doc = "Bit 4 - Validity flag enable"]
    #[inline(always)]
    #[must_use]
    pub fn vfe(&mut self) -> VfeW<CfgrSpec> {
        VfeW::new(self, 4)
    }
    #[doc = "Bit 5 - User data enable"]
    #[inline(always)]
    #[must_use]
    pub fn ude(&mut self) -> UdeW<CfgrSpec> {
        UdeW::new(self, 5)
    }
    #[doc = "Bit 6 - Channel status enable"]
    #[inline(always)]
    #[must_use]
    pub fn cse(&mut self) -> CseW<CfgrSpec> {
        CseW::new(self, 6)
    }
    #[doc = "Bit 7 - mclk domain logic clear\n\nWrite 1 to clear mclk domain logic. Read return zero."]
    #[inline(always)]
    #[must_use]
    pub fn clr(&mut self) -> ClrW<CfgrSpec> {
        ClrW::new(self, 7)
    }
    #[doc = "Bit 8 - PCM type"]
    #[inline(always)]
    #[must_use]
    pub fn pcmtype(&mut self) -> PcmtypeW<CfgrSpec> {
        PcmtypeW::new(self, 8)
    }
    #[doc = "Bits 16:23 - mclk divider\n\nFmclk/Fsdo\n\nThis parameter can be calculated by Fmclk/(Fs*128).\n\nFs=the sample frequency be wanted"]
    #[inline(always)]
    #[must_use]
    pub fn mcd(&mut self) -> McdW<CfgrSpec> {
        McdW::new(self, 16)
    }
}
