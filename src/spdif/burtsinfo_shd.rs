#[doc = "Register `BURTSINFO_SHD` reader"]
pub type R = crate::R<BurtsinfoShdSpec>;
#[doc = "Data type\n\nValue on reset: 0"]
...
#[doc = "Shadow Channel Burst Info Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`burtsinfo_shd::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BurtsinfoShdSpec;
impl crate::RegisterSpec for BurtsinfoShdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`burtsinfo_shd::R`](R) reader structure"]
impl crate::Readable for BurtsinfoShdSpec {}
#[doc = "`reset()` method sets BURTSINFO_SHD to value 0"]
impl crate::Resettable for BurtsinfoShdSpec {
