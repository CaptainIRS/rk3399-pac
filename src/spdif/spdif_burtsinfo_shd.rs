...
#[doc = "Field `BSNUM` reader - Bitstream Number This field indicates the bitstream number. Usually the birstream number is 0."]
...
impl R {
    ...
    #[doc = "Bits 13:15 - Bitstream Number This field indicates the bitstream number. Usually the birstream number is 0."]
    #[inline(always)]
