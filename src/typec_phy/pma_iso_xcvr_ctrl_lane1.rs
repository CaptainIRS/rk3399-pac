#[doc = "Register `PMA_ISO_XCVR_CTRL_LANE1` reader"]
pub type R = crate::R<PmaIsoXcvrCtrlLane1Spec>;
#[doc = "Register `PMA_ISO_XCVR_CTRL_LANE1` writer"]
pub type W = crate::W<PmaIsoXcvrCtrlLane1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn field15(&mut self) -> Field15W<PmaIsoXcvrCtrlLane1Spec> {
        Field15W::new(self, 0)
    }
    #[doc = "Bit 1 - Drives rx_termination PMA input for the associated lane when in PMA \n\nisolation mode. Valid for PMA lanes 2 and 3 only. For PMA lanes 0 and \n\n3, reserved."]
    #[inline(always)]
    #[must_use]
    pub fn field14(&mut self) -> Field14W<PmaIsoXcvrCtrlLane1Spec> {
        Field14W::new(self, 1)
    }
    #[doc = "Bit 4 - Drives xcvr_lane_suspend PMA input for the associated lane when in PMA \n\nisolation mode."]
    #[inline(always)]
    #[must_use]
    pub fn field11(&mut self) -> Field11W<PmaIsoXcvrCtrlLane1Spec> {
        Field11W::new(self, 4)
    }
    #[doc = "Bit 5 - Drives xcvr_link_reset_n PMA input for the associated lane when in PMA \n\nisolation mode."]
    #[inline(always)]
    #[must_use]
    pub fn field10(&mut self) -> Field10W<PmaIsoXcvrCtrlLane1Spec> {
        Field10W::new(self, 5)
    }
    #[doc = "Bit 6 - Drives rx_eq_training PMA input for the associated lane when in PMA \n\nisolation mode. Valid for PMA lanes 2 and 3 only. For PMA lanes 0 and \n\n3, reserved."]
    #[inline(always)]
    #[must_use]
    pub fn field9(&mut self) -> Field9W<PmaIsoXcvrCtrlLane1Spec> {
        Field9W::new(self, 6)
    }
    #[doc = "Bit 7 - Drives \n\nrx_eq_training_data_valid_ln_{nnnn} PMA \n\ninput \n\nfor \n\nthe \n\nassociated lane when in PMA isolation mode. Valid for PMA lanes 2 \n\nand 3 only. For PMA lanes 0 and 3, reserved."]
    #[inline(always)]
    #[must_use]
    pub fn field8(&mut self) -> Field8W<PmaIsoXcvrCtrlLane1Spec> {
        Field8W::new(self, 7)
    }
    #[doc = "Bit 8 - Drives tx_rcv_detect_en PMA input for the associated lane when in PMA \n\nisolation mode."]
    #[inline(always)]
    #[must_use]
    pub fn field7(&mut self) -> Field7W<PmaIsoXcvrCtrlLane1Spec> {
        Field7W::new(self, 8)
    }
    #[doc = "Bit 12 - Drives tx_elec_idle PMA input for the associated lane when in PMA \n\nisolation mode."]
    #[inline(always)]
    #[must_use]
    pub fn field3(&mut self) -> Field3W<PmaIsoXcvrCtrlLane1Spec> {
        Field3W::new(self, 12)
    }
    #[doc = "Bit 13 - Drives tx_lfps_en PMA input for the associated lane when in PMA isolation \n\nmode."]
    #[inline(always)]
    #[must_use]
    pub fn field2(&mut self) -> Field2W<PmaIsoXcvrCtrlLane1Spec> {
        Field2W::new(self, 13)
    }
    #[doc = "Bit 14 - Drives xcvr_pll_clk_en PMA input for the associated lane when in PMA \n\nisolation mode."]
    #[inline(always)]
    #[must_use]
    pub fn field1(&mut self) -> Field1W<PmaIsoXcvrCtrlLane1Spec> {
        Field1W::new(self, 14)
    }
}
#[doc = "PMA Isolation Tansceiver control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pma_iso_xcvr_ctrl_lane1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pma_iso_xcvr_ctrl_lane1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmaIsoXcvrCtrlLane1Spec;
impl crate::RegisterSpec for PmaIsoXcvrCtrlLane1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pma_iso_xcvr_ctrl_lane1::R`](R) reader structure"]
impl crate::Readable for PmaIsoXcvrCtrlLane1Spec {}
#[doc = "`write(|w| ..)` method takes [`pma_iso_xcvr_ctrl_lane1::W`](W) writer structure"]
impl crate::Writable for PmaIsoXcvrCtrlLane1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets PMA_ISO_XCVR_CTRL_LANE1 to value 0"]
impl crate::Resettable for PmaIsoXcvrCtrlLane1Spec {
