#[doc = "Register `PMA_ISO_TX_CFG_LANE3` reader"]
pub type R = crate::R<PmaIsoTxCfgLane3Spec>;
#[doc = "Register `PMA_ISO_TX_CFG_LANE3` writer"]
pub type W = crate::W<PmaIsoTxCfgLane3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn field5(&mut self) -> Field5W<PmaIsoTxCfgLane3Spec> {
        Field5W::new(self, 0)
    }
    #[doc = "Bit 8 - Drives tx_low_power_swing_en PMA input for the associated lane."]
    #[inline(always)]
    #[must_use]
    pub fn field3(&mut self) -> Field3W<PmaIsoTxCfgLane3Spec> {
        Field3W::new(self, 8)
    }
    #[doc = "Bits 12:13 - Drives tx_deemphasis PMA input for the associated lane when in PMA \n\nisolation mode"]
    #[inline(always)]
    #[must_use]
    pub fn field1(&mut self) -> Field1W<PmaIsoTxCfgLane3Spec> {
        Field1W::new(self, 12)
    }
}
#[doc = "PMA TX configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pma_iso_tx_cfg_lane3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pma_iso_tx_cfg_lane3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmaIsoTxCfgLane3Spec;
impl crate::RegisterSpec for PmaIsoTxCfgLane3Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pma_iso_tx_cfg_lane3::R`](R) reader structure"]
impl crate::Readable for PmaIsoTxCfgLane3Spec {}
#[doc = "`write(|w| ..)` method takes [`pma_iso_tx_cfg_lane3::W`](W) writer structure"]
impl crate::Writable for PmaIsoTxCfgLane3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets PMA_ISO_TX_CFG_LANE3 to value 0"]
impl crate::Resettable for PmaIsoTxCfgLane3Spec {
