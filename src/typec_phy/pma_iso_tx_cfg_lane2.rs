#[doc = "Register `PMA_ISO_TX_CFG_LANE2` reader"]
pub type R = crate::R<PmaIsoTxCfgLane2Spec>;
#[doc = "Register `PMA_ISO_TX_CFG_LANE2` writer"]
pub type W = crate::W<PmaIsoTxCfgLane2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn field5(&mut self) -> Field5W<PmaIsoTxCfgLane2Spec> {
        Field5W::new(self, 0)
    }
    #[doc = "Bit 8 - Drives tx_low_power_swing_en PMA input for the associated lane."]
    #[inline(always)]
    #[must_use]
    pub fn field3(&mut self) -> Field3W<PmaIsoTxCfgLane2Spec> {
        Field3W::new(self, 8)
    }
    #[doc = "Bits 12:13 - Drives tx_deemphasis PMA input for the associated lane when in PMA \n\nisolation mode"]
    #[inline(always)]
    #[must_use]
    pub fn field1(&mut self) -> Field1W<PmaIsoTxCfgLane2Spec> {
        Field1W::new(self, 12)
    }
}
#[doc = "PMA TX configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pma_iso_tx_cfg_lane2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pma_iso_tx_cfg_lane2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmaIsoTxCfgLane2Spec;
impl crate::RegisterSpec for PmaIsoTxCfgLane2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pma_iso_tx_cfg_lane2::R`](R) reader structure"]
impl crate::Readable for PmaIsoTxCfgLane2Spec {}
#[doc = "`write(|w| ..)` method takes [`pma_iso_tx_cfg_lane2::W`](W) writer structure"]
impl crate::Writable for PmaIsoTxCfgLane2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets PMA_ISO_TX_CFG_LANE2 to value 0"]
impl crate::Resettable for PmaIsoTxCfgLane2Spec {
