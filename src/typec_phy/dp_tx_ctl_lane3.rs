#[doc = "Register `DP_TX_CTL_LANE3` reader"]
pub type R = crate::R<DpTxCtlLane3Spec>;
#[doc = "Register `DP_TX_CTL_LANE3` writer"]
pub type W = crate::W<DpTxCtlLane3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn field3(&mut self) -> Field3W<DpTxCtlLane3Spec> {
        Field3W::new(self, 0)
    }
    #[doc = "Bits 4:5 - TX Voltage Level - Dxrives tx_vmargin PMA input for the mapped \n\nPMA lane (for functional and isolation modes). This field is used to \n\nset the DP Voltage Swing Level (0b00 = Level 0, 0b01 = Level 1, \n\n0b10 = Level 2 and 0b11 = Level 3). TBD if Voltage Swing Level \n\n3 supported."]
    #[inline(always)]
    #[must_use]
    pub fn field1(&mut self) -> Field1W<DpTxCtlLane3Spec> {
        Field1W::new(self, 4)
    }
}
#[doc = "DP Lane Configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dp_tx_ctl_lane3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dp_tx_ctl_lane3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DpTxCtlLane3Spec;
impl crate::RegisterSpec for DpTxCtlLane3Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`dp_tx_ctl_lane3::R`](R) reader structure"]
impl crate::Readable for DpTxCtlLane3Spec {}
#[doc = "`write(|w| ..)` method takes [`dp_tx_ctl_lane3::W`](W) writer structure"]
impl crate::Writable for DpTxCtlLane3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DP_TX_CTL_LANE3 to value 0"]
impl crate::Resettable for DpTxCtlLane3Spec {
