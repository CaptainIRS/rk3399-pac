#[doc = "Register `PMA_ISO_LINK_MODE_LANE2` reader"]
pub type R = crate::R<PmaIsoLinkModeLane2Spec>;
#[doc = "Register `PMA_ISO_LINK_MODE_LANE2` writer"]
pub type W = crate::W<PmaIsoLinkModeLane2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn field7(&mut self) -> Field7W<PmaIsoLinkModeLane2Spec> {
        Field7W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Drives xcvr_standard_mode PMA input for the associated lane when \n\nin PMA isolation mode."]
    #[inline(always)]
    #[must_use]
    pub fn field5(&mut self) -> Field5W<PmaIsoLinkModeLane2Spec> {
        Field5W::new(self, 4)
    }
    #[doc = "Bit 12 - Drives the tx_high_z PMA input for the associated lane when in PMA \n\nisolation mode"]
    #[inline(always)]
    #[must_use]
    pub fn field3(&mut self) -> Field3W<PmaIsoLinkModeLane2Spec> {
        Field3W::new(self, 12)
    }
    #[doc = "Bit 14 - rx_reset_n PMA input for the associated lane when in PMA isolation \n\nmode. Valid for PMA lanes 2 and 3 only. For PMA lanes 0 and 3, \n\nreserved."]
    #[inline(always)]
    #[must_use]
    pub fn field1(&mut self) -> Field1W<PmaIsoLinkModeLane2Spec> {
        Field1W::new(self, 14)
    }
    #[doc = "Bit 15 - tx_reset_n PMA input for the associated lane when in PMA isolation \n\nmode."]
    #[inline(always)]
    #[must_use]
    pub fn field0(&mut self) -> Field0W<PmaIsoLinkModeLane2Spec> {
        Field0W::new(self, 15)
    }
}
#[doc = "PMA Isolation mode control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pma_iso_link_mode_lane2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pma_iso_link_mode_lane2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmaIsoLinkModeLane2Spec;
impl crate::RegisterSpec for PmaIsoLinkModeLane2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pma_iso_link_mode_lane2::R`](R) reader structure"]
impl crate::Readable for PmaIsoLinkModeLane2Spec {}
#[doc = "`write(|w| ..)` method takes [`pma_iso_link_mode_lane2::W`](W) writer structure"]
impl crate::Writable for PmaIsoLinkModeLane2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets PMA_ISO_LINK_MODE_LANE2 to value 0xc000"]
impl crate::Resettable for PmaIsoLinkModeLane2Spec {
