#[doc = "Register `PMA_ISO_PWRST_CTRL_LANE2` reader"]
pub type R = crate::R<PmaIsoPwrstCtrlLane2Spec>;
#[doc = "Register `PMA_ISO_PWRST_CTRL_LANE2` writer"]
pub type W = crate::W<PmaIsoPwrstCtrlLane2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn field4(&mut self) -> Field4W<PmaIsoPwrstCtrlLane2Spec> {
        Field4W::new(self, 0)
    }
    #[doc = "Bit 14 - Drives \n\ntx_cmn_mode_en_ext \n\nPMA \n\ninput \n\nfor \n\nthe \n\nassociated \n\nlanewhen in PMA isolation mode. (Used for PCIe)"]
    #[inline(always)]
    #[must_use]
    pub fn field1(&mut self) -> Field1W<PmaIsoPwrstCtrlLane2Spec> {
        Field1W::new(self, 14)
    }
    #[doc = "Bit 15 - Drives rx_sig_det_en_ext_} PMA input for the associated lane when \n\nin PMA isolation mode. Valid for PMA lanes 2 and 3 only. For PMA \n\nlanes 0 and 3, reserved. (Used for PCIe)"]
    #[inline(always)]
    #[must_use]
    pub fn field0(&mut self) -> Field0W<PmaIsoPwrstCtrlLane2Spec> {
        Field0W::new(self, 15)
    }
}
#[doc = "PMA Isolation power state control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pma_iso_pwrst_ctrl_lane2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pma_iso_pwrst_ctrl_lane2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmaIsoPwrstCtrlLane2Spec;
impl crate::RegisterSpec for PmaIsoPwrstCtrlLane2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pma_iso_pwrst_ctrl_lane2::R`](R) reader structure"]
impl crate::Readable for PmaIsoPwrstCtrlLane2Spec {}
#[doc = "`write(|w| ..)` method takes [`pma_iso_pwrst_ctrl_lane2::W`](W) writer structure"]
impl crate::Writable for PmaIsoPwrstCtrlLane2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets PMA_ISO_PWRST_CTRL_LANE2 to value 0"]
impl crate::Resettable for PmaIsoPwrstCtrlLane2Spec {
