#[doc = "Register `L1_PM_SUBSTATES_CAPABILITIES` reader"]
pub type R = crate::R<L1PmSubstatesCapabilitiesSpec>;
...
#[doc = "L1 PM Substates Capabilities Register RSVD\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`l1_pm_substates_capabilities::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct L1PmSubstatesCapabilitiesSpec;
impl crate::RegisterSpec for L1PmSubstatesCapabilitiesSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`l1_pm_substates_capabilities::R`](R) reader structure"]
impl crate::Readable for L1PmSubstatesCapabilitiesSpec {}
#[doc = "`reset()` method sets L1_PM_SUBSTATES_CAPABILITIES to value 0x0028_ff1f"]
impl crate::Resettable for L1PmSubstatesCapabilitiesSpec {
