#[doc = "Register `VF_DEVICE_ID` reader"]
pub type R = crate::R<VfDeviceIdSpec>;
...
#[doc = "VF Device ID Register VF device id assigned to the device. Its default value is specified in reg_defaults.h, but can be re- written independently for each PF from the local management bus.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vf_device_id::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VfDeviceIdSpec;
impl crate::RegisterSpec for VfDeviceIdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vf_device_id::R`](R) reader structure"]
impl crate::Readable for VfDeviceIdSpec {}
#[doc = "`reset()` method sets VF_DEVICE_ID to value 0x0100_0000"]
impl crate::Resettable for VfDeviceIdSpec {
