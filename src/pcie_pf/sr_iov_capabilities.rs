#[doc = "Register `SR_IOV_CAPABILITIES` reader"]
pub type R = crate::R<SrIovCapabilitiesSpec>;
...
#[doc = "SR-IOV Capabilities Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sr_iov_capabilities::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SrIovCapabilitiesSpec;
impl crate::RegisterSpec for SrIovCapabilitiesSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sr_iov_capabilities::R`](R) reader structure"]
impl crate::Readable for SrIovCapabilitiesSpec {}
#[doc = "`reset()` method sets SR_IOV_CAPABILITIES to value 0x02"]
impl crate::Resettable for SrIovCapabilitiesSpec {
