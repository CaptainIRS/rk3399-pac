#[doc = "Register `PCI_EXPRESS_CAPABILITY_LIST` reader"]
pub type R = crate::R<PciExpressCapabilityListSpec>;
...
#[doc = "PCI Express Capability List Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pci_express_capability_list::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciExpressCapabilityListSpec;
impl crate::RegisterSpec for PciExpressCapabilityListSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pci_express_capability_list::R`](R) reader structure"]
impl crate::Readable for PciExpressCapabilityListSpec {}
#[doc = "`reset()` method sets PCI_EXPRESS_CAPABILITY_LIST to value 0x0002_0010"]
impl crate::Resettable for PciExpressCapabilityListSpec {
