#[doc = "Register `VF_BASE_ADDRESS_1` reader"]
pub type R = crate::R<VfBaseAddress1Spec>;
#[doc = "Register `VF_BASE_ADDRESS_1` writer"]
pub type W = crate::W<VfBaseAddress1Spec>;
...
This field defines the base address of the memory address range. The number of implemented bits in this field determines the BAR aperture setting of BAR Configuration Registers of the associated Physical Function. All other bits are not writeable, and are read as 0's."]
    #[inline(always)]
    #[must_use]
    pub fn bamrw(&mut self) -> BamrwW<VfBaseAddress1Spec> {
        BamrwW::new(self, 0)
    }
}
#[doc = "VF Base Address Register 1 This field defines the base address of the memory address range. The number of implemented bits in this field determines the BAR aperture setting of BAR Configuration Registers of the associated Physical Function. All other bits are not writeable, and are read as 0's.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vf_base_address_1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`vf_base_address_1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VfBaseAddress1Spec;
impl crate::RegisterSpec for VfBaseAddress1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vf_base_address_1::R`](R) reader structure"]
impl crate::Readable for VfBaseAddress1Spec {}
#[doc = "`write(|w| ..)` method takes [`vf_base_address_1::W`](W) writer structure"]
impl crate::Writable for VfBaseAddress1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VF_BASE_ADDRESS_1 to value 0"]
impl crate::Resettable for VfBaseAddress1Spec {
