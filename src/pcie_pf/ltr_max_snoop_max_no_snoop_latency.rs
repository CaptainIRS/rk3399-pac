#[doc = "Register `LTR_MAX_SNOOP_MAX_NO_SNOOP_LATENCY` reader"]
pub type R = crate::R<LtrMaxSnoopMaxNoSnoopLatencySpec>;
#[doc = "Register `LTR_MAX_SNOOP_MAX_NO_SNOOP_LATENCY` writer"]
pub type W = crate::W<LtrMaxSnoopMaxNoSnoopLatencySpec>;
...
When multiplied by the value of the Max Snoop Latency Scale, this field defines the maximum snoop value the device is permitted to request in an LTR message. This field can be written independently for each Physical Function from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn msl(&mut self) -> MslW<LtrMaxSnoopMaxNoSnoopLatencySpec> {
        MslW::new(self, 0)
    }
    #[doc = "Bits 10:12 - Max Snoop Latency Scale \\[MSLS\\]
Specifies the scale value for the Max Snoop Latency. When the setting of this field is non- zero, the actual snoop latency is determined by multiplying the Max Snoop Latency by the following scale factors: 001: 32 ns, 010: 1024 ns, 011: 32,768 ns, 100: 1,047,576 ns, 101: 33,554,432ns, 110-111: Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn msls(&mut self) -> MslsW<LtrMaxSnoopMaxNoSnoopLatencySpec> {
        MslsW::new(self, 10)
    }
    #[doc = "Bits 16:25 - Max No- Snoop Latency \\[MNSL\\]
When multiplied by the value of the Max No- Snoop Latency Scale, this field defines the maximum no-snoop value the device is permitted to request in an LTR message. This field can be written independently for each Physical Function from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn mnsl(&mut self) -> MnslW<LtrMaxSnoopMaxNoSnoopLatencySpec> {
        MnslW::new(self, 16)
    }
    #[doc = "Bits 26:28 - Max No- Snoop Latency Scale \\[MNSLS\\]
Specifies the scale value for the Max No-Snoop Latency. When the setting of this field is non- zero, the actual snoop latency is determined by multiplying the Max No-Snoop Latency by the following scale factors: 001: 32 ns, 010: 1024 ns,"]
    #[inline(always)]
    #[must_use]
    pub fn mnsls(&mut self) -> MnslsW<LtrMaxSnoopMaxNoSnoopLatencySpec> {
        MnslsW::new(self, 26)
    }
}
#[doc = "LTR Max Snoop/Max No-Snoop Latency Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ltr_max_snoop_max_no_snoop_latency::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ltr_max_snoop_max_no_snoop_latency::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LtrMaxSnoopMaxNoSnoopLatencySpec;
impl crate::RegisterSpec for LtrMaxSnoopMaxNoSnoopLatencySpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ltr_max_snoop_max_no_snoop_latency::R`](R) reader structure"]
impl crate::Readable for LtrMaxSnoopMaxNoSnoopLatencySpec {}
#[doc = "`write(|w| ..)` method takes [`ltr_max_snoop_max_no_snoop_latency::W`](W) writer structure"]
impl crate::Writable for LtrMaxSnoopMaxNoSnoopLatencySpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LTR_MAX_SNOOP_MAX_NO_SNOOP_LATENCY to value 0"]
impl crate::Resettable for LtrMaxSnoopMaxNoSnoopLatencySpec {
