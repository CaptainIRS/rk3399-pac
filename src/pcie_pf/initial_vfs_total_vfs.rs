#[doc = "Register `INITIAL_VFS_TOTAL_VFS` reader"]
pub type R = crate::R<InitialVfsTotalVfsSpec>;
...
#[doc = "Initial VFs/Total VFs Register This field contains the total number of VFs per PF. Its default setting is identical to that of InitialVFs. This field can be modified using local management registers.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`initial_vfs_total_vfs::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct InitialVfsTotalVfsSpec;
impl crate::RegisterSpec for InitialVfsTotalVfsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`initial_vfs_total_vfs::R`](R) reader structure"]
impl crate::Readable for InitialVfsTotalVfsSpec {}
#[doc = "`reset()` method sets INITIAL_VFS_TOTAL_VFS to value 0x0008_0008"]
impl crate::Resettable for InitialVfsTotalVfsSpec {
