#[doc = "Register `LATENCY_TOLERANCE_REPORTING_LTR_EXTENDED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<LatencyToleranceReportingLtrExtendedCapabilityHeaderSpec>;
...
#[doc = "Latency Tolerance Reporting (LTR) Extended Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`latency_tolerance_reporting_ltr_extended_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LatencyToleranceReportingLtrExtendedCapabilityHeaderSpec;
impl crate::RegisterSpec for LatencyToleranceReportingLtrExtendedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`latency_tolerance_reporting_ltr_extended_capability_header::R`](R) reader structure"]
impl crate::Readable for LatencyToleranceReportingLtrExtendedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets LATENCY_TOLERANCE_REPORTING_LTR_EXTENDED_CAPABILITY_HEADER to value 0x1c01_0018"]
impl crate::Resettable for LatencyToleranceReportingLtrExtendedCapabilityHeaderSpec {
