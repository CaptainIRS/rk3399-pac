#[doc = "Register `FUNCTION_DEPENDENCY_LINK_NUMVFS` reader"]
pub type R = crate::R<FunctionDependencyLinkNumvfsSpec>;
#[doc = "Register `FUNCTION_DEPENDENCY_LINK_NUMVFS` writer"]
pub type W = crate::W<FunctionDependencyLinkNumvfsSpec>;
...
This field must be set by the software to the number of VFs that it wants to enable for each PF. This field can be changed only when the VF Enable bit in the SR-IOV Control Register is 0. Its value should not exceed the setting of TotalVFs for the corresponding Physical Function. This field can also be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn nvf(&mut self) -> NvfW<FunctionDependencyLinkNumvfsSpec> {
        NvfW::new(self, 0)
    }
}
#[doc = "Function Dependency Link/NumVFs Register This field is used to specify dependencies between PFs. It can be modified independently for each Function from the local management bus.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`function_dependency_link_numvfs::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`function_dependency_link_numvfs::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FunctionDependencyLinkNumvfsSpec;
impl crate::RegisterSpec for FunctionDependencyLinkNumvfsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`function_dependency_link_numvfs::R`](R) reader structure"]
impl crate::Readable for FunctionDependencyLinkNumvfsSpec {}
#[doc = "`write(|w| ..)` method takes [`function_dependency_link_numvfs::W`](W) writer structure"]
impl crate::Writable for FunctionDependencyLinkNumvfsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FUNCTION_DEPENDENCY_LINK_NUMVFS to value 0"]
impl crate::Resettable for FunctionDependencyLinkNumvfsSpec {
