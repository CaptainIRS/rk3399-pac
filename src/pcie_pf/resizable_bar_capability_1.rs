#[doc = "Register `RESIZABLE_BAR_CAPABILITY_1` reader"]
pub type R = crate::R<ResizableBarCapability1Spec>;
...
#[doc = "Resizable BAR Capability Register 1 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_capability_1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarCapability1Spec;
impl crate::RegisterSpec for ResizableBarCapability1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_capability_1::R`](R) reader structure"]
impl crate::Readable for ResizableBarCapability1Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CAPABILITY_1 to value 0"]
impl crate::Resettable for ResizableBarCapability1Spec {
