...
#[doc = "Register `BASE_ADDRESS_5` writer"]
pub type W = crate::W<BaseAddress5Spec>;
...
#[doc = "`write(|w| ..)` method takes [`base_address_5::W`](W) writer structure"]
impl crate::Writable for BaseAddress5Spec {
