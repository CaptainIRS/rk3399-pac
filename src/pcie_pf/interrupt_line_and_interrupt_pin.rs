...
#[doc = "Register `INTERRUPT_LINE_AND_INTERRUPT_PIN` writer"]
pub type W = crate::W<InterruptLineAndInterruptPinSpec>;
...
Identifies the IRQx input of the interrupt controller at the Root Complex that is activated by this Functions interrupt (00 = IRQ0, ... , 0F = IRQ15, FF = unknown or not connected). This field is writable from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn ilr(&mut self) -> IlrW<InterruptLineAndInterruptPinSpec> {
        IlrW::new(self, 0)
    }
}
#[doc = "Interrupt Line and Interrupt Pin Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`interrupt_line_and_interrupt_pin::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`interrupt_line_and_interrupt_pin::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`interrupt_line_and_interrupt_pin::W`](W) writer structure"]
impl crate::Writable for InterruptLineAndInterruptPinSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INTERRUPT_LINE_AND_INTERRUPT_PIN to value 0x01ff"]
