#[doc = "Register `DPA_EXTENDED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<DpaExtendedCapabilityHeaderSpec>;
...
#[doc = "DPA Extended Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dpa_extended_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DpaExtendedCapabilityHeaderSpec;
impl crate::RegisterSpec for DpaExtendedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dpa_extended_capability_header::R`](R) reader structure"]
impl crate::Readable for DpaExtendedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets DPA_EXTENDED_CAPABILITY_HEADER to value 0x2001_0016"]
impl crate::Resettable for DpaExtendedCapabilityHeaderSpec {
