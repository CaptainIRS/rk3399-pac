#[doc = "Register `RESIZABLE_BAR_CAPABILITY_2` reader"]
pub type R = crate::R<ResizableBarCapability2Spec>;
...
#[doc = "Resizable BAR Capability Register 2 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_capability_2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarCapability2Spec;
impl crate::RegisterSpec for ResizableBarCapability2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_capability_2::R`](R) reader structure"]
impl crate::Readable for ResizableBarCapability2Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CAPABILITY_2 to value 0"]
impl crate::Resettable for ResizableBarCapability2Spec {
