#[doc = "Register `RESIZABLE_BAR_CAPABILITY_5` reader"]
pub type R = crate::R<ResizableBarCapability5Spec>;
...
#[doc = "Resizable BAR Capability Register 5 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_capability_5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarCapability5Spec;
impl crate::RegisterSpec for ResizableBarCapability5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_capability_5::R`](R) reader structure"]
impl crate::Readable for ResizableBarCapability5Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CAPABILITY_5 to value 0"]
impl crate::Resettable for ResizableBarCapability5Spec {
