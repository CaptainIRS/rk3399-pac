#[doc = "Register `RESIZABLE_BAR_CAPABILITY_0` reader"]
pub type R = crate::R<ResizableBarCapability0Spec>;
...
#[doc = "Resizable BAR Capability Register 0 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_capability_0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarCapability0Spec;
impl crate::RegisterSpec for ResizableBarCapability0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_capability_0::R`](R) reader structure"]
impl crate::Readable for ResizableBarCapability0Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CAPABILITY_0 to value 0"]
impl crate::Resettable for ResizableBarCapability0Spec {
