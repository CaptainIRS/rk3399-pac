...
#[doc = "Register `BASE_ADDRESS_3` writer"]
pub type W = crate::W<BaseAddress3Spec>;
...
#[doc = "`write(|w| ..)` method takes [`base_address_3::W`](W) writer structure"]
impl crate::Writable for BaseAddress3Spec {
