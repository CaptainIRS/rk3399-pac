#[doc = "Register `MSI_X_CONTROL` reader"]
pub type R = crate::R<MsiXControlSpec>;
#[doc = "Register `MSI_X_CONTROL` writer"]
pub type W = crate::W<MsiXControlSpec>;
...
Specifies the size of the MSI-X Table, that is, the number of interrupt vectors definedfor the Function. The programmed value is 1 minus the size of the table (that is, this field is set to 0 if the table size is 1.). It can be re- written independently for each Function from the local management bus."]
...
This bit serves as a global mask to all the interrupt conditions associated with this Function. When this bit is set, the core will not send out MSI-X messages from this Function. This field can also be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn fm(&mut self) -> FmW<MsiXControlSpec> {
        FmW::new(self, 30)
    }
    #[doc = "Bit 31 - MSI-X Enable \\[MSIXE\\]
Set by the configuration program to enable the MSI-X feature. This field can also be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn msixe(&mut self) -> MsixeW<MsiXControlSpec> {
        MsixeW::new(self, 31)
    }
}
#[doc = "MSI-X Control Register Set by the configuration program to enable the MSI-X feature. This field can also be written from the local management bus.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`msi_x_control::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`msi_x_control::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MsiXControlSpec;
impl crate::RegisterSpec for MsiXControlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`msi_x_control::R`](R) reader structure"]
impl crate::Readable for MsiXControlSpec {}
#[doc = "`write(|w| ..)` method takes [`msi_x_control::W`](W) writer structure"]
impl crate::Writable for MsiXControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MSI_X_CONTROL to value 0xc011"]
impl crate::Resettable for MsiXControlSpec {
