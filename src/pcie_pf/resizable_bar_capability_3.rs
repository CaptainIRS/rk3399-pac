#[doc = "Register `RESIZABLE_BAR_CAPABILITY_3` reader"]
pub type R = crate::R<ResizableBarCapability3Spec>;
...
#[doc = "Resizable BAR Capability Register 3 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_capability_3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarCapability3Spec;
impl crate::RegisterSpec for ResizableBarCapability3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_capability_3::R`](R) reader structure"]
impl crate::Readable for ResizableBarCapability3Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CAPABILITY_3 to value 0"]
impl crate::Resettable for ResizableBarCapability3Spec {
