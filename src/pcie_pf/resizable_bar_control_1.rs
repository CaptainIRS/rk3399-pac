#[doc = "Register `RESIZABLE_BAR_CONTROL_1` reader"]
pub type R = crate::R<ResizableBarControl1Spec>;
...
#[doc = "Resizable BAR Control Register 1 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_control_1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarControl1Spec;
impl crate::RegisterSpec for ResizableBarControl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_control_1::R`](R) reader structure"]
impl crate::Readable for ResizableBarControl1Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CONTROL_1 to value 0"]
impl crate::Resettable for ResizableBarControl1Spec {
