#[doc = "Register `DPA_CAPABILITY` reader"]
pub type R = crate::R<DpaCapabilitySpec>;
...
#[doc = "DPA Capability Register Specifies the second of the two transition latency values for the substates. The unit of latency is specified by the Transition Latency Unit field of this register.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dpa_capability::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DpaCapabilitySpec;
impl crate::RegisterSpec for DpaCapabilitySpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dpa_capability::R`](R) reader structure"]
impl crate::Readable for DpaCapabilitySpec {}
#[doc = "`reset()` method sets DPA_CAPABILITY to value 0x0010_0007"]
impl crate::Resettable for DpaCapabilitySpec {
