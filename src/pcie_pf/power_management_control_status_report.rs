#[doc = "Register `POWER_MANAGEMENT_CONTROL_STATUS_REPORT` reader"]
pub type R = crate::R<PowerManagementControlStatusReportSpec>;
#[doc = "Register `POWER_MANAGEMENT_CONTROL_STATUS_REPORT` writer"]
pub type W = crate::W<PowerManagementControlStatusReportSpec>;
...
Indicates the power state this Function is currently in. This field can be read by the software to monitor the current power state, or can be written to cause a transition to a new state. The valid settings are 00 (state D0), 01 (state D1) and 11 (state D3hot). The software should not write any other value into this field. This field can also be written from the local management bus independently for each Function."]
    #[inline(always)]
    #[must_use]
    pub fn ps(&mut self) -> PsW<PowerManagementControlStatusReportSpec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 8 - PME Enable \\[PE\\]
Setting this bit enables the notification of PME events from the associated Function. This bit can be set also by writing into this register from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn pe(&mut self) -> PeW<PowerManagementControlStatusReportSpec> {
        PeW::new(self, 8)
    }
    #[doc = "Bit 15 - PME Status \\[PMES\\]
When PME notification is enabled, writing a 1 into this bit position from the local management bus sets this bit and causes the core to send a PME message from the associated Function. When the Root Complex processes this message, it will turn off this bit by writing a 1 into this bit position through a Config Write. This bit can be set or cleared from the local management bus, by writing a 1 or 0, respectively. It can only be cleared from the configuration path (by writing a 1)."]
    #[inline(always)]
    #[must_use]
    pub fn pmes(&mut self) -> PmesW<PowerManagementControlStatusReportSpec> {
        PmesW::new(self, 15)
    }
}
#[doc = "Power Management Control/Status Report This optional register is not implemented in the PCIe core. This field is hardwired to 0.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`power_management_control_status_report::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`power_management_control_status_report::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PowerManagementControlStatusReportSpec;
impl crate::RegisterSpec for PowerManagementControlStatusReportSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`power_management_control_status_report::R`](R) reader structure"]
impl crate::Readable for PowerManagementControlStatusReportSpec {}
#[doc = "`write(|w| ..)` method takes [`power_management_control_status_report::W`](W) writer structure"]
impl crate::Writable for PowerManagementControlStatusReportSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x8000;
}
#[doc = "`reset()` method sets POWER_MANAGEMENT_CONTROL_STATUS_REPORT to value 0x08"]
impl crate::Resettable for PowerManagementControlStatusReportSpec {
