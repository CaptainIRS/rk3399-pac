#[doc = "Register `RESIZABLE_BAR_CONTROL_2` reader"]
pub type R = crate::R<ResizableBarControl2Spec>;
...
#[doc = "Resizable BAR Control Register 2 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_control_2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarControl2Spec;
impl crate::RegisterSpec for ResizableBarControl2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_control_2::R`](R) reader structure"]
impl crate::Readable for ResizableBarControl2Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CONTROL_2 to value 0"]
impl crate::Resettable for ResizableBarControl2Spec {
