#[doc = "Register `ARI_EXTENDED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<AriExtendedCapabilityHeaderSpec>;
...
#[doc = "ARI Extended Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ari_extended_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AriExtendedCapabilityHeaderSpec;
impl crate::RegisterSpec for AriExtendedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ari_extended_capability_header::R`](R) reader structure"]
impl crate::Readable for AriExtendedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets ARI_EXTENDED_CAPABILITY_HEADER to value 0x1601_000e"]
impl crate::Resettable for AriExtendedCapabilityHeaderSpec {
