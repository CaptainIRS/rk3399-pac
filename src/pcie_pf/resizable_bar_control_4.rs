#[doc = "Register `RESIZABLE_BAR_CONTROL_4` reader"]
pub type R = crate::R<ResizableBarControl4Spec>;
...
#[doc = "Resizable BAR Control Register 4 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_control_4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarControl4Spec;
impl crate::RegisterSpec for ResizableBarControl4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_control_4::R`](R) reader structure"]
impl crate::Readable for ResizableBarControl4Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CONTROL_4 to value 0"]
impl crate::Resettable for ResizableBarControl4Spec {
