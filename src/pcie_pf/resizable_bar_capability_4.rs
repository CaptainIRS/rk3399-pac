#[doc = "Register `RESIZABLE_BAR_CAPABILITY_4` reader"]
pub type R = crate::R<ResizableBarCapability4Spec>;
...
#[doc = "Resizable BAR Capability Register 4 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_capability_4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarCapability4Spec;
impl crate::RegisterSpec for ResizableBarCapability4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_capability_4::R`](R) reader structure"]
impl crate::Readable for ResizableBarCapability4Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CAPABILITY_4 to value 0"]
impl crate::Resettable for ResizableBarCapability4Spec {
