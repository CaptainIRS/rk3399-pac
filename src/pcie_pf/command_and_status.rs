...
Enables IO accesses through the core for this PCI Function. This field can be written from the local management bus."]
...
Enables memory accesses through the core for this PCI Function. This field can be written from the local management bus."]
...
Enables the device to issue memory and I/O requests from this Function. This field can be written from the local management bus."]
...
Enables the reporting of fatal and non-fatal errors detected by the core to the Root Complex. This field can be written from the local management bus."]
...
Enables or disables the transmission of INTx Assert and De-assert messages from the core. Setting this bit to 1 disables generation of INTx assert/de-assert messages in the core. This field can be written from the local management bus."]
...
This bit is set when the core has sent a completion to the link with the Completer Abort status. This field can also be cleared from the local management bus by writing a 1 into this bit position."]
...
This bit is set when the core has received a completion from the link with the Completer Abort status. This field can also be cleared from the local management bus by writing a 1 into this bit position"]
...
This bit is set when the core has received a completion from the link with the Unsupported Request status. This field can also be cleared from the local management bus by writing a 1 into this bit position"]
...
If the SERR enable bit is 1, this bit is set when the core has sent out a fatal or non-fatal error message on the link to the Root Complex. If the SERR enable bit is 0, this bit remains 0. This field can also be cleared from the local management bus by writing a 1 into this bit position."]
...
This bit is set when the core has received a poisoned TLP. The Parity Error Response enable bit (bit 6) has no effect on the setting of this bit. This field can also be cleared from the local management bus by writing a 1 into this bit position."]
...
Enables IO accesses through the core for this PCI Function. This field can be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn ise(&mut self) -> IseW<CommandAndStatusSpec> {
        IseW::new(self, 0)
    }
    #[doc = "Bit 1 - Mem-Space Enable \\[MSE\\]
Enables memory accesses through the core for this PCI Function. This field can be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn mse(&mut self) -> MseW<CommandAndStatusSpec> {
        MseW::new(self, 1)
    }
    #[doc = "Bit 2 - Bus-Master Enable \\[BE\\]
Enables the device to issue memory and I/O requests from this Function. This field can be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn be(&mut self) -> BeW<CommandAndStatusSpec> {
        BeW::new(self, 2)
    }
    #[doc = "Bit 6 - Parity Error Response Enable \\[PERE\\]
When this bit is 1, the core sets the Master Data Parity Error status bit when it detects the following error conditions: (i) The core receives a poisoned completion from the link in response to a request. (ii) The core sends out a poisoned write request on the link (this may be because an underflow occurred during the packet transfer at the host interface of the core.). When this bit is 0, the Master Data Parity Error status bit is never set. This field can be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn pere(&mut self) -> PereW<CommandAndStatusSpec> {
        PereW::new(self, 6)
    }
    #[doc = "Bit 8 - SERR Enable \\[SE\\]
Enables the reporting of fatal and non-fatal errors detected by the core to the Root Complex. This field can be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn se(&mut self) -> SeW<CommandAndStatusSpec> {
        SeW::new(self, 8)
    }
    #[doc = "Bit 10 - INTx Message Disabled \\[IMD\\]
Enables or disables the transmission of INTx Assert and De-assert messages from the core. Setting this bit to 1 disables generation of INTx assert/de-assert messages in the core. This field can be written from the local management bus."]
    #[inline(always)]
    #[must_use]
    pub fn imd(&mut self) -> ImdW<CommandAndStatusSpec> {
        ImdW::new(self, 10)
    }
    #[doc = "Bit 24 - Master Data Parity Error \\[MDPE\\]
When the Parity Error Response enable bit is 1, the core sets this bit when it detects the following error conditions: (i) The core receives a poisoned completion from the link in response to a request. (ii) The core sends out a poisoned write request on the link (this may be because an underflow occurred during the packet transfer at the host interface of the core.). This bit remains 0 when the Parity Error Response enable bit is 0. This field can also be cleared from the local management bus by writing a 1 into this bit position."]
