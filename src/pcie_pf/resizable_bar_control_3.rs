#[doc = "Register `RESIZABLE_BAR_CONTROL_3` reader"]
pub type R = crate::R<ResizableBarControl3Spec>;
...
#[doc = "Resizable BAR Control Register 3 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_control_3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarControl3Spec;
impl crate::RegisterSpec for ResizableBarControl3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_control_3::R`](R) reader structure"]
impl crate::Readable for ResizableBarControl3Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CONTROL_3 to value 0"]
impl crate::Resettable for ResizableBarControl3Spec {
