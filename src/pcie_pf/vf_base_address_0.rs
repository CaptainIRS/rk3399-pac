#[doc = "Register `VF_BASE_ADDRESS_0` reader"]
pub type R = crate::R<VfBaseAddress0Spec>;
#[doc = "Register `VF_BASE_ADDRESS_0` writer"]
pub type W = crate::W<VfBaseAddress0Spec>;
...
This field defines the base address of the memory address range. The number of implemented bits in this field determines the BAR aperture configured in BAR Configuration Registers of the associated Physical Function."]
    #[inline(always)]
    #[must_use]
    pub fn bamrw(&mut self) -> BamrwW<VfBaseAddress0Spec> {
        BamrwW::new(self, 22)
    }
}
#[doc = "VF Base Address Register 0 This field defines the base address of the memory address range. The number of implemented bits in this field determines the BAR aperture configured in BAR Configuration Registers of the associated Physical Function.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vf_base_address_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`vf_base_address_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VfBaseAddress0Spec;
impl crate::RegisterSpec for VfBaseAddress0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vf_base_address_0::R`](R) reader structure"]
impl crate::Readable for VfBaseAddress0Spec {}
#[doc = "`write(|w| ..)` method takes [`vf_base_address_0::W`](W) writer structure"]
impl crate::Writable for VfBaseAddress0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VF_BASE_ADDRESS_0 to value 0x04"]
impl crate::Resettable for VfBaseAddress0Spec {
