#[doc = "Register `RESIZABLE_BAR_EXTENDED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<ResizableBarExtendedCapabilityHeaderSpec>;
...
#[doc = "Resizable BAR Extended Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_extended_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarExtendedCapabilityHeaderSpec;
impl crate::RegisterSpec for ResizableBarExtendedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_extended_capability_header::R`](R) reader structure"]
impl crate::Readable for ResizableBarExtendedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_EXTENDED_CAPABILITY_HEADER to value 0"]
impl crate::Resettable for ResizableBarExtendedCapabilityHeaderSpec {
