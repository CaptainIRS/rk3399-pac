#[doc = "Register `RESIZABLE_BAR_CONTROL_5` reader"]
pub type R = crate::R<ResizableBarControl5Spec>;
...
#[doc = "Resizable BAR Control Register 5 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_control_5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarControl5Spec;
impl crate::RegisterSpec for ResizableBarControl5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_control_5::R`](R) reader structure"]
impl crate::Readable for ResizableBarControl5Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CONTROL_5 to value 0"]
impl crate::Resettable for ResizableBarControl5Spec {
