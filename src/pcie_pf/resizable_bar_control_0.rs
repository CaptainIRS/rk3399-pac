#[doc = "Register `RESIZABLE_BAR_CONTROL_0` reader"]
pub type R = crate::R<ResizableBarControl0Spec>;
...
#[doc = "Resizable BAR Control Register 0 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`resizable_bar_control_0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ResizableBarControl0Spec;
impl crate::RegisterSpec for ResizableBarControl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`resizable_bar_control_0::R`](R) reader structure"]
impl crate::Readable for ResizableBarControl0Spec {}
#[doc = "`reset()` method sets RESIZABLE_BAR_CONTROL_0 to value 0"]
impl crate::Resettable for ResizableBarControl0Spec {
