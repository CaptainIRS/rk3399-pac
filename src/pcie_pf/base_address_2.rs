...
#[doc = "Register `BASE_ADDRESS_2` writer"]
pub type W = crate::W<BaseAddress2Spec>;
...
#[doc = "`write(|w| ..)` method takes [`base_address_2::W`](W) writer structure"]
impl crate::Writable for BaseAddress2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BASE_ADDRESS_2 to value 0x04"]
