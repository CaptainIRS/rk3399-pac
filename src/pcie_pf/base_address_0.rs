...
#[doc = "Register `BASE_ADDRESS_0` writer"]
pub type W = crate::W<BaseAddress0Spec>;
...
#[doc = "`write(|w| ..)` method takes [`base_address_0::W`](W) writer structure"]
impl crate::Writable for BaseAddress0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BASE_ADDRESS_0 to value 0x04"]
