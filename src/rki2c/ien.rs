...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn btfien(&mut self) -> BtfienW<IenSpec> {
        BtfienW::new(self, 0)
    }
    #[doc = "Bit 1 - byte rx finished interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn brfien(&mut self) -> BrfienW<IenSpec> {
        BrfienW::new(self, 1)
    }
    #[doc = "Bit 2 - MTXCNT data transfer finished interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn mbtfien(&mut self) -> MbtfienW<IenSpec> {
        MbtfienW::new(self, 2)
    }
    #[doc = "Bit 3 - MRXCNT data received finished interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn mbrfien(&mut self) -> MbrfienW<IenSpec> {
        MbrfienW::new(self, 3)
    }
    #[doc = "Bit 4 - start operation finished interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn startien(&mut self) -> StartienW<IenSpec> {
        StartienW::new(self, 4)
    }
    #[doc = "Bit 5 - stop operation finished interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn stopien(&mut self) -> StopienW<IenSpec> {
        StopienW::new(self, 5)
    }
    #[doc = "Bit 6 - NAK handshake received interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn nakrcvien(&mut self) -> NakrcvienW<IenSpec> {
        NakrcvienW::new(self, 6)
    }
    #[doc = "Bit 7 - slave hold scl interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn slavehdsclen(&mut self) -> SlavehdsclenW<IenSpec> {
