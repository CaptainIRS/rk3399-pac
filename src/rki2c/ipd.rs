#[doc = "Register `IPD` reader"]
pub type R = crate::R<IpdSpec>;
#[doc = "Register `IPD` writer"]
pub type W = crate::W<IpdSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn btfipd(&mut self) -> BtfipdW<IpdSpec> {
        BtfipdW::new(self, 0)
    }
    #[doc = "Bit 1 - byte rx finished interrupt pending bit"]
    #[inline(always)]
    #[must_use]
    pub fn brfipd(&mut self) -> BrfipdW<IpdSpec> {
        BrfipdW::new(self, 1)
    }
    #[doc = "Bit 2 - MTXCNT data transfer finished interrupt pending bit"]
    #[inline(always)]
    #[must_use]
    pub fn mbtfipd(&mut self) -> MbtfipdW<IpdSpec> {
        MbtfipdW::new(self, 2)
    }
    #[doc = "Bit 3 - MRXCNT data received finished interrupt pending bit"]
    #[inline(always)]
    #[must_use]
    pub fn mbrfipd(&mut self) -> MbrfipdW<IpdSpec> {
        MbrfipdW::new(self, 3)
    }
    #[doc = "Bit 4 - start operation finished interrupt pending bit"]
    #[inline(always)]
    #[must_use]
    pub fn startipd(&mut self) -> StartipdW<IpdSpec> {
        StartipdW::new(self, 4)
    }
    #[doc = "Bit 5 - stop operation finished interrupt pending bit"]
    #[inline(always)]
    #[must_use]
    pub fn stopipd(&mut self) -> StopipdW<IpdSpec> {
        StopipdW::new(self, 5)
    }
    #[doc = "Bit 6 - NAK handshake received interrupt pending bit"]
    #[inline(always)]
    #[must_use]
    pub fn nakrcvipd(&mut self) -> NakrcvipdW<IpdSpec> {
        NakrcvipdW::new(self, 6)
    }
    #[doc = "Bit 7 - slave hold scl interrupt pending bit"]
    #[inline(always)]
    #[must_use]
    pub fn slavehdsclipd(&mut self) -> SlavehdsclipdW<IpdSpec> {
        SlavehdsclipdW::new(self, 7)
    }
}
#[doc = "interrupt pending register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ipd::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ipd::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IpdSpec;
impl crate::RegisterSpec for IpdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ipd::R`](R) reader structure"]
impl crate::Readable for IpdSpec {}
#[doc = "`write(|w| ..)` method takes [`ipd::W`](W) writer structure"]
impl crate::Writable for IpdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x7f;
}
#[doc = "`reset()` method sets IPD to value 0"]
impl crate::Resettable for IpdSpec {
