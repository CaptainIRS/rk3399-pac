#[doc = "Register `MRXRADDR` reader"]
pub type R = crate::R<MrxraddrSpec>;
#[doc = "Register `MRXRADDR` writer"]
pub type W = crate::W<MrxraddrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sraddr(&mut self) -> SraddrW<MrxraddrSpec> {
        SraddrW::new(self, 0)
    }
    #[doc = "Bit 24 - address low byte valid"]
    #[inline(always)]
    #[must_use]
    pub fn sraddlvld(&mut self) -> SraddlvldW<MrxraddrSpec> {
        SraddlvldW::new(self, 24)
    }
    #[doc = "Bit 25 - address middle byte valid"]
    #[inline(always)]
    #[must_use]
    pub fn sraddmvld(&mut self) -> SraddmvldW<MrxraddrSpec> {
        SraddmvldW::new(self, 25)
    }
    #[doc = "Bit 26 - address high byte valid"]
    #[inline(always)]
    #[must_use]
    pub fn sraddhvld(&mut self) -> SraddhvldW<MrxraddrSpec> {
        SraddhvldW::new(self, 26)
    }
}
#[doc = "the slave register address accessed for master rx mode\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mrxraddr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mrxraddr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MrxraddrSpec;
impl crate::RegisterSpec for MrxraddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrxraddr::R`](R) reader structure"]
impl crate::Readable for MrxraddrSpec {}
#[doc = "`write(|w| ..)` method takes [`mrxraddr::W`](W) writer structure"]
impl crate::Writable for MrxraddrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MRXRADDR to value 0"]
impl crate::Resettable for MrxraddrSpec {
