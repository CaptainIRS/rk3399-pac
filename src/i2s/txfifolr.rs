#[doc = "Register `TXFIFOLR` reader"]
pub type R = crate::R<TxfifolrSpec>;
...
#[doc = "TX FIFO level register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txfifolr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TxfifolrSpec;
impl crate::RegisterSpec for TxfifolrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`txfifolr::R`](R) reader structure"]
impl crate::Readable for TxfifolrSpec {}
#[doc = "`reset()` method sets TXFIFOLR to value 0"]
impl crate::Resettable for TxfifolrSpec {
