...
#[doc = "Field `VDW` reader - Valid Data width (Can be written only when XFER\\[0\\]
...
#[doc = "Field `VDW` writer - Valid Data width (Can be written only when XFER\\[0\\]
bit is 0.) 0~14:reserved 15:16bit 16:17bit 17:18bit 18:19bit ...... n:(n+1)bit ...... 28:29bit 29:30bit 30:31bit 31:32bit"]
pub type VdwW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Transfer format select (Can be written only when XFER\\[0\\]
bit is 0.)\n\nValue on reset: 0"]
...
#[doc = "Field `TFS` reader - Transfer format select (Can be written only when XFER\\[0\\]
bit is 0.)"]
...
#[doc = "Field `TFS` writer - Transfer format select (Can be written only when XFER\\[0\\]
bit is 0.)"]
...
#[doc = "PCM bus mode (Can be written only when XFER\\[0\\]
bit is 0.)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Pbm {
...
#[doc = "Field `PBM` reader - PCM bus mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
...
#[doc = "Field `PBM` writer - PCM bus mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
...
#[doc = "I2S bus mode (Can be written only when XFER\\[0\\]
bit is 0.)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Ibm {
...
#[doc = "Field `IBM` reader - I2S bus mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
...
#[doc = "Field `IBM` writer - I2S bus mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
...
#[doc = "First Bit Mode (Can be written only when XFER\\[0\\]
bit is 0.)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Fbm {
    #[doc = "0: LSB"]
...
#[doc = "Field `FBM` reader - First Bit Mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
...
#[doc = "Field `FBM` writer - First Bit Mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
...
#[doc = "Store justified mode SJM Store justified mode (Can be written only when XFER\\[1\\]
bit is 0.) 16bit~31bit DATA stored in 32 bits width fifo. This bit is invalid if VDW select 16bit data and HWT select 0, Because every fifo unit contain two 16bit data and 32 bit space is full, it is impossible to choose justified mode.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Sjm {
...
#[doc = "Field `SJM` reader - Store justified mode SJM Store justified mode (Can be written only when XFER\\[1\\]
bit is 0.) 16bit~31bit DATA stored in 32 bits width fifo. This bit is invalid if VDW select 16bit data and HWT select 0, Because every fifo unit contain two 16bit data and 32 bit space is full, it is impossible to choose justified mode."]
...
#[doc = "Field `SJM` writer - Store justified mode SJM Store justified mode (Can be written only when XFER\\[1\\]
bit is 0.) 16bit~31bit DATA stored in 32 bits width fifo. This bit is invalid if VDW select 16bit data and HWT select 0, Because every fifo unit contain two 16bit data and 32 bit space is full, it is impossible to choose justified mode."]
...
#[doc = "Halfword word transform (Can be written only when XFER\\[0\\]
bit is 0.) Only valid when VDW select 16bit data.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Hwt {
    #[doc = "0: low 16bit data valid from AHB/APB bus, high 16 bit data invalid."]
    B0 = 0,
...
#[doc = "Field `HWT` reader - Halfword word transform (Can be written only when XFER\\[0\\]
bit is 0.) Only valid when VDW select 16bit data."]
...
#[doc = "Field `HWT` writer - Halfword word transform (Can be written only when XFER\\[0\\]
bit is 0.) Only valid when VDW select 16bit data."]
...
#[doc = "Field `RCNT` reader - right justified counter (Can be written only when XFER\\[0\\]
bit is 0.) Only valid in I2S Right justified format and slave tx mode is selected. Start to transmit data RCNT sclk cycles after left channel valid."]
pub type RcntR = crate::FieldReader;
#[doc = "Field `RCNT` writer - right justified counter (Can be written only when XFER\\[0\\]
bit is 0.) Only valid in I2S Right justified format and slave tx mode is selected. Start to transmit data RCNT sclk cycles after left channel valid."]
pub type RcntW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:4 - Valid Data width (Can be written only when XFER\\[0\\]
bit is 0.) 0~14:reserved 15:16bit 16:17bit 17:18bit 18:19bit ...... n:(n+1)bit ...... 28:29bit 29:30bit 30:31bit 31:32bit"]
    #[inline(always)]
    pub fn vdw(&self) -> VdwR {
        VdwR::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bit 5 - Transfer format select (Can be written only when XFER\\[0\\]
bit is 0.)"]
    #[inline(always)]
    pub fn tfs(&self) -> TfsR {
        TfsR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bits 7:8 - PCM bus mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
    #[inline(always)]
    pub fn pbm(&self) -> PbmR {
        PbmR::new(((self.bits >> 7) & 3) as u8)
    }
    #[doc = "Bits 9:10 - I2S bus mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
    #[inline(always)]
    pub fn ibm(&self) -> IbmR {
        IbmR::new(((self.bits >> 9) & 3) as u8)
    }
    #[doc = "Bit 11 - First Bit Mode (Can be written only when XFER\\[0\\]
bit is 0.)"]
    #[inline(always)]
    pub fn fbm(&self) -> FbmR {
        FbmR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Store justified mode SJM Store justified mode (Can be written only when XFER\\[1\\]
bit is 0.) 16bit~31bit DATA stored in 32 bits width fifo. This bit is invalid if VDW select 16bit data and HWT select 0, Because every fifo unit contain two 16bit data and 32 bit space is full, it is impossible to choose justified mode."]
    #[inline(always)]
    pub fn sjm(&self) -> SjmR {
        SjmR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 14 - Halfword word transform (Can be written only when XFER\\[0\\]
bit is 0.) Only valid when VDW select 16bit data."]
    #[inline(always)]
    ...
    #[doc = "Bits 17:22 - right justified counter (Can be written only when XFER\\[0\\]
bit is 0.) Only valid in I2S Right justified format and slave tx mode is selected. Start to transmit data RCNT sclk cycles after left channel valid."]
    #[inline(always)]
