...
pub type R = crate::R<TxcrSpec>;
#[doc = "Register `TXCR` writer"]
pub type W = crate::W<TxcrSpec>;
...
bit is 0.)\n\n0~14:reserved\n\n15:16bit\n\n16:17bit\n\n17:18bit\n\n18:19bit\n\n......\n\nn:(n+1)bit\n\n......\n\n28:29bit\n\n29:30bit\n\n30:31bit\n\n31:32bit"]
    #[inline(always)]
    #[must_use]
    pub fn vdw(&mut self) -> VdwW<TxcrSpec> {
        VdwW::new(self, 0)
    }
    #[doc = "Bit 5 - Transfer format select\n\n(Can be written only when XFER\\[0\\]
bit is 0.)"]
    #[inline(always)]
    #[must_use]
    pub fn tfs(&mut self) -> TfsW<TxcrSpec> {
        TfsW::new(self, 5)
    }
    #[doc = "Bits 7:8 - PCM bus mode\n\n(Can be written only when XFER\\[0\\]
bit is 0.)"]
    #[inline(always)]
    #[must_use]
    pub fn pbm(&mut self) -> PbmW<TxcrSpec> {
        PbmW::new(self, 7)
    }
    #[doc = "Bits 9:10 - I2S bus mode\n\n(Can be written only when XFER\\[0\\]
bit is 0.)"]
    #[inline(always)]
    #[must_use]
    pub fn ibm(&mut self) -> IbmW<TxcrSpec> {
        IbmW::new(self, 9)
    }
    #[doc = "Bit 11 - First Bit Mode\n\n(Can be written only when XFER\\[0\\]
bit is 0.)"]
    #[inline(always)]
    #[must_use]
    pub fn fbm(&mut self) -> FbmW<TxcrSpec> {
        FbmW::new(self, 11)
    }
    #[doc = "Bit 12 - Store justified mode\n\nSJM\n\nStore justified mode\n\n(Can be written only when XFER\\[1\\]
bit is 0.)\n\n16bit~31bit DATA stored in 32 bits width fifo.\n\nThis bit is invalid if VDW select 16bit data and HWT select 0,\n\nBecause every fifo unit contain two 16bit data and 32 bit space is\n\nfull, it is impossible to choose justified mode."]
    #[inline(always)]
    #[must_use]
    pub fn sjm(&mut self) -> SjmW<TxcrSpec> {
        SjmW::new(self, 12)
    }
    #[doc = "Bit 14 - Halfword word transform\n\n(Can be written only when XFER\\[0\\]
bit is 0.)\n\nOnly valid when VDW select 16bit data."]
    #[inline(always)]
    #[must_use]
    pub fn hwt(&mut self) -> HwtW<TxcrSpec> {
        HwtW::new(self, 14)
    }
    #[doc = "Bits 15:16 - TX Channel select register"]
    #[inline(always)]
    #[must_use]
    pub fn tcsr(&mut self) -> TcsrW<TxcrSpec> {
        TcsrW::new(self, 15)
    }
    #[doc = "Bits 17:22 - right justified counter\n\n(Can be written only when XFER\\[0\\]
bit is 0.)\n\nOnly valid in I2S Right justified format and slave tx mode is\n\nselected.\n\nStart to transmit data RCNT sclk cycles after left channel valid."]
    #[inline(always)]
    #[must_use]
    pub fn rcnt(&mut self) -> RcntW<TxcrSpec> {
        RcntW::new(self, 17)
    }
}
#[doc = "transmit operation control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TxcrSpec;
impl crate::RegisterSpec for TxcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`txcr::R`](R) reader structure"]
impl crate::Readable for TxcrSpec {}
#[doc = "`write(|w| ..)` method takes [`txcr::W`](W) writer structure"]
impl crate::Writable for TxcrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TXCR to value 0x0f"]
impl crate::Resettable for TxcrSpec {
