#[doc = "Register `PCIE_PF_BASE_ADDRESS_4` reader"]
pub type R = crate::R<PciePfBaseAddress4Spec>;
#[doc = "Register `PCIE_PF_BASE_ADDRESS_4` writer"]
pub type W = crate::W<PciePfBaseAddress4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bamrw(&mut self) -> BamrwW<PciePfBaseAddress4Spec> {
        BamrwW::new(self, 22)
    }
}
#[doc = "Base Address Register 4\n\nThis field defines the base address\n\nof the memory address range. The\n\nnumber of implemented bits in this\n\nfield determines the BAR aperture\n\nconfigured in BAR Configuration\n\nRegisters of the associated Physical\n\nFunction.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_base_address_4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcie_pf_base_address_4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfBaseAddress4Spec;
impl crate::RegisterSpec for PciePfBaseAddress4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_base_address_4::R`](R) reader structure"]
impl crate::Readable for PciePfBaseAddress4Spec {}
#[doc = "`write(|w| ..)` method takes [`pcie_pf_base_address_4::W`](W) writer structure"]
impl crate::Writable for PciePfBaseAddress4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_PF_BASE_ADDRESS_4 to value 0x04"]
impl crate::Resettable for PciePfBaseAddress4Spec {
