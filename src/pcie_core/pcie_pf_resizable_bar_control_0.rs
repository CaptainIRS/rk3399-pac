#[doc = "Register `PCIE_PF_RESIZABLE_BAR_CONTROL_0` reader"]
pub type R = crate::R<PciePfResizableBarControl0Spec>;
...
#[doc = "Resizable BAR Control Register 0 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_control_0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarControl0Spec;
impl crate::RegisterSpec for PciePfResizableBarControl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_control_0::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarControl0Spec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_CONTROL_0 to value 0"]
impl crate::Resettable for PciePfResizableBarControl0Spec {
