#[doc = "Register `PCIE_RC_L1_PM_SUBSTATES_CONTROL_1` reader"]
pub type R = crate::R<PcieRcL1PmSubstatesControl1Spec>;
#[doc = "Register `PCIE_RC_L1_PM_SUBSTATES_CONTROL_1` writer"]
pub type W = crate::W<PcieRcL1PmSubstatesControl1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1pml12en(&mut self) -> L1pml12enW<PcieRcL1PmSubstatesControl1Spec> {
        L1pml12enW::new(self, 0)
    }
    #[doc = "Bit 1 - PML1.1 Enable \\[L1PML11EN\\]\n\n(no description)"]
    #[inline(always)]
    #[must_use]
    pub fn l1pml11en(&mut self) -> L1pml11enW<PcieRcL1PmSubstatesControl1Spec> {
        L1pml11enW::new(self, 1)
    }
    #[doc = "Bit 2 - ASPML1.2 Enable \\[L1ASPML12EN\\]\n\n(no description)"]
    #[inline(always)]
    #[must_use]
    pub fn l1aspml12en(&mut self) -> L1aspml12enW<PcieRcL1PmSubstatesControl1Spec> {
        L1aspml12enW::new(self, 2)
    }
    #[doc = "Bit 3 - ASPML1.1 Enable \\[L1ASPML11EN\\]\n\n(no description)"]
    #[inline(always)]
    #[must_use]
    pub fn l1aspml11en(&mut self) -> L1aspml11enW<PcieRcL1PmSubstatesControl1Spec> {
        L1aspml11enW::new(self, 3)
    }
    #[doc = "Bits 8:15 - Common Mode Restore Time \\[L1CmMdReStrTime\\]\n\n(no description)"]
    #[inline(always)]
    #[must_use]
    pub fn l1cm_md_re_str_time(&mut self) -> L1cmMdReStrTimeW<PcieRcL1PmSubstatesControl1Spec> {
        L1cmMdReStrTimeW::new(self, 8)
    }
    #[doc = "Bits 16:25 - LTR L1.2 Threshold Value \\[L1ThrshldVal\\]\n\n(no description)"]
    #[inline(always)]
    #[must_use]
    pub fn l1thrshld_val(&mut self) -> L1thrshldValW<PcieRcL1PmSubstatesControl1Spec> {
        L1thrshldValW::new(self, 16)
    }
    #[doc = "Bits 29:31 - LTR L1.2 Threshold Scale \\[L1ThrshldSc\\]\n\n(no description)"]
    #[inline(always)]
    #[must_use]
    pub fn l1thrshld_sc(&mut self) -> L1thrshldScW<PcieRcL1PmSubstatesControl1Spec> {
        L1thrshldScW::new(self, 29)
    }
}
#[doc = "L1 PM Substates Control 1 Register\n\n(no description)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_rc_l1_pm_substates_control_1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcie_rc_l1_pm_substates_control_1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcieRcL1PmSubstatesControl1Spec;
impl crate::RegisterSpec for PcieRcL1PmSubstatesControl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_rc_l1_pm_substates_control_1::R`](R) reader structure"]
impl crate::Readable for PcieRcL1PmSubstatesControl1Spec {}
#[doc = "`write(|w| ..)` method takes [`pcie_rc_l1_pm_substates_control_1::W`](W) writer structure"]
impl crate::Writable for PcieRcL1PmSubstatesControl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_RC_L1_PM_SUBSTATES_CONTROL_1 to value 0"]
impl crate::Resettable for PcieRcL1PmSubstatesControl1Spec {
