#[doc = "Register `PCIE_VF_MSI_X_CONTROL` reader"]
...
#[doc = "`read()` method returns [`pcie_vf_msi_x_control::R`](R) reader structure"]
impl crate::Readable for PcieVfMsiXControlSpec {}
#[doc = "`write(|w| ..)` method takes [`pcie_vf_msi_x_control::W`](W) writer structure"]
impl crate::Writable for PcieVfMsiXControlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_VF_MSI_X_CONTROL to value 0xc011"]
impl crate::Resettable for PcieVfMsiXControlSpec {
