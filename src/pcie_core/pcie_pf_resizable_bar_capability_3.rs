#[doc = "Register `PCIE_PF_RESIZABLE_BAR_CAPABILITY_3` reader"]
pub type R = crate::R<PciePfResizableBarCapability3Spec>;
...
#[doc = "Resizable BAR Capability Register 3\n\nReserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_capability_3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarCapability3Spec;
impl crate::RegisterSpec for PciePfResizableBarCapability3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_capability_3::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarCapability3Spec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_CAPABILITY_3 to value 0"]
impl crate::Resettable for PciePfResizableBarCapability3Spec {
