#[doc = "Register `PCIE_PF_LINK_CAPABILITIES` reader"]
pub type R = crate::R<PciePfLinkCapabilitiesSpec>;
...
#[doc = "Link Capabilities Register\n\nSpecifies the port number assigned\n\nto the PCI Express link connected to\n\nthis device.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_link_capabilities::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfLinkCapabilitiesSpec;
impl crate::RegisterSpec for PciePfLinkCapabilitiesSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_link_capabilities::R`](R) reader structure"]
impl crate::Readable for PciePfLinkCapabilitiesSpec {}
#[doc = "`reset()` method sets PCIE_PF_LINK_CAPABILITIES to value 0x0041_ac42"]
impl crate::Resettable for PciePfLinkCapabilitiesSpec {
