#[doc = "Register `PCIE_PF_L1_PM_SUBSTATES_EXTENDED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<PciePfL1PmSubstatesExtendedCapabilityHeaderSpec>;
...
#[doc = "L1 PM Substates Extended Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_l1_pm_substates_extended_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfL1PmSubstatesExtendedCapabilityHeaderSpec;
impl crate::RegisterSpec for PciePfL1PmSubstatesExtendedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_l1_pm_substates_extended_capability_header::R`](R) reader structure"]
impl crate::Readable for PciePfL1PmSubstatesExtendedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets PCIE_PF_L1_PM_SUBSTATES_EXTENDED_CAPABILITY_HEADER to value 0x0001_001e"]
impl crate::Resettable for PciePfL1PmSubstatesExtendedCapabilityHeaderSpec {
