#[doc = "Register `PCIE_PF_RESIZABLE_BAR_CAPABILITY_1` reader"]
pub type R = crate::R<PciePfResizableBarCapability1Spec>;
...
#[doc = "Resizable BAR Capability Register 1 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_capability_1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarCapability1Spec;
impl crate::RegisterSpec for PciePfResizableBarCapability1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_capability_1::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarCapability1Spec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_CAPABILITY_1 to value 0"]
impl crate::Resettable for PciePfResizableBarCapability1Spec {
