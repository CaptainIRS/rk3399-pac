#[doc = "Register `PCIE_PF_RESIZABLE_BAR_CAPABILITY_5` reader"]
pub type R = crate::R<PciePfResizableBarCapability5Spec>;
...
#[doc = "Resizable BAR Capability Register 5 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_capability_5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarCapability5Spec;
impl crate::RegisterSpec for PciePfResizableBarCapability5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_capability_5::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarCapability5Spec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_CAPABILITY_5 to value 0"]
impl crate::Resettable for PciePfResizableBarCapability5Spec {
