#[doc = "Register `PCIE_PF_DPA_EXTENDED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<PciePfDpaExtendedCapabilityHeaderSpec>;
#[doc = "Field `PECID` reader - PCI Express Extended Capability ID \\[PECID\\]
This field is hardwired to the Capability ID assigned by PCI SIG to the Dynamic Power Allocation Reporting Capability"]
...
#[doc = "DPA Extended Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_dpa_extended_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfDpaExtendedCapabilityHeaderSpec;
impl crate::RegisterSpec for PciePfDpaExtendedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_dpa_extended_capability_header::R`](R) reader structure"]
impl crate::Readable for PciePfDpaExtendedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets PCIE_PF_DPA_EXTENDED_CAPABILITY_HEADER to value 0x2001_0016"]
impl crate::Resettable for PciePfDpaExtendedCapabilityHeaderSpec {
    const RESET_VALUE: u32 = 0x2001_0016;
}
