#[doc = "Register `PCIE_PF_POWER_MANAGEMENT_CAPABILITIES` reader"]
pub type R = crate::R<PciePfPowerManagementCapabilitiesSpec>;
...
Contains pointer to the next PCI Capability Structure. The core sets it to the value defined in the RTL file reg_defaults.h. This field can be re- written independently for each Function from the local management bus."]
...
This bit, when set, indicates that the device requires additional configuration steps beyond setting up its PCI configuration space, to bring it to the D0 active state from the D0 uninitialized state. This bit is hardwired to 0."]
...
Indicates whether the Function is capable of sending PME messages when in the D1 state. This bit can be modified from the local management bus by writing into Function 0. All other Functions assume the value set in Function 0s Power Management Capabilities Register."]
...
#[doc = "Field `PSDHS` reader - PME Support for D3(hot) Statue \\[PSDHS\\]
...
Indicates whether the Function is capable of sending PME messages when in the D2 state. This bit is hardwired to 0 because D2 state is not supported."]
    ...
    #[doc = "Bit 30 - PME Support for D3(hot) Statue \\[PSDHS\\]
Indicates whether the Function is capable of sending PME messages when in the D3hot state. This bit is set to 1 by default, but can be modified from the local management bus by writing into Function 0. All other Functions assume the value set in Function 0s Power Management Capabilities Register."]
    #[inline(always)]
...
#[doc = "Power Management Capabilities Register Indicates whether the Function is capable of sending PME messages when in the D3cold state. Because the device does not have aux power, this bit is hardwired to 0.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_power_management_capabilities::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfPowerManagementCapabilitiesSpec;
impl crate::RegisterSpec for PciePfPowerManagementCapabilitiesSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_power_management_capabilities::R`](R) reader structure"]
impl crate::Readable for PciePfPowerManagementCapabilitiesSpec {}
#[doc = "`reset()` method sets PCIE_PF_POWER_MANAGEMENT_CAPABILITIES to value 0x5a03_9001"]
impl crate::Resettable for PciePfPowerManagementCapabilitiesSpec {
