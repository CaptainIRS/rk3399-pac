#[doc = "Register `PCIE_VF_TPH_ST_TABLE_1` reader"]
pub type R = crate::R<PcieVfTphStTable1Spec>;
#[doc = "Register `PCIE_VF_TPH_ST_TABLE_1` writer"]
pub type W = crate::W<PcieVfTphStTable1Spec>;
...
Lower 8 bits of the first Steering Tag. This is the 8- bit Steering Tag sent out in requests."]
    #[inline(always)]
    #[must_use]
    pub fn st0l(&mut self) -> St0lW<PcieVfTphStTable1Spec> {
        St0lW::new(self, 0)
    }
    #[doc = "Bits 16:23 - ST 1 Lower \\[ST1L\\]
Lower 8 bits of the second Steering Tag. This is the 8-bit Steering Tag sent out in requests."]
    #[inline(always)]
    #[must_use]
    pub fn st1l(&mut self) -> St1lW<PcieVfTphStTable1Spec> {
        St1lW::new(self, 16)
    }
}
#[doc = "TPH ST Table 1 This field is used for the upper 8 bits of the second Steering Tag when Extended TPH Requester support is enabled.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_vf_tph_st_table_1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcie_vf_tph_st_table_1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcieVfTphStTable1Spec;
impl crate::RegisterSpec for PcieVfTphStTable1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_vf_tph_st_table_1::R`](R) reader structure"]
impl crate::Readable for PcieVfTphStTable1Spec {}
#[doc = "`write(|w| ..)` method takes [`pcie_vf_tph_st_table_1::W`](W) writer structure"]
impl crate::Writable for PcieVfTphStTable1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_VF_TPH_ST_TABLE_1 to value 0"]
impl crate::Resettable for PcieVfTphStTable1Spec {
