#[doc = "Register `PCIE_PF_VF_BASE_ADDRESS_4` reader"]
pub type R = crate::R<PciePfVfBaseAddress4Spec>;
#[doc = "Register `PCIE_PF_VF_BASE_ADDRESS_4` writer"]
pub type W = crate::W<PciePfVfBaseAddress4Spec>;
...
When the BAR is used to define a memory address range, this field declares whether data from the address range is prefetchable (0 = non- prefetchable, 1 = prefetchable). The value read in this field is determined by the setting of BAR Configuration Registers of the"]
...
This field defines the base address of the memory address range. The number of implemented bits in this field determines the BAR aperture configured in BAR Configuration Registers of the associated Physical Function."]
    #[inline(always)]
    #[must_use]
    pub fn bamrw(&mut self) -> BamrwW<PciePfVfBaseAddress4Spec> {
        BamrwW::new(self, 22)
    }
}
#[doc = "VF Base Address Register 4 This field defines the base address of the memory address range. The number of implemented bits in this field determines the BAR aperture configured in BAR Configuration Registers of the associated Physical Function.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_vf_base_address_4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcie_pf_vf_base_address_4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfVfBaseAddress4Spec;
impl crate::RegisterSpec for PciePfVfBaseAddress4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_vf_base_address_4::R`](R) reader structure"]
impl crate::Readable for PciePfVfBaseAddress4Spec {}
#[doc = "`write(|w| ..)` method takes [`pcie_pf_vf_base_address_4::W`](W) writer structure"]
impl crate::Writable for PciePfVfBaseAddress4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_PF_VF_BASE_ADDRESS_4 to value 0x04"]
impl crate::Resettable for PciePfVfBaseAddress4Spec {
