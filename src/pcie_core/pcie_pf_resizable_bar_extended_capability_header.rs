#[doc = "Register `PCIE_PF_RESIZABLE_BAR_EXTENDED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<PciePfResizableBarExtendedCapabilityHeaderSpec>;
#[doc = "Field `PECID` reader - PCI Express Extended Capability ID \\[PECID\\]
This field is hardwired to the Capability ID assigned by PCI SIG to the Resizable BAR Capability (0015 hex)."]
...
#[doc = "Resizable BAR Extended Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_extended_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarExtendedCapabilityHeaderSpec;
impl crate::RegisterSpec for PciePfResizableBarExtendedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_extended_capability_header::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarExtendedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_EXTENDED_CAPABILITY_HEADER to value 0"]
impl crate::Resettable for PciePfResizableBarExtendedCapabilityHeaderSpec {
