#[doc = "Register `PCIE_RC_MSI_X_TABLE_OFFSET` reader"]
pub type R = crate::R<PcieRcMsiXTableOffsetSpec>;
...
#[doc = "MSI-X Table Offset Register Offset of the memory address where the MSI- X Table is located, relative to the selected BAR. The three least significant bits of the address are omitted, as the addresses are QWORD aligned.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_rc_msi_x_table_offset::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcieRcMsiXTableOffsetSpec;
impl crate::RegisterSpec for PcieRcMsiXTableOffsetSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_rc_msi_x_table_offset::R`](R) reader structure"]
impl crate::Readable for PcieRcMsiXTableOffsetSpec {}
#[doc = "`reset()` method sets PCIE_RC_MSI_X_TABLE_OFFSET to value 0"]
impl crate::Resettable for PcieRcMsiXTableOffsetSpec {
