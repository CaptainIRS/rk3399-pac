#[doc = "Register `PCIE_PF_BASE_ADDRESS_2` reader"]
pub type R = crate::R<PciePfBaseAddress2Spec>;
#[doc = "Register `PCIE_PF_BASE_ADDRESS_2` writer"]
pub type W = crate::W<PciePfBaseAddress2Spec>;
...
This field defines the base address of the memory address range. The number of implemented bits in this field determines the BAR aperture configured in BAR Configuration Registers of the associated Physical Function."]
    #[inline(always)]
    #[must_use]
    pub fn bamrw(&mut self) -> BamrwW<PciePfBaseAddress2Spec> {
        BamrwW::new(self, 22)
    }
}
#[doc = "Base Address Register 2 This field defines the base address of the memory address range. The number of implemented bits in this field determines the BAR aperture configured in BAR Configuration Registers of the associated Physical Function.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_base_address_2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcie_pf_base_address_2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfBaseAddress2Spec;
impl crate::RegisterSpec for PciePfBaseAddress2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_base_address_2::R`](R) reader structure"]
impl crate::Readable for PciePfBaseAddress2Spec {}
#[doc = "`write(|w| ..)` method takes [`pcie_pf_base_address_2::W`](W) writer structure"]
impl crate::Writable for PciePfBaseAddress2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_PF_BASE_ADDRESS_2 to value 0x04"]
impl crate::Resettable for PciePfBaseAddress2Spec {
