#[doc = "Register `PCIE_VF_ADVANCED_ERROR_REPORTING_AER_ENHANCED_CAPABILITY_HEADER` reader"]
pub type R = crate::R<PcieVfAdvancedErrorReportingAerEnhancedCapabilityHeaderSpec>;
...
Specifies the SIG assigned value for the version of the capability structure. This field reflects the setting of the corresponding field in the AER Enhanced Capability Header Register of PF 0."]
...
#[doc = "Advanced Error Reporting (AER) Enhanced Capability Header Register Indicates offset to the next PCI Express capability structure. The default next pointer value is dynamic and is dependent on whether the strap or LMI bits are set.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_vf_advanced_error_reporting_aer_enhanced_capability_header::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcieVfAdvancedErrorReportingAerEnhancedCapabilityHeaderSpec;
impl crate::RegisterSpec for PcieVfAdvancedErrorReportingAerEnhancedCapabilityHeaderSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_vf_advanced_error_reporting_aer_enhanced_capability_header::R`](R) reader structure"]
impl crate::Readable for PcieVfAdvancedErrorReportingAerEnhancedCapabilityHeaderSpec {}
#[doc = "`reset()` method sets PCIE_VF_ADVANCED_ERROR_REPORTING_AER_ENHANCED_CAPABILITY_HEADER to value 0x1402_0001"]
impl crate::Resettable for PcieVfAdvancedErrorReportingAerEnhancedCapabilityHeaderSpec {
