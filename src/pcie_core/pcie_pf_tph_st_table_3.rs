#[doc = "Register `PCIE_PF_TPH_ST_TABLE_3` reader"]
pub type R = crate::R<PciePfTphStTable3Spec>;
#[doc = "Register `PCIE_PF_TPH_ST_TABLE_3` writer"]
pub type W = crate::W<PciePfTphStTable3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn stl0(&mut self) -> Stl0W<PciePfTphStTable3Spec> {
        Stl0W::new(self, 0)
    }
    #[doc = "Bits 16:23 - ST Lower 1 \\[STL1\\]\n\nLower 8 bits of the second Steering\n\nTag. This is the 8-bit Steering Tag\n\nsent out in requests."]
    #[inline(always)]
    #[must_use]
    pub fn stl1(&mut self) -> Stl1W<PciePfTphStTable3Spec> {
        Stl1W::new(self, 16)
    }
}
#[doc = "TPH ST Table 3\n\nThis field is used for the upper 8 bits\n\nof the second Steering Tag when\n\nExtended TPH Requester support is\n\nenabled.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_tph_st_table_3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcie_pf_tph_st_table_3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfTphStTable3Spec;
impl crate::RegisterSpec for PciePfTphStTable3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_tph_st_table_3::R`](R) reader structure"]
impl crate::Readable for PciePfTphStTable3Spec {}
#[doc = "`write(|w| ..)` method takes [`pcie_pf_tph_st_table_3::W`](W) writer structure"]
impl crate::Writable for PciePfTphStTable3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_PF_TPH_ST_TABLE_3 to value 0"]
impl crate::Resettable for PciePfTphStTable3Spec {
