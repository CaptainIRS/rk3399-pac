#[doc = "Register `PCIE_PF_PCI_EXPRESS_CAPABILITY_LIST` reader"]
pub type R = crate::R<PciePfPciExpressCapabilityListSpec>;
...
Identifies the version number of the capability structure. The value depends on the value of the strap input PCIE_GENERATION_SEL If PCIE_GENERATION_SEL indicates Gen 2 or later generations, then the value is 2 else 1. It can be modified through local management interface."]
...
#[doc = "PCI Express Capability List Register Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_pci_express_capability_list::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfPciExpressCapabilityListSpec;
impl crate::RegisterSpec for PciePfPciExpressCapabilityListSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_pci_express_capability_list::R`](R) reader structure"]
impl crate::Readable for PciePfPciExpressCapabilityListSpec {}
#[doc = "`reset()` method sets PCIE_PF_PCI_EXPRESS_CAPABILITY_LIST to value 0x0002_0010"]
impl crate::Resettable for PciePfPciExpressCapabilityListSpec {
