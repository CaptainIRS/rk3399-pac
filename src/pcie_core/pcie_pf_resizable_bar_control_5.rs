#[doc = "Register `PCIE_PF_RESIZABLE_BAR_CONTROL_5` reader"]
pub type R = crate::R<PciePfResizableBarControl5Spec>;
...
#[doc = "Resizable BAR Control Register 5 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_control_5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarControl5Spec;
impl crate::RegisterSpec for PciePfResizableBarControl5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_control_5::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarControl5Spec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_CONTROL_5 to value 0"]
impl crate::Resettable for PciePfResizableBarControl5Spec {
