#[doc = "Register `PCIE_PF_RESIZABLE_BAR_CAPABILITY_4` reader"]
pub type R = crate::R<PciePfResizableBarCapability4Spec>;
...
#[doc = "Resizable BAR Capability Register 4 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_capability_4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarCapability4Spec;
impl crate::RegisterSpec for PciePfResizableBarCapability4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_capability_4::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarCapability4Spec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_CAPABILITY_4 to value 0"]
impl crate::Resettable for PciePfResizableBarCapability4Spec {
