...
Indicates the maximum speed supported by the link. (2.5 GT/s, 5 GT/s per lane). This field is hardwired to 0001 (2.5GT/s) when the strap input PCIE_GENERATION_SEL is set to 0, to 0010 (5GT/s) when the strap is set to 1."]
...
Set to 1 if the device is capable of reporting that the DL Control and Management State Machine has reached the DL Active state. This bit is hardwired to 0, as this version of the core does not support the feature."]
