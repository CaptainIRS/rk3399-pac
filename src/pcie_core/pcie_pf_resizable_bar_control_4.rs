#[doc = "Register `PCIE_PF_RESIZABLE_BAR_CONTROL_4` reader"]
pub type R = crate::R<PciePfResizableBarControl4Spec>;
...
#[doc = "Resizable BAR Control Register 4 Reserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_control_4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarControl4Spec;
impl crate::RegisterSpec for PciePfResizableBarControl4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_control_4::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarControl4Spec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_CONTROL_4 to value 0"]
impl crate::Resettable for PciePfResizableBarControl4Spec {
