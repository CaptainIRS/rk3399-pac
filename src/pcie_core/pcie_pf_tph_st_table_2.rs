#[doc = "Register `PCIE_PF_TPH_ST_TABLE_2` reader"]
pub type R = crate::R<PciePfTphStTable2Spec>;
#[doc = "Register `PCIE_PF_TPH_ST_TABLE_2` writer"]
pub type W = crate::W<PciePfTphStTable2Spec>;
...
Lower 8 bits of the first Steering Tag. This is the 8- bit Steering Tag sent out in requests."]
    #[inline(always)]
    #[must_use]
    pub fn stl0(&mut self) -> Stl0W<PciePfTphStTable2Spec> {
        Stl0W::new(self, 0)
    }
    #[doc = "Bits 16:23 - ST Lower 1 \\[STL1\\]
Lower 8 bits of the second Steering Tag. This is the 8-bit Steering Tag sent out in requests."]
    #[inline(always)]
    #[must_use]
    pub fn stl1(&mut self) -> Stl1W<PciePfTphStTable2Spec> {
        Stl1W::new(self, 16)
    }
}
#[doc = "TPH ST Table 2 This field is used for the upper 8 bits of the second Steering Tag when Extended TPH Requester support is enabled.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_tph_st_table_2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcie_pf_tph_st_table_2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfTphStTable2Spec;
impl crate::RegisterSpec for PciePfTphStTable2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_tph_st_table_2::R`](R) reader structure"]
impl crate::Readable for PciePfTphStTable2Spec {}
#[doc = "`write(|w| ..)` method takes [`pcie_pf_tph_st_table_2::W`](W) writer structure"]
impl crate::Writable for PciePfTphStTable2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_PF_TPH_ST_TABLE_2 to value 0"]
impl crate::Resettable for PciePfTphStTable2Spec {
