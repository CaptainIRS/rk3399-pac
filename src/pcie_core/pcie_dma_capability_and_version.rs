...
#[doc = "Field `MIN_VER` reader - min_ver Minor Version No"]
pub type MinVerR = crate::FieldReader;
#[doc = "Field `MAJ_VER` reader - maj_ver Major Version No"]
pub type MajVerR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - min_ver Minor Version No"]
    #[inline(always)]
    pub fn min_ver(&self) -> MinVerR {
        MinVerR::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - maj_ver Major Version No"]
    #[inline(always)]
