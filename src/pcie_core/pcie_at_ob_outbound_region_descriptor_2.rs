#[doc = "Register `PCIE_AT_OB_OUTBOUND_REGION_DESCRIPTOR_2` reader"]
pub type R = crate::R<PcieAtObOutboundRegionDescriptor2Spec>;
...
#[doc = "`read()` method returns [`pcie_at_ob_outbound_region_descriptor_2::R`](R) reader structure"]
impl crate::Readable for PcieAtObOutboundRegionDescriptor2Spec {}
#[doc = "`write(|w| ..)` method takes [`pcie_at_ob_outbound_region_descriptor_2::W`](W) writer structure"]
impl crate::Writable for PcieAtObOutboundRegionDescriptor2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCIE_AT_OB_OUTBOUND_REGION_DESCRIPTOR_2 to value 0"]
impl crate::Resettable for PcieAtObOutboundRegionDescriptor2Spec {
