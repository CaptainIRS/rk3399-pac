#[doc = "Register `PCIE_PF_RESIZABLE_BAR_CAPABILITY_0` reader"]
pub type R = crate::R<PciePfResizableBarCapability0Spec>;
...
#[doc = "Resizable BAR Capability Register 0\n\nReserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_pf_resizable_bar_capability_0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PciePfResizableBarCapability0Spec;
impl crate::RegisterSpec for PciePfResizableBarCapability0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_pf_resizable_bar_capability_0::R`](R) reader structure"]
impl crate::Readable for PciePfResizableBarCapability0Spec {}
#[doc = "`reset()` method sets PCIE_PF_RESIZABLE_BAR_CAPABILITY_0 to value 0"]
impl crate::Resettable for PciePfResizableBarCapability0Spec {
