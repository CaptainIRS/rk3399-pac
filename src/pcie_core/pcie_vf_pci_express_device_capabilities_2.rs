#[doc = "Register `PCIE_VF_PCI_EXPRESS_DEVICE_CAPABILITIES_2` reader"]
pub type R = crate::R<PcieVfPciExpressDeviceCapabilities2Spec>;
...
#[doc = "PCI Express Device Capabilities Register 2\n\nReserved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pcie_vf_pci_express_device_capabilities_2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcieVfPciExpressDeviceCapabilities2Spec;
impl crate::RegisterSpec for PcieVfPciExpressDeviceCapabilities2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcie_vf_pci_express_device_capabilities_2::R`](R) reader structure"]
impl crate::Readable for PcieVfPciExpressDeviceCapabilities2Spec {}
#[doc = "`reset()` method sets PCIE_VF_PCI_EXPRESS_DEVICE_CAPABILITIES_2 to value 0x0004_1812"]
impl crate::Resettable for PcieVfPciExpressDeviceCapabilities2Spec {
