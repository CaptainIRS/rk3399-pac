...
#[doc = "Field `BINUM1` reader - SS USB Instance Number for Port 1 Application-programmable ID field."]
pub type Binum1R = crate::FieldReader;
#[doc = "Field `BINUM1` writer - SS USB Instance Number for Port 1 Application-programmable ID field."]
pub type Binum1W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bits 0:3 - SS USB Instance Number for Port 1 Application-programmable ID field."]
    #[inline(always)]
