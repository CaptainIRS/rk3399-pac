#[doc = "Register `USB3_GUCTL1` reader"]
pub type R = crate::R<Usb3Guctl1Spec>;
#[doc = "Register `USB3_GUCTL1` writer"]
pub type W = crate::W<Usb3Guctl1Spec>;
#[doc = "Field `LOA_FILTER_EN` reader - LOA_FILTER_EN If this bit is set, the USB 2.0 port babble is checked at least three consecutive times before the port is disabled. This prevents false triggering of the babble condition when using low quality cables. Note: This bit is valid only in host mode."]
pub type LoaFilterEnR = crate::BitReader;
#[doc = "Field `LOA_FILTER_EN` writer - LOA_FILTER_EN If this bit is set, the USB 2.0 port babble is checked at least three consecutive times before the port is disabled. This prevents false triggering of the babble condition when using low quality cables. Note: This bit is valid only in host mode."]
pub type LoaFilterEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OVRLD_L1_SUSP_COM` reader - OVRLD_L1_SUSP_COM If this bit is set, the utmi_l1_suspend_com_n is overloaded with the utmi_sleep_n signal. This bit is usually set if the PHY stops the port clock during L1 sleep condition."]
pub type OvrldL1SuspComR = crate::BitReader;
#[doc = "Field `OVRLD_L1_SUSP_COM` writer - OVRLD_L1_SUSP_COM If this bit is set, the utmi_l1_suspend_com_n is overloaded with the utmi_sleep_n signal. This bit is usually set if the PHY stops the port clock during L1 sleep condition."]
pub type OvrldL1SuspComW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HC_PARCHK_DISABLE` reader - Host Parameter Check Disable When this bit is set to 0 (by default), the xHC checks that the input slot/EP context fields comply to the xHCI Specification. Upon detection of a parameter error during command execution, the xHC generates an event TRB with completion code indicating PARAMETER ERROR. When the bit is set to 1, the xHC does not perform parameter checks and does not generate PARAMETER ERROR completion code."]
pub type HcParchkDisableR = crate::BitReader;
#[doc = "Field `HC_PARCHK_DISABLE` writer - Host Parameter Check Disable When this bit is set to 0 (by default), the xHC checks that the input slot/EP context fields comply to the xHCI Specification. Upon detection of a parameter error during command execution, the xHC generates an event TRB with completion code indicating PARAMETER ERROR. When the bit is set to 1, the xHC does not perform parameter checks and does not generate PARAMETER ERROR completion code."]
pub type HcParchkDisableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HC_ERRATA_ENABLE` reader - Host ELD Enable When this bit is set to 1, it enables the Exit Latency Delta (ELD) support defined in the xHCI 1.0 Errata. This bit is used only in the host mode. This bit has to be set to 1 in Host mode."]
pub type HcErrataEnableR = crate::BitReader;
#[doc = "Field `HC_ERRATA_ENABLE` writer - Host ELD Enable When this bit is set to 1, it enables the Exit Latency Delta (ELD) support defined in the xHCI 1.0 Errata. This bit is used only in the host mode. This bit has to be set to 1 in Host mode."]
pub type HcErrataEnableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_SUSP_THRLD_FOR_HOST` reader - L1_SUSP_THRLD_FOR_HOST This field is effective only when the L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1. For more details, refer to the description of the L1_SUSP_THRLD_EN_FOR_HOST bit."]
pub type L1SuspThrldForHostR = crate::FieldReader;
#[doc = "Field `L1_SUSP_THRLD_FOR_HOST` writer - L1_SUSP_THRLD_FOR_HOST This field is effective only when the L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1. For more details, refer to the description of the L1_SUSP_THRLD_EN_FOR_HOST bit."]
pub type L1SuspThrldForHostW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `L1_SUSP_THRLD_EN_FOR_HOST` reader - L1_SUSP_THRLD_EN_FOR_HOST This bit is used only in host mode. The host controller asserts the utmi_l1_suspend_n and utmi_sleep_n output signals (see LPM Interface Signals table in the Databook) as follows: The controller asserts the utmi_l1_suspend_n signal to put the PHY into deep low-power mode in L1 when both of the following are true: The HIRD/BESL value used is greater than or equal to the value in L1_SUSP_THRLD_FOR_HOST field. The L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1'b1. The controller asserts utmi_sleep_n on L1 when one of the following is true: The HIRD/BESL value used is less than the value in L1_SUSP_THRLD_FOR_HOST field. The L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1'b0."]
pub type L1SuspThrldEnForHostR = crate::BitReader;
#[doc = "Field `L1_SUSP_THRLD_EN_FOR_HOST` writer - L1_SUSP_THRLD_EN_FOR_HOST This bit is used only in host mode. The host controller asserts the utmi_l1_suspend_n and utmi_sleep_n output signals (see LPM Interface Signals table in the Databook) as follows: The controller asserts the utmi_l1_suspend_n signal to put the PHY into deep low-power mode in L1 when both of the following are true: The HIRD/BESL value used is greater than or equal to the value in L1_SUSP_THRLD_FOR_HOST field. The L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1'b1. The controller asserts utmi_sleep_n on L1 when one of the following is true: The HIRD/BESL value used is less than the value in L1_SUSP_THRLD_FOR_HOST field. The L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1'b0."]
pub type L1SuspThrldEnForHostW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PARKMODE_DISABLE_FSLS` reader - PARKMODE_DISABLE_FSLS This bit is used only in host mode, and is for debug purpose only. When this bit is set to 1 all FS/LS bus instances in park mode disabled."]
pub type ParkmodeDisableFslsR = crate::BitReader;
#[doc = "Field `PARKMODE_DISABLE_FSLS` writer - PARKMODE_DISABLE_FSLS This bit is used only in host mode, and is for debug purpose only. When this bit is set to 1 all FS/LS bus instances in park mode disabled."]
pub type ParkmodeDisableFslsW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PARKMODE_DISABLE_HS` reader - PARKMODE_DISABLE_HS This bit is used only in host mode. When this bit is set to 1 all HS bus instances park mode are disabled. To improve performance in park mode, the xHCI scheduler queues in three requests of 4 packets each for High Speed asynchronous endpoints in a micro-frame. But if a device is slow and if it NAKs more than 3 times, then it is rescheduled only in the next micro-frame. This could decrease the performance of a slow device even further. In a few high speed devices (such as Sandisk Cruzer Blade 4GB VID:1921, PID:21863 and Flex Drive VID:3744, PID:8552) when an IN request is sent within 900ns of the ACK of the previous packet, these devices send a NAK. When connected to these devices, if required, the software can disable the park mode if you see performance drop in your system. When park mode is disabled, pipelining of multiple packet is disabled and instead one packet at a time is requested by the scheduler. This allows up to 12 NAKs in a micro-frame and improves performance of these slow devices."]
pub type ParkmodeDisableHsR = crate::BitReader;
#[doc = "Field `PARKMODE_DISABLE_HS` writer - PARKMODE_DISABLE_HS This bit is used only in host mode. When this bit is set to 1 all HS bus instances park mode are disabled. To improve performance in park mode, the xHCI scheduler queues in three requests of 4 packets each for High Speed asynchronous endpoints in a micro-frame. But if a device is slow and if it NAKs more than 3 times, then it is rescheduled only in the next micro-frame. This could decrease the performance of a slow device even further. In a few high speed devices (such as Sandisk Cruzer Blade 4GB VID:1921, PID:21863 and Flex Drive VID:3744, PID:8552) when an IN request is sent within 900ns of the ACK of the previous packet, these devices send a NAK. When connected to these devices, if required, the software can disable the park mode if you see performance drop in your system. When park mode is disabled, pipelining of multiple packet is disabled and instead one packet at a time is requested by the scheduler. This allows up to 12 NAKs in a micro-frame and improves performance of these slow devices."]
pub type ParkmodeDisableHsW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PARKMODE_DISABLE_SS` reader - PARKMODE_DISABLE_SS This bit is used only in host mode, and is for debug purpose only. When this bit is set to 1 all SS bus instances in park mode are disabled."]
pub type ParkmodeDisableSsR = crate::BitReader;
#[doc = "Field `PARKMODE_DISABLE_SS` writer - PARKMODE_DISABLE_SS This bit is used only in host mode, and is for debug purpose only. When this bit is set to 1 all SS bus instances in park mode are disabled."]
pub type ParkmodeDisableSsW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "NAK_PER_ENH_HS\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NakPerEnhHs {
    #[doc = "1: Enhancement not applied If a periodic endpoint is present , and if a bulk endpoint which is also active is being NAKed by the device, then this could result in a decrease in performance of other High Speed bulk endpoint which is ACked by the device. Setting this bit to 1, will enable the host controller to schedule more transactions to the async endpoints (bulk/ control) and hence will improve the performance of the bulk endpoint. This control bit should be enabled only if the existing performance with the default setting is not sufficient for your HighSpeed application. Setting this bit will only control, and is only required for High Speed transfers."]
    B1 = 1,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P3InU2 {
    #[doc = "0: When SuperSpeed link is in U2, PowerState P3 is attempted if GUSB3PIPECTL\\[17\\]
...
impl R {
    #[doc = "Bit 0 - LOA_FILTER_EN If this bit is set, the USB 2.0 port babble is checked at least three consecutive times before the port is disabled. This prevents false triggering of the babble condition when using low quality cables. Note: This bit is valid only in host mode."]
    #[inline(always)]
    pub fn loa_filter_en(&self) -> LoaFilterEnR {
        LoaFilterEnR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - OVRLD_L1_SUSP_COM If this bit is set, the utmi_l1_suspend_com_n is overloaded with the utmi_sleep_n signal. This bit is usually set if the PHY stops the port clock during L1 sleep condition."]
    #[inline(always)]
    pub fn ovrld_l1_susp_com(&self) -> OvrldL1SuspComR {
        OvrldL1SuspComR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Host Parameter Check Disable When this bit is set to 0 (by default), the xHC checks that the input slot/EP context fields comply to the xHCI Specification. Upon detection of a parameter error during command execution, the xHC generates an event TRB with completion code indicating PARAMETER ERROR. When the bit is set to 1, the xHC does not perform parameter checks and does not generate PARAMETER ERROR completion code."]
    #[inline(always)]
    pub fn hc_parchk_disable(&self) -> HcParchkDisableR {
        HcParchkDisableR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Host ELD Enable When this bit is set to 1, it enables the Exit Latency Delta (ELD) support defined in the xHCI 1.0 Errata. This bit is used only in the host mode. This bit has to be set to 1 in Host mode."]
    #[inline(always)]
    pub fn hc_errata_enable(&self) -> HcErrataEnableR {
        HcErrataEnableR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bits 4:7 - L1_SUSP_THRLD_FOR_HOST This field is effective only when the L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1. For more details, refer to the description of the L1_SUSP_THRLD_EN_FOR_HOST bit."]
    #[inline(always)]
    pub fn l1_susp_thrld_for_host(&self) -> L1SuspThrldForHostR {
        L1SuspThrldForHostR::new(((self.bits >> 4) & 0x0f) as u8)
    }
    #[doc = "Bit 8 - L1_SUSP_THRLD_EN_FOR_HOST This bit is used only in host mode. The host controller asserts the utmi_l1_suspend_n and utmi_sleep_n output signals (see LPM Interface Signals table in the Databook) as follows: The controller asserts the utmi_l1_suspend_n signal to put the PHY into deep low-power mode in L1 when both of the following are true: The HIRD/BESL value used is greater than or equal to the value in L1_SUSP_THRLD_FOR_HOST field. The L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1'b1. The controller asserts utmi_sleep_n on L1 when one of the following is true: The HIRD/BESL value used is less than the value in L1_SUSP_THRLD_FOR_HOST field. The L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1'b0."]
    #[inline(always)]
    pub fn l1_susp_thrld_en_for_host(&self) -> L1SuspThrldEnForHostR {
        L1SuspThrldEnForHostR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 15 - PARKMODE_DISABLE_FSLS This bit is used only in host mode, and is for debug purpose only. When this bit is set to 1 all FS/LS bus instances in park mode disabled."]
    #[inline(always)]
    pub fn parkmode_disable_fsls(&self) -> ParkmodeDisableFslsR {
        ParkmodeDisableFslsR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - PARKMODE_DISABLE_HS This bit is used only in host mode. When this bit is set to 1 all HS bus instances park mode are disabled. To improve performance in park mode, the xHCI scheduler queues in three requests of 4 packets each for High Speed asynchronous endpoints in a micro-frame. But if a device is slow and if it NAKs more than 3 times, then it is rescheduled only in the next micro-frame. This could decrease the performance of a slow device even further. In a few high speed devices (such as Sandisk Cruzer Blade 4GB VID:1921, PID:21863 and Flex Drive VID:3744, PID:8552) when an IN request is sent within 900ns of the ACK of the previous packet, these devices send a NAK. When connected to these devices, if required, the software can disable the park mode if you see performance drop in your system. When park mode is disabled, pipelining of multiple packet is disabled and instead one packet at a time is requested by the scheduler. This allows up to 12 NAKs in a micro-frame and improves performance of these slow devices."]
    #[inline(always)]
    pub fn parkmode_disable_hs(&self) -> ParkmodeDisableHsR {
        ParkmodeDisableHsR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - PARKMODE_DISABLE_SS This bit is used only in host mode, and is for debug purpose only. When this bit is set to 1 all SS bus instances in park mode are disabled."]
    #[inline(always)]
    ...
    #[doc = "Bits 21:23 - IP_GAP_ADD_ON This register field is used to add on to the default inter packet gap setting in the USB 2.0 MAC. This should be programmed to a non zero value only in case where you need to increase the default inter packet delay calculations in the USB 2.0 MAC module DWC_usb3_u2mac.v"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loa_filter_en(&mut self) -> LoaFilterEnW<Usb3Guctl1Spec> {
        LoaFilterEnW::new(self, 0)
    }
    #[doc = "Bit 1 - OVRLD_L1_SUSP_COM If this bit is set, the utmi_l1_suspend_com_n is overloaded with the utmi_sleep_n signal. This bit is usually set if the PHY stops the port clock during L1 sleep condition."]
    #[inline(always)]
    #[must_use]
    pub fn ovrld_l1_susp_com(&mut self) -> OvrldL1SuspComW<Usb3Guctl1Spec> {
        OvrldL1SuspComW::new(self, 1)
    }
    #[doc = "Bit 2 - Host Parameter Check Disable When this bit is set to 0 (by default), the xHC checks that the input slot/EP context fields comply to the xHCI Specification. Upon detection of a parameter error during command execution, the xHC generates an event TRB with completion code indicating PARAMETER ERROR. When the bit is set to 1, the xHC does not perform parameter checks and does not generate PARAMETER ERROR completion code."]
    #[inline(always)]
    #[must_use]
    pub fn hc_parchk_disable(&mut self) -> HcParchkDisableW<Usb3Guctl1Spec> {
        HcParchkDisableW::new(self, 2)
    }
    #[doc = "Bit 3 - Host ELD Enable When this bit is set to 1, it enables the Exit Latency Delta (ELD) support defined in the xHCI 1.0 Errata. This bit is used only in the host mode. This bit has to be set to 1 in Host mode."]
    #[inline(always)]
    #[must_use]
    pub fn hc_errata_enable(&mut self) -> HcErrataEnableW<Usb3Guctl1Spec> {
        HcErrataEnableW::new(self, 3)
    }
    #[doc = "Bits 4:7 - L1_SUSP_THRLD_FOR_HOST This field is effective only when the L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1. For more details, refer to the description of the L1_SUSP_THRLD_EN_FOR_HOST bit."]
    #[inline(always)]
    #[must_use]
    pub fn l1_susp_thrld_for_host(&mut self) -> L1SuspThrldForHostW<Usb3Guctl1Spec> {
        L1SuspThrldForHostW::new(self, 4)
    }
    #[doc = "Bit 8 - L1_SUSP_THRLD_EN_FOR_HOST This bit is used only in host mode. The host controller asserts the utmi_l1_suspend_n and utmi_sleep_n output signals (see LPM Interface Signals table in the Databook) as follows: The controller asserts the utmi_l1_suspend_n signal to put the PHY into deep low-power mode in L1 when both of the following are true: The HIRD/BESL value used is greater than or equal to the value in L1_SUSP_THRLD_FOR_HOST field. The L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1'b1. The controller asserts utmi_sleep_n on L1 when one of the following is true: The HIRD/BESL value used is less than the value in L1_SUSP_THRLD_FOR_HOST field. The L1_SUSP_THRLD_EN_FOR_HOST bit is set to 1'b0."]
    #[inline(always)]
    #[must_use]
    pub fn l1_susp_thrld_en_for_host(&mut self) -> L1SuspThrldEnForHostW<Usb3Guctl1Spec> {
        L1SuspThrldEnForHostW::new(self, 8)
    }
    #[doc = "Bit 15 - PARKMODE_DISABLE_FSLS This bit is used only in host mode, and is for debug purpose only. When this bit is set to 1 all FS/LS bus instances in park mode disabled."]
    #[inline(always)]
    #[must_use]
    pub fn parkmode_disable_fsls(&mut self) -> ParkmodeDisableFslsW<Usb3Guctl1Spec> {
        ParkmodeDisableFslsW::new(self, 15)
    }
    #[doc = "Bit 16 - PARKMODE_DISABLE_HS This bit is used only in host mode. When this bit is set to 1 all HS bus instances park mode are disabled. To improve performance in park mode, the xHCI scheduler queues in three requests of 4 packets each for High Speed asynchronous endpoints in a micro-frame. But if a device is slow and if it NAKs more than 3 times, then it is rescheduled only in the next micro-frame. This could decrease the performance of a slow device even further. In a few high speed devices (such as Sandisk Cruzer Blade 4GB VID:1921, PID:21863 and Flex Drive VID:3744, PID:8552) when an IN request is sent within 900ns of the ACK of the previous packet, these devices send a NAK. When connected to these devices, if required, the software can disable the park mode if you see performance drop in your system. When park mode is disabled, pipelining of multiple packet is disabled and instead one packet at a time is requested by the scheduler. This allows up to 12 NAKs in a micro-frame and improves performance of these slow devices."]
    #[inline(always)]
    #[must_use]
    pub fn parkmode_disable_hs(&mut self) -> ParkmodeDisableHsW<Usb3Guctl1Spec> {
        ParkmodeDisableHsW::new(self, 16)
    }
    #[doc = "Bit 17 - PARKMODE_DISABLE_SS This bit is used only in host mode, and is for debug purpose only. When this bit is set to 1 all SS bus instances in park mode are disabled."]
    #[inline(always)]
    #[must_use]
    pub fn parkmode_disable_ss(&mut self) -> ParkmodeDisableSsW<Usb3Guctl1Spec> {
        ParkmodeDisableSsW::new(self, 17)
    }
    #[doc = "Bit 18 - NAK_PER_ENH_HS"]
    #[inline(always)]
    #[must_use]
    pub fn nak_per_enh_hs(&mut self) -> NakPerEnhHsW<Usb3Guctl1Spec> {
        NakPerEnhHsW::new(self, 18)
    }
    #[doc = "Bit 19 - NAK_PER_ENH_FS"]
    #[inline(always)]
    #[must_use]
    pub fn nak_per_enh_fs(&mut self) -> NakPerEnhFsW<Usb3Guctl1Spec> {
        NakPerEnhFsW::new(self, 19)
    }
    #[doc = "Bit 20 - DEV_LSP_TAIL_LOCK_DIS"]
    #[inline(always)]
    #[must_use]
    pub fn dev_lsp_tail_lock_dis(&mut self) -> DevLspTailLockDisW<Usb3Guctl1Spec> {
        DevLspTailLockDisW::new(self, 20)
    }
    #[doc = "Bits 21:23 - IP_GAP_ADD_ON This register field is used to add on to the default inter packet gap setting in the USB 2.0 MAC. This should be programmed to a non zero value only in case where you need to increase the default inter packet delay calculations in the USB 2.0 MAC module DWC_usb3_u2mac.v"]
    #[inline(always)]
    #[must_use]
    pub fn ip_gap_add_on(&mut self) -> IpGapAddOnW<Usb3Guctl1Spec> {
        IpGapAddOnW::new(self, 21)
    }
    #[doc = "Bit 24 - DEV_L1_EXIT_BY_HW"]
    #[inline(always)]
    #[must_use]
    pub fn dev_l1_exit_by_hw(&mut self) -> DevL1ExitByHwW<Usb3Guctl1Spec> {
        DevL1ExitByHwW::new(self, 24)
    }
    #[doc = "Bit 25 - P3_IN_U2"]
    #[inline(always)]
    #[must_use]
    pub fn p3_in_u2(&mut self) -> P3InU2W<Usb3Guctl1Spec> {
        P3InU2W::new(self, 25)
    }
    #[doc = "Bit 26 - DEV_FORCE_20_CLK_FOR_30_CLK"]
    #[inline(always)]
    #[must_use]
    pub fn dev_force_20_clk_for_30_clk(&mut self) -> DevForce20ClkFor30ClkW<Usb3Guctl1Spec> {
        DevForce20ClkFor30ClkW::new(self, 26)
    }
    #[doc = "Bit 27 - DEV_TRB_OUT_SPR_IND"]
    #[inline(always)]
    #[must_use]
    pub fn dev_trb_out_spr_ind(&mut self) -> DevTrbOutSprIndW<Usb3Guctl1Spec> {
        DevTrbOutSprIndW::new(self, 27)
    }
    #[doc = "Bit 28 - TX_IPGAP_LINECHECK_DIS"]
    #[inline(always)]
    #[must_use]
    pub fn tx_ipgap_linecheck_dis(&mut self) -> TxIpgapLinecheckDisW<Usb3Guctl1Spec> {
        TxIpgapLinecheckDisW::new(self, 28)
    }
    #[doc = "Bit 29 - FILTER_SE0_FSLS_EOP"]
    #[inline(always)]
    #[must_use]
    pub fn filter_se0_fsls_eop(&mut self) -> FilterSe0FslsEopW<Usb3Guctl1Spec> {
        FilterSe0FslsEopW::new(self, 29)
    }
}
#[doc = "Global User Control Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb3_guctl1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb3_guctl1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb3Guctl1Spec;
impl crate::RegisterSpec for Usb3Guctl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb3_guctl1::R`](R) reader structure"]
impl crate::Readable for Usb3Guctl1Spec {}
#[doc = "`write(|w| ..)` method takes [`usb3_guctl1::W`](W) writer structure"]
impl crate::Writable for Usb3Guctl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB3_GUCTL1 to value 0x0004_018a"]
impl crate::Resettable for Usb3Guctl1Spec {
