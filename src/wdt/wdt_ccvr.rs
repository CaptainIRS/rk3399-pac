...
#[doc = "Field `CUR_CNT` reader - Current counter value This register, when read, is the current value of the internal counter. This value is read coherently whenever it is read"]
pub type CurCntR = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Current counter value This register, when read, is the current value of the internal counter. This value is read coherently whenever it is read"]
    #[inline(always)]
