#[doc = "Register `RKI2C_MRXADDR` reader"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addlvld(&mut self) -> AddlvldW<Rki2cMrxaddrSpec> {
        AddlvldW::new(self, 24)
    }
    #[doc = "Bit 25 - address middle byte valid"]
    #[inline(always)]
    #[must_use]
    pub fn addmvld(&mut self) -> AddmvldW<Rki2cMrxaddrSpec> {
        AddmvldW::new(self, 25)
    }
    #[doc = "Bit 26 - address high byte valid"]
    #[inline(always)]
    #[must_use]
    pub fn addhvld(&mut self) -> AddhvldW<Rki2cMrxaddrSpec> {
        AddhvldW::new(self, 26)
    }
}
#[doc = "the slave address accessed for master rx mode\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rki2c_mrxaddr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rki2c_mrxaddr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Rki2cMrxaddrSpec;
impl crate::RegisterSpec for Rki2cMrxaddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rki2c_mrxaddr::R`](R) reader structure"]
impl crate::Readable for Rki2cMrxaddrSpec {}
#[doc = "`write(|w| ..)` method takes [`rki2c_mrxaddr::W`](W) writer structure"]
impl crate::Writable for Rki2cMrxaddrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RKI2C_MRXADDR to value 0"]
impl crate::Resettable for Rki2cMrxaddrSpec {
