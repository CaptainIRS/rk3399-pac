...
#[repr(u8)]
pub enum I2cMode {
    #[doc = "0: transmit address (device + register address, write/read bit is 1) --> restart --> transmit address (device address) --> receive data"]
    B00 = 0,
    #[doc = "1: transmit address (device + register address, write/read bit is 1) --> restart --> transmit address (device address) --> receive data"]
    B01 = 1,
    #[doc = "2: transmit address (device + register address, write/read bit is 1) --> restart --> transmit address (device address) --> receive data"]
    B10 = 2,
...
#[doc = "Field `START` reader - start enable start enable, when this bit is written to 1, I2C will generate start signal."]
pub type StartR = crate::BitReader;
#[doc = "Field `START` writer - start enable start enable, when this bit is written to 1, I2C will generate start signal."]
pub type StartW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `STOP` reader - stop enable stop enable, when this bit is written to 1, I2C will generate stop signal."]
pub type StopR = crate::BitReader;
#[doc = "Field `STOP` writer - stop enable stop enable, when this bit is written to 1, I2C will generate stop signal."]
...
#[doc = "Field `DATA_UPD_ST` reader - SDA update point config Used to config sda change state when scl is low, used to adjust setup/hold time 4'bn:Thold = (n + 1) * Tclk_i2c Note: 0 &lt;= n &lt;= 5"]
pub type DataUpdStR = crate::FieldReader;
#[doc = "Field `DATA_UPD_ST` writer - SDA update point config Used to config sda change state when scl is low, used to adjust setup/hold time 4'bn:Thold = (n + 1) * Tclk_i2c Note: 0 &lt;= n &lt;= 5"]
pub type DataUpdStW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `START_SETUP` reader - start setup config TSU;sta = (start_setup + 1) * T(SCL_HIGH) + Tclk_i2c THD;sta = (start_setup + 2) * T(SCL_HIGH) - Tclk_i2c"]
pub type StartSetupR = crate::FieldReader;
#[doc = "Field `START_SETUP` writer - start setup config TSU;sta = (start_setup + 1) * T(SCL_HIGH) + Tclk_i2c THD;sta = (start_setup + 2) * T(SCL_HIGH) - Tclk_i2c"]
pub type StartSetupW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `STOP_SETUP` reader - staop setup config TSU;sto = (stop_setup + 1) * T(SCL_HIGH) + Tclk_i2c"]
pub type StopSetupR = crate::FieldReader;
#[doc = "Field `STOP_SETUP` writer - staop setup config TSU;sto = (stop_setup + 1) * T(SCL_HIGH) + Tclk_i2c"]
pub type StopSetupW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `VERSION` reader - rki2c version version information"]
...
impl R {
    ...
    #[doc = "Bit 3 - start enable start enable, when this bit is written to 1, I2C will generate start signal."]
    #[inline(always)]
    pub fn start(&self) -> StartR {
        StartR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - stop enable stop enable, when this bit is written to 1, I2C will generate stop signal."]
    #[inline(always)]
    ...
    #[doc = "Bits 8:10 - SDA update point config Used to config sda change state when scl is low, used to adjust setup/hold time 4'bn:Thold = (n + 1) * Tclk_i2c Note: 0 &lt;= n &lt;= 5"]
    #[inline(always)]
    pub fn data_upd_st(&self) -> DataUpdStR {
        DataUpdStR::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bits 12:13 - start setup config TSU;sta = (start_setup + 1) * T(SCL_HIGH) + Tclk_i2c THD;sta = (start_setup + 2) * T(SCL_HIGH) - Tclk_i2c"]
    #[inline(always)]
    pub fn start_setup(&self) -> StartSetupR {
        StartSetupR::new(((self.bits >> 12) & 3) as u8)
    }
    #[doc = "Bits 14:15 - staop setup config TSU;sto = (stop_setup + 1) * T(SCL_HIGH) + Tclk_i2c"]
    #[inline(always)]
    pub fn stop_setup(&self) -> StopSetupR {
        StopSetupR::new(((self.bits >> 14) & 3) as u8)
    }
    #[doc = "Bits 16:31 - rki2c version version information"]
    #[inline(always)]
