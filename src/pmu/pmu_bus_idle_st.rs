...
#[doc = "pmu bus idle status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_bus_idle_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuBusIdleStSpec;
impl crate::RegisterSpec for PmuBusIdleStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_bus_idle_st::R`](R) reader structure"]
impl crate::Readable for PmuBusIdleStSpec {}
#[doc = "`reset()` method sets PMU_BUS_IDLE_ST to value 0"]
impl crate::Resettable for PmuBusIdleStSpec {
