#[doc = "Register `PWRDN_ST` reader"]
pub type R = crate::R<PwrdnStSpec>;
#[doc = "Register `PWRDN_ST` writer"]
pub type W = crate::W<PwrdnStSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd_tcpd0_pwr_stat(&mut self) -> PdTcpd0PwrStatW<PwrdnStSpec> {
        PdTcpd0PwrStatW::new(self, 8)
    }
    #[doc = "Bit 9 - pd_tcpd1 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_tcpd1_pwr_stat(&mut self) -> PdTcpd1PwrStatW<PwrdnStSpec> {
        PdTcpd1PwrStatW::new(self, 9)
    }
    #[doc = "Bit 10 - pd_core power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_cci_pwr_stat(&mut self) -> PdCciPwrStatW<PwrdnStSpec> {
        PdCciPwrStatW::new(self, 10)
    }
    #[doc = "Bit 11 - pd_bus power stat"]
    #[inline(always)]
    #[must_use]
    pub fn pd_perilp_pwr_stat(&mut self) -> PdPerilpPwrStatW<PwrdnStSpec> {
        PdPerilpPwrStatW::new(self, 11)
    }
    #[doc = "Bit 12 - pd_peri power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_perihp_pwr_stat(&mut self) -> PdPerihpPwrStatW<PwrdnStSpec> {
        PdPerihpPwrStatW::new(self, 12)
    }
    #[doc = "Bit 13 - pd_center power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_center_pwr_stat(&mut self) -> PdCenterPwrStatW<PwrdnStSpec> {
        PdCenterPwrStatW::new(self, 13)
    }
    #[doc = "Bit 14 - pd_vio power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vio_pwr_stat(&mut self) -> PdVioPwrStatW<PwrdnStSpec> {
        PdVioPwrStatW::new(self, 14)
    }
    #[doc = "Bit 15 - pd_gpu power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gpu_pwr_stat(&mut self) -> PdGpuPwrStatW<PwrdnStSpec> {
        PdGpuPwrStatW::new(self, 15)
    }
    #[doc = "Bit 16 - pd_vcodec power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vcodec_pwr_stat(&mut self) -> PdVcodecPwrStatW<PwrdnStSpec> {
        PdVcodecPwrStatW::new(self, 16)
    }
    #[doc = "Bit 17 - pd_vdu power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vdu_pwr_stat(&mut self) -> PdVduPwrStatW<PwrdnStSpec> {
        PdVduPwrStatW::new(self, 17)
    }
    #[doc = "Bit 18 - pd_rga power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_rga_pwr_stat(&mut self) -> PdRgaPwrStatW<PwrdnStSpec> {
        PdRgaPwrStatW::new(self, 18)
    }
    #[doc = "Bit 19 - pd_iep power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_iep_pwr_stat(&mut self) -> PdIepPwrStatW<PwrdnStSpec> {
        PdIepPwrStatW::new(self, 19)
    }
    #[doc = "Bit 20 - pd_vo power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vo_pwr_stat(&mut self) -> PdVoPwrStatW<PwrdnStSpec> {
        PdVoPwrStatW::new(self, 20)
    }
    #[doc = "Bit 22 - pd_isp0 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_isp0_pwr_stat(&mut self) -> PdIsp0PwrStatW<PwrdnStSpec> {
        PdIsp0PwrStatW::new(self, 22)
    }
    #[doc = "Bit 23 - pd_isp1 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_isp1_pwr_stat(&mut self) -> PdIsp1PwrStatW<PwrdnStSpec> {
        PdIsp1PwrStatW::new(self, 23)
    }
    #[doc = "Bit 24 - pd_hdcp power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_hdcp_pwr_stat(&mut self) -> PdHdcpPwrStatW<PwrdnStSpec> {
        PdHdcpPwrStatW::new(self, 24)
    }
    #[doc = "Bit 25 - pd_gmac power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gmac_pwr_stat(&mut self) -> PdGmacPwrStatW<PwrdnStSpec> {
        PdGmacPwrStatW::new(self, 25)
    }
    #[doc = "Bit 26 - pd_emmc power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_emmc_pwr_stat(&mut self) -> PdEmmcPwrStatW<PwrdnStSpec> {
        PdEmmcPwrStatW::new(self, 26)
    }
    #[doc = "Bit 27 - pd_usb3 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_usb3_pwr_stat(&mut self) -> PdUsb3PwrStatW<PwrdnStSpec> {
        PdUsb3PwrStatW::new(self, 27)
    }
    #[doc = "Bit 28 - pd_edp power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_edp_pwr_stat(&mut self) -> PdEdpPwrStatW<PwrdnStSpec> {
        PdEdpPwrStatW::new(self, 28)
    }
    #[doc = "Bit 29 - pd_gic power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gic_pwr_stat(&mut self) -> PdGicPwrStatW<PwrdnStSpec> {
        PdGicPwrStatW::new(self, 29)
    }
    #[doc = "Bit 30 - pd_sd power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_sd_pwr_stat(&mut self) -> PdSdPwrStatW<PwrdnStSpec> {
        PdSdPwrStatW::new(self, 30)
    }
    #[doc = "Bit 31 - pd_sdioaudio power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_sdioaudio_pwr_stat(&mut self) -> PdSdioaudioPwrStatW<PwrdnStSpec> {
        PdSdioaudioPwrStatW::new(self, 31)
    }
}
#[doc = "pmu power down status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwrdn_st::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwrdn_st::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwrdnStSpec;
impl crate::RegisterSpec for PwrdnStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwrdn_st::R`](R) reader structure"]
impl crate::Readable for PwrdnStSpec {}
#[doc = "`write(|w| ..)` method takes [`pwrdn_st::W`](W) writer structure"]
impl crate::Writable for PwrdnStSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWRDN_ST to value 0"]
impl crate::Resettable for PwrdnStSpec {
