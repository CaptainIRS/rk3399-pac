#[doc = "Register `PMU_CCI500_CON` reader"]
pub type R = crate::R<PmuCci500ConSpec>;
#[doc = "Register `PMU_CCI500_CON` writer"]
pub type W = crate::W<PmuCci500ConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn preq_cci500_cfg(&mut self) -> PreqCci500CfgW<PmuCci500ConSpec> {
        PreqCci500CfgW::new(self, 0)
    }
    #[doc = "Bit 1 - CCI-500 P-channel request sent by hardware ."]
    #[inline(always)]
    #[must_use]
    pub fn clr_preq_cci500(&mut self) -> ClrPreqCci500W<PmuCci500ConSpec> {
        ClrPreqCci500W::new(self, 1)
    }
    #[doc = "Bits 2:4 - CCI-500 P-channel pstate ."]
    #[inline(always)]
    #[must_use]
    pub fn pstate_cci500(&mut self) -> PstateCci500W<PmuCci500ConSpec> {
        PstateCci500W::new(self, 2)
    }
    #[doc = "Bit 5 - CCI-500 Q-channel request sent by software."]
    #[inline(always)]
    #[must_use]
    pub fn qreq_cci500_cfg(&mut self) -> QreqCci500CfgW<PmuCci500ConSpec> {
        QreqCci500CfgW::new(self, 5)
    }
    #[doc = "Bit 6 - CCI-500 Q-channel request sent by hardware."]
    #[inline(always)]
    #[must_use]
    pub fn clr_qreq_cci500(&mut self) -> ClrQreqCci500W<PmuCci500ConSpec> {
...
pub struct PmuCci500ConSpec;
impl crate::RegisterSpec for PmuCci500ConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_cci500_con::R`](R) reader structure"]
impl crate::Readable for PmuCci500ConSpec {}
#[doc = "`write(|w| ..)` method takes [`pmu_cci500_con::W`](W) writer structure"]
impl crate::Writable for PmuCci500ConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMU_CCI500_CON to value 0"]
impl crate::Resettable for PmuCci500ConSpec {
