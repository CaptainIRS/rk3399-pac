#[doc = "Register `CPU0BPM_CON` reader"]
pub type R = crate::R<Cpu0bpmConSpec>;
#[doc = "Register `CPU0BPM_CON` writer"]
pub type W = crate::W<Cpu0bpmConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_b0_wfi_pwrdn_en(&mut self) -> CpuB0WfiPwrdnEnW<Cpu0bpmConSpec> {
        CpuB0WfiPwrdnEnW::new(self, 0)
    }
    #[doc = "Bit 1 - cpu b0 interrupt wake enable."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_b0_int_wakeup_en(&mut self) -> CpuB0IntWakeupEnW<Cpu0bpmConSpec> {
        CpuB0IntWakeupEnW::new(self, 1)
    }
    #[doc = "Bit 3 - cpu b0 software wakeup source."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_b0_sft_wakeup(&mut self) -> CpuB0SftWakeupW<Cpu0bpmConSpec> {
        CpuB0SftWakeupW::new(self, 3)
    }
}
#[doc = "pmu cluster_b cpu0 auto power down control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpu0bpm_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpu0bpm_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cpu0bpmConSpec;
impl crate::RegisterSpec for Cpu0bpmConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpu0bpm_con::R`](R) reader structure"]
impl crate::Readable for Cpu0bpmConSpec {}
#[doc = "`write(|w| ..)` method takes [`cpu0bpm_con::W`](W) writer structure"]
impl crate::Writable for Cpu0bpmConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPU0BPM_CON to value 0"]
impl crate::Resettable for Cpu0bpmConSpec {
