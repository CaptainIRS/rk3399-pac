#[doc = "Register `PMU_PWRMODE_CON` reader"]
pub type R = crate::R<PmuPwrmodeConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn power_mode_en(&mut self) -> PowerModeEnW<PmuPwrmodeConSpec> {
        PowerModeEnW::new(self, 0)
    }
    #[doc = "Bit 1 - wakeup reset enable when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_reset_en(&mut self) -> WakeupResetEnW<PmuPwrmodeConSpec> {
        WakeupResetEnW::new(self, 1)
    }
    #[doc = "Bit 2 - clamp vd_logic when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn input_clamp_en(&mut self) -> InputClampEnW<PmuPwrmodeConSpec> {
        InputClampEnW::new(self, 2)
    }
    #[doc = "Bit 3 - osc disable when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn osc_disable(&mut self) -> OscDisableW<PmuPwrmodeConSpec> {
        OscDisableW::new(self, 3)
    }
    #[doc = "Bit 4 - alive low frequency mode when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn alive_use_lf(&mut self) -> AliveUseLfW<PmuPwrmodeConSpec> {
        AliveUseLfW::new(self, 4)
    }
    #[doc = "Bit 5 - pmu low frequency mode enable when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_use_lf(&mut self) -> PmuUseLfW<PmuPwrmodeConSpec> {
        PmuUseLfW::new(self, 5)
    }
    #[doc = "Bit 6 - send power off request to PMIC when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn power_off_req_cfg(&mut self) -> PowerOffReqCfgW<PmuPwrmodeConSpec> {
        PowerOffReqCfgW::new(self, 6)
    }
    #[doc = "Bit 7 - chip power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn chip_pd_en(&mut self) -> ChipPdEnW<PmuPwrmodeConSpec> {
        ChipPdEnW::new(self, 7)
    }
    #[doc = "Bit 8 - power down pll when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn pll_pd_en(&mut self) -> PllPdEnW<PmuPwrmodeConSpec> {
        PllPdEnW::new(self, 8)
    }
    #[doc = "Bit 9 - power down core0 of cluster_l in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn cpu0_pd_en(&mut self) -> Cpu0PdEnW<PmuPwrmodeConSpec> {
        Cpu0PdEnW::new(self, 9)
    }
    #[doc = "Bit 10 - flush l2 by hardware when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn l2_flush_en(&mut self) -> L2FlushEnW<PmuPwrmodeConSpec> {
        L2FlushEnW::new(self, 10)
    }
    #[doc = "Bit 11 - wait l2 idle when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn l2_idle_en(&mut self) -> L2IdleEnW<PmuPwrmodeConSpec> {
        L2IdleEnW::new(self, 11)
    }
    #[doc = "Bit 12 - power down main cluster scu when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn scu_pd_en(&mut self) -> ScuPdEnW<PmuPwrmodeConSpec> {
        ScuPdEnW::new(self, 12)
    }
    #[doc = "Bit 13 - power down pd_cci when power mode"]
    #[inline(always)]
    #[must_use]
    pub fn cci_pd_en(&mut self) -> CciPdEnW<PmuPwrmodeConSpec> {
        CciPdEnW::new(self, 13)
    }
    #[doc = "Bit 14 - power down pd_perilp when power mode"]
    #[inline(always)]
    #[must_use]
    pub fn perilp_pd_en(&mut self) -> PerilpPdEnW<PmuPwrmodeConSpec> {
        PerilpPdEnW::new(self, 14)
    }
    #[doc = "Bit 15 - power down pd_center when power mode"]
    #[inline(always)]
    #[must_use]
    pub fn center_pd_en(&mut self) -> CenterPdEnW<PmuPwrmodeConSpec> {
        CenterPdEnW::new(self, 15)
    }
    #[doc = "Bit 16 - ddr0 self_refresh by hardware when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn sref0_enter_en(&mut self) -> Sref0EnterEnW<PmuPwrmodeConSpec> {
        Sref0EnterEnW::new(self, 16)
    }
    #[doc = "Bit 17 - ddr0 controller auto gating when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn ddrc0_gating_en(&mut self) -> Ddrc0GatingEnW<PmuPwrmodeConSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sref1_enter_en(&mut self) -> Sref1EnterEnW<PmuPwrmodeConSpec> {
        Sref1EnterEnW::new(self, 20)
    }
    #[doc = "Bit 21 - ddr1 controller auto gating when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn ddrc1_gating_en(&mut self) -> Ddrc1GatingEnW<PmuPwrmodeConSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_center_src_gate_en(&mut self) -> ClkCenterSrcGateEnW<PmuPwrmodeConSpec> {
        ClkCenterSrcGateEnW::new(self, 26)
    }
    #[doc = "Bit 27 - pd_perilp clock gate enable when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn clk_perilp_src_gate_en(&mut self) -> ClkPerilpSrcGateEnW<PmuPwrmodeConSpec> {
        ClkPerilpSrcGateEnW::new(self, 27)
    }
    #[doc = "Bit 28 - cpu clock gate enable when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn clk_core_src_gate_en(&mut self) -> ClkCoreSrcGateEnW<PmuPwrmodeConSpec> {
        ClkCoreSrcGateEnW::new(self, 28)
    }
    #[doc = "Bit 29 - hardware ddrio retention de-assert request"]
    #[inline(always)]
    #[must_use]
    pub fn ddrio_ret_hw_de_req(&mut self) -> DdrioRetHwDeReqW<PmuPwrmodeConSpec> {
        DdrioRetHwDeReqW::new(self, 29)
    }
    #[doc = "Bit 30 - output pmu_sleep instead of ap_pwroff to IO."]
    #[inline(always)]
    #[must_use]
    pub fn sleep_output_cfg(&mut self) -> SleepOutputCfgW<PmuPwrmodeConSpec> {
        SleepOutputCfgW::new(self, 30)
    }
    #[doc = "Bit 31 - use core big for main cluster."]
    #[inline(always)]
    #[must_use]
    pub fn main_cluster(&mut self) -> MainClusterW<PmuPwrmodeConSpec> {
        MainClusterW::new(self, 31)
    }
}
#[doc = "pmu power mode configure register of common resource\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_pwrmode_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmu_pwrmode_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuPwrmodeConSpec;
impl crate::RegisterSpec for PmuPwrmodeConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_pwrmode_con::R`](R) reader structure"]
impl crate::Readable for PmuPwrmodeConSpec {}
#[doc = "`write(|w| ..)` method takes [`pmu_pwrmode_con::W`](W) writer structure"]
impl crate::Writable for PmuPwrmodeConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0088_0000;
}
#[doc = "`reset()` method sets PMU_PWRMODE_CON to value 0"]
impl crate::Resettable for PmuPwrmodeConSpec {
