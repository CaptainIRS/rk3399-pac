#[doc = "Register `PMU_WAKEUP_CFG4` reader"]
pub type R = crate::R<PmuWakeupCfg4Spec>;
#[doc = "Register `PMU_WAKEUP_CFG4` writer"]
pub type W = crate::W<PmuWakeupCfg4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int_cluster_l_en(&mut self) -> IntClusterLEnW<PmuWakeupCfg4Spec> {
        IntClusterLEnW::new(self, 0)
    }
    #[doc = "Bit 1 - cluster_b interrupt wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn int_cluster_b_en(&mut self) -> IntClusterBEnW<PmuWakeupCfg4Spec> {
        IntClusterBEnW::new(self, 1)
    }
    #[doc = "Bit 2 - gpio interrupt wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_int_en(&mut self) -> GpioIntEnW<PmuWakeupCfg4Spec> {
        GpioIntEnW::new(self, 2)
    }
    #[doc = "Bit 3 - sdio detect wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn sdio_en(&mut self) -> SdioEnW<PmuWakeupCfg4Spec> {
        SdioEnW::new(self, 3)
    }
    #[doc = "Bit 4 - sdmmc detect wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn sdmmc_en(&mut self) -> SdmmcEnW<PmuWakeupCfg4Spec> {
        SdmmcEnW::new(self, 4)
    }
    #[doc = "Bit 6 - timer wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn timer_en(&mut self) -> TimerEnW<PmuWakeupCfg4Spec> {
        TimerEnW::new(self, 6)
    }
    #[doc = "Bit 7 - usb device detect wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn usbdev_en(&mut self) -> UsbdevEnW<PmuWakeupCfg4Spec> {
        UsbdevEnW::new(self, 7)
    }
    #[doc = "Bit 8 - software wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn sft_en(&mut self) -> SftEnW<PmuWakeupCfg4Spec> {
        SftEnW::new(self, 8)
    }
    #[doc = "Bit 9 - m3 watch dog wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn wdt_m0_en(&mut self) -> WdtM0EnW<PmuWakeupCfg4Spec> {
        WdtM0EnW::new(self, 9)
    }
    #[doc = "Bit 10 - pmu time out wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn timeout_en(&mut self) -> TimeoutEnW<PmuWakeupCfg4Spec> {
        TimeoutEnW::new(self, 10)
    }
    #[doc = "Bit 11 - pwm interrupt wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_en(&mut self) -> PwmEnW<PmuWakeupCfg4Spec> {
        PwmEnW::new(self, 11)
    }
    #[doc = "Bit 13 - pcie interrupt wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn pcie_en(&mut self) -> PcieEnW<PmuWakeupCfg4Spec> {
        PcieEnW::new(self, 13)
    }
}
#[doc = "pmu wakeup configure register 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_wakeup_cfg4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmu_wakeup_cfg4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuWakeupCfg4Spec;
impl crate::RegisterSpec for PmuWakeupCfg4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_wakeup_cfg4::R`](R) reader structure"]
impl crate::Readable for PmuWakeupCfg4Spec {}
#[doc = "`write(|w| ..)` method takes [`pmu_wakeup_cfg4::W`](W) writer structure"]
impl crate::Writable for PmuWakeupCfg4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMU_WAKEUP_CFG4 to value 0"]
impl crate::Resettable for PmuWakeupCfg4Spec {
