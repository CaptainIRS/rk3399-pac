...
#[doc = "pmu core power status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_core_pwr_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuCorePwrStSpec;
impl crate::RegisterSpec for PmuCorePwrStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_core_pwr_st::R`](R) reader structure"]
impl crate::Readable for PmuCorePwrStSpec {}
#[doc = "`reset()` method sets PMU_CORE_PWR_ST to value 0"]
impl crate::Resettable for PmuCorePwrStSpec {
