#[doc = "Register `WAKEUP_CFG2` reader"]
pub type R = crate::R<WakeupCfg2Spec>;
#[doc = "Register `WAKEUP_CFG2` writer"]
pub type W = crate::W<WakeupCfg2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio1a_posedge_en(&mut self) -> Gpio1aPosedgeEnW<WakeupCfg2Spec> {
        Gpio1aPosedgeEnW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio1b posedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1b_posedge_en(&mut self) -> Gpio1bPosedgeEnW<WakeupCfg2Spec> {
        Gpio1bPosedgeEnW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio1c posedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1c_posedge_en(&mut self) -> Gpio1cPosedgeEnW<WakeupCfg2Spec> {
        Gpio1cPosedgeEnW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio1d posedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1d_posedge_en(&mut self) -> Gpio1dPosedgeEnW<WakeupCfg2Spec> {
        Gpio1dPosedgeEnW::new(self, 24)
    }
}
#[doc = "pmu wakeup configure register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wakeup_cfg2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wakeup_cfg2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WakeupCfg2Spec;
impl crate::RegisterSpec for WakeupCfg2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wakeup_cfg2::R`](R) reader structure"]
impl crate::Readable for WakeupCfg2Spec {}
#[doc = "`write(|w| ..)` method takes [`wakeup_cfg2::W`](W) writer structure"]
impl crate::Writable for WakeupCfg2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WAKEUP_CFG2 to value 0"]
impl crate::Resettable for WakeupCfg2Spec {
