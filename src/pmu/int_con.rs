#[doc = "Register `INT_CON` reader"]
pub type R = crate::R<IntConSpec>;
#[doc = "Register `INT_CON` writer"]
pub type W = crate::W<IntConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pmu_int_en(&mut self) -> PmuIntEnW<IntConSpec> {
        PmuIntEnW::new(self, 0)
    }
    #[doc = "Bit 1 - power mode wakeup interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pwrmode_wakeup_int_en(&mut self) -> PwrmodeWakeupIntEnW<IntConSpec> {
        PwrmodeWakeupIntEnW::new(self, 1)
    }
    #[doc = "Bit 2 - gpio0 negedge wakeup interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio0_neg_int_en(&mut self) -> WakeupGpio0NegIntEnW<IntConSpec> {
        WakeupGpio0NegIntEnW::new(self, 2)
    }
    #[doc = "Bit 3 - gpio posedge wakeup interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio0_pos_int_en(&mut self) -> WakeupGpio0PosIntEnW<IntConSpec> {
        WakeupGpio0PosIntEnW::new(self, 3)
    }
    #[doc = "Bit 4 - gpio1 negedge wakeup interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio1_neg_int_en(&mut self) -> WakeupGpio1NegIntEnW<IntConSpec> {
        WakeupGpio1NegIntEnW::new(self, 4)
    }
    #[doc = "Bit 5 - gpio1 posedge wakeup interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio1_pos_int_en(&mut self) -> WakeupGpio1PosIntEnW<IntConSpec> {
        WakeupGpio1PosIntEnW::new(self, 5)
    }
}
#[doc = "pmu interrupt configure register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`int_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`int_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntConSpec;
impl crate::RegisterSpec for IntConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`int_con::R`](R) reader structure"]
impl crate::Readable for IntConSpec {}
#[doc = "`write(|w| ..)` method takes [`int_con::W`](W) writer structure"]
impl crate::Writable for IntConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INT_CON to value 0"]
impl crate::Resettable for IntConSpec {
