#[doc = "Register `GPIO0_NEG_INT_ST` reader"]
pub type R = crate::R<Gpio0NegIntStSpec>;
#[doc = "Register `GPIO0_NEG_INT_ST` writer"]
pub type W = crate::W<Gpio0NegIntStSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0a_neg_int_status(&mut self) -> Gpio0aNegIntStatusW<Gpio0NegIntStSpec> {
        Gpio0aNegIntStatusW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio0b negedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0b_neg_int_status(&mut self) -> Gpio0bNegIntStatusW<Gpio0NegIntStSpec> {
        Gpio0bNegIntStatusW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio0c negedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0c_neg_int_status(&mut self) -> Gpio0cNegIntStatusW<Gpio0NegIntStSpec> {
        Gpio0cNegIntStatusW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio0d negedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0d_neg_int_status(&mut self) -> Gpio0dNegIntStatusW<Gpio0NegIntStSpec> {
        Gpio0dNegIntStatusW::new(self, 24)
    }
}
#[doc = "pmu gpio0 negedge interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio0_neg_int_st::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio0_neg_int_st::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio0NegIntStSpec;
impl crate::RegisterSpec for Gpio0NegIntStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio0_neg_int_st::R`](R) reader structure"]
impl crate::Readable for Gpio0NegIntStSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio0_neg_int_st::W`](W) writer structure"]
impl crate::Writable for Gpio0NegIntStSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO0_NEG_INT_ST to value 0"]
impl crate::Resettable for Gpio0NegIntStSpec {
