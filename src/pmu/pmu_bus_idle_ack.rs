...
#[doc = "pmu bus idle ack status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_bus_idle_ack::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuBusIdleAckSpec;
impl crate::RegisterSpec for PmuBusIdleAckSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_bus_idle_ack::R`](R) reader structure"]
impl crate::Readable for PmuBusIdleAckSpec {}
#[doc = "`reset()` method sets PMU_BUS_IDLE_ACK to value 0"]
impl crate::Resettable for PmuBusIdleAckSpec {
