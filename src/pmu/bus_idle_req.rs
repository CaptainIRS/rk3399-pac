#[doc = "Register `BUS_IDLE_REQ` reader"]
pub type R = crate::R<BusIdleReqSpec>;
#[doc = "Register `BUS_IDLE_REQ` writer"]
pub type W = crate::W<BusIdleReqSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn idle_req_gpu(&mut self) -> IdleReqGpuW<BusIdleReqSpec> {
        IdleReqGpuW::new(self, 0)
    }
    #[doc = "Bit 1 - send idle request to perilp niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_perilp(&mut self) -> IdleReqPerilpW<BusIdleReqSpec> {
        IdleReqPerilpW::new(self, 1)
    }
    #[doc = "Bit 2 - send idle request to perihp niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_perihp(&mut self) -> IdleReqPerihpW<BusIdleReqSpec> {
        IdleReqPerihpW::new(self, 2)
    }
    #[doc = "Bit 3 - send idle request to vcodec niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_vcodec(&mut self) -> IdleReqVcodecW<BusIdleReqSpec> {
        IdleReqVcodecW::new(self, 3)
    }
    #[doc = "Bit 4 - send idle request to vdu niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_vdu(&mut self) -> IdleReqVduW<BusIdleReqSpec> {
        IdleReqVduW::new(self, 4)
    }
    #[doc = "Bit 5 - send idle request to rga niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_rga(&mut self) -> IdleReqRgaW<BusIdleReqSpec> {
        IdleReqRgaW::new(self, 5)
    }
    #[doc = "Bit 6 - send idle request to iep niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_iep(&mut self) -> IdleReqIepW<BusIdleReqSpec> {
        IdleReqIepW::new(self, 6)
    }
    #[doc = "Bit 7 - send idle request to vopb niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_vopb(&mut self) -> IdleReqVopbW<BusIdleReqSpec> {
        IdleReqVopbW::new(self, 7)
    }
    #[doc = "Bit 8 - send idle request to vopl niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_vopl(&mut self) -> IdleReqVoplW<BusIdleReqSpec> {
        IdleReqVoplW::new(self, 8)
    }
    #[doc = "Bit 9 - send idle request to isp0 niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_isp0(&mut self) -> IdleReqIsp0W<BusIdleReqSpec> {
        IdleReqIsp0W::new(self, 9)
    }
    #[doc = "Bit 10 - send idle request to isp1 niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_isp1(&mut self) -> IdleReqIsp1W<BusIdleReqSpec> {
        IdleReqIsp1W::new(self, 10)
    }
    #[doc = "Bit 11 - send idle request to hdcp niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_hdcp(&mut self) -> IdleReqHdcpW<BusIdleReqSpec> {
        IdleReqHdcpW::new(self, 11)
    }
    #[doc = "Bit 12 - send idle request to usb3 niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_usb3(&mut self) -> IdleReqUsb3W<BusIdleReqSpec> {
        IdleReqUsb3W::new(self, 12)
    }
    #[doc = "Bit 13 - send idle request to perilp m0 niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_perilpm0(&mut self) -> IdleReqPerilpm0W<BusIdleReqSpec> {
        IdleReqPerilpm0W::new(self, 13)
    }
    #[doc = "Bit 14 - send idle request to center niu"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_center(&mut self) -> IdleReqCenterW<BusIdleReqSpec> {
        IdleReqCenterW::new(self, 14)
    }
    #[doc = "Bit 15 - send idle request to ccim0 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_ccim0(&mut self) -> IdleReqCcim0W<BusIdleReqSpec> {
        IdleReqCcim0W::new(self, 15)
    }
    #[doc = "Bit 16 - send idle request to ccim1 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_ccim1(&mut self) -> IdleReqCcim1W<BusIdleReqSpec> {
        IdleReqCcim1W::new(self, 16)
    }
    #[doc = "Bit 17 - send idle request to vio low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_vio(&mut self) -> IdleReqVioW<BusIdleReqSpec> {
        IdleReqVioW::new(self, 17)
    }
    #[doc = "Bit 18 - send idle request to msch0 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_msch0(&mut self) -> IdleReqMsch0W<BusIdleReqSpec> {
        IdleReqMsch0W::new(self, 18)
    }
    #[doc = "Bit 19 - send idle request to msch1 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_msch1(&mut self) -> IdleReqMsch1W<BusIdleReqSpec> {
        IdleReqMsch1W::new(self, 19)
    }
    #[doc = "Bit 20 - send idle request to alive low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_alive(&mut self) -> IdleReqAliveW<BusIdleReqSpec> {
        IdleReqAliveW::new(self, 20)
    }
    #[doc = "Bit 21 - send idle request to pmu low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_pmu(&mut self) -> IdleReqPmuW<BusIdleReqSpec> {
        IdleReqPmuW::new(self, 21)
    }
    #[doc = "Bit 22 - send idle request to edp low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_edp(&mut self) -> IdleReqEdpW<BusIdleReqSpec> {
        IdleReqEdpW::new(self, 22)
    }
    #[doc = "Bit 23 - send idle request to gmac low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_gmac(&mut self) -> IdleReqGmacW<BusIdleReqSpec> {
        IdleReqGmacW::new(self, 23)
    }
    #[doc = "Bit 24 - send idle request to emmc low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_emmc(&mut self) -> IdleReqEmmcW<BusIdleReqSpec> {
        IdleReqEmmcW::new(self, 24)
    }
    #[doc = "Bit 25 - send idle request to center1 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_center1(&mut self) -> IdleReqCenter1W<BusIdleReqSpec> {
        IdleReqCenter1W::new(self, 25)
    }
    #[doc = "Bit 26 - send idle request to pmu m0 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_pmum0(&mut self) -> IdleReqPmum0W<BusIdleReqSpec> {
        IdleReqPmum0W::new(self, 26)
    }
    #[doc = "Bit 27 - send idle request to gic low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_gic(&mut self) -> IdleReqGicW<BusIdleReqSpec> {
        IdleReqGicW::new(self, 27)
    }
    #[doc = "Bit 28 - send idle request to sd low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_sd(&mut self) -> IdleReqSdW<BusIdleReqSpec> {
        IdleReqSdW::new(self, 28)
    }
    #[doc = "Bit 29 - send idle request to sdioaudio low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn idle_req_sdioaudio(&mut self) -> IdleReqSdioaudioW<BusIdleReqSpec> {
        IdleReqSdioaudioW::new(self, 29)
    }
}
#[doc = "pmu bus idle request register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bus_idle_req::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bus_idle_req::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BusIdleReqSpec;
impl crate::RegisterSpec for BusIdleReqSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bus_idle_req::R`](R) reader structure"]
impl crate::Readable for BusIdleReqSpec {}
#[doc = "`write(|w| ..)` method takes [`bus_idle_req::W`](W) writer structure"]
impl crate::Writable for BusIdleReqSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BUS_IDLE_REQ to value 0"]
impl crate::Resettable for BusIdleReqSpec {
