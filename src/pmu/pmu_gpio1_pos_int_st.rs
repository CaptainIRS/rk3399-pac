#[doc = "Register `PMU_GPIO1_POS_INT_ST` reader"]
pub type R = crate::R<PmuGpio1PosIntStSpec>;
#[doc = "Register `PMU_GPIO1_POS_INT_ST` writer"]
pub type W = crate::W<PmuGpio1PosIntStSpec>;
#[doc = "gpio1a posedge pulse interrupt status\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio1aPosIntStatus {
    #[doc = "0: wakeup by gpio1a posedge pulse"]
    B0 = 0,
...
pub enum Gpio1bPosIntStatus {
    #[doc = "0: wakeup by gpio1b posedge pulse"]
    B0 = 0,
...
pub enum Gpio1cPosIntStatus {
    #[doc = "0: wakeup by gpio1c posedge pulse"]
    B0 = 0,
...
pub enum Gpio1dPosIntStatus {
    #[doc = "0: wakeup by gpio1d posedge pulse"]
    B0 = 0,
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio1a_pos_int_status(&mut self) -> Gpio1aPosIntStatusW<PmuGpio1PosIntStSpec> {
        Gpio1aPosIntStatusW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio1b posedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1b_pos_int_status(&mut self) -> Gpio1bPosIntStatusW<PmuGpio1PosIntStSpec> {
        Gpio1bPosIntStatusW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio1c posedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1c_pos_int_status(&mut self) -> Gpio1cPosIntStatusW<PmuGpio1PosIntStSpec> {
        Gpio1cPosIntStatusW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio1d posedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1d_pos_int_status(&mut self) -> Gpio1dPosIntStatusW<PmuGpio1PosIntStSpec> {
        Gpio1dPosIntStatusW::new(self, 24)
    }
}
#[doc = "pmu gpio1 posedge interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_gpio1_pos_int_st::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmu_gpio1_pos_int_st::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuGpio1PosIntStSpec;
impl crate::RegisterSpec for PmuGpio1PosIntStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_gpio1_pos_int_st::R`](R) reader structure"]
impl crate::Readable for PmuGpio1PosIntStSpec {}
#[doc = "`write(|w| ..)` method takes [`pmu_gpio1_pos_int_st::W`](W) writer structure"]
impl crate::Writable for PmuGpio1PosIntStSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMU_GPIO1_POS_INT_ST to value 0"]
impl crate::Resettable for PmuGpio1PosIntStSpec {
