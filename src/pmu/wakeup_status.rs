#[doc = "Register `WAKEUP_STATUS` reader"]
pub type R = crate::R<WakeupStatusSpec>;
#[doc = "Register `WAKEUP_STATUS` writer"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wakeup_int_cluster_l_status(&mut self) -> WakeupIntClusterLStatusW<WakeupStatusSpec> {
        WakeupIntClusterLStatusW::new(self, 0)
    }
    #[doc = "Bit 1 - cluster_b interrupt wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_int_cluster_b_status(&mut self) -> WakeupIntClusterBStatusW<WakeupStatusSpec> {
        WakeupIntClusterBStatusW::new(self, 1)
    }
    #[doc = "Bit 2 - gpio interrupt wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio_int_status(&mut self) -> WakeupGpioIntStatusW<WakeupStatusSpec> {
        WakeupGpioIntStatusW::new(self, 2)
    }
    #[doc = "Bit 3 - sdio wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_sdio_status(&mut self) -> WakeupSdioStatusW<WakeupStatusSpec> {
        WakeupSdioStatusW::new(self, 3)
    }
    #[doc = "Bit 4 - sdmmc wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_sdmmc_status(&mut self) -> WakeupSdmmcStatusW<WakeupStatusSpec> {
        WakeupSdmmcStatusW::new(self, 4)
    }
    #[doc = "Bit 6 - timer wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_timer_status(&mut self) -> WakeupTimerStatusW<WakeupStatusSpec> {
        WakeupTimerStatusW::new(self, 6)
    }
    #[doc = "Bit 7 - usbdev detect wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_usbdev_status(&mut self) -> WakeupUsbdevStatusW<WakeupStatusSpec> {
        WakeupUsbdevStatusW::new(self, 7)
    }
    #[doc = "Bit 8 - m0 software control wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_sft_m0_status(&mut self) -> WakeupSftM0StatusW<WakeupStatusSpec> {
        WakeupSftM0StatusW::new(self, 8)
    }
    #[doc = "Bit 9 - m0 wdt interrupt wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_wdt_m0_status(&mut self) -> WakeupWdtM0StatusW<WakeupStatusSpec> {
        WakeupWdtM0StatusW::new(self, 9)
    }
    #[doc = "Bit 10 - timeout wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_timeout_status(&mut self) -> WakeupTimeoutStatusW<WakeupStatusSpec> {
        WakeupTimeoutStatusW::new(self, 10)
    }
    #[doc = "Bit 11 - pwm wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_pwm_status(&mut self) -> WakeupPwmStatusW<WakeupStatusSpec> {
        WakeupPwmStatusW::new(self, 11)
    }
    #[doc = "Bit 13 - pcie wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_pcie_status(&mut self) -> WakeupPcieStatusW<WakeupStatusSpec> {
...
#[doc = "`reset()` method sets WAKEUP_STATUS to value 0"]
