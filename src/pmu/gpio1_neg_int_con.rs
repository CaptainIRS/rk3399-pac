#[doc = "Register `GPIO1_NEG_INT_CON` reader"]
pub type R = crate::R<Gpio1NegIntConSpec>;
#[doc = "Register `GPIO1_NEG_INT_CON` writer"]
pub type W = crate::W<Gpio1NegIntConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio1a_neg_int_en(&mut self) -> Gpio1aNegIntEnW<Gpio1NegIntConSpec> {
        Gpio1aNegIntEnW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio1b negedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1b_neg_int_en(&mut self) -> Gpio1bNegIntEnW<Gpio1NegIntConSpec> {
        Gpio1bNegIntEnW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio1c negedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1c_neg_int_en(&mut self) -> Gpio1cNegIntEnW<Gpio1NegIntConSpec> {
        Gpio1cNegIntEnW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio1d negedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1d_neg_int_en(&mut self) -> Gpio1dNegIntEnW<Gpio1NegIntConSpec> {
        Gpio1dNegIntEnW::new(self, 24)
    }
}
#[doc = "pmu gpio1 negedge interrupt configure register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio1_neg_int_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio1_neg_int_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio1NegIntConSpec;
impl crate::RegisterSpec for Gpio1NegIntConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio1_neg_int_con::R`](R) reader structure"]
impl crate::Readable for Gpio1NegIntConSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio1_neg_int_con::W`](W) writer structure"]
impl crate::Writable for Gpio1NegIntConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO1_NEG_INT_CON to value 0"]
impl crate::Resettable for Gpio1NegIntConSpec {
