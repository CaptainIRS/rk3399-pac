#[doc = "Register `PMU_CPU3APM_CON` reader"]
pub type R = crate::R<PmuCpu3apmConSpec>;
#[doc = "Register `PMU_CPU3APM_CON` writer"]
pub type W = crate::W<PmuCpu3apmConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_l3_wfi_pwrdn_en(&mut self) -> CpuL3WfiPwrdnEnW<PmuCpu3apmConSpec> {
        CpuL3WfiPwrdnEnW::new(self, 0)
    }
    #[doc = "Bit 1 - cpu l3 interrupt wake enable."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_l3_int_wakeup_en(&mut self) -> CpuL3IntWakeupEnW<PmuCpu3apmConSpec> {
        CpuL3IntWakeupEnW::new(self, 1)
    }
    #[doc = "Bit 3 - cpu l3 software wakeup source."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_l3_sft_wakeup(&mut self) -> CpuL3SftWakeupW<PmuCpu3apmConSpec> {
        CpuL3SftWakeupW::new(self, 3)
    }
}
#[doc = "pmu cpu3 auto power down control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_cpu3apm_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmu_cpu3apm_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuCpu3apmConSpec;
impl crate::RegisterSpec for PmuCpu3apmConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_cpu3apm_con::R`](R) reader structure"]
impl crate::Readable for PmuCpu3apmConSpec {}
#[doc = "`write(|w| ..)` method takes [`pmu_cpu3apm_con::W`](W) writer structure"]
impl crate::Writable for PmuCpu3apmConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMU_CPU3APM_CON to value 0"]
impl crate::Resettable for PmuCpu3apmConSpec {
