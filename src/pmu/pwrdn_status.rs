#[doc = "Register `PWRDN_STATUS` reader"]
pub type R = crate::R<PwrdnStatusSpec>;
#[doc = "Register `PWRDN_STATUS` writer"]
pub type W = crate::W<PwrdnStatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l0_pwr_stat(&mut self) -> PdA53L0PwrStatW<PwrdnStatusSpec> {
        PdA53L0PwrStatW::new(self, 0)
    }
    #[doc = "Bit 1 - pd_a53_l1 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l1_pwr_stat(&mut self) -> PdA53L1PwrStatW<PwrdnStatusSpec> {
        PdA53L1PwrStatW::new(self, 1)
    }
    #[doc = "Bit 2 - pd_a53_l2 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l2_pwr_stat(&mut self) -> PdA53L2PwrStatW<PwrdnStatusSpec> {
        PdA53L2PwrStatW::new(self, 2)
    }
    #[doc = "Bit 3 - pd_a53_l3 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l3_pwr_stat(&mut self) -> PdA53L3PwrStatW<PwrdnStatusSpec> {
        PdA53L3PwrStatW::new(self, 3)
    }
    #[doc = "Bit 4 - pd_a72_b0 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a72_b0_pwr_stat(&mut self) -> PdA72B0PwrStatW<PwrdnStatusSpec> {
        PdA72B0PwrStatW::new(self, 4)
    }
    #[doc = "Bit 5 - pd_a72_b1 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a72_b1_pwr_stat(&mut self) -> PdA72B1PwrStatW<PwrdnStatusSpec> {
        PdA72B1PwrStatW::new(self, 5)
    }
    #[doc = "Bit 6 - pd_scu_l power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_scu_l_pwr_stat(&mut self) -> PdScuLPwrStatW<PwrdnStatusSpec> {
        PdScuLPwrStatW::new(self, 6)
    }
    #[doc = "Bit 7 - pd_scu_b power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_scu_b_pwr_stat(&mut self) -> PdScuBPwrStatW<PwrdnStatusSpec> {
        PdScuBPwrStatW::new(self, 7)
    }
    #[doc = "Bit 8 - pd_tcpd0 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_tcpd0_pwr_stat(&mut self) -> PdTcpd0PwrStatW<PwrdnStatusSpec> {
        PdTcpd0PwrStatW::new(self, 8)
    }
    #[doc = "Bit 9 - pd_tcpd1 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_tcpd1_pwr_stat(&mut self) -> PdTcpd1PwrStatW<PwrdnStatusSpec> {
        PdTcpd1PwrStatW::new(self, 9)
    }
    #[doc = "Bit 10 - pd_core power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_cci_pwr_stat(&mut self) -> PdCciPwrStatW<PwrdnStatusSpec> {
        PdCciPwrStatW::new(self, 10)
    }
    #[doc = "Bit 11 - pd_perilp power stat"]
    #[inline(always)]
    #[must_use]
    pub fn pd_perilp_pwr_stat(&mut self) -> PdPerilpPwrStatW<PwrdnStatusSpec> {
        PdPerilpPwrStatW::new(self, 11)
    }
    #[doc = "Bit 12 - pd_perihp power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_perihp_pwr_stat(&mut self) -> PdPerihpPwrStatW<PwrdnStatusSpec> {
        PdPerihpPwrStatW::new(self, 12)
    }
    #[doc = "Bit 13 - pd_center power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_center_pwr_stat(&mut self) -> PdCenterPwrStatW<PwrdnStatusSpec> {
        PdCenterPwrStatW::new(self, 13)
    }
    #[doc = "Bit 14 - pd_vio power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vio_pwr_stat(&mut self) -> PdVioPwrStatW<PwrdnStatusSpec> {
        PdVioPwrStatW::new(self, 14)
    }
    #[doc = "Bit 15 - pd_gpu power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gpu_pwr_stat(&mut self) -> PdGpuPwrStatW<PwrdnStatusSpec> {
        PdGpuPwrStatW::new(self, 15)
    }
    #[doc = "Bit 16 - pd_vcodec power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vcodec_pwr_stat(&mut self) -> PdVcodecPwrStatW<PwrdnStatusSpec> {
        PdVcodecPwrStatW::new(self, 16)
    }
    #[doc = "Bit 17 - pd_vdu power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vdu_pwr_stat(&mut self) -> PdVduPwrStatW<PwrdnStatusSpec> {
        PdVduPwrStatW::new(self, 17)
    }
    #[doc = "Bit 18 - pd_rga power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_rga_pwr_stat(&mut self) -> PdRgaPwrStatW<PwrdnStatusSpec> {
        PdRgaPwrStatW::new(self, 18)
    }
    #[doc = "Bit 19 - pd_iep power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_iep_pwr_stat(&mut self) -> PdIepPwrStatW<PwrdnStatusSpec> {
        PdIepPwrStatW::new(self, 19)
    }
    #[doc = "Bit 20 - pd_vo power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vo_pwr_stat(&mut self) -> PdVoPwrStatW<PwrdnStatusSpec> {
        PdVoPwrStatW::new(self, 20)
    }
    #[doc = "Bit 22 - pd_isp0 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_isp0_pwr_stat(&mut self) -> PdIsp0PwrStatW<PwrdnStatusSpec> {
        PdIsp0PwrStatW::new(self, 22)
    }
    #[doc = "Bit 23 - pd_isp1 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_isp1_pwr_stat(&mut self) -> PdIsp1PwrStatW<PwrdnStatusSpec> {
        PdIsp1PwrStatW::new(self, 23)
    }
    #[doc = "Bit 24 - pd_hdcp power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_hdcp_pwr_stat(&mut self) -> PdHdcpPwrStatW<PwrdnStatusSpec> {
        PdHdcpPwrStatW::new(self, 24)
    }
    #[doc = "Bit 25 - pd_gmac power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gmac_pwr_stat(&mut self) -> PdGmacPwrStatW<PwrdnStatusSpec> {
        PdGmacPwrStatW::new(self, 25)
    }
    #[doc = "Bit 26 - pd_emmc power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_emmc_pwr_stat(&mut self) -> PdEmmcPwrStatW<PwrdnStatusSpec> {
        PdEmmcPwrStatW::new(self, 26)
    }
    #[doc = "Bit 27 - pd_usb3 power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_usb3_pwr_stat(&mut self) -> PdUsb3PwrStatW<PwrdnStatusSpec> {
        PdUsb3PwrStatW::new(self, 27)
    }
    #[doc = "Bit 28 - pd_edp power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_edp_pwr_stat(&mut self) -> PdEdpPwrStatW<PwrdnStatusSpec> {
        PdEdpPwrStatW::new(self, 28)
    }
    #[doc = "Bit 29 - pd_gic power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gic_pwr_stat(&mut self) -> PdGicPwrStatW<PwrdnStatusSpec> {
        PdGicPwrStatW::new(self, 29)
    }
    #[doc = "Bit 30 - pd_sd power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_sd_pwr_stat(&mut self) -> PdSdPwrStatW<PwrdnStatusSpec> {
        PdSdPwrStatW::new(self, 30)
    }
    #[doc = "Bit 31 - pd_sdioaudio power state"]
    #[inline(always)]
    #[must_use]
    pub fn pd_sdioaudio_pwr_stat(&mut self) -> PdSdioaudioPwrStatW<PwrdnStatusSpec> {
        PdSdioaudioPwrStatW::new(self, 31)
    }
}
#[doc = "pmu power down interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwrdn_status::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwrdn_status::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwrdnStatusSpec;
impl crate::RegisterSpec for PwrdnStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwrdn_status::R`](R) reader structure"]
impl crate::Readable for PwrdnStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`pwrdn_status::W`](W) writer structure"]
impl crate::Writable for PwrdnStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xffdf_ffff;
}
#[doc = "`reset()` method sets PWRDN_STATUS to value 0"]
impl crate::Resettable for PwrdnStatusSpec {
