#[doc = "Register `GPIO0_POS_INT_ST` reader"]
pub type R = crate::R<Gpio0PosIntStSpec>;
#[doc = "Register `GPIO0_POS_INT_ST` writer"]
pub type W = crate::W<Gpio0PosIntStSpec>;
#[doc = "gpio0a posedge pulse interrupt status\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio0aPosIntStatus {
    #[doc = "0: not wakeup by gpio0a posedge pulse"]
    B0 = 0,
...
impl Gpio0aPosIntStatusR {
    ...
    #[doc = "not wakeup by gpio0a posedge pulse"]
    #[inline(always)]
...
pub enum Gpio0bPosIntStatus {
    #[doc = "0: not wakeup by gpio0b posedge pulse"]
    B0 = 0,
...
impl Gpio0bPosIntStatusR {
    ...
    #[doc = "not wakeup by gpio0b posedge pulse"]
    #[inline(always)]
    pub fn is_b0(&self) -> bool {
...
pub enum Gpio0cPosIntStatus {
    #[doc = "0: not wakeup by gpio0c posedge pulse"]
    B0 = 0,
...
impl Gpio0cPosIntStatusR {
    ...
    #[doc = "not wakeup by gpio0c posedge pulse"]
    #[inline(always)]
    pub fn is_b0(&self) -> bool {
...
pub enum Gpio0dPosIntStatus {
    #[doc = "0: not wakeup by gpio0d posedge pulse"]
    B0 = 0,
...
impl Gpio0dPosIntStatusR {
    ...
    #[doc = "not wakeup by gpio0d posedge pulse"]
    #[inline(always)]
    pub fn is_b0(&self) -> bool {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0a_pos_int_status(&mut self) -> Gpio0aPosIntStatusW<Gpio0PosIntStSpec> {
        Gpio0aPosIntStatusW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio0b posedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0b_pos_int_status(&mut self) -> Gpio0bPosIntStatusW<Gpio0PosIntStSpec> {
        Gpio0bPosIntStatusW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio0c posedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0c_pos_int_status(&mut self) -> Gpio0cPosIntStatusW<Gpio0PosIntStSpec> {
        Gpio0cPosIntStatusW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio0d posedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0d_pos_int_status(&mut self) -> Gpio0dPosIntStatusW<Gpio0PosIntStSpec> {
...
pub struct Gpio0PosIntStSpec;
impl crate::RegisterSpec for Gpio0PosIntStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio0_pos_int_st::R`](R) reader structure"]
impl crate::Readable for Gpio0PosIntStSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio0_pos_int_st::W`](W) writer structure"]
impl crate::Writable for Gpio0PosIntStSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO0_POS_INT_ST to value 0"]
impl crate::Resettable for Gpio0PosIntStSpec {
