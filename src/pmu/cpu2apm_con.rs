#[doc = "Register `CPU2APM_CON` reader"]
pub type R = crate::R<Cpu2apmConSpec>;
#[doc = "Register `CPU2APM_CON` writer"]
pub type W = crate::W<Cpu2apmConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_l2_wfi_pwrdn_en(&mut self) -> CpuL2WfiPwrdnEnW<Cpu2apmConSpec> {
        CpuL2WfiPwrdnEnW::new(self, 0)
    }
    #[doc = "Bit 1 - cpu l2 interrupt wake enable."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_l2_int_wakeup_en(&mut self) -> CpuL2IntWakeupEnW<Cpu2apmConSpec> {
        CpuL2IntWakeupEnW::new(self, 1)
    }
    #[doc = "Bit 3 - cpu l2 software wakeup source."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_l2_sft_wakeup(&mut self) -> CpuL2SftWakeupW<Cpu2apmConSpec> {
        CpuL2SftWakeupW::new(self, 3)
    }
}
#[doc = "pmu cpu2 auto power down control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpu2apm_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpu2apm_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cpu2apmConSpec;
impl crate::RegisterSpec for Cpu2apmConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpu2apm_con::R`](R) reader structure"]
impl crate::Readable for Cpu2apmConSpec {}
#[doc = "`write(|w| ..)` method takes [`cpu2apm_con::W`](W) writer structure"]
impl crate::Writable for Cpu2apmConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPU2APM_CON to value 0"]
impl crate::Resettable for Cpu2apmConSpec {
