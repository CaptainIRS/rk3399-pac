#[doc = "Register `CPU0APM_CON` reader"]
pub type R = crate::R<Cpu0apmConSpec>;
#[doc = "Register `CPU0APM_CON` writer"]
pub type W = crate::W<Cpu0apmConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_l0_wfi_pwrdn_en(&mut self) -> CpuL0WfiPwrdnEnW<Cpu0apmConSpec> {
        CpuL0WfiPwrdnEnW::new(self, 0)
    }
    #[doc = "Bit 1 - cpu l0 interrupt wake enable."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_l0_int_wakeup_en(&mut self) -> CpuL0IntWakeupEnW<Cpu0apmConSpec> {
        CpuL0IntWakeupEnW::new(self, 1)
    }
    #[doc = "Bit 3 - cpu l0 software wakeup source."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_l0_sft_wakeup(&mut self) -> CpuL0SftWakeupW<Cpu0apmConSpec> {
        CpuL0SftWakeupW::new(self, 3)
    }
}
#[doc = "pmu cpu0 auto power down control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpu0apm_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpu0apm_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cpu0apmConSpec;
impl crate::RegisterSpec for Cpu0apmConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpu0apm_con::R`](R) reader structure"]
impl crate::Readable for Cpu0apmConSpec {}
#[doc = "`write(|w| ..)` method takes [`cpu0apm_con::W`](W) writer structure"]
impl crate::Writable for Cpu0apmConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPU0APM_CON to value 0"]
impl crate::Resettable for Cpu0apmConSpec {
