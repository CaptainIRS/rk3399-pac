#[doc = "Register `GPIO0_POS_INT_CON` reader"]
pub type R = crate::R<Gpio0PosIntConSpec>;
#[doc = "Register `GPIO0_POS_INT_CON` writer"]
pub type W = crate::W<Gpio0PosIntConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0a_pos_int_en(&mut self) -> Gpio0aPosIntEnW<Gpio0PosIntConSpec> {
        Gpio0aPosIntEnW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio0b posedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0b_pos_int_en(&mut self) -> Gpio0bPosIntEnW<Gpio0PosIntConSpec> {
        Gpio0bPosIntEnW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio0c posedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0c_pos_int_en(&mut self) -> Gpio0cPosIntEnW<Gpio0PosIntConSpec> {
        Gpio0cPosIntEnW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio0d posedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0d_pos_int_en(&mut self) -> Gpio0dPosIntEnW<Gpio0PosIntConSpec> {
        Gpio0dPosIntEnW::new(self, 24)
    }
}
#[doc = "pmu gpio0 posedge interrupt configure register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio0_pos_int_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio0_pos_int_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio0PosIntConSpec;
impl crate::RegisterSpec for Gpio0PosIntConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio0_pos_int_con::R`](R) reader structure"]
impl crate::Readable for Gpio0PosIntConSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio0_pos_int_con::W`](W) writer structure"]
impl crate::Writable for Gpio0PosIntConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO0_POS_INT_CON to value 0"]
impl crate::Resettable for Gpio0PosIntConSpec {
