#[doc = "Register `WAKEUP_CFG3` reader"]
pub type R = crate::R<WakeupCfg3Spec>;
#[doc = "Register `WAKEUP_CFG3` writer"]
pub type W = crate::W<WakeupCfg3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio1a_negedge_en(&mut self) -> Gpio1aNegedgeEnW<WakeupCfg3Spec> {
        Gpio1aNegedgeEnW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio1b negedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1b_negedge_en(&mut self) -> Gpio1bNegedgeEnW<WakeupCfg3Spec> {
        Gpio1bNegedgeEnW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio1c negedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1c_negedge_en(&mut self) -> Gpio1cNegedgeEnW<WakeupCfg3Spec> {
        Gpio1cNegedgeEnW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio1d negedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1d_negedge_en(&mut self) -> Gpio1dNegedgeEnW<WakeupCfg3Spec> {
        Gpio1dNegedgeEnW::new(self, 24)
    }
}
#[doc = "pmu wakeup configure register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wakeup_cfg3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wakeup_cfg3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WakeupCfg3Spec;
impl crate::RegisterSpec for WakeupCfg3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wakeup_cfg3::R`](R) reader structure"]
impl crate::Readable for WakeupCfg3Spec {}
#[doc = "`write(|w| ..)` method takes [`wakeup_cfg3::W`](W) writer structure"]
impl crate::Writable for WakeupCfg3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WAKEUP_CFG3 to value 0"]
impl crate::Resettable for WakeupCfg3Spec {
