#[doc = "Register `PMU_WAKEUP_CFG1` reader"]
pub type R = crate::R<PmuWakeupCfg1Spec>;
#[doc = "Register `PMU_WAKEUP_CFG1` writer"]
pub type W = crate::W<PmuWakeupCfg1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0a_negedge_en(&mut self) -> Gpio0aNegedgeEnW<PmuWakeupCfg1Spec> {
        Gpio0aNegedgeEnW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio0b negedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0b_negedge_en(&mut self) -> Gpio0bNegedgeEnW<PmuWakeupCfg1Spec> {
        Gpio0bNegedgeEnW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio0c negedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0c_negedge_en(&mut self) -> Gpio0cNegedgeEnW<PmuWakeupCfg1Spec> {
        Gpio0cNegedgeEnW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio0d negedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0d_negedge_en(&mut self) -> Gpio0dNegedgeEnW<PmuWakeupCfg1Spec> {
        Gpio0dNegedgeEnW::new(self, 24)
    }
}
#[doc = "pmu wakeup configure register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_wakeup_cfg1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmu_wakeup_cfg1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuWakeupCfg1Spec;
impl crate::RegisterSpec for PmuWakeupCfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_wakeup_cfg1::R`](R) reader structure"]
impl crate::Readable for PmuWakeupCfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`pmu_wakeup_cfg1::W`](W) writer structure"]
impl crate::Writable for PmuWakeupCfg1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMU_WAKEUP_CFG1 to value 0"]
impl crate::Resettable for PmuWakeupCfg1Spec {
