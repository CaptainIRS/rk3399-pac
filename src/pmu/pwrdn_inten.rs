#[doc = "Register `PWRDN_INTEN` reader"]
pub type R = crate::R<PwrdnIntenSpec>;
#[doc = "Register `PWRDN_INTEN` writer"]
pub type W = crate::W<PwrdnIntenSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l0_pwr_switch_int_en(&mut self) -> PdA53L0PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdA53L0PwrSwitchIntEnW::new(self, 0)
    }
    #[doc = "Bit 1 - pd_a53_l1 power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l1_pwr_switch_int_en(&mut self) -> PdA53L1PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdA53L1PwrSwitchIntEnW::new(self, 1)
    }
    #[doc = "Bit 2 - pd_a53_l2 power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l2_pwr_switch_int_en(&mut self) -> PdA53L2PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdA53L2PwrSwitchIntEnW::new(self, 2)
    }
    #[doc = "Bit 3 - pd_a53_l3 power switch int enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l3_pwr_switch_int_en(&mut self) -> PdA53L3PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdA53L3PwrSwitchIntEnW::new(self, 3)
    }
    #[doc = "Bit 4 - pd_a72_b0 power enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a72_b0_pwr_switch_int_en(&mut self) -> PdA72B0PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdA72B0PwrSwitchIntEnW::new(self, 4)
    }
    #[doc = "Bit 5 - pd_a72_b1 power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a72_b1_pwr_switch_int_en(&mut self) -> PdA72B1PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdA72B1PwrSwitchIntEnW::new(self, 5)
    }
    #[doc = "Bit 6 - pd_scu_l power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_scu_l_pwr_switch_int_en(&mut self) -> PdScuLPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdScuLPwrSwitchIntEnW::new(self, 6)
    }
    #[doc = "Bit 7 - pd_scu_b power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_scu_b_pwr_switch_int_en(&mut self) -> PdScuBPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdScuBPwrSwitchIntEnW::new(self, 7)
    }
    #[doc = "Bit 8 - pd_tcpd0 power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_tcpd0_pwr_switch_int_en(&mut self) -> PdTcpd0PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdTcpd0PwrSwitchIntEnW::new(self, 8)
    }
    #[doc = "Bit 9 - pd_tcpd1 power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_tcpd1_pwr_switch_int_en(&mut self) -> PdTcpd1PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdTcpd1PwrSwitchIntEnW::new(self, 9)
    }
    #[doc = "Bit 10 - pd_cci power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_cci_pwr_switch_int_en(&mut self) -> PdCciPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdCciPwrSwitchIntEnW::new(self, 10)
    }
    #[doc = "Bit 11 - pd_perilp power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_perilp_pwr_switch_int_en(&mut self) -> PdPerilpPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdPerilpPwrSwitchIntEnW::new(self, 11)
    }
    #[doc = "Bit 12 - pd_perihp power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_perihp_pwr_switch_int_en(&mut self) -> PdPerihpPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdPerihpPwrSwitchIntEnW::new(self, 12)
    }
    #[doc = "Bit 13 - pd_center power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_center_pwr_switch_int_en(&mut self) -> PdCenterPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdCenterPwrSwitchIntEnW::new(self, 13)
    }
    #[doc = "Bit 14 - pd_vio power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vio_pwr_switch_int_en(&mut self) -> PdVioPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdVioPwrSwitchIntEnW::new(self, 14)
    }
    #[doc = "Bit 15 - pd_gpu power interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gpu_pwr_switch_int_en(&mut self) -> PdGpuPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdGpuPwrSwitchIntEnW::new(self, 15)
    }
    #[doc = "Bit 16 - pd_perihp power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vcodec_pwr_switch_inten(&mut self) -> PdVcodecPwrSwitchIntenW<PwrdnIntenSpec> {
        PdVcodecPwrSwitchIntenW::new(self, 16)
    }
    #[doc = "Bit 17 - pd_vdu power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vdu_pwr_switch_int_en(&mut self) -> PdVduPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdVduPwrSwitchIntEnW::new(self, 17)
    }
    #[doc = "Bit 18 - pd_rga power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_rga_pwr_switch_int_en(&mut self) -> PdRgaPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdRgaPwrSwitchIntEnW::new(self, 18)
    }
    #[doc = "Bit 19 - pd_perihp power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_iep_pwr_switch_int_en(&mut self) -> PdIepPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdIepPwrSwitchIntEnW::new(self, 19)
    }
    #[doc = "Bit 20 - pd_vo power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vo_pwr_switch_int_en(&mut self) -> PdVoPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdVoPwrSwitchIntEnW::new(self, 20)
    }
    #[doc = "Bit 22 - pd_isp0 power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_isp0_pwr_switch_int_en(&mut self) -> PdIsp0PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdIsp0PwrSwitchIntEnW::new(self, 22)
    }
    #[doc = "Bit 23 - pd_isp1 power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_isp1_pwr_switch_int_en(&mut self) -> PdIsp1PwrSwitchIntEnW<PwrdnIntenSpec> {
        PdIsp1PwrSwitchIntEnW::new(self, 23)
    }
    #[doc = "Bit 24 - pd_hdcp power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_hdcp_pwr_switch_int_en(&mut self) -> PdHdcpPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdHdcpPwrSwitchIntEnW::new(self, 24)
    }
    #[doc = "Bit 25 - pd_gmac power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gmac_pwr_switch_int_en(&mut self) -> PdGmacPwrSwitchIntEnW<PwrdnIntenSpec> {
    ...
    pub fn pd_emmc_pwr_switch_interrupt_en(
        &mut self,
    ) -> PdEmmcPwrSwitchInterruptEnW<PwrdnIntenSpec> {
    ...
    pub fn pd_usb3_pwr_switch_interrupt_en(
        &mut self,
    ) -> PdUsb3PwrSwitchInterruptEnW<PwrdnIntenSpec> {
        PdUsb3PwrSwitchInterruptEnW::new(self, 27)
    }
    #[doc = "Bit 28 - pd_edp power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_edp_pwr_switch_int_en(&mut self) -> PdEdpPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdEdpPwrSwitchIntEnW::new(self, 28)
    }
    #[doc = "Bit 29 - pd_gic power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gic_pwr_switch_int_en(&mut self) -> PdGicPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdGicPwrSwitchIntEnW::new(self, 29)
    }
    #[doc = "Bit 30 - pd_sd power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_sd_pwr_switch_int_en(&mut self) -> PdSdPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdSdPwrSwitchIntEnW::new(self, 30)
    }
    #[doc = "Bit 31 - pd_sdioaudio power switch interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_sdioaudio_pwr_switch_int_en(&mut self) -> PdSdioaudioPwrSwitchIntEnW<PwrdnIntenSpec> {
        PdSdioaudioPwrSwitchIntEnW::new(self, 31)
    }
}
#[doc = "pmu power down interrupt enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwrdn_inten::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwrdn_inten::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwrdnIntenSpec;
impl crate::RegisterSpec for PwrdnIntenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwrdn_inten::R`](R) reader structure"]
impl crate::Readable for PwrdnIntenSpec {}
#[doc = "`write(|w| ..)` method takes [`pwrdn_inten::W`](W) writer structure"]
impl crate::Writable for PwrdnIntenSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWRDN_INTEN to value 0"]
impl crate::Resettable for PwrdnIntenSpec {
