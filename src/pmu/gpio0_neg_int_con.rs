#[doc = "Register `GPIO0_NEG_INT_CON` reader"]
pub type R = crate::R<Gpio0NegIntConSpec>;
#[doc = "Register `GPIO0_NEG_INT_CON` writer"]
pub type W = crate::W<Gpio0NegIntConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0a_neg_int_en(&mut self) -> Gpio0aNegIntEnW<Gpio0NegIntConSpec> {
        Gpio0aNegIntEnW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio0b negedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0b_neg_int_en(&mut self) -> Gpio0bNegIntEnW<Gpio0NegIntConSpec> {
        Gpio0bNegIntEnW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio0c negedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0c_neg_int_en(&mut self) -> Gpio0cNegIntEnW<Gpio0NegIntConSpec> {
        Gpio0cNegIntEnW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio0d negedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0d_neg_int_en(&mut self) -> Gpio0dNegIntEnW<Gpio0NegIntConSpec> {
        Gpio0dNegIntEnW::new(self, 24)
    }
}
#[doc = "pmu gpio0 negedge interrupt configure register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio0_neg_int_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio0_neg_int_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio0NegIntConSpec;
impl crate::RegisterSpec for Gpio0NegIntConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio0_neg_int_con::R`](R) reader structure"]
impl crate::Readable for Gpio0NegIntConSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio0_neg_int_con::W`](W) writer structure"]
impl crate::Writable for Gpio0NegIntConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIO0_NEG_INT_CON to value 0"]
impl crate::Resettable for Gpio0NegIntConSpec {
