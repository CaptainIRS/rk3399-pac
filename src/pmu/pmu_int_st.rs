#[doc = "Register `PMU_INT_ST` reader"]
pub type R = crate::R<PmuIntStSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwrmode_wakeup_status(&mut self) -> PwrmodeWakeupStatusW<PmuIntStSpec> {
        PwrmodeWakeupStatusW::new(self, 1)
    }
    #[doc = "Bit 2 - gpio0 negedge pulse wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio0_neg_status(&mut self) -> WakeupGpio0NegStatusW<PmuIntStSpec> {
        WakeupGpio0NegStatusW::new(self, 2)
    }
    #[doc = "Bit 3 - gpio0 posedge pulse wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio0_pos_status(&mut self) -> WakeupGpio0PosStatusW<PmuIntStSpec> {
        WakeupGpio0PosStatusW::new(self, 3)
    }
    #[doc = "Bit 4 - gpio1 posedge pulse wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio1_pos_status(&mut self) -> WakeupGpio1PosStatusW<PmuIntStSpec> {
        WakeupGpio1PosStatusW::new(self, 4)
    }
    #[doc = "Bit 5 - gpio1 negedge pulse wakeup status"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_gpio1_neg_status(&mut self) -> WakeupGpio1NegStatusW<PmuIntStSpec> {
        WakeupGpio1NegStatusW::new(self, 5)
    }
}
#[doc = "pmu interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_int_st::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmu_int_st::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuIntStSpec;
impl crate::RegisterSpec for PmuIntStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_int_st::R`](R) reader structure"]
impl crate::Readable for PmuIntStSpec {}
#[doc = "`write(|w| ..)` method takes [`pmu_int_st::W`](W) writer structure"]
impl crate::Writable for PmuIntStSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMU_INT_ST to value 0"]
impl crate::Resettable for PmuIntStSpec {
