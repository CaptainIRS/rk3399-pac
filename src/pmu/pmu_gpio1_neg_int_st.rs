#[doc = "Register `PMU_GPIO1_NEG_INT_ST` reader"]
pub type R = crate::R<PmuGpio1NegIntStSpec>;
#[doc = "Register `PMU_GPIO1_NEG_INT_ST` writer"]
pub type W = crate::W<PmuGpio1NegIntStSpec>;
#[doc = "gpio1a negedge pulse interrupt status\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Gpio1aNegIntStatus {
    #[doc = "0: wakeup by gpio1a negedge pulse"]
    B0 = 0,
...
pub enum Gpio1bNegIntStatus {
    #[doc = "0: wakeup by gpio1b negedge pulse"]
    B0 = 0,
...
pub enum Gpio1cNegIntStatus {
    #[doc = "0: wakeup by gpio1c negedge pulse"]
    B0 = 0,
...
pub enum Gpio1dNegIntStatus {
    #[doc = "0: wakeup by gpio1d negedge pulse"]
    B0 = 0,
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio1a_neg_int_status(&mut self) -> Gpio1aNegIntStatusW<PmuGpio1NegIntStSpec> {
        Gpio1aNegIntStatusW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio1b negedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1b_neg_int_status(&mut self) -> Gpio1bNegIntStatusW<PmuGpio1NegIntStSpec> {
        Gpio1bNegIntStatusW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio1c negedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1c_neg_int_status(&mut self) -> Gpio1cNegIntStatusW<PmuGpio1NegIntStSpec> {
        Gpio1cNegIntStatusW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio1d negedge pulse interrupt status"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1d_neg_int_status(&mut self) -> Gpio1dNegIntStatusW<PmuGpio1NegIntStSpec> {
        Gpio1dNegIntStatusW::new(self, 24)
    }
}
#[doc = "pmu gpio1 negedge interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_gpio1_neg_int_st::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmu_gpio1_neg_int_st::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuGpio1NegIntStSpec;
impl crate::RegisterSpec for PmuGpio1NegIntStSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_gpio1_neg_int_st::R`](R) reader structure"]
impl crate::Readable for PmuGpio1NegIntStSpec {}
#[doc = "`write(|w| ..)` method takes [`pmu_gpio1_neg_int_st::W`](W) writer structure"]
impl crate::Writable for PmuGpio1NegIntStSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMU_GPIO1_NEG_INT_ST to value 0"]
impl crate::Resettable for PmuGpio1NegIntStSpec {
