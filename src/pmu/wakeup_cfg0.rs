#[doc = "Register `WAKEUP_CFG0` reader"]
pub type R = crate::R<WakeupCfg0Spec>;
#[doc = "Register `WAKEUP_CFG0` writer"]
pub type W = crate::W<WakeupCfg0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0a_posedge_en(&mut self) -> Gpio0aPosedgeEnW<WakeupCfg0Spec> {
        Gpio0aPosedgeEnW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio0b posedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0b_posedge_en(&mut self) -> Gpio0bPosedgeEnW<WakeupCfg0Spec> {
        Gpio0bPosedgeEnW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio0c posedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0c_posedge_en(&mut self) -> Gpio0cPosedgeEnW<WakeupCfg0Spec> {
        Gpio0cPosedgeEnW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio0d posedge pulse wakeup enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0d_posedge_en(&mut self) -> Gpio0dPosedgeEnW<WakeupCfg0Spec> {
        Gpio0dPosedgeEnW::new(self, 24)
    }
}
#[doc = "pmu wakeup configure register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wakeup_cfg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wakeup_cfg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WakeupCfg0Spec;
impl crate::RegisterSpec for WakeupCfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wakeup_cfg0::R`](R) reader structure"]
impl crate::Readable for WakeupCfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`wakeup_cfg0::W`](W) writer structure"]
impl crate::Writable for WakeupCfg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WAKEUP_CFG0 to value 0"]
impl crate::Resettable for WakeupCfg0Spec {
