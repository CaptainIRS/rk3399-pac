#[doc = "Register `SFT_CON` reader"]
pub type R = crate::R<SftConSpec>;
#[doc = "Register `SFT_CON` writer"]
pub type W = crate::W<SftConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wakeup_sft(&mut self) -> WakeupSftW<SftConSpec> {
        WakeupSftW::new(self, 0)
    }
    #[doc = "Bit 1 - software control of input clamp signal"]
    #[inline(always)]
    #[must_use]
    pub fn input_clamp_cfg(&mut self) -> InputClampCfgW<SftConSpec> {
        InputClampCfgW::new(self, 1)
    }
    #[doc = "Bit 2 - osc disable configure by software"]
    #[inline(always)]
    #[must_use]
    pub fn osc_disable_cfg(&mut self) -> OscDisableCfgW<SftConSpec> {
        OscDisableCfgW::new(self, 2)
    }
    #[doc = "Bit 3 - pd_pmu low frequency mode configure by software"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_lf_ena_cfg(&mut self) -> PmuLfEnaCfgW<SftConSpec> {
        PmuLfEnaCfgW::new(self, 3)
    }
    #[doc = "Bit 4 - pd_alive low frequency mode configure by software"]
    #[inline(always)]
    #[must_use]
    pub fn alive_lf_ena_cfg(&mut self) -> AliveLfEnaCfgW<SftConSpec> {
        AliveLfEnaCfgW::new(self, 4)
    }
    #[doc = "Bit 5 - configure PD_PMU use 24M clock"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_24m_ena_cfg(&mut self) -> Pmu24mEnaCfgW<SftConSpec> {
        Pmu24mEnaCfgW::new(self, 5)
    }
    #[doc = "Bit 6 - dbg powered up of pd_a53_l0 enable when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn dbgpwrdup_l0_cfg(&mut self) -> DbgpwrdupL0CfgW<SftConSpec> {
        DbgpwrdupL0CfgW::new(self, 6)
    }
    #[doc = "Bit 7 - m0 configure this bit to wakeup PMU state machine."]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_sft_m0(&mut self) -> WakeupSftM0W<SftConSpec> {
        WakeupSftM0W::new(self, 7)
    }
    #[doc = "Bit 8 - ddrctl idle request configure"]
    #[inline(always)]
    #[must_use]
    pub fn ddrctl0_c_sysreq_cfg(&mut self) -> Ddrctl0CSysreqCfgW<SftConSpec> {
        Ddrctl0CSysreqCfgW::new(self, 8)
    }
    #[doc = "Bit 9 - ddr0 io retention configure by software"]
    #[inline(always)]
    #[must_use]
    pub fn ddr0_io_ret_cfg(&mut self) -> Ddr0IoRetCfgW<SftConSpec> {
        Ddr0IoRetCfgW::new(self, 9)
    }
    #[doc = "Bit 12 - ddrctl1 idle request configure"]
    #[inline(always)]
    #[must_use]
    pub fn ddrctl1_c_sysreq_cfg(&mut self) -> Ddrctl1CSysreqCfgW<SftConSpec> {
        Ddrctl1CSysreqCfgW::new(self, 12)
    }
    #[doc = "Bit 13 - ddr1 io retention configure by software"]
    #[inline(always)]
    #[must_use]
    pub fn ddr1_io_ret_cfg(&mut self) -> Ddr1IoRetCfgW<SftConSpec> {
        Ddr1IoRetCfgW::new(self, 13)
    }
    #[doc = "Bit 15 - dbg powered up of pd_a72_b0 enable when in power mode"]
    #[inline(always)]
    #[must_use]
    pub fn dbgpwrdup_b0_cfg(&mut self) -> DbgpwrdupB0CfgW<SftConSpec> {
        DbgpwrdupB0CfgW::new(self, 15)
    }
    #[doc = "Bits 16:19 - dbgnopowerdown function of cluster_l enable"]
    #[inline(always)]
    #[must_use]
    pub fn dbgnopwrdwn_l_enable(&mut self) -> DbgnopwrdwnLEnableW<SftConSpec> {
        DbgnopwrdwnLEnableW::new(self, 16)
    }
    #[doc = "Bit 20 - dbg powered up request function of cluster_l enable"]
    #[inline(always)]
    #[must_use]
    pub fn dbgpwrupreq_l_en(&mut self) -> DbgpwrupreqLEnW<SftConSpec> {
        DbgpwrupreqLEnW::new(self, 20)
    }
    #[doc = "Bit 21 - cluster_l clock source gating configure"]
    #[inline(always)]
    #[must_use]
    pub fn cluster_l_clk_src_gating_cfg(&mut self) -> ClusterLClkSrcGatingCfgW<SftConSpec> {
        ClusterLClkSrcGatingCfgW::new(self, 21)
    }
    #[doc = "Bit 22 - send l2 flush request to cluster_l by software"]
    #[inline(always)]
    #[must_use]
    pub fn l2flushreq_cluster_l(&mut self) -> L2flushreqClusterLW<SftConSpec> {
        L2flushreqClusterLW::new(self, 22)
    }
    #[doc = "Bit 23 - acinactm indicate to cluster_l"]
    #[inline(always)]
    #[must_use]
    pub fn acinactm_cluster_l_cfg(&mut self) -> AcinactmClusterLCfgW<SftConSpec> {
        AcinactmClusterLCfgW::new(self, 23)
    }
    #[doc = "Bits 24:25 - dbgnopowerdown function of cluster_b enable"]
    #[inline(always)]
    #[must_use]
    pub fn dbgnopwrdwn_b_enable(&mut self) -> DbgnopwrdwnBEnableW<SftConSpec> {
        DbgnopwrdwnBEnableW::new(self, 24)
    }
    #[doc = "Bit 28 - dbg powered up request function of cluster_b enable"]
    #[inline(always)]
    #[must_use]
    pub fn dbgpwrupreq_b_en(&mut self) -> DbgpwrupreqBEnW<SftConSpec> {
        DbgpwrupreqBEnW::new(self, 28)
    }
    #[doc = "Bit 29 - cluster_b clock source gating configure"]
    #[inline(always)]
    #[must_use]
    pub fn cluster_b_clk_src_gating_cfg(&mut self) -> ClusterBClkSrcGatingCfgW<SftConSpec> {
        ClusterBClkSrcGatingCfgW::new(self, 29)
    }
    #[doc = "Bit 30 - send l2 flush request to cluster_l by software"]
    #[inline(always)]
    #[must_use]
    pub fn l2flushreq_cluster_b(&mut self) -> L2flushreqClusterBW<SftConSpec> {
        L2flushreqClusterBW::new(self, 30)
    }
    #[doc = "Bit 31 - acinactm indicate to cluster_b"]
    #[inline(always)]
    #[must_use]
    pub fn acinactm_cluster_b_cfg(&mut self) -> AcinactmClusterBCfgW<SftConSpec> {
        AcinactmClusterBCfgW::new(self, 31)
    }
}
#[doc = "pmu software configure register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sft_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sft_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SftConSpec;
impl crate::RegisterSpec for SftConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sft_con::R`](R) reader structure"]
impl crate::Readable for SftConSpec {}
#[doc = "`write(|w| ..)` method takes [`sft_con::W`](W) writer structure"]
impl crate::Writable for SftConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SFT_CON to value 0"]
impl crate::Resettable for SftConSpec {
