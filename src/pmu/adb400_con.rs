#[doc = "Register `ADB400_CON` reader"]
pub type R = crate::R<Adb400ConSpec>;
#[doc = "Register `ADB400_CON` writer"]
pub type W = crate::W<Adb400ConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwrdwn_req_cxcs(&mut self) -> PwrdwnReqCxcsW<Adb400ConSpec> {
        PwrdwnReqCxcsW::new(self, 0)
    }
    #[doc = "Bit 1 - software send idle request from core_l to cci low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn pwrdwn_req_core_l(&mut self) -> PwrdwnReqCoreLW<Adb400ConSpec> {
        PwrdwnReqCoreLW::new(self, 1)
    }
    #[doc = "Bit 2 - software send idle request to path from core_l to gic low power\n\ninterface"]
    #[inline(always)]
    #[must_use]
    pub fn pwrdwn_req_core_l_2gic(&mut self) -> PwrdwnReqCoreL2gicW<Adb400ConSpec> {
        PwrdwnReqCoreL2gicW::new(self, 2)
    }
    #[doc = "Bit 3 - send idle request to path from gic to core_l low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn pwrdwn_req_gic2_core_l(&mut self) -> PwrdwnReqGic2CoreLW<Adb400ConSpec> {
        PwrdwnReqGic2CoreLW::new(self, 3)
    }
    #[doc = "Bit 4 - software send idle request from core_b to cci low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn pwrdwn_req_core_b(&mut self) -> PwrdwnReqCoreBW<Adb400ConSpec> {
        PwrdwnReqCoreBW::new(self, 4)
    }
    #[doc = "Bit 5 - software send idle request to path from core_b to gic low power\n\ninterface"]
    #[inline(always)]
    #[must_use]
    pub fn pwrdwn_req_core_b_2gic(&mut self) -> PwrdwnReqCoreB2gicW<Adb400ConSpec> {
        PwrdwnReqCoreB2gicW::new(self, 5)
    }
    #[doc = "Bit 6 - send idle request to path from gic to core_b low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn pwrdwn_req_gic2_core_b(&mut self) -> PwrdwnReqGic2CoreBW<Adb400ConSpec> {
        PwrdwnReqGic2CoreBW::new(self, 6)
    }
    #[doc = "Bit 8 - hardware send idle request to cxcs low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_cxcs(&mut self) -> ClrCxcsW<Adb400ConSpec> {
        ClrCxcsW::new(self, 8)
    }
    #[doc = "Bit 9 - software send idle request from core_l to cci low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_core_l(&mut self) -> ClrCoreLW<Adb400ConSpec> {
        ClrCoreLW::new(self, 9)
    }
    #[doc = "Bit 10 - hardware send idle request to path from core_l to gic low power\n\ninterface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_core_l_2gic(&mut self) -> ClrCoreL2gicW<Adb400ConSpec> {
        ClrCoreL2gicW::new(self, 10)
    }
    #[doc = "Bit 11 - hardware send idle request to path from gic to core_l low power\n\ninterface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_gic2_core_l(&mut self) -> ClrGic2CoreLW<Adb400ConSpec> {
        ClrGic2CoreLW::new(self, 11)
    }
    #[doc = "Bit 12 - hardware send idle request from core_b to cci low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_core_b(&mut self) -> ClrCoreBW<Adb400ConSpec> {
        ClrCoreBW::new(self, 12)
    }
    #[doc = "Bit 13 - hardware send idle request to path from core_b to gic low power\n\ninterface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_core_b_2gic(&mut self) -> ClrCoreB2gicW<Adb400ConSpec> {
        ClrCoreB2gicW::new(self, 13)
    }
    #[doc = "Bit 14 - hardware send idle request to path from gic to core_b low power\n\ninterface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_gic2_core_b(&mut self) -> ClrGic2CoreBW<Adb400ConSpec> {
        ClrGic2CoreBW::new(self, 14)
    }
    #[doc = "Bits 16:31 - When bit 16=1, bit 0 can be written by software .\n\nWhen bit 16=0, bit 0 cannot be written by software;\n\nWhen bit 17=1, bit 1 can be written by software .\n\nWhen bit 17=0, bit 1 cannot be written by software;\n\n......\n\nWhen bit 31=1, bit 15 can be written by software .\n\nWhen bit 31=0, bit 15 cannot be written by software;"]
    #[inline(always)]
    #[must_use]
    pub fn write_enable(&mut self) -> WriteEnableW<Adb400ConSpec> {
        WriteEnableW::new(self, 16)
    }
}
#[doc = "adb-400 low power control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adb400_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adb400_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adb400ConSpec;
impl crate::RegisterSpec for Adb400ConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adb400_con::R`](R) reader structure"]
impl crate::Readable for Adb400ConSpec {}
#[doc = "`write(|w| ..)` method takes [`adb400_con::W`](W) writer structure"]
impl crate::Writable for Adb400ConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADB400_CON to value 0"]
impl crate::Resettable for Adb400ConSpec {
