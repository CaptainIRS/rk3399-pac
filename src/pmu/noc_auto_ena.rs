#[doc = "Register `NOC_AUTO_ENA` reader"]
pub type R = crate::R<NocAutoEnaSpec>;
#[doc = "Register `NOC_AUTO_ENA` writer"]
pub type W = crate::W<NocAutoEnaSpec>;
#[doc = "\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pmum0_gating_disable(&mut self) -> Pmum0GatingDisableW<NocAutoEnaSpec> {
        Pmum0GatingDisableW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn center1_gating_disable(&mut self) -> Center1GatingDisableW<NocAutoEnaSpec> {
        Center1GatingDisableW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn emmc_gating_disable(&mut self) -> EmmcGatingDisableW<NocAutoEnaSpec> {
        EmmcGatingDisableW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn gmac_gating_disable(&mut self) -> GmacGatingDisableW<NocAutoEnaSpec> {
        GmacGatingDisableW::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn edp_gating_disable(&mut self) -> EdpGatingDisableW<NocAutoEnaSpec> {
        EdpGatingDisableW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_gating_disable(&mut self) -> PmuGatingDisableW<NocAutoEnaSpec> {
        PmuGatingDisableW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn alive_gating_disable(&mut self) -> AliveGatingDisableW<NocAutoEnaSpec> {
        AliveGatingDisableW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn msch1_gating_disable(&mut self) -> Msch1GatingDisableW<NocAutoEnaSpec> {
        Msch1GatingDisableW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn msch0_gating_disable(&mut self) -> Msch0GatingDisableW<NocAutoEnaSpec> {
        Msch0GatingDisableW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn vio_gating_disable(&mut self) -> VioGatingDisableW<NocAutoEnaSpec> {
        VioGatingDisableW::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn ccim1_gating_disable(&mut self) -> Ccim1GatingDisableW<NocAutoEnaSpec> {
        Ccim1GatingDisableW::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn ccim0_gating_disable(&mut self) -> Ccim0GatingDisableW<NocAutoEnaSpec> {
        Ccim0GatingDisableW::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn center_gating_disable(&mut self) -> CenterGatingDisableW<NocAutoEnaSpec> {
        CenterGatingDisableW::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn perilpm0_gating_disable(&mut self) -> Perilpm0GatingDisableW<NocAutoEnaSpec> {
        Perilpm0GatingDisableW::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn usb3_gating_disable(&mut self) -> Usb3GatingDisableW<NocAutoEnaSpec> {
        Usb3GatingDisableW::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn hdcp_gating_disable(&mut self) -> HdcpGatingDisableW<NocAutoEnaSpec> {
        HdcpGatingDisableW::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn isp1_gating_disable(&mut self) -> Isp1GatingDisableW<NocAutoEnaSpec> {
        Isp1GatingDisableW::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn isp0_gating_disable(&mut self) -> Isp0GatingDisableW<NocAutoEnaSpec> {
        Isp0GatingDisableW::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn vopl_gating_disable(&mut self) -> VoplGatingDisableW<NocAutoEnaSpec> {
        VoplGatingDisableW::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn vopb_gating_disable(&mut self) -> VopbGatingDisableW<NocAutoEnaSpec> {
        VopbGatingDisableW::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn iep_gating_disable(&mut self) -> IepGatingDisableW<NocAutoEnaSpec> {
        IepGatingDisableW::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn rga_gating_disable(&mut self) -> RgaGatingDisableW<NocAutoEnaSpec> {
        RgaGatingDisableW::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn vdu_gating_disable(&mut self) -> VduGatingDisableW<NocAutoEnaSpec> {
        VduGatingDisableW::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn vcodec_gating_disable(&mut self) -> VcodecGatingDisableW<NocAutoEnaSpec> {
        VcodecGatingDisableW::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn perihp_gating_disable(&mut self) -> PerihpGatingDisableW<NocAutoEnaSpec> {
        PerihpGatingDisableW::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn perilp_gating_disable(&mut self) -> PerilpGatingDisableW<NocAutoEnaSpec> {
        PerilpGatingDisableW::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn gpu_gating_disable(&mut self) -> GpuGatingDisableW<NocAutoEnaSpec> {
        GpuGatingDisableW::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn gic_gating_disable(&mut self) -> GicGatingDisableW<NocAutoEnaSpec> {
        GicGatingDisableW::new(self, 27)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn sd_gating_disable(&mut self) -> SdGatingDisableW<NocAutoEnaSpec> {
        SdGatingDisableW::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn sdioaudio_gating_disable(&mut self) -> SdioaudioGatingDisableW<NocAutoEnaSpec> {
        SdioaudioGatingDisableW::new(self, 29)
    }
}
#[doc = "NOC auto domain clock gating disable enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`noc_auto_ena::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`noc_auto_ena::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NocAutoEnaSpec;
impl crate::RegisterSpec for NocAutoEnaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`noc_auto_ena::R`](R) reader structure"]
impl crate::Readable for NocAutoEnaSpec {}
#[doc = "`write(|w| ..)` method takes [`noc_auto_ena::W`](W) writer structure"]
impl crate::Writable for NocAutoEnaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NOC_AUTO_ENA to value 0"]
impl crate::Resettable for NocAutoEnaSpec {
