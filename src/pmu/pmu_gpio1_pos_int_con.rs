#[doc = "Register `PMU_GPIO1_POS_INT_CON` reader"]
pub type R = crate::R<PmuGpio1PosIntConSpec>;
#[doc = "Register `PMU_GPIO1_POS_INT_CON` writer"]
pub type W = crate::W<PmuGpio1PosIntConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio1a_pos_int_en(&mut self) -> Gpio1aPosIntEnW<PmuGpio1PosIntConSpec> {
        Gpio1aPosIntEnW::new(self, 0)
    }
    #[doc = "Bits 8:15 - gpio1b posedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1b_pos_int_en(&mut self) -> Gpio1bPosIntEnW<PmuGpio1PosIntConSpec> {
        Gpio1bPosIntEnW::new(self, 8)
    }
    #[doc = "Bits 16:23 - gpio1c posedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1c_pos_int_en(&mut self) -> Gpio1cPosIntEnW<PmuGpio1PosIntConSpec> {
        Gpio1cPosIntEnW::new(self, 16)
    }
    #[doc = "Bits 24:31 - gpio1d posedge pulse interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1d_pos_int_en(&mut self) -> Gpio1dPosIntEnW<PmuGpio1PosIntConSpec> {
        Gpio1dPosIntEnW::new(self, 24)
    }
}
#[doc = "pmu gpio1 posedge interrupt configure register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmu_gpio1_pos_int_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmu_gpio1_pos_int_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmuGpio1PosIntConSpec;
impl crate::RegisterSpec for PmuGpio1PosIntConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmu_gpio1_pos_int_con::R`](R) reader structure"]
impl crate::Readable for PmuGpio1PosIntConSpec {}
#[doc = "`write(|w| ..)` method takes [`pmu_gpio1_pos_int_con::W`](W) writer structure"]
impl crate::Writable for PmuGpio1PosIntConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PMU_GPIO1_POS_INT_CON to value 0"]
impl crate::Resettable for PmuGpio1PosIntConSpec {
