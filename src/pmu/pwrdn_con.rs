#[doc = "Register `PWRDN_CON` reader"]
pub type R = crate::R<PwrdnConSpec>;
#[doc = "Register `PWRDN_CON` writer"]
pub type W = crate::W<PwrdnConSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l0_pwrdwn_en(&mut self) -> PdA53L0PwrdwnEnW<PwrdnConSpec> {
        PdA53L0PwrdwnEnW::new(self, 0)
    }
    #[doc = "Bit 1 - pd_a53_l1 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l1_pwrdwn(&mut self) -> PdA53L1PwrdwnW<PwrdnConSpec> {
        PdA53L1PwrdwnW::new(self, 1)
    }
    #[doc = "Bit 2 - pd_a53_l2 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l2_pwrdwn(&mut self) -> PdA53L2PwrdwnW<PwrdnConSpec> {
        PdA53L2PwrdwnW::new(self, 2)
    }
    #[doc = "Bit 3 - pd_a53_l3 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a53_l3_pwrdwn(&mut self) -> PdA53L3PwrdwnW<PwrdnConSpec> {
        PdA53L3PwrdwnW::new(self, 3)
    }
    #[doc = "Bit 4 - pd_a72_b0 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a72_b0_pwrdwn_en(&mut self) -> PdA72B0PwrdwnEnW<PwrdnConSpec> {
        PdA72B0PwrdwnEnW::new(self, 4)
    }
    #[doc = "Bit 5 - pd_a72_b0 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_a72_b1_pwrdwn_en(&mut self) -> PdA72B1PwrdwnEnW<PwrdnConSpec> {
        PdA72B1PwrdwnEnW::new(self, 5)
    }
    #[doc = "Bit 6 - pd_scu_l power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_scu_l_pwrdwn_en(&mut self) -> PdScuLPwrdwnEnW<PwrdnConSpec> {
        PdScuLPwrdwnEnW::new(self, 6)
    }
    #[doc = "Bit 7 - pd_scu_b power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_scu_b_pwrdwn_en(&mut self) -> PdScuBPwrdwnEnW<PwrdnConSpec> {
        PdScuBPwrdwnEnW::new(self, 7)
    }
    #[doc = "Bit 8 - pd_tcpd0 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_tcpd0_pwrdwn_en(&mut self) -> PdTcpd0PwrdwnEnW<PwrdnConSpec> {
        PdTcpd0PwrdwnEnW::new(self, 8)
    }
    #[doc = "Bit 9 - pd_tcpd1 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_tcpd1_pwrdwn_en(&mut self) -> PdTcpd1PwrdwnEnW<PwrdnConSpec> {
        PdTcpd1PwrdwnEnW::new(self, 9)
    }
    #[doc = "Bit 10 - pd_cci power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_cci_pwrdwn_en(&mut self) -> PdCciPwrdwnEnW<PwrdnConSpec> {
        PdCciPwrdwnEnW::new(self, 10)
    }
    #[doc = "Bit 11 - pd_perilp power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_perilp_pwrdwn_en(&mut self) -> PdPerilpPwrdwnEnW<PwrdnConSpec> {
        PdPerilpPwrdwnEnW::new(self, 11)
    }
    #[doc = "Bit 12 - pd_perihp power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_perihp_pwrdwn_en(&mut self) -> PdPerihpPwrdwnEnW<PwrdnConSpec> {
        PdPerihpPwrdwnEnW::new(self, 12)
    }
    #[doc = "Bit 13 - pd_center power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_center_pwrdwn_en(&mut self) -> PdCenterPwrdwnEnW<PwrdnConSpec> {
        PdCenterPwrdwnEnW::new(self, 13)
    }
    #[doc = "Bit 14 - pd_vio power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vio_pwrdwn_en(&mut self) -> PdVioPwrdwnEnW<PwrdnConSpec> {
        PdVioPwrdwnEnW::new(self, 14)
    }
    #[doc = "Bit 15 - pd_gpu power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gpu_pwrdwn_en(&mut self) -> PdGpuPwrdwnEnW<PwrdnConSpec> {
        PdGpuPwrdwnEnW::new(self, 15)
    }
    #[doc = "Bit 16 - pd_perihp power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vcodec_pwrdwn_en(&mut self) -> PdVcodecPwrdwnEnW<PwrdnConSpec> {
        PdVcodecPwrdwnEnW::new(self, 16)
    }
    #[doc = "Bit 17 - pd_vdu power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vdu_pwrdwn_en(&mut self) -> PdVduPwrdwnEnW<PwrdnConSpec> {
        PdVduPwrdwnEnW::new(self, 17)
    }
    #[doc = "Bit 18 - pd_rga power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_rga_pwrdwn_en(&mut self) -> PdRgaPwrdwnEnW<PwrdnConSpec> {
        PdRgaPwrdwnEnW::new(self, 18)
    }
    #[doc = "Bit 19 - pd_perihp power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_iep_pwrdwn_en(&mut self) -> PdIepPwrdwnEnW<PwrdnConSpec> {
        PdIepPwrdwnEnW::new(self, 19)
    }
    #[doc = "Bit 20 - pd_vo power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_vo_pwrdwn_en(&mut self) -> PdVoPwrdwnEnW<PwrdnConSpec> {
        PdVoPwrdwnEnW::new(self, 20)
    }
    #[doc = "Bit 22 - pd_isp0 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_isp0_pwrdwn_en(&mut self) -> PdIsp0PwrdwnEnW<PwrdnConSpec> {
        PdIsp0PwrdwnEnW::new(self, 22)
    }
    #[doc = "Bit 23 - pd_isp1 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_isp1_pwrdwn_en(&mut self) -> PdIsp1PwrdwnEnW<PwrdnConSpec> {
        PdIsp1PwrdwnEnW::new(self, 23)
    }
    #[doc = "Bit 24 - pd_hdcp power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_hdcp_pwrdwn_en(&mut self) -> PdHdcpPwrdwnEnW<PwrdnConSpec> {
        PdHdcpPwrdwnEnW::new(self, 24)
    }
    #[doc = "Bit 25 - pd_gmac power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gmac_pwrdwn_en(&mut self) -> PdGmacPwrdwnEnW<PwrdnConSpec> {
        PdGmacPwrdwnEnW::new(self, 25)
    }
    #[doc = "Bit 26 - pd_emmc power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_emmc_pwrdwn_en(&mut self) -> PdEmmcPwrdwnEnW<PwrdnConSpec> {
        PdEmmcPwrdwnEnW::new(self, 26)
    }
    #[doc = "Bit 27 - pd_usb3 power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_usb3_pwrdwn_en(&mut self) -> PdUsb3PwrdwnEnW<PwrdnConSpec> {
        PdUsb3PwrdwnEnW::new(self, 27)
    }
    #[doc = "Bit 28 - pd_edp power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_edp_pwrdwn_en(&mut self) -> PdEdpPwrdwnEnW<PwrdnConSpec> {
        PdEdpPwrdwnEnW::new(self, 28)
    }
    #[doc = "Bit 29 - pd_gic power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_gic_pwrdwn_en(&mut self) -> PdGicPwrdwnEnW<PwrdnConSpec> {
        PdGicPwrdwnEnW::new(self, 29)
    }
    #[doc = "Bit 30 - pd_sd power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_sd_pwrdwn_en(&mut self) -> PdSdPwrdwnEnW<PwrdnConSpec> {
        PdSdPwrdwnEnW::new(self, 30)
    }
    #[doc = "Bit 31 - pd_sdioaudio power down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pd_sdioaudio_pwrdwn_en(&mut self) -> PdSdioaudioPwrdwnEnW<PwrdnConSpec> {
        PdSdioaudioPwrdwnEnW::new(self, 31)
    }
}
#[doc = "pmu power down configure register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwrdn_con::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwrdn_con::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwrdnConSpec;
impl crate::RegisterSpec for PwrdnConSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwrdn_con::R`](R) reader structure"]
impl crate::Readable for PwrdnConSpec {}
#[doc = "`write(|w| ..)` method takes [`pwrdn_con::W`](W) writer structure"]
impl crate::Writable for PwrdnConSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWRDN_CON to value 0"]
impl crate::Resettable for PwrdnConSpec {
