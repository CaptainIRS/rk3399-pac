#[doc = "Register `BUS_CLR` reader"]
pub type R = crate::R<BusClrSpec>;
#[doc = "Register `BUS_CLR` writer"]
pub type W = crate::W<BusClrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr_gpu(&mut self) -> ClrGpuW<BusClrSpec> {
        ClrGpuW::new(self, 0)
    }
    #[doc = "Bit 1 - send idle request to perilp niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_perilp(&mut self) -> ClrPerilpW<BusClrSpec> {
        ClrPerilpW::new(self, 1)
    }
    #[doc = "Bit 2 - send idle request to perihp niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_perihp(&mut self) -> ClrPerihpW<BusClrSpec> {
        ClrPerihpW::new(self, 2)
    }
    #[doc = "Bit 3 - send idle request to vcodec niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_vcodec(&mut self) -> ClrVcodecW<BusClrSpec> {
        ClrVcodecW::new(self, 3)
    }
    #[doc = "Bit 4 - send idle request to vdu niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_vdu(&mut self) -> ClrVduW<BusClrSpec> {
        ClrVduW::new(self, 4)
    }
    #[doc = "Bit 5 - send idle request to rga niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_rga(&mut self) -> ClrRgaW<BusClrSpec> {
        ClrRgaW::new(self, 5)
    }
    #[doc = "Bit 6 - send idle request to iep niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_iep(&mut self) -> ClrIepW<BusClrSpec> {
        ClrIepW::new(self, 6)
    }
    #[doc = "Bit 7 - send idle request to vopb niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_vopb(&mut self) -> ClrVopbW<BusClrSpec> {
        ClrVopbW::new(self, 7)
    }
    #[doc = "Bit 8 - send idle request to vopl niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_vopl(&mut self) -> ClrVoplW<BusClrSpec> {
        ClrVoplW::new(self, 8)
    }
    #[doc = "Bit 9 - send idle request to isp0 niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_isp0(&mut self) -> ClrIsp0W<BusClrSpec> {
        ClrIsp0W::new(self, 9)
    }
    #[doc = "Bit 10 - send idle request to isp1 niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_isp1(&mut self) -> ClrIsp1W<BusClrSpec> {
        ClrIsp1W::new(self, 10)
    }
    #[doc = "Bit 11 - send idle request to hdcp niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_hdcp(&mut self) -> ClrHdcpW<BusClrSpec> {
        ClrHdcpW::new(self, 11)
    }
    #[doc = "Bit 12 - send idle request to usb3 niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_usb3(&mut self) -> ClrUsb3W<BusClrSpec> {
        ClrUsb3W::new(self, 12)
    }
    #[doc = "Bit 13 - send idle request to perilp m0 niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_perilpm0(&mut self) -> ClrPerilpm0W<BusClrSpec> {
        ClrPerilpm0W::new(self, 13)
    }
    #[doc = "Bit 14 - send idle request to center niu"]
    #[inline(always)]
    #[must_use]
    pub fn clr_center(&mut self) -> ClrCenterW<BusClrSpec> {
        ClrCenterW::new(self, 14)
    }
    #[doc = "Bit 15 - send idle request to ccim1 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_ccim1(&mut self) -> ClrCcim1W<BusClrSpec> {
        ClrCcim1W::new(self, 15)
    }
    #[doc = "Bit 16 - send idle request to ccim0 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_ccim0(&mut self) -> ClrCcim0W<BusClrSpec> {
        ClrCcim0W::new(self, 16)
    }
    #[doc = "Bit 17 - send idle request to vio low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_vio(&mut self) -> ClrVioW<BusClrSpec> {
        ClrVioW::new(self, 17)
    }
    #[doc = "Bit 18 - send idle request to msch0 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_msch0(&mut self) -> ClrMsch0W<BusClrSpec> {
        ClrMsch0W::new(self, 18)
    }
    #[doc = "Bit 19 - send idle request to msch1 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_msch1(&mut self) -> ClrMsch1W<BusClrSpec> {
        ClrMsch1W::new(self, 19)
    }
    #[doc = "Bit 20 - send idle request to alive low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_alive(&mut self) -> ClrAliveW<BusClrSpec> {
        ClrAliveW::new(self, 20)
    }
    #[doc = "Bit 21 - send idle request to pmu low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_pmu(&mut self) -> ClrPmuW<BusClrSpec> {
        ClrPmuW::new(self, 21)
    }
    #[doc = "Bit 22 - send idle request to edp low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_edp(&mut self) -> ClrEdpW<BusClrSpec> {
        ClrEdpW::new(self, 22)
    }
    #[doc = "Bit 23 - send idle request to gmac low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_gmac(&mut self) -> ClrGmacW<BusClrSpec> {
        ClrGmacW::new(self, 23)
    }
    #[doc = "Bit 24 - send idle request to emmc low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_emmc(&mut self) -> ClrEmmcW<BusClrSpec> {
        ClrEmmcW::new(self, 24)
    }
    #[doc = "Bit 25 - send idle request to center1 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_center1(&mut self) -> ClrCenter1W<BusClrSpec> {
        ClrCenter1W::new(self, 25)
    }
    #[doc = "Bit 26 - send idle request to pmu m0 low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_pmum0(&mut self) -> ClrPmum0W<BusClrSpec> {
        ClrPmum0W::new(self, 26)
    }
    #[doc = "Bit 27 - send idle request to gic low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_gic(&mut self) -> ClrGicW<BusClrSpec> {
        ClrGicW::new(self, 27)
    }
    #[doc = "Bit 28 - send idle request to sd low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_sd(&mut self) -> ClrSdW<BusClrSpec> {
        ClrSdW::new(self, 28)
    }
    #[doc = "Bit 29 - send idle request to sdioaudio low power interface"]
    #[inline(always)]
    #[must_use]
    pub fn clr_sdioaudio(&mut self) -> ClrSdioaudioW<BusClrSpec> {
        ClrSdioaudioW::new(self, 29)
    }
}
#[doc = "pmu bus clear register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bus_clr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bus_clr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BusClrSpec;
impl crate::RegisterSpec for BusClrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bus_clr::R`](R) reader structure"]
impl crate::Readable for BusClrSpec {}
#[doc = "`write(|w| ..)` method takes [`bus_clr::W`](W) writer structure"]
impl crate::Writable for BusClrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BUS_CLR to value 0"]
impl crate::Resettable for BusClrSpec {
