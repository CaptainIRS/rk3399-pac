#[doc = "Register `PVALHS` reader"]
pub type R = crate::R<PvalhsSpec>;
...
#[doc = "Preset value register for High Speed\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pvalhs::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PvalhsSpec;
impl crate::RegisterSpec for PvalhsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pvalhs::R`](R) reader structure"]
impl crate::Readable for PvalhsSpec {}
#[doc = "`reset()` method sets PVALHS to value 0"]
impl crate::Resettable for PvalhsSpec {
