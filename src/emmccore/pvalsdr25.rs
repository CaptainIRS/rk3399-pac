#[doc = "Register `PVALSDR25` reader"]
pub type R = crate::R<Pvalsdr25Spec>;
...
#[doc = "Preset value register for SDR25\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pvalsdr25::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pvalsdr25Spec;
impl crate::RegisterSpec for Pvalsdr25Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pvalsdr25::R`](R) reader structure"]
impl crate::Readable for Pvalsdr25Spec {}
#[doc = "`reset()` method sets PVALSDR25 to value 0"]
impl crate::Resettable for Pvalsdr25Spec {
