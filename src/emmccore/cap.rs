...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suspendresumesupport(&mut self) -> SuspendresumesupportW<CapSpec> {
        SuspendresumesupportW::new(self, 23)
    }
    #[doc = "Bit 24 - Voltage Support 3.3 V"]
    #[inline(always)]
    #[must_use]
    pub fn voltage33vsupport(&mut self) -> Voltage33vsupportW<CapSpec> {
        Voltage33vsupportW::new(self, 24)
    }
    #[doc = "Bit 37 - This bit indicates support of Driver Type C for 1.8 Signaling."]
    #[inline(always)]
    #[must_use]
    pub fn drivertypecsupport(&mut self) -> DrivertypecsupportW<CapSpec> {
...
#[doc = "`reset()` method sets CAP to value 0x8010_20f7_44ed_c880"]
