#[doc = "Register `CQTDB` reader"]
pub type R = crate::R<CqtdbSpec>;
#[doc = "Register `CQTDB` writer"]
pub type W = crate::W<CqtdbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn taskdoorbell(&mut self) -> TaskdoorbellW<CqtdbSpec> {
        TaskdoorbellW::new(self, 0)
    }
}
#[doc = "Command queueing task doorbell register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cqtdb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cqtdb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CqtdbSpec;
impl crate::RegisterSpec for CqtdbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cqtdb::R`](R) reader structure"]
impl crate::Readable for CqtdbSpec {}
#[doc = "`write(|w| ..)` method takes [`cqtdb::W`](W) writer structure"]
impl crate::Writable for CqtdbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CQTDB to value 0"]
impl crate::Resettable for CqtdbSpec {
