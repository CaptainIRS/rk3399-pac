#[doc = "Register `PVALSDR50` reader"]
pub type R = crate::R<Pvalsdr50Spec>;
...
#[doc = "Preset value register for SDR50\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pvalsdr50::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pvalsdr50Spec;
impl crate::RegisterSpec for Pvalsdr50Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pvalsdr50::R`](R) reader structure"]
impl crate::Readable for Pvalsdr50Spec {}
#[doc = "`reset()` method sets PVALSDR50 to value 0"]
impl crate::Resettable for Pvalsdr50Spec {
