#[doc = "Register `NORINTSTSENA` reader"]
pub type R = crate::R<NorintstsenaSpec>;
#[doc = "Register `NORINTSTSENA` writer"]
pub type W = crate::W<NorintstsenaSpec>;
#[doc = "\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn commandcomplete(&mut self) -> CommandcompleteW<NorintstsenaSpec> {
        CommandcompleteW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn transfercomplete(&mut self) -> TransfercompleteW<NorintstsenaSpec> {
        TransfercompleteW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn blockgapevent(&mut self) -> BlockgapeventW<NorintstsenaSpec> {
        BlockgapeventW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn dmainterrupt(&mut self) -> DmainterruptW<NorintstsenaSpec> {
        DmainterruptW::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn bufferwriteready(&mut self) -> BufferwritereadyW<NorintstsenaSpec> {
        BufferwritereadyW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn bufferreadready(&mut self) -> BufferreadreadyW<NorintstsenaSpec> {
        BufferreadreadyW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn cardinsertion(&mut self) -> CardinsertionW<NorintstsenaSpec> {
        CardinsertionW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn cardremoval(&mut self) -> CardremovalW<NorintstsenaSpec> {
        CardremovalW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn cardinterrupt(&mut self) -> CardinterruptW<NorintstsenaSpec> {
        CardinterruptW::new(self, 8)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn retuningevent(&mut self) -> RetuningeventW<NorintstsenaSpec> {
        RetuningeventW::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn bootackrcv(&mut self) -> BootackrcvW<NorintstsenaSpec> {
        BootackrcvW::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn bootterminateinterrupt(&mut self) -> BootterminateinterruptW<NorintstsenaSpec> {
        BootterminateinterruptW::new(self, 14)
    }
}
#[doc = "Normal interrupt status enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`norintstsena::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`norintstsena::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NorintstsenaSpec;
impl crate::RegisterSpec for NorintstsenaSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`norintstsena::R`](R) reader structure"]
impl crate::Readable for NorintstsenaSpec {}
#[doc = "`write(|w| ..)` method takes [`norintstsena::W`](W) writer structure"]
impl crate::Writable for NorintstsenaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets NORINTSTSENA to value 0"]
impl crate::Resettable for NorintstsenaSpec {
