...
#[doc = "Auto CMD Timeout Error Occurs if the no response is returned within 64 SDCLK cycles from the end bit of the command. If this bit is set to 1, the other error status bits (D04 - D02) are meaningless.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `ACMDTIMEOUTERR` reader - Auto CMD Timeout Error Occurs if the no response is returned within 64 SDCLK cycles from the end bit of the command. If this bit is set to 1, the other error status bits (D04 - D02) are meaningless."]
...
#[doc = "Auto CMD CRC Error Occurs when detecting a CRC error in the command response.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Acmdcrcerr {
    #[doc = "0: CRC Error Generated"]
    B0 = 0,
...
#[doc = "Field `ACMDCRCERR` reader - Auto CMD CRC Error Occurs when detecting a CRC error in the command response."]
...
#[doc = "Auto CMD End Bit Error. Occurs when detecting that the end bit of command response is 0.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Acmdendbiterr {
    #[doc = "0: End Bit Error Generated"]
    B0 = 0,
...
#[doc = "Field `ACMDENDBITERR` reader - Auto CMD End Bit Error. Occurs when detecting that the end bit of command response is 0."]
...
#[doc = "Auto CMD Index Error. Occurs if the Command Index error occurs in response to a command.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `ACMDINDEXERR` reader - Auto CMD Index Error. Occurs if the Command Index error occurs in response to a command."]
...
#[doc = "Command Not Issued By Auto CMD12 Error. Setting this bit to 1 means CMD_wo_DAT is not executed due to an Auto CMD12 error (D04 - D01) in this register. This bit is set to 0 when Auto CMD Error is generated by Auto CMD23.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `CMDNOTISSBYACMD12ERR` reader - Command Not Issued By Auto CMD12 Error. Setting this bit to 1 means CMD_wo_DAT is not executed due to an Auto CMD12 error (D04 - D01) in this register. This bit is set to 0 when Auto CMD Error is generated by Auto CMD23."]
...
impl R {
    #[doc = "Bit 0 - Auto CMD12 not Executed If memory multiple block data transfer is not started due to command error, this bit is not set because it is not necessary to issue Auto CMD12. Setting this bit to 1 means the HC cannot issue Auto CMD12 to stop memory multiple block transfer due to some error. If this bit isset to 1, other error status bits (D04 - D01) are meaningless. This bit is set to 0 when Auto CMD Error is generated by Auto CMD23."]
    #[inline(always)]
    pub fn acmd12notexe(&self) -> Acmd12notexeR {
        Acmd12notexeR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Auto CMD Timeout Error Occurs if the no response is returned within 64 SDCLK cycles from the end bit of the command. If this bit is set to 1, the other error status bits (D04 - D02) are meaningless."]
    #[inline(always)]
    pub fn acmdtimeouterr(&self) -> AcmdtimeouterrR {
        AcmdtimeouterrR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Auto CMD CRC Error Occurs when detecting a CRC error in the command response."]
    #[inline(always)]
    pub fn acmdcrcerr(&self) -> AcmdcrcerrR {
        AcmdcrcerrR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Auto CMD End Bit Error. Occurs when detecting that the end bit of command response is 0."]
    #[inline(always)]
    pub fn acmdendbiterr(&self) -> AcmdendbiterrR {
        AcmdendbiterrR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Auto CMD Index Error. Occurs if the Command Index error occurs in response to a command."]
    #[inline(always)]
    pub fn acmdindexerr(&self) -> AcmdindexerrR {
        AcmdindexerrR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 7 - Command Not Issued By Auto CMD12 Error. Setting this bit to 1 means CMD_wo_DAT is not executed due to an Auto CMD12 error (D04 - D01) in this register. This bit is set to 0 when Auto CMD Error is generated by Auto CMD23."]
    #[inline(always)]
