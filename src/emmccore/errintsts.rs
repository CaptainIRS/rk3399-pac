#[doc = "Register `ERRINTSTS` reader"]
pub type R = crate::R<ErrintstsSpec>;
#[doc = "Register `ERRINTSTS` writer"]
pub type W = crate::W<ErrintstsSpec>;
#[doc = "\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmdtimeouterr(&mut self) -> CmdtimeouterrW<ErrintstsSpec> {
        CmdtimeouterrW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn cmdcrcerr(&mut self) -> CmdcrcerrW<ErrintstsSpec> {
        CmdcrcerrW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn cmdendbiterr(&mut self) -> CmdendbiterrW<ErrintstsSpec> {
        CmdendbiterrW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn cmdindexerr(&mut self) -> CmdindexerrW<ErrintstsSpec> {
        CmdindexerrW::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn datatimeouterr(&mut self) -> DatatimeouterrW<ErrintstsSpec> {
        DatatimeouterrW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn datacrcerr(&mut self) -> DatacrcerrW<ErrintstsSpec> {
        DatacrcerrW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn dataendbiterr(&mut self) -> DataendbiterrW<ErrintstsSpec> {
        DataendbiterrW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn currentlimiterr(&mut self) -> CurrentlimiterrW<ErrintstsSpec> {
        CurrentlimiterrW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn autocmderr(&mut self) -> AutocmderrW<ErrintstsSpec> {
        AutocmderrW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn admaerr(&mut self) -> AdmaerrW<ErrintstsSpec> {
        AdmaerrW::new(self, 9)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn targetresperr(&mut self) -> TargetresperrW<ErrintstsSpec> {
        TargetresperrW::new(self, 12)
    }
}
#[doc = "Error interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`errintsts::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`errintsts::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ErrintstsSpec;
impl crate::RegisterSpec for ErrintstsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`errintsts::R`](R) reader structure"]
impl crate::Readable for ErrintstsSpec {}
#[doc = "`write(|w| ..)` method takes [`errintsts::W`](W) writer structure"]
impl crate::Writable for ErrintstsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0x13fb;
}
#[doc = "`reset()` method sets ERRINTSTS to value 0"]
impl crate::Resettable for ErrintstsSpec {
