#[doc = "Register `EMMCCORE_PVALHS` reader"]
pub type R = crate::R<EmmccorePvalhsSpec>;
...
#[doc = "Preset value register for High Speed\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`emmccore_pvalhs::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmmccorePvalhsSpec;
impl crate::RegisterSpec for EmmccorePvalhsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`emmccore_pvalhs::R`](R) reader structure"]
impl crate::Readable for EmmccorePvalhsSpec {}
#[doc = "`reset()` method sets EMMCCORE_PVALHS to value 0"]
impl crate::Resettable for EmmccorePvalhsSpec {
