#[doc = "Register `PVALSDR104` reader"]
pub type R = crate::R<Pvalsdr104Spec>;
...
#[doc = "Preset value register for SDR104\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pvalsdr104::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pvalsdr104Spec;
impl crate::RegisterSpec for Pvalsdr104Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pvalsdr104::R`](R) reader structure"]
impl crate::Readable for Pvalsdr104Spec {}
#[doc = "`reset()` method sets PVALSDR104 to value 0"]
impl crate::Resettable for Pvalsdr104Spec {
