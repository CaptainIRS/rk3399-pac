...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn softwareresetall(&mut self) -> SoftwareresetallW<SwrstSpec> {
        SoftwareresetallW::new(self, 0)
    }
    #[doc = "Bit 1 - Only part of command circuit is reset."]
    #[inline(always)]
    #[must_use]
    pub fn softwareresetcmd(&mut self) -> SoftwareresetcmdW<SwrstSpec> {
        SoftwareresetcmdW::new(self, 1)
    }
    #[doc = "Bit 2 - Software Reset for DAT Line."]
    #[inline(always)]
    #[must_use]
    pub fn softwareresetdat(&mut self) -> SoftwareresetdatW<SwrstSpec> {
        SoftwareresetdatW::new(self, 2)
    }
}
#[doc = "Software reset register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`swrst::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`swrst::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
