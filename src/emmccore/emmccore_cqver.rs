...
#[doc = "Field `SUFFIX` reader - eMMC Version Suffix (2nd digit right of decimal point), in BCD format"]
pub type SuffixR = crate::FieldReader;
#[doc = "Field `MINOR` reader - eMMC Minor Version Number(digit right of decimal point), in BCD format"]
pub type MinorR = crate::FieldReader;
#[doc = "Field `MAJOR` reader - eMMC Major Version Number (digit left of decimal point), in BCD format"]
pub type MajorR = crate::FieldReader;
impl R {
    #[doc = "Bits 0:3 - eMMC Version Suffix (2nd digit right of decimal point), in BCD format"]
    #[inline(always)]
    pub fn suffix(&self) -> SuffixR {
        SuffixR::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 4:7 - eMMC Minor Version Number(digit right of decimal point), in BCD format"]
    #[inline(always)]
    pub fn minor(&self) -> MinorR {
        MinorR::new(((self.bits >> 4) & 0x0f) as u8)
    }
    #[doc = "Bits 8:11 - eMMC Major Version Number (digit left of decimal point), in BCD format"]
    #[inline(always)]
