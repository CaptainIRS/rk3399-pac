...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatranswidth(&mut self) -> DatatranswidthW<Hostctrl1Spec> {
        DatatranswidthW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn highspeedena(&mut self) -> HighspeedenaW<Hostctrl1Spec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn extendeddatatranswidth(&mut self) -> ExtendeddatatranswidthW<Hostctrl1Spec> {
        ExtendeddatatranswidthW::new(self, 5)
    }
    #[doc = "Bit 6 - This bit is enabled while the Card Detect Signal Selection is set to\n\n1 and it indicates card inserted or not.\n\nGenerates (card ins or card removal) interrupt when the normal\n\nint sts enable bit is set."]
    #[inline(always)]
    #[must_use]
    pub fn carddettestlevel(&mut self) -> CarddettestlevelW<Hostctrl1Spec> {
        CarddettestlevelW::new(self, 6)
    }
    #[doc = "Bit 7 - This bit selects source for card detection."]
    #[inline(always)]
    #[must_use]
    pub fn carddetsginaldet(&mut self) -> CarddetsginaldetW<Hostctrl1Spec> {
...
#[doc = "`reset()` method sets HOSTCTRL1 to value 0"]
