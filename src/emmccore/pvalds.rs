#[doc = "Register `PVALDS` reader"]
pub type R = crate::R<PvaldsSpec>;
...
#[doc = "Preset value register for Default Speed\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pvalds::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PvaldsSpec;
impl crate::RegisterSpec for PvaldsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pvalds::R`](R) reader structure"]
impl crate::Readable for PvaldsSpec {}
#[doc = "`reset()` method sets PVALDS to value 0"]
impl crate::Resettable for PvaldsSpec {
