#[doc = "Register `EMMCCORE_PVALDS` reader"]
pub type R = crate::R<EmmccorePvaldsSpec>;
...
#[doc = "Preset value register for Default Speed\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`emmccore_pvalds::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmmccorePvaldsSpec;
impl crate::RegisterSpec for EmmccorePvaldsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`emmccore_pvalds::R`](R) reader structure"]
impl crate::Readable for EmmccorePvaldsSpec {}
#[doc = "`reset()` method sets EMMCCORE_PVALDS to value 0"]
impl crate::Resettable for EmmccorePvaldsSpec {
