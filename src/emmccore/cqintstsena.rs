#[doc = "Register `CQINTSTSENA` reader"]
pub type R = crate::R<CqintstsenaSpec>;
#[doc = "Register `CQINTSTSENA` writer"]
pub type W = crate::W<CqintstsenaSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hac(&mut self) -> HacW<CqintstsenaSpec> {
        HacW::new(self, 0)
    }
    #[doc = "Bit 1 - Task Complete Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn tcc(&mut self) -> TccW<CqintstsenaSpec> {
        TccW::new(self, 1)
    }
    #[doc = "Bit 2 - Response Error Detected Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn red(&mut self) -> RedW<CqintstsenaSpec> {
        RedW::new(self, 2)
    }
    #[doc = "Bit 3 - Task Cleared"]
    #[inline(always)]
    #[must_use]
    pub fn tcl(&mut self) -> TclW<CqintstsenaSpec> {
        TclW::new(self, 3)
    }
    #[doc = "Bit 4 - Task Error Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn terr(&mut self) -> TerrW<CqintstsenaSpec> {
        TerrW::new(self, 4)
    }
}
#[doc = "Command queueing interrupt status enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cqintstsena::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cqintstsena::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CqintstsenaSpec;
impl crate::RegisterSpec for CqintstsenaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cqintstsena::R`](R) reader structure"]
impl crate::Readable for CqintstsenaSpec {}
#[doc = "`write(|w| ..)` method takes [`cqintstsena::W`](W) writer structure"]
impl crate::Writable for CqintstsenaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CQINTSTSENA to value 0"]
impl crate::Resettable for CqintstsenaSpec {
