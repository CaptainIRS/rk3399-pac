#[doc = "Register `PVALHS400` reader"]
pub type R = crate::R<Pvalhs400Spec>;
...
#[doc = "Preset value register for HS400\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pvalhs400::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pvalhs400Spec;
impl crate::RegisterSpec for Pvalhs400Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pvalhs400::R`](R) reader structure"]
impl crate::Readable for Pvalhs400Spec {}
#[doc = "`reset()` method sets PVALHS400 to value 0"]
impl crate::Resettable for Pvalhs400Spec {
