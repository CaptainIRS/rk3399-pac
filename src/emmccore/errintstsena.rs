#[doc = "Register `ERRINTSTSENA` reader"]
pub type R = crate::R<ErrintstsenaSpec>;
#[doc = "Register `ERRINTSTSENA` writer"]
pub type W = crate::W<ErrintstsenaSpec>;
#[doc = "\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmdtimeouterr(&mut self) -> CmdtimeouterrW<ErrintstsenaSpec> {
        CmdtimeouterrW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn cmdcrcerr(&mut self) -> CmdcrcerrW<ErrintstsenaSpec> {
        CmdcrcerrW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn cmdendbiterr(&mut self) -> CmdendbiterrW<ErrintstsenaSpec> {
        CmdendbiterrW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn cmdindexerr(&mut self) -> CmdindexerrW<ErrintstsenaSpec> {
        CmdindexerrW::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn datatimeouterr(&mut self) -> DatatimeouterrW<ErrintstsenaSpec> {
        DatatimeouterrW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn datacrcerr(&mut self) -> DatacrcerrW<ErrintstsenaSpec> {
        DatacrcerrW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn dataendbiterr(&mut self) -> DataendbiterrW<ErrintstsenaSpec> {
        DataendbiterrW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn currentlimiterr(&mut self) -> CurrentlimiterrW<ErrintstsenaSpec> {
        CurrentlimiterrW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn autocmderr(&mut self) -> AutocmderrW<ErrintstsenaSpec> {
        AutocmderrW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn admaerr(&mut self) -> AdmaerrW<ErrintstsenaSpec> {
        AdmaerrW::new(self, 9)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn targetresperr(&mut self) -> TargetresperrW<ErrintstsenaSpec> {
        TargetresperrW::new(self, 12)
    }
}
#[doc = "Error interrupt status enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`errintstsena::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`errintstsena::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ErrintstsenaSpec;
impl crate::RegisterSpec for ErrintstsenaSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`errintstsena::R`](R) reader structure"]
impl crate::Readable for ErrintstsenaSpec {}
#[doc = "`write(|w| ..)` method takes [`errintstsena::W`](W) writer structure"]
impl crate::Writable for ErrintstsenaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets ERRINTSTSENA to value 0"]
impl crate::Resettable for ErrintstsenaSpec {
