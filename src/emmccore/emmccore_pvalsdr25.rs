#[doc = "Register `EMMCCORE_PVALSDR25` reader"]
pub type R = crate::R<EmmccorePvalsdr25Spec>;
...
#[doc = "Preset value register for SDR25\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`emmccore_pvalsdr25::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmmccorePvalsdr25Spec;
impl crate::RegisterSpec for EmmccorePvalsdr25Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`emmccore_pvalsdr25::R`](R) reader structure"]
impl crate::Readable for EmmccorePvalsdr25Spec {}
#[doc = "`reset()` method sets EMMCCORE_PVALSDR25 to value 0"]
impl crate::Resettable for EmmccorePvalsdr25Spec {
