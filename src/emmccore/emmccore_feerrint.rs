#[doc = "Register `EMMCCORE_FEERRINT` reader"]
pub type R = crate::R<EmmccoreFeerrintSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmdtimeouterr(&mut self) -> CmdtimeouterrW<EmmccoreFeerrintSpec> {
        CmdtimeouterrW::new(self, 0)
    }
    #[doc = "Bit 1 - Force Event for Command CRC Error"]
    #[inline(always)]
    #[must_use]
    pub fn cmdcrcerr(&mut self) -> CmdcrcerrW<EmmccoreFeerrintSpec> {
        CmdcrcerrW::new(self, 1)
    }
    #[doc = "Bit 2 - Force Event for Command End Bit Error"]
    #[inline(always)]
    #[must_use]
    pub fn cmdendbiterr(&mut self) -> CmdendbiterrW<EmmccoreFeerrintSpec> {
        CmdendbiterrW::new(self, 2)
    }
    #[doc = "Bit 3 - Force Event for Command Index Error"]
    #[inline(always)]
    #[must_use]
    pub fn cmdindexerr(&mut self) -> CmdindexerrW<EmmccoreFeerrintSpec> {
        CmdindexerrW::new(self, 3)
    }
    #[doc = "Bit 4 - Force Event for Data Timeout Error"]
    #[inline(always)]
    #[must_use]
    pub fn dattimeouterr(&mut self) -> DattimeouterrW<EmmccoreFeerrintSpec> {
        DattimeouterrW::new(self, 4)
    }
    #[doc = "Bit 5 - Force Event for Data CRC Error"]
    #[inline(always)]
    #[must_use]
    pub fn datcrcerr(&mut self) -> DatcrcerrW<EmmccoreFeerrintSpec> {
        DatcrcerrW::new(self, 5)
    }
    #[doc = "Bit 6 - Force Event for Data End Bit Error"]
    #[inline(always)]
    #[must_use]
    pub fn datendbiterr(&mut self) -> DatendbiterrW<EmmccoreFeerrintSpec> {
        DatendbiterrW::new(self, 6)
    }
    #[doc = "Bit 7 - Force Event for Current Limit Error"]
    #[inline(always)]
    #[must_use]
    pub fn currenterr(&mut self) -> CurrenterrW<EmmccoreFeerrintSpec> {
        CurrenterrW::new(self, 7)
    }
    #[doc = "Bit 8 - Force Event for Auto CMD Error"]
    #[inline(always)]
    #[must_use]
    pub fn acmderr(&mut self) -> AcmderrW<EmmccoreFeerrintSpec> {
        AcmderrW::new(self, 8)
    }
    #[doc = "Bit 9 - Force Event for ADMA Error"]
    #[inline(always)]
    #[must_use]
    pub fn admaerr(&mut self) -> AdmaerrW<EmmccoreFeerrintSpec> {
        AdmaerrW::new(self, 9)
    }
}
#[doc = "Force event register for error interrupt status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`emmccore_feerrint::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`emmccore_feerrint::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmmccoreFeerrintSpec;
impl crate::RegisterSpec for EmmccoreFeerrintSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`emmccore_feerrint::R`](R) reader structure"]
impl crate::Readable for EmmccoreFeerrintSpec {}
#[doc = "`write(|w| ..)` method takes [`emmccore_feerrint::W`](W) writer structure"]
impl crate::Writable for EmmccoreFeerrintSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets EMMCCORE_FEERRINT to value 0"]
impl crate::Resettable for EmmccoreFeerrintSpec {
