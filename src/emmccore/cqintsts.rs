#[doc = "Register `CQINTSTS` reader"]
pub type R = crate::R<CqintstsSpec>;
#[doc = "Register `CQINTSTS` writer"]
pub type W = crate::W<CqintstsSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hac(&mut self) -> HacW<CqintstsSpec> {
        HacW::new(self, 0)
    }
    #[doc = "Bit 1 - Task Complete Interrupt\n\nThis status bit is asserted(if CQISTE.TCC=1) when at least one of\n\nthe following two conditions are met:\n\na. A task is completed and the INT bit is set in its Task Descriptor\n\nb. Interrupt caused by Interrupt Coalescing logic"]
    #[inline(always)]
    #[must_use]
    pub fn tcc(&mut self) -> TccW<CqintstsSpec> {
        TccW::new(self, 1)
    }
    #[doc = "Bit 2 - Response Error Detected Interrupt\n\nThis status bit is asserted (if CQISTE.RED=1) when a response is\n\nreceived with an error bit set in the device status field.\n\nSoftware uses CQRMEM register to configure which device status\n\nbit fields may trigger an interrupt, and which are masked."]
    #[inline(always)]
    #[must_use]
    pub fn red(&mut self) -> RedW<CqintstsSpec> {
        RedW::new(self, 2)
    }
    #[doc = "Bit 3 - Task Cleared\n\nThis status bit is asserted (if CQISTE.TCL=1) when a task clear\n\noperation is completed by CQE. The completed task clear\n\noperation is either an individual task clear (CQTCLR) or clearing\n\nof all tasks (CQCTL)."]
    #[inline(always)]
    #[must_use]
    pub fn tcl(&mut self) -> TclW<CqintstsSpec> {
        TclW::new(self, 3)
    }
    #[doc = "Bit 4 - Task Error Interrupt\n\nThis bit is asserted when task error is detected due to invalid task\n\ndescriptor"]
    #[inline(always)]
    #[must_use]
    pub fn terr(&mut self) -> TerrW<CqintstsSpec> {
        TerrW::new(self, 4)
    }
}
#[doc = "Command queueing interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cqintsts::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cqintsts::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CqintstsSpec;
impl crate::RegisterSpec for CqintstsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cqintsts::R`](R) reader structure"]
impl crate::Readable for CqintstsSpec {}
#[doc = "`write(|w| ..)` method takes [`cqintsts::W`](W) writer structure"]
impl crate::Writable for CqintstsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x1f;
}
#[doc = "`reset()` method sets CQINTSTS to value 0"]
impl crate::Resettable for CqintstsSpec {
