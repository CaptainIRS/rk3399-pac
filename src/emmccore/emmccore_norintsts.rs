#[doc = "Register `EMMCCORE_NORINTSTS` reader"]
pub type R = crate::R<EmmccoreNorintstsSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn commandcomplete(&mut self) -> CommandcompleteW<EmmccoreNorintstsSpec> {
        CommandcompleteW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn transfercomplete(&mut self) -> TransfercompleteW<EmmccoreNorintstsSpec> {
        TransfercompleteW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn blockgapevent(&mut self) -> BlockgapeventW<EmmccoreNorintstsSpec> {
        BlockgapeventW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn dmainterrupt(&mut self) -> DmainterruptW<EmmccoreNorintstsSpec> {
        DmainterruptW::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn bufferwriteready(&mut self) -> BufferwritereadyW<EmmccoreNorintstsSpec> {
        BufferwritereadyW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn bufferreadready(&mut self) -> BufferreadreadyW<EmmccoreNorintstsSpec> {
        BufferreadreadyW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn cardinsertion(&mut self) -> CardinsertionW<EmmccoreNorintstsSpec> {
        CardinsertionW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn cardremoval(&mut self) -> CardremovalW<EmmccoreNorintstsSpec> {
        CardremovalW::new(self, 7)
    }
    #[doc = "Bit 13 - This status is set if the boot acknowledge is received from device."]
    #[inline(always)]
    #[must_use]
    pub fn bootackrcv(&mut self) -> BootackrcvW<EmmccoreNorintstsSpec> {
        BootackrcvW::new(self, 13)
    }
    #[doc = "Bit 14 - This status is set if the boot operation get terminated"]
    #[inline(always)]
    #[must_use]
    pub fn bootterminateinterrupt(&mut self) -> BootterminateinterruptW<EmmccoreNorintstsSpec> {
...
pub struct EmmccoreNorintstsSpec;
impl crate::RegisterSpec for EmmccoreNorintstsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`emmccore_norintsts::R`](R) reader structure"]
impl crate::Readable for EmmccoreNorintstsSpec {}
#[doc = "`write(|w| ..)` method takes [`emmccore_norintsts::W`](W) writer structure"]
impl crate::Writable for EmmccoreNorintstsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0x60ff;
}
#[doc = "`reset()` method sets EMMCCORE_NORINTSTS to value 0"]
impl crate::Resettable for EmmccoreNorintstsSpec {
