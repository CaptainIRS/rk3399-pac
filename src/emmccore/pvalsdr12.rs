#[doc = "Register `PVALSDR12` reader"]
pub type R = crate::R<Pvalsdr12Spec>;
...
#[doc = "Preset value register for SDR12\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pvalsdr12::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pvalsdr12Spec;
impl crate::RegisterSpec for Pvalsdr12Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pvalsdr12::R`](R) reader structure"]
impl crate::Readable for Pvalsdr12Spec {}
#[doc = "`reset()` method sets PVALSDR12 to value 0"]
impl crate::Resettable for Pvalsdr12Spec {
