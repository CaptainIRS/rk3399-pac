#[doc = "Register `EMMCCORE_PVALSDR12` reader"]
pub type R = crate::R<EmmccorePvalsdr12Spec>;
...
#[doc = "Preset value register for SDR12\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`emmccore_pvalsdr12::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmmccorePvalsdr12Spec;
impl crate::RegisterSpec for EmmccorePvalsdr12Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`emmccore_pvalsdr12::R`](R) reader structure"]
impl crate::Readable for EmmccorePvalsdr12Spec {}
#[doc = "`reset()` method sets EMMCCORE_PVALSDR12 to value 0"]
impl crate::Resettable for EmmccorePvalsdr12Spec {
