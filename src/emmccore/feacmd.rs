#[doc = "Register `FEACMD` writer"]
pub type W = crate::W<FeacmdSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn notexe(&mut self) -> NotexeW<FeacmdSpec> {
        NotexeW::new(self, 0)
    }
    #[doc = "Bit 1 - Force Event for Auto CMD timeout Error"]
    #[inline(always)]
    #[must_use]
    pub fn timeouterr(&mut self) -> TimeouterrW<FeacmdSpec> {
        TimeouterrW::new(self, 1)
    }
    #[doc = "Bit 2 - Force Event for Auto CMD CRC Error"]
    #[inline(always)]
    #[must_use]
    pub fn crcerr(&mut self) -> CrcerrW<FeacmdSpec> {
        CrcerrW::new(self, 2)
    }
    #[doc = "Bit 3 - Force Event for Auto CMD End bit Error"]
    #[inline(always)]
    #[must_use]
    pub fn enderr(&mut self) -> EnderrW<FeacmdSpec> {
        EnderrW::new(self, 3)
    }
    #[doc = "Bit 4 - Force Event for Auto CMD Index Error"]
    #[inline(always)]
    #[must_use]
    pub fn indexerr(&mut self) -> IndexerrW<FeacmdSpec> {
        IndexerrW::new(self, 4)
    }
    #[doc = "Bit 7 - Force Event for command not issued by Auto CMD12 Error"]
    #[inline(always)]
    #[must_use]
    pub fn cmderr(&mut self) -> CmderrW<FeacmdSpec> {
        CmderrW::new(self, 7)
    }
}
#[doc = "Force event register for Auto CMD error status\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`feacmd::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FeacmdSpec;
impl crate::RegisterSpec for FeacmdSpec {
    type Ux = u16;
}
#[doc = "`write(|w| ..)` method takes [`feacmd::W`](W) writer structure"]
impl crate::Writable for FeacmdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets FEACMD to value 0"]
impl crate::Resettable for FeacmdSpec {
