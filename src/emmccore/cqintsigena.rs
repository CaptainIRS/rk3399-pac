#[doc = "Register `CQINTSIGENA` reader"]
pub type R = crate::R<CqintsigenaSpec>;
#[doc = "Register `CQINTSIGENA` writer"]
pub type W = crate::W<CqintsigenaSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hac(&mut self) -> HacW<CqintsigenaSpec> {
        HacW::new(self, 0)
    }
    #[doc = "Bit 1 - Task Complete Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn tcc(&mut self) -> TccW<CqintsigenaSpec> {
        TccW::new(self, 1)
    }
    #[doc = "Bit 2 - Response Error Detected Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn red(&mut self) -> RedW<CqintsigenaSpec> {
        RedW::new(self, 2)
    }
    #[doc = "Bit 3 - Task Cleared"]
    #[inline(always)]
    #[must_use]
    pub fn tcl(&mut self) -> TclW<CqintsigenaSpec> {
        TclW::new(self, 3)
    }
    #[doc = "Bit 4 - Task Error Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn terr(&mut self) -> TerrW<CqintsigenaSpec> {
        TerrW::new(self, 4)
    }
}
#[doc = "Command queueing interrupt signal enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cqintsigena::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cqintsigena::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CqintsigenaSpec;
impl crate::RegisterSpec for CqintsigenaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cqintsigena::R`](R) reader structure"]
impl crate::Readable for CqintsigenaSpec {}
#[doc = "`write(|w| ..)` method takes [`cqintsigena::W`](W) writer structure"]
impl crate::Writable for CqintsigenaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CQINTSIGENA to value 0"]
impl crate::Resettable for CqintsigenaSpec {
