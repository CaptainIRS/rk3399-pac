#[doc = "Register `EMMCCORE_PVALINIT` reader"]
pub type R = crate::R<EmmccorePvalinitSpec>;
...
#[doc = "Preset value register for Initialization\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`emmccore_pvalinit::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmmccorePvalinitSpec;
impl crate::RegisterSpec for EmmccorePvalinitSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`emmccore_pvalinit::R`](R) reader structure"]
impl crate::Readable for EmmccorePvalinitSpec {}
#[doc = "`reset()` method sets EMMCCORE_PVALINIT to value 0"]
impl crate::Resettable for EmmccorePvalinitSpec {
