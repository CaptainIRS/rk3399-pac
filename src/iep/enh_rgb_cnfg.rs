#[doc = "Register `ENH_RGB_CNFG` reader"]
pub type R = crate::R<EnhRgbCnfgSpec>;
#[doc = "Register `ENH_RGB_CNFG` writer"]
pub type W = crate::W<EnhRgbCnfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enh_radius(&mut self) -> EnhRadiusW<EnhRgbCnfgSpec> {
        EnhRadiusW::new(self, 0)
    }
    #[doc = "Bits 8:14 - enhancement alpha value\n\n0000000:0\n\n0000001:1/16\n\n0000010:2/16\n\n......\n\n0001111:15/16\n\n0010000:1\n\n0010001:1+1/16;\n\n0010010:1+2/16;\n\n0010011:1+3/16;\n\n......\n\n0100000:2;\n\n......\n\n0110000:3;\n\n......\n\n1000000:4;\n\n......\n\n1010000:5;\n\n......\n\n1100000:6;\n\nother : reserved"]
    #[inline(always)]
    #[must_use]
    pub fn enh_alpha(&mut self) -> EnhAlphaW<EnhRgbCnfgSpec> {
        EnhAlphaW::new(self, 8)
    }
    #[doc = "Bits 16:23 - enhancement threshold\n\nIn denoise and detail enhancement operation, more than the\n\nthreshold, considering as detail; but if less than the threshold,\n\nconsidering as noise, need to to be filtered."]
    #[inline(always)]
    #[must_use]
    pub fn enh_threshold(&mut self) -> EnhThresholdW<EnhRgbCnfgSpec> {
        EnhThresholdW::new(self, 16)
    }
    #[doc = "Bits 24:25 - 3D denoise chroma temporal coefficient select"]
    #[inline(always)]
    #[must_use]
    pub fn chroma_temp_sel(&mut self) -> ChromaTempSelW<EnhRgbCnfgSpec> {
        ChromaTempSelW::new(self, 24)
    }
    #[doc = "Bits 26:27 - 3D denoise chroma spatial coefficient select"]
    #[inline(always)]
    #[must_use]
    pub fn chroma_spat_sel(&mut self) -> ChromaSpatSelW<EnhRgbCnfgSpec> {
        ChromaSpatSelW::new(self, 26)
    }
    #[doc = "Bits 28:29 - 3D denoise luma temporal coefficient select"]
    #[inline(always)]
    #[must_use]
    pub fn luma_temp_sel(&mut self) -> LumaTempSelW<EnhRgbCnfgSpec> {
        LumaTempSelW::new(self, 28)
    }
    #[doc = "Bits 30:31 - 3D denoise luma spatial coefficient select"]
    #[inline(always)]
    #[must_use]
    pub fn luma_spat_sel(&mut self) -> LumaSpatSelW<EnhRgbCnfgSpec> {
        LumaSpatSelW::new(self, 30)
    }
}
#[doc = "enhancement RGB configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`enh_rgb_cnfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`enh_rgb_cnfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EnhRgbCnfgSpec;
impl crate::RegisterSpec for EnhRgbCnfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`enh_rgb_cnfg::R`](R) reader structure"]
impl crate::Readable for EnhRgbCnfgSpec {}
#[doc = "`write(|w| ..)` method takes [`enh_rgb_cnfg::W`](W) writer structure"]
impl crate::Writable for EnhRgbCnfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ENH_RGB_CNFG to value 0"]
impl crate::Resettable for EnhRgbCnfgSpec {
