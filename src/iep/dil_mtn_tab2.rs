#[doc = "Register `DIL_MTN_TAB2` reader"]
pub type R = crate::R<DilMtnTab2Spec>;
#[doc = "Register `DIL_MTN_TAB2` writer"]
pub type W = crate::W<DilMtnTab2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mtn_sub_tab0(&mut self) -> MtnSubTab0W<DilMtnTab2Spec> {
        MtnSubTab0W::new(self, 0)
    }
    #[doc = "Bits 8:14 - motion sub table1"]
    #[inline(always)]
    #[must_use]
    pub fn mtn_sub_tab1(&mut self) -> MtnSubTab1W<DilMtnTab2Spec> {
        MtnSubTab1W::new(self, 8)
    }
    #[doc = "Bits 16:22 - motion sub table2"]
    #[inline(always)]
    #[must_use]
    pub fn mtn_sub_tab2(&mut self) -> MtnSubTab2W<DilMtnTab2Spec> {
        MtnSubTab2W::new(self, 16)
    }
    #[doc = "Bits 24:30 - motion sub table3"]
    #[inline(always)]
    #[must_use]
    pub fn mtn_sub_tab3(&mut self) -> MtnSubTab3W<DilMtnTab2Spec> {
        MtnSubTab3W::new(self, 24)
    }
}
#[doc = "Deinterlace motion table2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dil_mtn_tab2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dil_mtn_tab2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DilMtnTab2Spec;
impl crate::RegisterSpec for DilMtnTab2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dil_mtn_tab2::R`](R) reader structure"]
impl crate::Readable for DilMtnTab2Spec {}
#[doc = "`write(|w| ..)` method takes [`dil_mtn_tab2::W`](W) writer structure"]
impl crate::Writable for DilMtnTab2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DIL_MTN_TAB2 to value 0"]
impl crate::Resettable for DilMtnTab2Spec {
