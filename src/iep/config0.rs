...
pub enum RgbConGamOrder {
    ...
    B0 = 0,
    #[doc = "1: DDE prior to CG (CG represent for contrast &amp; gamma operation, and DDE represent for denoise, detail or edge enhancement operation)"]
    B1 = 1,
}
...
impl RgbConGamOrderR {
    ...
    #[doc = "DDE prior to CG (CG represent for contrast &amp; gamma operation, and DDE represent for denoise, detail or edge enhancement operation)"]
    #[inline(always)]
    pub fn is_b1(&self) -> bool {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vop_path_en(&mut self) -> VopPathEnW<Config0Spec> {
        VopPathEnW::new(self, 0)
    }
    #[doc = "Bits 1:7 - deinterlace high frequency factor"]
    #[inline(always)]
    #[must_use]
    pub fn dil_hf_fct(&mut self) -> DilHfFctW<Config0Spec> {
        DilHfFctW::new(self, 1)
    }
    #[doc = "Bits 8:10 - Deinterlace mode select:"]
    #[inline(always)]
    #[must_use]
    pub fn dil_mode(&mut self) -> DilModeW<Config0Spec> {
        DilModeW::new(self, 8)
    }
    #[doc = "Bit 11 - deinterlace high frequency calculation enable"]
    #[inline(always)]
    #[must_use]
    pub fn dil_hf_en(&mut self) -> DilHfEnW<Config0Spec> {
        DilHfEnW::new(self, 11)
    }
    #[doc = "Bit 12 - deinterlace edge interpolation"]
    #[inline(always)]
    #[must_use]
    pub fn dil_ei_mode(&mut self) -> DilEiModeW<Config0Spec> {
        DilEiModeW::new(self, 12)
    }
    #[doc = "Bit 13 - YUV 3D denoise enable"]
    #[inline(always)]
    #[must_use]
    pub fn yuv_dns_en(&mut self) -> YuvDnsEnW<Config0Spec> {
        YuvDnsEnW::new(self, 13)
    }
    #[doc = "Bit 14 - yuv enhancement enable"]
    #[inline(always)]
    #[must_use]
    pub fn yuv_enh_en(&mut self) -> YuvEnhEnW<Config0Spec> {
        YuvEnhEnW::new(self, 14)
    }
    #[doc = "Bit 15 - deinterlace edge interpolation for smooth effect"]
    #[inline(always)]
    #[must_use]
    pub fn dil_ei_smooth(&mut self) -> DilEiSmoothW<Config0Spec> {
        DilEiSmoothW::new(self, 15)
    }
    #[doc = "Bit 16 - RGB color enhancement enable"]
    #[inline(always)]
    #[must_use]
    pub fn rgb_color_enh_en(&mut self) -> RgbColorEnhEnW<Config0Spec> {
        RgbColorEnhEnW::new(self, 16)
    }
    #[doc = "Bit 17 - RGB contrast enhancement and gamma adjustment enable"]
    #[inline(always)]
    #[must_use]
    pub fn rgb_con_gam_en(&mut self) -> RgbConGamEnW<Config0Spec> {
        RgbConGamEnW::new(self, 17)
    }
    #[doc = "Bits 18:19 - RGB enhancement select"]
    #[inline(always)]
    #[must_use]
    pub fn rgb_enh_sel(&mut self) -> RgbEnhSelW<Config0Spec> {
        RgbEnhSelW::new(self, 18)
    }
    #[doc = "Bit 20 - RGB contrast enhancement and gamma adjustment operation\n\norder select."]
    #[inline(always)]
    #[must_use]
    pub fn rgb_con_gam_order(&mut self) -> RgbConGamOrderW<Config0Spec> {
        RgbConGamOrderW::new(self, 20)
    }
    #[doc = "Bits 21:22 - deinterlace edge interpolation radius"]
    #[inline(always)]
    #[must_use]
    pub fn dil_ei_radius(&mut self) -> DilEiRadiusW<Config0Spec> {
        DilEiRadiusW::new(self, 21)
    }
    #[doc = "Bit 23 - deinterlace edge interpolation select"]
    #[inline(always)]
    #[must_use]
    pub fn dil_ei_sel(&mut self) -> DilEiSelW<Config0Spec> {
