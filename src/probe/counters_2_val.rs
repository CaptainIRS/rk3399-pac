#[doc = "Register `Counters_2_Val` reader"]
pub type R = crate::R<Counters2ValSpec>;
...
#[doc = "Registers Counters_M_Val contain the statistics counter values.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`counters_2_val::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Counters2ValSpec;
impl crate::RegisterSpec for Counters2ValSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`counters_2_val::R`](R) reader structure"]
impl crate::Readable for Counters2ValSpec {}
#[doc = "`reset()` method sets Counters_2_Val to value 0"]
impl crate::Resettable for Counters2ValSpec {
