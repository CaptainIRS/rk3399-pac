#[doc = "Register `SDMMC_CTRL` reader"]
pub type R = crate::R<SdmmcCtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn controller_reset(&mut self) -> ControllerResetW<SdmmcCtrlSpec> {
        ControllerResetW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_reset(&mut self) -> FifoResetW<SdmmcCtrlSpec> {
        FifoResetW::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn dma_reset(&mut self) -> DmaResetW<SdmmcCtrlSpec> {
        DmaResetW::new(self, 2)
    }
    #[doc = "Bit 4 - Global interrupt enable/disable bit:"]
    #[inline(always)]
    #[must_use]
    pub fn int_enable(&mut self) -> IntEnableW<SdmmcCtrlSpec> {
        IntEnableW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn dma_enable(&mut self) -> DmaEnableW<SdmmcCtrlSpec> {
        DmaEnableW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn read_wait(&mut self) -> ReadWaitW<SdmmcCtrlSpec> {
        ReadWaitW::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn send_irq_response(&mut self) -> SendIrqResponseW<SdmmcCtrlSpec> {
        SendIrqResponseW::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn abort_read_data(&mut self) -> AbortReadDataW<SdmmcCtrlSpec> {
        AbortReadDataW::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn send_ccsd(&mut self) -> SendCcsdW<SdmmcCtrlSpec> {
        SendCcsdW::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn send_auto_stop_ccsd(&mut self) -> SendAutoStopCcsdW<SdmmcCtrlSpec> {
...
#[doc = "Control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sdmmc_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sdmmc_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SdmmcCtrlSpec;
impl crate::RegisterSpec for SdmmcCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sdmmc_ctrl::R`](R) reader structure"]
impl crate::Readable for SdmmcCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sdmmc_ctrl::W`](W) writer structure"]
impl crate::Writable for SdmmcCtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x07;
}
#[doc = "`reset()` method sets SDMMC_CTRL to value 0x0100_0000"]
impl crate::Resettable for SdmmcCtrlSpec {
