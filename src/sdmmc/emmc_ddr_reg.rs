#[doc = "Register `EMMC_DDR_REG` reader"]
pub type R = crate::R<EmmcDdrRegSpec>;
#[doc = "Register `EMMC_DDR_REG` writer"]
pub type W = crate::W<EmmcDdrRegSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn half_start_bit(&mut self) -> HalfStartBitW<EmmcDdrRegSpec> {
        HalfStartBitW::new(self, 0)
    }
}
#[doc = "eMMC4.5 DDR start bit detection control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`emmc_ddr_reg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`emmc_ddr_reg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmmcDdrRegSpec;
impl crate::RegisterSpec for EmmcDdrRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emmc_ddr_reg::R`](R) reader structure"]
impl crate::Readable for EmmcDdrRegSpec {}
#[doc = "`write(|w| ..)` method takes [`emmc_ddr_reg::W`](W) writer structure"]
impl crate::Writable for EmmcDdrRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EMMC_DDR_REG to value 0"]
impl crate::Resettable for EmmcDdrRegSpec {
