#[doc = "Register `DENALI_CTL_81` reader"]
pub type R = crate::R<DenaliCtl81Spec>;
#[doc = "Register `DENALI_CTL_81` writer"]
pub type W = crate::W<DenaliCtl81Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn upd_ctrlupd_timeout_f2(&mut self) -> UpdCtrlupdTimeoutF2W<DenaliCtl81Spec> {
    ...
    pub fn upd_ctrlupd_sw_promote_threshold_f2(
        &mut self,
    ) -> UpdCtrlupdSwPromoteThresholdF2W<DenaliCtl81Spec> {
        UpdCtrlupdSwPromoteThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_81::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_81::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl81Spec;
impl crate::RegisterSpec for DenaliCtl81Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_81::R`](R) reader structure"]
impl crate::Readable for DenaliCtl81Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_81::W`](W) writer structure"]
impl crate::Writable for DenaliCtl81Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_81 to value 0"]
impl crate::Resettable for DenaliCtl81Spec {
