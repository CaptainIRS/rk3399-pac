#[doc = "Register `DENALI_CTL_186` reader"]
pub type R = crate::R<DenaliCtl186Spec>;
#[doc = "Register `DENALI_CTL_186` writer"]
pub type W = crate::W<DenaliCtl186Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzqcal_f2(&mut self) -> TzqcalF2W<DenaliCtl186Spec> {
        TzqcalF2W::new(self, 0)
    }
    #[doc = "Bits 16:21 - Holds the DRAM ZQLAT value for frequency copy 2 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tzqlat_f2(&mut self) -> TzqlatF2W<DenaliCtl186Spec> {
        TzqlatF2W::new(self, 16)
    }
    #[doc = "Bits 24:25 - Specifies which chip selects will simultaneously receive a ZQ start or latch command once the ZQ_REQ parameter is written with a ZQ Start or ZQ Latch command."]
    #[inline(always)]
    #[must_use]
    pub fn zq_sw_req_start_latch_map(&mut self) -> ZqSwReqStartLatchMapW<DenaliCtl186Spec> {
        ZqSwReqStartLatchMapW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_186::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_186::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl186Spec;
impl crate::RegisterSpec for DenaliCtl186Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_186::R`](R) reader structure"]
impl crate::Readable for DenaliCtl186Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_186::W`](W) writer structure"]
impl crate::Writable for DenaliCtl186Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_186 to value 0"]
impl crate::Resettable for DenaliCtl186Spec {
