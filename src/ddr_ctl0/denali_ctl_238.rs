#[doc = "Register `DENALI_CTL_238` reader"]
pub type R = crate::R<DenaliCtl238Spec>;
#[doc = "Register `DENALI_CTL_238` writer"]
pub type W = crate::W<DenaliCtl238Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_on_sref_exit(&mut self) -> RdlvlOnSrefExitW<DenaliCtl238Spec> {
        RdlvlOnSrefExitW::new(self, 0)
    }
    #[doc = "Bit 8 - Enables the use of the dfi_lvl_periodic signal during gate training. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_gate_periodic(&mut self) -> RdlvlGatePeriodicW<DenaliCtl238Spec> {
        RdlvlGatePeriodicW::new(self, 8)
    }
    #[doc = "Bit 16 - Enables automatic gate training on a self-refresh exit. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_gate_on_sref_exit(&mut self) -> RdlvlGateOnSrefExitW<DenaliCtl238Spec> {
        RdlvlGateOnSrefExitW::new(self, 16)
    }
    #[doc = "Bit 24 - Enables refreshes and other non- data commands to execute in the middle of data eye training. Set to 1 to enable."]
    #[inline(always)]
    #[must_use]
    pub fn rdlvl_aref_en(&mut self) -> RdlvlArefEnW<DenaliCtl238Spec> {
        RdlvlArefEnW::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_238::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_238::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl238Spec;
impl crate::RegisterSpec for DenaliCtl238Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_238::R`](R) reader structure"]
impl crate::Readable for DenaliCtl238Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_238::W`](W) writer structure"]
impl crate::Writable for DenaliCtl238Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_238 to value 0"]
impl crate::Resettable for DenaliCtl238Spec {
