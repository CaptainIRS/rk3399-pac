#[doc = "Register `DENALI_CTL_175` reader"]
pub type R = crate::R<DenaliCtl175Spec>;
#[doc = "Register `DENALI_CTL_175` writer"]
pub type W = crate::W<DenaliCtl175Spec>;
...
impl W {
    ...
    pub fn zq_calstart_high_threshold_f2(
        &mut self,
    ) -> ZqCalstartHighThresholdF2W<DenaliCtl175Spec> {
    ...
    pub fn zq_callatch_high_threshold_f2(
        &mut self,
    ) -> ZqCallatchHighThresholdF2W<DenaliCtl175Spec> {
        ZqCallatchHighThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_175::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_175::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl175Spec;
impl crate::RegisterSpec for DenaliCtl175Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_175::R`](R) reader structure"]
impl crate::Readable for DenaliCtl175Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_175::W`](W) writer structure"]
impl crate::Writable for DenaliCtl175Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_175 to value 0"]
impl crate::Resettable for DenaliCtl175Spec {
