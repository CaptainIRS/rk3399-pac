#[doc = "Register `DENALI_CTL_178` reader"]
pub type R = crate::R<DenaliCtl178Spec>;
#[doc = "Register `DENALI_CTL_178` writer"]
pub type W = crate::W<DenaliCtl178Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn zq_cs_timeout_f2(&mut self) -> ZqCsTimeoutF2W<DenaliCtl178Spec> {
        ZqCsTimeoutF2W::new(self, 0)
    }
    #[doc = "Bits 16:31 - ZQ SW promotion number of long counts until the high priority request is asserted for frequency copy 2."]
    #[inline(always)]
    #[must_use]
    pub fn zq_promote_threshold_f2(&mut self) -> ZqPromoteThresholdF2W<DenaliCtl178Spec> {
        ZqPromoteThresholdF2W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_178::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_178::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl178Spec;
impl crate::RegisterSpec for DenaliCtl178Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_178::R`](R) reader structure"]
impl crate::Readable for DenaliCtl178Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_178::W`](W) writer structure"]
impl crate::Writable for DenaliCtl178Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_178 to value 0"]
impl crate::Resettable for DenaliCtl178Spec {
