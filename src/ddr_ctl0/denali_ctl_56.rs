#[doc = "Register `DENALI_CTL_56` reader"]
pub type R = crate::R<DenaliCtl56Spec>;
#[doc = "Register `DENALI_CTL_56` writer"]
pub type W = crate::W<DenaliCtl56Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tckelcs_f0(&mut self) -> TckelcsF0W<DenaliCtl56Spec> {
        TckelcsF0W::new(self, 0)
    }
    #[doc = "Bits 8:11 - DRAM TCKEHCS value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tckehcs_f0(&mut self) -> TckehcsF0W<DenaliCtl56Spec> {
        TckehcsF0W::new(self, 8)
    }
    #[doc = "Bits 16:20 - DRAM TMRWCKEL value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tmrwckel_f0(&mut self) -> TmrwckelF0W<DenaliCtl56Spec> {
        TmrwckelF0W::new(self, 16)
    }
    #[doc = "Bits 24:27 - DRAM TZQCKE value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn tzqcke_f0(&mut self) -> TzqckeF0W<DenaliCtl56Spec> {
        TzqckeF0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_56::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_56::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl56Spec;
impl crate::RegisterSpec for DenaliCtl56Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_56::R`](R) reader structure"]
impl crate::Readable for DenaliCtl56Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_56::W`](W) writer structure"]
impl crate::Writable for DenaliCtl56Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_56 to value 0"]
impl crate::Resettable for DenaliCtl56Spec {
