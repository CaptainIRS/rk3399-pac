#[doc = "Register `DENALI_CTL_84` reader"]
pub type R = crate::R<DenaliCtl84Spec>;
#[doc = "Register `DENALI_CTL_84` writer"]
pub type W = crate::W<DenaliCtl84Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdfi_phymstr_max_f1(&mut self) -> TdfiPhymstrMaxF1W<DenaliCtl84Spec> {
        TdfiPhymstrMaxF1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Defines the DFI tPHYMSTR_RESP timing parameter (in DFI clocks), the maximum cycles between a dfi_phymstr_req assertion and a dfi_phymstr_ack assertion, for frequency copy 1. If programmed to a non-zero, a timing violation will cause an interrupt and bit (1) set in the PHYMSTR_ERROR_STATUS parameter."]
    #[inline(always)]
    #[must_use]
    pub fn tdfi_phymstr_resp_f1(&mut self) -> TdfiPhymstrRespF1W<DenaliCtl84Spec> {
        TdfiPhymstrRespF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_84::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_84::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl84Spec;
impl crate::RegisterSpec for DenaliCtl84Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_84::R`](R) reader structure"]
impl crate::Readable for DenaliCtl84Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_84::W`](W) writer structure"]
impl crate::Writable for DenaliCtl84Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_84 to value 0"]
impl crate::Resettable for DenaliCtl84Spec {
