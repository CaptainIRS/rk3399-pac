#[doc = "Register `DENALI_CTL_23` reader"]
pub type R = crate::R<DenaliCtl23Spec>;
#[doc = "Register `DENALI_CTL_23` writer"]
pub type W = crate::W<DenaliCtl23Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tdll_f2(&mut self) -> TdllF2W<DenaliCtl23Spec> {
        TdllF2W::new(self, 0)
    }
    #[doc = "Bits 16:22 - Sets latency from read command send to data receive from/to controller for frequency copy 0. Bit (0) is half-cycle increment and the upper bits define memory CAS latency for the controller."]
    #[inline(always)]
    #[must_use]
    pub fn caslat_lin_f0(&mut self) -> CaslatLinF0W<DenaliCtl23Spec> {
        CaslatLinF0W::new(self, 16)
    }
    #[doc = "Bits 24:28 - DRAM WRLAT value for frequency copy 0 in cycles."]
    #[inline(always)]
    #[must_use]
    pub fn wrlat_f0(&mut self) -> WrlatF0W<DenaliCtl23Spec> {
        WrlatF0W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_23::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_23::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl23Spec;
impl crate::RegisterSpec for DenaliCtl23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_23::R`](R) reader structure"]
impl crate::Readable for DenaliCtl23Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_23::W`](W) writer structure"]
impl crate::Writable for DenaliCtl23Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_23 to value 0"]
impl crate::Resettable for DenaliCtl23Spec {
