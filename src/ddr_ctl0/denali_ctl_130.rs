#[doc = "Register `DENALI_CTL_130` reader"]
pub type R = crate::R<DenaliCtl130Spec>;
#[doc = "Register `DENALI_CTL_130` writer"]
pub type W = crate::W<DenaliCtl130Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mrr_promote_threshold_f0(&mut self) -> MrrPromoteThresholdF0W<DenaliCtl130Spec> {
        MrrPromoteThresholdF0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - MRR promotion number of long counts until the high priority request is asserted for frequency copy 1. Applies to SW MRR commands."]
    #[inline(always)]
    #[must_use]
    pub fn mrr_promote_threshold_f1(&mut self) -> MrrPromoteThresholdF1W<DenaliCtl130Spec> {
        MrrPromoteThresholdF1W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`denali_ctl_130::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`denali_ctl_130::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DenaliCtl130Spec;
impl crate::RegisterSpec for DenaliCtl130Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`denali_ctl_130::R`](R) reader structure"]
impl crate::Readable for DenaliCtl130Spec {}
#[doc = "`write(|w| ..)` method takes [`denali_ctl_130::W`](W) writer structure"]
impl crate::Writable for DenaliCtl130Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DENALI_CTL_130 to value 0"]
impl crate::Resettable for DenaliCtl130Spec {
