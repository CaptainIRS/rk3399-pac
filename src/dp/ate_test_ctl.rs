...
#[doc = "Field `ATE_CLR_ERR` reader - Clear error counter \\[3\\]:lane3,\\[2\\]:lane2,\\[1\\]:lane1,\\[0\\]:lane0"]
pub type AteClrErrR = crate::FieldReader;
#[doc = "Field `ATE_CLR_ERR` writer - Clear error counter \\[3\\]:lane3,\\[2\\]:lane2,\\[1\\]:lane1,\\[0\\]:lane0"]
...
#[doc = "Field `TX_ATE` reader - ATE test enable Bit 15~12: Reserved for analog test. Bit 11: ate_en in ch3, Bit 10: ate_en in ch2, Bit 9: ate_en in ch1 Bit 8: ate_en in ch0"]
pub type TxAteR = crate::FieldReader;
#[doc = "Field `TX_ATE` writer - ATE test enable Bit 15~12: Reserved for analog test. Bit 11: ate_en in ch3, Bit 10: ate_en in ch2, Bit 9: ate_en in ch1 Bit 8: ate_en in ch0"]
pub type TxAteW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:3 - Clear error counter \\[3\\]:lane3,\\[2\\]:lane2,\\[1\\]:lane1,\\[0\\]:lane0"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:15 - ATE test enable Bit 15~12: Reserved for analog test. Bit 11: ate_en in ch3, Bit 10: ate_en in ch2, Bit 9: ate_en in ch1 Bit 8: ate_en in ch0"]
    #[inline(always)]
