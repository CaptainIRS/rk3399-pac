...
#[doc = "Hot plug detect signal lost time is larger than \n\n2ms before cable plugged, it means cable is \n\nplugged in:\n\nValue on reset: 0"]
...
#[doc = "Field `PLUG` reader - Hot plug detect signal lost time is larger than \n\n2ms before cable plugged, it means cable is \n\nplugged in:"]
...
#[doc = "Field `PLUG` writer - Hot plug detect signal lost time is larger than \n\n2ms before cable plugged, it means cable is \n\nplugged in:"]
...
#[doc = "Hot plug detect signal lost timer larger than \n\n2ms, that means cable is plugged out:\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum HpdLost {
    #[doc = "1: Interrupt assert,"]
...
#[doc = "Field `HPD_LOST` reader - Hot plug detect signal lost timer larger than \n\n2ms, that means cable is plugged out:"]
...
#[doc = "Field `HPD_LOST` writer - Hot plug detect signal lost timer larger than \n\n2ms, that means cable is plugged out:"]
