...
#[doc = "Colorimetric format of input video. This is used to \n\nspecify video data format in main stream attribute \n\ndata.\n\nValue on reset: 0"]
...
#[doc = "Field `IN_COLOR_F` reader - Colorimetric format of input video. This is used to \n\nspecify video data format in main stream attribute \n\ndata."]
...
#[doc = "Field `IN_COLOR_F` writer - Colorimetric format of input video. This is used to \n\nspecify video data format in main stream attribute \n\ndata."]
...
#[doc = "Field `IN_BPC` reader - Video input bit per color/ component (bpc). This bit \n\nfield is used to specify video data format in main \n\nstream attribute data. Note that 6 bpc mode is invalid \n\nin YCbCr 422 mode. \n\n100, 101, 110, 111: Reserved,"]
...
#[doc = "Field `IN_BPC` writer - Video input bit per color/ component (bpc). This bit \n\nfield is used to specify video data format in main \n\nstream attribute data. Note that 6 bpc mode is invalid \n\nin YCbCr 422 mode. \n\n100, 101, 110, 111: Reserved,"]
...
#[doc = "Dynamic range. This bit field is used to specify video \n\ndata format in main stream attribute data.\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum InDRange {
    #[doc = "1: CEA range (16 ~ 235),"]
    B1 = 1,
...
#[doc = "Field `IN_D_RANGE` reader - Dynamic range. This bit field is used to specify video \n\ndata format in main stream attribute data."]
...
#[doc = "Field `IN_D_RANGE` writer - Dynamic range. This bit field is used to specify video \n\ndata format in main stream attribute data."]
...
impl R {
    #[doc = "Bits 0:1 - Colorimetric format of input video. This is used to \n\nspecify video data format in main stream attribute \n\ndata."]
    #[inline(always)]
    pub fn in_color_f(&self) -> InColorFR {
        InColorFR::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 4:6 - Video input bit per color/ component (bpc). This bit \n\nfield is used to specify video data format in main \n\nstream attribute data. Note that 6 bpc mode is invalid \n\nin YCbCr 422 mode. \n\n100, 101, 110, 111: Reserved,"]
    #[inline(always)]
    pub fn in_bpc(&self) -> InBpcR {
        InBpcR::new(((self.bits >> 4) & 7) as u8)
    }
    #[doc = "Bit 7 - Dynamic range. This bit field is used to specify video \n\ndata format in main stream attribute data."]
    #[inline(always)]
