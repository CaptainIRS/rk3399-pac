...
#[doc = "Field `MYDP_HPD_IRQ` reader - 1: MYDP HPD interrupt is detected. Write 1 to clear"]
pub type MydpHpdIrqR = crate::BitReader;
#[doc = "Field `MYDP_HPD_IRQ` writer - 1: MYDP HPD interrupt is detected. Write 1 to clear"]
pub type MydpHpdIrqW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MYDP_PLUG_OUT` reader - 1: MYDP plug out event is detected. Write 1 to clear"]
pub type MydpPlugOutR = crate::BitReader;
#[doc = "Field `MYDP_PLUG_OUT` writer - 1: MYDP plug out event is detected. Write 1 to clear"]
pub type MydpPlugOutW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MYDP_PLUG_IN` reader - 1: MYDP plug out event is detected. Write 1 to clear"]
pub type MydpPlugInR = crate::BitReader;
#[doc = "Field `MYDP_PLUG_IN` writer - 1: MYDP plug out event is detected. Write 1 to clear"]
pub type MydpPlugInW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DPCD_SPECIFIC_IRQ` reader - 1: Sink specific interrupt in DPCD is detected. Write 1 to clear"]
pub type DpcdSpecificIrqR = crate::BitReader;
#[doc = "Field `DPCD_SPECIFIC_IRQ` writer - 1: Sink specific interrupt in DPCD is detected. Write 1 to clear"]
pub type DpcdSpecificIrqW<'a, REG> = crate::BitWriter1C<'a, REG>;
impl R {
    #[doc = "Bit 1 - 1: MYDP HPD interrupt is detected. Write 1 to clear"]
    #[inline(always)]
    pub fn mydp_hpd_irq(&self) -> MydpHpdIrqR {
        MydpHpdIrqR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - 1: MYDP plug out event is detected. Write 1 to clear"]
    #[inline(always)]
    pub fn mydp_plug_out(&self) -> MydpPlugOutR {
        MydpPlugOutR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - 1: MYDP plug out event is detected. Write 1 to clear"]
    #[inline(always)]
    pub fn mydp_plug_in(&self) -> MydpPlugInR {
        MydpPlugInR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 1: Sink specific interrupt in DPCD is detected. Write 1 to clear"]
    #[inline(always)]
