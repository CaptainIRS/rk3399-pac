...
#[doc = "Field `R_PC2_400MV_6DB` reader - The lookup-table 3(for calculating chx_swing_bit and chx_pc2_bit) value when V_diff is 400mv and Pre_emphasis is 6db."]
pub type RPc2_400mv6dbR = crate::FieldReader;
#[doc = "Field `R_PC2_400MV_6DB` writer - The lookup-table 3(for calculating chx_swing_bit and chx_pc2_bit) value when V_diff is 400mv and Pre_emphasis is 6db."]
pub type RPc2_400mv6dbW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - The lookup-table 3(for calculating chx_swing_bit and chx_pc2_bit) value when V_diff is 400mv and Pre_emphasis is 6db."]
    #[inline(always)]
