...
#[doc = "Field `R_AMP_800MV_3P5DB` reader - The lookup-table 1(for calculating chx_swing_bit) value when V_diff is 800mv and Pre_emphasis is 3.5 db."]
pub type RAmp800mv3p5dbR = crate::FieldReader;
#[doc = "Field `R_AMP_800MV_3P5DB` writer - The lookup-table 1(for calculating chx_swing_bit) value when V_diff is 800mv and Pre_emphasis is 3.5 db."]
pub type RAmp800mv3p5dbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - The lookup-table 1(for calculating chx_swing_bit) value when V_diff is 800mv and Pre_emphasis is 3.5 db."]
    #[inline(always)]
