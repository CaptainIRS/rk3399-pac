...
#[doc = "Field `R_PC2_800MV_3P5DB` reader - The lookup-table 3(for calculating chx_swing_bit and chx_pc2_bit) value when V_diff is 800mv and Pre_emphasis is 3.5 db."]
pub type RPc2_800mv3p5dbR = crate::FieldReader;
#[doc = "Field `R_PC2_800MV_3P5DB` writer - The lookup-table 3(for calculating chx_swing_bit and chx_pc2_bit) value when V_diff is 800mv and Pre_emphasis is 3.5 db."]
pub type RPc2_800mv3p5dbW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - The lookup-table 3(for calculating chx_swing_bit and chx_pc2_bit) value when V_diff is 800mv and Pre_emphasis is 3.5 db."]
    #[inline(always)]
