...
#[doc = "Field `M_VID_0` reader - M_VID \\[7:0\\]. If FIX_M_VID is 1, this M_VID is used. Otherwise the M_VID value which chip calculated is used"]
pub type MVid0R = crate::FieldReader;
#[doc = "Field `M_VID_0` writer - M_VID \\[7:0\\]. If FIX_M_VID is 1, this M_VID is used. Otherwise the M_VID value which chip calculated is used"]
pub type MVid0W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - M_VID \\[7:0\\]. If FIX_M_VID is 1, this M_VID is used. Otherwise the M_VID value which chip calculated is used"]
    #[inline(always)]
