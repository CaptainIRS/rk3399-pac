...
#[doc = "Field `R_AMP_400MV_9DB` reader - The lookup-table 1(for calculating chx_swing_bit) value when V_diff is 400mv and Pre_emphasis is 9db."]
pub type RAmp400mv9dbR = crate::FieldReader;
#[doc = "Field `R_AMP_400MV_9DB` writer - The lookup-table 1(for calculating chx_swing_bit) value when V_diff is 400mv and Pre_emphasis is 9db."]
pub type RAmp400mv9dbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - The lookup-table 1(for calculating chx_swing_bit) value when V_diff is 400mv and Pre_emphasis is 9db."]
    #[inline(always)]
